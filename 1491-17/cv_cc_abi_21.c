...
bool func_73(var uParam0)
{
	...
	func_157(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_SAD"), "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", -1, 1, 45.0f, 1065353216, 1);
	...
	func_157(uParam0, iLocal_15, 2, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_D", -1, 1, 35.0f, 1065353216, 1);
