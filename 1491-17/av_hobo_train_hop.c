...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[2])
	{
		...
		if (((Global_1415419.f_9757 == -310375866 && func_78(Global_36, uParam0->f_483) < 12100.0f) || func_79(uParam0, 1065353216, 100.0f, 4, 50.0f, 1112014848)) || func_56(&uLocal_51) > 100.0f)
		{
			func_75(uParam0);
	...
	if (uParam0->f_469[2] && !uParam0->f_469[0])
	{
		...
		if (!uParam0->f_469[4])
		{
			if (func_81(uParam0, 3.0f, 1116471296, 4, joaat("ACTION"), 1))
			{
				func_76(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[4] = 1;
			}
...
void func_121(int iParam0, Vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_134(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
