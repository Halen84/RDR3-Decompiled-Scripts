...
bool func_73(var uParam0)
{
	...
	func_153(uParam0, joaat("P_JAVIERKNIFE_TEMP"), 0.0f, 0.0f, 0.0f, "Knife", 0, 1, 1);
...
int func_372(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_414(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
