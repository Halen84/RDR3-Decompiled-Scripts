#pragma region Local_Variables
	...
	int iLocal_263 = 0;
	int iLocal_264 = 0;
	struct<4> /*32*/ sLocal_265 = { 0, 0, 0, 0 } ;
...
void __SCRIPT()
{
	...
	func_2(&sLocal_265, &uScriptParam_0);
	while (!func_3(&sLocal_265))
	{
		func_4(&sLocal_265);
		switch (func_5(sLocal_265))
		{
			case 0:
				if (func_6(&sLocal_265))
				{
					func_7(&sLocal_265, 1);
				}
				break;
			case 1:
				if (func_8(&sLocal_265))
				{
					func_7(&sLocal_265, 2);
				}
				break;
			case 2:
				if (func_9(&sLocal_265))
				{
					func_7(&sLocal_265, 3);
				}
				break;
...
bool func_6(var uParam0)
{
	...
	iVar0 = 1;
	if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_16, true, false))
	{
		iVar0 = 0;
	}
...
int func_19(var uParam0)
{
	...
	ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_16, "PBL_1");
	...
	if (!func_46(&uLocal_20, (1 << 14)))
	{
		func_47(&uLocal_20, (1 << 14));
	}
	return 1;
}
...
int func_21(var uParam0)
{
	...
	{
		vVar0 = { 2276.192f, -756.3764f, 41.2659f /*3*/ };
		fVar3 = 125.3885f;
		sVar5.f_10 = 7;
		sVar5.f_0 = 1;
		sVar5.f_1 = 1;
		...
		sVar5.f_6 = { vVar0 /*3*/ };
		sVar5.f_9 = fVar3;
		iLocal_14 = func_51(&uVar4, &sVar5);
		return 0;
	}
	if (func_52(1) && !func_33(iLocal_15, 0))
	{
		vVar16 = { 2285.796f, -746.6627f, 40.7068f /*3*/ };
		fVar19 = 181.3868f;
		sVar21.f_10 = 7;
		sVar21.f_10 = 1;
		sVar21.f_0 = 1;
		...
		sVar21.f_6 = { vVar16 /*3*/ };
		sVar21.f_9 = fVar19;
		iLocal_15 = func_51(&uVar20, &sVar21);
		return 0;
	}
	...
	func_53(0, 0);
	func_54(1);
	if (ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_16, true, false) && ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(iLocal_16, "PBL_1"))
	{
		...
		if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_16, false) && !ANIMSCENE::IS_ANIM_SCENE_FINISHED(iLocal_16, false))
		{
			func_55();
			func_56(100.0f, 0, 0, 1);
			func_57(100.0f, 0, 0, 1);
			func_58(100.0f, 0, 0, 1);
			ANIMSCENE::START_ANIM_SCENE(iLocal_16);
			ANIMSCENE::SET_ANIM_SCENE_PLAY_LIST(iLocal_16, "PBL_1", true);
		}
		return 1;
	}
	return 0;
...
bool func_23(var uParam0)
{
	...
	if (!bLocal_18)
	{
		if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_16, false) && !CAM::IS_SCREEN_FADING_IN())
		{
...
void func_36(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		PED::SET_PED_CONFIG_FLAG(func_80(iParam0), 137 /*PCF_0xE18960DE*/, true);
	}
}
...
void func_38(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		PED::SET_PED_CONFIG_FLAG(func_80(iParam0), 204 /*PCF_0x435F091E*/, true);
	}
	else
	{
		PED::SET_PED_CONFIG_FLAG(func_80(iParam0), 204 /*PCF_0x435F091E*/, false);
	}
}
...
void func_44(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!func_90(*iParam0, (1 << 12)))
	{
		func_101(Global_35);
	}
	if (!func_90(*iParam0, (1 << 20)))
	{
		UIFEED::UI_FEED_CLEAR_CHANNEL(7, true, false);
	}
	if (!func_90(*iParam0, (1 << 21)))
	{
...
int func_51(var uParam0, var uParam1)
{
	...
	if (*uParam1)
	{
		if (bVar0 && !func_109(Global_1835011[4 /*74*/].f_1, 1))
		{
			if (func_52(5))
			{
				func_110(5);
	...
	if ((bVar0 && func_109(Global_1835011[37 /*74*/].f_1, 1)) && !func_109(Global_1835011[43 /*74*/].f_1, 1))
	{
		*uParam0 = 1;
		return 0;
	}
	if ((bVar0 && func_109(Global_1835011[43 /*74*/].f_1, 1)) && !func_109(Global_1835011[44 /*74*/].f_1, 1))
	{
		if (uParam1->f_10 == 0)
		{
			*uParam0 = 1;
	...
	if (uParam1->f_4)
	{
		if (uParam1->f_10 == 0)
		{
			...
			sVar8 = { func_128(uParam1->f_10) /*2*/ };
			sVar10 = { func_129() /*6*/ };
			func_130(iVar2, &sVar8, &sVar10, 0);
...
void func_56(float fParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_75() == 0)
	{
		func_138(1, (fParam0 / 2.0f), bParam1, 1, bParam2);
		return;
	}
	fVar0 = func_139(1);
	if (bParam1)
	...
	fParam0 += fVar0;
	func_143(1, func_142(fParam0, -100.0f, 100.0f), bParam1);
}
...
void func_57(float fParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_75() == 0)
	{
		func_138(2, (fParam0 / 2.0f), bParam1, 1, bParam2);
		return;
	}
	fVar0 = func_139(2);
	if (bParam1)
	...
	fParam0 += fVar0;
	func_143(2, func_142(fParam0, -100.0f, 100.0f), bParam1);
}
...
void func_58(float fParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_75() == 0)
	{
		func_138(0, (fParam0 / 2.0f), bParam1, 1, bParam2);
		return;
	}
	fVar0 = func_139(0);
	if (bParam1)
	...
	fParam0 += fVar0;
	func_143(0, func_142(fParam0, -100.0f, 100.0f), bParam1);
}
...
void func_61()
{
	...
	if (ANIMSCENE::IS_ANIM_SCENE_FINISHED(iLocal_16, false) && !bLocal_18)
	{
...
void func_63(int iParam0, int iParam1)
{
	...
	{
		func_151(Global_35, joaat("CLOTHING_ITEM_NECKWEAR_NONE"), 0, joaat("MP_COMPONENT_TYPE_NECKWEAR_1"), 0, 1, 0, 0, 1, 0);
		func_152(joaat("KIT_BANDANA"), 0);
	}
	func_153(&(Global_1946054.f_1497), Global_35, 1, 49217, 1, 1, 1);
	if ((Global_1359489.f_16 & (1 << 22)) != 0)
	{
...
int func_87(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_33(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_161(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000.0f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_163(iParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_164(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_164(iParam0, 0));
					func_165(iParam0);
				}
			}
			else
...
void func_91(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < 29)
	{
		...
		{
			if (func_167(iVar3) && WEAPON::IS_WEAPON_A_GUN(iVar3))
			{
				if (bParam0)
				{
...
void func_92()
{
	...
	if (func_167(iVar0) && WEAPON::_IS_WEAPON_TWO_HANDED(iVar0))
	{
...
int func_95(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_173(*uParam0, 0.0f, 0.0f, 0.0f))
	{
		return 1;
	}
	iVar1 = 0;
...
struct<2> /*16*/ func_128(int iParam0)
{
	struct<2> /*16*/ sVar0;
	var uVar2;
	var uVar3;
...
struct<6> /*48*/ func_129()
{
	...
	if (func_223(joaat("SLOTID_HORSE_BEDROLL"), &uVar6))
	{
		sVar0.f_4 = uVar6;
	}
	if (func_223(joaat("SLOTID_HORSE_BLANKET"), &uVar7))
	{
		sVar0.f_0 = uVar7;
	}
	if (func_223(joaat("SLOTID_HORSE_HORN"), &uVar8))
	{
		sVar0.f_2 = uVar8;
	}
	if (func_223(joaat("SLOTID_HORSE_SADDLEBAG"), &uVar9))
	{
		sVar0.f_5 = uVar9;
	}
	if (func_223(joaat("SLOTID_HORSE_STIRRUP"), &uVar10))
	{
		sVar0.f_3 = uVar10;
	}
	if (func_223(joaat("SLOTID_HORSE_SADDLE"), &uVar11))
	{
		sVar0.f_1 = uVar11;
	}
	return sVar0;
	...
	while (iVar0 < 45)
	{
		...
		if (func_230(iVar1, 0))
		{
			if ((*uParam1)[iVar0] > 0)
			{
				if (bParam2)
				{
					WEAPON::_ADD_AMMO_TO_PED_BY_TYPE(iParam0, iVar1, (*uParam1)[iVar0], joaat("ADD_REASON_DEFAULT"));
				}
				else
				{
					WEAPON::_ADD_AMMO_TO_PED_BY_TYPE(iParam0, iVar1, ((*uParam1)[iVar0] - WEAPON::GET_PED_AMMO_BY_TYPE(iParam0, iVar1)), joaat("ADD_REASON_DEFAULT"));
				}
			}
		}
		iVar0++;
...
void func_136(int iParam0, int iParam1, int iParam2)
{
	...
	{
		iVar1 = 5;
		if (func_234(Global_1946054.f_1378.f_1[iVar1 /*3*/], iVar3, iVar0, bVar2) != -1)
		{
			Global_1946054.f_1378.f_1[iVar1 /*3*/].f_1 = iVar0;
			Global_1946054.f_2653 = iParam0;
		}
		else if (func_234(Global_1946054.f_1378.f_1[iVar1 /*3*/], iVar3, func_233(iParam0 + 1), bVar2) != -1)
		{
		...
		{
			Global_1946054.f_1378.f_1[iVar1 /*3*/] = func_235(0);
			if (iVar0 == -888790689 || iVar0 == -2126063412)
			{
				Global_1946054.f_1378.f_1[iVar1 /*3*/].f_1 = joaat("REMOVE_COMPONENT");
				Global_1946054.f_2653 = iParam0;
			}
			else
			{
	...
	if (iVar0 != 0)
	{
		...
		else if (func_234(Global_1946054.f_1378.f_1[iVar1 /*3*/], iVar3, func_233(iParam1 + 1), bVar2) != -1)
		{
			Global_1946054.f_1378.f_1[iVar1 /*3*/].f_1 = joaat("BASE");
			Global_1946054.f_2654 = iParam1;
		}
		...
		{
			Global_1946054.f_1378.f_1[iVar1 /*3*/] = func_235(1);
			if (iVar0 == -888790689 || iVar0 == -2126063412)
			{
				Global_1946054.f_1378.f_1[iVar1 /*3*/].f_1 = joaat("REMOVE_COMPONENT");
				Global_1946054.f_2654 = iParam1;
	...
	if (iVar0 != 0)
	{
		...
		else if (func_234(Global_1946054.f_1378.f_1[iVar1 /*3*/], iVar3, func_233(iParam2 + 1), bVar2) != -1)
		{
			Global_1946054.f_1378.f_1[iVar1 /*3*/].f_1 = joaat("BASE");
			Global_1946054.f_2655 = iParam2;
		}
		...
		{
			Global_1946054.f_1378.f_1[iVar1 /*3*/] = func_235(2);
			if (iVar0 == -888790689 || iVar0 == -2126063412)
			{
				Global_1946054.f_1378.f_1[iVar1 /*3*/].f_1 = joaat("REMOVE_COMPONENT");
				Global_1946054.f_2655 = iParam2;
...
void func_137()
{
	...
	func_236(0);
	func_237(0, Global_1946054.f_2653, 0);
	func_237(1, Global_1946054.f_2654, 0);
	func_237(2, Global_1946054.f_2655, 0);
	iVar0 = 5;
	iVar1 = 6;
	iVar2 = 7;
	iVar3 = 0;
...
void func_143(int iParam0, float fParam1, bool bParam2)
{
	...
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(Global_35, func_252(iParam0), iVar0);
	func_254(func_253(iParam0), (100.0f * (BUILTIN::TO_FLOAT(iVar0) / 100.0f)), 0);
...
bool func_146(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (bParam2)
	{
		if (!func_261(Global_1347702[iParam0 /*49*/].f_13, (1 << 10)))
		{
			func_262(&(Global_1347702[iParam0 /*49*/].f_13), (1 << 10));
		}
	}
	if (bParam4 && !func_261(Global_1347702[iParam0 /*49*/].f_13, (1 << 13)))
	{
		func_262(&(Global_1347702[iParam0 /*49*/].f_13), (1 << 13));
	}
	...
	else if (bParam3 && !func_265(Global_1347702[iParam0 /*49*/].f_15))
	{
...
int func_151(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	{
		sVar0 = { func_269(iParam1, 1, 0) /*5*/ };
		iParam3 = func_270(sVar0.f_4);
		if (iParam3 == joaat("MP_COMPONENT_TYPE_END"))
		{
			return 0;
		}
	...
	switch (iParam3)
	{
		...
		case joaat("MP_COMPONENT_TYPE_NECKWEAR_1"):
			if (bParam8 && iParam1 != Global_1946054.f_57[func_271(iParam3, 1) /*11*/])
			{
				func_274(31, 0, 0, 0, 0);
			}
			break;
		case joaat("MP_COMPONENT_TYPE_HEADWEAR"):
			if (func_275((1 << 15)) && iParam1 != Global_1946054.f_57[func_271(iParam3, 1) /*11*/])
			{
				func_276();
...
void func_152(int iParam0, bool bParam1)
{
	...
	sVar0 = { func_269(iParam0, 0, 0) /*5*/ };
	sVar5 = { func_280(iParam0, sVar0, sVar0.f_4, 0) /*4*/ };
	if (func_281(iParam0, sVar0, sVar0.f_4, 0) <= 0)
	{
		return;
	}
	INVENTORY::_INVENTORY_SET_INVENTORY_ITEM_IN_USE(func_282(0), &sVar5, bParam1);
}
...
void func_153(var uParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if ((func_275((1 << 15)) && func_285(joaat("MP_COMPONENT_TYPE_HEADWEAR"), 8)) && func_286(10, iParam3))
	{
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_285(iVar3, 6) || uParam0->f_1[iVar1 /*3*/] == Global_1946054.f_57[iVar1 /*11*/]) || uParam0->f_1[iVar1 /*3*/].f_1 == joaat("REMOVE_COMPONENT"))
				{
...
int func_171(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		func_300(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0.0f;
...
void func_189(int iParam0, bool bParam1)
{
	...
	if (PERSCHAR::_0xA8120EBEAF290C7A(func_34(iParam0, 0)))
	{
		iVar0 = PERSCHAR::_0x69786495C92A3044(func_34(iParam0, 0));
		if (iVar0 != Global_1360165[iParam0 /*1157*/].f_47 || bParam1)
		{
			Global_1360165[iParam0 /*1157*/].f_47 = iVar0;
			strcpy_s(&(Global_1360165[iParam0 /*1157*/].f_48), 64, PERSCHAR::_0x9C7F95946E304778(func_34(iParam0, 0), Global_1360165[iParam0 /*1157*/].f_47));
...
void func_196(int iParam0, struct<2> /*16*/ sParam1)
{
	iParam0 = func_107(iParam0);
	if (iParam0 == -1)
	{
	...
	if (!func_314(iParam0, sParam1.f_0))
	{
	}
	if (!func_315(iParam0, sParam1.f_1))
	{
	}
}
...
int func_210(int iParam0, int iParam1)
{
	...
	if (!func_317(iParam0, &sVar0))
	{
		return 0;
	}
	bVar58 = false;
	if (!func_317(iParam1, &sVar29))
	{
		bVar58 = true;
	}
	if (bVar58)
	{
		...
		if (!func_319(sVar0, sVar0.f_5, iVar59, 0, 0))
		{
			return 0;
		}
	}
	else if (!func_320(sVar0, sVar29, 0, 0))
	{
		return 0;
	}
	return 1;
...
bool func_221(int iParam0, var uParam1)
{
	...
	*uParam1 = func_343(sVar0, joaat("SLOTID_HORSE_MANE"), 0);
...
bool func_222(int iParam0, var uParam1)
{
	...
	*uParam1 = func_343(sVar0, joaat("SLOTID_HORSE_TAIL"), 0);
	if (!func_230(*uParam1, 0))
	{
		return false;
	}
...
bool func_223(int iParam0, var uParam1)
{
	...
	sVar0 = { func_345() /*4*/ };
	*uParam1 = func_343(sVar0, iParam0, 0);
	if (!func_230(*uParam1, 0))
	{
		return false;
	}
...
{
	if (func_232() == joaat("MPC_PLAYER_TYPE_SP_MARSTON"))
	{
		switch (iParam0)
		{
			case 0:
...
void func_238()
{
	...
	if (func_75() == -1)
	{
		...
		while (iVar4 < 5)
		{
			func_352(&(Global_1946054.f_1497.f_1[iVar0 /*3*/]), iVar0, iVar4);
			func_352(&(Global_1946054.f_1497.f_1[iVar1 /*3*/]), iVar1, iVar4);
			func_352(&(Global_1946054.f_1497.f_1[iVar2 /*3*/]), iVar2, iVar4);
			func_352(&(Global_1946054.f_1497.f_1[iVar3 /*3*/]), iVar3, iVar4);
			iVar4++;
		}
		return;
	}
	...
	while (iVar4 < 5)
	{
		func_353(&(Global_1946054.f_1497.f_1[iVar0 /*3*/]), iVar0, iVar4);
		func_353(&(Global_1946054.f_1497.f_1[iVar1 /*3*/]), iVar1, iVar4);
		func_353(&(Global_1946054.f_1497.f_1[iVar2 /*3*/]), iVar2, iVar4);
		func_353(&(Global_1946054.f_1497.f_1[iVar3 /*3*/]), iVar3, iVar4);
		iVar4++;
	}
}
...
int func_241(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iVar0))
	{
		ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iVar0, func_252(iParam0), BUILTIN::CEIL(fParam1));
		return 1;
	}
	else
	{
...
int func_260(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		if (func_374(Global_1347702[iParam0 /*49*/].f_12, (1 << 21)))
		{
...
struct<5> /*40*/ func_269(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;

	sVar0 = { func_382(bParam1) /*4*/ };
	...
	switch (func_383(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_280(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
			...
			break;
		case joaat("WEAPON"):
			sVar0 = { func_384(bParam1) /*4*/ };
			if (bParam2 && func_385(iParam0, 1))
			{
				sVar5.f_9 = joaat("SLOTID_NONE");
				if (!func_386(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_386(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_387(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_390(iParam0, joaat("CI_CATEGORY_CAMP")))
			{
				sVar0 = { func_280(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("KIT_CAMP"));
			}
			else if (func_390(iParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_280(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("WARDROBE"));
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_391(sVar0, &sVar27, bParam1, 0))
				{
					sVar0.f_4 = 0;
				}
				else
...
bool func_272(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (iParam2 == 39)
	{
		sVar0 = { func_269(iParam0, 1, 0) /*5*/ };
		iParam2 = func_271(func_270(sVar0.f_4), 1);
	}
	if (iParam2 < 0 || iParam2 >= 39)
	{
		return false;
	}
	if (func_393(iParam0, joaat("CI_TAG_ITEM_TALISMAN")) && func_394(&(Global_1946054.f_1378)) >= 2)
	{
		return false;
	}
	if ((func_275((1 << 15)) && iParam2 == 10) && iParam0 != Global_1946054.f_57[iParam2 /*11*/])
	{
	...
	func_399(&(Global_1946054.f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1;
	}
	Global_1946054.f_1378.f_1[iParam2 /*3*/] = iParam0;
	Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1 = func_400(iParam0, iParam2, iParam1, func_75() != -1);
	if (bParam4)
	{
		func_401(&(Global_1946054.f_1378), 1, 3);
	}
	else
	{
		func_401(&(Global_1946054.f_1378), 1, 0);
	}
	if (bParam3)
	{
		iVar6 = 0;
		while (iVar6 < Global_1946054.f_2589)
		{
			if (Global_1946054.f_2589.f_2[iVar6 /*2*/] >= 0 && Global_1946054.f_2589.f_2[iVar6 /*2*/] < 39)
			{
				...
				func_290(func_288(Global_1946054.f_2589.f_2[iVar6 /*2*/], 1), 1, 6);
			}
			iVar6++;
		}
	}
...
void func_276()
{
	...
	func_405((1 << 15));
	func_290(joaat("MP_COMPONENT_TYPE_HEADWEAR"), 8, 6);
}
...
struct<4> /*32*/ func_280(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_282(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}

int func_281(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	sVar0 = { func_280(iParam0, sParam1, iParam5, bParam6) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&sVar0))
	{
		return 0;
	}
	iVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_282(bParam6), &sVar0, false);
	return iVar4;
}
...
{
	return (Global_1946054.f_57[func_271(iParam0, 1) /*11*/].f_10 & iParam1) != 0;
}
...
void func_287(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar0 = 10;
	if (func_285(joaat("MP_COMPONENT_TYPE_HEADWEAR"), 6))
	{
		if (bParam2)
		{
			func_284(iParam0, iVar0, func_75() != -1, 0, 0);
			func_289(joaat("MP_COMPONENT_TYPE_HEADWEAR"), 1, 6);
		}
		else
		{
			return;
	...
	else
	{
		...
		func_290(joaat("MP_COMPONENT_TYPE_HEADWEAR"), 1, 6);
	}
	Global_1946054.f_857++;
	if (!bParam1)
	{
...
{
	Global_1946054.f_57[func_271(iParam0, 1) /*11*/].f_10 |= iParam1;
}
...
int func_300(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, iParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_386(iParam0, &sVar0, iVar5, 0))
			{
				if (func_387(iParam0, &sVar6, iVar5))
				{
					sVar29 = { func_280(iParam0, sVar0, iVar5, 0) /*4*/ };
					func_419(iParam0, &sVar29, &sVar0, 1, joaat("REMOVE_REASON_DEFAULT"), 1, 0);
				}
				else
				{
					iVar28++;
...
int func_303(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_424("ALL WEAPONS", &iVar1, &iVar2, joaat("SLOTID_NONE"), 0))
	{
		sVar23.f_9 = joaat("SLOTID_NONE");
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_425(&sVar4, iVar3, iVar1, iVar2))
			{
			}
			else if (!func_167(sVar4.f_4))
			{
			}
			...
			else if ((!func_423(iParam1, (1 << 9)) && func_426(sVar4.f_4, &uVar19, &sVar23, joaat("SLOTID_WEAPON_0"))) && !sVar23.f_21)
			{
			}
			else if (!bVar18 || WEAPON::IS_PED_CARRYING_WEAPON(Global_35, sVar4.f_4))
			{
				if ((((((WEAPON::_IS_WEAPON_TWO_HANDED(sVar4.f_4) || func_427(sVar4.f_4)) && (!WEAPON::IS_WEAPON_SHOTGUN(sVar4.f_4) || func_423(iParam1, 16))) && (!WEAPON::_IS_WEAPON_SNIPER(sVar4.f_4) || func_423(iParam1, 4))) && (!func_427(sVar4.f_4) || func_423(iParam1, 8))) && (!WEAPON::IS_WEAPON_REPEATER(sVar4.f_4) || !func_423(iParam1, (1 << 23)))) && (!WEAPON::IS_WEAPON_RIFLE(sVar4.f_4) || !func_423(iParam1, (1 << 20))))
				{
	...
	else if (!func_423(iParam1, (1 << 9)) && !func_423(iParam1, (1 << 10)))
	{
		iParam1 |= (1 << 9);
...
void func_304(int iParam0, float fParam1)
{
	...
	{
		bVar1 = fParam1 != 0.0f;
		sVar2 = func_429(fParam1 < 0.0f, "rpg_cold", "rpg_hot");
		func_430(1, bVar1, 1, sVar2);
		func_431(!bVar1, fParam1 < 0.0f, bVar1);
...
bool func_314(int iParam0, int iParam1)
{
	...
	sVar29 = { func_280(iParam1, sVar0, joaat("SLOTID_HORSE_MANE"), 0) /*4*/ };
	return func_436(sVar29, 1);
}
...
bool func_315(int iParam0, int iParam1)
{
	...
	sVar29 = { func_280(iParam1, sVar0, joaat("SLOTID_HORSE_TAIL"), 0) /*4*/ };
	return func_436(sVar29, 1);
}
...
bool func_317(int iParam0, var uParam1)
{
	...
	sVar15 = { func_382(0) /*4*/ };
	if (!func_438(sVar15, iVar0, &sVar1, 0, 0))
	{
		return false;
	}
	if (!func_439(&sVar1, uParam1))
	{
		return false;
	}
	return true;
...
bool func_319(struct<4> /*32*/ sParam0, struct<4> /*32*/ sParam4, int iParam8, bool bParam9, bool bParam10)
{
	struct<12> /*96*/ sVar0;
	struct<4> /*32*/ sVar14;
	...
	{
		return func_440(sParam0, sParam4, iParam8, 1, bParam9, 1) != -1;
	}
	...
	sVar0.f_9 = joaat("SLOTID_NONE");
	if (!func_391(sParam0, &sVar0, 0, 0))
	{
		return false;
	}
	if (func_441(&(sVar0.f_5), &sParam4) && sVar0.f_9 == iParam8)
	{
		return true;
	}
	...
	if (!INVENTORY::_INVENTORY_MOVE_INVENTORY_ITEM(func_282(0), &sParam0, &sParam4, iParam8, sVar0.f_11, &sVar14))
	{
		return false;
	}
	if (bParam9)
	{
		if (!func_436(sVar14, 1))
		{
		}
	}
	return true;
...
bool func_320(struct<4> /*32*/ sParam0, struct<4> /*32*/ sParam4, int iParam8, bool bParam9)
{
	struct<11> /*88*/ sVar0;
	struct<11> /*88*/ sVar14;
	int iVar28;
	...
	if (!func_420(bParam9))
	{
		return func_442(sParam0, sParam4, iParam8, 1) != -1;
	}
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&sParam0) || !INVENTORY::_INVENTORY_IS_GUID_VALID(&sParam4))
	{
		return false;
	}
	if (func_441(&sParam0, &sParam4))
	{
		return false;
	}
	sVar0.f_9 = joaat("SLOTID_NONE");
	sVar14.f_9 = joaat("SLOTID_NONE");
	if (!func_391(sParam0, &sVar0, bParam9, 1) || !func_391(sParam4, &sVar14, bParam9, 1))
	{
		return false;
	}
	if (func_441(&(sVar0.f_5), &(sVar14.f_5)) && sVar0.f_9 == sVar14.f_9)
	{
		return false;
	}
...
int func_343(struct<4> /*32*/ sParam0, int iParam4, int iParam5)
{
	struct<10> /*80*/ sVar0;

	sVar0.f_9 = joaat("SLOTID_NONE");
	if (func_446(sParam0, iParam4, &sVar0, iParam5))
	{
		return sVar0.f_4;
	}
	return 0;
...
struct<4> /*32*/ func_345()
{
	struct<4> /*32*/ sVar0;

	sVar0 = { func_382(0) /*4*/ };
	return func_280(856287005, sVar0, joaat("SLOTID_CARRIED_HORSE_EQUIPMENT"), 0);
}
...
void func_357(int iParam0, int iParam1, float fParam2)
{
	...
	{
		PED::_SET_PED_BLACKBOARD_FLOAT(iParam0, func_451(iParam1), fParam2, -1);
	}
}
...
{
	return ((BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31) * func_454(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
bool func_369(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((Global_1898164.f_163 && !func_464(iParam0, 1)) || func_465((1 << 15)))
	{
		if (!func_464(iParam0, (1 << 18)) || !Global_1905944.f_5696)
		{
			return false;
		}
	}
...
struct<4> /*32*/ func_382(bool bParam0)
{
...
struct<4> /*32*/ func_384(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_280(joaat("CARRIED_WEAPONS"), func_382(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_280(joaat("CARRIED_WEAPONS"), func_382(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_280(joaat("CARRIED_WEAPONS"), func_382(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_385(int iParam0, bool bParam1)
{
	if (func_389(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
struct<4> /*32*/ func_388(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_280(joaat("EMOTE_ITEM"), func_382(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_280(joaat("EMOTE_ITEM"), func_382(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
bool func_391(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_282(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
void func_399(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_286(iParam2, (1 << 16)) && uParam0->f_1[iVar1 /*3*/] == -452402570)
	{
	...
	if (func_479(joaat("MP_COMPONENT_TYPE_LOADOUT_9")) && func_286(iParam2, (1 << 19)))
	{
		iVar1 = 33;
		uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
		uParam0->f_1[iVar1 /*3*/].f_1 = 0;
		...
		case joaat("CI_CATEGORY_WARDROBE_SHIRT"):
			...
			else
			{
				...
				if (iParam1 == Global_1946054.f_57[iParam2 /*11*/])
				{
					...
					iVar1 = 35;
					if (joaat("CI_CATEGORY_WARDROBE_SPATS") == func_389(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_481(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && joaat("CI_CATEGORY_WARDROBE_SPATS") == func_389(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946054.f_57[iParam2 /*11*/] && (func_481(Global_1946054.f_1497.f_1[iVar1 /*3*/]) || func_393(Global_1946054.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946054.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
			...
			switch (func_389(iParam1))
			{
				case joaat("CI_CATEGORY_WARDROBE_MASK"):
					iVar1 = 10;
					if (joaat("CI_CATEGORY_WARDROBE_BIG_MASK") == func_389(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				case joaat("CI_CATEGORY_WARDROBE_BIG_MASK"):
					iVar1 = 12;
					if (joaat("CI_CATEGORY_WARDROBE_MASK") == func_389(uParam0->f_1[iVar1 /*3*/]) || func_393(uParam0->f_1[iVar1 /*3*/], joaat("CI_TAG_ITEM_TALISMAN")))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
void func_401(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_285(iVar5, 6) || uParam0->f_1[iVar0 /*3*/] == Global_1946054.f_57[iVar0 /*11*/])
			{
			}
			else
			{
...
void func_403(struct<4> /*32*/ sParam0)
{
	...
	switch (sParam0.f_0)
	{
		...
		case 35:
		case 36:
			func_279(sParam0.f_0, sParam0.f_1, sParam0.f_2);
			break;
	}
}
...
void func_407(struct<4> /*32*/ sParam0)
{
	int iVar0;
	int iVar1;
...
void func_409(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME(*uParam0, func_494(func_493(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_177())
	{
...
bool func_419(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	sVar0.f_9 = joaat("SLOTID_NONE");
	if (!func_391(*uParam1, &sVar0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_282(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
void func_422(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_499(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_282(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_426(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_282(0);
	*uParam1 = { func_280(iParam0, func_384(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
...
bool func_436(struct<4> /*32*/ sParam0, bool bParam4)
{
	struct<11> /*88*/ sVar0;

	if (!func_420(0))
	{
		return func_503(sParam0, bParam4, 1) != -1;
	}
	...
	if (!INVENTORY::_INVENTORY_EQUIP_ITEM_WITH_GUID(func_282(0), &sParam0, bParam4))
	{
		return false;
	}
	return true;
...
bool func_439(var uParam0, var uParam1)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_282(0), uParam0, uParam1, 29, 1))
	{
		return false;
	}
	return true;
...
int func_440(struct<4> /*32*/ sParam0, struct<4> /*32*/ sParam4, int iParam8, bool bParam9, bool bParam10, bool bParam11)
{
	struct<12> /*96*/ sVar0;
	int iVar14;
	int iVar15;
	...
	iVar14 = func_281(sVar0.f_4, sParam4, iParam8, 0);
	...
	sVar16 = { func_505(&sVar0) /*17*/ };
	sVar16.f_4 = { sParam4 /*4*/ };
	sVar16.f_11 = iParam8;
	sVar16.f_10 = bParam10;
	iVar33 = func_506(joaat("MOVEITEMS"), &sVar16, bParam9);
	if (iVar33 == -1)
	{
		return -1;
	}
...
int func_442(struct<4> /*32*/ sParam0, struct<4> /*32*/ sParam4, int iParam8, bool bParam9)
{
	struct<11> /*88*/ sVar0;
	struct<11> /*88*/ sVar14;
	...
	sVar0.f_9 = joaat("SLOTID_NONE");
	sVar14.f_9 = joaat("SLOTID_NONE");
	if (!func_391(sParam0, &sVar0, 1, 0) || !func_391(sParam4, &sVar14, 1, 0))
	{
		return -1;
	}
	if (func_441(&(sVar0.f_5), &(sVar14.f_5)) && sVar0.f_9 == sVar14.f_9)
	...
	if (bParam9)
	{
		...
		{
			if (func_507(iVar62, joaat("MOVEITEMS"), &sVar28) && func_507(iVar62, joaat("MOVEITEMS"), &sVar45))
			{
	...
	{
		iVar62 = func_506(joaat("MOVEITEMS"), &sVar28, 0);
		iVar62 = func_506(joaat("MOVEITEMS"), &sVar45, 0);
	}
	return iVar62;
}
...
bool func_446(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_EQUIPPED_IN_SLOT_BY_REF(func_282(bParam6), &uParam0, iParam4, &sVar0))
	{
		return false;
	}
	if (!func_391(sVar0, uParam5, bParam6, 0))
	{
		return false;
	}
	return true;
...
void func_449(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, int iParam5)
{
	...
	iVar0 = func_509(BUILTIN::TO_FLOAT(*uParam0), fVar3);
	iVar1 = func_510(BUILTIN::TO_FLOAT(*uParam1), fVar3);
	iVar2 = func_511(BUILTIN::TO_FLOAT(*uParam2), fVar3);
	*uParam0 /= iParam5;
	*uParam1 /= iParam5;
	*uParam2 /= iParam5;
	*uParam3 /= iParam5;
...
bool func_463(int iParam0)
{
	...
	if (!func_464(iParam0, (1 << 16)) && !func_464(iParam0, (1 << 15)))
	{
		return false;
	}
	iVar0 = 0;
	while (iVar0 < Global_40.f_7756)
	{
		if (Global_40.f_7756[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			if (iVar2 < 1800 && func_464(iParam0, (1 << 15)))
			{
				return true;
			}
		}
...
void func_468(int iParam0)
{
	...
	if ((Global_1347702[iParam0 /*49*/].f_13 & 2) == 0)
	{
		...
		while (iVar1 <= 4)
		{
			...
			{
				func_513(&iVar0, func_512(Global_1347702[iParam0 /*49*/].f_29[iVar1]));
			}
			iVar1++;
		}
		if (iVar0 == 0)
		...
		{
			if (func_515(iVar0, Global_1347702[iParam0 /*49*/].f_15, 1, Global_1347702[iParam0 /*49*/].f_27, func_514()))
			{
				func_262(&(Global_1347702[iParam0 /*49*/].f_13), 2);
			}
		}
...
{
	*uParam3 = func_516(iParam0);
	*uParam1 = func_517(iParam0);
	*uParam2 = func_518(iParam0);
}

struct<4> /*32*/ func_476()
{
	struct<4> /*32*/ sVar0;
...
void func_477(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_520(&(uParam0->f_2[iVar0 /*2*/]), 2) || uParam0->f_2[iVar0 /*2*/] == iParam1) || uParam0->f_2[iVar0 /*2*/] == 39)
			{
				uParam0->f_2[iVar0 /*2*/] = { sVar2 /*2*/ };
			}
			else
			{
				if (func_520(&(uParam0->f_2[iVar0 /*2*/]), 1))
				{
					func_521(&(uParam0->f_2[iVar0 /*2*/]), 2, 6);
				}
...
int func_484(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam0 == Global_1946054.f_57[func_271(iParam1, 1) /*11*/])
	{
		return 0;
	}
	iVar0 = 0;
...
float func_500()
{
	...
	func_534(3, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
	func_535(3, fVar9, fVar9 > 100.0f);
	return func_142(fVar7, -100.0f, 100.0f);
}
...
float func_501()
{
	...
	fVar9 = (100.0f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100.0f) / 200.0f);
	func_534(2, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
	func_535(2, fVar9, fVar9 > 100.0f);
	return func_142(fVar7, -100.0f, 100.0f);
}
...
float func_502()
{
	...
	fVar9 = (100.0f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100.0f) / 200.0f);
	func_534(1, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
	func_535(1, fVar9, fVar9 > 100.0f);
...
int func_503(struct<4> /*32*/ sParam0, bool bParam4, bool bParam5)
{
	int iVar0;
	struct<11> /*88*/ sVar1;
	int iVar15;
	...
	iVar15 = func_383(sVar1.f_4);
	if (iVar15 == joaat("HORSE"))
	{
		sVar16 = { func_538(sParam0, 1) /*29*/ };
		sVar16.f_10 = bParam4;
		iVar0 = func_539(joaat("UPDATE"), &sVar16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		sVar45 = { func_540(sParam0, 1) /*18*/ };
		sVar45.f_10 = bParam4;
		iVar0 = func_541(joaat("UPDATE"), &sVar45, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		sVar63 = { func_505(&sVar1) /*17*/ };
		sVar63.f_10 = bParam4;
		iVar0 = func_506(joaat("UPDATE"), &sVar63, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
{
	return INVENTORY::INVENTORY_GET_CHILDREN_IN_SLOT_COUNT(func_282(bParam2), uParam0, iParam1);
}

struct<17> /*136*/ func_505(var uParam0)
{
	struct<17> /*136*/ sVar0;
...
int func_506(int iParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		{
			if (func_507(iVar0, iParam0, uParam1))
			{
...
int func_511(float fParam0, float fParam1)
{
	return BUILTIN::FLOOR((((fParam0 / fParam1) - BUILTIN::TO_FLOAT(BUILTIN::FLOOR((fParam0 / fParam1)))) * 60.0f));
}
...
bool func_526(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_549(&(Global_1109000.f_4), iVar0, 5);
	}
	if (iParam1 == func_550())
	{
		return func_549(&(Global_1109000.f_4), iVar0, 5);
	...
	{
		return func_549(&(Global_1108108[iParam1 /*27*/].f_4), iVar0, 5);
	}
	return false;
}
...
void func_535(int iParam0, float fParam1, bool bParam2)
{
	char* sVar0;
...
struct<29> /*232*/ func_538(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<29> /*232*/ sVar0;
	...
	sVar29.f_9 = joaat("SLOTID_NONE");
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_282(bParam4), &uParam0, &sVar29, 29, 1))
	{
		return sVar0;
	}
	sVar0 = { func_505(&sVar29) /*17*/ };
...
int func_539(int iParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_START(&iVar0, joaat("BASKET"), iParam0))
		{
			if (func_554(iVar0, iParam0, uParam1))
			{
				if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_CHECKOUT(iVar0))
				{
					func_508(iVar0, 1);
...
struct<18> /*144*/ func_540(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<18> /*144*/ sVar0;
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_282(bParam4), &uParam0, &sVar18, 15, 1))
	{
		return sVar0;
	}
	sVar0 = { func_505(&sVar18) /*17*/ };
...
int func_541(int iParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_START(&iVar0, joaat("BASKET"), iParam0))
		{
			if (func_555(iVar0, iParam0, uParam1))
			{
				if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_CHECKOUT(iVar0))
				{
					func_508(iVar0, 1);
...
bool func_543(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_258(iVar0) && func_374(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
