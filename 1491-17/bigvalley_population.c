...
void func_2()
{
	...
	vVar0 = { fLocal_26, fLocal_27, fLocal_28 /*3*/ };
	vVar3 = { fLocal_29, fLocal_30, fLocal_31 /*3*/ };
	FLOCK::_0xF2CCA7B68CFAB2B9(joaat("SPECIES_BIRD_CROW"), -1927.953f, 412.0278f, 180.0f, vVar0, vVar3, 9.5f, 50.0f, 1.0f, 6.0f);
}

void func_3()
{
	iLocal_32 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volFortRiggsRestriction");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_32, -1560.0f, -935.0f, 85.0f, 0.0f, 0.0f, 0.0f, 50.0f, 55.0f, 20.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_32, -1567.5f, -907.5f, 85.0f, 0.0f, 0.0f, 40.0f, 50.0f, 40.0f, 20.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_32, -1605.0f, -882.5f, 85.0f, 0.0f, 0.0f, 0.0f, 50.0f, 30.0f, 20.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_32, -1577.0f, -885.5f, 85.0f, 0.0f, 0.0f, -25.5f, 21.0f, 30.0f, 20.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_32, -1602.5f, -917.5f, 85.0f, 0.0f, 0.0f, 0.0f, 35.0f, 40.0f, 20.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_32, -1592.5f, -935.5f, 85.0f, 0.0f, 0.0f, 55.0f, 35.0f, 43.0f, 20.0f);
	func_9(iLocal_32, 0, 0, 1);
	iLocal_33 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-2212.354f, 708.9626f, 124.4049f, 0.0f, 0.0f, 11.49984f, 68.16475f, 52.09315f, 21.00951f, "m_volHangingDogRanchRestriction");
	func_9(iLocal_33, 0, 0, 1);
	iLocal_34 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-865.0f, -760.0f, 75.0f, 0.0f, 0.0f, 0.0f, 60.0f, 60.0f, 30.0f, "m_volLoneMuleSteadRestriction");
	func_9(iLocal_34, 0, 0, 1);
	iLocal_35 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1898.0f, -238.5f, 188.0f, 0.0f, 0.0f, 16.5f, 14.0f, 59.0f, 24.5f, "m_volMountainRiverRestriction");
	func_9(iLocal_35, 0, 0, 1);
	iLocal_36 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-1897.5f, 1370.0f, 215.0f, 0.0f, 0.0f, 0.0f, 75.0f, 75.0f, 25.0f, "m_volNorthernMiningTownRestriction");
	func_9(iLocal_36, 0, 0, 1);
	iLocal_37 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-617.0f, -40.2f, 80.0f, 0.0f, 0.0f, 0.0f, 43.7f, 43.7f, 13.0f, "m_volPaintedSkyRestriction");
	func_9(iLocal_37, 0, 0, 1);
	iLocal_38 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-1825.0f, 655.0f, 120.0f, 0.0f, 0.0f, 0.0f, 45.0f, 45.0f, 20.0f, "m_volWatsonsCabinRestriction");
	func_9(iLocal_38, 0, 0, 1);
	iLocal_39 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1554.0f, 257.4f, 116.0f, 0.0f, 0.0f, 14.0f, 45.0f, 45.0f, 25.0f, "m_volShepherdsRiseRestriction");
	func_9(iLocal_39, 0, 0, 1);
	iLocal_40 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volStrawberryRestriction");
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_40, -1820.0f, -365.0f, 170.0f, 0.0f, 0.0f, 0.0f, 80.0f, 80.0f, 50.0f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_40, -1765.0f, -420.0f, 170.0f, 0.0f, 0.0f, 0.0f, 80.0f, 80.0f, 50.0f);
	func_10(iLocal_40, 1);
	iLocal_41 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-1813.34f, -580.26f, 150.0f, 0.0f, 0.0f, 65.0f, 52.0f, 31.0f, 25.0f, "m_volStrawberryHorseShopRestriction");
	func_10(iLocal_41, 1);
	if (func_11())
	{
		iLocal_42 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volPronghornRanchRestriction");
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_42, -2530.598f, 340.663f, 153.0f, 0.0f, 0.0f, 0.0f, 22.0f, 22.0f, 15.0f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_42, -2530.057f, 471.4158f, 153.0f, 0.0f, 0.0f, 0.0f, 30.0f, 30.0f, 15.0f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_42, -2590.521f, 470.2267f, 153.0f, 0.0f, 0.0f, 0.0f, 30.0f, 30.0f, 15.0f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_42, -2572.795f, 343.0885f, 153.0f, 0.0f, 0.0f, 0.0f, 31.0f, 31.0f, 15.0f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_42, -2541.964f, 408.2656f, 153.0f, 0.0f, 0.0f, -3.75f, 75.0f, 132.0f, 30.0f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_42, -2574.994f, 411.635f, 153.0f, 0.0f, 0.0f, 7.5f, 75.0f, 128.0f, 30.0f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_42, -2555.338f, 340.0247f, 153.0f, 0.0f, 0.0f, 9.25f, 43.0f, 50.0f, 30.0f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_42, -2559.616f, 476.0391f, 153.0f, 0.0f, 0.0f, 1.5f, 61.0f, 50.0f, 30.0f);
		func_9(iLocal_42, 0, 0, 1);
	}
	iLocal_43 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-1301.288f, 403.2579f, 102.4782f, 0.0f, 0.0f, -27.0f, 15.0f, 25.0f, 15.0f, "m_volWallaceStationRestriction");
	func_9(iLocal_43, 0, 0, 1);
	iLocal_44 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volFlatIronLakeIslandRestriction");
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_44, 237.213f, -769.7713f, 42.9804f, 0.0f, 0.0f, 0.0f, 156.4307f, 81.38799f, 25.72252f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_44, -401.9616f, -1012.638f, 42.9804f, 0.0f, 0.0f, -51.00734f, 240.5335f, 103.688f, 24.89919f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_44, 440.3216f, -1462.027f, 55.90892f, 0.0f, 0.0f, 13.40226f, 421.2939f, 982.8425f, 99.70844f);
	func_12(iLocal_44, 0, 0, 1);
	iLocal_45 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-2172.987f, -253.5375f, 195.0f, 0.0f, 0.0f, -6.0f, 11.0f, 15.0f, 10.0f, "m_volRockCarvingsRestriction");
	func_9(iLocal_45, 0, 0, 1);
	iLocal_46 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volBardsCrossingRestriction");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_46, -730.6474f, -548.0654f, 77.02292f, 0.0f, 0.0f, 27f, 353.0691f, 8.967957f, 13.35221f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_46, -892.4706f, -627.4682f, 77.26994f, 0.0f, 0.0f, 18.91964f, 20.99991f, 7.632857f, 11.3815f);
...
void func_7()
{
	...
	if (func_27(8))
	{
		iVar0 = PERSCHAR::_0x112DDF56300BC6E5(joaat("BGV_PAI_RANCHHAND_01"));
		iVar1 = PERSCHAR::_0x112DDF56300BC6E5(joaat("PAI_RANCHHAND_02"));
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(iVar0) || !PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(iVar1))
		{
			return;
		}
		if (PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar0) && PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar1))
		{
			if (!func_28(joaat("WS_PAI_CHIMNEY_OFF")))
			{
				if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(71064384, Global_36))
				{
					func_29(joaat("WS_PAI_CHIMNEY_OFF"));
				}
			}
		}
		else if (func_28(joaat("WS_PAI_CHIMNEY_OFF")))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(71064384, Global_36))
			{
				func_30(joaat("WS_PAI_CHIMNEY_OFF"));
			}
		}
	}
	else
	{
		iVar2 = PERSCHAR::_0x112DDF56300BC6E5(joaat("PAI_RANCHHAND_02"));
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(iVar2))
		{
			return;
		}
		if (PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar2))
		{
			if (!func_28(joaat("WS_PAI_CHIMNEY_OFF")))
			{
				if (!STREAMING::_IS_POSITION_INSIDE_IPL_STREAMING_EXTENTS(71064384, Global_36))
...
void func_14()
{
	...
	iVar0 = 7;
	iLocal_24[0] = VOLUME::_CREATE_VOLUME_LOCK(-771.731f, -7.501f, 75.411f, 8.0f, iVar0, (1 << 14));
}
