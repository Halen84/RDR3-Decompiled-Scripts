...
bool func_72(var uParam0)
{
	...
	switch (func_19(uParam0))
	{
		...
		case 14:
			...
			func_156(uParam0, iLocal_14, 2, joaat("WORLD_CAMP_FIRE_SIT_GROUND"), "WORLD_CAMP_FIRE_SIT_GROUND_MALE_C", iVar0, 1, -1073741824, 1065353216, 1);
			break;
		default:
			return false;
	}
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_251(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
