...
bool func_72(var uParam0)
{
	switch (func_149(uParam0))
	{
		case 1:
			...
			break;
		case 2:
			func_151(uParam0, 657.166f, -1243.321f, 43.13f, 0.0f, 0.0f, -34.34f);
			break;
		default:
			return false;
	}
	...
	func_154(uParam0, 0.8755f, 1.4219f, 0.9428f, 0.0f, 2.5f, 3.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	func_155(uParam0, 1);
	func_156(uParam0, joaat("P_RAG02X"), 0.0f, 0.0f, 0.0f, "RAG", 0, 1, 1);
	...
	sLocal_18 = { func_160(uParam0, 0.876f, 1.422f, 0.943f, -115.92f, 7.0f, 0.6f, 0.6f) /*10*/ };
	func_161(uParam0, 1);
...
bool func_93(var uParam0)
{
	...
	{
		TASK::TASK_START_SCENARIO_IN_PLACE_HASH(func_48(uParam0, iLocal_15), joaat("STAND"), 25000, false, 0, -1.0f, false);
	}
	return true;
}
