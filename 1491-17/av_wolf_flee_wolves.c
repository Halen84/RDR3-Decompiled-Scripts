...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_48(uParam0, 4, "carcass", joaat("A_C_DEER_01"), OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.0f, 0.3f, 0.0f), (vParam4.z - 270.0f), 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
