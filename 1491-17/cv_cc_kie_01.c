...
bool func_77(var uParam0)
{
	...
	func_166(uParam0, iLocal_93, 2, joaat("WORLD_CAMP_KIERAN_TREE_TIED"), "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1, -1.0f, 1065353216, 1);
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_273(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
...
void func_323(var uParam0, var uParam1)
{
	...
	func_381(Global_35, iVar0, &sVar1, 0.0f, 0.0f, 0.0f, 0, 0, 1, 1069547520, -1082130432, 1073069561, 1056964608, 1092616192, -1, 1, 0, 0, 0, 1);
	func_222(1);
}
...
void func_324(var uParam0, var uParam1)
{
	...
	sVar1.f_19 = -1;
	sVar1.f_26 = -1082130432;
	func_382(iVar0, Global_35, &sVar1, -1082130432, 0, 0, uParam1->f_4, uParam1->f_5, 1, uParam1->f_26, 0, 0, 1069547520, (1 << 30), 1050253722, 1067030938, 0, 0, -1, 1, -1082130432, -1082130432, 1);
}
...
int func_374(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_431(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
bool func_390(var uParam0, var uParam1)
{
	...
	if (!func_395(uParam1->f_47.f_3))
	{
		uParam1->f_47.f_3 = func_436("INTERACT_WNT_DISMISS", joaat("INPUT_INTERACT_LOCKON_NEG"), iVar0, 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
...
int func_436(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_474(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_475(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
