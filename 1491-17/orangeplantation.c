		...
		if (MISC::GET_GAME_TIMER() > iLocal_85)
		{
			...
			switch (iLocal_84)
			{
				...
				case 1:
					...
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_86));
				...
				case 6:
					if (func_7(func_6(iLocal_86)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_86 /*35*/].f_11 > 0.0f)
							{
								PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1888801[iLocal_86 /*35*/].f_11);
							}
							Jump @785; // curOff = 766
							func_42(iVar0);
							iVar0 = (1 + iVar0);
						...
						{
							PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1888801[iLocal_86 /*35*/].f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	...
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2014.568f, -844.9777f, 44.706f, 0.0f, 0.0f, 0.0f, 69.6883f, 50.95198f, 16.54283f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 1994.893f, -813.8496f, 44.706f, 0.0f, 0.0f, 32.02662f, 49.04269f, 28.47917f, 16.54283f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 1968.462f, -859.535f, 44.706f, 0.0f, 0.0f, -0.583631f, 30.73095f, 51.93652f, 16.54283f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2050.994f, -804.7936f, 44.706f, 0.0f, 0.0f, 39.76538f, 38.38671f, 59.01843f, 16.54283f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2076.114f, -860.0187f, 44.706f, 0.0f, 0.0f, 0.0f, 38.38671f, 37.38729f, 16.54283f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2012.807f, -764.5793f, 44.706f, 0.0f, 0.0f, 39.76538f, 11.55689f, 14.41201f, 15.9332f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2040.947f, -887.8384f, 44.706f, 0.0f, 0.0f, 2.644386f, 138.1747f, 21.08713f, 16.54283f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2099.362f, -835.4238f, 44.706f, 0.0f, 0.0f, 38.97644f, 8.372574f, 17.93935f, 18.54283f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_14, 2106.672f, -874.8062f, 44.706f, 0.0f, 0.0f, 173.7751f, 15.22373f, 31.89837f, 18.54283f);
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		iLocal_17 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Orange Plantation - m_volThreat Agg");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2065.472f, -851.4658f, 42.55719f, 0.0f, 0.0f, 0.0f, 19.02366f, 13.64085f, 16.67954f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2019.272f, -774.1213f, 41.40026f, 0.0f, 0.0f, 37.13808f, 9.83179f, 10.20259f, 16.67954f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2013.173f, -774.8469f, 41.40026f, 0.0f, 0.0f, 37.13808f, 4.350712f, 4.302257f, 16.67954f);
		iLocal_15 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Orange Plantation - m_volRestricted Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_15, iLocal_17);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 2076.114f, -860.0187f, 44.706f, 0.0f, 0.0f, 0.0f, 36.89741f, 35.70032f, 15.9332f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 2050.994f, -804.7936f, 44.706f, 0.0f, 0.0f, 39.76539f, 36.89741f, 57.33146f, 15.9332f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 2012.807f, -764.5793f, 44.706f, 0.0f, 0.0f, 39.76538f, 10.22549f, 13.5511f, 15.9332f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 1998.531f, -853.2407f, 44.706f, 0.0f, 0.0f, 0.0f, 45.40543f, 35.23671f, 15.9332f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 2099.362f, -835.4238f, 44.706f, 0.0f, 0.0f, 38.97644f, 6.372574f, 15.93935f, 16.54283f);
		iLocal_16 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Orange Plantation - m_volWarning Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_16, iLocal_15);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 2014.568f, -844.9777f, 44.706f, 0.0f, 0.0f, 0.0f, 68.19901f, 49.26501f, 15.9332f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 1968.462f, -859.535f, 44.706f, 0.0f, 0.0f, -0.583632f, 29.24165f, 50.24955f, 15.9332f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 1994.893f, -813.8496f, 44.706f, 0.0f, 0.0f, 32.02662f, 47.55339f, 26.7922f, 15.9332f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 2040.947f, -887.8384f, 44.706f, 0.0f, 0.0f, 2.644384f, 136.6854f, 19.40016f, 15.9332f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 2106.672f, -874.8062f, 44.706f, 0.0f, 0.0f, 173.7751f, 13.22373f, 29.89837f, 16.54283f);
		sLocal_18 = "ORANGE_PLANTATION";
		LAW::_CREATE_GUARD_ZONE(sLocal_18);
		LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_START(sLocal_18, iLocal_14);
		LAW::_SET_GUARD_ZONE_VOLUME_RESTRICTED(sLocal_18, iLocal_15);
		LAW::_SET_GUARD_ZONE_VOLUME_WARNING(sLocal_18, iLocal_16);
		LAW::_SET_GUARD_ZONE_VOLUME_THREAT(sLocal_18, iLocal_17);
		LAW::_SET_GUARD_ZONE_POSITION(sLocal_18, 2066.902f, -851.1766f, 43.3946f);
		LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_END(sLocal_18, iLocal_14);
	}
	return true;
}
...
void func_14(int iParam0)
{
	...
	if (func_20() == -1)
	{
		...
		func_46(&uLocal_59, 947, 5, "", joaat("CHUCKWAGON000X"), 2009.136f, -822.2015f, 42.3163f, -78.0f, joaat("PG_DELIVERY_ORANGE01X"), 0);
	}
}
...
void func_39(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0.0f, 0.0f, 0.0f) <= 5.0f || func_56(Global_1935630, (1 << 14))) || func_56(Global_1935630, (1 << 23)))
	{
		return;
	}
...
bool func_58()
{
	return func_56(Global_1935630, (1 << 12));
}
...
void func_63(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_52(iParam0) && func_80(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
...
struct<8> /*64*/ func_81(char* sParam0)
{
	char cVar0[64];
...
bool func_96(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_11))
	{
		func_141(uParam0->f_13, 3.0f, 1, 0);
...
char* func_115(char* sParam0, int iParam1)
{
	...
	return func_150(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
void func_132(int iParam0)
{
	...
	func_159(iParam0, (1 << 13));
	func_159(iParam0, (1 << 14));
	func_159(iParam0, (1 << 15));
	func_159(iParam0, (1 << 17));
	func_159(iParam0, (1 << 24));
	func_159(iParam0, (1 << 19));
	func_159(iParam0, (1 << 20));
...
bool func_144(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_173(iVar0) && func_174(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_162(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		{
			func_185(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_184(iParam0, (1 << 10)))
	{
		func_186(iParam0, (1 << 10));
		INVENTORY::_0x9B4E793B1CB6550A();
	}
	func_187(iParam0);
}
...
bool func_176(Vector3 vParam0, int iParam3)
{
	...
	func_192(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_193(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
