...
bool func_1(var uParam0)
{
	...
	if (func_8(4))
	{
		...
		{
			func_10(uParam0->f_107[iLocal_15 /*113*/].f_1, 0, 0, 0, -1082130432, 1, 1, 0, 0, 0, 0);
		}
	}
	return true;
}
		...
		else if (func_49(uParam0->f_107[iVar0 /*113*/].f_7))
		{
			...
			else
			{
				...
				if (func_49(uParam0->f_107[iVar0 /*113*/].f_1))
				{
					...
					{
						func_10(uParam0->f_107[iVar0 /*113*/].f_1, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
					}
				}
			}
			iVar0++;
...
bool func_104(var uParam0)
{
	...
	{
		iLocal_29 = func_207("VIG_JOIN_CONVERSATION", joaat("INPUT_CONTEXT_Y"), vLocal_32, 5.0f, 3, 0, 0, 0, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0);
	}
	if (!MAP::DOES_BLIP_EXIST(iLocal_30))
	{
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_270(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
...
void func_319(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		...
		{
			func_10(uParam0->f_107[iParam1 /*113*/].f_1, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
		}
	}
}
...
int func_396(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_429(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
void func_419(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_464(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_464(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
	...
	switch (func_503(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_505(iParam0, 1))
			{
				...
				if (!func_493(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_493(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_494(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
