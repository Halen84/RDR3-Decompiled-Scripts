			...
			if (!func_60(uParam0->f_20[0 /*14*/], joaat("SCRIPT_TASK_LEAD_AND_CONVERSE")))
			{
				if (iLocal_74 < sLocal_51.f_0)
				{
					if (!func_7(sLocal_51[iLocal_74 /*11*/].f_1))
					{
						TASK::CLEAR_PED_TASKS(uParam0->f_20[0 /*14*/], true, false);
						TASK::CLEAR_PED_TASKS(uParam0->f_20[1 /*14*/], true, false);
						TASK::TASK_LEAD_AND_CONVERSE(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], &(sLocal_51[iLocal_74 /*11*/]), 1, 5.0f, 2.5f, 1.6f, 1092616192, 1.0f);
...
void func_102(int iParam0, Vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_117(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
