...
bool func_72(var uParam0)
{
	...
	func_156(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_STAND_WAITING"), 0, -1, 1, 45.0f, 1065353216, 1);
	func_157(uParam0, iLocal_14, 3, 0);
	func_158(uParam0, iLocal_14, 2, 1, 0, 0, 0);
	func_159(uParam0, iLocal_14, 1);
	func_156(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SIT_GROUND"), 0, -1, 1, 55.0f, 1065353216, 1);
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_259(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
...
int func_352(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_391(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
struct<5> /*40*/ func_477(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_489(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_481(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_491(iParam0, 1))
			{
				...
				if (!func_479(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_479(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_480(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_481(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
