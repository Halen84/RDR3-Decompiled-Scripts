...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			break;
		case 2:
			func_150(uParam0, 672.4047f, -1259.892f, 42.9838f, 0.0f, 0.0f, 105.0f);
			break;
		case 3:
			func_150(uParam0, 1877.057f, -1869.943f, 41.8052f, 0.0f, 0.0f, 172.5f);
			break;
		default:
			return false;
	}
	...
	func_152(uParam0, -0.56f, -0.42f, 1.0f, 95.04f, 4.0f, 6.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	func_153(uParam0, joaat("P_CS_HORSEGELDING01X"), 0.0f, 0.0f, 0.0f, "CLAMP", 0, 1, 1);
	...
	sLocal_19 = { func_158(uParam0, -2.7071f, -1.4956f, 1.1086f, -36.36f, 8.0f, 0.5f, 0.5f) /*10*/ };
	return true;
}
