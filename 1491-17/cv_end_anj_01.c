...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, joaat("P_BASKET06X"), 0.0f, 0.0f, 0.0f, "BASKET", 0, 0, 1);
...
int func_350(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_389(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
