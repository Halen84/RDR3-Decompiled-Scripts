...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 4.4f, -8.9625f, 0.0f, 0.0f, 1.2f, 1.2f, 4.0f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, 0.9625f, -0.5f, 0.0f, 0.0f, 1.87f, 1.87f, 4.0f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	func_152(uParam0, 0.56f, -0.96f, 1.0325f, 0.0f, 0.8f, 0.8f, 2.0f, joaat("VOLCYLINDER"), 1);
	iLocal_51 = func_153(uParam0, joaat("P_CS_LEDGER01X"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 1, 1);
	func_153(uParam0, joaat("P_CIGARLIT01X"), 0.0f, 0.0f, 0.0f, "CIGAR", 0, 1, 1);
	iLocal_52 = func_153(uParam0, joaat("P_STOOLFOLDING01X"), 0.0f, 0.0f, 0.0f, 0, 1, 0, 1);
	iLocal_53 = func_153(uParam0, joaat("P_PEN01X"), 0.0f, 0.0f, 0.0f, "PEN", 0, 1, 1);
	sLocal_21 = { func_154(uParam0, 1.0275f, -0.048f, 0.988f, 99.5f, 6.3375f, 0.5125f, 0.4325f) /*10*/ };
	sLocal_31 = { func_154(uParam0, 1.17f, 0.197f, 0.988f, 180.0f, 6.5f, 0.3f, 0.3775f) /*10*/ };
	sLocal_41 = { func_154(uParam0, 1.17f, -0.1425f, 0.988f, 3.88f, 6.5f, 0.625f, 0.205f) /*10*/ };
...
{
	vLocal_55 = { ENTITY::GET_ENTITY_COORDS(func_193(uParam0, iLocal_51), true, false) /*3*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	if (!bLocal_54)
	{
		...
		{
			if (func_202(uParam0, sLocal_21, 1, 0))
			{
				func_192(uParam0, iLocal_17, 1);
			}
			else if (func_202(uParam0, sLocal_31, 1, 0))
			{
				func_192(uParam0, iLocal_18, 1);
			}
			else if (func_202(uParam0, sLocal_41, 1, 0))
			{
...
struct<10> /*80*/ func_154(var uParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	float fVar0;
	float fVar1;
	struct<10> /*80*/ sVar2;
