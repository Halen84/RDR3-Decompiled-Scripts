...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			func_149(uParam0, -118.0872f, -27.6725f, 94.7f, 0.0f, 0.0f, -103.99f);
			break;
		case 2:
			func_149(uParam0, 665.5107f, -1243.862f, 43.04f, 0.0f, 0.0f, 134.74f);
			break;
		case 3:
			func_149(uParam0, 1881.7f, -1874.126f, 41.705f, 0.0f, 0.0f, -103.99f);
			break;
		default:
			return false;
	}
	...
	func_151(uParam0, -0.738f, -0.7181f, 0.5044f, 0.0f, 2.44f, 1.89f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -2.9678f, -4.3495f, 1.1403f, 0.0f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_152(uParam0, joaat("P_CHAIRFOLDING02X"), 0.0f, 0.0f, 0.0f, "CHAIR", 1, 0, 1);
	func_152(uParam0, joaat("P_BOTTLEBEER01X"), 0.0f, 0.0f, 0.0f, "BOTTLE", 0, 0, 1);
	if (func_148(uParam0) == 1)
	{
		func_152(uParam0, joaat("P_BASKET02X"), 0.0f, 0.0f, 0.0f, "BASKET", 0, 0, 1);
	}
	...
	sLocal_19 = { func_158(uParam0, 0.1821f, -1.2983f, 0.5878f, 78.84f, 8.0f, 0.75f, 0.7f) /*10*/ };
	return true;
}
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_250(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
...
int func_374(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_407(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
struct<5> /*40*/ func_469(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_481(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_473(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_483(iParam0, 1))
			{
				...
				if (!func_471(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_471(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_472(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_473(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
