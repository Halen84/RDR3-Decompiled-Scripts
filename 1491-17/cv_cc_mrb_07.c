...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.175f, -7.0875f, 0.85f, -65.75f, 1.0f, 1.0f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_151(uParam0, 0.85f, -1.3375f, 0.85f, 0.0f, 4.4575f, 3.4825f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_152(uParam0, -0.207769f, -1.05733f, 1.00032f, 0.0f, 1.1f, 1.1f, 3.2f, joaat("VOLCYLINDER"), 1);
	iLocal_16 = func_153(uParam0, joaat("P_CS_KNITTING01X"), 0.0f, 0.0f, 0.0f, "KNITTING", 0, 0, 1);
	iLocal_17 = func_153(uParam0, joaat("P_CHAIR_CRATE02X"), 0.0f, 0.0f, 0.0f, 0, 1, 0, 1);
