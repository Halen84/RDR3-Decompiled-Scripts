...
void __SCRIPT()
{
	...
	fLocal_7 = 1.0f;
	fLocal_8 = 1.0f;
	vLocal_28 = { 651.7131f, -1258.331f, 42.7264f /*3*/ };
	sVar0 = -1;
	sVar0.f_1 = -1;
	sVar0.f_2 = -1;
	sVar0.f_17 = 10;
...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.6875f, 1.2375f, 0.0f, -26.0f, 1.0f, 1.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, -0.6f, -1.2125f, 0.0f, -26.0f, 1.0f, 1.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	func_151(uParam0, -3.59344f, 10.879f, 0.830566f, 0.0f, 1.1f, 1.1f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -14.461f, -2.763f, -0.136f, 84.35f, 1.5f, 1.5f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -1.25f, 0.7875f, 0.0f, -26.0f, 1.0f, 1.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	vVar0 = { -14.345f, -2.16691f, 0.826759f /*3*/ };
	...
	func_152(uParam0, joaat("P_MONEYSTACK01X"), 0.0f, 0.0f, 0.0f, "MONEYSTACK", 0, 1, 1);
	func_152(uParam0, joaat("P_MONEYSTACK01X"), 0.0f, 0.0f, 0.0f, "MONEYSTACK^1", 0, 1, 1);
...
bool func_93(var uParam0)
{
	...
	if (!bLocal_20)
	{
		...
		{
			fVar0 = -65.4f;
			vVar1 = { 652.0314f, -1257.147f, 43.7423f /*3*/ };
			ANIMSCENE::SET_ANIM_SCENE_ORIGIN(uParam0->f_1984[iLocal_17], vLocal_22, vLocal_25, 2);
			TASK::TASK_START_SCENARIO_AT_POSITION(func_48(uParam0, iLocal_14), joaat("STAND"), vVar1, fVar0, 0, true, false, 0, -1.0f, false);
			bLocal_20 = true;
		}
	}
	if (bLocal_20 && !bLocal_21)
	{
		if (BUILTIN::VDIST2(Global_36, vLocal_28) <= 9.0f)
		{
...
int func_149(var uParam0)
{
	...
	vLocal_22 = { func_249(96) /*3*/ };
	vLocal_25 = { func_250(96) /*3*/ };
	return 1;
}
...
bool func_197(var uParam0, int iParam1)
{
	...
	{
		if (!func_301(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_ANY")))
		{
			return true;
		}
	}
...
void func_274(var uParam0, int iParam1)
{
	...
	else if (!func_301(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
	{
...
int func_345(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_383(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
