...
bool func_20()
{
		...
		if (func_61(uLocal_15[iVar0], 0, 1))
		{
			...
			switch (iVar0)
			{
				...
				case 4:
					...
					func_129(uLocal_15[iVar0], joaat("GROUP_REPEATER"), -1, 1, 0, 1056964608, 1065353216, 0);
					break;
				default:
					func_129(uLocal_15[iVar0], joaat("GROUP_REVOLVER"), -1, 1, 0, 1056964608, 1065353216, 0);
					break;
	...
	iLocal_280[3] = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(ENTITY::GET_ENTITY_COORDS(uLocal_15.f_52[0], false, false), 0.0f, 0.0f, 0.0f, fVar7, fVar7, 20.0f, "volTrigger");
	iLocal_280[4] = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(ENTITY::GET_ENTITY_COORDS(uLocal_15.f_52[0], false, false), 0.0f, 0.0f, 0.0f, fVar8, fVar8, 20.0f, "volTriggerFoot");
	return true;
}
	...
	switch (iLocal_274)
	{
		case 0:
			if (func_141())
			{
				...
				{
					vVar0 = { func_143(0) /*4*/ };
					AUDIO::AUDIO_TRIGGER_EXPLOSION("EXPLOSIONS_SCRIPTED_WAGON_WOOD_BIG", vVar0);
		...
		case 2:
			...
			{
				vLocal_286 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Global_35, -3.0f, -5.0f, 0.0f) /*3*/ };
				func_102(&vLocal_286, 1, 10, 0);
				iLocal_280[2] = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(Global_36, 0.0f, 0.0f, 0.0f, 15.0f, 15.0f, 15.0f, "volHorseStayout");
				iLocal_274 = 3;
			}
			break;
		case 3:
			if (func_133(&uLocal_278, (1 << 13)))
			{
				func_151(&uLocal_15, iLocal_280[2], vLocal_286, 2.001f, 30.0f, 2.0f, 1);
			}
			PLAYER::SET_PLAYER_INVINCIBLE(PLAYER::PLAYER_ID(), true);
			if (func_152())
			{
...
bool func_31()
{
	...
	switch (iLocal_275)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (func_171(-2.0f, 1, 0, 0))
			{
				if (func_172(&uLocal_15) <= 3 || func_47(&uLocal_295, 15.0f))
				{
					PLAYER::_SET_PLAYER_DEFENSE_TYPE_MODIFIER(PLAYER::PLAYER_ID(), 4, 0.85f);
					iVar0 = 0;
					while (iVar0 <= 4)
					{
						if (func_61(uLocal_15[iVar0], 0, 0))
						{
							...
							if (!bVar1)
							{
								...
								{
									if (func_174(uLocal_15[iVar0], Global_35, "AMBUSH_WAB_TRIGGER", 100.0f, 0, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CRITICAL")))
									{
										bVar1 = true;
									}
								}
		...
		case 3:
			...
			{
				PLAYER::_SET_PLAYER_DEFENSE_TYPE_MODIFIER(PLAYER::PLAYER_ID(), 4, 1.0f);
				iLocal_275 = 4;
			}
			break;
		case 4:
...
bool func_57(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (Global_40.f_9632[iParam0 /*4*/] > 0)
		{
			...
			sVar2 = { func_159(joaat("TOTAL_PLAYING_TIME")) /*2*/ };
...
void func_91(var uParam0, int iParam1)
{
	...
	func_250(uParam0->f_238, iParam1, (1 << 18), 1, 0);
}
...
void func_132(var uParam0, var uParam1)
{
	switch (iLocal_279)
	{
		case 0:
			if (func_133(&uLocal_278, 4))
			{
				*uParam0 = { 915.95f, -1128.921f, 53.177f /*3*/ };
				*uParam1 = { 5.927f, -5.88f, -45.075f /*3*/ };
			}
			else if (func_133(&uLocal_278, 128))
			{
				*uParam0 = { 925.7f, -1171.3f, 54.175f /*3*/ };
				*uParam1 = { -4.473f, 6.62f, 149.925f /*3*/ };
			}
			else if (func_133(&uLocal_278, 256))
			{
				*uParam0 = { 943.8f, -1155.1f, 56.095f /*3*/ };
				*uParam1 = { 4.927f, 2.82f, -138.775f /*3*/ };
			}
			break;
		case 1:
			*uParam0 = { 1483.9f, -1043.9f, 54.4f /*3*/ };
			*uParam1 = { 10.127f, 5.42f, 76.225f /*3*/ };
			break;
	}
}
...
void func_137(var uParam0)
{
	...
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(uLocal_15[iVar0], 0, 1))
		{
			...
			func_201(uLocal_15[iVar0], &iVar1, 0.3f, 1.0f, 1, 1);
			if (!*uParam0)
			{
				if (func_97(iVar0) == joaat("G_M_Y_UNIEXCONFEDS_01"))
				{
					func_174(uLocal_15[iVar0], Global_35, "AMBUSH_WAB_BYPASS", -1073741824, 0, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CRITICAL"));
					*uParam0 = 1;
				}
			}
			func_128(&uLocal_15, iVar0, 1);
...
void func_138()
{
	...
	if (!OBJECT::DOES_RAYFIRE_MAP_OBJECT_EXIST(iLocal_302))
	{
		...
		iLocal_302 = OBJECT::GET_RAYFIRE_MAP_OBJECT(vVar0, 5.0f, sVar3);
...
void func_140()
{
	if (!func_133(&uLocal_278, (1 << 14)))
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_15.f_52[0]))
		{
			if (func_189(uLocal_15.f_52[0], Global_36, 1) < 80.0f && OBJECT::IS_OBJECT_VISIBLE(uLocal_15.f_52[0]))
			{
				func_147(&uLocal_278, (1 << 14));
			}
		}
	}
}
...
bool func_141()
{
	...
	{
		vVar0 = { func_271(Global_35, 0.5f) /*3*/ };
		iVar3 = iLocal_280[3];
	}
	else
	{
		...
		case 0:
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_15.f_52[0]))
			{
				if (VOLUME::IS_POINT_IN_VOLUME(iVar3, vVar0))
				{
					...
					func_144(&uLocal_289);
					func_25(&uLocal_15, 1);
					func_174(uLocal_15[4], Global_35, "AMBUSH_WAB_REVEAL_MISSION", 200.0f, 0, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CRITICAL"));
					func_272();
...
bool func_142()
{
	...
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(Global_36, ENTITY::GET_ENTITY_COORDS(uLocal_15.f_52[0], false, false), false) < 22.0f)
	{
		if (func_61(Global_35, 0, 1))
		{
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(Global_36, ENTITY::GET_ENTITY_COORDS(uLocal_15.f_52[0], false, false), false) < (22.0f * 0.5f))
			{
				ENTITY::SET_ENTITY_HEALTH(Global_35, BUILTIN::FLOOR((0.4f * (float)ENTITY::GET_ENTITY_HEALTH(Global_35))), 0);
			}
			else
			{
				ENTITY::SET_ENTITY_HEALTH(Global_35, BUILTIN::FLOOR((0.6f * (float)ENTITY::GET_ENTITY_HEALTH(Global_35))), 0);
			}
		}
	}
	if (func_61(Global_35, 0, 1))
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_15.f_52[0]))
	{
		sVar0.f_8 = -1082130432;
		sVar0 = { func_275() /*3*/ };
		sVar0.f_3 = { func_276() /*3*/ };
		sVar0.f_6 = joaat("WEAPON_REPEATER_CARBINE");
		sVar0.f_7 = 100.0f;
		sVar0.f_10 = uLocal_15.f_52[0];
		sVar0.f_12 = 1;
		...
		if (!func_277(Global_35))
		{
			...
			vVar21 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(Global_36, fVar20, 0.0f, 0.8f, 0.0f) /*3*/ };
			FIRE::ADD_EXPLOSION(vVar21, 25, 0.2f, false, true, 1.0f);
			PLAYER::SET_PLAYER_INVINCIBLE(PLAYER::PLAYER_ID(), true);
		}
		else
		{
...
struct<4> /*32*/ func_143(int iParam0)
{
	struct<4> /*32*/ sVar0;
	...
	if (iParam0 == 0)
	{
		sVar0 = { sVar0 + Vector(0.0f, 2.0f, 2.0f) /*3*/ };
	}
	return sVar0;
}
...
bool func_146()
{
	...
	{
		func_40(&uLocal_292, 0);
		func_174(uLocal_15[1], Global_35, "AMBUSH_WAB_BYPASS", -1073741824, 0, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CRITICAL"));
		func_25(&uLocal_15, 1);
		func_270(uLocal_15.f_151, 1);
			...
			else
			{
				if (func_61(uLocal_15[iVar1], 0, 0))
				{
					...
					if (PED::IS_PED_IN_COMBAT(uLocal_15[iVar1], Global_35))
					{
						...
						TASK::TASK_FLEE_PED(uLocal_15[iVar1], Global_35, 4, iVar0, -1.0f, -1, 0);
				...
				PED::_SET_REMOVE_PED_NETWORKED(uLocal_15[iVar1], -1);
...
void func_150()
{
	...
	if (!func_133(&uLocal_278, 2))
	{
		...
		{
			func_286(&uLocal_15, 1061997773, 1061997773, 1028443341, 1028443341);
			func_147(&uLocal_278, 2);
		}
		func_287();
	}
	...
	if (!func_30(uParam0, 32))
	{
		if (!func_277(Global_35))
		{
			...
			if (func_61(uParam0->f_56, 0, 1))
			{
				...
				PED::SET_PED_CONFIG_FLAG(uParam0->f_56, 355 /*PCF_0xEEBAF435*/, true);
				if (func_69(vParam2))
				{
			...
			if (!func_133(&uLocal_278, (1 << 11)))
			{
				if (func_47(&uLocal_289, 0.75f))
				{
					if (func_61(uLocal_15[4], 0, 0))
					{
						...
						PED::SET_PED_SPHERE_DEFENSIVE_AREA(uLocal_15[4], vVar0, 3.0f, false, false, false);
						TASK::OPEN_SEQUENCE_TASK(&iVar4);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar0, 2.0f, 20000, 0.25f, 2112, fVar3);
						TASK::TASK_COMBAT_PED(0, Global_35, 0, 0);
						func_201(uLocal_15[4], &iVar4, 0, 0, 1, 1);
					}
					func_147(&uLocal_278, (1 << 11));
				}
			}
			if (func_47(&uLocal_289, 2.0f))
			{
				func_144(&uLocal_289);
			...
			if (func_267(&uLocal_15, iVar0))
			{
				if (!bVar1)
				{
					if (func_97(iVar0) == joaat("G_M_Y_UNIEXCONFEDS_01"))
					{
						if (!func_133(&uLocal_278, 8))
						{
							func_174(uLocal_15[iVar0], Global_35, "AMBUSH_WAB_TRIGGER", -1073741824, 0, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CRITICAL"));
						}
						bVar1 = true;
					}
				}
...
void func_168()
{
	...
	while (iVar5 < uLocal_15.f_215)
	{
		if (func_61(uLocal_15[iVar5], 0, 0))
		{
			vVar0 = { func_288(iVar5) /*3*/ };
			if (!func_69(vVar0))
			{
				fVar3 = func_308(iVar5);
				bVar4 = func_309(iVar5);
				if (fVar3 > 0.0f)
				{
			...
			PED::_0x1F44B7E283C09EDE(uLocal_15[iVar5], 0.0f, 6000);
			PED::SET_PED_COMBAT_RANGE(uLocal_15[iVar5], 0);
		}
		iVar5++;
	}
	PLAYER::_SET_PLAYER_DEFENSE_TYPE_MODIFIER(PLAYER::PLAYER_ID(), 4, 0.2f);
}
...
bool func_170()
{
	...
	func_174(uVar1[0], Global_35, "AMBUSH_WAB_FLEE", 100.0f, 0, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CRITICAL"));
	return true;
}
...
{
	return func_315(iParam0, iParam1, sParam2, "", fParam3, iParam4, 0, 0, 1, fParam3 > 0.0f, 1, iParam5, 1, 0, 0);
}
...
void func_195(Vector3 vParam0, float fParam3, int iParam4)
{
	...
	vVar6 = { func_336(vVar0, vVar3, 0.0f) /*3*/ };
	vVar9 = { func_337(vVar0, vVar3, 0.0f) /*3*/ };
	if (iParam4 == 5)
	{
...
{
	if (func_349(iParam1, 1114636288) || func_351(iParam1, 1, 1) <= 30.0f)
	{
		return false;
	}
	return true;
...
void func_208(var uParam0, float fParam1)
{
	...
	vVar6 = { func_336(vVar0, vVar3, 0) /*3*/ };
	vVar9 = { func_337(vVar0, vVar3, 0) /*3*/ };
...
struct<4> /*32*/ func_260(int iParam0)
{
	struct<4> /*32*/ sVar0;
...
bool func_268(int iParam0)
{
	...
	if (uLocal_15.f_9[iParam0] > 12.0f)
	{
...
void func_272()
{
	...
	iVar0 = func_127();
	vVar1 = { 0.2f, -0.2f, 0.8f /*3*/ };
	if (iLocal_279 == 1 && func_133(&uLocal_278, 4))
	{
		vVar1 = { 0.2f, -0.3f, 0.9f /*3*/ };
	}
	if (iLocal_279 == 0 && func_133(&uLocal_278, 4))
	{
		vVar1 = { 0.2f, -0.2f, 1.0f /*3*/ };
	}
	if (func_61(uLocal_15[iVar0], 0, 1))
	{
		PED::_SET_PED_CROUCH_MOVEMENT(uLocal_15[iVar0], false, 0, false);
		vVar5 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_15.f_52[0], vVar1) /*3*/ };
		TASK::OPEN_SEQUENCE_TASK(&iVar4);
...
{
	if (func_47(&uLocal_289, 5.0f))
	{
		return true;
	}
	if (ENTITY::GET_ENTITY_SPEED(Global_35) >= 6.5f)
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(vParam0, ENTITY::GET_ENTITY_COORDS(uLocal_15.f_52[0], false, false), false) < 15.0f)
		{
			return true;
		}
	}
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(Global_36, ENTITY::GET_ENTITY_COORDS(uLocal_15.f_52[0], false, false), false) <= 10.0f)
	{
		return true;
	}
...
bool func_274(Vector3 vParam0)
{
	...
	if (func_61(uLocal_15[iVar0], 0, 1))
	{
		...
		{
			if (!func_133(&uLocal_278, (1 << 12)))
			{
				vVar3 = { 0.2f, -0.2f, 0.8f /*3*/ };
				if (iLocal_279 == 1 && func_133(&uLocal_278, 4))
				{
					vVar3 = { 0.2f, -0.3f, 0.9f /*3*/ };
				}
				if (iLocal_279 == 0 && func_133(&uLocal_278, 4))
				{
					vVar3 = { 0.2f, -0.2f, 1.0f /*3*/ };
				}
...
Vector3 func_275()
{
	return { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_15.f_52[0], 0.5f, -3.0f, 2.0f) };
}
...
float func_278(struct<2> /*16*/ sParam0, int iParam2, struct<2> /*16*/ sParam3, Vector3 vParam5, int iParam6)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_287()
{
	...
	if (!func_133(&uLocal_278, (1 << 9)))
	{
		uVar18[0] = Global_35;
		vVar22 = { ENTITY::GET_ENTITY_COORDS(uLocal_15.f_52[0], false, false) /*3*/ };
		iVar27 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(joaat("EVENT_SHOCKING_BEAT_TERRIFYING"), vVar22, -1.0f, -1.0f, -1.0f, -1.0f, -1.0f, -1, -1);
		iVar20 = func_428(&uVar0, &uVar18, 8, vVar22, 15.0f, 0, 0, 0, -1, 1, 0, -1082130432, 0, 0);
		iVar21 = 0;
		while (iVar21 < iVar20)
		{
			if (func_61(uVar0[iVar21], 0, 0))
			{
				...
				TASK::TASK_FLEE_COORD(0, vVar22, 3, (1 << 12), -1.0f, -1, 0);
				func_201(uVar0[iVar21], &iVar25, 0.0f, 0.5f, 1, 1);
				PED::APPLY_DAMAGE_TO_PED(uVar0[iVar21], 50, 0, -1, 0);
			}
			iVar21++;
		}
		iVar20 = func_429(&uVar9, &uVar26, 8, vVar22, 15.0f, 0);
		iVar21 = 0;
		while (iVar21 < iVar20)
		{
			if (func_61(uVar9[iVar21], 0, 0))
			{
				if (func_430(uVar9[iVar21]))
				{
					if (PED::_GET_RIDER_OF_MOUNT(uVar9[iVar21], true) != Global_35)
					{
						...
						TASK::TASK_FLEE_COORD(0, vVar22, 4, (1 << 12), -1.0f, -1, 0);
		...
		func_147(&uLocal_278, (1 << 9));
	}
	else if (!func_133(&uLocal_278, (1 << 10)))
	{
		uVar32 = 1;
		vVar36 = { ENTITY::GET_ENTITY_COORDS(uLocal_15.f_52[0], false, false) /*3*/ };
		iVar34 = func_432(&uVar28, &uVar32, 3, vVar36, 15.0f);
		iVar35 = 0;
		while (iVar35 < iVar34)
		{
			vVar39 = { ENTITY::GET_ENTITY_FORWARD_VECTOR(uVar28[iVar35]) /*3*/ };
			...
			{
				VEHICLE::_BREAK_OFF_DRAFT_WHEEL(uVar28[iVar35], 0, 100.0f);
				VEHICLE::_BREAK_OFF_DRAFT_WHEEL(uVar28[iVar35], 4, 100.0f);
			}
			else
			{
				VEHICLE::_BREAK_OFF_DRAFT_WHEEL(uVar28[iVar35], 1, 100.0f);
				VEHICLE::_BREAK_OFF_DRAFT_WHEEL(uVar28[iVar35], 5, 100.0f);
			}
			VEHICLE::SET_VEHICLE_DAMAGE(uVar28[iVar35], ENTITY::GET_ENTITY_COORDS(uVar28[iVar35], true, false), 80.0f, 0.25f, false);
			iVar35++;
		}
		func_147(&uLocal_278, (1 << 10));
	}
}
...
bool func_307(int iParam0)
{
	...
	if (func_189(uLocal_15[iParam0], Global_36, 1) < 3.0f)
	{
		return false;
	}
...
void func_360()
{
	...
	if (func_133(&uLocal_278, 4))
	{
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 919.9129f, -1142.319f, 58.9201f, 0.0f, 0.0f, 85.55064f, 22.9198f, 68.99059f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 940.0757f, -1130.841f, 58.9201f, 0.0f, 0.0f, 162.7497f, 22.9198f, 26.60962f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 895.0365f, -1125.038f, 58.9201f, 0.0f, 0.0f, -86.32182f, 22.9198f, 26.60962f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 938.5794f, -1268.628f, 58.9201f, 0.0f, 0.0f, 102.2903f, 240.7625f, 413.3715f, 58.83871f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 1016.263f, -1156.188f, 58.9201f, 0.0f, 0.0f, -7.625053f, 154.6291f, 203.5814f, 58.83871f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 818.122f, -1179.718f, 58.9201f, 0.0f, 0.0f, 1.687667f, 168.8384f, 203.5814f, 58.83871f);
	}
	else if (func_133(&uLocal_278, 128))
	{
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 928.2882f, -1160.344f, 58.9201f, 0.0f, 0.0f, 93.32861f, 22.9198f, 68.99059f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 901.4467f, -1171.426f, 58.9201f, 0.0f, 0.0f, 178.1586f, 24.73056f, 42.81178f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 942.963f, -1171.131f, 58.9201f, 0.0f, 0.0f, -163.7904f, 22.9198f, 37.41507f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 920.9067f, -1042.365f, 58.9201f, 0.0f, 0.0f, -85.31746f, 240.7625f, 413.3715f, 58.83871f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 815.5959f, -1162.613f, 58.9201f, 0.0f, 0.0f, -1.985029f, 191.5743f, 203.5814f, 58.83871f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 1026.71f, -1145.781f, 58.9201f, 0.0f, 0.0f, 7.970647f, 175.5276f, 109.6086f, 58.83871f);
	}
	else
	{
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 927.8225f, -1148.209f, 58.9201f, 0.0f, 0.0f, -12.33349f, 22.9198f, 68.99059f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 929.8199f, -1173.013f, 58.9201f, 0.0f, 0.0f, 21.46918f, 22.9198f, 26.60962f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 949.7383f, -1136.613f, 58.9201f, 0.0f, 0.0f, 3.11025f, 22.9198f, 26.60962f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 818.1218f, -1164.378f, 58.9201f, 0.0f, 0.0f, 2.940468f, 240.7625f, 413.3715f, 58.83871f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 930.6552f, -1276.798f, 58.9201f, 0.0f, 0.0f, -129.5257f, 154.6291f, 203.5814f, 58.83871f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 982.3572f, -1059.821f, 58.9201f, 0.0f, 0.0f, -104.3027f, 187.8317f, 146.189f, 58.83871f);
	}
}
...
void func_361()
{
	...
	if (func_133(&uLocal_278, 4))
	{
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 1461.022f, -1036.259f, 58.9201f, 0.0f, 0.0f, -149.5055f, 22.9198f, 53.53887f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 1491.532f, -1059.379f, 58.9201f, 0.0f, 0.0f, -94.92382f, 24.73056f, 42.81178f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 1333.364f, -1018.002f, 58.9201f, 0.0f, 0.0f, -44.58528f, 200.4494f, 215.5016f, 102.0099f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 1403.921f, -1161.298f, 58.9201f, 0.0f, 0.0f, -7.757735f, 140.9638f, 194.7786f, 94.92717f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 1453.261f, -994.6071f, 58.9201f, 0.0f, 0.0f, -78.58529f, 38.12796f, 40.25013f, 102.0099f);
	}
	else if (func_133(&uLocal_278, 128))
	{
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 1487.767f, -1023.813f, 58.9201f, 0.0f, 0.0f, 86.756f, 22.9198f, 40.94622f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 1467.374f, -1050.545f, 58.9201f, 0.0f, 0.0f, 171.586f, 24.73056f, 42.81178f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 1349.461f, -924.8898f, 58.9201f, 0.0f, 0.0f, -85.31746f, 240.7625f, 253.303f, 58.83871f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 1360.439f, -1088.001f, 58.9201f, 0.0f, 0.0f, -9.757735f, 252.8302f, 83.03677f, 58.83871f);
	}
	else
	{
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 1492.816f, -1050.349f, 58.9201f, 0.0f, 0.0f, -166.4329f, 22.9198f, 68.99059f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 1466.395f, -1026.811f, 58.9201f, 0.0f, 0.0f, -92.92725f, 22.9198f, 26.60962f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[0], 1479.639f, -1073.008f, 58.9201f, 0.0f, 0.0f, -150.9891f, 22.9198f, 26.60962f, 33.29299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 1603.897f, -1035.163f, 58.9201f, 0.0f, 0.0f, -169.6827f, 240.7625f, 413.3715f, 58.83871f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 1485.326f, -920.2891f, 58.9201f, 0.0f, 0.0f, -179.3547f, 154.6291f, 203.5814f, 58.83871f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_280[1], 1538.523f, -1134.953f, 58.9201f, 0.0f, 0.0f, 113.8741f, 187.8317f, 146.189f, 58.83871f);
	}
}
...
int func_378(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, iParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_463(iParam0, &sVar0, iVar5, 0))
			{
				if (func_464(iParam0, &sVar6, iVar5))
				{
					sVar29 = { func_465(iParam0, sVar0, iVar5, 0) /*4*/ };
					func_466(iParam0, &sVar29, &sVar0, 1, joaat("REMOVE_REASON_DEFAULT"), 1, 0);
				}
				else
				{
					iVar28++;
	...
	switch (iParam0->f_6)
	{
		case 0:
			if ((*iParam0 & 16) != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_472(1) || (*iParam0 & (1 << 13)) != 0))
				{
...
bool func_384(int iParam0, int iParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_481(iParam0, !(*iParam1 & (1 << 28)) != 0, !(*iParam1 & (1 << 29)) != 0, !(*iParam1 & (1 << 30)) != 0, 0, 0))
		{
...
bool func_385(int iParam0, int iParam1, int iParam2)
{
	...
	fVar0 = 85.0f;
	if (func_485(iParam1, !(*iParam2 & (1 << 28)) != 0, !(*iParam2 & (1 << 29)) != 0, !(*iParam2 & (1 << 30)) != 0, 0))
	{
...
bool func_389(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam2->f_12 < (float)func_487(iParam2))
	{
...
bool func_397(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_359(iParam0, iParam1, 1, 1) < 4.0f)
		{
...
int func_416(int iParam0, Vector3 vParam1, int iParam4, int iParam5, bool bParam6, var uParam7, bool bParam8)
{
	...
	if (WEAPON::GET_CURRENT_PED_WEAPON(iParam0, &(sVar0.f_6), false, iParam5, false))
	{
		...
		{
			sVar0 = { func_508(iVar20) /*3*/ };
			if (func_69(vParam1))
			{
				sVar0.f_3 = { func_509(iVar20) /*3*/ };
			}
			else
			{
				sVar0.f_3 = { vParam1 /*3*/ };
...
struct<4> /*32*/ func_417(int iParam0, int iParam1)
{
	struct<4> /*32*/ sVar0;

	sVar0 = { func_510(iParam0, iParam1) /*3*/ };
	sVar0.f_3 = func_511(iParam0, iParam1);
	return sVar0;
}
...
bool func_424(var uParam0)
{
	if (!func_30(uParam0, (1 << 19)))
	{
		if (uParam0->f_20 < 60.0f)
		{
			if (func_517(uParam0, 60.0f, uParam0->f_239))
			{
				return true;
			}
		}
...
bool func_433(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
bool func_440(int iParam0, int iParam1, var uParam2, int iParam3)
{
	struct<13> /*104*/ sVar0;
	int iVar23;
...
void func_445(int iParam0, bool bParam1)
{
	...
	if (STATS::STAT_ID_GET_INT(&sVar2, &iVar0))
	{
		...
		{
			Global_40.f_9632[iParam0 /*4*/].f_3 += func_411(iParam0, 0);
		}
	}
}
...
bool func_454(int iParam0, int iParam1, bool bParam2, float fParam3, bool bParam4)
{
	if (bParam2)
	{
		if (!func_528(iParam0, iParam1, 0.0f))
		{
			return false;
		}
	}
...
struct<5> /*40*/ func_461(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;
	...
	switch (func_534(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_536(iParam0, 1))
			{
				...
				if (!func_463(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_463(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_464(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_539(iParam0, joaat("CI_CATEGORY_CAMP")))
			{
			...
			else if (func_539(iParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_465(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("WARDROBE"));
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_540(sVar0, &sVar27, bParam1, 0))
				{
					sVar0.f_4 = 0;
				}
				else
...
struct<4> /*32*/ func_465(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_544(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}
...
bool func_466(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!func_540(*uParam1, &sVar0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_544(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_481(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_359(iVar0, iParam0, 1, 1) <= 4.0f)
		{
			return true;
		}
	}
...
int func_516(var uParam0, float fParam1, int iParam2)
{
	...
	return func_559(&iVar0, uParam0->f_209, fParam1, 0, 0, 1084227584, bVar6, iParam2);
}
...
int func_520(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	while (iVar15 < iVar16)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar2))
		{
			if (!ENTITY::IS_ENTITY_DEAD(iVar2))
			{
				if ((!PED::IS_PED_HUMAN(iVar2) && iVar2 != func_570(uParam1, &sVar3)) && iVar17 != iVar2)
				{
					if (bParam4)
					{
...
{
	return func_465(joaat("CHARACTER"), func_585(), joaat("SLOTID_NONE"), bParam0);
}
...
struct<4> /*32*/ func_535(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_465(joaat("CARRIED_WEAPONS"), func_533(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_465(joaat("CARRIED_WEAPONS"), func_533(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_465(joaat("CARRIED_WEAPONS"), func_533(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_536(int iParam0, bool bParam1)
{
	if (func_538(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
struct<4> /*32*/ func_537(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_465(joaat("EMOTE_ITEM"), func_533(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_465(joaat("EMOTE_ITEM"), func_533(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
int func_541(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	iVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_544(bParam6), &sVar0, false);
	return iVar4;
}
...
bool func_542(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_544(0);
	*uParam1 = { func_465(iParam0, func_535(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
...
int func_570(var uParam0, var uParam1)
{
	...
	if (uParam1->f_4)
	{
		if (uParam1->f_10 == 0)
		{
			...
			sVar8 = { func_613(uParam1->f_10) /*2*/ };
			sVar10 = { func_614() /*6*/ };
			func_615(iVar2, &sVar8, &sVar10, 0);
...
void func_575(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME(*uParam0, func_620(func_619(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_621())
	{
...
bool func_590(int iParam0)
{
	...
	if (PED::IS_PED_GROUP_MEMBER(iParam0, func_625(), true))
	{
		return true;
	}
	return false;
...
void func_632(int iParam0, struct<2> /*16*/ sParam1)
{
	iParam0 = func_290(iParam0);
	if (iParam0 == -1)
	{
...
bool func_656(int iParam0, var uParam1)
{
	...
	*uParam1 = func_701(sVar0, joaat("SLOTID_HORSE_MANE"), 0);
...
bool func_657(int iParam0, var uParam1)
{
	...
	*uParam1 = func_701(sVar0, joaat("SLOTID_HORSE_TAIL"), 0);
	if (!func_543(*uParam1, 0))
	{
		return false;
	}
...
bool func_658(int iParam0, var uParam1)
{
	...
	sVar0 = { func_703() /*4*/ };
	*uParam1 = func_701(sVar0, iParam0, 0);
	if (!func_543(*uParam1, 0))
	{
		return false;
	}
...
bool func_664(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_705(&(Global_1109000.f_4), iVar0, 5);
	}
	if (iParam1 == func_706())
	{
		return func_705(&(Global_1109000.f_4), iVar0, 5);
	...
	{
		return func_705(&(Global_1108108[iParam1 /*27*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_676(int iParam0, var uParam1)
{
	...
	sVar15 = { func_533(0) /*4*/ };
	if (!func_712(sVar15, iVar0, &sVar1, 0, 0))
	{
		return false;
	}
	if (!func_713(&sVar1, uParam1))
	{
		return false;
	}
	return true;
...
bool func_678(struct<4> /*32*/ sParam0, struct<4> /*32*/ sParam4, int iParam8, bool bParam9, bool bParam10)
{
	...
	{
		return func_714(sParam0, sParam4, iParam8, 1, bParam9, 1) != -1;
	}
	...
	sVar0.f_9 = joaat("SLOTID_NONE");
	if (!func_540(sParam0, &sVar0, 0, 0))
	{
		return false;
	}
	if (func_715(&(sVar0.f_5), &sParam4) && sVar0.f_9 == iParam8)
	{
		return true;
	}
	...
	if (!INVENTORY::_INVENTORY_MOVE_INVENTORY_ITEM(func_544(0), &sParam0, &sParam4, iParam8, sVar0.f_11, &sVar14))
	{
		return false;
	}
	if (bParam9)
	{
		if (!func_710(sVar14, 1))
		{
		}
	}
	return true;
...
bool func_679(struct<4> /*32*/ sParam0, struct<4> /*32*/ sParam4, int iParam8, bool bParam9)
{
	...
	if (!func_467(bParam9))
	{
		return func_716(sParam0, sParam4, iParam8, 1) != -1;
	}
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&sParam0) || !INVENTORY::_INVENTORY_IS_GUID_VALID(&sParam4))
	{
		return false;
	}
	if (func_715(&sParam0, &sParam4))
	{
		return false;
	}
	sVar0.f_9 = joaat("SLOTID_NONE");
	sVar14.f_9 = joaat("SLOTID_NONE");
	if (!func_540(sParam0, &sVar0, bParam9, 1) || !func_540(sParam4, &sVar14, bParam9, 1))
	{
		return false;
	}
	if (func_715(&(sVar0.f_5), &(sVar14.f_5)) && sVar0.f_9 == sVar14.f_9)
	{
		return false;
	}
...
int func_701(struct<4> /*32*/ sParam0, int iParam4, int iParam5)
{
	struct<10> /*80*/ sVar0;

	sVar0.f_9 = joaat("SLOTID_NONE");
	if (func_720(sParam0, iParam4, &sVar0, iParam5))
	{
		return sVar0.f_4;
	}
	return 0;
...
bool func_710(struct<4> /*32*/ sParam0, bool bParam4)
{
	struct<11> /*88*/ sVar0;

	if (!func_467(0))
	{
		return func_723(sParam0, bParam4, 1) != -1;
	}
	...
	if (!INVENTORY::_INVENTORY_EQUIP_ITEM_WITH_GUID(func_544(0), &sParam0, bParam4))
	{
		return false;
	}
	return true;
...
bool func_713(var uParam0, var uParam1)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_544(0), uParam0, uParam1, 29, 1))
	{
		return false;
	}
	return true;
...
int func_714(struct<4> /*32*/ sParam0, struct<4> /*32*/ sParam4, int iParam8, bool bParam9, bool bParam10, bool bParam11)
{
	struct<12> /*96*/ sVar0;
	int iVar14;
	int iVar15;
	...
	iVar14 = func_541(sVar0.f_4, sParam4, iParam8, 0);
	...
	sVar16 = { func_725(&sVar0) /*17*/ };
	sVar16.f_4 = { sParam4 /*4*/ };
	sVar16.f_11 = iParam8;
	sVar16.f_10 = bParam10;
	iVar33 = func_726(joaat("MOVEITEMS"), &sVar16, bParam9);
	if (iVar33 == -1)
	{
		return -1;
	}
...
int func_716(struct<4> /*32*/ sParam0, struct<4> /*32*/ sParam4, int iParam8, bool bParam9)
{
	struct<11> /*88*/ sVar0;
	struct<11> /*88*/ sVar14;
	...
	sVar0.f_9 = joaat("SLOTID_NONE");
	sVar14.f_9 = joaat("SLOTID_NONE");
	if (!func_540(sParam0, &sVar0, 1, 0) || !func_540(sParam4, &sVar14, 1, 0))
	{
		return -1;
	}
	if (func_715(&(sVar0.f_5), &(sVar14.f_5)) && sVar0.f_9 == sVar14.f_9)
	...
	if (bParam9)
	{
		...
		{
			if (func_727(iVar62, joaat("MOVEITEMS"), &sVar28) && func_727(iVar62, joaat("MOVEITEMS"), &sVar45))
			{
	...
	{
		iVar62 = func_726(joaat("MOVEITEMS"), &sVar28, 0);
		iVar62 = func_726(joaat("MOVEITEMS"), &sVar45, 0);
	}
	return iVar62;
}
...
bool func_720(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_EQUIPPED_IN_SLOT_BY_REF(func_544(bParam6), &uParam0, iParam4, &sVar0))
	{
		return false;
	}
	if (!func_540(sVar0, uParam5, bParam6, 0))
	{
		return false;
	}
	return true;
...
int func_723(struct<4> /*32*/ sParam0, bool bParam4, bool bParam5)
{
	int iVar0;
	struct<11> /*88*/ sVar1;
	int iVar15;
	...
	iVar15 = func_534(sVar1.f_4);
	if (iVar15 == joaat("HORSE"))
	{
		sVar16 = { func_729(sParam0, 1) /*29*/ };
		sVar16.f_10 = bParam4;
		iVar0 = func_730(joaat("UPDATE"), &sVar16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		sVar45 = { func_731(sParam0, 1) /*18*/ };
		sVar45.f_10 = bParam4;
		iVar0 = func_732(joaat("UPDATE"), &sVar45, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		sVar63 = { func_725(&sVar1) /*17*/ };
		sVar63.f_10 = bParam4;
		iVar0 = func_726(joaat("UPDATE"), &sVar63, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
struct<17> /*136*/ func_725(var uParam0)
{
	struct<17> /*136*/ sVar0;
...
struct<29> /*232*/ func_729(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<29> /*232*/ sVar0;
	...
	sVar29.f_9 = joaat("SLOTID_NONE");
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_544(bParam4), &uParam0, &sVar29, 29, 1))
	{
		return sVar0;
	}
	sVar0 = { func_725(&sVar29) /*17*/ };
...
struct<18> /*144*/ func_731(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<18> /*144*/ sVar0;
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_544(bParam4), &uParam0, &sVar18, 15, 1))
	{
		return sVar0;
	}
	sVar0 = { func_725(&sVar18) /*17*/ };
