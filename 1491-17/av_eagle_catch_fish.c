...
int func_32(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		...
		while (iVar2 < uParam0->f_19)
		{
			...
			{
				if (ENTITY::IS_ENTITY_ON_SCREEN(uParam0->f_20[iVar2 /*14*/]) || ((uParam0->f_469[4] && !uParam0->f_469[5]) && func_61(uParam0->f_20[iVar2 /*14*/], Global_35, 1) < 22500.0f))
				{
					return 0;
				}
			}
