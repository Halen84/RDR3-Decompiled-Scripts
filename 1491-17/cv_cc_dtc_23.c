...
bool func_78(var uParam0)
{
	...
	iLocal_16 = func_158(uParam0, joaat("S_CHAIR04X"), 3.388f, -3.688f, 0.0f, "CHAIR", 1, 0, 1);
...
int func_390(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_423(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
