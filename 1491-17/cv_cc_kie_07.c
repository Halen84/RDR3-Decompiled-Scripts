...
void __SCRIPT()
{
	...
	fLocal_7 = 1.0f;
	fLocal_8 = 1.0f;
	strcpy_s(&cLocal_117, 24, "KIE_CNV_7_ARTH");
	sVar0 = -1;
	sVar0.f_1 = -1;
	sVar0.f_2 = -1;
	sVar0.f_17 = 10;
...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.45f, 2.2f, 0.0f, -35.0f, 5.0f, 4.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_ADLERS"), 1, 1, 1);
	func_151(uParam0, -1.0f, 8.5f, 0.0f, 0.0f, 3.5f, 3.5f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	iLocal_17 = func_152(uParam0, joaat("P_STEWPLATE01X"), 0.0f, 0.0f, 0.0f, "PLATE", 0, 0, 1);
	func_152(uParam0, joaat("P_STEWPLATE02X"), 0.0f, 0.0f, 0.0f, "PLATE_EMPTY", 0, 0, 1);
	iLocal_18 = func_152(uParam0, joaat("P_CS_ROPE03BX"), 0.0f, 0.0f, 0.0f, "ROPE", 0, 0, 1);
	...
	func_155(uParam0, iLocal_14, 2, joaat("WORLD_CAMP_KIERAN_TREE_TIED"), "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1, -1.0f, 1065353216, 1);
...
bool func_87(var uParam0)
{
	if (func_162(10))
	{
		return (func_197() == func_19(uParam0) || func_198(uParam0, 7.0f, 7.0f));
	}
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_206(uParam0, iLocal_16, 0.845f) && func_209(Global_35, func_48(uParam0, iLocal_14), 0) < 49.0f)
		{
		...
		if ((bParam1 || !func_105(iParam0)) || func_51(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_209(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000.0f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_224(iParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_225(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_225(iParam0, 0));
					func_226(iParam0);
				}
			}
			else
			{
				if (func_227(iParam0, (1 << 15), 1))
				{
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_240(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_242(iParam0) < 10000.0f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_143(var uParam0)
{
	...
	if (func_248(Global_1935630, (1 << 14)))
	{
		return true;
	}
	if (func_249(2))
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_255(uParam0->f_107[iVar0 /*113*/].f_1, (1 << 11)))
			{
				return true;
			}
...
{
	uParam0->f_23 = { func_262(iParam1) + Vector(fParam4, fParam3, fParam2) /*3*/ };
	uParam0->f_26 = { func_263(iParam1) /*3*/ };
}
...
int func_151(var uParam0, Vector3 vParam1, float fParam4, Vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_265(uParam0, vParam1) /*3*/ };
...
{
	func_155(uParam0, iParam1, 0, 0, 0, -1, 0, 0.0f, 1065353216, 1);
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_223(uParam0->f_107[iVar12 /*113*/].f_7, 1));
				}
			}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0 /*15*/].f_5 && !ENTITY::DOES_ENTITY_EXIST(uParam0->f_1711[iVar0 /*15*/].f_10))
			{
				...
				{
					vVar3 = { func_265(uParam0, uParam0->f_1711[iVar0 /*15*/].f_1) /*3*/ };
				}
				else
				{
...
void func_191(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_265(uParam0, uParam0->f_1976.f_1), 1, func_266(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
bool func_212(var uParam0, int iParam1)
{
	...
	{
		if (!func_319(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_ANY")))
		{
			return true;
		}
	}
...
void func_219(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_206(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
bool func_279(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1 /*15*/].f_5)
		{
			...
			{
				vVar2 = { func_265(uParam0, uParam0->f_1711[iVar1 /*15*/].f_1) /*3*/ };
			}
			else
			{
...
void func_287(var uParam0, int iParam1)
{
	...
	else if (!func_319(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
	{
...
int func_305(var uParam0, int iParam1)
{
	...
	if (func_206(uParam0, iParam1, 1.0f))
	{
		return 1;
	}
...
void func_317(char[4] cParam0, char[4] cParam1, char[4] cParam2, var uParam3)
{
	int iVar0;
...
bool func_381(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_255(iParam0, (1 << 31)))
	{
		return true;
	}
	if (func_255(iParam0, (1 << 30)))
	{
		return true;
	}
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_SET_PERSCHAR_SCHEDULE(func_223(iParam0, 1), &cVar4);
				}
		...
		case 3:
			...
			{
				PERSCHAR::_0x63AA2B8EB087886A(func_223(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
void func_413(int iParam0, Vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_238(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_238(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_238(iParam5, 32), true);
...
bool func_430(int iParam0, Vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489.f_12) || (bParam5 && Global_1359489.f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_223(iParam0, 1));
...
void func_432(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_240(iParam1), iParam0, false);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_340(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_405(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
