...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.573273f, 1.16449f, 0.496552f, -23.76f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	func_151(uParam0, -0.526581f, -1.20927f, 0.502571f, -21.96f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_CHARLES"), 1, 1, 1);
	func_152(uParam0, joaat("P_SPOON01X"), 0.0f, 0.0f, 0.0f, "SPOON_0", 0, 1, 1);
	iLocal_19 = func_152(uParam0, joaat("P_BOWL04X_STEW"), 0.0f, 0.0f, 0.0f, "BOWL_0", 0, 1, 1);
	func_152(uParam0, joaat("P_SPOON01X"), 0.0f, 0.0f, 0.0f, "SPOON_1", 0, 1, 1);
	iLocal_20 = func_152(uParam0, joaat("P_BOWL04X_STEW"), 0.0f, 0.0f, 0.0f, "BOWL_1", 0, 1, 1);
...
bool func_86(var uParam0)
{
	...
	ENTITY::_0x669655FFB29EF1A9(func_191(uParam0, iLocal_19), 0, "Stew_Fill", 1.0f);
	ENTITY::_0x669655FFB29EF1A9(func_191(uParam0, iLocal_20), 0, "Stew_Fill", 1.0f);
	return true;
}
...
int func_151(var uParam0, Vector3 vParam1, float fParam4, Vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_192(uParam0, vParam1) /*3*/ };
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0 /*15*/].f_5 && !ENTITY::DOES_ENTITY_EXIST(uParam0->f_1711[iVar0 /*15*/].f_10))
			{
				...
				{
					vVar3 = { func_192(uParam0, uParam0->f_1711[iVar0 /*15*/].f_1) /*3*/ };
				}
				else
				{
...
void func_185(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_192(uParam0, uParam0->f_1976.f_1), 1, func_252(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
bool func_265(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1 /*15*/].f_5)
		{
			...
			{
				vVar2 = { func_192(uParam0, uParam0->f_1711[iVar1 /*15*/].f_1) /*3*/ };
			}
			else
			{
