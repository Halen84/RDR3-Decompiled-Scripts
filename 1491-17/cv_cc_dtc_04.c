...
bool func_72(var uParam0)
{
	...
	switch (func_148(uParam0))
	{
		case 1:
			...
			vLocal_32 = { -124.199f, -34.674f, 94.768f /*3*/ };
			fLocal_35 = 71.885f;
			vLocal_36 = { -124.25f, -29.905f, 94.863f /*3*/ };
			fLocal_39 = 127.046f;
			vLocal_40 = { -125.096f, -35.884f, 94.74f /*3*/ };
			fLocal_43 = 47.362f;
			break;
		default:
			return false;
	...
	func_152(uParam0, -1.26f, -1.2004f, 0.0f, 0.0f, 4.0f, 4.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, vLocal_32, 0.0f, 1.2f, 1.2f, 5.0f, joaat("VOLBOX"), -1, 0, 1, 1);
	func_152(uParam0, vLocal_36, 0.0f, 1.2f, 1.2f, 5.0f, joaat("VOLBOX"), -1, 0, 1, 1);
	func_152(uParam0, vLocal_40, 0.0f, 1.2f, 1.2f, 5.0f, joaat("VOLBOX"), -1, 0, 1, 1);
	iLocal_21 = func_153(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 1, 1);
	...
	sLocal_22 = { func_165(uParam0, -2.098f, -2.4125f, 1.07f, -164.605f, 6.5f, 0.8005f, 0.9475f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_204(uParam0, sLocal_22, 1, 0))
		{
...
bool func_204(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
		...
		else if (func_19(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_382(&iVar2, func_381(iVar3)))
					{
...
void func_348(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_388(iParam1))
		{
			func_389(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
int func_361(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_396(fVar9) /*3*/ };
			vVar13 = { func_397(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
void func_428(int iParam0, int iParam1)
{
	...
	func_403(iParam1, func_456(iParam1, (1 << 13)), func_456(iParam1, (1 << 14)), 1);
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_334(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_404(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
