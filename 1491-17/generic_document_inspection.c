...
void func_136(int iParam0)
{
	...
	switch (iParam0)
	{
		case joaat("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_99(437, 0);
			func_99(440, 0);
			func_288(joaat("TAXIDERMY_ORDER_01"), joaat("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_2"):
			...
			func_288(joaat("TAXIDERMY_ORDER_02"), joaat("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_3"):
			...
			func_288(joaat("TAXIDERMY_ORDER_03"), joaat("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_4"):
			...
			func_288(joaat("TAXIDERMY_ORDER_04"), joaat("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_5"):
			...
			func_99(438, 0);
			func_288(joaat("TAXIDERMY_ORDER_05"), joaat("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &cVar0, 1, 0, 0);
...
void func_171(int iParam0, char* sParam1)
{
	...
	func_338(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_337(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_172(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	strcpy_s(&cVar2, 32, func_341(iVar1 == 1, "ITEM_GET_PUMP", "ITEM_GET_PUMP_MULT"));
	if (iParam1 > 0)
	{
	}
	else
...
struct<5> /*40*/ func_220(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_109(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_258(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_369(iParam0, 1))
			{
				...
				if (!func_256(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_256(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_257(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_258(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
...
bool func_224(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_216(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_257(iParam0, &sVar4, joaat("SLOTID_WEAPON_0")))
			{
				return false;
			}
			if (func_369(iParam0, 1))
			{
				if (!func_256(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					return false;
				}
				else if (func_257(iParam0, &sVar4, joaat("SLOTID_WEAPON_1")))
				{
					return false;
				}
			}
...
char* func_238(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6)
{
	switch (iParam1)
	{
		...
		case joaat("TAXIDERMY"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_TX_CARCASS_COLLECTED_OBJ", sParam4, func_237(iParam6, 20));
			}
			break;
	}
	return sParam3;
...
void func_326(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_487(MISC::VAR_STRING(10, "OUT_JOURN_DONE", MISC::VAR_STRING(0, iVar0)), 10000, 0, 0, 0, 1);
	}
	func_488(iParam0, 6);
	if (bParam2)
	{
...
{
	if (func_537(iParam0, joaat("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
int func_458(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	iVar0 = func_572(0);
	if (iParam2 != 0 && func_573(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
void func_483(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_482(iParam0))
	{
		...
		if ((!func_486() && !bParam1) && !func_50(0, 0, 1))
		{
			func_487(MISC::VAR_STRING(10, "OUT_JOURN_ADD", func_587(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
void func_545(int iParam0, int iParam1, int iParam2)
{
	...
	func_245(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_634(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_553()
{
	...
	func_638(0);
	func_639(7);
	func_640(joaat("KIT_BANDANA"), 1, 1, 0);
	if (func_327() == joaat("MPC_PLAYER_TYPE_SP_MARSTON"))
	{
		func_640(joaat("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
		func_640(joaat("CLOTHING_SP_MAR_OUTFIT_GUNSLINGER"), 1, 1, 1);
	}
