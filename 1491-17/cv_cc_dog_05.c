...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.0564f, -1.585f, 0.0f, -46.75f, 1.2f, 1.2f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -0.6186f, 2.04f, 0.0f, 39.5f, 1.55f, 1.11f, 5.0f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, 0.24f, 2.24f, 0.9775f, 16.2f, 1.0f, 0.76f, 2.0f, joaat("VOLCYLINDER"), 1);
	func_153(uParam0, joaat("P_KNIFE02X"), 0.0f, 0.0f, 0.0f, "Knife", 0, 1, 1);
	func_153(uParam0, joaat("P_WOODWHITTLE01X"), 0.0f, 0.0f, 0.0f, "Woodwhittle", 0, 1, 1);
...
bool func_93(var uParam0)
{
	...
	if (bLocal_21)
	{
		...
		{
			if (func_197(func_48(uParam0, iLocal_14), joaat("SCRIPT_TASK_PERSISTENT_CHARACTER")))
			{
				PED::SET_PED_CONFIG_FLAG(func_48(uParam0, iLocal_14), 447 /*PCF_0xA1040728*/, false);
				func_198(uParam0, iLocal_14, 1, 1);
			}
			if (!bLocal_22 && !func_197(func_48(uParam0, iLocal_14), joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
			{
...
bool func_196(var uParam0, int iParam1)
{
	...
	{
		if (!func_197(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_ANY")))
		{
			return true;
		}
	}
...
void func_204(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_195(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
void func_274(var uParam0, int iParam1)
{
	...
	else if (!func_197(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
	{
...
int func_291(var uParam0, int iParam1)
{
	...
	if (func_195(uParam0, iParam1, 1.0f))
	{
		return 1;
	}
...
int func_342(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_379(fVar9) /*3*/ };
			vVar13 = { func_380(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
void func_414(int iParam0, int iParam1)
{
	...
	func_386(iParam1, func_442(iParam1, (1 << 13)), func_442(iParam1, (1 << 14)), 1);
}
