	...
	switch (func_14())
	{
		case 0:
			if (func_15())
			{
				...
				if (sLocal_5.f_7 == -630818830)
				{
					strcpy_s(&(sLocal_5.f_1), 32, "WANTED_BOUNTY_POSTER_CHAIN_GANG");
					strcpy_s(&(sLocal_5.f_18), 32, "doc_bounty_poster_chain_gang");
					sLocal_5.f_8.f_2 = joaat("DOCUMENT_BOUNTY_POSTER_CHAIN_GANG");
				}
				else if (sLocal_5.f_7 == -1325774943)
				{
					strcpy_s(&(sLocal_5.f_1), 32, "WANTED_BOUNTY_POSTER");
					strcpy_s(&(sLocal_5.f_18), 32, "doc_bounty_poster_player");
					sLocal_5.f_8.f_2 = joaat("DOCUMENT_ARTHUR_HAS_POSTER_1");
				}
				else
				{
					strcpy_s(&(sLocal_5.f_1), 32, "WANTED_BOUNTY_POSTER");
					strcpy_s(&(sLocal_5.f_18), 32, "doc_bounty_poster");
					sLocal_5.f_8.f_2 = joaat("DOCUMENT_TEST_BOUNTY_POSTER");
				}
		...
		case 3:
			...
			if ((!PED::IS_PED_USING_ANY_SCENARIO(sLocal_5.f_0) && SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("DOC_BOUNTY_POSTER_CHAIN_GANG")) == 0) && SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("DOC_BOUNTY_POSTER")) == 0)
			{
				iLocal_0 = 0;
			}
			break;
...
{
	if ((sLocal_5.f_25 >= 3 && SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("DOC_BOUNTY_POSTER_CHAIN_GANG")) == 0) && SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("DOC_BOUNTY_POSTER")) == 0)
	{
		iLocal_0 = 0;
	}
}
