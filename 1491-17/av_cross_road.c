	...
	switch (iLocal_13)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], iLocal_12, uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
		...
		case 1:
			if (func_57(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_20[0 /*14*/], 0.0f, 10.0f, 0.0f) /*3*/ };
					vVar3 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_20[0 /*14*/], 0.0f, -1.0f, 0.0f) /*3*/ };
					func_55(&vVar0, 50, 10, 0);
					PED::SET_PED_SHOULD_PLAY_NORMAL_SCENARIO_EXIT(uParam0->f_20[0 /*14*/]);
					TASK::TASK_FLEE_COORD(uParam0->f_20[0 /*14*/], vVar3, iLocal_11, 66816, fLocal_9, -1, 0);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 230 /*PCF_0x59D3A97A*/, true);
					PED::_0xF9CBD46433E36713(Global_35, uParam0->f_20[0 /*14*/], 0.0f, 0.0f, 0.0f, 10.0f, 40.0f, 70.0f, 20.0f, "CRP_ANIMAL");
				}
				func_58(*uParam0, 0);
			...
			break;
		case 2:
			if (!func_61(uParam0->f_20[0 /*14*/], joaat("SCRIPT_TASK_FLEE")))
			{
...
int func_55(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_82(*uParam0, 0.0f, 0.0f, 0.0f))
	{
		return 1;
	}
	iVar1 = 0;
...
bool func_65(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, Vector3 vParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
bool func_67(Vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_94(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1.0f, 0))
			{
				return true;
			}
		}
...
void func_92(int iParam0, Vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_94(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
