...
bool func_72(var uParam0)
{
	switch (func_149(uParam0))
	{
		case 1:
			...
			break;
		case 2:
			func_151(uParam0, 663.0867f, -1231.747f, 43.2655f, 0.0f, 0.0f, 168.12f);
			break;
		default:
			return false;
	}
	...
	func_154(uParam0, -0.105f, 1.0775f, 0.85f, -78.25f, 4.325f, 4.3875f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	func_154(uParam0, -4.5875f, 6.7625f, 0.85f, -65.75f, 1.5f, 1.5f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	func_155(uParam0, 1);
	func_156(uParam0, joaat("P_BRUSHHORSE01X"), 0.0f, 0.0f, 0.0f, "BRUSH", 0, 1, 1);
	func_156(uParam0, joaat("P_CIGARETTE_CS01X"), 0.0f, 0.0f, 0.0f, "CIGARETTE", 0, 1, 1);
	...
	func_159(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_HORSE_TEND_BRUSH_LINK"), "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 2.0f, 1065353216, 1);
...
bool func_93(var uParam0)
{
	...
	if (func_203(uParam0, iLocal_17))
	{
		...
		if (ANIMSCENE::GET_ANIM_SCENE_PHASE(iVar0) > 0.85f)
		{
			if (bLocal_18)
			{
		...
		else if (ANIMSCENE::GET_ANIM_SCENE_PHASE(iVar0) > 0.23f)
		{
			if (!bLocal_18)
			{
				iLocal_20 = func_205(uParam0, 1.075f, 1.014f, 0.6f, 0.0f, 2.0f, 2.0f, 2.5f, joaat("VOLCYLINDER"), 1);
	...
	{
		TASK::TASK_START_SCENARIO_IN_PLACE_HASH(func_48(uParam0, iLocal_16), joaat("STAND"), 45000, false, 0, 1.0f, false);
	}
	return true;
}
...
int func_143(var uParam0)
{
	if (UIAPPS::IS_UIAPP_ACTIVE_BY_HASH(joaat("FAST_TRAVEL_MENU")))
	{
		...
		PERSCHAR::_0xD4B614179BCD0654(func_219(10, 0));
		func_35(uParam0);
		return 1;
	}
	return 0;
