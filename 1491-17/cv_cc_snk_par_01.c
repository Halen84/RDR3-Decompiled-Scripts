...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			break;
		case 2:
			func_150(uParam0, 679.62f, -1269.801f, 42.8451f, 0.0f, 0.0f, -117.21f);
			break;
		default:
			return false;
	}
	...
	{
		func_155(uParam0, 1.9376f, -0.875f, 1.4875f, 0.0f, 2.1625f, 2.2275f, 3.2075f, joaat("VOLBOX"), -1, 1, 1, 1);
	}
	iLocal_17 = func_156(uParam0, joaat("P_BOTTLEBEER01X"), 0.0f, 0.0f, 0.0f, "p_bottlebeer01x", 0, 0, 1);
	iLocal_18 = func_156(uParam0, joaat("P_BOTTLEJD01X"), 0.0f, 0.0f, 0.0f, "p_bottleJD01x", 0, 0, 1);
	if (!func_152(14))
	{
...
void func_166(var uParam0, int iParam1, Vector3 vParam2, float fParam5, int iParam6, bool bParam7)
{
	if (bParam7)
	{
		vParam2 = { func_261(uParam0, vParam2) /*3*/ };
...
void func_214(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_313(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
int func_301(var uParam0, int iParam1)
{
	...
	if (func_313(uParam0, iParam1, 1.0f))
	{
		return 1;
	}
...
void func_311(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_263(100.0f, 140.0f);
			}
		}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_331(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_394(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
