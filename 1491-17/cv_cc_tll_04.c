...
void __SCRIPT()
{
	...
	fLocal_7 = 1.0f;
	fLocal_8 = 1.0f;
	iLocal_48 = joaat("CAMP_CONVO_PROP_WASHBOARD");
	sVar0 = -1;
	sVar0.f_1 = -1;
	sVar0.f_2 = -1;
	sVar0.f_17 = 10;
...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 2:
			...
			vLocal_45 = { 678.39f, -1265.06f, 42.98f /*3*/ };
			break;
		case 3:
			func_149(uParam0, 200, 0, 0, 0);
			vLocal_45 = { 1882.42f, -1882.1f, 41.81f /*3*/ };
			break;
		default:
			return false;
	}
	...
	func_151(uParam0, 1.75f, 2.9675f, 0.85f, -65.75f, 1.0f, 1.0f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	func_151(uParam0, 0.0625f, -0.275f, 0.85f, 0.0f, 1.0f, 1.0f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, 1.3125f, -0.8375f, 0.85f, 0.0f, 1.0f, 1.0f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, 0.75f, -0.5f, 0.0f, -18.0f, 1.53f, 0.8f, 3.0f, joaat("VOLCYLINDER"), 1);
	func_153(uParam0, joaat("P_KNITTINGNEEDLE01X"), 0.0f, 0.0f, 0.0f, "KNITTINGNEEDLE1", 0, 1, 1);
	func_153(uParam0, joaat("P_KNITTINGNEEDLE01X"), 0.0f, 0.0f, 0.0f, "KNITTINGNEEDLE2", 0, 1, 1);
	func_153(uParam0, joaat("P_CS_SOCK01X"), 0.0f, 0.0f, 0.0f, "SOCK1", 0, 1, 1);
	func_153(uParam0, joaat("P_CS_SOCK01X"), 0.0f, 0.0f, 0.0f, "SOCK2", 0, 1, 1);
	iLocal_24 = func_153(uParam0, joaat("P_WASHBOARD01X"), 0.0f, 0.0f, 0.0f, "WASHBOARD", 0, 1, 1);
	iLocal_23 = func_153(uParam0, joaat("P_CS_RAG02X"), 0.0f, 0.0f, 0.0f, "RAG", 0, 1, 1);
	iLocal_21 = func_153(uParam0, joaat("P_CHAIR_CRATE15X"), 0.0f, 0.0f, 0.0f, 0, 1, 0, 1);
	...
	func_157(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_WASHBOARD"), "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 10.0f, 1065353216, 1);
	...
	sLocal_35 = { func_161(uParam0, 0.3025f, -0.8575f, 1.8254f, 100.75f, 5.5f, 0.1025f, 0.6825f) /*10*/ };
	sLocal_25 = { func_161(uParam0, 0.303f, -0.858f, 1.8254f, 176.75f, 5.5f, 0.115f, 0.7425f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	if (!bLocal_49)
	{
		if (func_199(uParam0, iLocal_17))
		{
			...
			else if (func_200(uParam0, sLocal_35, 1, 0))
			{
...
bool func_95(var uParam0)
{
	...
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_45, 1.0f))
	{
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(iLocal_48, true);
		return true;
	}
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_257(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	switch (func_487(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_489(iParam0, 1))
			{
				...
				if (!func_477(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_477(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_478(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
