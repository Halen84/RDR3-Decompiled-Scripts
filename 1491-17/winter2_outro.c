...
void func_30(var uParam0, int iParam1)
{
	...
	{
		func_70(Global_35, joaat("CLOTHING_ITEM_NECKWEAR_NONE"), 0, joaat("MP_COMPONENT_TYPE_NECKWEAR_1"), 0, 1, 0, 0, 1, 0);
	...
	if (func_184(iParam0, 1, 0))
	{
		if (func_185(iParam0))
		{
			...
			if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(iVar0))
			{
				...
				if ((bParam1 || !func_186(func_79(iParam0), 1116471296, -1082130432, -1082130432, -1082130432)) || CAM::IS_SCREEN_FADED_OUT())
				{
...
struct<5> /*40*/ func_119(bool bParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_190(bParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_131(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_192(bParam0, 1))
			{
				...
				if (!func_193(bParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_193(bParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_194(bParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_131(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
...
int func_207(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	iVar0 = func_245(0);
	if (iParam2 != 0 && func_246(bParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
int func_233(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_263("ALL WEAPONS", &iVar1, &iVar2, joaat("SLOTID_NONE"), 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_262(iParam1, (1 << 9)) && func_239(sVar4.f_4, &uVar19, &sVar23, joaat("SLOTID_WEAPON_0"))) && !sVar23.f_21)
			{
			}
