...
bool func_73(var uParam0)
{
	...
	{
		case 1:
			func_150(uParam0, -149.1513f, -16.0276f, 95.3f, 0.0f, 0.0f, 79.21f);
			break;
		case 2:
			func_150(uParam0, 689.8932f, -1253.845f, 43.65f, 0.0f, 0.0f, -16.89f);
			break;
		default:
			return false;
	}
	...
	func_152(uParam0, 1.1566f, -0.516f, 0.0f, 31.68f, 2.0f, 3.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	if (iVar0 == 1)
	{
	...
	{
		func_153(uParam0, joaat("P_PILLOW01X"), 0.0f, 0.0f, 0.0f, "Pillow", 0, 0, 1);
	}
	...
	func_158(uParam0, iLocal_15, 2, joaat("WORLD_CAMP_JACK_SLEEP"), "WORLD_CAMP_JACK_SLEEP", -1, 1, 240.0f, 1065353216, 1);
	func_162(uParam0, 1);
	func_163(uParam0, iLocal_14, 1094713344, 1092616192);
	sLocal_17 = { func_164(uParam0, 1.2363f, -0.1641f, 1.0444f, 120.96f, 7.0f, 0.5f, 0.5f) /*10*/ };
	iLocal_29 = func_165(uParam0, 0.5875f, -1.025f, 0.95f, 0.0f, 0.0f, 80.98939f, 1.1f, 1.1f, 1.38f, "Grief", joaat("VOLCYLINDER"));
	func_166(uParam0, 1);
	return true;
}
...
{
	return func_198(uParam0, sLocal_17, 1, 0);
}
...
int func_165(var uParam0, Vector3 vParam1, Vector3 vParam4, Vector3 vParam7, char* sParam10, int iParam11)
{
	...
	vVar1 = { func_257(uParam0, vParam1) /*3*/ };
...
int func_198(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
void func_393(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_427(func_105(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_428(iParam0);
