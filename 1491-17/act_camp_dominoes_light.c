...
bool func_2()
{
	...
	switch (iLocal_37)
	{
		...
		case 1:
			...
			if (((((bVar0 && !PED::IS_PED_CARRYING_SOMETHING(Global_35)) && func_15(1)) && !Global_1327590.f_19745) && !TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1)) && !(WEAPON::GET_CURRENT_PED_WEAPON(Global_35, &iVar2, true, 0, true) && (iVar2 == joaat("WEAPON_KIT_CAMERA") || iVar2 == joaat("WEAPON_KIT_BINOCULARS"))))
			{
				if (!MAP::DOES_BLIP_EXIST(iLocal_30))
				{
					iLocal_30 = MAP::BLIP_ADD_FOR_COORDS(joaat("BLIP_STYLE_MINIGAME"), vLocal_19);
					switch (func_16())
					{
						case 1:
					...
					iVar3 = func_18(joaat("CA_DOMINOES_CAMP"));
					if (iVar3 != 0)
					{
				...
				{
					MAP::BLIP_REMOVE_MODIFIER(iLocal_30, joaat("BLIP_MODIFIER_LOCKED"));
				}
				if (!func_4(iLocal_14))
				{
					iLocal_14 = func_20(func_19(joaat("CA_DOMINOES_CAMP")), joaat("INPUT_CONTEXT_X"), vLocal_19, fLocal_23, 1, 1, 0, 5, 570, 4000, 10, (1 << 30), 0, joaat("MEDIUM_TIMED_EVENT"), 0);
				}
				else
				{
			...
			else
			{
				if (MAP::DOES_BLIP_EXIST(iLocal_30))
				{
					MAP::BLIP_ADD_MODIFIER(iLocal_30, joaat("BLIP_MODIFIER_LOCKED"));
				}
				if (func_4(iLocal_14))
				{
			...
			if (bVar0)
			{
				if (func_27(iLocal_14, 1))
				{
					...
					if (!VOLUME::DOES_VOLUME_EXIST(iLocal_31))
					{
						iLocal_31 = VOLUME::CREATE_VOLUME_SPHERE(vLocal_19, 0.0f, 0.0f, 0.0f, 3.0f, 3.0f, 3.0f);
						uLocal_32 = PED::_ADD_SCENARIO_BLOCKING_VOLUME(iLocal_31, false, 15);
			...
			else
			{
				...
				if (ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_44, true, false))
				{
					if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(iLocal_44, "PL_INTRO"))
					{
						...
						func_43(vLocal_19, 4.0f, 0);
						iVar5 = func_44(vLocal_19, joaat("P_BOWL04X"), 4.0f, 1);
						if (ENTITY::DOES_ENTITY_EXIST(iVar5))
						{
							OBJECT::DELETE_OBJECT(&iVar5);
						}
						iVar5 = func_44(vLocal_19, joaat("P_BOWL04X_STEW"), 4.0f, 1);
						if (ENTITY::DOES_ENTITY_EXIST(iVar5))
						{
							OBJECT::DELETE_OBJECT(&iVar5);
						}
		...
		case 4:
			if (func_47(7, func_11(), vLocal_19, fLocal_22, 0, &iLocal_15, 0, 1, 0))
			{
				...
				while (iVar6 < 27)
				{
					...
					{
						AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(func_30(iVar6), "Minigame_Non_Participant_Ped_group", 0.0f);
					}
					iVar6++;
				}
				func_35(&uLocal_24);
		...
		case 6:
			...
			while (iVar7 < 27)
			{
				...
				{
					AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(func_30(iVar7), 0.0f);
				}
				iVar7++;
			}
			iVar8 = 0;
...
bool func_13(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_69(iVar0) && func_70(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
bool func_15(int iParam0)
{
	...
	if (func_10(func_72(iParam0, func_16()), 6.0f, 4, 1))
	{
		return false;
	}
	if (func_73(&(Global_1391438.f_5), (1 << 11)))
	{
		return false;
	}
	...
	switch (iParam0)
	{
		case 0:
			...
			if (!func_77(joaat("CA_POKER_CAMP")))
			{
				return false;
			}
			if (!(iVar2 < 2 || iVar2 > 10))
			...
			if (func_78(joaat("CA_POKER_CAMP")))
			{
				return false;
			}
			break;
		case 1:
			...
			if (func_73(&(Global_1391438.f_5), (1 << 9)))
			{
				return false;
			}
			...
			if (!func_77(joaat("CA_DOMINOES_CAMP")))
			{
				return false;
			}
			if (!(iVar2 > 6 && iVar2 < 20))
			...
			if (func_78(joaat("CA_DOMINOES_CAMP")))
			{
				return false;
			}
			break;
		case 2:
			...
			if (func_73(&(Global_1391438.f_5), (1 << 10)))
			{
				return false;
			}
...
int func_20(char* sParam0, int iParam1, Vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_82(iVar0, 2))
		{
			if (func_83(vParam2, Global_1945188[iVar0 /*18*/].f_6, 0.01f, 1) && iParam1 == Global_1945188[iVar0 /*18*/].f_4)
			{
				iVar2 = iVar0;
				return iVar2;
			}
	...
	while (iVar0 < 27)
	{
		...
		else if (func_29(iVar0) && !func_105(iVar0))
		{
			if (ENTITY::IS_ENTITY_IN_VOLUME(func_30(iVar0), *iParam0, true, 0))
			{
				...
				PERSCHAR::_RETASK_PERSISTENT_CHARACTER(func_106(iVar0, 0));
			}
		}
		iVar0++;
	}
...
int func_44(Vector3 vParam0, int iParam3, float fParam4, bool bParam5)
{
	...
	fVar2 = (fParam4 * 2.0f);
	func_107(&iVar0, vParam0, 0.0f, 0.0f, 0.0f, fVar2, fVar2, fVar2);
...
bool func_47(int iParam0, int iParam1, Vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	...
	if (SCRIPTS::HAS_SCRIPT_WITH_NAME_HASH_LOADED(iVar14))
	{
		...
		sVar15.f_13 = iParam9;
		if (func_122(iParam0, &sVar15, &uVar49, 0, 1))
		{
			if (iParam8 == 1)
			{
				func_121(vVar4.y, 0);
...
bool func_59(int iParam0, bool bParam1)
{
	...
	return PED::IS_PED_GROUP_MEMBER(iVar0, func_134(), true);
}
...
void func_61(Vector3 vParam0, int iParam3)
{
	...
	while (iVar0 < Global_1911670)
	{
		...
		if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(iVar1))
		{
			...
			if (func_83(vVar2, vParam0, 2.0f, 1))
			{
...
bool func_91(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((Global_1898164.f_163 && !func_155(iParam0, 1)) || func_156((1 << 15)))
	{
		if (!func_155(iParam0, (1 << 18)) || !Global_1905944.f_5696)
		{
			return false;
		}
	}
...
int func_114(var uParam0, bool bParam1, int iParam2)
{
	...
	bVar1 = func_172(uParam0->f_1, (1 << 17));
	...
	if (bParam1)
	{
		func_175(uParam0->f_1, (1 << 16));
		if ((uParam0->f_1 == 1 || uParam0->f_1 == 2) || uParam0->f_1 == 0)
		{
			func_175(uParam0->f_1, (1 << 21));
		}
	}
	if (bVar1)
	{
		func_175(uParam0->f_1, (1 << 17));
	}
...
bool func_154(int iParam0)
{
	...
	if (!func_155(iParam0, (1 << 16)) && !func_155(iParam0, (1 << 15)))
	{
		return false;
	}
	iVar0 = 0;
	while (iVar0 < Global_40.f_7756)
	{
		if (Global_40.f_7756[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			if (iVar2 < 1800 && func_155(iParam0, (1 << 15)))
			{
				return true;
			}
		}
...
bool func_160(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_214(iParam0, (1 << 31)))
	{
		return true;
	}
	if (func_214(iParam0, (1 << 30)))
	{
		return true;
	}
...
bool func_182(int iParam0, Vector3 vParam1, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	func_233(&iVar5, vVar0, 0.0f, 0.0f, 0.0f, fVar8, fVar8, 1.8f);
...
void func_186(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_71(func_117(0)))
	{
		...
		{
			func_241(&Global_0, (1 << 10));
		}
		if (func_54() == -1)
		{
			func_242(&(Global_1347343.f_11), (1 << 29));
			func_243(2);
			Global_1357515 = -1;
			if (iVar0 == 1)
			{
...
void func_197(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_177(iParam0) == 3 || (func_177(iParam0) == 1 && STATS::STATSTRACKER_IS_INITIALIZED(func_227(iParam0))))
	{
		...
		if ((!func_71(Global_1572864.f_8) && !func_13(0, 1, 0)) && !func_263(Global_1935630, (1 << 15)))
		{
...
{
	if (!bParam0 && func_297(joaat("WS_GUARMA_EXISTS")))
	{
		return 0;
	}
...
float func_337()
{
	...
	func_353(3, fVar9, fVar9 > 100.0f);
	return func_354(fVar7, -100.0f, 100.0f);
}
