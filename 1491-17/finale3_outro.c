...
void __SCRIPT()
{
	...
	func_2(&sLocal_67, &uScriptParam_0);
	while (!func_3(&sLocal_67))
	{
		func_4(&sLocal_67);
		switch (func_5(sLocal_67))
		{
			case 0:
				if (func_6(&sLocal_67))
				{
...
bool func_6(var uParam0)
{
	...
	iVar0 = 1;
	if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_9, true, false))
	{
		iVar0 = 0;
	}
	...
	bLocal_11 = func_21(13, 1, 1, -1557.32f, -1433.23f, 94.08f, 89.95f, 1, 0, 0, 0, 0, 0, -2040275819, 0, 0, 0, 1, 1, 1, 0, 0, 1, 0, 1);
	if (!ENTITY::DOES_ENTITY_EXIST(bLocal_11))
	{
		iVar0 = 0;
	}
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_11) && !func_22(13, bLocal_11, -2040275819))
	{
		iVar0 = 0;
	}
	return iVar0;
...
void func_19(var uParam0)
{
	...
	iLocal_58[0] = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(joaat("VOLCYLINDER"), -1555.683f, -1417.174f, 90.1822f, 0.0f, 0.0f, -19.67098f, 2.626542f, 18.71136f, 3.681293f);
	iLocal_58[1] = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(joaat("VOLCYLINDER"), -1558.386f, -1430.378f, 93.68977f, 0.0f, 0.0f, -29.25712f, 1.25935f, 3.725714f, 1.587422f);
	iLocal_58[2] = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(joaat("VOLCYLINDER"), -1560.36f, -1436.362f, 93.68977f, 0.0f, 0.0f, -2.146133f, 1.0f, 3.464732f, 1.587422f);
	iLocal_58[3] = VOLUME::_CREATE_ANTI_GRIEF_VOLUME(joaat("VOLCYLINDER"), -1572.138f, -1442.667f, 90.88407f, 0.0f, 0.0f, 126.3318f, 3.18645f, 15.24051f, 4.382712f);
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_54(Global_1360165[iParam0 /*1157*/], vVar0, fParam6, 2, (1 << 30));
			}
			else if (bParam16)
			{
...
bool func_22(int iParam0, bool bParam1, int iParam2)
{
	if (!ENTITY::IS_ENTITY_DEAD(bParam1) && !iLocal_12[iParam0])
	{
		func_63(iParam0, bParam1, iParam2);
		if (!func_64(bParam1))
		{
			return false;
		}
		func_56(iParam0, iParam2, 1);
		func_57(iParam0, bParam1, iParam2, 1);
		iLocal_12[iParam0] = 1;
		return false;
	}
	return true;
...
{
	PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_11, true);
	ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_9, "ABIGAIL", bLocal_11, 0);
	...
	switch (iLocal_41)
	{
		case 0:
			if (CAM::IS_SCREEN_FADING_IN() || CAM::IS_SCREEN_FADED_IN())
			{
				...
				func_67(Global_35, bLocal_11, &sVar0, 0.0f, 0.0f, 0.0f, 0, 0, 1, 1069547520, -1082130432, 1073069561, 1056964608, 1092616192, -1, 1, 0, 0, 0, 1);
				func_68(bLocal_11, Global_35, &sVar0, -1082130432, 0, 0, -1082130432, -1082130432, 1, 8, 0, 0, 1069547520, (1 << 30), 1050253722, 1067030938, 0, 0, -1, 1, -1082130432, -1082130432, 1);
				iLocal_41++;
			}
			break;
		case 1:
			func_69(Global_35, bLocal_11, 1, 1, 1, 0, 1, 1, 0, 1, 1);
			func_70(bLocal_11, Global_35, 1, 1, 1, 0, 1, 1, 0, 1, 1);
			PLAYER::SET_PLAYER_MAY_NOT_ENTER_ANY_VEHICLE(PLAYER::PLAYER_ID());
			PLAYER::_SET_PLAYER_RESET_FLAG(PLAYER::PLAYER_ID(), 28, true);
			if (bLocal_63)
			{
				func_71(&cLocal_42, bLocal_11);
			}
			else if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_10, false) && CAM::GET_LETTER_BOX_RATIO() == 0.0f)
			{
				func_72(&cLocal_42);
				bLocal_63 = true;
			}
			if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_10, false) && !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
			{
				PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0, false);
			}
			if ((!ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_9, false) && !ANIMSCENE::IS_ANIM_SCENE_FINISHED(iLocal_9, false)) && func_73(&uLocal_64) >= 2.0f)
			{
				ANIMSCENE::START_ANIM_SCENE(iLocal_9);
			}
			if (ANIMSCENE::IS_ANIM_SCENE_FINISHED(iLocal_9, false))
			{
				return true;
			}
			break;
...
void func_41(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		PED::SET_PED_CONFIG_FLAG(func_81(iParam0), 137 /*PCF_0xE18960DE*/, true);
	}
}
...
void func_43(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		PED::SET_PED_CONFIG_FLAG(func_81(iParam0), 204 /*PCF_0x435F091E*/, true);
	}
	else
	{
		PED::SET_PED_CONFIG_FLAG(func_81(iParam0), 204 /*PCF_0x435F091E*/, false);
	}
}
...
void func_45(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_81(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_83(iParam0) < 10000.0f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_51(int iParam0, Vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_94(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) /*7*/ };
			if (!bParam6)
			{
				func_37(iParam0, 44, 1);
			}
...
void func_57(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(bParam1))
	{
		if (func_103(iParam2))
		{
			...
			if (func_105(bParam1, iVar0))
			{
				if (func_106(bParam1, iVar0))
				{
					if (func_107(bParam1, iVar0))
					{
...
void func_67(int iParam0, bool bParam1, var uParam2, Vector3 vParam3, char* sParam6, int iParam7, int iParam8, float fParam9, float fParam10, float fParam11, float fParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	struct<10> /*80*/ sVar0;
	struct<10> /*80*/ sVar11;
	...
	else if (!func_117(vParam3, 0.0f, 0.0f, 0.0f))
	{
		sVar11.f_0 = 0;
	...
	if (bParam19)
	{
		func_118(iParam0, bParam1, iParam14);
	}
}

void func_68(bool bParam0, bool bParam1, var uParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, bool bParam8, int iParam9, float fParam10, float fParam11, float fParam12, float fParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	struct<7> /*56*/ sVar0;
	...
	{
		TASK::TASK_FOLLOW_AND_CONVERSE_WITH_PED(bParam0, bParam1, iParam4, iParam5, fParam6, fParam7, iParam9, fParam10, fParam11, fParam12, fParam13);
	}
	if (bParam19)
	{
	...
	if (bParam22)
	{
		func_118(bParam0, bParam1, iParam18);
	}
}

void func_69(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	if (ENTITY::IS_ENTITY_DEAD(iParam0))
	{
	}
...
void func_70(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	if (ENTITY::IS_ENTITY_DEAD(bParam0))
	{
	}
	...
	if (bParam8)
	{
		PED::SET_PED_RESET_FLAG(bParam0, 229 /*PRF_0xB5071147*/, true);
	}
	if (PED::IS_PED_A_PLAYER(bParam0))
	{
		if (bParam3 && PED::GET_PED_CROUCH_MOVEMENT(bParam0))
		{
			PED::_SET_PED_CROUCH_MOVEMENT(bParam0, false, 0, false);
		}
		func_119(bParam4, bParam5, bParam6, bParam7, bParam3, bParam9, bParam10);
		if (bParam2)
		{
			PED::SET_PED_RESET_FLAG(bParam0, 188 /*PRF_0x8DF01625*/, true);
		}
	}
}
...
int func_88(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_38(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_124(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000.0f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_126(iParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_127(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_127(iParam0, 0));
					func_128(iParam0);
				}
			}
			else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_132(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_130(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<7> /*56*/ func_94(int iParam0, int iParam1, Vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	struct<7> /*56*/ sVar0;
...
void func_109(int iParam0, bool bParam1, bool bParam2)
{
	...
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & 1) > 0 && func_105(bParam1, 860729266))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, 860729266);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 12)) > 0 && func_105(bParam1, 879715242))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, 879715242);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & 128) > 0 && func_105(bParam1, 1606325429))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, 1606325429);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & 256) > 0 && func_105(bParam1, 1743550585))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, 1743550585);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 9)) > 0 && func_105(bParam1, 1064646155))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, 1064646155);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 10)) > 0 && func_105(bParam1, -536694793))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, -536694793);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 11)) > 0 && func_105(bParam1, -1304053509))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, -1304053509);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 31)) > 0 && func_105(bParam1, 718939204))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, 718939204);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 16)) > 0 && func_105(bParam1, -972364774))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, -972364774);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 14)) > 0 && func_105(bParam1, -1100875244))
	{
	...
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 18)) > 0 && func_105(bParam1, 1153596794))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, 1153596794);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 19)) > 0 && func_105(bParam1, 1016389820))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, 1016389820);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 20)) > 0 && func_105(bParam1, -726966617))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, -726966617);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 21)) > 0 && func_105(bParam1, 1365901568))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, 1365901568);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 15)) > 0 && func_105(bParam1, -1658942149))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, -1658942149);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 17)) > 0 && func_105(bParam1, -1980913856))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, -1980913856);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 22)) > 0 && func_105(bParam1, 491764525))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, 491764525);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 23)) > 0 && func_105(bParam1, -76015264))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, -76015264);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 24)) > 0 && func_105(bParam1, 622113465))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, 622113465);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 25)) > 0 && func_105(bParam1, 781533162))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, 781533162);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 26)) > 0 && func_105(bParam1, -271415321))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, -271415321);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 27)) > 0 && func_105(bParam1, -1683207356))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, -1683207356);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 28)) > 0 && func_105(bParam1, -254794762))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, -254794762);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 29)) > 0 && func_105(bParam1, 609066278))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, 609066278);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 30)) > 0 && func_105(bParam1, -1712783565))
	{
		PED::_EQUIP_META_PED_OUTFIT(bParam1, -1712783565);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 13)) > 0 && func_105(bParam1, 1544915253))
	{
...
void func_110(int iParam0)
{
	...
	func_147(iParam0, (1 << 10));
	func_147(iParam0, (1 << 11));
	func_147(iParam0, (1 << 12));
	func_147(iParam0, (1 << 16));
	func_147(iParam0, (1 << 14));
	func_147(iParam0, (1 << 18));
	func_147(iParam0, (1 << 19));
	func_147(iParam0, (1 << 20));
	func_147(iParam0, (1 << 21));
	func_147(iParam0, (1 << 15));
	func_147(iParam0, (1 << 17));
...
int func_112(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		func_151(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0.0f;
...
void func_118(bool bParam0, bool bParam1, int iParam2)
{
	if (ENTITY::IS_ENTITY_DEAD(bParam0))
	{
	}
...
int func_151(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, iParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_167(iParam0, &sVar0, iVar5, 0))
			{
				if (func_168(iParam0, &sVar6, iVar5))
				{
					sVar29 = { func_169(iParam0, sVar0, iVar5, 0) /*4*/ };
					func_170(iParam0, &sVar29, &sVar0, 1, joaat("REMOVE_REASON_DEFAULT"), 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_171(0))
				{
					...
					func_172(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> /*40*/ func_165(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;

	sVar0 = { func_176(bParam1) /*4*/ };
	...
	switch (func_177(iParam0))
	{
		case joaat("CLOTHING"):
			...
			break;
		case joaat("WEAPON"):
			sVar0 = { func_178(bParam1) /*4*/ };
			if (bParam2 && func_179(iParam0, 1))
			{
				sVar5.f_9 = joaat("SLOTID_NONE");
				if (!func_167(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_167(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_168(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_182(iParam0, joaat("CI_CATEGORY_CAMP")))
			{
			...
			else if (func_182(iParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_169(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("WARDROBE"));
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_183(sVar0, &sVar27, bParam1, 0))
				{
					sVar0.f_4 = 0;
				}
				else
...
struct<4> /*32*/ func_169(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_187(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}
...
bool func_170(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!func_183(*uParam1, &sVar0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_187(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
void func_173(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_190(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> /*32*/ func_176(bool bParam0)
{
...
struct<4> /*32*/ func_178(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_169(joaat("CARRIED_WEAPONS"), func_176(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_169(joaat("CARRIED_WEAPONS"), func_176(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_169(joaat("CARRIED_WEAPONS"), func_176(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_179(int iParam0, bool bParam1)
{
	if (func_181(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
struct<4> /*32*/ func_180(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_169(joaat("EMOTE_ITEM"), func_176(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_169(joaat("EMOTE_ITEM"), func_176(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
bool func_183(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_187(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_184(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	sVar0 = { func_169(iParam0, sParam1, iParam5, bParam6) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&sVar0))
	{
		return 0;
	}
	iVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_187(bParam6), &sVar0, false);
	return iVar4;
}
...
bool func_185(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_187(0);
	*uParam1 = { func_169(iParam0, func_178(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
