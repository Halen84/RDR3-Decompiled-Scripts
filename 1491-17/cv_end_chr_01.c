...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			func_149(uParam0, -1597.175f, -1407.71f, 80.955f, 0.0f, 0.0f, -24.82f);
			break;
		default:
			return false;
	}
	iLocal_14 = func_150(uParam0, 7, 0);
	func_151(uParam0, joaat("P_PITCHFORK01X"), 0.0f, 0.0f, 0.0f, "PITCHFORK", 0, 1, 1);
	func_151(uParam0, joaat("P_WHEELBARROW01X"), 0.0f, 0.0f, 0.0f, "WHEELBARROW", 0, 0, 1);
	func_151(uParam0, joaat("P_HAYPILE02X"), 0.0f, 0.0f, 0.0f, "HAYPILE", 0, 0, 1);
	func_151(uParam0, joaat("S_HORSEPOOP01X"), 0.0f, 0.0f, 0.0f, "HORSEPOOP01", 0, 0, 1);
	func_151(uParam0, joaat("S_HORSEPOOP02X"), 0.0f, 0.0f, 0.0f, "HORSEPOOP02", 0, 0, 1);
	func_151(uParam0, joaat("S_HORSEPOOP02X"), 0.0f, 0.0f, 0.0f, "HORSEPOOP02^1", 0, 0, 1);
	func_151(uParam0, joaat("S_HORSEPOOP02X"), 0.0f, 0.0f, 0.0f, "HORSEPOOP02^2", 0, 0, 1);
	func_151(uParam0, joaat("S_HORSEPOOP02X"), 0.0f, 0.0f, 0.0f, "HORSEPOOP02^3", 0, 0, 1);
	func_151(uParam0, joaat("S_HORSEPOOP02X"), 0.0f, 0.0f, 0.0f, "HORSEPOOP02^4", 0, 0, 1);
	func_151(uParam0, joaat("S_HORSEPOOP03X"), 0.0f, 0.0f, 0.0f, "HORSEPOOP03", 0, 0, 1);
	...
	iLocal_18 = func_156(uParam0, 0.0f, 5.38f, 1.95f, 0.0f, 0.0f, -1.0f, 8.64f, 8.12f, 4.0f, "volTriggerBeecherCharles1", joaat("VOLBOX"));
	func_157(uParam0, 1);
...
bool func_93(var uParam0)
{
	...
	{
		if (func_199(Global_35, uParam0->f_29, 0) > (25.0f * 25.0f) && !CAM::IS_SPHERE_VISIBLE(uParam0->f_23, 5.0f))
		{
...
void func_183(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_250(uParam0, uParam0->f_1976.f_1), 1, func_282(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
