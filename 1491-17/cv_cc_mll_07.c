...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -10.5949f, 2.2941f, 1.1367f, -29.0f, 4.5f, 4.5f, 4.0f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
	...
	sLocal_29 = { func_160(uParam0, -8.8956f, 3.1365f, 1.1416f, -131.0f, 10.0f, 0.15f, 0.15f) /*10*/ };
	sLocal_19 = { func_160(uParam0, -8.8956f, 3.1365f, 1.1416f, 68.75f, 15.0f, 0.15f, 0.15f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_199(uParam0, sLocal_29, 1, 0))
		{
			func_190(uParam0, iLocal_17, 1);
		}
		else if (func_199(uParam0, sLocal_19, 1, 0))
		{
	...
	if (func_203(uParam0, iLocal_14))
	{
		...
		TASK::TASK_FLEE_COORD(func_48(uParam0, iLocal_14), 1907.99f, -1817.852f, 40.86853f, 2, 256, 100.0f, -1, 0);
		PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(func_48(uParam0, iLocal_14), false, false);
		func_56(uParam0->f_107[iLocal_14 /*113*/].f_1, 0, 0, 0, 15.0f, 1, 1, 0, 0, 0, 0);
	}
	return true;
}
...
bool func_203(var uParam0, int iParam1)
{
	...
	{
		if (!func_305(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_ANY")))
		{
			return true;
		}
	}
...
void func_275(var uParam0, int iParam1)
{
	...
	else if (!func_305(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
	{
