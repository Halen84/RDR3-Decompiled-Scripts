...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.275f, -0.1f, 0.0f, -16.0f, 5.855f, 3.0f, 5.0f, joaat("VOLBOX"), -1, 1, 1, 1);
	...
	func_157(uParam0, iLocal_14, 1, joaat("WORLD_HUMAN_STAND_WAITING"), 0, -1, 0, 90.0f, 1065353216, 1);
	func_158(uParam0, iLocal_14, 1.5f, 1.0f, 10.0f);
	...
	sLocal_21 = { func_159(uParam0, 2.9764f, -0.9499f, 1.2095f, 167.1853f, 8.0f, 0.56f, 0.21f) /*10*/ };
	sLocal_31 = { func_159(uParam0, 2.3222f, -1.1977f, 1.1786f, 110.1719f, 8.0f, 0.46f, 0.22f) /*10*/ };
	sLocal_41 = { func_159(uParam0, 3.6042f, -0.3755f, 1.2095f, -129.6687f, 8.0f, 0.4f, 0.21f) /*10*/ };
	return true;
}
...
void func_199(var uParam0, int iParam1, int iParam2)
{
	...
	iVar1 = BUILTIN::ROUND(((1000.0f * (float)iParam2) / 4000.0f));
	iVar2 = BUILTIN::FLOOR((BUILTIN::TO_FLOAT(iVar1) / 60.0f));
	iVar1 = (iVar1 % 60);
