...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, joaat("P_CS_ROPE03X"), 0.0f, 0.0f, 0.0f, "ROPE", 0, 1, 1);
	...
	sLocal_20 = { func_155(uParam0, 0.165f, -0.113f, 0.979f, -140.0f, 8.0f, 0.7f, 0.7f) /*10*/ };
...
void func_423(int iParam0, int iParam1)
{
	...
	func_396(iParam1, func_451(iParam1, (1 << 13)), func_451(iParam1, (1 << 14)), 1);
}
