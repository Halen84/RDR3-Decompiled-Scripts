	...
	switch (func_14())
	{
			...
			if (func_15())
			{
				...
				switch (iVar0)
				{
					case joaat("S_MAPROLLED01X"):
						sLocal_5.f_15.f_2 = joaat("DOCUMENT_SERIAL_KILLER_CLUE1");
						break;
					case joaat("S_MAPROLLED02X"):
						sLocal_5.f_15.f_2 = joaat("DOCUMENT_SERIAL_KILLER_CLUE2");
						break;
					case joaat("S_MAPROLLED03X"):
						sLocal_5.f_15.f_2 = joaat("DOCUMENT_SERIAL_KILLER_CLUE3");
						break;
					default:
						break;
				}
		...
		case 2:
			...
			if ((SCRIPTS::HAS_SCRIPT_LOADED(&(sLocal_5.f_25)) && TASK::IS_PED_ACTIVE_IN_SCENARIO(sLocal_5.f_0, 0)) && func_19())
			{
				...
				iLocal_64 = TASK::GET_PROP_FOR_SCENARIO_POINT(sLocal_5.f_6, "Knife");
				iLocal_65 = TASK::GET_PROP_FOR_SCENARIO_POINT(sLocal_5.f_6, "Head");
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_64))
				{
					if (TASK::_DISASSOCIATE_PROP_FROM_SCENARIO(sLocal_5.f_6, "Knife"))
					{
