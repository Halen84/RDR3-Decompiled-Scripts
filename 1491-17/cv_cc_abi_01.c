		...
		else if (func_52(uParam0->f_107[iVar0 /*113*/].f_7))
		{
			...
			else
			{
				...
				if (func_52(uParam0->f_107[iVar0 /*113*/].f_1))
				{
					...
					{
						func_23(uParam0->f_107[iVar0 /*113*/].f_1, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
					}
				}
			}
			iVar0++;
...
bool func_89(var uParam0)
{
	...
	func_167(uParam0, iLocal_15, 1, joaat("WORLD_HUMAN_STARE_STOIC"), 0, -1, 0, 90.0f, 1065353216, 1);
...
void func_304(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		...
		{
			func_23(uParam0->f_107[iParam1 /*113*/].f_1, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
		}
	}
}
