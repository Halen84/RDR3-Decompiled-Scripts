...
bool func_72(var uParam0)
{
	...
	iLocal_16 = func_152(uParam0, joaat("P_STOOL03X"), 0.0f, 0.0f, 0.0f, "stool", 0, 0, 1);
	...
	func_156(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_16, 0, -1073741824, 0.0f, 1);
