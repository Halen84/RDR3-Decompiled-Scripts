...
bool func_76(var uParam0)
{
	...
	func_155(uParam0, -0.0328f, 1.2303f, 0.0f, 0.0f, 1.0f, 1.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_16 = func_156(uParam0, joaat("S_INV_GINSENG01X"), 0.0f, 0.0f, 0.0f, "s_inv_ginseng01x", 0, 1, 1);
	...
	sLocal_17 = { func_162(uParam0, -0.013f, 0.81f, 0.5054f, 1.8007f, 5.5f, 0.65f, 0.65f) /*10*/ };
	func_163(uParam0, 1);
...
bool func_90(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (ANIMSCENE::GET_ANIM_SCENE_ENTITY_LOCATION_DATA(func_196(uParam0, iLocal_15), "s_inv_ginseng01x", &sVar1, false, 0, 2))
		{
			ENTITY::SET_ENTITY_COORDS(iVar0, sVar1, true, false, true, true);
			ENTITY::SET_ENTITY_ROTATION(iVar0, sVar1.f_3, 2, true);
		}
	}
	if (!ENTITY::IS_ENTITY_DEAD(func_9(uParam0, iLocal_14)))
	{
		PED::SET_PED_RESET_FLAG(func_9(uParam0, iLocal_14), 256 /*PRF_0x4779AF94*/, true);
	}
	return true;
}
...
bool func_91(var uParam0)
{
	...
	if (func_197(uParam0))
	{
		iLocal_30 = PED::_GET_PED_REGISTER_PROP(func_9(uParam0, iLocal_14), "p_mortarPestle02x_PH_L_HAND", true);
...
bool func_97(var uParam0)
{
	...
	{
		PED::GIVE_PED_HASH_SCENARIO_PROP(func_9(uParam0, iLocal_14), iLocal_30, "p_mortarPestle02x_PH_L_HAND", joaat("PROP_HUMAN_SEAT_CHAIR_MORTAR_PESTLE"), "PROP_HUMAN_SEAT_CHAIR_MORTAR_PESTLE_MALE_A_MORTAR", true);
	}
	return true;
}
...
{
	if (!func_303(uParam0, sLocal_17, 1, 0))
	{
		func_8(&iLocal_28, 1, 1);
		if (!ENTITY::IS_ENTITY_DEAD(func_9(uParam0, iLocal_14)))
		{
	...
	{
		iLocal_28 = func_304("INTERACT_GREET", joaat("INPUT_INTERACT_LOCKON_POS"), func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		func_305(iLocal_28, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(func_9(uParam0, iLocal_14)), 0, 1);
	}
...
char* func_382(char* sParam0, int iParam1)
{
	...
	return func_432(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
int func_440(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_480(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
