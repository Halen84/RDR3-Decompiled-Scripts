...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.4407f, -0.9511f, 0.5101f, 0.0f, 3.0f, 2.5f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, 0.572576f, -1.05075f, 1.00132f, 0.0f, 1.0f, 1.0f, 3.2075f, joaat("VOLCYLINDER"), 1);
	iLocal_17 = func_153(uParam0, joaat("P_CHAIRFOLDING02X"), 0.0f, 0.0f, 0.0f, 0, 1, 0, 1);
	iLocal_16 = func_153(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 0, 1);
	iLocal_20 = func_153(uParam0, joaat("P_CRATE03X"), -0.0359887f, -1.2f, 0.0f, 0, 0, 0, 1);
	...
	vLocal_30 = { func_154(uParam0, -0.0494653f, -1.12035f, 0.452904f) /*3*/ };
	...
	sLocal_37 = { func_163(uParam0, 0.0093f, -0.0011f, 0.5101f, 172.8f, 6.0f, 0.25f, 0.25f) /*10*/ };
	sLocal_47 = { func_163(uParam0, 0.009f, -0.001f, 0.51f, -128.6f, 6.0f, 0.4f, 0.4f) /*10*/ };
	sLocal_57 = { func_163(uParam0, 0.009f, -0.001f, 0.51f, 123.25f, 6.0f, 0.3f, 0.3f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_202(uParam0, sLocal_47, 1, 0))
		{
			func_193(uParam0, iLocal_23, 1);
		}
		else if (func_202(uParam0, sLocal_57, 1, 0))
		{
	...
	if (!bLocal_36)
	{
		...
		{
			if (func_202(uParam0, sLocal_37, 1, 0))
			{
				func_203(uParam0, iLocal_27, -1, 0.82f);
				func_193(uParam0, iLocal_27, 1);
			}
			else if (func_202(uParam0, sLocal_47, 1, 0))
			{
...
{
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_30, 1.0f))
	{
...
int func_151(var uParam0, Vector3 vParam1, float fParam4, Vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_154(uParam0, vParam1) /*3*/ };
...
struct<10> /*80*/ func_163(var uParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	...
	sVar2 = { func_154(uParam0, vParam1) /*3*/ };
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0 /*15*/].f_5 && !ENTITY::DOES_ENTITY_EXIST(uParam0->f_1711[iVar0 /*15*/].f_10))
			{
				...
				{
					vVar3 = { func_154(uParam0, uParam0->f_1711[iVar0 /*15*/].f_1) /*3*/ };
				}
				else
				{
...
void func_188(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_154(uParam0, uParam0->f_1976.f_1), 1, func_257(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
bool func_271(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1 /*15*/].f_5)
		{
			...
			{
				vVar2 = { func_154(uParam0, uParam0->f_1711[iVar1 /*15*/].f_1) /*3*/ };
			}
			else
			{
