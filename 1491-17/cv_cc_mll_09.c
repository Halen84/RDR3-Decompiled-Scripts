...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 6.5725f, -9.2225f, 0.3367f, -29.0f, 2.0f, 2.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
	func_151(uParam0, 2.76f, -5.9725f, 0.6723f, -29.0f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	...
	sLocal_42 = { func_158(uParam0, 5.5537f, -7.7938f, 0.1144f, 142.54f, 7.0f, 0.5f, 0.5f) /*10*/ };
	sLocal_22 = { func_158(uParam0, 5.5537f, -7.7938f, 0.1144f, -128.52f, 7.0f, 0.5f, 0.5f) /*10*/ };
	sLocal_52 = { func_158(uParam0, 5.5537f, -7.7938f, 0.1144f, 54.36f, 7.0f, 0.5f, 0.5f) /*10*/ };
	sLocal_32 = { func_158(uParam0, 5.5537f, -7.7938f, 0.1144f, -34.2f, 7.0f, 0.5f, 0.571f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_197(uParam0, sLocal_22, 1, 0))
		{
			func_188(uParam0, iLocal_18, 1);
		}
		else if (func_197(uParam0, sLocal_52, 1, 0))
		{
		...
		else if (func_197(uParam0, sLocal_42, 1, 0))
		{
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_253(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
