...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 54:
			...
			func_50(uParam0, 1, "MPDHP_HORSE", iLocal_39, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, -4.0f, 0.0f, 0.0f), (10.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			break;
		case 74:
			...
			func_50(uParam0, 0, "MPDHP_MAN", iLocal_38, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, -2.0f, 0.0f, 0.0f), (10.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			fLocal_46 = MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 4.0f);
			break;
	}
}
				...
				switch (iLocal_9)
				{
					case 0:
						if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
						{
							...
							TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], iLocal_44, uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
						...
						if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
						{
							...
							if (*uParam0 == 54)
							{
								func_70(uParam0->f_20[0 /*14*/], joaat("WORLD_HUMAN_SIT_FALL_ASLEEP"), 0, 0, 0, -1082130432);
								PED::_0xF9CBD46433E36713(Global_35, uParam0->f_20[0 /*14*/], 0.0f, 0.0f, 0.0f, 4.0f, 20.0f, 200.0f, -1.0f, "MPDHP_MAN");
							}
							else
							{
								TASK::TASK_PLAY_ANIM(uParam0->f_20[0 /*14*/], sLocal_43, "respawn_loop", 8.0f, -8.0f, -1, 1, 0.0f, false, 0, false, 0, false);
							}
					...
					case 2:
						...
						{
							if (func_77(&uLocal_40, func_76(*uParam0 == 54, 240.0f, fLocal_46)) || func_78(uParam0->f_20[0 /*14*/], Global_35, 1) < 100.0f)
							{
								PED::SET_PED_SHOULD_PLAY_DIRECTED_NORMAL_SCENARIO_EXIT(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/].f_5);
								TASK::OPEN_SEQUENCE_TASK(&iVar3);
								if (*uParam0 != 54)
								{
									TASK::TASK_PLAY_ANIM(0, sLocal_43, "respawn_action", 8.0f, -8.0f, -1, 0, 0.0f, false, 0, false, 0, false);
								}
								TASK::TASK_MOUNT_ANIMAL(0, uParam0->f_20[1 /*14*/], -1, -1, 1.0f, 1, 0, 0);
					...
					case 3:
						...
						if (func_77(&uLocal_40, 20.0f) && func_78(Global_35, uParam0->f_20[0 /*14*/], 1) > 10000.0f)
						{
							return 1;
						}
						break;
...
bool func_51(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_96(iVar0) && func_97(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
bool func_65(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (Global_1935630.f_26 & func_114(PLAYER::PLAYER_ID(), 0, 1, (uParam2->f_1 & (1 << 19)) == 0))
		{
...
int func_67(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_138(*uParam0, 0.0f, 0.0f, 0.0f))
	{
		return 1;
	}
	iVar1 = 0;
...
bool func_83(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, Vector3 vParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
bool func_85(Vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_155(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1.0f, 0))
			{
				return true;
			}
		}
...
void func_150(int iParam0, Vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_155(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
