...
bool func_75(var uParam0)
{
	...
	{
		case 8:
			func_153(uParam0, -1639.005f, -1361.768f, 83.403f, 0.0f, 0.0f, 148.5f);
			break;
		default:
			return false;
	}
	...
	func_155(uParam0, 36.4401f, -18.1472f, -0.0375f, -33.25f, 1.0f, 1.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	func_155(uParam0, 34.2901f, -18.2597f, -0.0375f, -33.25f, 1.0f, 1.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_155(uParam0, 32.8901f, -19.1347f, -0.0375f, -31.75f, 2.59f, 1.0825f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	iLocal_18 = func_156(uParam0, joaat("P_CS_KNITTING01X"), 3.0f, 3.0f, 0.0f, "Knitting", 0, 0, 1);
	...
	func_161(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", -1, 0, -1073741824, 2.0f, 1);
	...
	func_161(uParam0, iLocal_15, 2, joaat("PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_LEFT"), "PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_MALE_A", -1, 0, 640.0f, 1065353216, 1);
...
bool func_208(var uParam0, int iParam1)
{
	...
	if (func_209(uParam0, iParam1, 1.0f))
	{
		return true;
	}
...
void func_216(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_209(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
void func_396(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_426(func_108(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_427(iParam0);
