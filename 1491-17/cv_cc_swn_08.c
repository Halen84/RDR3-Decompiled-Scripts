...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			vLocal_23 = { -148.4072f, -26.36927f, 95.88963f /*3*/ };
			break;
		default:
			return false;
	}
	...
	func_151(uParam0, 2.6814f, 4.64f, 0.0f, 0.0f, 1.2f, 1.2f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	func_151(uParam0, 0.0064f, 0.7775f, 0.0f, 0.0f, 1.2f, 1.2f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_STRAUSS"), 1, 1, 1);
	iLocal_21 = func_152(uParam0, joaat("P_CS_LEDGER01X"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 1, 1);
	iLocal_22 = func_152(uParam0, joaat("P_PEN01X"), 0.0f, 0.0f, 0.0f, "PEN", 0, 1, 1);
	...
	sLocal_27 = { func_155(uParam0, -0.38f, 0.692f, 0.988f, 178.8701f, 6.5f, 0.57f, 0.45f) /*10*/ };
	sLocal_37 = { func_155(uParam0, -0.38f, 0.6924f, 0.988f, -91.6299f, 5.685f, 0.2875f, 0.42f) /*10*/ };
	sLocal_47 = { func_155(uParam0, -0.38f, 0.692f, 0.988f, 92.1201f, 6.5f, 0.5125f, 0.42f) /*10*/ };
...
bool func_93(var uParam0)
{
	...
	{
		if (func_199(uParam0, sLocal_27, 1, 0))
		{
			func_190(uParam0, iLocal_15, 1);
		}
		else if (func_199(uParam0, sLocal_37, 1, 0))
		{
			func_190(uParam0, iLocal_16, 1);
		}
		else if (func_199(uParam0, sLocal_47, 1, 0))
		{
...
bool func_95(var uParam0)
{
	...
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_23, 1.0f))
	{
		TASK::SET_SCENARIO_GROUP_ENABLED("hso_strauss_ledger", true);
		return true;
	}
