				...
				case 2:
					if (((func_61(&(uLocal_173[0]), iLocal_169, 2644.443f, -1207.946f, 52.3368f, 199.0776f, 1, 0, 1) & func_62(&iLocal_175, iLocal_171, 2644.251f, -1208.702f, 53.5354f)) & func_62(&iLocal_176, iLocal_171, 2643.541f, -1208.416f, 53.1764f)) & func_62(&iLocal_177, iLocal_170, 2643.355f, -1208.241f, 52.3474f))
					{
						if (func_9(uLocal_173[0], 0))
						{
							...
							PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, PLAYER::GET_DISCOVERABLE_NAME_HASH_AND_TYPE_FOR_ENTITY(uLocal_173[0], &uLocal_253));
							if (func_38())
							{
				...
				case 28:
					...
					if (func_19(iLocal_190, 2) && !func_19(iLocal_190, 4))
					{
						if (func_19(iLocal_190, 16))
						{
							...
							func_77(1);
							if (func_80(uLocal_173[0], iLocal_189, func_78(), func_79(), 1, 1056964608, 20000) && func_19(iLocal_190, (1 << 17)))
							{
								if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_188))
								{
									if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(iLocal_188, false))
...
void func_30()
{
	...
	if (!VOLUME::DOES_VOLUME_EXIST(iLocal_183))
	{
		iLocal_183 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2644.566f, -1208.341f, 53.3452f, 0.0f, 0.0f, 0.0f, 1.1f, 1.1f, 4.0f, "Close");
	}
...
bool func_108(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_202(iParam0, joaat("CURRENCY_CASH"), iParam1, iVar0);
	}
...
void func_250(int* iParam0, var uParam1, var uParam2)
{
	...
	if (iVar0 != -1)
	{
		...
		{
			func_345(Global_35, *uParam2, sVar1, "", -1082130432, uVar2, 0, 0, 1, 1, 1, joaat("SPEECH_PARAMS_BEAT_SPOKEN_CLEAR"), 1, 0, 0);
		}
	}
}
...
int func_438(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_324(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_442(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
