...
bool func_72(var uParam0)
{
	...
	iLocal_21 = func_151(uParam0, joaat("P_BOTTLEBEER01X"), 0.0f, 0.0f, 0.0f, "p_bottleJD01x", 0, 0, 1);
	iLocal_18 = func_151(uParam0, joaat("P_BOTTLEBEER01X"), 0.0f, 0.0f, 0.0f, "p_bottleJD01x^1", 0, 0, 1);
	iLocal_20 = func_151(uParam0, joaat("P_BOTTLEJD01X"), 0.0f, 0.0f, 0.0f, "p_bottleJD01x^2", 0, 0, 1);
	iLocal_19 = func_151(uParam0, joaat("P_BOTTLEBEER01X"), 0.0f, 0.0f, 0.0f, "p_bottleJD01x^3", 0, 0, 1);
	iLocal_22 = func_151(uParam0, joaat("P_BOTTLECRATE02X"), 0.0f, 0.0f, 0.0f, "p_bottlecrate02x", 0, 0, 1);
	iLocal_23 = func_151(uParam0, joaat("P_CHAIR_BARREL04B"), 0.0f, 0.0f, 0.0f, "p_chair_barrel04b", 1, 0, 1);
	iLocal_24 = func_151(uParam0, joaat("P_CHAIR_CRATE02X"), 0.0f, 0.0f, 0.0f, "p_chair_crate02x", 1, 0, 1);
	iLocal_25 = func_151(uParam0, joaat("P_CHAIR_CRATE15X"), 0.0f, 0.0f, 0.0f, "p_chair_crate15x", 1, 0, 1);
	iLocal_26 = func_151(uParam0, joaat("S_CRATESEAT03X"), 0.0f, 0.0f, 0.0f, "s_crateseat03x", 1, 0, 1);
	func_152(uParam0, -0.0375f, 0.0f, 0.8695f, 90.75f, 3.1375f, 3.5075f, 2.045f, joaat("VOLBOX"), -1, 1, 1, 1);
	...
	func_157(uParam0, iLocal_16, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_24, 0, 25.0f, 1065353216, 1);
	func_158(uParam0, iLocal_16, iLocal_20, "p_bottleJD01x_ph_r_hand", 0, 0);
	func_159(uParam0, iLocal_16, 4, 2, 0, 0, 0);
	func_157(uParam0, iLocal_17, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", iLocal_23, 0, 47.0f, 1065353216, 1);
	func_158(uParam0, iLocal_17, iLocal_21, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_159(uParam0, iLocal_17, 4, 2, 0, 0, 0);
	func_157(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_B", iLocal_25, 0, 38.0f, 1065353216, 1);
	...
	func_157(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_FEMALE_A", iLocal_26, 0, 55.0f, 1065353216, 1);
...
bool func_93(var uParam0)
{
	...
	if (bLocal_27)
	{
		fVar0 = ANIMSCENE::GET_ANIM_SCENE_PHASE(uParam0->f_2046);
		if (fVar0 <= 0.135f)
		{
			if (fVar0 > 0.109f && func_199(Global_35, uParam0->f_29, 1) >= 625.0f)
			{
				func_160(uParam0, iLocal_14, 1, -1);
				bLocal_27 = false;
			}
