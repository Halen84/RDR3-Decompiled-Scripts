...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			func_149(uParam0, -1649.056f, -1373.15f, 86.16f, 0.0f, 0.0f, 0.0f);
			break;
		default:
			return false;
	}
	...
	sLocal_24 = { func_151(uParam0, 14.655f, 9.502f, -1.942f, 180.0f, 7.56f, 0.239f, 0.5075f) /*10*/ };
	sLocal_34 = { func_151(uParam0, 14.655f, 9.5f, -1.942f, -120.0f, 3.4875f, 0.405f, 0.45f) /*10*/ };
	sLocal_44 = { func_151(uParam0, 14.655f, 9.5f, -1.942f, -51.0f, 5.0f, 0.4025f, 0.4f) /*10*/ };
	...
	func_157(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_CROUCH_INSPECT"), "WORLD_HUMAN_CROUCH_INSPECT_MALE_C", -1, 1, 1.0f, 1065353216, 1);
...
bool func_93(var uParam0)
{
	...
	{
		if (func_197(uParam0, sLocal_44, 1, 0))
		{
			iLocal_18 = iLocal_23;
		}
		else if (func_197(uParam0, sLocal_24, 1, 0))
		{
			iLocal_18 = iLocal_21;
		}
		else if (func_197(uParam0, sLocal_34, 1, 0))
		{
			iLocal_18 = iLocal_22;
		}
		else
...
struct<10> /*80*/ func_151(var uParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	float fVar0;
	float fVar1;
	struct<10> /*80*/ sVar2;
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0 /*113*/].f_32.f_32 > -1)
			{
				...
				func_294(uParam0->f_107[iVar0 /*113*/].f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
...
void func_198(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_300(100.0f, 140.0f);
			}
		}
...
int func_345(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_383(fVar9) /*3*/ };
			vVar13 = { func_384(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
void func_418(int iParam0, int iParam1)
{
	...
	func_390(iParam1, func_446(iParam1, (1 << 13)), func_446(iParam1, (1 << 14)), 1);
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_321(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_391(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
