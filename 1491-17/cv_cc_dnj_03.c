...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 2.0f, -1.0f, 0.0f, -7.92f, 5.0f, 5.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	iLocal_21 = func_152(uParam0, joaat("P_BOWL04X_STEW"), 0.0f, 0.0f, 0.0f, "BOWL", 0, 0, 1);
	func_152(uParam0, joaat("P_SPOON01X"), 0.0f, 0.0f, 0.0f, "SPOON", 0, 0, 1);
	...
	iLocal_20 = func_155(uParam0, 4.475f, 3.5762f, 2.4264f, 0.0f, 0.0f, 169.265f, 16.4725f, 17.09f, 5.0f, "Start_Trigger", joaat("VOLBOX"));
	func_156(uParam0, 1);
	sLocal_22 = { func_157(uParam0, -0.1365f, -0.621f, 0.9877f, -112.32f, 6.1f, 0.3625f, 0.005f) /*10*/ };
	sLocal_32 = { func_157(uParam0, -0.1185f, -0.6235f, 0.9877f, -147.24f, 3.475f, 0.384f, 0.7465f) /*10*/ };
...
{
	ENTITY::_0x669655FFB29EF1A9(func_189(uParam0, iLocal_21), 0, "Stew_Fill", 1.0f);
	return true;
}
...
bool func_93(var uParam0)
{
	if (func_198(uParam0, iLocal_14))
	{
		...
		else if (func_199(uParam0, sLocal_32, 1, 1))
		{
