...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_48(uParam0, 0, "BL_BIRD_1", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.0f, 5.0f, -20.0f), (0.0f + vParam4.z), iVar0, 1, 1, 1, iLocal_10, 1);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[2])
	{
		if (func_62(uParam0, &uLocal_11, 0) || func_63(Global_35, uParam0->f_483, 1) < 64.0f)
		{
	...
	switch (iLocal_39)
	{
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				if (func_63(Global_35, uParam0->f_483, 1) < func_67(PED::IS_PED_ON_MOUNT(Global_35), 1600.0f, 400.0f))
				{
					if (CAM::IS_SPHERE_VISIBLE(uParam0->f_483, 1.0f))
					{
						if (!ENTITY::WOULD_ENTITY_BE_OCCLUDED(uParam0->f_20[0 /*14*/].f_2, uParam0->f_483, true))
						{
							vVar0 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_483, uParam0->f_486.f_2, 0.0f, -35.0f, 1.0f) /*3*/ };
							if (!CAM::IS_SPHERE_VISIBLE(vVar0, 0.25f))
							{
								...
								func_64(uParam0);
								func_69(uParam0->f_20[0 /*14*/], vVar0, func_68(vVar0, uParam0->f_483), 0, (1 << 30));
								PED::FORCE_PED_MOTION_STATE(uParam0->f_20[0 /*14*/], joaat("MOTIONSTATE_FLYING"), false, 0, false);
								TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], iLocal_40, uParam0->f_483, uParam0->f_20[0 /*14*/].f_8, 0, true, false, 0, -1.0f, false);
		...
		case 4:
			if (!uParam0->f_469[0])
			{
				if (func_63(uParam0->f_20[0 /*14*/], uParam0->f_483, 1) < 1.0f)
				{
...
float func_68(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5)
{
