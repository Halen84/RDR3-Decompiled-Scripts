...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -2.4573f, -0.9856f, 0.0289f, 100.97f, 1.5f, 1.9f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	func_152(uParam0, joaat("P_BOTTLEJD01X"), -2.486f, -1.599f, 0.0f, 0, 0, 0, 1);
	...
	sLocal_18 = { func_154(uParam0, -2.4332f, -1.0036f, 0.6719f, 101.3764f, 7.5f, 0.75f, 0.75f) /*10*/ };
...
{
	return func_191(uParam0, sLocal_18, 1, 0);
}
