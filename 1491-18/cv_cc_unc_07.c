...
bool func_1(var uParam0)
{
	...
	else if ((MISC::GET_GAME_TIMER() > iLocal_18 && ENTITY::IS_ENTITY_OCCLUDED(func_9(uParam0, iLocal_14))) && func_10(Global_35, func_9(uParam0, iLocal_14), 1) > 225.0f)
	{
...
void func_55(var uParam0, int iParam1, bool bParam2)
{
	...
	{
		case 1:
			if (!func_110(&(uParam0->f_107[iParam1 /*113*/].f_32.f_56)) || func_111(&(uParam0->f_107[iParam1 /*113*/].f_32.f_56)) > 1.0f)
			{
				...
				{
					func_113(&(uParam0->f_107[iParam1 /*113*/].f_32.f_56), 0.0f);
				}
			}
			if (!func_110(&(uParam0->f_1693)) || func_111(&(uParam0->f_1693)) > 1.0f)
			{
				if (func_114())
				{
					iVar3 = joaat("ARTHUR");
...
bool func_74(var uParam0)
{
	...
	func_154(uParam0, joaat("P_CS_ROLLUPCIG01X"), 0.0f, 0.0f, 0.0f, "p_cs_rollupcig01x", 0, 1, 1);
	...
	func_157(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SMOKE_ROLL"), "PROP_HUMAN_SEAT_CHAIR_SMOKE_ROLL_MALE_A", iLocal_17, 0, -1.0f, 1065353216 /* Float: 1f */, 1);
...
int func_109(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_122(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_10(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000.0f))
			{
...
void func_158(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1 /*113*/].f_32.f_5 = { func_255(func_150(uParam0), func_254(uParam0, iParam1), func_22(uParam0), 1) /*3*/ };
			break;
		default:
			sVar0 = { func_256(func_150(uParam0), func_254(uParam0, iParam1), func_22(uParam0), 1) /*4*/ };
...
struct<4> /*32*/ func_256(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 1:
...
bool func_277(var uParam0, int iParam1, Vector3 vParam2)
{
	...
	if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(uParam0->f_107[iParam1 /*113*/].f_3, vParam2, true))
	{
		...
		{
			func_113(&(uParam0->f_107[iParam1 /*113*/].f_109), 0.0f);
		}
	}
	else
	{
...
bool func_278(var uParam0, int iParam1, Vector3 vParam2)
{
	...
	if (ENTITY::IS_ENTITY_OCCLUDED(uParam0->f_107[iParam1 /*113*/].f_5))
	{
		...
		{
			func_113(&(uParam0->f_107[iParam1 /*113*/].f_106), 0.0f);
		}
	}
	else
	{
...
bool func_305(var uParam0, int iParam1)
{
	...
	{
		func_113(&(uParam0->f_107[iParam1 /*113*/].f_32.f_52), 0.0f);
	}
...
void func_387(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_421(func_106(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_422(iParam0);
