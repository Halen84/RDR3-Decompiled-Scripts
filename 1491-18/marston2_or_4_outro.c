...
void func_49(int iParam0, bool bParam1)
{
	...
	{
		iVar4 = (-1 - iVar2);
		iLocal_14[iVar0] = (iLocal_14[iVar0] & iVar4);
	}
}
...
bool func_53(int iParam0, var uParam1)
{
	...
	{
		if (!PED::_HAS_META_PED_ASSET_LOADED(uParam1->f_135[iVar0 /*2*/]))
		{
			return false;
		}
		iVar0++;
...
bool func_122(int iParam0, var uParam1)
{
	...
	if (!func_121(uParam1, 2))
	{
		...
		while (iVar0 < 39)
		{
			...
			{
				uParam1->f_135[uParam1->f_134 /*2*/] = PED::_REQUEST_META_PED_COMPONENT(iVar1, uParam1->f_1.f_1[iVar0 /*3*/], 0, 0, 0);
...
void func_123(var uParam0)
{
	...
	{
		if (PED::_IS_META_PED_ASSET_VALID(uParam0->f_135[iVar0 /*2*/]))
		{
			PED::_RELEASE_META_PED_ASSET_REQUEST(uParam0->f_135[iVar0 /*2*/]);
		}
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_195(iVar3, 6) || uParam0->f_1[iVar1 /*3*/] == Global_1946054.f_57[iVar1 /*11*/]) || uParam0->f_1[iVar1 /*3*/].f_1 == joaat("REMOVE_COMPONENT"))
				{
