...
bool func_42(var uParam0, var uParam1, bool bParam2)
{
	...
	while (iVar16 < 5)
	{
		...
		if (!bVar14)
		{
			...
			PED::SET_PED_CONFIG_FLAG(iVar9, 279 /*PCF_NeverLeavesGroup*/, true);
			if (iVar16 == 0 && !bVar15)
			{
			...
			PED::SET_PED_CONFIG_FLAG(iVar9, 49 /*PCF_CanPerformArrest*/, false);
...
void func_68(var uParam0)
{
	...
	{
		uParam0->f_30.f_3 = func_85("GUAMA_PATROL_HINT" /* GXTEntry: "Look at patrol" */, joaat("INPUT_FOCUS_CAM"), iVar0, 1, 0, 1, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
...
int func_85(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_77(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_101(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
