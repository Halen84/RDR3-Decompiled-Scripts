...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_47(uParam0, 0, "DTRP_DEER", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("WORLD_ANIMAL_DEER_TREE_RUB"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
...
int func_63(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_99(*uParam0, 0.0f, 0.0f, 0.0f))
	{
		return 1;
	}
	iVar1 = 0;
