...
void func_6()
{
	...
	if (!bLocal_19)
	{
		if ((ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, joaat("OBJECTEXCHANGE")) || ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, joaat("OBJECTEXCHANGE01"))) || ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, joaat("OBJECTEXCHANGE02")))
		{
			bLocal_19 = true;
			if (func_12(iLocal_20))
			{
				func_18(func_17(iLocal_20, 0), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1, joaat("ADD_REASON_DEFAULT"));
			}
			func_19(2, 0, 0, 0, 0, 0, 1065353216 /* Float: 1f */, 0);
			func_21(func_20(joaat("CASH_REGISTERS_ROBBED")), 1);
			if (Global_1935630.f_13)
			{
				sVar1 = { func_22(joaat("STORE_ROBBERY_WITNESSED"), 0) /*2*/ };
	...
	if (!PED::IS_PED_USING_ANY_SCENARIO(Global_35))
	{
		if (!bLocal_19)
		{
			if (func_12(iLocal_20))
			{
				func_18(func_17(iLocal_20, 1), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1, joaat("ADD_REASON_DEFAULT"));
			}
			bLocal_19 = true;
		}
		func_23(iLocal_20);
...
int func_17(int iParam0, int iParam1)
{
	...
	iVar1 = iVar0;
	iVar2 = BUILTIN::FLOOR((0.25f * (float)func_32(iParam0)));
...
struct<2> /*16*/ func_20(int iParam0)
{
	struct<2> /*16*/ sVar0;
...
struct<2> /*16*/ func_22(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
int func_30(int iParam0, bool bParam1, int iParam2)
{
	...
	while (iVar24 < sVar1.f_0)
	{
		...
		else
		{
			...
			if (func_49(bVar25, 0) && func_50(bVar25, joaat("CI_TAG_ITEM_MONEY")))
			{
				return BUILTIN::CEIL(((float)sVar1.f_12[iVar24] * fVar0));
			}
		}
...
void func_35(int iParam0, char* sParam1, int iParam2)
{
	...
	func_52(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_40(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	sVar8 = { func_20(joaat("HONOR_CURRENT")) /*2*/ };
...
bool func_77(bool bParam0, int iParam1)
{
	...
	bVar0 = func_104(bParam0, iParam1);
...
int func_78(bool bParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_110(bParam2), bParam0, false);
	return iVar2;
}
...
void func_81(int iParam0)
{
	...
	sVar0 = { func_20(joaat("GANG_SAVINGS_CASH")) /*2*/ };
...
bool func_90(int iParam0, bool bParam1, int iParam2)
{
	struct<4> /*32*/ sVar0;
	var uVar5;

	if (!func_112(23, &sVar0))
	{
		return false;
	}
...
bool func_104(bool bParam0, int iParam1)
{
	...
	if (func_50(bParam0, joaat("CI_TAG_ITEM_AMMOBOX")))
	{
...
int func_109(bool bParam0, bool bParam1)
{
	...
	sVar0 = { func_114(bParam0, joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0) /*18*/ };
	if (bParam1)
	{
		func_116(&sVar0, func_115(0));
	}
	if (!func_117(&sVar0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_108(iVar18);
...
struct<18> /*144*/ func_114(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
struct<4> /*32*/ func_115(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_121(joaat("CARRIED_WEAPONS"), func_120(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_121(joaat("CARRIED_WEAPONS"), func_120(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_121(joaat("CARRIED_WEAPONS"), func_120(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

void func_116(var uParam0, struct<4> /*32*/ sParam1)
{
...
struct<4> /*32*/ func_120(bool bParam0)
{
	return func_121(joaat("CHARACTER"), func_122(), joaat("SLOTID_NONE"), bParam0);
}

struct<4> /*32*/ func_121(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_110(bParam6), &uParam1, bParam0, iParam5, &sVar0);
	return sVar0;
}

struct<4> /*32*/ func_122()
{
	struct<4> /*32*/ sVar0;
