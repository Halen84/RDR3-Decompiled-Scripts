...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			func_149(uParam0, -1594.812f, -1412.783f, 80.9761f, 0.0f, 0.0f, 155.0f);
			break;
		default:
			return false;
	}
	func_150(uParam0, -1.8232f, -1.0459f, -0.0401f, -155.0f, 4.0f, 4.0f, 2.0f, joaat("VOLCYLINDER"), -1, 1, 1, 1);
	func_151(uParam0, 1);
	iLocal_16 = func_152(uParam0, 14, 0);
	iLocal_17 = func_153(uParam0, joaat("A_C_SHEEP_01"), "SHEEP");
	func_154(uParam0, joaat("P_SHEEPSHEERS01X"), 0.0f, 0.0f, 0.0f, "Shears", 0, 1, 1);
	...
	sLocal_18 = { func_159(uParam0, 0.37f, -1.0725f, 1.005f, 103.68f, 7.0f, 0.482f, 1.0f) /*10*/ };
	func_160(uParam0, 1);
...
{
	return func_192(uParam0, sLocal_18, 1, 0);
}
...
bool func_93(var uParam0)
{
	...
	if ((func_201(uParam0, iLocal_15) & func_202(uParam0, iLocal_17)) && !func_203(func_48(uParam0, iLocal_17), joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD")))
	{
		TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(func_48(uParam0, iLocal_17), -1584.05f, -1433.536f, 80.3732f, 1.0f, -1, 0.25f, 4194305, 40000.0f);
...
int func_192(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
