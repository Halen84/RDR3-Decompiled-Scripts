...
int func_21(var uParam0)
{
	if (func_44())
	{
		...
		TASK::ADD_PATROL_ROUTE_NODE(0, "", 1321.784f, -638.8179f, 60.7909f, 1322.784f, -638.8179f, 60.7909f, 9000, false);
		TASK::ADD_PATROL_ROUTE_NODE(1, "", 1287.772f, -625.0335f, 59.4377f, 1286.772f, -624.0335f, 59.4377f, 6000, false);
		TASK::ADD_PATROL_ROUTE_NODE(2, "", 1291.384f, -583.4655f, 68.9213f, 1291.384f, -582.4655f, 68.9213f, 12000, false);
		TASK::ADD_PATROL_ROUTE_NODE(3, "", 1334.909f, -600.3217f, 74.7698f, 1335.909f, -599.3217f, 74.7698f, 9000, false);
		...
		TASK::ADD_PATROL_ROUTE_NODE(0, "", 1259.567f, -599.2295f, 61.8549f, 1261.88f, -602.2684f, 61.2076f, 9000, false);
		TASK::ADD_PATROL_ROUTE_NODE(1, "", 1214.321f, -608.605f, 69.2934f, 1214.321f, -608.605f, 69.2934f, 0, false);
		TASK::ADD_PATROL_ROUTE_NODE(2, "", 1206.03f, -601.7572f, 69.9861f, 1205.03f, -601.7572f, 69.9861f, 12000, false);
		TASK::ADD_PATROL_ROUTE_NODE(3, "", 1222.396f, -565.0325f, 66.9171f, 1221.577f, -562.2708f, 66.3934f, 9000, false);
		TASK::ADD_PATROL_ROUTE_LINK(0, 1);
		TASK::ADD_PATROL_ROUTE_LINK(1, 2);
		TASK::ADD_PATROL_ROUTE_LINK(2, 3);
		TASK::ADD_PATROL_ROUTE_LINK(3, 0);
...
bool func_44()
{
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(sLocal_5[iVar0 /*6*/]) && !func_62(sLocal_5[iVar0 /*6*/].f_5, 1))
		{
			...
			func_64(sLocal_5[iVar0 /*6*/], joaat("WEAPON_MELEE_LANTERN") /* GXTEntry: "Old Lantern" */, 1, 0, 1, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
			func_64(sLocal_5[iVar0 /*6*/], joaat("WEAPON_REVOLVER_CATTLEMAN") /* GXTEntry: "Cattleman Revolver" */, 1, 0, 0, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
...
int func_64(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == joaat("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case joaat("GROUP_SHOTGUN"):
			case joaat("GROUP_RIFLE"):
				if (func_85(joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */))
				{
...
struct<5> /*40*/ func_135(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_194(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_139(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_196(iParam0, 1))
			{
				...
				if (!func_137(iParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_137(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_138(iParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_139(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
