...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		...
		case 2:
			...
			break;
		case 3:
			func_150(uParam0, 1895.533f, -1869.434f, 46.35f, 0.0f, 0.0f, 18.0f);
			break;
		default:
			return false;
	}
	...
	func_152(uParam0, 0.75f, -0.2f, 0.0f, 0.0f, 2.0f, 2.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_153(uParam0, 0.0f, -0.8f, 0.95f, 80.98939f, 1.512f, 1.512f, 1.38f, joaat("VOLCYLINDER"), 1);
	...
	sLocal_22 = { func_160(uParam0, 1.0013f, 0.4609f, 1.0444f, 137.88f, 7.0f, 0.766f, 0.007f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_199(uParam0, sLocal_22, 1, 1))
		{
