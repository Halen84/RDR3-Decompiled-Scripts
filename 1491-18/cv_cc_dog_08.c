...
bool func_72(var uParam0)
{
	...
	iLocal_17 = func_151(uParam0, joaat("P_CHAIRFOLDING02X"), -0.258237f, -1.19728f, 0.0f, "Chair" /* GXTEntry: "Chair" */, 1, 0, 1);
...
int func_202(var uParam0)
{
	...
	switch (uParam0->f_1699)
	{
		case 0:
			...
			break;
		case 1:
			uParam0->f_1707 = func_308("INTERACT_INSULT" /* GXTEntry: "Antagonize" */, joaat("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, (1 << 30), 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
			func_309(uParam0->f_1707, iVar0, 0, 1, -1);
			if (uParam0->f_1709)
			{
				uParam0->f_1708 = func_308("INTERACT_GREET" /* GXTEntry: "Greet" */, joaat("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, (1 << 30), 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
