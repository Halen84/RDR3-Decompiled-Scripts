		...
		if (MISC::GET_GAME_TIMER() > iLocal_26)
		{
			...
			switch (iLocal_25)
			{
				...
				case 1:
					...
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_27));
				...
				case 6:
					if (func_7(func_6(iLocal_27)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_27 /*35*/].f_11 > 0.0f)
							{
								PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1888801[iLocal_27 /*35*/].f_11);
							}
							Jump @785; // curOff = 766
							func_42(iVar0);
							iVar0 = (1 + iVar0);
						...
						{
							PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1888801[iLocal_27 /*35*/].f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
void func_60(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_99(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_99(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_99(&cVar6, joaat("COLOR_PURE_WHITE")), func_99(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
int func_83(int iParam0, bool bParam1)
{
	...
	if (func_118(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			if (func_118(iParam0, (1 << 11)))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_122(iParam0));
				func_123(iParam0, (1 << 11));
			}
...
char* func_99(char* sParam0, int iParam1)
{
	...
	return func_133(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_100(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_104(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_114(int iParam0)
{
	...
	func_141(iParam0, (1 << 13));
	func_141(iParam0, (1 << 14));
	func_141(iParam0, (1 << 15));
	func_141(iParam0, (1 << 17));
	func_141(iParam0, (1 << 24));
	func_141(iParam0, (1 << 19));
	func_141(iParam0, (1 << 20));
...
bool func_127(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_155(iVar0) && func_156(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_144(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_166(iParam0, (1 << 10)))
		{
			func_167(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_166(iParam0, (1 << 10)))
	{
...
bool func_158(Vector3 vParam0, int iParam3)
{
	...
	func_175(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_176(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
