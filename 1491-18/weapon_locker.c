...
bool func_7(var uParam0)
{
	...
	uParam0->f_94.f_1 = DATABINDING::_DATABINDING_ADD_DATA_STRING(uParam0->f_94, "header_text", MISC::VAR_STRING(2, "WL_HEADER" /* GXTEntry: "Weapon Locker" */));
	...
	while (iVar26 < 29)
	{
		...
		if (func_31(bVar27))
		{
			if (WEAPON::GET_PED_WEAPON_GUID_AT_ATTACH_POINT(Global_35, iVar26, &uVar0) && INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(1, &uVar0, &sVar4, 22, 1))
			{
				if (!sVar4.f_21)
				{
					WEAPON::SET_CURRENT_PED_WEAPON(Global_35, joaat("WEAPON_UNARMED") /* GXTEntry: "Unarmed" */, true, iVar26, false, false);
				}
			}
		}
		iVar26++;
...
void func_17(int* iParam0)
{
	...
	while (UIEVENTS::EVENTS_UI_IS_PENDING(joaat("WEAPON_LOCKER_MENU")))
	{
		if (UIEVENTS::EVENTS_UI_PEEK_MESSAGE(joaat("WEAPON_LOCKER_MENU"), &sVar0))
		{
			func_36(iParam0, &sVar0);
			UIEVENTS::EVENTS_UI_POP_MESSAGE(joaat("WEAPON_LOCKER_MENU"));
		}
	}
	if (func_37(iParam0))
	{
...
char* func_23(int iParam0)
{
	...
	{
		case 0:
			return "WL_FILTER_ALL" /* GXTEntry: "All" */;
		case 1:
			return "WL_FILTER_LOCKER" /* GXTEntry: "Locker" */;
		case 2:
			return "WL_FILTER_HORSE" /* GXTEntry: "Horse" */;
		case 3:
			return "WL_FILTER_EQUIPPED" /* GXTEntry: "Equipped" */;
		default:
			break;
	}
...
bool func_69(var uParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		case -1174213347:
			break;
		case -1694113483:
			sVar0 = "WL_NUMBER_STORED_IN_WL" /* GXTEntry: "~1~ stored in Weapon Locker" */;
			break;
		case -337881065:
			sVar0 = "WL_NUMBER_STOWED_ON_HORSE" /* GXTEntry: "~1~ stowed on your horse" */;
			break;
		case -2060496899:
			sVar0 = "WL_NUMBER_EQUIPPED" /* GXTEntry: "~1~ equipped" */;
			break;
		default:
			return false;
	}
	...
	if (func_67(&sVar1))
	{
		...
		{
			case 3:
				func_99(uParam0, MISC::VAR_STRING(2, "WL_FOOTER_ALWAYS_MELEE" /* GXTEntry: "You always need a Melee weapon equipped" */));
				return true;
			case 4:
				if (!func_100(func_30(Global_35, 2, 1, 0)))
				{
					func_99(uParam0, MISC::VAR_STRING(2, "WL_FOOTER_ALWAYS_SIDEARMS" /* GXTEntry: "You always need a Sidearm equipped" */));
				}
				return true;
			case 5:
				func_99(uParam0, MISC::VAR_STRING(2, "WL_FOOTER_ALWAYS_SIDEARMS" /* GXTEntry: "You always need a Sidearm equipped" */));
...
bool func_73(var uParam0)
{
	...
	if (sVar0.f_14 >= 0)
	{
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, joaat("WEAPON_UNARMED") /* GXTEntry: "Unarmed" */, true, sVar0.f_14, false, false);
	}
	return true;
}
...
bool func_102(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		if (func_112(sVar22.f_6, &iVar44))
		{
			...
			func_114(MISC::VAR_STRING(42, "WL_TICKER_EQUIPPED_TO" /* GXTEntry: "~1p~ equipped to ~2p~" */, &cVar45, &cVar53), -2, 0, 0, 0, 1);
		}
	}
	return true;
}
...
bool func_108(bool bParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	...
	uParam2->f_4 = joaat("WEAPON_LOCKER_MENU");
	switch (iParam4)
	{
		case 0:
...
bool func_116(int iParam0, var uParam1, var uParam2)
{
	switch (iParam0)
	{
		case joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */:
			*uParam2 = joaat("MENU_TEXTURES");
			*uParam1 = joaat("CLUB");
			return true;
		case joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */:
			*uParam2 = joaat("MENU_TEXTURES");
...
bool func_136(int iParam0, var uParam1, var uParam2)
{
	switch (iParam0)
	{
		...
		case 2:
			*uParam2 = joaat("MENU_TEXTURES");
			*uParam1 = joaat("MENU_ICON_WEAPON_LOCKER");
			return true;
		default:
			break;
	}
