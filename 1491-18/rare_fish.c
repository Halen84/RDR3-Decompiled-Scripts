...
int func_3()
{
	...
	return COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, joaat("LEGENDARY_FISHING_SPOT"), 0);
}
...
int func_17(var uParam0, int iParam1)
{
	...
	{
		return func_38(0, func_37(iParam1, 1), 11, joaat("CABR01") /* GXTEntry: "High and Low Finance" */);
	}
