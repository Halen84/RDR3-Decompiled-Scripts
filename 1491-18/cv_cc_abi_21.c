...
bool func_73(var uParam0)
{
	...
	func_152(uParam0, -0.0125f, 0.5375f, 1.4875f, 0.0f, 2.1875f, 2.18f, 2.7575f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	...
	func_157(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_SAD"), "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", -1, 1, 45.0f, 1065353216 /* Float: 1f */, 1);
	...
	func_157(uParam0, iLocal_15, 2, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_D", -1, 1, 35.0f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_15, 1, -1);
	func_159(uParam0, iLocal_15, 1, 4, 0, 0, 0);
	iLocal_16 = func_161(uParam0, -2.6625f, -3.0f, 2.6125f, 0.0f, 0.0f, 0.0f, 17.2325f, 16.44f, 3.575f, "Trigger", joaat("VOLBOX"));
	func_162(uParam0, 1);
	return true;
}
...
void func_386(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_420(func_105(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_421(iParam0);
