...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -0.45f, 1.21f, 0.0f, 0.0f, 2.5f, 2.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_15 = func_153(uParam0, joaat("P_CIGAR02X"), 0.0f, 0.0f, 0.0f, "p_cigar01x_PH_R_HAND", 0, 0, 1);
	func_153(uParam0, joaat("P_PHONOGRAPH01X"), 0.0f, 0.0f, 0.0f, "p_phonograph01x", 1, 0, 1);
	if (bVar0)
	{
...
void func_200(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_193(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
int func_287(var uParam0, int iParam1)
{
	...
	if (func_193(uParam0, iParam1, 1.0f))
	{
		return 1;
	}
...
void func_296(int iParam0, int iParam1)
{
	...
	Global_1357549.f_1833 = { func_336(iParam0) /*8*/ };
	Global_1357549.f_1841 = { func_337(iParam0) /*3*/ };
...
struct<8> /*64*/ func_336(int iParam0)
{
	switch (iParam0)
	{
		case 0:
...
struct<8> /*64*/ func_370(char* sParam0)
{
	char cVar0[64];
