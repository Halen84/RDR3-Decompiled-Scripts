...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -4.1f, 0.1f, 1.15f, 0.0f, 1.285f, 1.735f, 2.685f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, joaat("P_CS_KNITTING01X"), 0.0f, 0.0f, 0.0f, "p_cs_knitting01x", 0, 1, 1);
	...
	func_157(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE"), 0, -1, 0, 60.0f, 1065353216 /* Float: 1f */, 1);
	...
	func_157(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_SIT_GROUND"), 0, -1, 0, 70.0f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, 3, 0);
	func_159(uParam0, iLocal_14, 2, 6, 0, "Default_Angry", 0);
	sLocal_18 = { func_161(uParam0, 0.01f, -2.16f, 1.099f, 164.16f, 5.61f, 0.2225f, 0.7425f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_200(uParam0, sLocal_18, 1, 0))
		{
...
bool func_200(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_306(sParam1, sParam1.f_6, Global_36))
	{
		return false;
	}
	if (func_306(sParam1, sParam1.f_3, Global_36))
	{
		return false;
	}
	if (bParam12)
...
void func_201(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_308(100.0f, 140.0f);
			}
		}
...
bool func_306(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5, struct<2> /*16*/ sParam6, var uParam8)
{
		...
		else if (func_19(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_378(&iVar2, func_377(iVar3)))
					{
...
int func_354(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_392(fVar9) /*3*/ };
			vVar13 = { func_393(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) /*3*/ };
...
int func_397(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_422(iParam0) && func_423(iParam0, &cVar4))
				{
...
void func_399(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_429(func_104(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_430(iParam0);
...
bool func_406(int iParam0, Vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_440(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) /*7*/ };
			if (!bParam6)
			{
				func_102(iParam0, 44, 1);
			}
...
void func_413(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_454(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_454(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
void func_427(int iParam0, int iParam1)
{
	...
	func_399(iParam1, func_455(iParam1, (1 << 13)), func_455(iParam1, (1 << 14)), 1);
}
...
struct<7> /*56*/ func_440(int iParam0, int iParam1, Vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	struct<7> /*56*/ sVar0;
...
int func_454(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
