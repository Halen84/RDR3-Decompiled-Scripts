...
bool func_6(int iParam0, var uParam1)
{
	...
	iParam0->f_182 = DATABINDING::_DATABINDING_ADD_DATA_STRING(iParam0->f_181, "header_text", MISC::VAR_STRING(2, "SP_PLAYER_MENU_HEADER" /* GXTEntry: "LOG" */));
...
void func_10()
{
	...
	PAD::DISABLE_CONTROL_ACTION(0, joaat("INPUT_RADIAL_MENU_SLOT_NAV_NEXT") /* GXTEntry: "Next wheel item in slot" */, false);
	PAD::DISABLE_CONTROL_ACTION(0, joaat("INPUT_RADIAL_MENU_SLOT_NAV_PREV") /* GXTEntry: "Previous wheel item in slot" */, false);
	PAD::DISABLE_CONTROL_ACTION(0, joaat("INPUT_COVER") /* GXTEntry: "Take cover" */, false);
	PAD::DISABLE_CONTROL_ACTION(0, joaat("INPUT_OPEN_WHEEL_MENU") /* GXTEntry: "Wheel Menu" */, false);
}
	...
	while (iVar0 <= (Global_1935689.f_1225.f_1207 - 1))
	{
		...
		else
		{
			...
			else
			{
				...
				{
					sVar5 = NETWORK::_REQUEST_PEDSHOT_TEXTURE_MULTIPLAYER_DOWNLOAD(&sVar2, 0);
		...
		if (UIEVENTS::EVENTS_UI_PEEK_MESSAGE(iVar4, &sVar0))
		{
			...
			switch (sVar0.f_0)
			{
				...
				case joaat("ITEM_FOCUSED"):
					...
					switch (iVar5)
					{
						case joaat("PLAYER_MENU_INVITE_ITEM_SCRIPT_EVENT"):
				...
				case joaat("ITEM_SELECTED"):
					switch (iVar5)
					{
						case joaat("PLAYER_MENU_INVITE_ITEM_SCRIPT_EVENT"):
							func_49(sVar0.f_3);
							break;
						case joaat("PLAYER_MENU_INVITE_ITEM_DELETION_EVENT"):
							func_50(Global_1935689.f_1225);
							break;
						case joaat("PLAYER_MENU_INVITE_ITEM_R3_EVENT"):
...
void func_46(struct<4> /*32*/ sParam0, int iParam4)
{
	switch (iParam4)
	{
		case joaat("PLAYER_MENU_FEED_INVITE"):
			...
			func_60(sParam0.f_3);
			break;
		case joaat("PLAYER_MENU_FEED_DEFAULT"):
			break;
		default:
			break;
	}
...
void func_52(int iParam0)
{
	...
	if (func_65(Global_40.f_9910[iVar0 /*6*/]) && func_66(Global_40.f_9910[iVar0 /*6*/], -1))
	{
		...
		if (bVar4 != 0)
		{
			sVar5 = { func_68(bVar4, 0, 0) /*5*/ };
			if (func_69(bVar4, &sVar5, 0, 0) < iVar3)
			{
				func_70(MISC::VAR_STRING(2, "SHOP_MAILBOX_CANT_CARRY" /* GXTEntry: "~s~You cannot carry ~1~ more of this item.~s~" */, iVar3), 7500, 0, 0, 0, 1);
			}
			else
			{
...
int func_53(int iParam0)
{
	...
	else
	{
		...
		{
			iVar0 = func_77(0, 10, 11, joaat("CABR01") /* GXTEntry: "High and Low Finance" */);
		}
	}
	return iVar0;
}
...
struct<5> /*40*/ func_68(bool bParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;
	...
	switch (func_89(bParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_90(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_92(bParam0, 1))
			{
				sVar5.f_9 = joaat("SLOTID_NONE");
				if (!func_93(bParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_93(bParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_94(bParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_97(bParam0, joaat("CI_CATEGORY_CAMP")))
			{
				sVar0 = { func_90(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(bParam0, joaat("KIT_CAMP") /* GXTEntry: "Camp" */);
			}
			else if (func_97(bParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_90(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(bParam0, joaat("WARDROBE") /* GXTEntry: "Wardrobe" */);
			}
...
int func_69(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	...
	iVar0 = func_102(bParam0, uParam1, bParam2, bParam3);
	if (iVar0 < 0)
	{
		return 2147483647 /* Hex: 0x7FFFFFFF */;
	}
	if (bParam2 || !func_103(bParam0))
	{
		iVar1 = func_104(bParam0, *uParam1, uParam1->f_4, bParam3);
	}
	else
	{
		iVar1 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_105(bParam3), bParam0, false);
	}
	if (iVar0 > iVar1)
	{
		return (iVar0 - iVar1);
...
void func_72(int iParam0, var uParam1)
{
	...
	while (iVar1 < iVar0)
	{
		func_67(iParam0, iVar1, uParam1, &bVar2, &iVar3);
		func_109(bVar2, iVar3, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
		iVar1++;
	}
}
...
struct<4> /*32*/ func_90(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_105(bParam6), &uParam1, bParam0, iParam5, &sVar0);
	return sVar0;
}
...
{
	if (func_96(bParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
bool func_93(bool bParam0, var uParam1, int iParam2, bool bParam3)
{
	return func_104(bParam0, *uParam1, iParam2, bParam3) > 0;
}

bool func_94(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;

	if (func_125(bParam0, &uVar0, uParam1, iParam2))
	{
...
int func_102(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (!func_100(bParam0, 0))
	{
		return 0;
	...
	return INVENTORY::_GET_ITEM_ROLE_MAX_LEVEL_COUNT(func_105(bParam3), bParam0);
}

bool func_103(bool bParam0)
{
	if (func_126(bParam0, joaat("DEFAULT") /* GXTEntry: "_" */) == 0)
	{
		return false;
	}
	return true;
...
int func_104(bool bParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	sVar0 = { func_90(bParam0, sParam1, iParam5, bParam6) /*4*/ };
...
int func_109(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	if (!func_127(bParam0, iParam1, bParam2, iParam5))
	{
		return 0;
	}
	if (!func_128(bParam0, &iVar0, iParam1))
	{
		return 0;
	}
	func_129(bParam0, bParam2);
	iVar2 = 0;
	if (func_130(bParam0, 0, 0) == 0)
	{
		if (func_131(bParam0))
		{
			iVar5 = func_132(bParam0);
	...
	if (func_89(bParam0) == joaat("CLOTHING"))
	{
		if ((!func_146(bParam0, joaat("CI_TAG_ITEM_TALISMAN")) && !func_146(bParam0, joaat("CI_TAG_ITEM_UPGRADE"))) && !func_146(bParam0, joaat("CI_TAG_ITEM_IS_SATCHEL")))
		{
			bVar3 = true;
		}
	}
	if (func_147(bParam0, (1 << 23)) && !func_124(28))
	{
		func_148(28);
	}
	if (!bVar3)
	{
		if (func_146(bParam0, joaat("CI_TAG_ITEM_THROWN")))
		{
			bParam2 = true;
			bVar4 = true;
			if (func_96(bParam0) == joaat("CI_CATEGORY_AMMO"))
			{
				bVar1 = func_150(func_149(bParam0, 1), 0);
				if (WEAPON::IS_WEAPON_VALID(bVar1))
				{
					...
					if (func_101(0) && func_152(bVar1, 0, 0, 1, 0, 0, iParam5, 0))
					{
						func_153(bParam0, iVar0, iParam5);
						if (!bParam9)
						{
							bParam2 = false;
						}
			...
			else
			{
				...
				if (WEAPON::_IS_AMMO_VALID(bVar1))
				{
					...
					if (func_101(0) && func_152(bParam0, 0, 0, 1, 0, 0, iParam5, 0))
					{
						func_153(bVar1, iVar0, iParam5);
						if (!bParam9)
						{
							bParam2 = false;
						}
		...
		else if (func_89(bParam0) == joaat("WEAPON"))
		{
			if (!func_154(bParam0, iParam5, &bParam2, bParam3, bParam4))
			{
				bParam2 = true;
			}
			bVar4 = true;
		}
		else if (func_89(bParam0) == joaat("AMMO") && func_155(bParam0))
		{
			if (!func_156(bParam0, &iVar0, iParam5))
			{
				bParam2 = true;
			}
			bVar4 = true;
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_TALISMAN")))
		{
			func_157(bParam0);
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_TRINKET")))
		{
			func_158(bParam0);
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_ANIMAL_CLAW")))
		{
		...
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_VALUABLE")) && !func_146(bParam0, joaat("CI_TAG_ITEM_COLLECTIBLE")))
		{
			...
			if (func_146(bParam0, joaat("CI_TAG_ITEM_TALISMAN_INGREDIENT")) || func_146(bParam0, joaat("CI_TAG_ITEM_TRINKET_INGREDIENT")))
			{
				func_162(bParam0);
			}
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_CANNED")))
		{
			if (func_146(bParam0, joaat("CI_TAG_ITEM_FRUIT")))
			{
			}
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_USED")) && func_146(bParam0, joaat("CI_TAG_ITEM_CONSUMABLE")))
		{
			func_137(484, 0);
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_CONSUMABLE")) && func_146(bParam0, joaat("CI_TAG_ITEM_SNACK")))
		{
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_CONFECTIONARY")))
		{
		}
		else if (func_146(bParam0, 589988438))
		{
			if (func_163())
			{
		...
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_LETTER_INVITATION")) && func_146(bParam0, joaat("CI_TAG_ITEM_DOCUMENT")))
		{
			func_165(bParam0);
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_DINO_BONES")))
		{
			func_166(bParam0);
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_ROCK_CARVINGS")))
		{
			func_167(bParam0);
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_TAXIDERMY")) && func_146(bParam0, joaat("CI_TAG_ITEM_DOCUMENT")))
		{
			func_168(bParam0);
		}
		...
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_TREASURE_HUNTER_MAP")))
		{
			func_169();
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_COLLECTIBLE")))
		{
			func_170(bParam0, iParam1);
			func_171(bParam0);
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_TAXIDERMY")) && func_146(bParam0, joaat("CI_TAG_ITEM_MATERIAL")))
		{
			func_172(bParam0, 0, 0, 0);
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_TALISMAN_INGREDIENT")) || func_146(bParam0, joaat("CI_TAG_ITEM_TRINKET_INGREDIENT")))
		{
			func_162(bParam0);
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_MONEY")))
		{
			if (func_1() != -1)
			{
				return 0;
			}
			func_173(bParam0, iParam5, iParam8);
			bParam2 = true;
			bVar4 = true;
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_FISHING_LURE")))
		{
			switch (bParam0)
			{
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_LAKE") /* GXTEntry: "Special Lake Lure" */:
					if (!func_174(joaat("DOCUMENT_PAMPHLET_SPECIAL_LAKE_LURE") /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0))
					{
						func_109(joaat("DOCUMENT_PAMPHLET_SPECIAL_LAKE_LURE") /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_RIVER") /* GXTEntry: "Special River Lure" */:
					if (!func_174(joaat("DOCUMENT_PAMPHLET_SPECIAL_RIVER_LURE") /* GXTEntry: "Special River Lure Handbill" */, 1, 0))
					{
						func_109(joaat("DOCUMENT_PAMPHLET_SPECIAL_RIVER_LURE") /* GXTEntry: "Special River Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_SWAMP") /* GXTEntry: "Special Swamp Lure" */:
					if (!func_174(joaat("DOCUMENT_PAMPHLET_SPECIAL_SWAMP_LURE") /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0))
					{
						func_109(joaat("DOCUMENT_PAMPHLET_SPECIAL_SWAMP_LURE") /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_LAKE") /* GXTEntry: "Lake Lure" */:
					if (!func_174(joaat("DOCUMENT_PAMPHLET_LAKE_LURE") /* GXTEntry: "Lake Lure Handbill" */, 1, 0))
					{
						func_109(joaat("DOCUMENT_PAMPHLET_LAKE_LURE") /* GXTEntry: "Lake Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_RIVER") /* GXTEntry: "River Lure" */:
					if (!func_174(joaat("DOCUMENT_PAMPHLET_RIVER_LURE") /* GXTEntry: "River Lure Handbill" */, 1, 0))
					{
						func_109(joaat("DOCUMENT_PAMPHLET_RIVER_LURE") /* GXTEntry: "River Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_SWAMP") /* GXTEntry: "Swamp Lure" */:
					if (!func_174(joaat("DOCUMENT_PAMPHLET_SWAMP_LURE") /* GXTEntry: "Swamp Lure Handbill" */, 1, 0))
					{
						func_109(joaat("DOCUMENT_PAMPHLET_SWAMP_LURE") /* GXTEntry: "Swamp Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
			}
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_MEAT_FISH")) && func_147(bParam0, 4))
		{
			if (!func_136(42))
			{
				func_175(bParam0);
		...
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_AMMOBOX")))
		{
			func_176(bParam0, &iVar2);
			bParam2 = true;
			bVar4 = true;
		}
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_IS_SATCHEL")))
		{
			bVar8 = false;
			switch (bParam0)
			{
			...
			if (bVar8 != 0)
			{
				func_109(bVar8, 1, 1, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
			}
		}
		switch (bParam0)
		{
			...
			case joaat("UPGRADE_OFFHAND_HOLSTER") /* GXTEntry: "Upgraded Off-Hand Holster" */:
				...
				{
					func_177(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_OFFHAND_HOLSTER") /* GXTEntry: "Upgraded Off-Hand Holster" */, 0, joaat("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_178(&bVar9, 0))
				{
					func_152(bVar9, 0, 0, bParam4, 3, 0, joaat("ADD_REASON_DEFAULT"), 0);
				}
				break;
			case joaat("UPGRADE_BANDOLIER") /* GXTEntry: "Upgraded Bandolier" */:
				...
				{
					func_177(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_BANDOLIER") /* GXTEntry: "Upgraded Bandolier" */, 0, joaat("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case joaat("CONSUMABLE_AGED_PIRATE_RUM") /* GXTEntry: "Aged Pirate Rum" */:
				func_193(242, func_192(joaat("CONSUMABLE_AGED_PIRATE_RUM") /* GXTEntry: "Aged Pirate Rum" */), 0);
				break;
			case joaat("CONSUMABLE_GINSENG_ELIXIER") /* GXTEntry: "Ginseng Elixir" */:
				func_193(240, func_192(joaat("CONSUMABLE_GINSENG_ELIXIER") /* GXTEntry: "Ginseng Elixir" */), 0);
				break;
			case joaat("CONSUMABLE_VALERIAN_ROOT") /* GXTEntry: "Valerian Root" */:
				func_193(241, func_192(joaat("CONSUMABLE_VALERIAN_ROOT") /* GXTEntry: "Valerian Root" */), 0);
				break;
			...
			case joaat("CONSUMABLE_MOONSHINE") /* GXTEntry: "Moonshine" */:
				...
				{
					func_194(594, joaat("TF_FORTIFY_TANK1") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Health Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_RESTORATIVE") /* GXTEntry: "Bitters" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_194(594, joaat("TF_FORTIFY_TANK2") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Stamina Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_CHEWING_TOBACCO_USED") /* GXTEntry: "Opened Chewing Tobacco" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_194(594, joaat("TF_FORTIFY_TANK3") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Dead Eye Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_POTENT_TONIC") /* GXTEntry: "Potent Miracle Tonic" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_194(594, joaat("TF_FORTIFY_TANK4") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    ...
    "d Eye Bars." */, 1, 1);
			...
			case joaat("CONSUMABLE_MEAL_ROAST_BEEF") /* GXTEntry: "Roast Beef" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_194(595, joaat("TF_FORTIFY_CORE1") /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    "for a short period of time. This Provision will Fortify your Health Core." */, 1, 1);
			...
			case joaat("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL_EGGS") /* GXTEntry: "Regional Beef and Eggs Stew" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_194(595, joaat("TF_FORTIFY_CORE2") /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
	...
	if (!bVar4)
	{
		...
		bVar10 = bParam0;
		func_197(&bVar10);
		if (!func_198(bVar10, iVar0, iParam5))
		{
			return 0;
		}
		else if (!func_101(0))
		...
		if (func_146(bParam0, joaat("CI_TAG_ITEM_UPGRADE")))
		{
			func_200(bParam0);
		}
	}
	...
	if (fParam6 > 0.0f)
	{
		if (func_146(bParam0, joaat("CI_TAG_ITEM_MEAT_FISH")))
		{
			func_204(bParam0, fParam6);
		}
	}
	else if (!bParam2)
	{
		bVar37 = iParam5 == joaat("ADD_REASON_PURCHASED");
		func_205(bParam0, iVar0, 0, bVar37, 0);
	}
	return 1;
}
...
bool func_125(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_105(0);
	*uParam1 = { func_90(bParam0, func_91(0), iParam3, 0) /*4*/ };
...
bool func_127(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_1() == -1)
	{
		if (func_219(bParam0) && func_220(bParam0))
		{
			func_221(bParam0, iParam1, 1, &bParam2, iParam3);
			return false;
		}
	}
...
bool func_128(bool bParam0, int iParam1, int iParam2)
{
	...
	*iParam1 = iParam2;
	...
	sVar0 = { func_68(bParam0, 0, 1) /*5*/ };
	iVar5 = func_102(bParam0, &sVar0, 0, 0);
	iVar6 = func_223(bParam0, 0);
	if ((iVar5 > 1 && !func_41()) && (iVar6 + iParam2) >= iVar5)
	{
		if (func_146(bParam0, joaat("CI_TAG_ITEM_ANIMAL_PART")))
		{
			func_137(583, 1);
		}
		else
	...
	if (func_224(bParam0, &sVar0, *iParam1, 0, 0))
	{
		if (iVar6 < iVar5)
		{
			*iParam1 = (iVar5 - iVar6);
...
void func_129(bool bParam0, bool bParam1)
{
	...
	switch (func_225(bParam0, joaat("TAG_INTERACTION_TYPE")))
	{
...
int func_130(bool bParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_105(bParam2), bParam0, false);
	return iVar2;
}
...
void func_143(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, bool bParam5, int iParam6, bool bParam7)
{
	char* sVar0;
	char* sVar1;
	char* sVar2;
	...
	if (func_241(iParam0, iVar13, iVar14, iParam3, bParam1, iParam6, iVar9, iParam2, iVar10, bParam5))
	{
	}
...
bool func_149(bool bParam0, bool bParam1)
{
	...
	if (func_100(bVar0, 0))
	{
		if (bParam1)
		{
			if (func_249(bVar0) || func_250(bVar0))
			{
				return bVar0;
			}
		}
...
bool func_152(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_93(bParam0, &sVar0, iVar5, 0))
			{
				if (func_94(bParam0, &sVar6, iVar5))
				{
					sVar29 = { func_90(bParam0, sVar0, iVar5, 0) /*4*/ };
					func_253(bParam0, &sVar29, &sVar0, 1, joaat("REMOVE_REASON_DEFAULT"), 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_101(0))
				{
					...
					func_153(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
...
bool func_154(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	var uVar1;
	int iVar6;
	...
	if (WEAPON::IS_WEAPON_VALID(bVar0))
	{
		...
		if (!func_224(bParam0, &uVar1, 1, 0, 0))
		{
			func_221(bParam0, 1, 0, bParam2, iParam1);
			iVar6 = func_256(bVar0);
			if (WEAPON::_IS_WEAPON_SNIPER(bVar0))
			{
				func_152(bVar0, iVar6, bParam3, bParam4, 0, 0, iParam1, 0);
			}
			else if (bVar0 == joaat("WEAPON_FISHINGROD") || bVar0 == joaat("WEAPON_KIT_BINOCULARS"))
			{
				func_152(bVar0, 0, bParam3, bParam4, 0, 0, iParam1, 0);
			}
			else if (bVar0 == joaat("WEAPON_LASSO"))
			{
				func_152(bVar0, 1, bParam3, bParam4, 0, 0, iParam1, 0);
			}
			else if (WEAPON::IS_WEAPON_MELEE_WEAPON(bVar0))
			{
				if (bVar0 == joaat("WEAPON_MELEE_KNIFE_JOHN") && !func_257())
				{
					return false;
				}
				...
				else if (!func_258(bVar0))
				{
					func_152(bVar0, 1, bParam3, bParam4, 0, 0, iParam1, 0);
				}
				else
				{
					func_152(bVar0, WEAPON::GET_WEAPON_CLIP_SIZE(bVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(bVar0))
			{
				bVar7 = func_259(Global_35, 2, 0, 1);
				if ((((func_251(bVar7) && !Global_43891) && bVar7 != bVar0) && !func_124(24)) && bParam4)
				{
					WEAPON::_SEND_WEAPON_TO_INVENTORY(Global_35, bVar7);
				}
				bVar8 = true;
				if (func_251(bVar7) && func_124(24))
				{
					if (!func_152(bVar0, iVar6, bParam3, bParam4, 3, bVar8, iParam1, 0))
					{
						return false;
					}
				}
				else if (!func_152(bVar0, iVar6, bParam3, bParam4, 0, bVar8, iParam1, 0))
				{
					return false;
				}
			}
			else if (!func_152(bVar0, iVar6, bParam3, bParam4, 0, 0, iParam1, 0))
			{
				return false;
			}
		}
...
bool func_156(bool bParam0, int iParam1, int iParam2)
{
	...
	if (func_174(joaat("PROVISION_TRINKET_CROW_BEAK") /* GXTEntry: "Crow Beak Trinket" */, 1, 0) && iParam2 == joaat("ADD_REASON_LOOTED"))
	{
	...
	{
		func_193(func_260(bParam0), func_192(bParam0), 1);
		return false;
	}
	...
	if (func_101(0))
	{
		if (func_153(bParam0, iVar0, iParam2))
		{
			*iParam1 = iVar0;
			return true;
		}
...
void func_157(bool bParam0)
{
	...
	if ((bParam0 == joaat("PROVISION_TALISMAN_EAGLE_TALON") && !func_261()) || bParam0 != joaat("PROVISION_TALISMAN_EAGLE_TALON"))
	{
		if (func_262(Global_35, bParam0, &uVar0))
		{
			func_177(PLAYER::PLAYER_PED_ID(), bParam0, 0, joaat("MP_COMPONENT_TYPE_END"), 1, 1, 1, 0, 1, 1);
		}
	}
	switch (bParam0)
	{
...
void func_162(bool bParam0)
{
	...
	bVar0 = func_146(bParam0, joaat("CI_TAG_ITEM_TALISMAN_INGREDIENT"));
	if (func_265() < 3)
	{
		if (bVar0)
		{
			if (func_267(func_266(bParam0), bParam0))
			{
				func_193(79, func_192(func_266(bParam0)), 1);
			}
			else
			{
				func_193(78, func_192(func_266(bParam0)), 1);
			}
		}
		else
		{
			func_193(80, func_192(func_268(bParam0)), 1);
		}
	}
}
...
bool func_163()
{
	if (((((func_269(joaat("DOCUMENT_ARTHUR_MINOR_BOUNTY_1") /* GXTEntry: "Bounty Poster of Arthur" */, 400) || func_269(joaat("DOCUMENT_ARTHUR_MINOR_BOUNTY_2") /* GXTEntry: "Bounty Notice" */, 400)) || func_269(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_1") /* GXTEntry: "Bounty Hunter\'s Orders" */, 400)) || func_269(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_2") /* GXTEntry: "Poster of a Violent Criminal" */, 400)) || func_269(joaat("DOCUMENT_ARTHUR_HAS_POSTER_1") /* GXTEntry: "Bounty Hunter\'s Letter" */, 400)) || func_269(joaat("DOCUMENT_ARTHUR_HAS_POSTER_2") /* GXTEntry: "Bounty Page" */, 400))
	{
		return true;
	}
	return false;
...
void func_168(bool bParam0)
{
	...
	switch (bParam0)
	{
		case joaat("DOCUMENT_TAXIDERMY_ORDER_1") /* GXTEntry: "Hunting Request" */:
			...
			func_137(437, 0);
			func_137(440, 0);
			func_281(joaat("TAXIDERMY_ORDER_01"), joaat("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT") /* GXTEntry: "Perfect Squirrel Carcass" */, &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_2") /* GXTEntry: "Hunting Request" */:
			...
			func_281(joaat("TAXIDERMY_ORDER_02"), joaat("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT") /* GXTEntry: "Perfect Cardinal Carcass" */, &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_3") /* GXTEntry: "Hunting Request" */:
			...
			func_281(joaat("TAXIDERMY_ORDER_03"), joaat("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT") /* GXTEntry: "Perfect Chipmunk Carcass" */, &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_4") /* GXTEntry: "Hunting Request" */:
			...
			func_281(joaat("TAXIDERMY_ORDER_04"), joaat("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT") /* GXTEntry: "Perfect Songbird Carcass" */, &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_5") /* GXTEntry: "Hunting Request" */:
			...
			func_137(438, 0);
			func_281(joaat("TAXIDERMY_ORDER_05"), joaat("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT") /* GXTEntry: "Perfect Cedar Waxwing Carcass" */, &cVar0, 1, 0, 0);
...
void func_170(bool bParam0, int iParam1)
{
	...
	if (func_1() == -1)
	{
		...
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_01")))
		{
			func_283(joaat("EXOTIC_STAGE_01"));
			if (func_284() == 0)
			{
				func_23(0, 10);
				iVar1 = func_285(bParam0, iParam1, 1);
				...
				{
					if (func_286(bParam0) < func_287(bParam0))
					{
						func_143(43, bParam0, iParam1, joaat("EXOTIC_STAGE_01"), iVar1, 0, -1, 0);
		...
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_02")))
		{
			func_283(joaat("EXOTIC_STAGE_02"));
			if (func_284() == 1)
			{
				func_23(0, 10);
				iVar1 = func_285(bParam0, iParam1, 2);
				if ((bParam0 == joaat("PROVISION_HERON_FEATHER") || bParam0 == joaat("PROVISION_RO_FLOWER_LADY_SLIPPER")) || bParam0 == joaat("PROVISION_RO_FLOWER_MOCCASIN"))
				{
					if (func_286(bParam0) < func_287(bParam0))
					{
						func_143(43, bParam0, iParam1, joaat("EXOTIC_STAGE_02"), iVar1, 0, -1, 0);
		...
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_03")))
		{
			func_283(joaat("EXOTIC_STAGE_03"));
			if (func_284() == 2)
			{
				func_23(0, 10);
				iVar1 = func_285(bParam0, iParam1, 4);
				if (bParam0 == joaat("PROVISION_GATOR_EGG"))
				{
					...
					if (func_286(bParam0) < func_287(bParam0))
					{
						func_143(43, bParam0, iParam1, joaat("EXOTIC_STAGE_03"), iVar1, 0, -1, 0);
		...
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_04")))
		{
			func_283(joaat("EXOTIC_STAGE_04"));
			if (func_284() == 3)
			{
				func_23(0, 10);
				iVar1 = func_285(bParam0, iParam1, 8);
				if (((bParam0 == joaat("PROVISION_SPOONBILL_FEATHER") || bParam0 == joaat("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || bParam0 == joaat("PROVISION_RO_FLOWER_RAT_TAIL")) || bParam0 == joaat("PROVISION_RO_FLOWER_SPIDER"))
				{
					if (func_286(bParam0) < func_287(bParam0))
					{
						func_143(43, bParam0, iParam1, joaat("EXOTIC_STAGE_04"), iVar1, 0, -1, 0);
		...
		else if (func_146(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_05")))
		{
			func_283(joaat("EXOTIC_STAGE_05"));
			if (func_284() == 4)
			{
				func_23(0, 10);
				iVar1 = func_285(bParam0, iParam1, 16);
				if (((bParam0 == joaat("PROVISION_RO_FLOWER_CLAMSHELL") || bParam0 == joaat("PROVISION_RO_FLOWER_DRAGONS")) || bParam0 == joaat("PROVISION_RO_FLOWER_SPARROWS")) || bParam0 == joaat("PROVISION_RO_FLOWER_QUEENS"))
				{
					if (func_286(bParam0) < func_287(bParam0))
					{
						func_143(43, bParam0, iParam1, joaat("EXOTIC_STAGE_05"), iVar1, 0, -1, 0);
...
void func_172(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar1 < 5)
	{
		...
		if (func_174(func_290(iVar0, 10), 1, 0))
		{
			if (bParam2)
			{
				func_291(bParam0, iVar0, cVar2, iParam1, bParam2);
			}
			else
			{
				func_292(bParam0, iVar0, bParam3);
			}
		}
		iVar1++;
	}
...
bool func_174(bool bParam0, int iParam1, bool bParam2)
{
	...
	return func_130(bParam0, 0, bParam2) >= iParam1;
}
...
void func_176(bool bParam0, int iParam1)
{
	...
	func_298(bParam0, iParam1, &uVar0);
}

int func_177(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	struct<5> /*40*/ sVar0;
	int iVar5;
	...
	{
		sVar0 = { func_68(bParam1, 1, 0) /*5*/ };
		bParam3 = func_299(sVar0.f_4);
		if (bParam3 == joaat("MP_COMPONENT_TYPE_END"))
		{
			return 0;
		}
	}
	if (!func_301(bParam1, iParam2, func_300(bParam3, 1), bParam4, bParam9))
	{
		return 0;
	}
	...
	switch (bParam3)
	{
		...
		case joaat("MP_COMPONENT_TYPE_NECKWEAR_1"):
			if (bParam8 && bParam1 != Global_1946054.f_57[func_300(bParam3, 1) /*11*/])
			{
				func_303(31, 0, 0, 0, 0);
			}
			break;
		case joaat("MP_COMPONENT_TYPE_HEADWEAR"):
			if (func_304((1 << 15)) && bParam1 != Global_1946054.f_57[func_300(bParam3, 1) /*11*/])
			{
				func_305();
				func_303(22, bParam3, 256, 0, 0);
			}
	...
	if (!bParam6)
	{
		if (bParam7)
		{
			func_303(22, bParam3, 0, 0, 0);
		}
		return 1;
	}
	iVar5 = func_306(bParam3);
...
int func_198(bool bParam0, int iParam1, int iParam2)
{
	...
	sVar0 = { func_68(bParam0, 0, 1) /*5*/ };
	sVar5 = { func_90(bParam0, sVar0, sVar0.f_4, 0) /*4*/ };
	return func_317(bParam0, &sVar5, &sVar0, iParam1, iParam2, 0);
}
...
void func_199(bool bParam0)
{
	...
	switch (func_96(bParam0))
	{
		case joaat("CI_CATEGORY_WARDROBE_MASK"):
			if (bParam0 == joaat("KIT_BANDANA") && func_318(joaat("CI_CATEGORY_WARDROBE_MASK"), 0) <= 0)
			{
				func_303(32, bParam0, 0, 0, 0);
			}
			break;
		...
		case joaat("CI_CATEGORY_WARDROBE_BIG_MASK"):
			...
			{
				if (func_324(joaat("CI_CATEGORY_WARDROBE_BIG_MASK"), &bVar1))
				{
					func_303(33, bVar1, 0, 0, 0);
				}
			}
			func_303(32, bParam0, 0, 0, 0);
			break;
	...
	if ((bParam0 == joaat("CLOTHING_SP_OFFHAND_000") || bParam0 == -1515874150) || bParam0 == joaat("UPGRADE_OFFHAND_HOLSTER"))
	{
		...
		{
			func_177(Global_35, bParam0, 0, joaat("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
		}
		func_148(24);
		if (func_178(&bVar2, 0))
		{
			func_152(bVar2, 0, 0, 1, 3, 0, joaat("ADD_REASON_DEFAULT"), 0);
		}
	}
}
...
{
	if (func_146(bParam0, 943695443))
	{
		func_326(0, bParam0);
	}
	else if (func_146(bParam0, -2096528786))
	{
		func_326(1, bParam0);
	}
	else if (func_146(bParam0, -1094167013))
	{
		func_326(2, bParam0);
	}
	else if (func_146(bParam0, 1936654645))
	{
		func_326(3, bParam0);
	}
	else if (func_146(bParam0, 1306489306))
	{
		func_326(4, bParam0);
	}
	else if (func_146(bParam0, 435762317))
	{
		func_326(5, bParam0);
	}
	else if (func_146(bParam0, 1259363210))
	{
		func_326(6, bParam0);
	}
	else if (func_146(bParam0, 881398259))
	{
		func_326(7, bParam0);
	}
	else if (func_146(bParam0, -541549214))
	{
		func_326(8, bParam0);
	}
	else if (func_146(bParam0, joaat("CI_TAG_ITEM_EQUIPMENT")))
	{
		func_326(-1, bParam0);
	}
}
...
struct<2> /*16*/ func_202(bool bParam0)
{
	struct<2> /*16*/ sVar0;
	struct<2> /*16*/ sVar2;
	...
	if (func_146(bParam0, joaat("CI_TAG_ITEM_DEADEYE")))
	{
		if (func_1() == -1)
		{
			if (func_146(bParam0, joaat("CI_TAG_ITEM_MEDICINE")))
			{
	...
	else if (func_146(bParam0, joaat("CI_TAG_ITEM_MEDICINE")))
	{
		return func_329(joaat("MEDICINE_ITEMS"));
	}
	if (func_146(bParam0, joaat("CI_TAG_ITEM_LOCK_BREAKER")))
	{
...
void func_204(bool bParam0, char* sParam1)
{
	char* sVar0;

	sVar0 = func_331(func_330(0));
	func_333(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP" /* GXTEntry: "~1w~ ~2~" */, sParam1, sVar0), "inventory_items", func_332(bParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}

void func_205(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	int iVar1;
	char cVar2[32];
	...
	if (!func_334())
	{
		func_335(bParam0, iParam1, bParam2, bParam4);
		return;
	}
	bVar0 = false;
	iVar1 = MISC::ABSI(iParam1);
	strcpy_s(&cVar2, 32, func_336(iVar1 == 1, "ITEM_GET_PUMP" /* GXTEntry: "~1~" */, "ITEM_GET_PUMP_MULT" /* GXTEntry: "~2~x ~1~" */));
	if (iParam1 > 0)
	{
	}
	else
	{
		...
		else if (bParam2 && func_147(bParam0, (1 << 21)))
		{
			strcpy_s(&cVar2, 32, "ITEM_READ_PUMP_MULT" /* GXTEntry: "~2~x READ ~1~" */);
		}
		bVar0 = true;
	}
	iVar6 = func_89(bParam0);
	iVar10 = 0;
	...
	else if (!func_337(bParam0, &sVar7, iVar11, iVar10, 0, joaat("UI_ITEMVIEWER")))
	{
	...
	sVar15 = func_338(MISC::VAR_STRING(10, &cVar2, MISC::VAR_STRING(0, func_192(bParam0)), iVar1), iVar12);
	if (((((iParam1 == 1 || func_146(bParam0, joaat("CI_TAG_SMOKING_CIGARETTE"))) || bParam0 == joaat("CONSUMABLE_CIGARETTE_BOX")) || bParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_USED")) || bParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || bParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
		sVar15 = MISC::VAR_STRING(0, func_192(bParam0));
	}
...
{
	return func_89(bParam0) == joaat("WEAPON");
}
...
bool func_220(bool bParam0)
{
	...
	if (func_147(bParam0, (1 << 20)))
	{
		return false;
	}
	if (WEAPON::IS_WEAPON_VALID(bParam0))
	{
		return func_224(bParam0, &uVar0, 1, 0, 0);
	}
	return func_174(bParam0, 1, 0);
}

void func_221(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	bool bVar0;

	if (func_89(bParam0) != joaat("WEAPON"))
	{
		return;
	}
	bVar0 = func_150(bParam0, 0);
	...
	if (bParam2 || !func_250(bVar0))
	{
		if (func_1() == -1)
		{
			func_151(bVar0);
		}
		if (bParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, bVar0, 0, false) && func_130(bParam0, 0, 0) == 0))
		{
			if (!*bParam3 && !iParam4 == joaat("ADD_REASON_PURCHASED"))
			{
				func_205(bParam0, iParam1, 0, 0, 0);
...
void func_222(bool bParam0, int iParam1)
{
	...
	if (func_146(bParam0, joaat("CI_TAG_ITEM_MULTIPLE_USES")))
	{
		func_342(bParam0, joaat("COST_SHOP_DEFAULT"), &iVar0, 1);
		*iParam1 *= iVar0;
	}
}
...
int func_223(bool bParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_105(bParam1), bParam0, false);
}

bool func_224(bool bParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	struct<4> /*32*/ sVar0;
	struct<10> /*80*/ sVar4;
	var uVar26;
	...
	if (func_219(bParam0) && WEAPON::IS_WEAPON_A_GUN(bParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
		{
			sVar0 = { func_91(0) /*4*/ };
			...
			else if (func_94(bParam0, &sVar4, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
			{
				return false;
			}
			if (func_92(bParam0, 1))
			{
				if (!func_93(bParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					return false;
				}
				else if (func_94(bParam0, &sVar4, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */))
				{
					return false;
				}
			}
		}
		else if (!func_343(bParam0, &uVar26, 0))
		{
			return false;
		}
		return true;
	}
	iVar27 = func_102(bParam0, uParam1, bParam3, bParam4);
	if (iVar27 < 0)
	{
		return false;
	}
	...
	if (bParam3 || !func_103(bParam0))
	{
		iVar28 = func_104(bParam0, *uParam1, uParam1->f_4, bParam4);
	}
	else
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_105(bParam4), bParam0, false);
	}
...
bool func_226(bool bParam0, int iParam1)
{
	...
	if (func_146(bParam0, joaat("CI_TAG_ITEM_AMMOBOX")))
	{
		func_298(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return false;
}
...
int func_227(bool bParam0, bool bParam1)
{
	...
	sVar0 = { func_344(bParam0, joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0) /*18*/ };
	if (bParam1)
	{
...
char* func_237(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6)
{
	switch (iParam1)
	{
		case joaat("CIGARETTE_CARDS"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_CC_CARD_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Card Sets Posted" */, func_360(), 12);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_CC_CARD_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Card Sets Found" */, func_361(), 12);
			}
			break;
		case joaat("DINO_BONES"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_DB_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Dinosaur Bones Posted" */, func_362(), 30);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_DB_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Dinosaur Bones Found" */, func_279(), 30);
			}
			break;
		...
		case joaat("LEGENDARY_FISH"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_LF_CAUGHT_OBJ" /* GXTEntry: "~1~ of ~2~ Legendary Fish Caught and Posted" */, func_363(), 13);
			}
			break;
		case joaat("ROCK_CARVINGS"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_RC_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Rock Faces Posted" */, func_364(), 10);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_RC_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Rock Faces Found" */, func_280(), 10);
			}
			break;
		case joaat("TAXIDERMY"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_TX_CARCASS_COLLECTED_OBJ" /* GXTEntry: "~1~ of ~2~ Carcasses Collected" */, sParam4, func_236(iParam6, 20));
			}
			break;
	}
	return sParam3;
...
bool func_241(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	while (iVar0 < iParam6)
	{
		if (iParam2 == joaat("CIGARETTE_CARDS"))
		{
			...
			{
				bVar1 = (func_174(bVar2, 1, 0) || func_367(func_366(bVar2)));
			}
			if (iParam5 == 8)
			{
				bVar1 = true;
		...
		{
			bVar2 = func_290(iParam3, func_369(iVar0));
			if (iParam5 == 8)
			{
				bVar1 = true;
			}
			else if (bParam9)
			{
				if (bParam4 == bVar2)
				{
					bVar1 = (func_286(bVar2) - iParam7) >= func_236(iParam3, func_370(iVar0));
				}
				else
				{
					bVar1 = func_286(bVar2) >= func_236(iParam3, func_370(iVar0));
				}
			}
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_371(bVar2)), func_371(bVar2), bVar1, true, false);
		}
		...
		if (iParam2 == joaat("TAXIDERMY"))
		{
			...
			if (bParam9)
			{
				if (bParam4 == bVar2)
				{
					bVar1 = (func_286(bVar2) - iParam7) >= true;
				}
				else
				{
					bVar1 = func_375(bVar2);
				}
			}
			else if (bParam4 == bVar2)
			{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_376(bVar2)), func_376(bVar2), bVar1, true, false);
		}
		iVar0++;
	}
	return true;
...
void func_248(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_246("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_MANUAL_PAINT" /* GXTEntry: "Manual Painting" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_246("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_STAY_ACTIVE" /* GXTEntry: "Continued Free Fire" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_246("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_FATAL" /* GXTEntry: "Fatal Region Highlights" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_246("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_CRITICAL" /* GXTEntry: "Critical Region Highlights" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 24:
			...
			if (func_1() == -1)
			{
				if (!func_325(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) || func_387(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					...
					if (!func_174(bVar0, 1, 0))
					{
						func_198(bVar0, 1, joaat("ADD_REASON_DEFAULT"));
					}
					func_177(Global_35, bVar0, 0, joaat("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
				}
			}
			break;
		case 48:
...
bool func_253(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> /*96*/ sVar0;
	int iVar14;
...
void func_254(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_390(WEAPON::GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
bool func_262(int iParam0, bool bParam1, var uParam2)
{
	var uVar0;
	bool bVar1;
	int iVar2;
	...
	if (func_89(bParam1) != joaat("CLOTHING"))
	{
		return false;
	}
	bVar1 = func_1() != -1;
	iVar2 = PED::_GET_META_PED_TYPE(iParam0);
	if (func_96(bParam1) == joaat("CI_CATEGORY_WARDROBE_OUTFIT"))
	{
		return true;
	}
	...
	bVar7 = false;
	bVar8 = bParam1;
	if (func_146(bParam1, joaat("CI_TAG_ITEM_TALISMAN")))
	{
		iVar5 = func_300(iVar4, 1);
		if (func_395(&(Global_1946054.f_1497)) >= 2 && Global_1946054.f_1497.f_1[iVar5 /*3*/] != bVar8)
		{
	...
	switch (iVar4)
	{
		...
		case joaat("MP_COMPONENT_TYPE_FOOTWEAR_1"):
			iVar5 = 35;
			if (Global_1946054.f_1497.f_1[iVar5 /*3*/] != Global_1946054.f_57[iVar5 /*11*/] && func_146(bParam1, -1638171711))
			{
		...
		case joaat("MP_COMPONENT_TYPE_LOADOUT_6"):
			...
			else
			{
				...
				iVar10 = func_397(bVar8, iVar4, iVar2, bVar1);
    ...
    "" */
				...
				Jump @776; // curOff = 583
				iVar3 = func_96(bParam1);
				iVar5 = 36;
				iVar6 = 35;
				if (bParam1 != Global_1946054.f_57[iVar6 /*11*/] && func_146(Global_1946054.f_1497.f_1[iVar5 /*3*/], -1638171711))
				{
				...
				{
					if (bParam1 != Global_1946054.f_57[iVar6 /*11*/] && func_398(Global_1946054.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = joaat("MPC_ACTION_NOT_AVAILABLE_BOOTS_DO_NOT_SUPPORT_THIS"); /* GXTEntry: "Your boots do not support this." */
						return false;
					}
...
bool func_267(bool bParam0, bool bParam1)
{
	...
	if (func_174(bVar0, 1, 0) && func_174(bVar1, 1, 0))
	{
		return true;
	}
	return false;
...
int func_270(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1.0f;
	if (bParam1 && func_174(joaat("PROVISION_TRINKET_ELK_ANTLER") /* GXTEntry: "Elk Antler Trinket" */, 1, 0))
	{
		fVar0 += 0.1f;
	}
	sVar1.f_1 = 10;
	...
	while (iVar24 < sVar1.f_0)
	{
		...
		else
		{
			...
			if (func_100(bVar25, 0) && func_146(bVar25, joaat("CI_TAG_ITEM_MONEY")))
			{
				return BUILTIN::CEIL(((float)sVar1.f_12[iVar24] * fVar0));
			}
		}
...
int func_277(int iParam0)
{
	...
	iVar1 = func_286(bVar9);
	iVar2 = func_286(bVar10);
	iVar3 = func_286(bVar11);
	iVar5 = func_287(bVar9);
	iVar6 = func_287(bVar10);
	iVar7 = func_287(bVar11);
	if (iParam0 != 2)
	{
		iVar4 = func_286(bVar12);
		iVar8 = func_287(bVar12);
	}
	if (iVar1 >= iVar5)
	{
		iVar0 += iVar5;
...
bool func_281(int iParam0, bool bParam1, char* sParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	else if (iParam0 == joaat("TAXIDERMY_ORDER_02"))
	{
		...
		if (func_375(bVar0) && func_375(bVar1))
		{
			return true;
		}
	}
	else if (iParam0 == joaat("TAXIDERMY_ORDER_03"))
	{
		...
		if ((func_375(bVar0) && func_375(bVar1)) && func_375(bVar2))
		{
			return true;
		}
	}
	else
	{
		...
		if (((func_375(bVar0) && func_375(bVar1)) && func_375(bVar2)) && func_375(bVar3))
		{
			return true;
		}
	}
...
void func_291(bool bParam0, int iParam1, char[4] cParam2, int iParam3, bool bParam4)
{
	if ((((bParam0 == func_290(iParam1, 5) || bParam0 == func_290(iParam1, 6)) || bParam0 == func_290(iParam1, 7)) || bParam0 == func_290(iParam1, 8)) || bParam0 == func_290(iParam1, 9))
	{
		func_281(iParam1, bParam0, &cParam2, 0, iParam3, bParam4);
		func_143(51, 0, 0, iParam1, cParam2, 0, -1, 0);
		func_145(51, 0, 0, 0, 0, -1, 0);
	}
}

void func_292(bool bParam0, int iParam1, bool bParam2)
{
	char[] cVar0[8];
	...
	if ((((bParam0 == func_290(iParam1, 5) || bParam0 == func_290(iParam1, 6)) || bParam0 == func_290(iParam1, 7)) || bParam0 == func_290(iParam1, 8)) || bParam0 == func_290(iParam1, 9))
	{
		if (func_281(iParam1, bParam0, &cVar0, 0, 0, 0))
		{
			func_143(51, bParam0, 0, iParam1, cVar0, 0, -1, 0);
			if (!bParam2)
			{
...
bool func_294(bool bParam0, int iParam1)
{
	...
	bVar0 = func_226(bParam0, iParam1);
	sVar4.f_9 = joaat("SLOTID_NONE");
...
void func_298(bool bParam0, int iParam1, var uParam2)
{
	*iParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
bool func_301(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	struct<5> /*40*/ sVar0;
	int iVar5;
	int iVar6;
	...
	if (func_146(bParam0, joaat("CI_TAG_ITEM_TALISMAN")) && func_395(&(Global_1946054.f_1378)) >= 2)
	{
		return false;
	}
	if ((func_304((1 << 15)) && iParam2 == 10) && bParam0 != Global_1946054.f_57[iParam2 /*11*/])
	{
	...
	func_421(&(Global_1946054.f_1378), bParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1;
	}
	Global_1946054.f_1378.f_1[iParam2 /*3*/] = bParam0;
	Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1 = func_422(bParam0, iParam2, iParam1, func_1() != -1);
	if (bParam4)
	{
...
void func_303(int iParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	struct<4> /*32*/ sVar0;
...
int func_317(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	if (!func_100(bParam0, 0))
	{
	}
	...
	if (func_224(bParam0, uParam2, iParam3, bParam5, 0))
	{
		return 0;
	}
	if (!func_101(0))
	...
	if (!INVENTORY::_INVENTORY_ADD_ITEM_WITH_GUID(func_105(0), uParam1, uParam2, bParam0, uParam2->f_4, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
void func_321(int iParam0, bool bParam1, bool bParam2)
{
	...
	bVar0 = func_448(iParam0);
	if (bVar0 != 0 && !(iParam0 >= 0 && iParam0 <= 5))
	{
		if (func_449(iParam0, (1 << 9)))
		{
			func_303(30, bVar0, 0, 0, 0);
		}
	}
	if ((!func_450() && !bParam1) && !func_73(0, 0, 1))
	{
		func_451(MISC::VAR_STRING(10, "OUT_JOURN_DONE" /* GXTEntry: "~1~ completed." */, MISC::VAR_STRING(0, bVar0)), 10000, 0, 0, 0, 1);
	}
	func_452(iParam0, 6);
	if (bParam2)
	{
...
bool func_325(bool bParam0)
{
	...
	return Global_1946054.f_1497.f_1[func_300(bParam0, 1) /*3*/] != Global_1946054.f_57[func_300(bParam0, 1) /*11*/];
}

void func_326(int iParam0, bool bParam1)
{
	if (func_146(bParam1, joaat("CI_TAG_ITEM_EQUIPMENT")))
	{
		func_454(bParam1, 0);
	}
	else if (func_146(bParam1, 930141731))
	{
		func_454(bParam1, 1);
		func_455(iParam0);
	}
...
int func_332(bool bParam0)
{
	...
	if (!func_458(bParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
...
void func_335(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
...
bool func_337(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_343(bool bParam0, var uParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
	...
	while (iVar29 < 4)
	{
		...
		if (func_93(bParam0, &sVar0, iVar5, 0))
		{
			bVar28 = func_94(bParam0, &sVar6, iVar5);
...
struct<18> /*144*/ func_344(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
int func_361()
{
	...
	while (iVar1 < 12)
	{
		...
		if (func_174(bVar2, 1, 0) || func_367(func_366(bVar2)))
		{
			iVar0++;
		}
		iVar1++;
...
{
	if (func_474(bParam0) && func_174(bParam0, 1, 0))
	{
		return true;
	}
	else if (func_475(bParam0) & func_476(bParam0))
	{
		return true;
	}
	return false;
...
char* func_376(bool bParam0)
{
	...
	return HUD::GET_STRING_FROM_HASH_KEY(func_192(bParam0));
}
...
int func_387(bool bParam0)
{
	...
	return Global_1946054.f_1497.f_1[func_300(bParam0, 1) /*3*/];
}
...
void func_388()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_151(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN") /* GXTEntry: "John\'s Cattleman Revolver" */);
		func_198(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN") /* GXTEntry: "John\'s Cattleman Revolver" */, 1, joaat("ADD_REASON_DEFAULT"));
		...
		func_151(joaat("WEAPON_MELEE_KNIFE_JOHN") /* GXTEntry: "John\'s Knife" */);
		func_198(joaat("WEAPON_MELEE_KNIFE_JOHN") /* GXTEntry: "John\'s Knife" */, 1, joaat("ADD_REASON_DEFAULT"));
...
int func_397(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if (bParam0 == Global_1946054.f_57[func_300(bParam1, 1) /*11*/])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_421(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iVar2)
	{
		...
		case joaat("CI_CATEGORY_WARDROBE_SHIRT"):
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_398(bParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && joaat("CI_CATEGORY_WARDROBE_SPATS") == func_96(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
int func_422(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	bool bVar0;

	bVar0 = func_495(0);
	if (iParam2 != 0 && func_496(bParam0, bVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
	if (func_497(bParam0, func_415(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_423(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_498(bVar5, 6) || uParam0->f_1[iVar0 /*3*/] == Global_1946054.f_57[iVar0 /*11*/])
			{
			}
			else
			{
				iVar4 = func_397(uParam0->f_1[iVar0 /*3*/], bVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
{
	Global_1946054.f_57[func_300(bParam0, 1) /*11*/].f_10 -= (Global_1946054.f_57[func_300(bParam0, 1) /*11*/].f_10 & iParam1);
}
...
int func_444()
{
	...
	{
		bVar1 = Global_1946054.f_2657[iVar0];
		if (func_96(bVar1) == joaat("CI_CATEGORY_WARDROBE_OUTFIT"))
		{
			if (func_509() != bVar1)
			{
				iVar2++;
...
void func_447(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_446(iParam0))
	{
		...
		if ((!func_450() && !bParam1) && !func_73(0, 0, 1))
		{
			func_451(MISC::VAR_STRING(10, "OUT_JOURN_ADD" /* GXTEntry: "~1~ discovered." */, func_510(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
bool func_458(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_469(int iParam0, int iParam1, int iParam2)
{
	...
	func_244(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC" /* GXTEntry: "Hold ~INPUT_FEED_INTERACT~ for details" */, func_530(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_477()
{
	...
	func_534(0);
	func_535(7);
	func_536(joaat("KIT_BANDANA") /* GXTEntry: "Bandana" */, 1, 1, 0);
	if (func_322() == joaat("MPC_PLAYER_TYPE_SP_MARSTON"))
	{
		func_536(joaat("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000") /* GXTEntry: "John\'s Classic Hat" */, 1, 1, 1);
		func_536(joaat("CLOTHING_SP_MAR_OUTFIT_GUNSLINGER") /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
...
int func_496(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
bool func_497(bool bParam0, int iParam1, int iParam2)
{
	*iParam2 = joaat("BASE");
	return true;
}
...
{
	return (Global_1946054.f_57[func_300(bParam0, 1) /*11*/].f_10 & iParam1) != 0;
}
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_336(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD" /* GXTEntry: "Cold" */, "PMPLAYER_CONDITION_TEMPERATURE_HOT" /* GXTEntry: "Hot" */);
					}
					break;
				case 2:
					return func_336(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD" /* GXTEntry: "Good" */, "PMPLAYER_CONDITION_HONOR_BAD" /* GXTEntry: "Bad" */);
			}
			break;
		case 1:
		case 2:
...
void func_535(int iParam0)
{
	...
	while (iVar0 < Global_1946054.f_2657.f_19)
	{
		...
		if (func_96(bVar2) != joaat("CI_CATEGORY_WARDROBE_OUTFIT"))
		{
...
void func_536(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	bool bVar1;
	...
	if (func_578(iVar0))
	{
		INVENTORY::_INVENTORY_DISABLE_ITEM(func_105(0), bParam0, 0);
	}
...
bool func_555(bool bParam0)
{
	...
	if (func_146(bParam0, -1066545920))
	{
		return true;
	}
	return false;
...
bool func_557(bool bParam0)
{
	...
	if (func_146(bParam0, joaat("CI_TAG_ITEM_EQUIPMENT_HOLSTER")))
	{
		return true;
	}
	return false;
...
bool func_558(bool bParam0)
{
	...
	if (func_146(bParam0, joaat("CI_TAG_ITEM_EQUIPMENT_OFFHAND")))
	{
		return true;
	}
	return false;
...
bool func_571(bool bParam0, bool bParam1)
{
	...
	sVar0 = { func_68(bParam0, 0, 0) /*5*/ };
	sVar5 = { func_90(bParam0, sVar0, sVar0.f_4, 0) /*4*/ };
	if (func_104(bParam0, sVar0, sVar0.f_4, 0) <= 0)
	{
		return false;
	}
...
int func_574(bool bParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (func_96(bParam0) != joaat("CI_CATEGORY_WARDROBE_OUTFIT"))
	{
...
void func_595(var uParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (iParam2 == -1)
	{
		uParam0->f_1 = func_300(func_394(bParam1), 1);
		if (uParam0->f_1 == -1)
		{
		}
	}
