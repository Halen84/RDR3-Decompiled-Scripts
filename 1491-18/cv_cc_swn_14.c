...
bool func_72(var uParam0)
{
	...
	iLocal_16 = func_152(uParam0, joaat("P_CHAIRFOLDING02X"), 1.198f, -1.869f, 0.472f, "CHAIR" /* GXTEntry: "Chair" */, 1, 0, 1);
	iLocal_17 = func_152(uParam0, joaat("P_CHAIR_CRATE02X"), -1.863f, -0.829f, 0.479f, 0, 1, 0, 1);
	func_153(uParam0, -1.6251f, -0.625f, 1.15f, 6.81f, 1.0f, 1.0f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	func_153(uParam0, 1.1749f, -1.775f, 1.15f, 30.81f, 1.0f, 1.0f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	func_154(uParam0, "script@vignette@swanson_14@base", 1, 1, 0, 0);
	func_154(uParam0, "script@vignette@swanson_14@action", 0, 0, 1, 0);
	func_155(uParam0, iLocal_14, 3, joaat("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
