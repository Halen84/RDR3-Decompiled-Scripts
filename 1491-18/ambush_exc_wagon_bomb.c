...
int func_92(int iParam0)
{
	if (uLocal_15.f_57[iParam0] == 0)
	{
		...
		{
			uLocal_15.f_57[iParam0] = func_251(joaat("HORSE_CLASS_RIDING") /* GXTEntry: "Riding" */, 1);
		}
		else
		{
	...
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(uLocal_15[iVar0], 0, 1))
		{
			...
			if (!*uParam0)
			{
				...
				{
					func_174(uLocal_15[iVar0], Global_35, "AMBUSH_WAB_BYPASS", -1073741824 /* Float: -2f */, 0, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CRITICAL"));
					*uParam0 = 1;
				}
			}
			func_128(&uLocal_15, iVar0, 1);
...
bool func_146()
{
	...
	{
		func_40(&uLocal_292, 0);
		func_174(uLocal_15[1], Global_35, "AMBUSH_WAB_BYPASS", -1073741824 /* Float: -2f */, 0, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CRITICAL"));
		func_25(&uLocal_15, 1);
		func_270(uLocal_15.f_151, 1);
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_15[iVar1]))
		{
			...
			else
			{
				if (func_61(uLocal_15[iVar1], 0, 0))
				{
					...
					PED::_SET_PED_PERSONALITY(uLocal_15[iVar1], 993130593);
					if (!func_30(&uLocal_15, (1 << 14)))
					{
			...
			if (func_267(&uLocal_15, iVar0))
			{
				if (!bVar1)
				{
					if (func_97(iVar0) == joaat("G_M_Y_UNIEXCONFEDS_01"))
					{
						if (!func_133(&uLocal_278, 8))
						{
							func_174(uLocal_15[iVar0], Global_35, "AMBUSH_WAB_TRIGGER", -1073741824 /* Float: -2f */, 0, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CRITICAL"));
						}
						bVar1 = true;
					}
				}
...
{
	if (func_349(iParam1, 1114636288 /* Float: 60f */) || func_351(iParam1, 1, 1) <= 30.0f)
	{
		return false;
	}
	return true;
...
void func_287()
{
	...
	if (!func_133(&uLocal_278, (1 << 9)))
	{
		...
		iVar20 = func_428(&uVar0, &uVar18, 8, vVar22, 15.0f, 0, 0, 0, -1, 1, 0, -1082130432 /* Float: -1f */, 0, 0);
		iVar21 = 0;
		while (iVar21 < iVar20)
		{
			if (func_61(uVar0[iVar21], 0, 0))
			{
				...
				PED::APPLY_DAMAGE_TO_PED(uVar0[iVar21], 50, false, -1, 0);
			}
			iVar21++;
		}
...
bool func_302(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_440(iParam0, joaat("CURRENCY_CASH") /* GXTEntry: "Money" */, iParam1, iVar0);
	}
	...
	switch (func_534(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_536(iParam0, 1))
			{
				...
				if (!func_463(iParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_463(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_464(iParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
...
char* func_620(char* sParam0, int iParam1)
{
	...
	return func_665(MISC::VAR_STRING(10, "PLAYER_STRING" /* GXTEntry: "~fg~~1p~~fo~" */, sParam0), iParam1);
}
