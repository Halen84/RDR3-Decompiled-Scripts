...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	iVar1 = func_49(joaat("HORSE_CLASS_RIDING") /* GXTEntry: "Riding" */, 1);
	...
	func_52(uParam0, 0, "MWLO_LANTERN", joaat("S_INTERACT_LANTERN02X"), vParam1, 0.0f, 0);
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				func_69(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 2, (1 << 30));
				func_70(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 1, -1, 1);
				ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_372[0 /*8*/], uParam0->f_20[1 /*14*/], PED::GET_PED_BONE_INDEX(uParam0->f_20[1 /*14*/], 62111), -0.32f, 0.05f, -0.22f, 0.0f, 53.0f, 0.0f, false, false, false, false, 2, true, true, false);
...
float func_50(Vector3 vParam0)
{
	...
	vVar4.f_2 = 0.0f;
	vVar4 = { func_87(vVar4) /*3*/ };
	vVar7 = { -BUILTIN::SIN(fVar0), BUILTIN::COS(fVar0), 0.0f /*3*/ };
	if (func_88(vVar4, vVar7) < 0.0f)
	{
		fVar0 += 180.0f;
	}
	return fVar0;
...
bool func_78(Vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_119(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1.0f, 0))
			{
				return true;
			}
		}
...
float func_88(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5)
{
...
bool func_103(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (Global_1935630.f_26 & func_140(PLAYER::PLAYER_ID(), 0, 1, (uParam2->f_1 & (1 << 19)) == 0))
		{
