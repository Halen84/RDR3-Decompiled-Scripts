...
bool func_72(var uParam0)
{
	...
	vLocal_22 = { 662.609f, -1251.718f, 42.723f /*3*/ };
	fLocal_25 = 78.502f;
	vLocal_26 = { 660.045f, -1246.491f, 42.707f /*3*/ };
	fLocal_29 = 125.549f;
	vLocal_30 = { 658.926f, -1245.483f, 42.736f /*3*/ };
	fLocal_33 = 140.438f;
	...
	func_151(uParam0, -0.3f, -2.0004f, 0.0f, 0.0f, 4.5f, 3.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, vLocal_22, 0.0f, 1.2f, 1.2f, 5.0f, joaat("VOLBOX"), -1, 0, 1, 1);
	func_151(uParam0, vLocal_26, 0.0f, 1.2f, 1.2f, 5.0f, joaat("VOLBOX"), -1, 0, 1, 1);
	func_151(uParam0, vLocal_30, 0.0f, 1.2f, 1.2f, 5.0f, joaat("VOLBOX"), -1, 0, 1, 1);
	iLocal_18 = func_152(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 0, 1);
	iLocal_20 = func_152(uParam0, joaat("P_CIGAR02X"), 0.0f, 0.0f, 0.0f, "CIGAR", 0, 1, 1);
...
void func_162(var uParam0, int iParam1, Vector3 vParam2, float fParam5, int iParam6, bool bParam7)
{
	if (bParam7)
	{
		vParam2 = { func_262(uParam0, vParam2) /*3*/ };
...
void func_212(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_205(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
int func_302(var uParam0, int iParam1)
{
	...
	if (func_205(uParam0, iParam1, 1.0f))
	{
		return 1;
	}
...
void func_426(int iParam0, int iParam1)
{
	...
	func_401(iParam1, func_454(iParam1, (1 << 13)), func_454(iParam1, (1 << 14)), 1);
}
