...
void __SCRIPT()
{
	...
	while (true)
	{
		...
		fVar2 = PAD::GET_CONTROL_NORMAL(0, joaat("INPUT_MOVE_LR") /* GXTEntry: "Move left/right" */);
		fVar3 = PAD::GET_CONTROL_NORMAL(0, joaat("INPUT_MOVE_UD") /* GXTEntry: "Move up/down" */);
		...
		switch (iLocal_29)
		{
			...
			case 1:
				if (func_24())
				{
					...
					if (!MISC::IS_STRING_NULL_OR_EMPTY(&(sLocal_32.f_76)))
					{
						func_27(Global_35, &(sLocal_32.f_76), 1, 1061360239 /* Float: 0.762f */, 1053609165 /* Float: 0.4f */, 0, 0, 1);
					}
					if (!MISC::IS_STRING_NULL_OR_EMPTY(&(sLocal_32.f_84)) && !PED::IS_PED_INJURED(sLocal_32.f_98))
					{
						func_27(sLocal_32.f_98, &(sLocal_32.f_84), 1, 1061360239 /* Float: 0.762f */, 1053609165 /* Float: 0.4f */, 0, 0, 1);
					}
					func_28(1, 0, 0);
					if (!func_19())
					{
			...
			case 6:
				...
				AUDIO::_SET_AUDIO_SCENESET("Respawn" /* GXTEntry: "Respawn" */, "DEATH_FAIL_RESPAWN_SCENES");
				func_43(&sLocal_32, 0);
				if (func_45(func_44()))
				{
...
void func_1(bool bParam0)
{
	...
	while (iVar0 < sLocal_32.f_64)
	{
		...
		{
			func_77(joaat("CONSUMABLE_CIGARETTE_BOX") /* GXTEntry: "Premium Cigarettes" */, 1);
		}
		iVar0++;
	}
...
{
	if ((((((((((((((((TASK::IS_PED_WALKING(Global_35) || TASK::IS_PED_RUNNING(Global_35)) || TASK::IS_PED_SPRINTING(Global_35)) || PLAYER::IS_PLAYER_FREE_AIMING(PLAYER::PLAYER_ID())) || MISC::ABSF(fParam0) > 0.2f) || MISC::ABSF(fParam1) > 0.2f) || PAD::IS_CONTROL_JUST_PRESSED(0, joaat("INPUT_CONTEXT_A"))) || PAD::IS_CONTROL_JUST_PRESSED(0, joaat("INPUT_OPEN_WHEEL_MENU") /* GXTEntry: "Wheel Menu" */)) || PAD::IS_CONTROL_JUST_PRESSED(0, joaat("INPUT_TOGGLE_HOLSTER"))) || PAD::IS_CONTROL_JUST_PRESSED(0, joaat("INPUT_ATTACK") /* GXTEntry: "Fire weapon" */)) || PAD::IS_CONTROL_JUST_PRESSED(0, joaat("INPUT_ATTACK2"))) || PAD::IS_CONTROL_JUST_PRESSED(0, joaat("INPUT_MELEE_ATTACK") /* GXTEntry: "Melee attack" */)) || PAD::GET_CONTROL_NORMAL(0, joaat("INPUT_ATTACK") /* GXTEntry: "Fire weapon" */) > 0.0f) || PAD::IS_CONTROL_JUST_PRESSED(0, joaat("INPUT_SELECT_RADAR_MODE"))) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, joaat("INPUT_OPEN_JOURNAL"))) || PAD::IS_CONTROL_JUST_PRESSED(0, joaat("INPUT_OPEN_SATCHEL_MENU"))) || PAD::IS_CONTROL_JUST_PRESSED(0, joaat("INPUT_OPEN_JOURNAL")))
	{
		return 1;
	}
...
bool func_25()
{
	...
	return (PED::_IS_META_PED_USING_COMPONENT(Global_35, joaat("HATS")) || func_125(joaat("CI_CATEGORY_WARDROBE_HAT"), &uVar0));
}
...
void func_43(var uParam0, int iParam1)
{
	...
	if (func_152(iVar3))
	{
		...
		{
			WEAPON::SET_CURRENT_PED_WEAPON(Global_35, joaat("WEAPON_UNARMED") /* GXTEntry: "Unarmed" */, true, iVar0, false, false);
		}
	}
}
...
char* func_314(char* sParam0, int iParam1)
{
	...
	return func_444(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}
...
char* func_645(char* sParam0, int iParam1)
{
	...
	return func_444(MISC::VAR_STRING(10, "PLAYER_STRING" /* GXTEntry: "~fg~~1p~~fo~" */, sParam0), iParam1);
}
