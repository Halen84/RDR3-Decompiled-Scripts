...
void func_53()
{
	...
	bVar0 = false;
	if (func_88(joaat("WS_COLTER_STAGE_HIGH_SNOW")) || func_88(joaat("WS_COLTER_STAGE_CABIN_BURNING")))
	{
		bVar0 = true;
	}
	if (bVar0 != bLocal_0)
...
void func_61(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_51(iParam0) && func_78(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
...
char* func_103(char* sParam0, int iParam1)
{
	...
	return func_139(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}
