...
bool func_11()
{
	iLocal_15 = VOLUME::CREATE_VOLUME_CYLINDER(2747.629f, 2006.864f, 214.971f, 0.0f, 0.0f, 0.0f, 32.0f, 25.0f, 40.0f);
	return true;
}
...
void func_25()
{
	...
	if (!func_52(1, 1))
	{
		func_53(799);
		func_54(1);
		func_55(joaat("DOOR_ROC_HOUSE_INT_2"), 1, 0.0f, 0, 0, 0, 0, 0);
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(joaat("STORY_ITEM_ROCKY_7_PIC"), false);
	}
	else
	{
		func_56(6, 1, joaat("DOOR_ROC_HOUSE_INT_2"));
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(joaat("STORY_ITEM_ROCKY_7_PIC"), true);
		if (func_57(59))
		{
			func_58();
		}
...
int func_53(int iParam0)
{
	...
	iVar0 = PERSCHAR::_GET_PERSCHAR_PED_INDEX(func_105(iParam0));
...
void func_65()
{
	...
	if (((func_100(6, 2) || func_100(6, 1)) || func_115(6, (1 << 14))) || func_133(PLAYER::PLAYER_ID(), 1, 0, 1))
	{
		func_124(8);
		func_134(&uVar0, 0);
	}
...
void func_73(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_60(iParam0) && func_90(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_149(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_149(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_149(&cVar6, joaat("COLOR_PURE_WHITE")), func_149(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
char* func_149(char* sParam0, int iParam1)
{
	...
	return func_199(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_150(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_154(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
bool func_186()
{
	return func_115(6, (1 << 22));
}

bool func_187()
{
	return func_115(6, (1 << 23));
}
...
bool func_193(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_183(iVar0) && func_226(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
int func_216(struct<2> /*16*/ sParam0, var uParam2)
{
	int iVar0;
...
bool func_227(Vector3 vParam0, int iParam3)
{
	...
	func_242(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_243(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
