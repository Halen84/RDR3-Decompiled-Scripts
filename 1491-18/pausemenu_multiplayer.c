...
void __SCRIPT()
{
	...
	{
		case 2:
			if (sScriptParam_0.f_1 == joaat("LAUNCHMP") || sScriptParam_0.f_1 == joaat("SWITCHTOFREEMODE"))
			{
			...
			else if (sScriptParam_0.f_1 == joaat("LAUNCHMPPRIVATE") || sScriptParam_0.f_1 == joaat("SWITCHTOPRIVATE"))
			{
				if (!NETWORK::NETWORK_CHECK_ACCESS_AND_ALERT_IF_FAIL())
				{
					return;
