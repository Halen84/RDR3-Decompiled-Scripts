...
void func_8(var uParam0)
{
	...
	switch (iLocal_62)
	{
		case 0:
			...
			if (*uParam0 == joaat("DISCOVER_LOC_AXE_IN_TREE") || *uParam0 == joaat("DISCOVER_LOC_TREASURE_MAP_HALVES"))
			{
				if (func_48(*uParam0))
				{
					if (func_20(uParam0))
			...
			else if (*uParam0 == joaat("DISCOVER_LOC_FRANKENSTEIN_BOOK") || *uParam0 == joaat("DISCOVER_LOC_BLACK_FLOWER"))
			{
				...
				else if (*uParam0 == joaat("DISCOVER_LOC_BLACK_FLOWER"))
				{
					if (func_48(*uParam0))
					{
						func_49(&iLocal_62, 13, 1);
			...
			else if (*uParam0 == joaat("DISCOVER_LOC_MICAH_CAMP"))
			{
				if (!func_54(uParam0))
				{
					return;
			...
			else
			{
				...
				{
					if (!func_48(joaat("DISCOVER_LOC_DREAMCATCHERS")))
					{
						if (func_56() >= 20)
						{
							if (!func_48(joaat("DISCOVER_LOC_DREAMCATCHERS")))
							{
								func_57(joaat("DISCOVER_LOC_DREAMCATCHERS"));
							}
						}
						return;
					}
				}
				else if (*uParam0 == joaat("DISCOVER_LOC_WHISKEY_TREE"))
				{
				...
				else if (*uParam0 == joaat("DISCOVER_LOC_WAGON_CIRCLE"))
				{
					func_59();
				}
		...
		case 10:
			...
			if (*uParam0 == joaat("DISCOVER_LOC_ANCIENT_URN"))
			{
				if (!iLocal_55[0])
				{
			...
			else if (*uParam0 == joaat("DISCOVER_LOC_WHISKEY_TREE"))
			{
				...
				if (iLocal_55[2])
				{
					if (!func_48(*uParam0))
					{
						...
						{
							if (func_71(joaat("PROVISION_GOLD_NUGGET") /* GXTEntry: "Gold Nugget" */))
							{
								func_68(uParam0);
								func_69(uParam0);
								func_49(&iLocal_62, 13, 1);
			...
			else if (*uParam0 == joaat("DISCOVER_LOC_VIKING_GEAR"))
			{
			...
			else if ((*uParam0 == -261997819 || *uParam0 == joaat("DISCOVER_LOC_CIVIL_WAR_SWORD")) || *uParam0 == joaat("DISCOVER_LOC_PIRATE_SWORD"))
			{
			...
			else if (*uParam0 == joaat("DISCOVER_LOC_AXE_IN_TREE") || *uParam0 == joaat("DISCOVER_LOC_ANCIENT_TOMAHAWK"))
			{
				if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_47[0]))
				{
					if (PED::IS_PED_USING_THIS_SCENARIO(Global_35, iLocal_47[0]) && TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 0))
			...
			else if (*uParam0 == joaat("DISCOVER_LOC_SHRINE"))
			{
				iVar3 = 0;
				while (iVar3 <= 1)
				{
			...
			else if (((*uParam0 == joaat("DISCOVER_LOC_PIRATE_RUM") || *uParam0 == joaat("DISCOVER_LOC_ABANDONED_WELL")) || *uParam0 == joaat("DISCOVER_LOC_RAILROAD_GRAVESTONE")) || *uParam0 == joaat("DISCOVER_LOC_BIRD_NEST"))
			{
				if (VOLUME::DOES_VOLUME_EXIST(iLocal_14) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_14, true, 0))
				{
					func_68(uParam0);
		...
		case 11:
					...
					if (!func_39(Global_40.f_8863.f_150, 256))
					{
						if (PED::IS_PED_USING_THIS_SCENARIO(Global_35, iLocal_47[0]))
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, MISC::GET_HASH_KEY("ObjectExchange")))
							{
								...
								func_96(1500, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1, joaat("ADD_REASON_DEFAULT"));
							}
						}
					}
			...
			else if (*uParam0 == joaat("DISCOVER_LOC_ANCIENT_TOMAHAWK"))
			{
				if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_47[0]))
				{
					if (!PED::IS_PED_USING_THIS_SCENARIO(Global_35, iLocal_47[0]) && !TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 0))
			...
			else if (*uParam0 == 373034311)
			{
				func_68(uParam0);
				iVar7 = func_98();
				func_99(joaat("DISCOVER_LOC_DREAMCATCHERS"), iVar7, 20);
				func_100(MISC::VAR_STRING(2, "MISSION_COMPLETE" /* GXTEntry: "Mission Complete" */));
				func_37(1, -1);
				func_69(uParam0);
				func_49(&iLocal_62, 13, 1);
			}
...
void func_9(var uParam0)
{
	...
	if (*uParam0 == joaat("DISCOVER_LOC_WHISKEY_TREE") || *uParam0 == joaat("DISCOVER_LOC_BLACK_FLOWER"))
	{
		iVar0 = 0;
		while (iVar0 <= (2 - 1))
		{
...
void func_28(var uParam0)
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == joaat("DISCOVER_LOC_GRAVE_ARTHUR"))
		{
			if (func_48(*uParam0))
			{
				uParam0->f_6.f_8 = func_117("DISCO_FOCUS" /* GXTEntry: "View" */, joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
				func_34(uParam0->f_6.f_8, 0, 1);
			}
			else
			{
				uParam0->f_6.f_8 = func_117("DISCO_EXAMINE" /* GXTEntry: "Inspect" */, joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
			}
		}
		else if (*uParam0 == joaat("DISCOVER_LOC_GRAVE"))
		{
		...
		else if (*uParam0 == joaat("DISCOVER_LOC_BRAITHWAITES_SECRET"))
		{
			...
			{
				uParam0->f_6.f_8 = func_117("DISCO_EXAMINE" /* GXTEntry: "Inspect" */, joaat("INPUT_CONTEXT_Y"), Global_35, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("PLAYER_FOCUS_TIMING"), 0, 0);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_117("DISCO_EXAMINE" /* GXTEntry: "Inspect" */, joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("PLAYER_FOCUS_TIMING"), 0, 0);
		}
...
void func_62(var uParam0)
{
	...
	func_158(&sLocal_66);
	if (((((((((*uParam0 == -763376358 || *uParam0 == joaat("DISCOVER_LOC_CAT_MASK")) || *uParam0 == joaat("DISCOVER_LOC_RAM_MASK")) || *uParam0 == joaat("DISCOVER_LOC_VIKING_GEAR")) || *uParam0 == joaat("DISCOVER_LOC_OBJECT_IN_TREE")) || *uParam0 == joaat("DISCOVER_LOC_SCARECROW_1")) || *uParam0 == joaat("DISCOVER_LOC_SCARECROW_2")) || *uParam0 == joaat("DISCOVER_LOC_SCARECROW_3")) || *uParam0 == joaat("DISCOVER_LOC_SCARECROW_4")) || *uParam0 == 2135153015)
	{
		iLocal_15 = func_159(uParam0);
	}
	if (*uParam0 == joaat("DISCOVER_LOC_FRANKENSTEIN_BOOK") || *uParam0 == joaat("DISCOVER_LOC_DEFACED_GRAVE"))
	{
		iVar0 = 0;
		while (iVar0 <= (4 - 1))
		{
...
bool func_65(var uParam0)
{
	...
	if (*uParam0 == joaat("DISCOVER_LOC_ANCIENT_URN") || *uParam0 == joaat("DISCOVER_LOC_WHISKEY_TREE"))
	{
		if (*uParam0 == joaat("DISCOVER_LOC_WHISKEY_TREE"))
		{
	...
	else if (((((((((*uParam0 == -763376358 || *uParam0 == joaat("DISCOVER_LOC_CAT_MASK")) || *uParam0 == joaat("DISCOVER_LOC_RAM_MASK")) || *uParam0 == joaat("DISCOVER_LOC_VIKING_GEAR")) || *uParam0 == joaat("DISCOVER_LOC_OBJECT_IN_TREE")) || *uParam0 == joaat("DISCOVER_LOC_SCARECROW_1")) || *uParam0 == joaat("DISCOVER_LOC_SCARECROW_2")) || *uParam0 == joaat("DISCOVER_LOC_SCARECROW_3")) || *uParam0 == joaat("DISCOVER_LOC_SCARECROW_4")) || *uParam0 == 2135153015)
	{
		if (*uParam0 == joaat("DISCOVER_LOC_VIKING_GEAR"))
		{
			if (!func_39(Global_40.f_8863.f_149, 32))
			{
	...
	if (*uParam0 == joaat("DISCOVER_LOC_SHRINE") || *uParam0 == joaat("DISCOVER_LOC_ANCIENT_URN"))
	{
		if (!TASK::DOES_SCENARIO_POINT_EXIST(iLocal_47[0]))
		{
			iLocal_47[0] = func_169(func_87(uParam0, uParam0->f_4), func_86(uParam0, uParam0->f_4), func_168(uParam0, uParam0->f_4), 0, 0, 0);
	...
	if ((*uParam0 == joaat("DISCOVER_LOC_BANK_STAGECOACH") || *uParam0 == joaat("DISCOVER_LOC_METEORITE")) || *uParam0 == joaat("DISCOVER_LOC_DEFACED_GRAVE"))
	{
		if (!ENTITY::IS_ENTITY_DEAD(sLocal_66[0]))
		{
			ENTITY::FREEZE_ENTITY_POSITION(sLocal_66[0], true);
			if (!*uParam0 == joaat("DISCOVER_LOC_DEFACED_GRAVE"))
			{
	...
	{
		func_175(&iLocal_15);
		if ((((*uParam0 == -763376358 || *uParam0 == joaat("DISCOVER_LOC_CAT_MASK")) || *uParam0 == joaat("DISCOVER_LOC_RAM_MASK")) || *uParam0 == joaat("DISCOVER_LOC_VIKING_GEAR")) || *uParam0 == 2135153015)
		{
			if (!ENTITY::IS_ENTITY_DEAD(sLocal_66[0]))
			{
				if (((*uParam0 == -763376358 || *uParam0 == joaat("DISCOVER_LOC_CAT_MASK")) || *uParam0 == joaat("DISCOVER_LOC_RAM_MASK")) || *uParam0 == joaat("DISCOVER_LOC_VIKING_GEAR"))
				{
	...
	else if (*uParam0 == joaat("DISCOVER_LOC_ANCIENT_URN"))
	{
		if (!ENTITY::IS_ENTITY_DEAD(sLocal_66[0]))
		{
		}
...
int func_72(var uParam0)
{
	...
	{
		case -763376358:
			return joaat("CLOTHING_ITEM_MASK_PIG_001") /* GXTEntry: "Pig Mask" */;
		case joaat("DISCOVER_LOC_PAGAN_RITUAL"):
			return joaat("CLOTHING_ITEM_SKULLMASK_MR1_001_1") /* GXTEntry: "Pagan Skull Mask" */;
		case joaat("DISCOVER_LOC_CAT_MASK"):
			return joaat("CLOTHING_ITEM_SKULLMASK_MR1_002_1") /* GXTEntry: "Cat Skull Mask" */;
		case joaat("DISCOVER_LOC_RAM_MASK"):
			return joaat("CLOTHING_ITEM_SKULLMASK_MR1_000_1") /* GXTEntry: "Ram Skull Mask" */;
		case joaat("DISCOVER_LOC_PIRATE_SKELETON"):
			return joaat("CLOTHING_ITEM_PZ_HAT_PIRATE_01") /* GXTEntry: "Tricorn Hat" */;
		case joaat("DISCOVER_LOC_DEAD_CHINESE_TRAVELLER"):
			return joaat("CLOTHING_SP_CHINESE_LABOR_HAT_000_1") /* GXTEntry: "Chinese Skull Cap" */;
		case joaat("DISCOVER_LOC_OBJECT_IN_TREE"):
			return joaat("CLOTHING_SP_CIVIL_WAR_HAT_000_1") /* GXTEntry: "Civil War Hardee Hat" */;
		case joaat("DISCOVER_LOC_FROZEN_SETTLER"):
			return joaat("CLOTHING_SP_CONQUISTADOR_HAT_000_1") /* GXTEntry: "Morion Helmet" */;
		case joaat("DISCOVER_LOC_DEAD_MINER"):
			return joaat("CLOTHING_SP_DEAD_MINER_HAT_000_1") /* GXTEntry: "Miner\'s Hat" */;
		case joaat("DISCOVER_LOC_SCARECROW_1"):
			return joaat("CLOTHING_SP_SCARECROW_01_HAT_000_1") /* GXTEntry: "Scarecrow Derby Hat" */;
		case joaat("DISCOVER_LOC_SCARECROW_2"):
			return joaat("CLOTHING_SP_SCARECROW_02_HAT_000_1") /* GXTEntry: "Scarecrow Sombrero" */;
		case joaat("DISCOVER_LOC_SCARECROW_3"):
			return joaat("CLOTHING_SP_SCARECROW_03_HAT_000_1") /* GXTEntry: "Scarecrow Top Hat" */;
		case joaat("DISCOVER_LOC_SCARECROW_4"):
			return joaat("CLOTHING_SP_SCARECROW_04_HAT_000_1") /* GXTEntry: "Scarecrow Hat" */;
		case joaat("DISCOVER_LOC_RAILROAD_GRAVESTONE"):
			return joaat("CLOTHING_SP_CHINESE_LABOR_HAT_000_1") /* GXTEntry: "Chinese Skull Cap" */;
		case joaat("DISCOVER_LOC_VIKING_GEAR"):
			return joaat("CLOTHING_SP_VIKING_HAT_000_1") /* GXTEntry: "Viking Helmet" */;
		case 2135153015:
			return joaat("CLOTHING_ITEM_SP_VALSHERIFF_HAT_000") /* GXTEntry: "Nevada Hat" */;
		default:
			break;
	}
	return 0;
...
int func_73(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	{
		if ((!func_199(iParam0, joaat("CI_TAG_ITEM_TALISMAN")) && !func_199(iParam0, joaat("CI_TAG_ITEM_UPGRADE"))) && !func_199(iParam0, joaat("CI_TAG_ITEM_IS_SATCHEL")))
		{
			bVar3 = true;
		}
	}
	...
	if (!bVar3)
	{
		...
		else if (func_199(iParam0, joaat("CI_TAG_ITEM_FISHING_LURE")))
		{
			switch (iParam0)
			{
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_LAKE") /* GXTEntry: "Special Lake Lure" */:
					if (!func_89(joaat("DOCUMENT_PAMPHLET_SPECIAL_LAKE_LURE") /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0))
					{
						func_73(joaat("DOCUMENT_PAMPHLET_SPECIAL_LAKE_LURE") /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_RIVER") /* GXTEntry: "Special River Lure" */:
					if (!func_89(joaat("DOCUMENT_PAMPHLET_SPECIAL_RIVER_LURE") /* GXTEntry: "Special River Lure Handbill" */, 1, 0))
					{
						func_73(joaat("DOCUMENT_PAMPHLET_SPECIAL_RIVER_LURE") /* GXTEntry: "Special River Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_SWAMP") /* GXTEntry: "Special Swamp Lure" */:
					if (!func_89(joaat("DOCUMENT_PAMPHLET_SPECIAL_SWAMP_LURE") /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0))
					{
						func_73(joaat("DOCUMENT_PAMPHLET_SPECIAL_SWAMP_LURE") /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_LAKE") /* GXTEntry: "Lake Lure" */:
					if (!func_89(joaat("DOCUMENT_PAMPHLET_LAKE_LURE") /* GXTEntry: "Lake Lure Handbill" */, 1, 0))
					{
						func_73(joaat("DOCUMENT_PAMPHLET_LAKE_LURE") /* GXTEntry: "Lake Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_RIVER") /* GXTEntry: "River Lure" */:
					if (!func_89(joaat("DOCUMENT_PAMPHLET_RIVER_LURE") /* GXTEntry: "River Lure Handbill" */, 1, 0))
					{
						func_73(joaat("DOCUMENT_PAMPHLET_RIVER_LURE") /* GXTEntry: "River Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_SWAMP") /* GXTEntry: "Swamp Lure" */:
					if (!func_89(joaat("DOCUMENT_PAMPHLET_SWAMP_LURE") /* GXTEntry: "Swamp Lure Handbill" */, 1, 0))
					{
						func_73(joaat("DOCUMENT_PAMPHLET_SWAMP_LURE") /* GXTEntry: "Swamp Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
			}
		}
		...
		else if (func_199(iParam0, joaat("CI_TAG_ITEM_IS_SATCHEL")))
		{
			iVar8 = 0;
			switch (iParam0)
			{
		...
		switch (iParam0)
		{
			...
			case joaat("UPGRADE_OFFHAND_HOLSTER") /* GXTEntry: "Upgraded Off-Hand Holster" */:
				...
				{
					func_231(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_OFFHAND_HOLSTER") /* GXTEntry: "Upgraded Off-Hand Holster" */, 0, joaat("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_232(&iVar9, 0))
				{
			...
			case joaat("UPGRADE_BANDOLIER") /* GXTEntry: "Upgraded Bandolier" */:
				...
				{
					func_231(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_BANDOLIER") /* GXTEntry: "Upgraded Bandolier" */, 0, joaat("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case joaat("CONSUMABLE_AGED_PIRATE_RUM") /* GXTEntry: "Aged Pirate Rum" */:
				func_247(242, func_246(joaat("CONSUMABLE_AGED_PIRATE_RUM") /* GXTEntry: "Aged Pirate Rum" */), 0);
				break;
			case joaat("CONSUMABLE_GINSENG_ELIXIER") /* GXTEntry: "Ginseng Elixir" */:
				func_247(240, func_246(joaat("CONSUMABLE_GINSENG_ELIXIER") /* GXTEntry: "Ginseng Elixir" */), 0);
				break;
			case joaat("CONSUMABLE_VALERIAN_ROOT") /* GXTEntry: "Valerian Root" */:
				func_247(241, func_246(joaat("CONSUMABLE_VALERIAN_ROOT") /* GXTEntry: "Valerian Root" */), 0);
				break;
			...
			case joaat("CONSUMABLE_MOONSHINE") /* GXTEntry: "Moonshine" */:
				...
				{
					func_248(594, joaat("TF_FORTIFY_TANK1") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Health Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_RESTORATIVE") /* GXTEntry: "Bitters" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_248(594, joaat("TF_FORTIFY_TANK2") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Stamina Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_CHEWING_TOBACCO_USED") /* GXTEntry: "Opened Chewing Tobacco" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_248(594, joaat("TF_FORTIFY_TANK3") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Dead Eye Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_POTENT_TONIC") /* GXTEntry: "Potent Miracle Tonic" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_248(594, joaat("TF_FORTIFY_TANK4") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    ...
    "d Eye Bars." */, 1, 1);
			...
			case joaat("CONSUMABLE_MEAL_ROAST_BEEF") /* GXTEntry: "Roast Beef" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_248(595, joaat("TF_FORTIFY_CORE1") /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    "for a short period of time. This Provision will Fortify your Health Core." */, 1, 1);
			...
			case joaat("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL_EGGS") /* GXTEntry: "Regional Beef and Eggs Stew" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_248(595, joaat("TF_FORTIFY_CORE2") /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
...
int func_74(var uParam0, int iParam1)
{
	...
	{
		case -261997819:
			return joaat("WEAPON_MELEE_ANCIENT_HATCHET") /* GXTEntry: "Stone Hatchet" */;
		case joaat("DISCOVER_LOC_ANCIENT_TOMAHAWK"):
			return joaat("WEAPON_THROWN_TOMAHAWK_ANCIENT") /* GXTEntry: "Ancient Tomahawk" */;
		case joaat("DISCOVER_LOC_DEAD_MINER"):
			return joaat("WEAPON_MELEE_KNIFE_MINER") /* GXTEntry: "Wide-Blade Knife" */;
		case joaat("DISCOVER_LOC_VIKING_GEAR"):
			return joaat("WEAPON_MELEE_HATCHET_VIKING") /* GXTEntry: "Viking Hatchet" */;
		case joaat("DISCOVER_LOC_CIVIL_WAR_SWORD"):
			return joaat("WEAPON_MELEE_KNIFE_CIVIL_WAR") /* GXTEntry: "Civil War Knife" */;
		case joaat("DISCOVER_LOC_PIRATE_SWORD"):
			return joaat("WEAPON_MELEE_BROKEN_SWORD") /* GXTEntry: "Broken Pirate Sword" */;
		case joaat("DISCOVER_LOC_TREASURE_MAP_HALVES"):
			return joaat("WEAPON_REVOLVER_SCHOFIELD_GOLDEN") /* GXTEntry: "Otis Miller\'s Revolver" */;
		case joaat("DISCOVER_LOC_DEAD_BEAR"):
			return joaat("WEAPON_MELEE_KNIFE_BEAR") /* GXTEntry: "Antler Knife" */;
		case joaat("DISCOVER_LOC_DEAD_MICAH"):
			return joaat("WEAPON_REVOLVER_DOUBLEACTION_MICAH") /* GXTEntry: "Micah\'s Revolver" */;
		case joaat("DISCOVER_LOC_AXE_IN_TREE"):
			switch (iParam1)
			{
				case 0:
					return joaat("WEAPON_MELEE_HATCHET_DOUBLE_BIT") /* GXTEntry: "Double Bit Hatchet" */;
				case 1:
					return joaat("WEAPON_MELEE_HATCHET_HEWING") /* GXTEntry: "Hewing Hatchet" */;
				case 2:
					return joaat("WEAPON_MELEE_HATCHET_HUNTER") /* GXTEntry: "Hunter Hatchet" */;
				case 3:
					return joaat("WEAPON_MELEE_HATCHET_DOUBLE_BIT_RUSTED") /* GXTEntry: "Rusted Double Bit Hatchet" */;
				case 4:
					return joaat("WEAPON_MELEE_HATCHET_HUNTER_RUSTED") /* GXTEntry: "Rusted Hunter Hatchet" */;
				default:
					break;
			}
			break;
...
int func_82(var uParam0, int iParam1)
{
	...
	{
		case joaat("DISCOVER_LOC_RUNAWAY_CORPSE"):
			return joaat("DOCUMENT_DISCO_RUNAWAY_LETTER") /* GXTEntry: "Letter to Uncle Lewis from Elijah" */;
		case 1937333853:
			return joaat("DOCUMENT_DISCO_DEAD_SOLDIER_LETTER") /* GXTEntry: "Letter to Garfield from Martha" */;
		case joaat("DISCOVER_LOC_ABANDONED_OIL_WELL"):
			return joaat("DOCUMENT_DISCO_ABANDONED_OILDRILL_LETTER") /* GXTEntry: "Letter from Cornwall Kerosene & Tar" */;
		case joaat("DISCOVER_LOC_JESUIT_MISSIONARY"):
			return joaat("DOCUMENT_DISCO_LETTER_JESUIT") /* GXTEntry: "Letter to Brother Rodolfo" */;
		case joaat("DISCOVER_LOC_CIVIL_WAR_FORT"):
			return joaat("DOCUMENT_CWFORT_JOURNAL") /* GXTEntry: "Civil War Report" */;
		case joaat("DISCOVER_LOC_FACE_IN_CLIFF"):
			return joaat("DOCUMENT_DISCO_FACE_IN_CLIFF_LETTER") /* GXTEntry: "Note from the Sculptor" */;
		case joaat("DISCOVER_LOC_DEFACED_GRAVE"):
			return joaat("DOCUMENT_DISCO_GRAVE_NEWSCLIP") /* GXTEntry: "Grave Newspaper Clipping" */;
		case 2135153015:
			return joaat("DOCUMENT_DISCO_BOOTS_LETTER") /* GXTEntry: "Note from Robert Elliot Patchen" */;
		case joaat("DISCOVER_LOC_DEAD_CHINESE_TRAVELLER"):
			return joaat("DOCUMENT_LETTER_CHINESE_TRAVELLER") /* GXTEntry: "Letter to Zhou Yi from Zhou Wei" */;
		case joaat("DISCOVER_LOC_FRANKENSTEIN_BOOK"):
			switch (iParam1)
			{
				case 0:
					return joaat("DOCUMENT_NOTE_FRANKENSTEIN_1") /* GXTEntry: "Experiment Notes 1" */;
				case 1:
					return joaat("DOCUMENT_NOTE_FRANKENSTEIN_2") /* GXTEntry: "Experiment Notes 2" */;
				case 2:
					return joaat("DOCUMENT_NOTE_FRANKENSTEIN_3") /* GXTEntry: "Experiment Notes 3" */;
				case 3:
					return joaat("DOCUMENT_NOTE_FRANKENSTEIN_4") /* GXTEntry: "Experiment Notes 4" */;
				default:
					break;
			}
			break;
		case -1061274876:
			...
			{
				case 0:
					return joaat("DOCUMENT_DISCO_MAIL_WAGON_1") /* GXTEntry: "Letter to Judge Finley" */;
				case 1:
					return joaat("DOCUMENT_DISCO_MAIL_WAGON_2") /* GXTEntry: "Letter to Henrietta Douglas" */;
				case 2:
					return joaat("DOCUMENT_DISCO_MAIL_WAGON_3") /* GXTEntry: "Letter to Miriam Wegner" */;
				case 3:
					return joaat("DOCUMENT_DISCO_MAIL_WAGON_4") /* GXTEntry: "Letter to the Saint Denis Times Tribune" */;
				case 4:
					return joaat("DOCUMENT_DISCO_MAIL_WAGON_5") /* GXTEntry: "Letter to William Errington" */;
				default:
					break;
			}
			break;
		case joaat("DISCOVER_LOC_MICAH_CAMP"):
			switch (iParam1)
			{
				...
				case 2:
					return joaat("DOCUMENT_DUTCH_BURNED_POSTER") /* GXTEntry: "Dutch\'s Wanted Poster" */;
				default:
					break;
			}
			break;
		case joaat("DISCOVER_LOC_TREASURE_MAP_HALVES"):
			switch (uParam0->f_4)
			{
				case 0:
					...
					{
						case 0:
							return joaat("DOCUMENT_DISCO_MAP_HALF_1") /* GXTEntry: "Torn Treasure Map 1" */;
						case 1:
							return joaat("DOCUMENT_DISCO_MAP_HALF_2") /* GXTEntry: "Torn Treasure Map 2" */;
						case 2:
							return joaat("DOCUMENT_DISCO_MAP_FULL") /* GXTEntry: "Mended Map" */;
						default:
							break;
					}
					break;
				...
				case 2:
					...
					{
						case 3:
							return joaat("DOCUMENT_BARE_LADY_PHOTO_01") /* GXTEntry: "Erotic Photograph" */;
						case 4:
							return joaat("DOCUMENT_BARE_LADY_PHOTO_02") /* GXTEntry: "Erotic Photograph" */;
						case 5:
							return joaat("DOCUMENT_BARE_LADY_PHOTO_03") /* GXTEntry: "Erotic Photograph" */;
						case 6:
							return joaat("DOCUMENT_BARE_LADY_PHOTO_04") /* GXTEntry: "Erotic Photograph" */;
						case 7:
							return joaat("DOCUMENT_BARE_LADY_PHOTO_05") /* GXTEntry: "Erotic Photograph" */;
						default:
							break;
					}
					break;
...
int func_88(var uParam0)
{
	...
	{
		case joaat("DISCOVER_LOC_WAGON_CIRCLE"):
			return joaat("AMMO_ARROW") /* GXTEntry: "Arrows" */;
		case joaat("DISCOVER_LOC_TREASURE_MAP_HALVES"):
			return joaat("AMMO_REVOLVER") /* GXTEntry: "Revolver Cartridges - Regular" */;
		default:
			break;
	}
	return 0;
	...
	if (func_58(Global_35, func_86(uParam0, uParam0->f_4), 15.0f, 1, 1))
	{
		...
		else if (!DECORATOR::DECOR_EXIST_ON((*uParam2)[iParam3], "letter_item"))
		{
			...
			if (*uParam0 == joaat("DISCOVER_LOC_FRANKENSTEIN_BOOK"))
			{
				if (iParam3 == 0)
				{
					iVar0 = joaat("DOCUMENT_NOTE_FRANKENSTEIN_1"); /* GXTEntry: "Experiment Notes 1" */
				}
				else if (iParam3 == 1)
				{
					iVar0 = joaat("DOCUMENT_NOTE_FRANKENSTEIN_2"); /* GXTEntry: "Experiment Notes 2" */
				}
				else if (iParam3 == 2)
				{
					iVar0 = joaat("DOCUMENT_NOTE_FRANKENSTEIN_3"); /* GXTEntry: "Experiment Notes 3" */
				}
				else if (iParam3 == 3)
				{
					iVar0 = joaat("DOCUMENT_NOTE_FRANKENSTEIN_4"); /* GXTEntry: "Experiment Notes 4" */
				}
			}
			else if (*uParam0 == joaat("DISCOVER_LOC_GRAYS_SECRET"))
			{
				iVar0 = joaat("DOCUMENT_DISCO_GRAYS_SECRET_LETTER"); /* GXTEntry: "Gray Family History Letter" */
			}
...
int func_93(var uParam0, int iParam1)
{
	switch (*uParam0)
	{
		case joaat("DISCOVER_LOC_ANCIENT_URN"):
			...
			{
				case 1:
					return joaat("PROVISION_DISCO_SHRUNKEN_HEAD") /* GXTEntry: "Shrunken Head" */;
				default:
					break;
			}
			break;
		case joaat("DISCOVER_LOC_SHRINE"):
			...
			{
				case 0:
					return joaat("CONSUMABLE_WHISKEY") /* GXTEntry: "Kentucky Bourbon" */;
				case 1:
					return joaat("CONSUMABLE_APPLE") /* GXTEntry: "Apple" */;
				default:
					break;
			}
			break;
		case joaat("DISCOVER_LOC_STRANGE_STATUES"):
			...
			{
				case 0:
					return joaat("PROVISION_GOLDBAR_LARGE") /* GXTEntry: "Gold Bar" */;
				case 1:
					return joaat("PROVISION_GOLDBAR_LARGE") /* GXTEntry: "Gold Bar" */;
				case 2:
					return joaat("PROVISION_GOLDBAR_LARGE") /* GXTEntry: "Gold Bar" */;
		...
		case 373034311:
			...
			{
				case 0:
					return joaat("PROVISION_DISCO_ARROWHEAD_02") /* GXTEntry: "Ancient Arrowhead" */;
				default:
					break;
			}
			break;
		case joaat("DISCOVER_LOC_OLD_DIRTY_CABIN"):
			...
			{
				case 0:
					return joaat("PROVISION_DISCO_FERTILITY_STATUE") /* GXTEntry: "Fertility Statue" */;
				default:
					break;
			}
			break;
...
int func_95(var uParam0, int iParam1)
{
	...
	{
		case -2108030724:
			return joaat("PROVISION_CATHERINES_NECKLACE") /* GXTEntry: "Catherine\'s Brooch" */;
		case -777592153:
		case joaat("DISCOVER_LOC_BLACK_SHEEP"):
			return joaat("PROVISION_GOLDRING") /* GXTEntry: "Gold Wedding Ring" */;
		case joaat("DISCOVER_LOC_DEAD_MINER"):
		case joaat("DISCOVER_LOC_WHISKEY_TREE"):
			return joaat("PROVISION_GOLD_NUGGET") /* GXTEntry: "Gold Nugget" */;
		case joaat("DISCOVER_LOC_STONEHENGE"):
			return joaat("PROVISION_DISCO_VIKING_COMB") /* GXTEntry: "Ancient viking comb" */;
		case joaat("DISCOVER_LOC_WATER_DIVINER"):
			return joaat("PROVISION_JEWELRYBAG_SM") /* GXTEntry: "Small Jewelry Bag" */;
		case joaat("DISCOVER_LOC_METEORITE"):
		case joaat("DISCOVER_LOC_METEOR_HOUSE"):
			return joaat("PROVISION_ASTEROID_CHUNK") /* GXTEntry: "Meteorite" */;
		case joaat("DISCOVER_LOC_BLACK_FLOWER"):
			switch (iParam1)
			{
				case 0:
					return joaat("PROVISION_RING_PLATINUM") /* GXTEntry: "Platinum Band" */;
				case 1:
					return joaat("PROVISION_DISCO_ANCIENT_NECKLACE") /* GXTEntry: "Ancient Necklace" */;
				default:
					break;
			}
			break;
...
{
	UILOG::_UILOG_SET_PENDING_DETAILS_ID(1, func_272(joaat("DISCOVER_LOC_DREAMCATCHERS")));
	func_280(MISC::VAR_STRING(2, "DISCO_DREAM" /* GXTEntry: "Dreamcatchers" */), sParam0, joaat("HUD_TOASTS"), joaat("TOAST_DREAMCATCHER"), joaat("PLAYER_MENU"), MISC::VAR_STRING(2, "COL_CTX_PLAYER_LOG" /* GXTEntry: "Hold ~INPUT_FEED_INTERACT~ for details" */), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
int func_117(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_296(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_297(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
bool func_131()
{
	...
	if (!func_89(joaat("DOCUMENT_PLAYER_JOURNAL") /* GXTEntry: "Journal" */, 1, 0))
	{
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_311(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS" /* GXTEntry: "+" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_311(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT" /* GXTEntry: "+" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_311(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG" /* GXTEntry: "~COLOR_RED~-~s~" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_311(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT" /* GXTEntry: "~COLOR_RED~-~s~" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
void func_156(var uParam0)
{
	...
	vVar3 = { 0.0f, 0.0f, 0.0f /*3*/ };
	if (((*uParam0 == joaat("DISCOVER_LOC_ANCIENT_URN") || *uParam0 == joaat("DISCOVER_LOC_RAILROAD_GRAVESTONE")) || *uParam0 == 2135153015) || *uParam0 == joaat("DISCOVER_LOC_METEORITE"))
	{
		vVar6.x = (2.0f * 2.0f);
		vVar6.f_1 = (2.0f * 2.0f);
		vVar6.f_2 = 3.0f;
	...
	if (*uParam0 == joaat("DISCOVER_LOC_ABANDONED_TRADING_POST"))
	{
...
int func_160(var uParam0, int iParam1)
{
	switch (*uParam0)
	{
		...
		case joaat("DISCOVER_LOC_DEFACED_GRAVE"):
			return joaat("UI_DOC_SKATENEWSP") /* GXTEntry: "TALENTED ICESKATER\'S CAREER CUT SHORT IN TERRIBLE ACCIDENT" */;
		case joaat("DISCOVER_LOC_FRANKENSTEIN_BOOK"):
			switch (iParam1)
			{
				case 0:
...
{
	if (!PED::_HAS_META_PED_ASSET_LOADED(*iParam0))
	{
		return false;
	}
	return true;
...
void func_175(int iParam0)
{
	if (PED::_HAS_META_PED_ASSET_LOADED(*iParam0))
	{
		PED::_RELEASE_META_PED_ASSET_REQUEST(*iParam0);
	}
}
...
char* func_176(var uParam0)
{
	...
	{
		case -763376358:
			return "DISCO_MASK_AM" /* GXTEntry: "Pig Mask" */;
		case joaat("DISCOVER_LOC_PAGAN_RITUAL"):
			return "DISCO_MASK_PR" /* GXTEntry: "Pagan Mask" */;
		case joaat("DISCOVER_LOC_CAT_MASK"):
			return "DISCO_MASK_CAT" /* GXTEntry: "Cat Skull Mask" */;
		case joaat("DISCOVER_LOC_RAM_MASK"):
			return "DISCO_MASK_RAM" /* GXTEntry: "Ram Skull Mask" */;
		case joaat("DISCOVER_LOC_VIKING_GEAR"):
		case joaat("DISCOVER_LOC_FROZEN_SETTLER"):
			return "DISCO_HELMET" /* GXTEntry: "Helmet" */;
		default:
			break;
	}
	return "";
...
void func_181(int iParam0, bool bParam1)
{
	...
	switch (func_331(iParam0, joaat("TAG_INTERACTION_TYPE")))
	{
...
bool func_211(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_89(joaat("PROVISION_TRINKET_CROW_BEAK") /* GXTEntry: "Crow Beak Trinket" */, 1, 0) && iParam2 == joaat("ADD_REASON_LOOTED"))
	{
...
bool func_218()
{
	if (((((func_373(joaat("DOCUMENT_ARTHUR_MINOR_BOUNTY_1") /* GXTEntry: "Bounty Poster of Arthur" */, 400) || func_373(joaat("DOCUMENT_ARTHUR_MINOR_BOUNTY_2") /* GXTEntry: "Bounty Notice" */, 400)) || func_373(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_1") /* GXTEntry: "Bounty Hunter\'s Orders" */, 400)) || func_373(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_2") /* GXTEntry: "Poster of a Violent Criminal" */, 400)) || func_373(joaat("DOCUMENT_ARTHUR_HAS_POSTER_1") /* GXTEntry: "Bounty Hunter\'s Letter" */, 400)) || func_373(joaat("DOCUMENT_ARTHUR_HAS_POSTER_2") /* GXTEntry: "Bounty Page" */, 400))
	{
		return true;
	}
	return false;
...
void func_223(int iParam0)
{
	...
	switch (iParam0)
	{
		case joaat("DOCUMENT_TAXIDERMY_ORDER_1") /* GXTEntry: "Hunting Request" */:
			...
			func_189(437, 0);
			func_189(440, 0);
			func_383(joaat("TAXIDERMY_ORDER_01"), joaat("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT") /* GXTEntry: "Perfect Squirrel Carcass" */, &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_2") /* GXTEntry: "Hunting Request" */:
			...
			func_383(joaat("TAXIDERMY_ORDER_02"), joaat("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT") /* GXTEntry: "Perfect Cardinal Carcass" */, &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_3") /* GXTEntry: "Hunting Request" */:
			...
			func_383(joaat("TAXIDERMY_ORDER_03"), joaat("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT") /* GXTEntry: "Perfect Chipmunk Carcass" */, &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_4") /* GXTEntry: "Hunting Request" */:
			...
			func_383(joaat("TAXIDERMY_ORDER_04"), joaat("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT") /* GXTEntry: "Perfect Songbird Carcass" */, &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_5") /* GXTEntry: "Hunting Request" */:
			...
			func_189(438, 0);
			func_383(joaat("TAXIDERMY_ORDER_05"), joaat("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT") /* GXTEntry: "Perfect Cedar Waxwing Carcass" */, &cVar0, 1, 0, 0);
...
void func_225(int iParam0, int iParam1)
{
	...
	if (func_106() == -1)
	{
		...
		else if (func_199(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_01")))
		{
		...
		else if (func_199(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_02")))
		{
		...
		else if (func_199(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_03")))
		{
		...
		else if (func_199(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_04")))
		{
		...
		else if (func_199(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_05")))
		{
...
void func_228(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_106() == -1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam2))
		{
			...
			{
				func_219(0, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), iVar0);
				return;
			}
		}
	}
	switch (iParam0)
	{
		case joaat("MONEY_ONE_DOLLAR") /* GXTEntry: "$1.00" */:
			func_219(joaat("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_FIVE_DOLLARS") /* GXTEntry: "$5.00" */:
			func_219(joaat("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_TEN_DOLLARS") /* GXTEntry: "$10.00" */:
			func_219(joaat("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLFOLD") /* GXTEntry: "Bill Fold" */:
			func_219(joaat("REWARD_BILLFOLD"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLFOLD_SML") /* GXTEntry: "Small Bill Fold" */:
			func_219(joaat("REWARD_BILLFOLD_SML"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLSTACK") /* GXTEntry: "Bill Stack" */:
			func_219(joaat("REWARD_BILLSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COIN") /* GXTEntry: "Coin" */:
			func_219(joaat("REWARD_COIN"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINPURSE") /* GXTEntry: "Coin Purse" */:
			func_219(joaat("REWARD_COINPURSE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINSACK") /* GXTEntry: "Coin Sack" */:
			func_219(joaat("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINSTACK") /* GXTEntry: "Coin Stack" */:
			func_219(joaat("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYCLIP") /* GXTEntry: "Money Clip" */:
			func_219(joaat("REWARD_MONEYCLIP"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYSTACK") /* GXTEntry: "Money Stack" */:
			func_219(joaat("REWARD_MONEYSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYSTACK_LARGE") /* GXTEntry: "Money Pile" */:
			if (!func_394())
			{
				func_219(joaat("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			}
			break;
		case joaat("MONEY_COINCUP_SM") /* GXTEntry: "Change Cup" */:
			func_219(joaat("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINCUP_LG") /* GXTEntry: "Coin Cup" */:
			func_219(joaat("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
...
void func_258(int iParam0, char* sParam1)
{
	...
	func_311(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP" /* GXTEntry: "~1w~ ~2~" */, sParam1, sVar0), "inventory_items", func_431(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_259(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	strcpy_s(&cVar2, 32, func_434(iVar1 == 1, "ITEM_GET_PUMP" /* GXTEntry: "~1~" */, "ITEM_GET_PUMP_MULT" /* GXTEntry: "~2~x ~1~" */));
	if (iParam1 > 0)
	{
	}
	else
	...
	if (((((iParam1 == 1 || func_199(iParam0, joaat("CI_TAG_SMOKING_CIGARETTE"))) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
...
void func_271(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iParam0 += iVar2;
		iVar1 += iVar2;
		func_311(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN" /* GXTEntry: "Total Take ~1$~" */, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_TOTAL_TAKE"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		iParam0 -= iVar0;
		if (iVar0 > 0)
		{
			func_444(iVar0);
		...
		func_311(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN" /* GXTEntry: "Your Share ~1$~" */, iVar1), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_272(int iParam0)
{
	...
	{
		case joaat("DISCOVER_LOC_DREAMCATCHERS"):
			sVar0 = "DISCO_DREAM" /* GXTEntry: "Dreamcatchers" */;
			break;
		default:
			break;
	}
...
int func_273(int iParam0)
{
	...
	{
		case joaat("DISCOVER_LOC_DREAMCATCHERS"):
			return joaat("DISCO_DREAM") /* GXTEntry: "Dreamcatchers" */;
	}
	return 0;
}
...
int func_274(int iParam0)
{
	...
	{
		case joaat("DISCOVER_LOC_DREAMCATCHERS"):
			return joaat("DISCO_DRM_DESC") /* GXTEntry: "You have discovered Dreamcatchers in the wild. Find all the Dreamcatchers to reve" +
...
int func_275(int iParam0)
{
	...
	{
		case joaat("DISCOVER_LOC_DREAMCATCHERS"):
			return joaat("DISCO_DC_FOUND") /* GXTEntry: "~1~ of ~2~ Found" */;
	}
	return 0;
}
...
int func_276(int iParam0)
{
	...
	{
		case joaat("DISCOVER_LOC_DREAMCATCHERS"):
			return joaat("DISCO_DRM_OBJ") /* GXTEntry: "~1~ of ~2~ Dreamcatchers found" */;
	}
	return 0;
}
...
char* func_279(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case joaat("DISCOVER_LOC_DREAMCATCHERS"):
			...
			{
				case 0:
					return "DISCO_DRM_CHECK1" /* GXTEntry: "Find all 20 Dreamcatchers" */;
				case 1:
					return "DISCO_DRM_CHECK2" /* GXTEntry: "Learn the ancient secret within the Dreamcatchers" */;
				default:
					break;
			}
			break;
...
bool func_292(bool bParam0)
{
	if (PED::IS_PED_CARRYING_SOMETHING(Global_35) && !Global_1392040.f_2)
	{
		if (bParam0)
		{
			func_452("ITEM_UNUSABLE_CARRYING" /* GXTEntry: "Cannot use this item while carrying something." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	return true;
...
bool func_320(var uParam0, int iParam1, Vector3 vParam2, Vector3 vParam5, int iParam8, bool bParam9, bool bParam10)
{
	...
	{
		(*uParam0)[iParam8] = PED::_CREATE_META_PED_ASSET(iParam1, vParam2, vParam5, true, bParam9, bParam10);
...
struct<5> /*40*/ func_326(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_198(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_358(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_473(iParam0, 1))
			{
				...
				if (!func_356(iParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_356(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_357(iParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_358(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
...
bool func_330(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_322(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_357(iParam0, &sVar4, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
			{
				return false;
			}
			if (func_473(iParam0, 1))
			{
				if (!func_356(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					return false;
				}
				else if (func_357(iParam0, &sVar4, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */))
				{
					return false;
				}
			}
...
char* func_341(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6)
{
	switch (iParam1)
	{
		case joaat("CIGARETTE_CARDS"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_CC_CARD_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Card Sets Posted" */, func_494(), 12);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_CC_CARD_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Card Sets Found" */, func_495(), 12);
			}
			break;
		case joaat("DINO_BONES"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_DB_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Dinosaur Bones Posted" */, func_496(), 30);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_DB_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Dinosaur Bones Found" */, func_381(), 30);
			}
			break;
		...
		case joaat("LEGENDARY_FISH"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_LF_CAUGHT_OBJ" /* GXTEntry: "~1~ of ~2~ Legendary Fish Caught and Posted" */, func_497(), 13);
			}
			break;
		case joaat("ROCK_CARVINGS"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_RC_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Rock Faces Posted" */, func_498(), 10);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_RC_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Rock Faces Found" */, func_382(), 10);
			}
			break;
		case joaat("TAXIDERMY"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_TX_CARCASS_COLLECTED_OBJ" /* GXTEntry: "~1~ of ~2~ Carcasses Collected" */, sParam4, func_340(iParam6, 20));
			}
			break;
	}
	return sParam3;
...
bool func_345(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		...
		{
			if (func_506(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, joaat("LEGENDARY_FISH"), 0)))
			{
				bVar1 = true;
			}
			else if (iParam5 == 8)
...
void func_353(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_349("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_MANUAL_PAINT" /* GXTEntry: "Manual Painting" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_349("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_STAY_ACTIVE" /* GXTEntry: "Continued Free Fire" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_349("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_FATAL" /* GXTEntry: "Fatal Region Highlights" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_349("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_CRITICAL" /* GXTEntry: "Critical Region Highlights" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
...
int func_374(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1.0f;
	if (bParam1 && func_89(joaat("PROVISION_TRINKET_ELK_ANTLER") /* GXTEntry: "Elk Antler Trinket" */, 1, 0))
	{
		fVar0 += 0.1f;
	}
	sVar1.f_1 = 10;
...
int func_385()
{
	...
	while (iVar1 < 5)
	{
		if (func_538(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, joaat("EXOTIC_ITEMS"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_421(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_452(MISC::VAR_STRING(10, "OUT_JOURN_DONE" /* GXTEntry: "~1~ completed." */, MISC::VAR_STRING(0, iVar0)), 10000, 0, 0, 0, 1);
	}
	func_579(iParam0, 6);
	if (bParam2)
	{
...
void func_442(int iParam0, int iParam1)
{
	...
	if (func_106() == -1)
	{
		if (func_188(43))
		{
			if (func_199(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_01")))
			{
				func_384(joaat("EXOTIC_STAGE_01"));
				if (func_385() == 0)
				{
		...
		if (func_188(44))
		{
			if (func_199(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_02")))
			{
				func_384(joaat("EXOTIC_STAGE_02"));
				if (func_385() == 1)
				{
		...
		if (!func_188(45))
		{
			if (func_199(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_03")))
			{
				func_384(joaat("EXOTIC_STAGE_03"));
				if (func_385() == 2)
				{
		...
		if (!func_188(46))
		{
			if (func_199(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_04")))
			{
				func_384(joaat("EXOTIC_STAGE_04"));
				if (func_385() == 3)
				{
		...
		if (!func_188(47))
		{
			if (func_199(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_05")))
			{
				func_384(joaat("EXOTIC_STAGE_05"));
				if (func_385() == 4)
				{
...
{
	if (func_594(iParam0, joaat("DEFAULT") /* GXTEntry: "_" */) == 0)
	{
		return false;
	}
	return true;
...
int func_497()
{
	...
	while (iVar1 < 14)
	{
		if (func_506(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, joaat("LEGENDARY_FISH"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_522()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_76(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN") /* GXTEntry: "John\'s Cattleman Revolver" */);
		func_252(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN") /* GXTEntry: "John\'s Cattleman Revolver" */, 1, joaat("ADD_REASON_DEFAULT"));
		...
		func_76(joaat("WEAPON_MELEE_KNIFE_JOHN") /* GXTEntry: "John\'s Knife" */);
		func_252(joaat("WEAPON_MELEE_KNIFE_JOHN") /* GXTEntry: "John\'s Knife" */, 1, joaat("ADD_REASON_DEFAULT"));
...
int func_549(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	bVar0 = func_626(0);
	if (iParam2 != 0 && func_627(iParam0, bVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
void func_574(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_573(iParam0))
	{
		...
		if ((!func_577() && !bParam1) && !func_578(0, 0, 1))
		{
			func_452(MISC::VAR_STRING(10, "OUT_JOURN_ADD" /* GXTEntry: "~1~ discovered." */, func_641(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
void func_602(int iParam0, int iParam1, int iParam2)
{
	...
	func_280(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC" /* GXTEntry: "Hold ~INPUT_FEED_INTERACT~ for details" */, func_665(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_610()
{
	...
	func_669(0);
	func_670(7);
	func_671(joaat("KIT_BANDANA") /* GXTEntry: "Bandana" */, 1, 1, 0);
	if (func_422() == joaat("MPC_PLAYER_TYPE_SP_MARSTON"))
	{
		func_671(joaat("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000") /* GXTEntry: "John\'s Classic Hat" */, 1, 1, 1);
		func_671(joaat("CLOTHING_SP_MAR_OUTFIT_GUNSLINGER") /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_434(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD" /* GXTEntry: "Cold" */, "PMPLAYER_CONDITION_TEMPERATURE_HOT" /* GXTEntry: "Hot" */);
					}
					break;
				case 2:
					return func_434(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD" /* GXTEntry: "Good" */, "PMPLAYER_CONDITION_HONOR_BAD" /* GXTEntry: "Bad" */);
			}
			break;
		case 1:
		case 2:
...
bool func_694(int iParam0)
{
	...
	if (func_199(iParam0, joaat("CI_TAG_ITEM_EQUIPMENT_HOLSTER")))
	{
		return true;
	}
	return false;
...
bool func_695(int iParam0)
{
	...
	if (func_199(iParam0, joaat("CI_TAG_ITEM_EQUIPMENT_OFFHAND")))
	{
		return true;
	}
	return false;
...
void func_745(var uParam0, var uParam1, int iParam2)
{
	...
	uParam0->f_1 = PED::_REQUEST_META_PED_COMPONENT(iVar0, uParam1, 0, func_106() != -1, iParam2);
	*uParam0 = 1;
}
