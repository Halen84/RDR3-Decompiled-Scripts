...
int func_86(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_37[iParam0]))
	{
		if (ENTITY::DOES_ENTITY_HAVE_PHYSICS(iLocal_43[iParam0]))
		{
			...
			PHYSICS::_CREATE_ROPE_WINDING_ABILITY(iLocal_31[iParam0], 0, 0, fLocal_93[iParam0], true);
			AUDIO::_0xF092B6030D6FD49C(iLocal_31[iParam0], "ROPE_SETTINGS_DEFAULT");
			PHYSICS::_ROPE_CHANGE_VISIBILITY(&(iLocal_31[iParam0]), true);
...
char* func_112(char* sParam0, int iParam1)
{
	...
	return func_155(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}
