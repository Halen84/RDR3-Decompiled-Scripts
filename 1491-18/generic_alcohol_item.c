	...
	while (!SCRIPTS::IS_THREAD_EXIT_REQUESTED())
	{
		if (!sScriptParam_0.f_3)
		{
			if (!sVar0.f_180)
			{
				...
				func_6(&sVar0);
				if (iVar184 == joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-55_H18_NECK_A8_B1-8_TABLE_HOLD") || iVar184 == joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-55_H18_NECK_A8_B1-8_TABLE_CHUG_A"))
				{
					func_7(&sVar0);
				}
				else if (iVar184 == joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-3_H30-5_NECK_A13_B2-5_TABLE_HOLD") || iVar184 == joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-3_H30-5_NECK_A13_B2-5_TABLE_CHUG_A"))
				{
					func_8(&sVar0);
				}
		...
		switch (sVar0.f_0)
		{
			...
			case 2:
				if (!sVar0.f_180)
				{
					if (iVar184 == joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-55_H18_NECK_A8_B1-8_HOLD") || iVar184 == joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-3_H30-5_NECK_A13_B2-5_HOLD"))
					{
						TASK::_0xB35370D5353995CB(Global_35, func_17(sVar0.f_2, iVar184), 0.25f);
						func_12(&sVar0, 4);
					}
					else if (iVar184 == joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-55_H18_NECK_A8_B1-8_TABLE_HOLD"))
					{
					...
					else if (iVar184 != joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-3_H30-5_NECK_A13_B2-5_TABLE_HOLD"))
					{
					}
					else
					{
...
float func_4(var uParam0, var uParam1)
{
	...
	switch (uParam0->f_2)
	{
		case joaat("CONSUMABLE_RUM_USED") /* GXTEntry: "Opened Guarma Rum" */:
			fVar0 = 0.1f;
			break;
		case joaat("CONSUMABLE_BRANDY_USED") /* GXTEntry: "Opened Fine Brandy" */:
			fVar0 = 0.1f;
			break;
		case joaat("CONSUMABLE_GIN_USED") /* GXTEntry: "Opened Gin" */:
			fVar0 = 0.1f;
			break;
		case joaat("CONSUMABLE_RUM") /* GXTEntry: "Guarma Rum" */:
			fVar0 = 0.17f;
			break;
		case joaat("CONSUMABLE_SALOON_BEER") /* GXTEntry: "Beer" */:
			fVar0 = 0.025f;
			uParam0->f_180 = 0;
			break;
		case joaat("CONSUMABLE_SALOON_WHISKEY"):
			...
			uParam0->f_180 = 0;
			break;
		case joaat("CONSUMABLE_BRANDY") /* GXTEntry: "Fine Brandy" */:
			fVar0 = 0.17f;
			break;
		case joaat("CONSUMABLE_GIN") /* GXTEntry: "Gin" */:
			fVar0 = 0.17f;
			break;
		...
		default:
			if (ENTITY::DOES_ENTITY_EXIST(*uParam1))
			{
				...
				{
					uParam0->f_2 = joaat("CONSUMABLE_SALOON_BEER"); /* GXTEntry: "Beer" */
					fVar0 = 0.025f;
					uParam0->f_180 = 0;
				}
	...
	if (func_22(joaat("PROVISION_TRINKET_WOLF_HEART") /* GXTEntry: "Wolf Heart Trinket" */, 1, 0))
	{
		fVar0 *= 0.5f;
	}
	return fVar0;
...
void func_5()
{
	if (TASK::GET_ITEM_INTERACTION_STATE(Global_35) == joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-55_H18_NECK_A8_B1-8_UNCORK"))
	{
...
{
	if (iParam0 == joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-55_H18_NECK_A8_B1-8_HOLD"))
	{
		...
		{
			TASK::_0xB35370D5353995CB(Global_35, joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-55_H18_NECK_A8_B1-8_TABLE_HOLD"), 1.0f);
		}
	}
	else if (iParam0 == joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-55_H18_NECK_A8_B1-8_TABLE_HOLD"))
	{
		if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1) || TASK::IS_PED_EXITING_SCENARIO(Global_35, false))
		{
			TASK::_0xB35370D5353995CB(Global_35, joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-55_H18_NECK_A8_B1-8_HOLD"), 1.0f);
		}
	}
	else if (iParam0 == joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-3_H30-5_NECK_A13_B2-5_HOLD"))
	{
		...
		{
			TASK::_0xB35370D5353995CB(Global_35, joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-3_H30-5_NECK_A13_B2-5_TABLE_HOLD"), 1.0f);
		}
	}
	else if (iParam0 == joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-3_H30-5_NECK_A13_B2-5_TABLE_HOLD"))
	{
		if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1) || TASK::IS_PED_EXITING_SCENARIO(Global_35, false))
		{
			TASK::_0xB35370D5353995CB(Global_35, joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-3_H30-5_NECK_A13_B2-5_HOLD"), 1.0f);
		}
	}
}
...
void func_16(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		case joaat("CONSUMABLE_GINSENG_ELIXIER") /* GXTEntry: "Ginseng Elixir" */:
			if (func_40(0) >= 7)
			{
				func_42(244, func_41(joaat("CONSUMABLE_GINSENG_ELIXIER") /* GXTEntry: "Ginseng Elixir" */), 1);
			}
			func_43(19);
			break;
		case joaat("CONSUMABLE_VALERIAN_ROOT") /* GXTEntry: "Valerian Root" */:
			if (func_40(2) >= 7)
			{
				func_42(243, func_41(joaat("CONSUMABLE_VALERIAN_ROOT") /* GXTEntry: "Valerian Root" */), 1);
			}
			func_43(50);
			break;
		case joaat("CONSUMABLE_AGED_PIRATE_RUM") /* GXTEntry: "Aged Pirate Rum" */:
			if (func_40(1) >= 7)
			{
				func_42(245, func_41(joaat("CONSUMABLE_AGED_PIRATE_RUM") /* GXTEntry: "Aged Pirate Rum" */), 1);
			}
			func_43(30);
			break;
		...
		case joaat("CONSUMABLE_HERB_PRAIRIE_POPPY") /* GXTEntry: "Prairie Poppy" */:
			...
			break;
		case joaat("CONSUMABLE_POTENT_ANTIDOTE") /* GXTEntry: "Potent Antidote" */:
		case joaat("CONSUMABLE_ANTIDOTE") /* GXTEntry: "Antidote" */:
...
{
	switch (func_49(iParam0, joaat("TAG_INTERACTION_TYPE")))
	{
		case joaat("CI_TAG_DRINKING_BEER"):
			if (iParam1 == joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-55_H18_NECK_A8_B1-8_TABLE_HOLD"))
			{
				return 1534923913;
			}
			else
			{
				return joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-55_H18_NECK_A8_B1-8_DISCARD");
			}
			break;
		case -2001232688:
			return joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-3_H30-5_NECK_A13_B2-5_DISCARD");
	}
	return joaat("DRINK_BOTTLE@BOTTLE_CYLINDER_D1-55_H18_NECK_A8_B1-8_DISCARD");
}
...
void func_39(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam0)
	{
		...
		case joaat("CONSUMABLE_HAYCUBE") /* GXTEntry: "Hay" */:
			func_81(func_84(joaat("USED"), joaat("FEED_BAG") /* GXTEntry: "Feed Bag" */), 1);
			break;
	}
	switch (iParam0)
	{
		...
		case joaat("CONSUMABLE_WHISKEY_USED") /* GXTEntry: "Opened Kentucky Bourbon" */:
		case joaat("CONSUMABLE_WHISKEY") /* GXTEntry: "Kentucky Bourbon" */:
			func_81(func_84(joaat("USED"), joaat("WHISKEY") /* GXTEntry: "Whiskey" */), 1);
			break;
...
void func_165(int iParam0, int iParam1, int iParam2)
{
	...
	func_204(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC" /* GXTEntry: "Hold ~INPUT_FEED_INTERACT~ for details" */, func_203(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_143(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD" /* GXTEntry: "Cold" */, "PMPLAYER_CONDITION_TEMPERATURE_HOT" /* GXTEntry: "Hot" */);
					}
					break;
				case 2:
					return func_143(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD" /* GXTEntry: "Good" */, "PMPLAYER_CONDITION_HONOR_BAD" /* GXTEntry: "Bad" */);
			}
			break;
		case 1:
		case 2:
