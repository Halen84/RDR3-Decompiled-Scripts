...
bool func_72(var uParam0)
{
	...
	{
		func_154(uParam0, 8.88f, 3.18f, 1.2f, 7.068f, 1.5f, 1.5f, 2.0f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
		func_154(uParam0, 0.6f, -0.8f, 1.0f, 2.0f, 1.75f, 2.5f, 2.0f, joaat("VOLBOX"), 2076113919, 1, 1, 1);
		func_155(uParam0, 0.625f, -0.0377f, 1.15f, 38.56f, 1.0f, 1.0f, 2.685f, joaat("VOLCYLINDER"), 1);
	}
	iLocal_17 = func_156(uParam0, joaat("P_CIGARLIT01X"), 0.0f, 0.0f, 0.0f, "CIGAR", 0, 0, 1);
	func_156(uParam0, joaat("P_CHAIRFOLDING02X"), 1.20486f, -1.61288f, 0.00105286f, "CHAIR" /* GXTEntry: "Chair" */, 1, 0, 1);
	iLocal_16 = func_156(uParam0, joaat("P_STOOLFOLDING01X"), 0.0f, 0.0f, 0.0f, 0, 1, 0, 1);
	if (!func_151(14))
	{
	...
	sLocal_25 = { func_166(uParam0, 1.0669f, -0.7771f, 0.5984f, 100.44f, 8.0f, 0.5f, 0.5f) /*10*/ };
	sLocal_35 = { func_166(uParam0, 1.067f, -0.777f, 0.598f, 172.44f, 8.0f, 0.3f, 0.3f) /*10*/ };
	sLocal_45 = { func_166(uParam0, 1.067f, -0.777f, 0.598f, 10.44f, 8.0f, 0.5f, 0.5f) /*10*/ };
	if (func_151(14))
	{
...
bool func_93(var uParam0)
{
	...
	{
		if (func_210(uParam0, sLocal_45, 1, 0))
		{
	...
	{
		if (func_210(uParam0, sLocal_25, 1, 0))
		{
			func_201(uParam0, iLocal_21, 1);
		}
		else if (func_210(uParam0, sLocal_45, 1, 0))
		{
			func_201(uParam0, iLocal_22, 1);
		}
		else if (func_210(uParam0, sLocal_35, 1, 0))
		{
...
{
	func_162(uParam0, iParam1, 0, 0, 0, -1, 0, 0.0f, 1065353216 /* Float: 1f */, 1);
}
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_267(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
...
void func_399(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_433(func_104(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_434(iParam0);
