...
void __SCRIPT()
{
	...
	fLocal_7 = 1.0f;
	fLocal_8 = 1.0f;
	iLocal_51 = func_1(joaat("HORSE_CLASS_RIDING") /* GXTEntry: "Riding" */, 1);
	sVar0.f_1 = -1;
	sVar0.f_3.f_9 = 3;
	sVar0.f_20 = 25;
...
void func_15(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	iVar1 = func_1(joaat("HORSE_CLASS_RACE") /* GXTEntry: "Race" */, 1);
	if (*uParam0 == 62)
	{
		...
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				if (*uParam0 != 56)
				{
					...
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 462 /*PCF_0xC3BB03BA*/, true);
				}
				...
				PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 255 /*PCF_0xBD08A8FC*/, true);
				...
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[0 /*14*/], joaat("WEAPON_REVOLVER_CATTLEMAN") /* GXTEntry: "Cattleman Revolver" */, 500, false, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
				if (*uParam0 == 42)
				{
				...
				PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 279 /*PCF_NeverLeavesGroup*/, true);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				if (*uParam0 != 56)
				{
					...
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[1 /*14*/], joaat("WEAPON_REVOLVER_CATTLEMAN") /* GXTEntry: "Cattleman Revolver" */, 500, false, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
					PED::SET_PED_AS_GROUP_MEMBER(uParam0->f_20[1 /*14*/], iLocal_56);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 462 /*PCF_0xC3BB03BA*/, true);
				}
				if (*uParam0 == 42)
				{
				...
				if (*uParam0 == 62)
				{
					TASK::TASK_MOVE_BE_IN_FORMATION(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 2.5f, 0.0f, 0.0f, -1082130432 /* Float: -1f */, 0);
				}
				else if (*uParam0 == 63)
				{
				...
				{
					TASK::TASK_MOVE_BE_IN_FORMATION(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 2.0f, 0.0f, 0.0f, -1082130432 /* Float: -1f */, 1);
				}
				func_76(&(uParam0->f_20[1 /*14*/]), 0, 1);
				PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 279 /*PCF_NeverLeavesGroup*/, true);
	...
	if (func_116(&uLocal_44, 2.5f))
	{
		switch (iLocal_54)
		{
			...
			case 1:
				if (*uParam0 != 42)
				{
					func_132(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], "HOWS_IT_GOING", 0, -1082130432 /* Float: -1f */, 1, 0, 0, 1, 1, 1, joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), 1, 0, 0);
				}
				else
				{
					func_132(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], "CHAT_RESPONSE_A", 0, -1082130432 /* Float: -1f */, 0, 0, 0, 1, 1, 1, joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), 1, 0, 0);
				}
			...
			case 2:
				if (*uParam0 != 42)
				{
					func_132(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], "GOING_WELL", 0, -1082130432 /* Float: -1f */, 1, 0, 0, 1, 1, 1, joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), 1, 0, 0);
				}
				else
				{
					func_132(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], "RESPONSE_A", 0, -1082130432 /* Float: -1f */, 0, 0, 0, 1, 1, 1, joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), 1, 0, 0);
				}
			...
			case 3:
				if (*uParam0 == 42)
				{
					func_132(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], "CONVO_TAIL_OFF", 0, -1082130432 /* Float: -1f */, 0, 0, 0, 1, 1, 1, joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), 1, 0, 0);
					iLocal_55 = uParam0->f_20[1 /*14*/];
				}
				else
				{
					func_132(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], "GLAD_TO_HEAR_THAT", 0, -1082130432 /* Float: -1f */, 1, 0, 0, 1, 1, 1, joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), 1, 0, 0);
					iLocal_55 = uParam0->f_20[0 /*14*/];
				}
				iLocal_54++;
				func_78(&uLocal_44);
		...
		switch (iLocal_54)
		{
			case 4:
				if (!AUDIO::IS_ANY_SPEECH_PLAYING(Global_35))
				{
					...
					{
						func_132(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], "CHAT_GOOD_WEATHER", 0, -1082130432 /* Float: -1f */, 0, 0, 0, 1, 1, 1, joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), 1, 0, 0);
					}
					else
					{
						func_132(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], "CHAT_BAD_WEATHER", 0, -1082130432 /* Float: -1f */, 0, 0, 0, 1, 1, 1, joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), 1, 0, 0);
					}
					iLocal_55 = uParam0->f_20[1 /*14*/];
					iLocal_54++;
					func_78(&uLocal_44);
			...
			case 5:
				if (!func_135(func_134()))
				{
					func_132(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], "RESPONSE_GOOD_WEATHER", 0, -1082130432 /* Float: -1f */, 0, 0, 0, 1, 1, 1, joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), 1, 0, 0);
				}
				else
				{
					func_132(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], "RESPONSE_BAD_WEATHER", 0, -1082130432 /* Float: -1f */, 0, 0, 0, 1, 1, 1, joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), 1, 0, 0);
				}
				iLocal_55 = uParam0->f_20[0 /*14*/];
				iLocal_54++;
				func_78(&uLocal_44);
