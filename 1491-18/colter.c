...
bool func_11()
{
	iLocal_0 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-1336.415f, 2442.417f, 307.4014f, 0.0f, 3.96856f, 32.68665f, 68.62094f, 45.669f, 16.22106f, "Colter - volTown");
	return true;
}
