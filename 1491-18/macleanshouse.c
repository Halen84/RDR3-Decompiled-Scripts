...
bool func_11()
{
	iLocal_14 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2257.921f, -129.5337f, 51.985f, 0.0f, -1E-06f, 13.20028f, 82.29547f, 67.60979f, 21.17161f, "MacLean's Ranch - m_volTown");
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		iLocal_17 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("MacLean's Ranch - m_volRancherThreat Agg");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2241.916f, -109.335f, 47.39677f, 0.0f, 0.0f, 81.00094f, 15.27625f, 30.5406f, 14.65559f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2242.125f, -118.91f, 49.79729f, 0.0f, 0.0f, -9.792401f, 22.84632f, 3.968585f, 11.03726f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2229.892f, -115.0595f, 50.13812f, 0.0f, 0.0f, -43.69167f, 7.061154f, 5.28716f, 10.09026f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2253.012f, -119.7667f, 49.20896f, 0.0f, 0.0f, -55.08507f, 2.867169f, 4.725968f, 9.455753f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2244.684f, -99.80244f, 49.79729f, 0.0f, 0.0f, -6.792556f, 27.39669f, 5.430289f, 11.03726f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2230.888f, -99.64697f, 49.20896f, 0.0f, 0.0f, -141.6504f, 5.207262f, 4.725968f, 9.455753f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2236.452f, -142.7769f, 50.13812f, 0.0f, 0.0f, -49.1528f, 7.766057f, 7.596688f, 10.09026f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2236.481f, -142.6387f, 47.39677f, 0.0f, 0.0f, 39.75399f, 7.495997f, 7.665227f, 14.65559f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2282.604f, -118.0235f, 45.6339f, 0.0f, 0.0f, -24.74522f, 3.359454f, 14.73906f, 12.52731f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2274.63f, -102.5251f, 46.93924f, 0.0f, 0.0f, -12.90716f, 17.48779f, 5.873432f, 15.33682f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2273.252f, -116.878f, 46.93924f, 0.0f, 0.0f, -9.949313f, 19.00171f, 22.66021f, 15.33682f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2283.666f, -109.4251f, 44.44471f, 0.0f, 0.0f, 0.0f, 3.780884f, 6.839418f, 7.568232f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2275.129f, -99.41361f, 44.81648f, 0.0f, 0.0f, -12.62545f, 8.420317f, 1.0f, 9.244777f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 2269.443f, -125.7176f, 44.44471f, 0.0f, 0.0f, 73.07793f, 3.302727f, 7.064869f, 7.568232f);
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 2255.429f, -122.8375f, 51.985f, -1E-06f, 0.0f, 78.69922f, 38.29042f, 36.90052f, 21.17161f);
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, 2254.417f, -126.5447f, 51.985f, -1E-06f, 0.0f, 78.69922f, 51.7244f, 47.73219f, 21.17161f);
...
void func_28(int iParam0)
{
	...
	VOLUME::_0x53D05D60E5F5B40C(iLocal_16, 3, 1, func_51(906));
	VOLUME::_0x53D05D60E5F5B40C(iLocal_16, 3, 1, func_51(772));
...
void func_63(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_54(iParam0) && func_80(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_104(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_104(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_104(&cVar6, joaat("COLOR_PURE_WHITE")), func_104(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
char* func_104(char* sParam0, int iParam1)
{
	...
	return func_138(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_105(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_109(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_120(int iParam0)
{
	...
	func_146(iParam0, (1 << 13));
	func_146(iParam0, (1 << 14));
	func_146(iParam0, (1 << 15));
	func_146(iParam0, (1 << 17));
	func_146(iParam0, (1 << 24));
	func_146(iParam0, (1 << 19));
	func_146(iParam0, (1 << 20));
...
bool func_132(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_160(iVar0) && func_161(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_149(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_171(iParam0, (1 << 10)))
		{
			func_172(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_171(iParam0, (1 << 10)))
	{
		func_173(iParam0, (1 << 10));
		INVENTORY::_0x9B4E793B1CB6550A();
	}
	func_174(iParam0);
}
...
bool func_163(Vector3 vParam0, int iParam3)
{
	...
	func_179(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_180(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
