...
int func_18(var uParam0)
{
	...
	{
		iLocal_11 = VEHICLE::_CREATE_MISSION_TRAIN(joaat("HANDCART_CONFIG"), VEHICLE::_GET_NEAREST_TRAIN_TRACK_POSITION(uParam0->f_483), true, false, true, true);
	}
	if (!VEHICLE::_HAS_TRAIN_LOADED(iLocal_11))
	{
		return 0;
	}
	return 1;
	...
	switch (iLocal_9)
	{
		case 0:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_11))
			{
				...
				VEHICLE::SET_TRAIN_SPEED(iLocal_11, 0.0f);
				VEHICLE::SET_TRAIN_CRUISE_SPEED(iLocal_11, 0.0f);
			}
			iLocal_9 = 1;
			break;
		case 1:
...
int func_32(var uParam0, var uParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_11))
	{
		VEHICLE::SET_MISSION_TRAIN_AS_NO_LONGER_NEEDED(&iLocal_11, 0);
	}
	return 1;
}
...
bool func_47(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_73(iVar0) && func_74(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
bool func_60(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, Vector3 vParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
bool func_62(Vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_88(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1.0f, 0))
			{
				return true;
			}
		}
