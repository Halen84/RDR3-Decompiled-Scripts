...
bool func_73(var uParam0)
{
	...
	func_151(uParam0, 0.0f, 0.0f, 0.625f, 0.0f, 2.0f, 2.0f, 2.0f, joaat("VOLCYLINDER"), 1);
	func_152(uParam0, -1.5f, -0.075f, 0.85f, 0.0f, 1.2025f, 1.8925f, 2.0875f, joaat("VOLBOX"), -1, 1, 1, 1);
	...
	iLocal_18 = func_157(uParam0, 1.3375f, -0.4125f, 0.85f, 0.0f, 0.0f, 0.0f, 2.2825f, 2.6175f, 2.0875f, "Pearson Volume", joaat("VOLBOX"));
	return true;
}
...
void func_387(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_421(func_105(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_422(iParam0);
