...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_50(uParam0, "WAGON" /* GXTEntry: "Wagon" */, iLocal_38, vParam1, vParam4.z, 0, 0, 1, 0);
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[0 /*14*/], joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */, 500, true, false, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), true, 0.0f, false);
