...
bool func_72(var uParam0)
{
	...
	func_155(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_PASSED_OUT_TABLE"), "PROP_HUMAN_PASSED_OUT_TABLE_MALE_C", -1, 0, MISC::GET_RANDOM_FLOAT_IN_RANGE(70.0f, 120.0f), 1065353216 /* Float: 1f */, 1);
...
{
	WEAPON::SET_CURRENT_PED_WEAPON(func_48(uParam0, iLocal_14), joaat("WEAPON_UNARMED") /* GXTEntry: "Unarmed" */, true, 0, false, false);
	WEAPON::SET_CURRENT_PED_WEAPON(func_48(uParam0, iLocal_15), joaat("WEAPON_UNARMED") /* GXTEntry: "Unarmed" */, true, 0, false, false);
	if (func_148(uParam0) == 3)
	{
