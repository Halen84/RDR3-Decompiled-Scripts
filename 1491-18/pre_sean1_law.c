...
bool func_6()
{
	...
	while (iVar0 < 4)
	{
		...
		else if (!ENTITY::DOES_ENTITY_EXIST(iLocal_0[iVar0]) && bVar5)
		{
			...
			WEAPON::GIVE_WEAPON_TO_PED(iLocal_0[iVar0], func_20((1 << 22), 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */), 500, true, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
...
bool func_20(int iParam0, float fParam1, float fParam2)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	{
		if (!func_32(bVar5) || WEAPON::_0xF2F585411E748B9C(bVar1, 0) > WEAPON::_0xF2F585411E748B9C(bVar5, 0))
		{
			bVar5 = bVar1;
		}
	}
	...
	{
		if (!func_32(bVar5) || WEAPON::_0xF2F585411E748B9C(bVar3, 0) > WEAPON::_0xF2F585411E748B9C(bVar5, 0))
		{
			bVar5 = bVar3;
		}
	}
	...
	{
		if (!func_32(bVar5) || WEAPON::_0xF2F585411E748B9C(bVar2, 0) > WEAPON::_0xF2F585411E748B9C(bVar5, 0))
		{
			bVar5 = bVar2;
		}
	}
...
int func_63(int iParam0, var uParam1)
{
	...
	{
		return func_114(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
