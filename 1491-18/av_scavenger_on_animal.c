...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_47(uParam0, 1, "SOAP_BIRD_1", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.25f, -1.0f, 0.0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 0, "SOAP_ANIMAL_1", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.0f, 0.0f, 0.0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_11)
	{
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[1 /*14*/], iLocal_12, 0, false, 0, -1.0f, false);
...
int func_48(var uParam0, Vector3 vParam1)
{
	...
	{
		if (func_85(iVar0, vParam1, 1) <= 1.0f)
		{
