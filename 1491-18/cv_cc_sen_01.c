...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.0616f, -0.3636f, 0.5329f, -19.8f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	func_151(uParam0, 0.4272f, 1.0817f, 0.5567f, -23.76f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_LENNY"), 1, 1, 1);
	func_152(uParam0, joaat("P_BOTTLEJD01X"), 0.0f, 0.0f, 0.0f, "BOTTLE_0", 0, 1, 1);
	func_152(uParam0, joaat("P_BOTTLEJD01X"), 0.0f, 0.0f, 0.0f, "BOTTLE_1", 0, 1, 1);
	iLocal_21 = func_152(uParam0, joaat("P_CHAIR_CRATE02X"), 1.42059f, -0.462698f, 0.000679016f, 0, 1, 0, 1);
	func_153(uParam0, iLocal_15, joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */, "RIFLE");
	...
	func_156(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	sLocal_22 = { func_157(uParam0, 0.4272f, 1.0817f, 0.5567f, 156.96f, 7.0f, 0.5f, 0.5f) /*10*/ };
	sLocal_32 = { func_157(uParam0, 0.427f, 1.082f, 0.557f, -113.04f, 7.0f, 0.5f, 0.5f) /*10*/ };
	sLocal_42 = { func_157(uParam0, 0.427f, 1.082f, 0.557f, 66.96f, 7.0f, 0.5f, 0.5f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_196(uParam0, sLocal_22, 1, 0))
		{
			func_187(uParam0, iLocal_17, 1);
		}
		else if (func_196(uParam0, sLocal_32, 1, 0))
		{
			func_187(uParam0, iLocal_18, 1);
		}
		else if (func_196(uParam0, sLocal_42, 1, 0))
		{
...
int func_151(var uParam0, Vector3 vParam1, float fParam4, Vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_249(uParam0, vParam1) /*3*/ };
...
struct<10> /*80*/ func_157(var uParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	...
	fVar0 = func_250(uParam0, (fParam4 + (fParam6 * 90.0f)));
	fVar1 = func_250(uParam0, (fParam4 - (fParam7 * 90.0f)));
	sVar2 = { func_249(uParam0, vParam1) /*3*/ };
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0 /*15*/].f_5 && !ENTITY::DOES_ENTITY_EXIST(uParam0->f_1711[iVar0 /*15*/].f_10))
			{
				...
				{
					vVar3 = { func_249(uParam0, uParam0->f_1711[iVar0 /*15*/].f_1) /*3*/ };
				}
				else
				{
...
void func_182(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_249(uParam0, uParam0->f_1976.f_1), 1, func_250(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
bool func_195(var uParam0, int iParam1)
{
	...
	if (func_296(uParam0, iParam1, 1.0f))
	{
		return true;
	}
...
bool func_196(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
void func_202(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_296(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
bool func_263(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1 /*15*/].f_5)
		{
			...
			{
				vVar2 = { func_249(uParam0, uParam0->f_1711[iVar1 /*15*/].f_1) /*3*/ };
			}
			else
			{
...
void func_271(var uParam0, int iParam1)
{
	...
	else if (!func_330(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
	{
...
bool func_300(var uParam0, int iParam1)
{
	...
	{
		if (!func_330(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_ANY")))
		{
			return true;
		}
	}
