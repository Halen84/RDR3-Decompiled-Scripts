		...
		if (MISC::GET_GAME_TIMER() > iLocal_217)
		{
			...
			switch (iLocal_216)
			{
				...
				case 1:
					...
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_218));
				...
				case 6:
					if (func_7(func_6(iLocal_218)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_218 /*35*/].f_11 > 0.0f)
							{
								PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1888801[iLocal_218 /*35*/].f_11);
							}
							Jump @785; // curOff = 766
							func_42(iVar0);
							iVar0 = (1 + iVar0);
						...
						{
							PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1888801[iLocal_218 /*35*/].f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_209, -1301.158f, 398.81f, 95.65845f, 0.0f, 0.0f, 61.99999f, 1.32f, 1.421f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_209, -1299.192f, 402.038f, 95.658f, 0.0f, 0.0f, 61.99999f, 1.537f, 2.022f, 3.0f);
	iLocal_208 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("WalStn-m_volPostOfficeOwner");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_208, -1301.045f, 400.748f, 95.8015f, 0.0f, 0.0f, 61.99999f, 2.173f, 5.0f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_208, -1301.309f, 398.458f, 95.8015f, 0.0f, 0.0f, 61.99999f, 2.173f, 2.006f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_208, -1298.877f, 402.661f, 95.8015f, 0.0f, 0.0f, 61.99999f, 3.035f, 2.644f, 3.0f);
	iLocal_210 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1301.071f, 400.6989f, 95.824f, 0.0f, 0.0f, 61.99999f, 2.0f, 5.0f, 3.0f, "WalStn-m_volPostOfficeOfflimits");
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_211, -1302.8f, 395.115f, 95.824f, 0.0f, 0.0f, 61.99999f, 13.80803f, 7.2f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_211, -1296.613f, 397.2601f, 95.824f, 0.0f, 0.0f, 61.99999f, 3.88245f, 2.262934f, 3.0f);
	iLocal_212 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1303.289f, 394.199f, 95.824f, 0.0f, 0.0f, 62.0f, 2.042f, 1.5f, 3.0f, "WalStn-m_volGeneralShopPrompt");
	iLocal_213 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1307.855f, 397.8527f, 95.324f, 0.0f, 0.0f, 61.99999f, 4.5f, 4.5f, 4.0f, "WalStn-m_volGeneralShopPorch");
	iLocal_214 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1301.095f, 393.546f, 95.824f, 0.0f, 0.0f, 60f, 3.235947f, 2.050864f, 3.0f, "WalStn-m_volGeneralShopOff");
...
{
	func_51(2, 802, iLocal_208, iParam0, iLocal_209, iLocal_210, 491520, (12.5f * 2.0f), 0, 0);
...
void func_39(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0.0f, 0.0f, 0.0f) <= 5.0f || func_61(Global_1935630, (1 << 14))) || func_61(Global_1935630, (1 << 23)))
	{
		return;
	}
...
void func_51(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	vVar1 = { func_94(iVar0) /*3*/ };
	vVar4 = { func_95(iVar0) /*3*/ };
	if (func_96(vVar1))
	{
		return;
	}
...
bool func_63()
{
	return func_61(Global_1935630, (1 << 12));
}
...
void func_68(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_57(iParam0) && func_85(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_132(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_132(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_132(&cVar6, joaat("COLOR_PURE_WHITE")), func_132(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
void func_86()
{
	...
	uVar0 = 5;
	func_153(&sLocal_117, 802, &uVar0, 0, 0);
	sLocal_117[0 /*45*/].f_43 = 25976;
	sLocal_117[0 /*45*/].f_44 = 26206;
	iVar6[0] = 802;
	func_153(&sLocal_117, 803, &iVar6, 1, 0);
	sLocal_117[1 /*45*/].f_43 = 26251;
	sLocal_117[1 /*45*/].f_44 = 26206;
}
...
bool func_103(int iParam0, int iParam1)
{
	...
	if (func_97(iParam0, (1 << 14)) && !func_172(iParam0, 1))
	{
		return true;
	}
	if (!func_90(iParam1))
...
char* func_132(char* sParam0, int iParam1)
{
	...
	return func_191(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_133(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_137(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_147()
{
	...
	while (iVar0 < 2)
	{
		if (func_197(&(sLocal_117[iVar0 /*45*/].f_34)))
		{
			func_198(&(sLocal_117[iVar0 /*45*/].f_34));
		}
		func_199(sLocal_117[iVar0 /*45*/].f_38);
		func_199(sLocal_117[iVar0 /*45*/].f_39);
		iVar0++;
	}
}
...
void func_148(int iParam0)
{
	...
	func_202(iParam0, (1 << 13));
	func_202(iParam0, (1 << 14));
	func_202(iParam0, (1 << 15));
	func_202(iParam0, (1 << 17));
	func_202(iParam0, (1 << 24));
	func_202(iParam0, (1 << 19));
	func_202(iParam0, (1 << 20));
...
void func_153(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	func_208(uParam0[iParam3 /*45*/], (1 << 15));
	func_208(uParam0[iParam3 /*45*/], (1 << 10));
...
Vector3 func_154(var uParam0)
{
	...
	if ((AUDIO::IS_ANY_SPEECH_PLAYING(bVar0) || AUDIO::_0x2B101AD9F651243A()) || AUDIO::IS_SCRIPTED_SPEECH_PLAYING(bVar0))
	{
		func_208(&(sLocal_117[1 /*45*/]), 16);
		func_208(&(sLocal_117[1 /*45*/]), (1 << 11));
	}
	return func_210("");
}
...
Vector3 func_156(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(bVar1) || ENTITY::IS_ENTITY_DEAD(bVar1))
	{
		return func_210("");
	}
	if ((AUDIO::IS_ANY_SPEECH_PLAYING(bVar1) || AUDIO::_0x2B101AD9F651243A()) || AUDIO::IS_SCRIPTED_SPEECH_PLAYING(bVar1))
	{
		func_208(uParam0, 16);
	}
...
void func_165(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		{
			func_179(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_178(iParam0, (1 << 10)))
	{
		func_222(iParam0, (1 << 10));
		INVENTORY::_0x9B4E793B1CB6550A();
	}
	func_223(iParam0);
}
...
bool func_181(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (uParam0->f_30 == 1)
	{
		if (!func_213(uParam0, (1 << 16)) && func_232(Global_35, iVar0, 1) > 25.0f)
		{
			func_233(1, 1, 0);
		}
...
bool func_211(var uParam0, int iParam1)
{
	...
	if (!func_262(iVar0, iParam1, (1 << 10)))
	{
		if (func_219(uParam0) && func_263(0))
		{
			func_264(iVar0, iParam1, (1 << 10));
			uParam0->f_21 = -1;
			return true;
		}
	}
...
bool func_234(var uParam0, bool bParam1)
{
	...
	if (!func_288(bVar0, func_213(uParam0, (1 << 11))))
	{
		return false;
	}
	if (uParam0->f_30 == 0)
	{
		if (!func_213(uParam0, (1 << 11)) && !func_213(uParam0, (1 << 15)))
		{
			...
			else if (func_213(uParam0, (1 << 10)))
			{
				if (func_289(&(uParam0->f_34)) < 5.0f)
				{
					return false;
				}
			}
			else if (func_289(&(uParam0->f_34)) < 25.0f)
			{
				return false;
			}
		}
...
bool func_239(var uParam0, int iParam1)
{
	...
	if (func_213(uParam0, 128))
	{
		...
		while (iVar0 < 5)
		{
			...
			if (func_242(iVar1, 0) && func_291(iVar1, iParam1, 1, 1) <= 4.0f)
			{
				uParam0->f_21 = iVar0;
				return true;
			}
	...
	if (!func_213(uParam0, (1 << 9)) && !func_213(uParam0, 256))
	{
		return true;
	}
...
void func_247(var uParam0)
{
	...
	func_209(&(uParam0->f_34), 1);
	uParam0->f_40 = { func_299() /*3*/ };
	uParam0->f_21 = -1;
	if (func_213(uParam0, (1 << 14)))
	{
		func_218(uParam0, (1 << 14));
	}
	func_218(uParam0, (1 << 15));
	func_218(uParam0, (1 << 10));
	func_198(&uLocal_15);
	if (func_213(uParam0, (1 << 12)))
	{
		iVar0 = func_93(func_139(), uParam0->f_24);
		bVar1 = func_173(*uParam0);
		if (func_279(iVar0) && func_288(bVar1, 1))
		{
			func_300(iVar0, 0);
			func_218(uParam0, (1 << 13));
			func_218(uParam0, (1 << 12));
		}
	}
}
...
bool func_253(Vector3 vParam0, int iParam3)
{
	...
	func_302(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_303(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
{
	if (!ENTITY::DOES_ENTITY_EXIST(bParam0) || func_298(bParam0, 0))
	{
		return false;
	}
	if (func_317(bParam0))
...
bool func_294(int iParam0, int iParam1)
{
	...
	return func_178(Global_1914319.f_3[iParam0 /*446*/].f_10, (1 << 10));
}
...
{
	if (((func_310(1) || AUDIO::_0x2B101AD9F651243A()) || AUDIO::IS_SCRIPTED_SPEECH_PLAYING(bParam0)) || AUDIO::IS_ANY_SPEECH_PLAYING(bParam0))
	{
		return true;
	}
	return false;
