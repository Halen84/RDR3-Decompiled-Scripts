...
int func_15(int iParam0)
{
	...
	iVar0 = func_48(func_46((1 << 13)), 0, 3, func_47((1 << 13)));
	func_49(&iVar0, &uVar1);
	bVar3 = func_50((1 << 13), &fVar2);
	if (!func_51(uVar1, 8))
	{
		if (!func_51(uVar1, 4) || (bVar3 && (func_52() - fVar2) >= 24.0f))
		{
			return func_55(&uLocal_14, (1 << 13), &uLocal_14, func_53(), 0, func_54(), 0, 0, 0);
		}
	}
	return 1;
}
	...
	if (!func_51(uParam0->f_3, iVar0))
	{
		if (func_51(uParam0->f_3, 2))
		{
			if (!SCRIPTS::IS_THREAD_ACTIVE(*uParam2, false))
			{
				...
				{
					uParam0->f_52 = { func_109(iParam1) /*3*/ };
					uParam0->f_5 = func_48(func_46(iParam1), 0, 3, func_47(iParam1));
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_60(iParam0) && func_86(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_129(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_129(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_129(&cVar6, joaat("COLOR_PURE_WHITE")), func_129(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
bool func_106(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_164(iVar0) && func_165(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
bool func_108(var uParam0)
{
	...
	if ((!func_51(uParam0->f_3, (1 << 15)) && func_50(uParam0->f_1, &fVar1)) && func_167(uParam0->f_1, 0, &fVar0))
	{
		fVar2 = func_52();
		if ((func_52() - fVar1) >= fVar0)
		{
			func_93(&(uParam0->f_3), (1 << 15));
		}
	}
	if (func_51(uParam0->f_3, (1 << 15)))
	{
		return true;
	}
	return false;
...
char* func_129(char* sParam0, int iParam1)
{
	...
	return func_180(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_130(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
void func_145(int iParam0)
{
	...
	func_188(iParam0, (1 << 13));
	func_188(iParam0, (1 << 14));
	func_188(iParam0, (1 << 15));
	func_188(iParam0, (1 << 17));
	func_188(iParam0, (1 << 24));
	func_188(iParam0, (1 << 19));
	func_188(iParam0, (1 << 20));
...
void func_191(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_214(iParam0, (1 << 10)))
		{
			func_215(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_214(iParam0, (1 << 10)))
	{
...
bool func_206(Vector3 vParam0, int iParam3)
{
	...
	func_224(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_225(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
