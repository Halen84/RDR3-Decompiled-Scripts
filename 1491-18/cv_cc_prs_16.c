...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 3.9375f, -2.925f, 0.8945f, 88.25f, 1.0f, 1.0f, 2.2325f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	...
	iLocal_16 = func_152(uParam0, joaat("P_CS_RAG02X"), 0.0f, 0.0f, 0.0f, "RAG", 0, 0, 1);
