#pragma region Local_Variables
	...
	int iLocal_77 = 0;
	int iLocal_78 = 0;
	struct<8> /*64*/ sLocal_79 = { 0, 0, 0, 0, -1, 0, 0, 0 } ;
	var uLocal_87 = 2;
	var uLocal_88 = 1;
	var uLocal_89 = 1;
	var uLocal_90 = 1;
...
void __SCRIPT()
{
	...
	fLocal_7 = 1.0f;
	fLocal_8 = 1.0f;
	iLocal_78 = func_1(joaat("HORSE_CLASS_RIDING") /* GXTEntry: "Riding" */, 1);
	sVar0.f_1 = -1;
	sVar0.f_3.f_9 = 3;
	sVar0.f_20 = 25;
...
void func_15(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	iVar2 = func_1(joaat("HORSE_CLASS_WORK") /* GXTEntry: "Work" */, 1);
	if (*uParam0 == 52)
	{
		if (func_49())
		{
		...
		func_52(uParam0, 2, "RWP_HORSE_2", iVar2, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, fVar1, 0.0f, -4.5f, 0.0f), fVar1, iVar0, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	}
	else
	{
		if (uParam0->f_489 == 1)
	...
	switch (iLocal_9)
	{
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				func_76(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 2, (1 << 30));
				...
				if (*uParam0 == 52)
				{
					...
					func_78(uParam0->f_20[1 /*14*/], uParam0->f_20[2 /*14*/], &uLocal_38, 0.0f, 0.0f, 0.0f, 0, 0, 1, 1069547520 /* Float: 1.5f */, -1082130432 /* Float: -1f */, 1073069561, 1.0f, 1092616192 /* Float: 10f */, -1, 1, 0, 0, 0, 1);
			...
			if (*uParam0 == 52)
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
				{
					...
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[2 /*14*/], 388 /*PCF_DisableFatallyWoundedBehaviour*/, true);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[2 /*14*/], 442 /*PCF_0x78525B66*/, true);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[2 /*14*/], 136 /*PCF_CannotBeMounted*/, true);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[2 /*14*/], 209 /*PCF_0xC44343FA*/, true);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[2 /*14*/], 214 /*PCF_0x3B611ABF*/, true);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[2 /*14*/], 419 /*PCF_BlockMountHorsePrompt*/, true);
					...
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
					{
						PED::_EQUIP_META_PED_OUTFIT(uParam0->f_20[2 /*14*/], iLocal_76);
						PED::_UPDATE_PED_VARIATION(uParam0->f_20[2 /*14*/], false, true, true, true, false);
					}
					func_80(uParam0->f_20[2 /*14*/], uParam0->f_20[1 /*14*/], &uLocal_38, -1082130432 /* Float: -1f */, 0, 0, -1082130432 /* Float: -1f */, 1.0f, 1, 32, 0, -4.5f, 4.5f, (1 << 30), 1050253722 /* Float: 0.3f */, 1067030938 /* Float: 1.2f */, 0, 0, -1, 1, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1);
				}
			}
			iLocal_9 = 1;
			break;
...
float func_48(Vector3 vParam0)
{
	...
	vVar4.f_2 = 0.0f;
	vVar4 = { func_98(vVar4) /*3*/ };
	vVar7 = { -BUILTIN::SIN(fVar0), BUILTIN::COS(fVar0), 0.0f /*3*/ };
	if (func_99(vVar4, vVar7) < 0.0f)
	{
		fVar0 += 180.0f;
	}
	return fVar0;
...
void func_53(var uParam0)
{
	...
	iLocal_112 = PED::_REQUEST_META_PED_OUTFIT(iLocal_78, iLocal_76);
}
...
bool func_54(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_102(iVar0) && func_103(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_72(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		if (!PED::_GET_IS_PED_IN_DISPUTE_WITH_PED(uParam0->f_20[1 /*14*/], 0) && func_114(uParam0->f_20[1 /*14*/], Global_35, 1) > 225.0f)
		{
			if (!func_115(&uLocal_104))
			{
				if (bLocal_109)
				{
					vVar0 = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-15.0f, -5.0f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10.0f, 10.0f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10.0f, 10.0f) /*3*/ };
				}
				else
				{
					vVar0 = { MISC::GET_RANDOM_FLOAT_IN_RANGE(5.0f, 15.0f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10.0f, 10.0f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10.0f, 10.0f) /*3*/ };
				}
				sLocal_79 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_20[1 /*14*/], vVar0) /*3*/ };
				sLocal_79.f_7 = 0;
				bLocal_109 = !bLocal_109;
				func_116(&uLocal_104, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.0f, 4.5f));
			}
			if (func_117(&uLocal_104, 15.0f))
			{
				func_118(&uLocal_104);
			}
			IK::_INVERSE_KINEMATICS_REQUEST_LOOK_AT(uParam0->f_20[1 /*14*/], &sLocal_79);
		}
	}
}
...
int func_75(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_122(*uParam0, 0.0f, 0.0f, 0.0f))
	{
		return 1;
	}
	iVar1 = 0;
...
void func_78(int iParam0, int iParam1, var uParam2, Vector3 vParam3, char* sParam6, int iParam7, int iParam8, float fParam9, float fParam10, float fParam11, float fParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	...
	else if (!func_122(vParam3, 0.0f, 0.0f, 0.0f))
	{
		sVar11.f_0 = 0;
...
void func_80(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, bool bParam8, int iParam9, float fParam10, float fParam11, float fParam12, float fParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	struct<7> /*56*/ sVar0;
...
bool func_87(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, Vector3 vParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
float func_99(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5)
{
