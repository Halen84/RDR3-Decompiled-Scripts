...
bool func_11()
{
	iLocal_14 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(207.2673f, 990.9026f, 190.0828f, 0.0f, 0.0f, 0.0f, 28.40839f, 27.79798f, 6.675867f, "volDeborahWorkingAudio");
	return true;
}
...
void func_68(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_50(iParam0) && func_85(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
...
char* func_114(char* sParam0, int iParam1)
{
	...
	return func_148(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}
...
void func_129(int iParam0)
{
	...
	func_155(iParam0, (1 << 13));
	func_155(iParam0, (1 << 14));
	func_155(iParam0, (1 << 15));
	func_155(iParam0, (1 << 17));
	func_155(iParam0, (1 << 24));
	func_155(iParam0, (1 << 19));
	func_155(iParam0, (1 << 20));
...
bool func_142(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_93(iVar0) && func_170(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
char* func_143(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
bool func_171(Vector3 vParam0, int iParam3)
{
	...
	func_188(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_189(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
