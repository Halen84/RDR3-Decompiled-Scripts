...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.3991f, 0.23f, 0.0f, 0.0f, 2.5f, 2.5f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_16 = func_152(uParam0, joaat("P_SKETCHBOOK02X"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 0, 1);
	iLocal_17 = func_152(uParam0, joaat("P_PENCIL01X"), 0.0f, 0.0f, 0.0f, "PENCIL", 0, 0, 1);
	...
	sLocal_24 = { func_161(uParam0, -0.8992f, 0.8759f, 0.7524f, 100.44f, 8.0f, 0.4f, 0.4f) /*10*/ };
	sLocal_34 = { func_161(uParam0, -0.899f, 0.876f, 0.752f, 172.5f, 8.0f, 0.4f, 0.4f) /*10*/ };
	sLocal_44 = { func_161(uParam0, -0.899f, 0.876f, 0.752f, -115.4f, 8.0f, 0.8f, 0.4f) /*10*/ };
	sLocal_54 = { func_161(uParam0, -0.899f, 0.876f, 0.752f, 29.16f, 8.0f, 0.4f, 0.8f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_200(uParam0, sLocal_24, 1, 0))
		{
			func_191(uParam0, iLocal_19, 1);
		}
		else if (func_200(uParam0, sLocal_34, 1, 0))
		{
			func_191(uParam0, iLocal_20, 1);
		}
		else if (func_200(uParam0, sLocal_44, 1, 0))
		{
			func_191(uParam0, iLocal_21, 1);
		}
		else if (func_200(uParam0, sLocal_54, 1, 0))
		{
