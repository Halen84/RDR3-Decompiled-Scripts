...
int func_105(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_171(*uParam0, 0.0f, 0.0f, 0.0f))
	{
		return 1;
	}
	iVar1 = 0;
...
int func_110(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_174(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_175(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_121(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
	{
		func_185(uParam0->f_12, uParam0->f_12.f_10, func_99(uParam0->f_615), 2, (1 << 30));
...
bool func_129(bool bParam0, int iParam1, var uParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	*iParam3 = sVar0.f_3;
	...
	if (bParam4)
	{
		func_188(bParam0, iParam1, uParam2, *iParam3);
	}
	return true;
}
...
bool func_137(bool bParam0)
{
	...
	if (func_195(bParam0, joaat("CI_TAG_SHOP_ANIMAL_LEGENDARY")))
	{
		return true;
	}
	return false;
...
bool func_139(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (func_196(bParam0, uParam2, iParam3, bParam5, 0))
	{
		return false;
	}
	if (!func_192(0))
...
Vector3 func_158(int iParam0, int iParam1)
{
	...
	{
		case 0:
			vVar0 = { func_202(1, iParam1) /*3*/ };
			break;
		case 1:
			vVar0 = { func_202(2, iParam1) /*3*/ };
			break;
		case 2:
			vVar0 = { func_202(3, iParam1) /*3*/ };
			break;
	}
	return vVar0;
}
...
float func_159(int iParam0, int iParam1)
{
	...
	{
		case 0:
			fVar0 = func_203(1, iParam1);
			break;
		case 1:
			fVar0 = func_203(2, iParam1);
			break;
		case 2:
			fVar0 = func_203(3, iParam1);
			break;
	}
	return fVar0;
}
...
Vector3 func_160()
{
	return func_204("ATZ_INS_EXC_CO" /* GXTEntry: "Cougar Dung" */);
}

Vector3 func_161()
{
	return func_204("ATZ_INS_FUR" /* GXTEntry: "Fur" */);
}
...
void func_188(bool bParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
{
	if (func_226(bParam0, joaat("DEFAULT") /* GXTEntry: "_" */) == 0)
	{
		return false;
	}
	return true;
...
bool func_196(bool bParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_228(bParam0) && WEAPON::IS_WEAPON_A_GUN(bParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
		{
			...
			if (!func_230(bParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
			{
				return false;
			}
			else if (func_231(bParam0, &sVar4, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
			{
				return false;
			}
			if (func_232(bParam0, 1))
			{
				if (!func_230(bParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					return false;
				}
				else if (func_231(bParam0, &sVar4, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */))
				{
					return false;
				}
			}
...
{
	if (func_190(bParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	...
	switch (func_245(bParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_232(bParam0, 1))
			{
				...
				else if (!func_230(bParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_231(bParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
