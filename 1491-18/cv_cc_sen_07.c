...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			func_149(uParam0, -139.903f, -41.345f, 93.65f, 0.0f, 0.0f, -100.97f);
			iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-98.0355f, -17.41405f, 96.11881f, 0.0f, 0.0f, 0.0f, 14.0f, 12.0f, 3.0f, "TRIGGER_VOL");
			break;
		case 2:
			func_149(uParam0, 682.339f, -1229.725f, 44.215f, 0.0f, -2.0f, -84.6f);
			iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(717.5239f, -1193.695f, 45.56543f, 0.0f, 0.0f, 20f, 14.0f, 12.0f, 3.0f, "TRIGGER_VOL");
			break;
		default:
			return false;
	}
	...
	func_151(uParam0, joaat("P_CS_PLATESTEW01X"), 0.0f, 0.0f, 0.0f, "PLATE", 0, 0, 1);
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_250(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_264(uParam0->f_107[iVar12 /*113*/].f_1));
				}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0 /*15*/].f_5 && !ENTITY::DOES_ENTITY_EXIST(uParam0->f_1711[iVar0 /*15*/].f_10))
			{
				...
				{
					vVar3 = { func_280(uParam0, uParam0->f_1711[iVar0 /*15*/].f_1) /*3*/ };
				}
				else
				{
...
void func_183(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_280(uParam0, uParam0->f_1976.f_1), 1, func_282(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
bool func_261(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1 /*15*/].f_5)
		{
			...
			{
				vVar2 = { func_280(uParam0, uParam0->f_1711[iVar1 /*15*/].f_1) /*3*/ };
			}
			else
			{
