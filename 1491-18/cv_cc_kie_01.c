...
bool func_77(var uParam0)
{
	...
	{
		case 1:
			func_160(uParam0, -138.345f, -12.258f, 95.336f, 0.0f, 0.0f, -70.97f);
			break;
		default:
			return false;
	}
	...
	func_162(uParam0, 0.0875f, 0.1625f, 1.4875f, 0.0f, 3.345f, 3.06f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	func_162(uParam0, 2.6625f, -5.6f, 1.1875f, 47.5f, 1.95f, 1.7025f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	func_162(uParam0, -0.375f, -7.25f, 1.4875f, 0.0f, 1.2f, 1.2f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	func_163(uParam0, joaat("P_BUCKET02X"), 0.0f, 0.0f, 0.0f, "p_bucket02x", 0, 1, 1);
	iLocal_95 = func_163(uParam0, joaat("P_CS_ROPE03BX"), 0.0f, 0.0f, 0.0f, "p_cs_rope03x", 0, 0, 1);
	iLocal_96 = func_163(uParam0, joaat("P_MUGCOFFEE01X"), 0.0f, 0.0f, 0.0f, "p_cuptin01x", 0, 0, 1);
	...
	func_166(uParam0, iLocal_93, 2, joaat("WORLD_CAMP_KIERAN_TREE_TIED"), "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1, -1.0f, 1065353216 /* Float: 1f */, 1);
	...
	func_166(uParam0, iLocal_92, 1, joaat("WORLD_HUMAN_COFFEE_DRINK"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_167(uParam0, iLocal_92, iLocal_96, "p_mugCoffee01x_ph_r_hand", 0, 0);
	sLocal_97 = { func_171(uParam0, 3.24f, 2.525f, 0.805f, 18.0f, 6.5f, 0.22f, 0.95f) /*10*/ };
...
bool func_98(var uParam0)
{
	if (func_210(uParam0, iLocal_92))
	{
		...
		else if (func_212(uParam0, sLocal_97, 1, 0))
		{
			bLocal_107 = true;
	...
	if (bLocal_108)
	{
		if (ENTITY::IS_ENTITY_OCCLUDED(func_53(uParam0, iLocal_93)))
		{
			...
			func_61(10, 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
		}
	}
	return true;
}
...
void func_109(Vector3 vParam0, int iParam3)
{
	...
	while (iVar0 < Global_1911670)
	{
		...
		if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(iVar1))
		{
			...
			if (func_228(vVar2, vParam0, 2.0f, 1))
			{
...
int func_118(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_131(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_229(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000.0f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_231(iParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_232(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_232(iParam0, 0));
					func_233(iParam0);
				}
			}
			else
			{
				if (func_234(iParam0, (1 << 15), 1))
				{
...
void func_137(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_247(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_249(iParam0) < 10000.0f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_154(var uParam0)
{
	...
	if (func_255(Global_1935630, (1 << 14)))
	{
		return true;
	}
	if (func_256(2))
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_262(uParam0->f_107[iVar0 /*113*/].f_1, (1 << 11)))
			{
				return true;
			}
...
int func_162(var uParam0, Vector3 vParam1, float fParam4, Vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_270(uParam0, vParam1) /*3*/ };
...
struct<10> /*80*/ func_171(var uParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	float fVar0;
	float fVar1;
	struct<10> /*80*/ sVar2;

	fVar0 = func_271(uParam0, (fParam4 + (fParam6 * 90.0f)));
	fVar1 = func_271(uParam0, (fParam4 - (fParam7 * 90.0f)));
	sVar2 = { func_270(uParam0, vParam1) /*3*/ };
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_230(uParam0->f_107[iVar12 /*113*/].f_7, 1));
				}
			}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0 /*15*/].f_5 && !ENTITY::DOES_ENTITY_EXIST(uParam0->f_1711[iVar0 /*15*/].f_10))
			{
				...
				{
					vVar3 = { func_270(uParam0, uParam0->f_1711[iVar0 /*15*/].f_1) /*3*/ };
				}
				else
				{
...
void func_197(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_270(uParam0, uParam0->f_1976.f_1), 1, func_271(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
void func_211(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_320(100.0f, 140.0f);
			}
		}
...
bool func_212(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_322(sParam1, sParam1.f_6, Global_36))
	{
		return false;
	}
	if (func_322(sParam1, sParam1.f_3, Global_36))
	{
		return false;
	}
	if (bParam12)
...
void func_220(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_335(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
bool func_261(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_345(iVar0) && func_346(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
bool func_284(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1 /*15*/].f_5)
		{
			...
			{
				vVar2 = { func_270(uParam0, uParam0->f_1711[iVar1 /*15*/].f_1) /*3*/ };
			}
			else
			{
...
int func_310(var uParam0, int iParam1)
{
	...
	if (func_335(uParam0, iParam1, 1.0f))
	{
		return 1;
	}
...
bool func_322(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
void func_323(var uParam0, var uParam1)
{
	...
	func_381(Global_35, iVar0, &sVar1, 0.0f, 0.0f, 0.0f, 0, 0, 1, 1069547520 /* Float: 1.5f */, -1082130432 /* Float: -1f */, 1073069561, 1056964608 /* Float: 0.5f */, 1092616192 /* Float: 10f */, -1, 1, 0, 0, 0, 1);
	func_222(1);
}
...
void func_324(var uParam0, var uParam1)
{
	...
	sVar1.f_19 = -1;
	sVar1.f_26 = -1082130432;
	func_382(iVar0, Global_35, &sVar1, -1082130432 /* Float: -1f */, 0, 0, uParam1->f_4, uParam1->f_5, 1, uParam1->f_26, 0, 0, 1069547520 /* Float: 1.5f */, (1 << 30), 1050253722 /* Float: 0.3f */, 1067030938 /* Float: 1.2f */, 0, 0, -1, 1, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1);
}
		...
		else
		{
			...
			if (fVar3 < uParam1->f_54[iVar1 /*6*/].f_3)
			{
				if (PED::IS_PED_HEADING_TOWARDS_POSITION(Global_35, ENTITY::GET_ENTITY_COORDS(iVar2, true, false), uParam1->f_54[iVar1 /*6*/].f_5))
				{
					...
					fVar0 = func_389(func_388(fVar6, fVar0), 0.0f);
				}
			}
		}
		iVar1++;
	...
	switch (uParam1->f_47.f_1)
	{
		case 0:
			if (func_390(uParam0, uParam1))
			{
				...
				if (uParam0->f_2 == 456)
				{
					func_391(Global_35, "WNT_INTERRUPT_NAGGED", joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), iVar0, 1, 0, 5, 1);
					func_392(uParam1, 2);
					return;
				}
				func_391(Global_35, func_393(uParam0, uParam1), joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), iVar0, 1, 0, 0, 1);
		...
		case 2:
			if (!AUDIO::IS_ANY_SPEECH_PLAYING(Global_35))
			{
				...
				func_391(iVar0, func_397(uParam0, uParam1), joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), Global_35, 1, 0, 0, 1);
		...
		else if (func_20(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_416(&iVar2, func_415(iVar3)))
					{
...
int func_374(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_430(fVar9) /*3*/ };
			vVar13 = { func_431(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) /*3*/ };
...
void func_381(int iParam0, bool bParam1, var uParam2, Vector3 vParam3, char* sParam6, int iParam7, int iParam8, float fParam9, float fParam10, float fParam11, float fParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	struct<10> /*80*/ sVar0;
	struct<10> /*80*/ sVar11;
	...
	else if (!func_433(vParam3, 0.0f, 0.0f, 0.0f))
	{
		sVar11.f_0 = 0;
	...
	if (bParam19)
	{
		func_434(iParam0, bParam1, iParam14);
	}
}

void func_382(int iParam0, bool bParam1, var uParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, bool bParam8, int iParam9, float fParam10, float fParam11, float fParam12, float fParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	struct<7> /*56*/ sVar0;
	...
	if (bParam22)
	{
		func_434(iParam0, bParam1, iParam18);
	}
}
...
bool func_390(var uParam0, var uParam1)
{
	...
	if (!func_395(uParam1->f_47.f_3))
	{
		uParam1->f_47.f_3 = func_436("INTERACT_WNT_DISMISS" /* GXTEntry: "Not Now" */, joaat("INPUT_INTERACT_LOCKON_NEG"), iVar0, 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		func_437(uParam1->f_47.f_3, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(iVar0), 0, 1);
	}
	if (AUDIO::IS_ANY_SPEECH_PLAYING(Global_35))
	{
...
int func_394(var uParam0)
{
	...
	return (func_444() - BUILTIN::ROUND((uParam0->f_1 * 1000.0f)));
}
...
bool func_414(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_262(iParam0, (1 << 31)))
	{
		return true;
	}
	if (func_262(iParam0, (1 << 30)))
	{
		return true;
	}
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_460(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, (1 << 30));
			}
			else if (bParam16)
			{
...
int func_436(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 48)
	{
		if (func_474(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_475(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
char* func_443(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_SET_PERSCHAR_SCHEDULE(func_230(iParam0, 1), &cVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_227(vVar0)) && !func_228(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_460(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, (1 << 30));
			}
			if (bParam1)
			{
				if (!ENTITY::_DOES_THREAD_OWN_THIS_ENTITY(Global_1360165[iParam0 /*1157*/].f_124))
			...
			{
				PERSCHAR::_0x63AA2B8EB087886A(func_230(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
void func_451(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_489(func_115(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_490(iParam0);
...
bool func_485(int iParam0, Vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489.f_12) || (bParam5 && Global_1359489.f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_230(iParam0, 1));
...
void func_487(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_247(iParam1), iParam0, false);
	...
	func_451(iParam1, func_516(iParam1, (1 << 13)), func_516(iParam1, (1 << 14)), 1);
}
...
void func_489(int iParam0, float fParam1, bool bParam2)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		fParam1 = func_519(fParam1, 0.0f, 1.0f);
...
void func_512(int iParam0)
{
	...
	func_530(iParam0, (1 << 9));
	func_530(iParam0, (1 << 10));
	func_530(iParam0, (1 << 11));
	func_530(iParam0, (1 << 12));
	func_530(iParam0, (1 << 16));
	func_530(iParam0, (1 << 14));
	func_530(iParam0, (1 << 18));
	func_530(iParam0, (1 << 19));
	func_530(iParam0, (1 << 20));
	func_530(iParam0, (1 << 21));
	func_530(iParam0, (1 << 15));
	func_530(iParam0, (1 << 17));
	func_530(iParam0, (1 << 27));
	func_530(iParam0, (1 << 30));
}
...
int func_514(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == joaat("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case joaat("GROUP_SHOTGUN"):
			case joaat("GROUP_RIFLE"):
				if (func_532(joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */))
				{
	...
	{
		func_533(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0.0f;
...
int func_533(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
...
struct<5> /*40*/ func_540(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_552(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_544(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_554(iParam0, 1))
			{
				...
				if (!func_542(iParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_542(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_543(iParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_544(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
...
struct<4> /*32*/ func_544(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_562(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}
...
bool func_545(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_562(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
void func_548(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_565(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> /*32*/ func_553(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_544(joaat("CARRIED_WEAPONS"), func_551(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_544(joaat("CARRIED_WEAPONS"), func_551(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_544(joaat("CARRIED_WEAPONS"), func_551(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}
...
struct<4> /*32*/ func_555(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_544(joaat("EMOTE_ITEM"), func_551(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_544(joaat("EMOTE_ITEM"), func_551(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
bool func_558(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_562(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_559(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	...
	iVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_562(bParam6), &sVar0, false);
	return iVar4;
}
...
bool func_560(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_562(0);
	*uParam1 = { func_544(iParam0, func_553(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
