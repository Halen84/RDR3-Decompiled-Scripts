	...
	while (true)
	{
		...
		switch (iLocal_14)
		{
			case 0:
				if (7 == iLocal_15)
				{
					sLocal_20 = "DONT_LEAVE_CAMP" /* GXTEntry: "The weather is harsh. Return to your camp." */;
					func_4(1);
		...
		if (iLocal_16 < MISC::GET_GAME_TIMER())
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_18))
			{
				if (ENTITY::IS_ENTITY_DEAD(iLocal_18))
				{
					...
					{
						func_4(1);
						sLocal_20 = "DONT_LEAVE_CAMP_HORSE_DIED" /* GXTEntry: "Your horse has died due to the harsh weather conditions. Return to camp." */;
						bLocal_21 = true;
					}
				}
				else
