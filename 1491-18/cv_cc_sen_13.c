...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 4.115f, 2.36f, 1.1875f, -44.0f, 1.0975f, 1.145f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_LENNY"), 1, 1, 1);
	func_151(uParam0, -0.0675f, 2.0425f, 1.1875f, 16.0f, 3.4425f, 1.2525f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	func_152(uParam0, joaat("P_CIGARETTE_CS02X"), 0.0f, 0.0f, 0.0f, "CIGARETTE", 0, 1, 1);
	...
	func_157(uParam0, iLocal_14, 2, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, 1, -1);
	func_156(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_D", -1, 1);
	sLocal_22 = { func_159(uParam0, -0.5575f, 2.325f, 1.07f, 159.0f, 6.5f, 0.1725f, 0.66f) /*10*/ };
	sLocal_32 = { func_159(uParam0, -0.5575f, 2.325f, 1.07f, -126.25f, 6.5f, 0.22f, 0.6575f) /*10*/ };
	sLocal_42 = { func_159(uParam0, -0.558f, 2.325f, 1.07f, -47.16f, 6.5f, 0.22f, 0.66f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_198(uParam0, sLocal_22, 1, 0))
		{
			func_189(uParam0, iLocal_18, 1);
		}
		else if (func_198(uParam0, sLocal_32, 1, 0))
		{
			func_189(uParam0, iLocal_19, 1);
		}
		else if (func_198(uParam0, sLocal_42, 1, 0))
		{
