	...
	switch (iLocal_725)
	{
		...
		else
		{
			...
			else
			{
				...
				iLocal_725 = 4;
				MISC::_0x1096603B519C905F("BRT2" /* GXTEntry: "The Fine Joys of Tobacco" */);
				return 1;
			}
			return 0;
			default:
...
bool func_25(int iParam0)
{
	...
	switch (iLocal_731[iParam0])
	{
		...
		case 7:
			CAM::_REQUEST_LETTER_BOX_OVERTIME(-1, -1, false, 17, true, false);
			if ((func_62(&uLocal_846) > 3.0f && CAM::_IS_CINEMATIC_CAM_LOCATION_LOADED("script@Cinematics@TripSkip@Clemens_Point")) && STREAMING::IS_SRL_LOADED())
			{
				...
				AUDIO::_0x5E3CCF03995388B5(joaat("2_TRIPSKIP_BRT2_1_CAM"), 1192.2f, -1557.0f, 55.4f);
		...
		case 9:
			...
			if (AUDIO::_0xFFE9C53DEEA3DB0B((CAM::_0xEA113BF9B0C0C5D7("script@Cinematics@TripSkip@Clemens_Point", "2_TripSkip_BRT2_1", 5) - func_66(&uLocal_846)), joaat("2_TRIPSKIP_BRT2_2_CAM"), 1919.4f, -1341.3f, 49.1f, true, 2147483647 /* Hex: 0x7FFFFFFF */))
			{
		...
		case 11:
			...
			if (AUDIO::_0xFFE9C53DEEA3DB0B((CAM::_0xEA113BF9B0C0C5D7("script@Cinematics@TripSkip@Clemens_Point", "2_TripSkip_BRT2_2", 5) - func_66(&uLocal_846)), joaat("1_TRIPSKIP_CLEMENS_1_CAM"), 749.7f, -1202.1f, 46.0f, true, 2147483647 /* Hex: 0x7FFFFFFF */) && CAM::IS_SCREEN_FADED_OUT())
			{
		...
		case 12:
			...
			if (AUDIO::_0xFFE9C53DEEA3DB0B((CAM::_0xEA113BF9B0C0C5D7("script@Cinematics@TripSkip@Clemens_Point", "1_TripSkip_Clemens_1", 5) - func_66(&uLocal_846)), 0, 749.7f, -1202.1f, 46.0f, true, 2147483647 /* Hex: 0x7FFFFFFF */))
			{
		...
		case 14:
			...
			if (func_76(uLocal_729[iParam0], vLocal_836[iParam0 /*3*/], 1.0f, 1096810496 /* Float: 14f */))
			{
...
void func_56()
{
	WEAPON::SET_CURRENT_PED_WEAPON(uLocal_729[0], joaat("WEAPON_UNARMED") /* GXTEntry: "Unarmed" */, false, 0, false, false);
...
bool func_61(int iParam0)
{
	...
	{
		WEAPON::SET_CURRENT_PED_WEAPON(uLocal_729[iParam0], joaat("WEAPON_UNARMED") /* GXTEntry: "Unarmed" */, true, 0, false, false);
		return true;
	}
	return false;
}
...
void func_71()
{
	...
	if (bLocal_853)
	{
		...
		func_136(uLocal_729[0], fVar0, 0, 1045220557 /* Float: 0.2f */, 1, 3.0f, (30.0f / 2.0f), (60.0f / 2.0f), 1033476506 /* Float: 0.075f */, 1061158912 /* Float: 0.75f */, 1, 0, 1045220557 /* Float: 0.2f */, 0);
...
void func_102()
{
	...
	PLAYER::_ADD_PLAYER_AS_FOLLOW_TARGET(PLAYER::GET_PLAYER_INDEX(), uLocal_729[0], -1.0f, -1.0f, 1, 2, false);
}
...
void func_162(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_213(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_213(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
int func_213(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == joaat("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case joaat("GROUP_SHOTGUN"):
			case joaat("GROUP_RIFLE"):
				if (func_271(joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */))
				{
...
struct<5> /*40*/ func_301(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_323(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_305(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_325(iParam0, 1))
			{
				...
				if (!func_303(iParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_303(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_304(iParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_305(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
