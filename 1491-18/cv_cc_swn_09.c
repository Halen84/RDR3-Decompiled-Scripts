...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.36f, -0.02f, 0.5f, 0.0f, 1.4f, 1.4f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -0.2379f, -1.0318f, 0.5f, 0.0f, 1.4f, 1.4f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	func_152(uParam0, joaat("P_SPOON01X"), 0.0f, 0.0f, 0.0f, "SPOON", 0, 1, 1);
	iLocal_17 = func_152(uParam0, joaat("P_BOWL04X_STEW"), 0.0f, 0.0f, 0.0f, "BOWL", 0, 1, 1);
...
{
	iLocal_18 = WEAPON::_CREATE_WEAPON_OBJECT(joaat("WEAPON_MELEE_KNIFE") /* GXTEntry: "Hunting Knife" */, 1, uParam0->f_23, true, 1.0f);
...
bool func_87(var uParam0)
{
	...
	{
		func_192(uParam0, iLocal_18, "KNIFE" /* GXTEntry: "Knife" */);
		bLocal_20 = true;
		return false;
	}
	return true;
...
int func_201(var uParam0)
{
	...
	switch (uParam0->f_1699)
	{
		case 0:
			...
			break;
		case 1:
			uParam0->f_1707 = func_306("INTERACT_INSULT" /* GXTEntry: "Antagonize" */, joaat("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, (1 << 30), 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
			func_307(uParam0->f_1707, iVar0, 0, 1, -1);
			if (uParam0->f_1709)
			{
				uParam0->f_1708 = func_306("INTERACT_GREET" /* GXTEntry: "Greet" */, joaat("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, (1 << 30), 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
		...
		case 3:
			...
			func_310(Global_35, &sVar1, 0, iVar0, 1, 0, 0, 1);
			uParam0->f_1699++;
			break;
		case 4:
			if (!AUDIO::IS_ANY_SPEECH_PLAYING(Global_35))
			{
				...
				func_310(iVar0, &sVar1, 0, Global_35, 1, 0, 0, 1);
				uParam0->f_1699++;
			}
			break;
		case 5:
...
int func_306(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, float fParam8, bool bParam9, int iParam10, int iParam11, bool bParam12)
{
	int iVar0;
	int iVar1;
