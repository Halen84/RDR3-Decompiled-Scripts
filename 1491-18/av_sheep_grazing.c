#pragma region Local_Variables
	...
	Vector3 vLocal_86 = { 0.0f, 0.0f, 0.0f };
...
void __SCRIPT()
{
	...
	iLocal_10 = joaat("WORLD_ANIMAL_SHEEP_GRAZING");
...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 15:
			...
			iLocal_94 = 5;
			iLocal_72 = 1071881105;
			vLocal_80 = { -230.685f, 637.878f, 112.425f /*3*/ };
			fLocal_95 = 48.96f;
			vLocal_83 = { -228.877f, 638.1553f, 112.389f /*3*/ };
			fLocal_96 = 60.2229f;
			break;
		case 5:
			iLocal_10 = joaat("WORLD_ANIMAL_COW_GRAZING");
			iLocal_70 = joaat("A_C_COW");
			iLocal_9 = joaat("A_M_M_RANCHER_01");
			iLocal_72 = -1983185436;
			vLocal_80 = { 2254.331f, -97.407f, 44.618f /*3*/ };
			fLocal_95 = 154.8f;
			vLocal_83 = { 2256.156f, -97.059f, 44.471f /*3*/ };
			fLocal_96 = 152.64f;
			vLocal_86 = { 2255.22f, -104.21f, 44.79f /*3*/ };
			fLocal_97 = -133.984f;
			vLocal_89 = { 2251.53f, -115.28f, 44.95f /*3*/ };
			fLocal_98 = 119.957f;
			break;
		case 8:
			...
			vLocal_80 = { -5189.384f, -2130.353f, 11.053f /*3*/ };
			fLocal_95 = 97.2f;
			vLocal_83 = { -5189.521f, -2128.847f, 11.053f /*3*/ };
			fLocal_96 = 97.2f;
			vLocal_86 = { -5219.56f, -2130.54f, 11.16f /*3*/ };
			fLocal_97 = -11.14f;
			vLocal_89 = { -5198.76f, -2129.81f, 11.05f /*3*/ };
			fLocal_98 = -107.478f;
			break;
	}
	func_49(uParam0, 0, "SGP_MAN", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 1, "SGP_DOG", joaat("A_C_DOGAMERICANFOXHOUND_01"), OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 1.25f, 0.0f, 0.0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	if (Global_1415419.f_9757 != -310375866)
	{
		func_49(uParam0, 2, "SGP_SHEEP_1", iLocal_70, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, -1.15f, 4.5f, 0.0f), (45.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_49(uParam0, 3, "SGP_SHEEP_2", iLocal_70, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.25f, 5.25f, 0.0f), (120.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	}
}
...
{
	if (!VOLUME::DOES_VOLUME_EXIST(iLocal_13))
	{
		if (*uParam0 == 15)
		{
			if (Global_1415419.f_9757 == -310375866)
			{
				vLocal_77 = { -235.3057f, 640.7958f, 113.0241f /*3*/ };
				iLocal_13 = VOLUME::CREATE_VOLUME_BOX(vLocal_77, 0.0f, 0.0f, -37.02594f, 9.625906f, 8.149053f, 4.805788f);
			}
		}
	}
	return true;
...
int func_30(var uParam0)
{
	...
	if (*uParam0 == 15)
	{
		if (Global_1415419.f_9757 == -310375866)
		{
			vLocal_74 = { -218.9387f, 643.7864f, 113.522f /*3*/ };
		}
	}
	return 1;
}
...
int func_31(var uParam0)
{
	...
	if (!bLocal_92)
	{
		if (func_65(Global_35, vLocal_74, 1) <= 400.0f && !func_66(uParam0))
		{
			func_67(uParam0);
			bLocal_92 = true;
		}
	...
	if (*uParam0 != 8 && *uParam0 != 5)
	{
		if (iLocal_11 < 6)
		{
			...
			{
				func_69(iLocal_72, 0, 1.0f, 1, 1, 0, 0, 0);
			}
		}
	}
	switch (iLocal_11)
	{
		case 0:
			...
			if (func_71(uParam0->f_20[0 /*14*/], 0))
			{
				...
				if (Global_1415419.f_9757 == -310375866)
				{
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("WORLD_HUMAN_CROUCH_INSPECT"), -216.29f, 650.41f, 112.07f, 153.346f, 0, false, true, 0, -1.0f, false);
				}
				else
				{
					func_72(&(uParam0->f_20[0 /*14*/].f_5), 50, 10, 0);
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[0 /*14*/], joaat("WEAPON_REVOLVER_CATTLEMAN") /* GXTEntry: "Cattleman Revolver" */, 999, false, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
					TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[0 /*14*/], joaat("WORLD_HUMAN_CROUCH_INSPECT"), 0, false, 0, -1.0f, false);
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("WORLD_HUMAN_CROUCH_INSPECT"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
				}
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], joaat("STAND"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[2 /*14*/]))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
				{
					...
					FLOCK::SET_ANIMAL_TUNING_FLOAT_PARAM(uParam0->f_20[2 /*14*/], 73, 0.0f);
					...
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[2 /*14*/], iLocal_10, uParam0->f_20[2 /*14*/].f_5, uParam0->f_20[2 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[3 /*14*/]))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[3 /*14*/]))
				{
					...
					FLOCK::SET_ANIMAL_TUNING_FLOAT_PARAM(uParam0->f_20[3 /*14*/], 73, 0.0f);
					...
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[3 /*14*/], iLocal_10, uParam0->f_20[3 /*14*/].f_5, uParam0->f_20[3 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
					func_73(&(uParam0->f_20[3 /*14*/]), 0, 1);
				}
			}
			if (func_71(uParam0->f_20[1 /*14*/], 0) && Global_1415419.f_9757 == -310375866)
			{
				func_74(uParam0->f_20[1 /*14*/], -214.15f, 648.98f, 111.96f, 111.96f, 2, (1 << 30));
			}
			iLocal_11 = 1;
			break;
		case 1:
			if (func_75(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				...
				if (func_71(uParam0->f_20[1 /*14*/], 0))
				{
					...
					if (Global_1415419.f_9757 == -310375866)
					{
						TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], joaat("WORLD_ANIMAL_DOG_GUARD_GROWL"), -214.15f, 648.98f, 111.96f, 111.96f, 0, true, true, 0, -1.0f, false);
					}
					else
					{
						TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[1 /*14*/], joaat("WORLD_ANIMAL_DOG_GUARD_GROWL"), 0, true, 0, -1.0f, false);
					}
				}
				func_78(&uLocal_99);
				iLocal_11 = 3;
			...
			break;
		case 3:
			if (func_79(&uLocal_99, 3.0f))
			{
				if (func_71(uParam0->f_20[0 /*14*/], 0))
				{
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("WORLD_HUMAN_STARE_STOIC"), vLocal_80, fLocal_95, 0, true, false, 0, -1.0f, false);
				...
				else
				{
					if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[2 /*14*/]))
					{
						if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
						{
							...
							TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[2 /*14*/], iLocal_10, vLocal_86, fLocal_97, 0, true, false, 0, -1.0f, false);
						}
					}
					if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[3 /*14*/]))
					{
						if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[3 /*14*/]))
						{
							...
							TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[3 /*14*/], iLocal_10, vLocal_89, fLocal_98, 0, true, false, 0, -1.0f, false);
						}
					}
				}
				func_78(&uLocal_99);
		...
		case 2:
			if (func_79(&uLocal_99, 1.5f))
			{
				if (func_71(uParam0->f_20[1 /*14*/], 0))
				{
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], joaat("WORLD_ANIMAL_DOG_SITTING"), vLocal_83, fLocal_96, 0, true, false, 0, -1.0f, false);
		...
		case 4:
			...
			break;
		case 6:
			if (func_66(uParam0) || func_79(&uLocal_99, 15.0f))
			{
				if (*uParam0 == 15)
				{
					if (Global_1415419.f_9757 != -310375866)
...
bool func_64(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (Global_1935630.f_26 & func_117(PLAYER::PLAYER_ID(), 0, 1, (uParam2->f_1 & (1 << 19)) == 0))
		{
		...
		{
			if (func_118(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!(uParam2->f_1 & 4) != 0)
				{
	...
	if (ITEMSET::IS_ITEMSET_VALID(iLocal_73))
	{
		...
		while (iVar0 < iVar1)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iVar3))
			{
				...
				TASK::_TASK_FLEE_FROM_PED(iVar3, Global_35, vLocal_77, -1.0f, 10000, 1280, 1.5f, 0);
...
void func_69(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_142(iParam0, 0, 0);
	if (func_143(iParam0))
	{
		...
		if (bParam3)
		{
			func_144(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
bool func_70(var uParam0)
{
	...
	if (!VOLUME::DOES_VOLUME_EXIST(iLocal_12))
	{
		if (*uParam0 == 15)
		{
			if (Global_1415419.f_9757 == -310375866)
			{
				iLocal_12 = VOLUME::CREATE_VOLUME_BOX(vLocal_74, 0.0f, 0.0f, -37.02594f, 9.625906f, 8.149053f, 4.805788f);
			}
		}
	}
	if (!VOLUME::DOES_VOLUME_EXIST(iLocal_13))
	...
	iVar0 = ENTITY::GET_MATCHING_ENTITIES(iLocal_13, iLocal_73, 1, 1, iLocal_70, 0);
	if (iVar0 < iLocal_94)
	{
		ITEMSET::_CLEAR_ITEMSET(iLocal_73);
	...
	while (iVar1 < iVar0)
	{
		iVar2 = ITEMSET::GET_INDEXED_ITEM_IN_ITEMSET(iVar1, iLocal_73);
		iVar3 = MISC::_GET_PED_FROM_INDEXED_ITEM(iVar2);
		if (func_71(iVar3, 0))
		{
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(iVar3, false, true);
			fVar4 = 1.0f;
			func_74(iVar3, vLocal_74 + Vector(0.0f, 0.0f, ((float)iVar1 * fVar4)), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.0f, 360.0f), 2, (1 << 30));
			func_73(&iVar3, 1, 1);
...
int func_72(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_152(*uParam0, 0.0f, 0.0f, 0.0f))
	{
		return 1;
	}
	iVar1 = 0;
...
void func_74(int iParam0, Vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_151(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_151(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_151(iParam5, 32), true);
...
bool func_86(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, Vector3 vParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
bool func_88(Vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_168(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1.0f, 0))
			{
				return true;
			}
		}
...
void func_102(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_178(iParam1))
		{
			func_179(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if ((*uParam0 & 16) != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_185(1) || (*uParam0 & (1 << 13)) != 0))
				{
					func_9(uParam0, (1 << 25));
				}
			}
...
bool func_114(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_194(iParam0, !(*uParam1 & (1 << 28)) != 0, !(*uParam1 & (1 << 29)) != 0, !(*uParam1 & (1 << 30)) != 0, 0, 0))
		{
...
bool func_115(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85.0f;
	if (func_198(iParam1, !(*uParam2 & (1 << 28)) != 0, !(*uParam2 & (1 << 29)) != 0, !(*uParam2 & (1 << 30)) != 0, 0))
	{
...
bool func_120(int iParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < (float)func_201(uParam2))
	{
...
bool func_128(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_211(iParam0, iParam1, 1, 1) < 4.0f)
		{
		...
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(iVar0, &iVar5, &iVar4))
		{
			...
			else if (iVar4 == iVar5)
			{
				...
				while (iVar6 < iVar4)
				{
					...
					{
						if (func_213(iVar7, vVar1, 1) < 3.0f)
						{
		...
		case joaat("EVENT_SHOCKING_ENTITY_HOGTIED"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(iParam0, iVar4, -1.0f, -1.0f, -1.0f, -1.0f) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(iParam0, Global_35, -1.0f, -1.0f, -1.0f, -1.0f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iVar4, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					...
					{
						if (func_213(iVar4, Global_36, 1) < 7.0f)
						{
							return true;
						}
					}
...
int func_139(int iParam0, var uParam1)
{
	...
	{
		return func_222(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
void func_144(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (func_143(iParam0))
	{
...
bool func_149(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!func_7(vVar0))
	{
		PERSCHAR::_0x59C7AD6FEA2AC449(func_150(iParam0), vVar0);
	}
	if (bParam5)
	{
		iVar3 = PERSCHAR::_0x08FC896D2CB31FCC(func_150(iParam0), false);
	}
	else
	{
		iVar3 = PERSCHAR::_FORCE_SPAWN_PERSCHAR(func_150(iParam0), false);
	}
	if (!func_7(vVar0))
	{
...
void func_164(int iParam0, Vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_168(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
bool func_194(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_211(iVar0, iParam0, 1, 1) <= 4.0f)
		{
			return true;
		}
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(iParam0, Global_35, -1.0f, -1.0f, -1.0f, -1.0f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
			{
				...
				{
					if (func_213(iVar1, Global_36, 1) < 5.0f)
					{
						return true;
					}
				}
...
int func_227(int iParam0, bool bParam1)
{
	...
	if (func_254(iParam0, 32) && !bParam1)
	{
		...
		if (func_242() == -1)
		{
			if (func_254(iParam0, (1 << 11)))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_150(iParam0));
				func_256(iParam0, (1 << 11));
			}
