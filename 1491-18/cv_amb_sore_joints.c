...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			break;
		case 2:
			func_150(uParam0, 681.0845f, -1246.778f, 43.0f, 0.0f, 0.0f, 150.0f);
			break;
		default:
			return false;
	}
	func_151(uParam0, -0.0024f, 0.0058f, 0.0f, -113.79f, 1.0f, 1.0f, 2.0f, joaat("VOLCYLINDER"), -1, 1, 1, 1);
	...
	switch (func_19(uParam0))
	{
		case 19:
			...
			func_155(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_D", -1, 0, 25.0f, 1065353216 /* Float: 1f */, 1);
			break;
		case 18:
			iLocal_14 = func_153(uParam0, 17, "Ped");
			iLocal_16 = func_154(uParam0, iLocal_15, "PL_MALE_ACTION", 1);
			func_155(uParam0, iLocal_14, 2, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_I", -1, 0, 25.0f, 1065353216 /* Float: 1f */, 1);
