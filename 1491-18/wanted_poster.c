		...
		case 0:
			if (func_15())
			{
				...
				if (sLocal_5.f_7 == -630818830)
				{
					...
					sLocal_5.f_8.f_2 = joaat("DOCUMENT_BOUNTY_POSTER_CHAIN_GANG"); /* GXTEntry: "Bounty Poster - Mr Black & Mr White" */
				}
				else if (sLocal_5.f_7 == -1325774943)
				{
					...
					sLocal_5.f_8.f_2 = joaat("DOCUMENT_ARTHUR_HAS_POSTER_1"); /* GXTEntry: "Bounty Hunter\'s Letter" */
				}
				else
				{
					strcpy_s(&(sLocal_5.f_1), 32, "WANTED_BOUNTY_POSTER");
					strcpy_s(&(sLocal_5.f_18), 32, "doc_bounty_poster");
					sLocal_5.f_8.f_2 = joaat("DOCUMENT_TEST_BOUNTY_POSTER"); /* GXTEntry: "Bounty Poster" */
				}
