...
bool func_72(int iParam0, float fParam1)
{
	...
	if (!func_66(iVar0) && func_118(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(BUILTIN::FLOOR(fParam1), joaat("RARE_ORCHIDS"), 0)))
	{
		return true;
	}
	return false;
...
void func_94(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	strcpy_s(&cVar2, 32, func_171(iVar1 == 1, "ITEM_GET_PUMP" /* GXTEntry: "~1~" */, "ITEM_GET_PUMP_MULT" /* GXTEntry: "~2~x ~1~" */));
	if (iParam1 > 0)
	{
	}
	else
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_171(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD" /* GXTEntry: "Cold" */, "PMPLAYER_CONDITION_TEMPERATURE_HOT" /* GXTEntry: "Hot" */);
					}
					break;
				case 2:
					return func_171(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD" /* GXTEntry: "Good" */, "PMPLAYER_CONDITION_HONOR_BAD" /* GXTEntry: "Bad" */);
			}
			break;
		case 1:
		case 2:
