...
void func_14(int iParam0)
{
	...
	if (func_20() == -1)
	{
		...
		iVar0[2] = joaat("DOOR_TUM_02_JAIL_CELL2");
		iVar0[3] = joaat("DOOR_TUM_02_JAIL_CELL2");
		iVar0[4] = joaat("DOOR_TUM_02_JAIL_CELL3");
		iVar0[5] = joaat("DOOR_TUM_02_JAIL_CELL3");
		func_47(115, &iVar0, 6);
		func_48();
		func_49();
	}
...
{
	func_58(6, 365, iLocal_211, iParam0, iLocal_213, iLocal_214, 20, -1082130432 /* Float: -1f */, 0, 0);
	func_59(6, 1880285656, 0, 0);
	func_60(6, iLocal_212);
	func_61(6, -5506.172f, -2957.387f, -2.65f, 76.3147f);
	func_58(3, 353, iLocal_215, iParam0, iLocal_216, iLocal_218, 12, -1082130432 /* Float: -1f */, 0, 0);
	func_59(3, -460561996, 0, 0);
	func_59(3, 687453229, 0, 0);
	func_60(3, iLocal_217);
	func_61(3, -5485.011f, -2930.324f, -2.1296f, 136.731f);
	func_58(10, 352, iLocal_223, iParam0, iLocal_224, 0, 460, -1082130432 /* Float: -1f */, 0, 0);
	func_62(iParam0);
	VOLUME::_0xB469CFD9E065EB99(iLocal_223, 10117);
	func_58(9, 347, iLocal_220, iParam0, 0, 0, 2, -1082130432 /* Float: -1f */, 0, 0);
	func_63(9, 1);
	func_63(9, (1 << 14));
	func_64(9, 1);
	func_59(9, joaat("TUM_BARN_INT_DOOR_01"), 1.0f, 1);
	func_59(9, joaat("TUM_BARN_INT_DOOR_02"), -1.0f, 1);
	func_59(9, joaat("TUM_BARN_INT_DOOR_03"), 0, 0);
	func_59(9, joaat("TUM_BARN_INT_DOOR_04"), 0, 0);
}
...
char* func_186(char* sParam0, int iParam1)
{
	...
	return func_276(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}
