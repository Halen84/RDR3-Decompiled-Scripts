...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[1])
	{
		if (func_68(uParam0, 1065353216 /* Float: 1f */, 90.0f, 4, 1109393408 /* Float: 40f */, 1112014848 /* Float: 50f */))
		{
			func_66(uParam0);
			if (func_69())
			{
...
void func_132(int iParam0, Vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_150(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
