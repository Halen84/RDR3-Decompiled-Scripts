...
bool func_73(var uParam0)
{
	...
	func_152(uParam0, 0.64f, -0.72f, 0.0f, 31.68f, 3.0f, 3.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, -0.3586f, 2.5571f, 0.9955f, 76.6025f, 1.0f, 1.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	...
	func_157(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_GROUND"), 0, -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	sLocal_22 = { func_160(uParam0, 1.2363f, -0.1641f, 1.0444f, 120.96f, 7.0f, 0.629f, 0.5f) /*10*/ };
	iLocal_32 = func_161(uParam0, 0.5875f, -1.025f, 0.95f, 0.0f, 0.0f, 80.98939f, 1.1f, 1.1f, 1.38f, "Grief", joaat("VOLCYLINDER"));
	return true;
}
...
bool func_94(var uParam0)
{
	...
	{
		if (func_200(uParam0, sLocal_22, 1, 0))
		{
...
void func_389(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_423(func_105(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_424(iParam0);
