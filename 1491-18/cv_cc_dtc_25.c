...
bool func_72(var uParam0)
{
	...
	iLocal_22 = func_152(uParam0, joaat("P_CIGAR02X"), 0.0f, 0.0f, 0.0f, "CIGAR", 0, 1, 1);
	...
	sLocal_23 = { func_159(uParam0, 2.2422f, -4.2411f, 1.0206f, -0.2165f, 8.0f, 0.27f, 0.7f) /*10*/ };
	sLocal_33 = { func_159(uParam0, 2.242f, -4.241f, 1.021f, -90.25f, 8.0f, 0.3f, 0.3f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_201(uParam0, sLocal_23, 1, 1))
		{
			func_202(uParam0, iLocal_20, -1, 0.68f);
			func_189(uParam0, iLocal_20, 1);
		}
		else if (func_201(uParam0, sLocal_33, 1, 1))
		{
