...
bool func_72(var uParam0)
{
	...
	{
		case 0:
			func_149(uParam0, -1347.485f, 2407.773f, 306.0743f, 0.0f, 0.0f, 162.8f);
			break;
		default:
			return false;
	}
	func_150(uParam0, -0.5962f, 0.1022f, 1.0076f, 84.6f, 1.0f, 1.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	...
	sLocal_17 = { func_154(uParam0, -0.4469f, -0.1258f, 1.1107f, 150.84f, 7.0f, 0.6f, 0.6f) /*10*/ };
	sLocal_27 = { func_154(uParam0, -0.4469f, -0.1258f, 1.1107f, 166.32f, 10.0f, 0.8f, 0.8f) /*10*/ };
...
{
	return func_189(uParam0, sLocal_17, 1, 0);
}
...
bool func_189(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_290(sParam1, sParam1.f_6, Global_36))
	{
		return false;
	}
	if (func_290(sParam1, sParam1.f_3, Global_36))
	{
		return false;
	}
	if (bParam12)
...
void func_198(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_299(100.0f, 140.0f);
			}
		}
...
bool func_290(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5, struct<2> /*16*/ sParam6, var uParam8)
{
