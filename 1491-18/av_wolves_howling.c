...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_47(uParam0, 1, "WHP_WOLF_2", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 2.0f, 0.5f, 0.0f), (45.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 2, "WHP_WOLF_3", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 4.0f, 3.5f, 0.0f), (120.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				iLocal_12[0] = func_65(joaat("WORLD_ANIMAL_WOLF_HOWLING_SITTING"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, 0, 0);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				iLocal_12[1] = func_65(joaat("WORLD_ANIMAL_WOLF_SNIFFING_GROUND"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, 0, 0);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
			{
				...
				iLocal_12[2] = func_65(joaat("WORLD_ANIMAL_WOLF_EATING"), uParam0->f_20[2 /*14*/].f_5, uParam0->f_20[2 /*14*/].f_8, 0, 0, 0);
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[2 /*14*/], iLocal_12[2], 0, 0, false, true, 0, false, -1.0f, false);
		...
		case 1:
			if (func_67(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				...
				TASK::REACT_LOOK_AT(uParam0->f_20[0 /*14*/], Global_35, 1, 1, 15.0f, 1, 0, 0, 0);
				TASK::REACT_LOOK_AT(uParam0->f_20[1 /*14*/], Global_35, 1, 1, 15.0f, 1, 0, 0, 0);
				func_68(&uLocal_19);
				iLocal_11 = 3;
			}
			break;
		case 3:
			if (!func_69(uParam0->f_20[2 /*14*/], joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")))
			{
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(uParam0->f_20[2 /*14*/], Global_35, 0, -1.0f, -1.0f, -1.0f);
			}
			if (func_70(uParam0->f_20[0 /*14*/], Global_35, 1) < 324.0f || func_71(&uLocal_19, 12.5f))
			{
			...
			break;
		case 4:
			if (func_73(uParam0) || func_71(&uLocal_16, 5.0f))
			{
				return 1;
			}
			break;
...
bool func_73(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
		{
			if (PED::IS_PED_USING_THIS_SCENARIO(uParam0->f_20[iVar0 /*14*/], iLocal_12[iVar0]))
			{
				return false;
			}
		}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if ((*uParam0 & 16) != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_174(1) || (*uParam0 & (1 << 13)) != 0))
				{
					func_9(uParam0, (1 << 25));
				}
			}
...
bool func_134(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_183(iParam0, !(*uParam1 & (1 << 28)) != 0, !(*uParam1 & (1 << 29)) != 0, !(*uParam1 & (1 << 30)) != 0, 0, 0))
		{
...
bool func_135(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85.0f;
	if (func_187(iParam1, !(*uParam2 & (1 << 28)) != 0, !(*uParam2 & (1 << 29)) != 0, !(*uParam2 & (1 << 30)) != 0, 0))
	{
...
bool func_140(int iParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < (float)func_190(uParam2))
	{
...
bool func_148(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_200(iParam0, iParam1, 1, 1) < 4.0f)
		{
...
bool func_183(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_200(iVar0, iParam0, 1, 1) <= 4.0f)
		{
			return true;
		}
	}
