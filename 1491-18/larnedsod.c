...
void __SCRIPT()
{
	...
	fLocal_7 = 1.0f;
	fLocal_8 = 1.0f;
	vLocal_26 = { 905.7465f, 269.0549f, 115.0637f /*3*/ };
	iLocal_30 = 20000;
		...
		if (MISC::GET_GAME_TIMER() > iLocal_32)
		{
			...
			switch (iLocal_31)
			{
				...
				case 1:
					...
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_33));
				...
				case 6:
					if (func_7(func_6(iLocal_33)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_33 /*35*/].f_11 > 0.0f)
							{
								PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1888801[iLocal_33 /*35*/].f_11);
							}
							Jump @804; // curOff = 785
							func_42(iVar0);
							iVar0 = (1 + iVar0);
						...
						{
							PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1888801[iLocal_33 /*35*/].f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
void func_5(int iParam0)
{
	...
	func_46(-327351684, 1, -1.0f, 1, 1, 0, 0, 0);
	func_46(406215150, 1, 1.0f, 1, 1, 0, 0, 0);
...
bool func_11()
{
	iLocal_14 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(894.7135f, 260.2712f, 129.5878f, 0.0f, 0.0f, -0.492423f, 88.10741f, 65.87466f, 39.61107f, "Larned Sod - m_volTown");
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		iLocal_16 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Larned Sod - m_volTenantOwner_Threat Agg");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 901.97f, 261.5441f, 115.7395f, 0.0f, 0.0f, -0.825771f, 12.77186f, 7.290863f, 4.182421f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 886.826f, 258.2958f, 120.034f, 0.0f, 0.0f, 0.0f, 6.865234f, 13.71682f, 18.96277f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 887.2566f, 258.3552f, 121.8763f, 0.0f, 0.0f, -0.580099f, 4.594322f, 6.421996f, 6.34872f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 889.3727f, 250.7424f, 120.034f, 0.0f, 0.0f, -71.9487f, 5.361883f, 5.311553f, 18.96277f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 884.868f, 250.9919f, 120.034f, 0.0f, 0.0f, -31.54634f, 3.975522f, 1.561551f, 18.96277f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 886.9943f, 250.5041f, 120.034f, 0.0f, 0.0f, -51.34731f, 3.201982f, 2.32918f, 18.96277f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, 943.6283f, 240.538f, 120.034f, 0.0f, 0.0f, 36.22269f, 2.583991f, 1.168234f, 18.96277f);
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 899.733f, 262.0444f, 121.8763f, 0.0f, 0.0f, -8.182039f, 26.6654f, 26.8703f, 20.0f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_15, 943.883f, 240.5778f, 121.8763f, 0.0f, 0.0f, -8.182041f, 4.201227f, 4.104132f, 20.0f);
		iLocal_17 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Larned Sod - m_volTenantOwner_Warning Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_17, iLocal_15);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 895.8494f, 261.3904f, 121.8763f, 0.0f, 0.0f, -8.182039f, 38.88291f, 38.47965f, 20.0f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, 940.5317f, 241.0733f, 121.8763f, 0.0f, 0.0f, -8.182038f, 10.83869f, 7.036053f, 20.0f);
		iLocal_18 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Larned Sod - m_volTenantOwner_Registration Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_18, iLocal_17);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, 895.8494f, 261.3904f, 121.8763f, 0.0f, 0.0f, -8.182039f, 46.9045f, 46.40221f, 20.0f);
		sLocal_19 = "LARNED_SOD";
		LAW::_CREATE_GUARD_ZONE(sLocal_19);
		LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_START(sLocal_19, iLocal_18);
		LAW::_SET_GUARD_ZONE_VOLUME_RESTRICTED(sLocal_19, iLocal_15);
		LAW::_SET_GUARD_ZONE_VOLUME_THREAT(sLocal_19, iLocal_16);
		LAW::_SET_GUARD_ZONE_VOLUME_WARNING(sLocal_19, iLocal_17);
		LAW::_SET_GUARD_ZONE_POSITION(sLocal_19, 901.2f, 262.7f, 116.4f);
		LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_END(sLocal_19, iLocal_14);
	}
	return true;
}
...
void func_28(int iParam0)
{
	...
	if (!func_53(iVar1, 0))
	{
		...
		PED::SET_PED_OWNS_ANIMAL(func_52(iVar0), func_52(735), false);
	}
}
...
void func_39(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0.0f, 0.0f, 0.0f) <= 5.0f || func_62(Global_1935630, (1 << 14))) || func_62(Global_1935630, (1 << 23)))
	{
		return;
	}
...
void func_46(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_47(iParam0, 0, 0);
	if (func_87(iParam0))
	{
		...
		if (bParam3)
		{
			func_88(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_61()
{
	...
	if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(iVar0))
	{
		if (!TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(joaat("RANCHES_PLAYER_USABLE")))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(joaat("RANCHES_PLAYER_USABLE"), true);
		}
	}
	else if (PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar0))
	{
		if (!TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(joaat("RANCHES_PLAYER_USABLE")))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(joaat("RANCHES_PLAYER_USABLE"), true);
	...
	else if (TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(joaat("RANCHES_PLAYER_USABLE")))
	{
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_57(iParam0) && func_86(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
...
void func_88(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (func_87(iParam0))
	{
	...
	if (STREAMING::HAS_NAMED_PTFX_ASSET_LOADED(joaat("SCR_DISTANCE_SMOKE")))
	{
		if (!func_147(uParam0->f_1, 8))
		{
			if (!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(*uParam0))
			{
				...
				uParam0->f_5 /= 255.0f;
				*uParam0 = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD(sVar0, vParam1, 0.0f, 0.0f, 0.0f, func_154(iParam4), false, false, false, false);
				uParam0->f_4 = MISC::GET_FRAME_COUNT();
				if (func_155(vParam1, 1) > (CAM::GET_GAMEPLAY_CAM_FOV() + 15.0f))
				{
...
char* func_119(char* sParam0, int iParam1)
{
	...
	return func_166(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}
...
void func_136(int iParam0)
{
	...
	func_174(iParam0, (1 << 13));
	func_174(iParam0, (1 << 14));
	func_174(iParam0, (1 << 15));
	func_174(iParam0, (1 << 17));
	func_174(iParam0, (1 << 24));
	func_174(iParam0, (1 << 19));
	func_174(iParam0, (1 << 20));
...
void func_149(var uParam0, Vector3 vParam1, int iParam4, float fParam5)
{
	...
	else
	{
		...
		fVar2 = func_187(0.0f, fVar1, fVar0);
	}
...
float func_155(Vector3 vParam0, bool bParam3)
{
	...
	vVar0 = { func_189(0) /*3*/ };
	vVar3 = { func_190(vParam0 - CAM::GET_GAMEPLAY_CAM_COORD()) /*3*/ };
	if (bParam3)
	{
...
void func_177(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_204(iParam0, (1 << 10)))
		{
			func_205(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_204(iParam0, (1 << 10)))
	{
		func_206(iParam0, (1 << 10));
		INVENTORY::_0x9B4E793B1CB6550A();
	}
	func_207(iParam0);
}
...
float func_186(float fParam0, int iParam1)
{
	...
	fVar0 = (2.0f * BUILTIN::SIN((180.0f * (fParam0 / func_151(iParam1)))));
	if (fVar0 < 0.0f)
	{
		return 0.0f;
	}
...
bool func_196(Vector3 vParam0, int iParam3)
{
	...
	func_211(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_212(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
