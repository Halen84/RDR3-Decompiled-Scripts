					...
					if (!func_20(uParam0))
					{
						if (func_11(*uParam0, 16))
						{
							...
							else
							{
								...
								func_87(MISC::VAR_STRING(2, "DISCO_DC_FOUND" /* GXTEntry: "~1~ of ~2~ Found" */, iVar0, 20));
							}
		...
		case 12:
			...
			else if (*uParam0 == joaat("DISCOVER_LOC_DREAMCATCHERS"))
			{
				...
				if (!func_94())
				{
					...
					func_87(MISC::VAR_STRING(2, "DISCO_DC_FOUND" /* GXTEntry: "~1~ of ~2~ Found" */, iVar1, 20));
					func_71(uParam0);
					func_37(1, -1);
					func_57(&sLocal_24, 13, 1);
				}
...
void func_28(var uParam0)
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == joaat("DISCOVER_LOC_GRAVE_ARTHUR"))
		{
			if (func_53(*uParam0))
			{
				uParam0->f_6.f_8 = func_113("DISCO_FOCUS" /* GXTEntry: "View" */, joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
				func_34(uParam0->f_6.f_8, 0, 1);
			}
			else
			{
				uParam0->f_6.f_8 = func_113("DISCO_EXAMINE" /* GXTEntry: "Inspect" */, joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
			}
		}
		else if (*uParam0 == joaat("DISCOVER_LOC_GRAVE"))
		{
		...
		else if (*uParam0 == joaat("DISCOVER_LOC_BRAITHWAITES_SECRET"))
		{
			...
			{
				uParam0->f_6.f_8 = func_113("DISCO_EXAMINE" /* GXTEntry: "Inspect" */, joaat("INPUT_CONTEXT_Y"), Global_35, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("PLAYER_FOCUS_TIMING"), 0, 0);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_113("DISCO_EXAMINE" /* GXTEntry: "Inspect" */, joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("PLAYER_FOCUS_TIMING"), 0, 0);
		}
...
bool func_72(var uParam0)
{
	...
	switch (iLocal_65)
	{
		...
		case 2:
			...
			{
				iLocal_63 = func_113("GENERIC_USE" /* GXTEntry: "Use" */, joaat("INPUT_CONTEXT_X"), Global_35, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
				func_115(iLocal_63);
				func_178(3, 1);
			}
			break;
		case 3:
			func_30(uParam0, iLocal_63, "PLUNGER" /* GXTEntry: "Plunger" */, 0);
			if (func_14(Global_35, func_76(uParam0, 0), 1) > (1.6f + 1.0f))
			{
				func_104(&iLocal_63, 1, 1);
				func_178(1, 1);
...
bool func_75(var uParam0)
{
	...
	switch (iLocal_65)
	{
		...
		case 2:
			...
			{
				if (func_188(Global_35, func_13(uParam0, uParam0->f_4), (func_187(uParam0, uParam0->f_4) + 55.0f), 1065353216 /* Float: 1f */))
				{
					bLocal_23 = false;
					if (func_20(uParam0))
					{
						iLocal_63 = func_189("DISCO_PUSH" /* GXTEntry: "Push" */, joaat("INPUT_CONTEXT_Y"), func_13(uParam0, uParam0->f_4), 2.0f, 2, 0, 0, 5, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0);
					}
					func_178(4, 1);
				}
				else
		...
		case 3:
			...
			else if (func_188(Global_35, func_13(uParam0, uParam0->f_4), (func_187(uParam0, uParam0->f_4) + 55.0f), 1065353216 /* Float: 1f */))
			{
				func_104(&iLocal_63, 1, 1);
				func_178(2, 1);
			}
...
void func_87(char* sParam0)
{
	...
	func_208(MISC::VAR_STRING(2, "DISCO_DREAM" /* GXTEntry: "Dreamcatchers" */), sParam0, joaat("HUD_TOASTS"), joaat("TOAST_DREAMCATCHER"), joaat("PLAYER_MENU"), MISC::VAR_STRING(2, "COL_CTX_PLAYER_LOG" /* GXTEntry: "Hold ~INPUT_FEED_INTERACT~ for details" */), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
int func_113(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_235(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_236(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
bool func_126()
{
	...
	if (!func_238(joaat("DOCUMENT_PLAYER_JOURNAL") /* GXTEntry: "Journal" */, 1, 0))
	{
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_252(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS" /* GXTEntry: "+" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_252(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT" /* GXTEntry: "+" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_252(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG" /* GXTEntry: "~COLOR_RED~-~s~" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_252(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT" /* GXTEntry: "~COLOR_RED~-~s~" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
bool func_231(bool bParam0)
{
	if (PED::IS_PED_CARRYING_SOMETHING(Global_35) && !Global_1392040.f_2)
	{
		if (bParam0)
		{
			func_289("ITEM_UNUSABLE_CARRYING" /* GXTEntry: "Cannot use this item while carrying something." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	return true;
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_471(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD" /* GXTEntry: "Cold" */, "PMPLAYER_CONDITION_TEMPERATURE_HOT" /* GXTEntry: "Hot" */);
					}
					break;
				case 2:
					return func_471(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD" /* GXTEntry: "Good" */, "PMPLAYER_CONDITION_HONOR_BAD" /* GXTEntry: "Bad" */);
			}
			break;
		case 1:
		case 2:
