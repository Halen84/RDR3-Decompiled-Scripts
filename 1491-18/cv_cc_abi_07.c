...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.3f, 0.8f, 0.4f, -12.0f, 3.75f, 2.5f, 2.0f, joaat("VOLBOX"), 1);
	func_152(uParam0, -0.95f, -1.85f, 0.0f, 0.0f, 3.8f, 7.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	...
	func_159(uParam0, 15.0f, 20.0f);
	sLocal_22 = { func_160(uParam0, 1.0f, -1.2f, 0.84f, -11.0f, 6.0f, 0.2f, 0.2f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		PED::GET_PED_CURRENT_MOVE_BLEND_RATIO(Global_35, &fVar0, &fVar1);
		if (func_201(uParam0, sLocal_22, 1, 0) && (fVar0 < 0.8f && fVar1 < 0.8f))
		{
...
bool func_193(struct<2> /*16*/ sParam0, float fParam2, struct<2> /*16*/ sParam3, float fParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
bool func_201(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_193(sParam1, sParam1.f_6, Global_36))
	{
		return false;
	}
	if (func_193(sParam1, sParam1.f_3, Global_36))
	{
		return false;
	}
	if (bParam12)
