				...
				case 6:
					if (func_7(func_6(iLocal_23)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_23 /*35*/].f_11 > 0.0f)
							{
...
bool func_11()
{
	iLocal_14 = VOLUME::CREATE_VOLUME_CYLINDER(1324.004f, -2287.084f, 50.711f, 0.0f, 0.0f, 0.0f, 57.0f, 50.0f, 20.0f);
	iLocal_15 = VOLUME::CREATE_VOLUME_SPHERE(1322.59f, -2285.19f, 51.316f, 0.0f, 0.0f, 0.0f, 0.25f, 0.25f, 0.25f);
	PED::_ADD_SCENARIO_BLOCKING_VOLUME(iLocal_15, false, 16);
	return true;
}
...
bool func_38(int iParam0)
{
	...
	if (!func_59(joaat("DOCUMENT_LETTER_CATFISH_LOANSHARKING") /* GXTEntry: "Letter to Nate from Momma" */, 1, 0))
	{
		if (!func_60(4))
		{
			if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_16))
			{
				...
				{
					iLocal_17 = TASK::GET_PROP_FOR_SCENARIO_POINT(iLocal_16, "PrimaryItem");
				...
				{
					if (DECORATOR::DECOR_SET_INT(iLocal_18, "letter_item", joaat("DOCUMENT_LETTER_CATFISH_LOANSHARKING") /* GXTEntry: "Letter to Nate from Momma" */))
					{
...
void func_39(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0.0f, 0.0f, 0.0f) <= 5.0f || func_66(Global_1935630, (1 << 14))) || func_66(Global_1935630, (1 << 23)))
	{
		return;
	}
...
void func_64()
{
	...
	if (func_103(2, 2))
	{
		...
		if (iVar6 > 2 || func_124(2, 2))
		{
			...
			if (!GRAPHICS::_IS_PROXY_INTERIOR_INDEX_ARTIFICIAL_LIGHTS_ENABLED(iVar9))
			{
				return;
			}
			GRAPHICS::_SET_PROXY_INTERIOR_INDEX_ARTIFICIAL_LIGHTS_STATE(iVar9, false);
		}
		else
		{
			...
			if (!GRAPHICS::_IS_PROXY_INTERIOR_INDEX_ARTIFICIAL_LIGHTS_ENABLED(iVar10))
			{
				return;
			}
			GRAPHICS::_SET_PROXY_INTERIOR_INDEX_ARTIFICIAL_LIGHTS_STATE(iVar10, false);
		}
	}
	else
	{
	...
	if ((!func_59(joaat("DOCUMENT_LETTER_CATFISH_LOANSHARKING") /* GXTEntry: "Letter to Nate from Momma" */, 1, 0) && (!func_132() || (!func_103(2, 16) && !func_104(2)))) && !func_103(2, 2))
	{
		iLocal_16 = TASK::CREATE_SCENARIO_POINT_HASH(joaat("WORLD_PLAYER_INSPECT_LETTER_80CM_PAPER_W15_1_H24_FOLDVERTICAL_P_CS_LETTER03X"), 1320.37f, -2274.06f, 49.53f, 7.859f, 0.0f, 0.0f, false);
	}
	else
	{
		func_61(4);
...
bool func_68()
{
	return func_66(Global_1935630, (1 << 12));
}
...
void func_73(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_57(iParam0) && func_90(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
...
void func_85(int iParam0)
{
	...
	if (func_103(2, 2) && !func_124(2, 2))
	{
		...
		GRAPHICS::_SET_PROXY_INTERIOR_INDEX_ARTIFICIAL_LIGHTS_STATE(iVar0, false);
		func_165(2);
	}
	func_166(2, 4);
	func_166(2, 32);
...
int func_96(int iParam0, bool bParam1)
{
	...
	if (func_171(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			if (func_171(iParam0, (1 << 11)))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_175(iParam0));
				func_176(iParam0, (1 << 11));
			}
...
void func_109(int iParam0, int iParam1)
{
	...
	Global_40.f_9422[iParam0 /*7*/].f_5 |= iParam1;
}
...
bool func_115(int iParam0, int iParam1)
{
	...
	if (func_189("ALL WEAPONS", &iVar1, &iVar2, joaat("SLOTID_NONE"), 0))
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_190(&sVar4, iVar3, iVar1, iVar2))
			{
			}
			else if (!func_191(sVar4.f_4))
			{
			}
...
int func_116(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_194(bParam2), iParam0, false);
	return iVar2;
}
...
char* func_150(char* sParam0, int iParam1)
{
	...
	return func_204(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_151(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_155(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_167(int iParam0)
{
	...
	func_211(iParam0, (1 << 14));
	func_211(iParam0, (1 << 15));
	func_211(iParam0, (1 << 17));
	func_211(iParam0, (1 << 24));
	func_211(iParam0, (1 << 19));
	func_211(iParam0, (1 << 20));
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_194(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
void func_196(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar4 += func_241(iVar0, iVar1);
		iVar3--;
		iVar0 = BUILTIN::ROUND(func_242(BUILTIN::TO_FLOAT(iVar0 + 1), 0.0f, 12.0f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
bool func_198(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_226(iVar0) && func_245(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_214(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		{
			func_254(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_253(iParam0, (1 << 10)))
	{
...
int func_222(struct<2> /*16*/ sParam0, var uParam2)
{
	int iVar0;
...
struct<4> /*32*/ func_233(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_262(joaat("CARRIED_WEAPONS"), func_261(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_262(joaat("CARRIED_WEAPONS"), func_261(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_262(joaat("CARRIED_WEAPONS"), func_261(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_194(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_247(Vector3 vParam0, int iParam3)
{
	...
	func_267(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_268(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
struct<4> /*32*/ func_262(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_194(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}
