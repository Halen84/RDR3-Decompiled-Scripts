	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				if (*uParam0 == 45)
				{
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[0 /*14*/], joaat("WEAPON_RIFLE_VARMINT") /* GXTEntry: "Varmint Rifle" */, 5000, true, false, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), true, 0.0f, false);
					WEAPON::SET_CURRENT_PED_WEAPON(uParam0->f_20[0 /*14*/], joaat("WEAPON_RIFLE_VARMINT") /* GXTEntry: "Varmint Rifle" */, true, 0, false, false);
		...
		case 3:
			if (!uParam0->f_469[2])
			{
				if (func_71(uParam0, 1065353216 /* Float: 1f */, 105.0f, 4, joaat("ACTION"), 0))
				{
...
void func_70(var uParam0)
{
	...
	PED::_SET_PED_DESIRED_LOCO_MOTION_TYPE(uParam0->f_20[1 /*14*/], "default" /* GXTEntry: "_" */);
