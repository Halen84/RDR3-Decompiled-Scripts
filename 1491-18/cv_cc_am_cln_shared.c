...
void func_5(var uParam0, struct<6> /*48*/ sParam1)
{
	...
	*uParam0 = sParam1.f_1;
	...
	uParam0->f_1 = func_23();
	uParam0->f_29 = { func_24(uParam0->f_2) /*3*/ };
...
void func_58(var uParam0, int iParam1, bool bParam2)
{
	...
	{
		case 1:
			if (!func_119(&(uParam0->f_107[iParam1 /*113*/].f_32.f_56)) || func_120(&(uParam0->f_107[iParam1 /*113*/].f_32.f_56)) > 1.0f)
			{
				...
				{
					func_122(&(uParam0->f_107[iParam1 /*113*/].f_32.f_56), 0.0f);
				}
			}
			if (!func_119(&(uParam0->f_1693)) || func_120(&(uParam0->f_1693)) > 1.0f)
			{
				if (func_123())
				{
					iVar3 = joaat("ARTHUR");
...
bool func_77(var uParam0)
{
	...
	switch (func_159(uParam0))
	{
		case 1:
			...
			vLocal_98 = { func_161(113) /*3*/ };
			vLocal_101 = { func_162(113) /*3*/ };
			break;
		case 2:
			func_160(uParam0, 100, 0, 0, 0);
			vLocal_98 = { func_161(50) /*3*/ };
			vLocal_101 = { func_162(50) /*3*/ };
			break;
	}
	iLocal_18 = func_163(uParam0, 19, 0);
	func_164(uParam0, -0.96f, -3.36f, 0.0f, -111.15f, 5.0f, 5.0f, 5.0f, joaat("VOLCYLINDER"), 1);
	func_165(uParam0, -2.23f, -4.41f, 0.0f, 0.0f, 3.5f, 3.5f, 5.0f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_165(uParam0, 0.16f, -0.4f, 0.0f, -109.8f, 3.5f, 3.5f, 5.0f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_166(uParam0, joaat("P_CS_BILLSINGLE01BX"), 0.0f, 0.0f, 0.0f, "BILL01", 0, 1, 1);
	func_166(uParam0, joaat("P_CS_BILLSINGLE01BX"), 0.0f, 0.0f, 0.0f, "BILL02", 0, 1, 1);
	func_166(uParam0, joaat("P_CS_BILLSINGLE01BX"), 0.0f, 0.0f, 0.0f, "BILL03", 0, 1, 1);
...
bool func_98(var uParam0)
{
	...
	if (func_216(uParam0, iLocal_21))
	{
		...
		func_220(0);
		if (func_221(joaat("CSTAG_PLAYER_DIRTY"), 1))
		{
			func_222(joaat("CSTAG_PLAYER_DIRTY"), 1, 0);
		}
		PED::_0xFD8E853F0BC2E942(Global_35, 0.0f);
		ATTRIBUTE::SET_ATTRIBUTE_POINTS(Global_35, 22, 0);
		PED::_SET_PED_DIRT_CLEANED(Global_35, 0.0f, -1, true, true);
		PED::_0xD049920CD29F6CC8(Global_35, 0.0f, -1, 1, 1);
...
void func_109(Vector3 vParam0, int iParam3)
{
	...
	while (iVar0 < Global_1911670)
	{
		...
		if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(iVar1))
		{
			...
			if (func_239(vVar2, vParam0, 2.0f, 1))
			{
...
int func_118(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_131(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_240(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000.0f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_242(iParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_243(iParam0, 0));
...
void func_137(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_258(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_260(iParam0) < 10000.0f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_154(var uParam0)
{
	...
	if (func_266(Global_1935630, (1 << 14)))
	{
		return true;
	}
	if (func_267(2))
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_273(uParam0->f_107[iVar0 /*113*/].f_1, (1 << 11)))
			{
				return true;
			}
...
{
	uParam0->f_23 = { func_161(iParam1) + Vector(fParam4, fParam3, fParam2) /*3*/ };
	uParam0->f_26 = { func_162(iParam1) /*3*/ };
}
...
int func_164(var uParam0, Vector3 vParam1, float fParam4, Vector3 vParam5, int iParam8, bool bParam9)
{
	...
	if (bParam9)
	{
		vParam1 = { func_281(uParam0, vParam1) /*3*/ };
	...
	while (iVar0 < uParam0->f_33)
	{
		if (!VOLUME::DOES_VOLUME_EXIST(uParam0->f_33[iVar0]))
		{
			uParam0->f_33[iVar0] = VOLUME::_CREATE_VOLUME_BY_HASH_WITH_CUSTOM_NAME(iParam8, vParam1, 0.0f, 0.0f, fParam4, vParam5, "volBlockContent");
			return iVar0;
		}
		iVar0++;
	}
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_287(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_301(uParam0->f_107[iVar12 /*113*/].f_1));
				}
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_241(uParam0->f_107[iVar12 /*113*/].f_7, 1));
				}
			}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0 /*15*/].f_5 && !ENTITY::DOES_ENTITY_EXIST(uParam0->f_1711[iVar0 /*15*/].f_10))
			{
				...
				{
					vVar3 = { func_281(uParam0, uParam0->f_1711[iVar0 /*15*/].f_1) /*3*/ };
				}
				else
				{
...
void func_198(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_281(uParam0, uParam0->f_1976.f_1), 1, func_282(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
void func_202(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_321(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iVar2 /*113*/].f_5, true, false));
				iVar1 = func_321(uParam0->f_107[iVar2 /*113*/].f_96);
				if (iVar0 | iVar1)
				{
...
bool func_205(var uParam0, var uParam1)
{
	...
	if (!func_304(uParam0, uParam1, 1) || !func_305(uParam0, uParam1, 1))
	{
		if (uParam1->f_9)
		{
			if (!func_108(iVar0, joaat("SCRIPT_TASK_PERSISTENT_CHARACTER")))
			{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0 /*113*/].f_32.f_32 > -1)
			{
				...
				func_331(uParam0->f_107[iVar0 /*113*/].f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
...
bool func_216(var uParam0, int iParam1)
{
	...
	if (func_342(uParam0, iParam1, 1.0f))
	{
		return true;
	}
...
bool func_217(var uParam0)
{
	...
	if (func_343(*uParam0, joaat("HATS"), 0))
	{
		return true;
	}
	return false;
...
void func_218()
{
	func_344(joaat("MPC_HIDE_ACTION_HAT"), Global_35, 0, 1);
}
...
void func_223()
{
	func_347(Global_35, joaat("MPC_HIDE_ACTION_HAT"), 1);
}
...
void func_229(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_342(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
bool func_272(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_366(iVar0) && func_367(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
int func_277()
{
	...
	if (func_221(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_278()
{
	...
	if (func_221(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
bool func_298(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1 /*15*/].f_5)
		{
			...
			{
				vVar2 = { func_281(uParam0, uParam0->f_1711[iVar1 /*15*/].f_1) /*3*/ };
			}
			else
			{
...
bool func_304(var uParam0, var uParam1, bool bParam2)
{
	...
	if (!bVar1)
	{
		if (BUILTIN::VDIST2(Global_36, func_387(func_159(uParam0))) <= 4.0f)
		{
			func_51(uParam0, "Walk and talk - Player is near the tithing box / ledger", iVar0, -1);
			return false;
		}
		if (BUILTIN::VDIST2(Global_36, func_388(func_159(uParam0))) <= 4.0f)
		{
...
void func_308(var uParam0, int iParam1)
{
	...
	else if (!func_108(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
	{
...
bool func_309(var uParam0, int iParam1, Vector3 vParam2)
{
	...
	if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(uParam0->f_107[iParam1 /*113*/].f_3, vParam2, true))
	{
		...
		{
			func_122(&(uParam0->f_107[iParam1 /*113*/].f_109), 0.0f);
		}
	}
	else
	{
...
bool func_310(var uParam0, int iParam1, Vector3 vParam2)
{
	...
	if (ENTITY::IS_ENTITY_OCCLUDED(uParam0->f_107[iParam1 /*113*/].f_5))
	{
		...
		{
			func_122(&(uParam0->f_107[iParam1 /*113*/].f_106), 0.0f);
		}
	}
	else
	{
...
int func_320(int iParam0, struct<8> /*64*/ sParam1, int iParam9)
{
	int iVar0;
	var uVar1;
...
void func_333(var uParam0, var uParam1)
{
	...
	func_399(Global_35, iVar0, &sVar1, 0.0f, 0.0f, 0.0f, 0, 0, 1, 1069547520 /* Float: 1.5f */, -1082130432 /* Float: -1f */, 1073069561, 1056964608 /* Float: 0.5f */, 1092616192 /* Float: 10f */, -1, 1, 0, 0, 0, 1);
	func_233(1);
}
...
void func_334(var uParam0, var uParam1)
{
	...
	sVar1.f_19 = -1;
	sVar1.f_26 = -1082130432;
	func_400(iVar0, Global_35, &sVar1, -1082130432 /* Float: -1f */, 0, 0, uParam1->f_4, uParam1->f_5, 1, uParam1->f_26, 0, 0, 1069547520 /* Float: 1.5f */, (1 << 30), 1050253722 /* Float: 0.3f */, 1067030938 /* Float: 1.2f */, 0, 0, -1, 1, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1);
}
		...
		else
		{
			...
			if (fVar3 < uParam1->f_54[iVar1 /*6*/].f_3)
			{
				if (PED::IS_PED_HEADING_TOWARDS_POSITION(Global_35, ENTITY::GET_ENTITY_COORDS(iVar2, true, false), uParam1->f_54[iVar1 /*6*/].f_5))
				{
					...
					fVar0 = func_406(func_405(fVar6, fVar0), 0.0f);
				}
			}
		}
		iVar1++;
	...
	switch (uParam1->f_47.f_1)
	{
		case 0:
			if (func_407(uParam0, uParam1))
			{
				...
				if (uParam0->f_2 == 456)
				{
					func_408(Global_35, "WNT_INTERRUPT_NAGGED", joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), iVar0, 1, 0, 5, 1);
					func_409(uParam1, 2);
					return;
				}
				func_408(Global_35, func_410(uParam0, uParam1), joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), iVar0, 1, 0, 0, 1);
				func_122(&(uParam1->f_47.f_4), 0.0f);
				func_409(uParam1, 1);
			}
			break;
		case 1:
		...
		case 2:
			if (!AUDIO::IS_ANY_SPEECH_PLAYING(Global_35))
			{
				...
				func_408(iVar0, func_415(uParam0, uParam1), joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), Global_35, 1, 0, 0, 1);
...
bool func_349(var uParam0, int iParam1)
{
	...
	{
		if (!func_108(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_ANY")))
		{
			return true;
		}
	}
...
void func_350(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_425(100.0f, 140.0f);
			}
		}
...
bool func_351(var uParam0, int iParam1)
{
	...
	{
		func_122(&(uParam0->f_107[iParam1 /*113*/].f_32.f_52), 0.0f);
	}
...
bool func_353(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((Global_1898164.f_163 && !func_429(iParam0, 1)) || func_430((1 << 15)))
	{
		if (!func_429(iParam0, (1 << 18)) || !Global_1905944.f_5696)
		{
			return false;
		}
	}
...
void func_355(int iParam0)
{
	...
	sVar0 = { func_433(joaat("CAREER_CASH")) /*2*/ };
...
void func_356(int iParam0, char* sParam1, int iParam2)
{
	...
	func_434(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 1, joaat("COLOR_RED"), 0, 0, 0, 1);
}
...
int func_376(Vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	Vector3 vVar2;
		...
		else if (func_20(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_452(&iVar2, func_451(iVar3)))
					{
...
int func_381(int iParam0, bool bParam1)
{
	...
	if (func_139(iParam0, 32) && !bParam1)
	{
		...
		if (func_252() == -1)
		{
			if (func_139(iParam0, (1 << 11)))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_145(iParam0));
				func_141(iParam0, (1 << 11));
			}
...
void func_393(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_460(iParam1))
		{
			func_461(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_399(int iParam0, bool bParam1, var uParam2, Vector3 vParam3, char* sParam6, int iParam7, int iParam8, float fParam9, float fParam10, float fParam11, float fParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	struct<10> /*80*/ sVar0;
	struct<10> /*80*/ sVar11;
	...
	else if (!func_465(vParam3, 0.0f, 0.0f, 0.0f))
	{
		sVar11.f_0 = 0;
	...
	if (bParam19)
	{
		func_466(iParam0, bParam1, iParam14);
	}
}

void func_400(int iParam0, bool bParam1, var uParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, bool bParam8, int iParam9, float fParam10, float fParam11, float fParam12, float fParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	struct<7> /*56*/ sVar0;
	...
	if (bParam22)
	{
		func_466(iParam0, bParam1, iParam18);
	}
}
...
bool func_407(var uParam0, var uParam1)
{
	...
	if (!func_413(uParam1->f_47.f_3))
	{
		uParam1->f_47.f_3 = func_468("INTERACT_WNT_DISMISS" /* GXTEntry: "Not Now" */, joaat("INPUT_INTERACT_LOCKON_NEG"), iVar0, 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		func_469(uParam1->f_47.f_3, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(iVar0), 0, 1);
	}
	if (AUDIO::IS_ANY_SPEECH_PLAYING(Global_35))
	{
...
int func_411(var uParam0)
{
	...
	return (func_476() - BUILTIN::ROUND((uParam0->f_1 * 1000.0f)));
}
...
bool func_428(int iParam0)
{
	...
	if (!func_429(iParam0, (1 << 16)) && !func_429(iParam0, (1 << 15)))
	{
		return false;
	}
	iVar0 = 0;
	while (iVar0 < Global_40.f_7756)
	{
		if (Global_40.f_7756[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			if (iVar2 < 1800 && func_429(iParam0, (1 << 15)))
			{
				return true;
			}
		}
...
struct<2> /*16*/ func_433(int iParam0)
{
	struct<2> /*16*/ sVar0;
...
int func_434(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)
{
	struct<4> /*32*/ sVar0;
	struct<7> /*56*/ sVar13;
	int iVar20;
...
bool func_450(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_273(iParam0, (1 << 31)))
	{
		return true;
	}
	if (func_273(iParam0, (1 << 30)))
	{
		return true;
	}
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_508(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, (1 << 30));
			}
			else if (bParam16)
			{
...
int func_468(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 48)
	{
		if (func_520(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_521(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
char* func_475(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7)
{
...
int func_481(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	func_533(&(Global_1946054.f_1497), iParam0, 1, iParam1, 1, bParam3, 1);
	return 1;
}
...
bool func_483(int iParam0)
{
	...
	while (iVar1 < 39)
	{
		if (func_535(iVar1, Global_1946054.f_2535.f_43[iVar0 /*2*/].f_1))
		{
			func_536(iVar1, Global_1946054.f_2535.f_43[iVar0 /*2*/].f_1);
		}
		iVar1++;
	}
...
int func_490(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_541(fVar9) /*3*/ };
			vVar13 = { func_542(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) /*3*/ };
...
int func_497(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_544(iParam0) && func_545(iParam0, &cVar4))
				{
					PERSCHAR::_SET_PERSCHAR_SCHEDULE(func_241(iParam0, 1), &cVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_238(vVar0)) && !func_239(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_508(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, (1 << 30));
			}
			if (bParam1)
			{
				if (!ENTITY::_DOES_THREAD_OWN_THIS_ENTITY(Global_1360165[iParam0 /*1157*/].f_124))
...
void func_499(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_551(func_115(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_552(iParam0);
...
bool func_506(int iParam0, Vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_562(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) /*7*/ };
			if (!bParam6)
			{
				func_113(iParam0, 44, 1);
			}
...
void func_513(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_576(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_576(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
bool func_528(int iParam0, int iParam1)
{
	...
	if (iParam0 == joaat("MP_COMPONENT_TYPE_MASK"))
	{
		...
		if (func_579(func_578(iVar0)) != joaat("CI_CATEGORY_WARDROBE_MASK"))
		{
			return false;
		}
	}
...
void func_533(var uParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if ((func_590((1 << 15)) && func_584(joaat("MP_COMPONENT_TYPE_HEADWEAR"), 8)) && func_591(10, iParam3))
	{
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_584(iVar3, 6) || uParam0->f_1[iVar1 /*3*/] == Global_1946054.f_57[iVar1 /*11*/]) || uParam0->f_1[iVar1 /*3*/].f_1 == joaat("REMOVE_COMPONENT"))
				{
...
bool func_547(int iParam0, Vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489.f_12) || (bParam5 && Global_1359489.f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_241(iParam0, 1));
			STREAMING::REQUEST_MODEL(iVar0, false);
			if (STREAMING::HAS_MODEL_LOADED(iVar0))
			{
				Global_1360165[iParam0 /*1157*/].f_124 = func_314(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
bool func_548(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_EQUIP_META_PED_OUTFIT(iParam1, func_597(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, false, true, true, true, false);
...
void func_549(int iParam0, int iParam1)
{
	...
	func_499(iParam1, func_596(iParam1, (1 << 13)), func_596(iParam1, (1 << 14)), 1);
}
...
void func_551(int iParam0, float fParam1, bool bParam2)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		fParam1 = func_599(fParam1, 0.0f, 1.0f);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_221(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_500(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<7> /*56*/ func_562(int iParam0, int iParam1, Vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	struct<7> /*56*/ sVar0;
...
void func_573(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 12)) > 0 && func_515(iParam1, 879715242))
	{
	...
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 9)) > 0 && func_515(iParam1, 1064646155))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1064646155);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 10)) > 0 && func_515(iParam1, -536694793))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -536694793);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 11)) > 0 && func_515(iParam1, -1304053509))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1304053509);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 31)) > 0 && func_515(iParam1, 718939204))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 718939204);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 16)) > 0 && func_515(iParam1, -972364774))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -972364774);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 14)) > 0 && func_515(iParam1, -1100875244))
	{
	...
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 18)) > 0 && func_515(iParam1, 1153596794))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1153596794);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 19)) > 0 && func_515(iParam1, 1016389820))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1016389820);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 20)) > 0 && func_515(iParam1, -726966617))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -726966617);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 21)) > 0 && func_515(iParam1, 1365901568))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1365901568);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 15)) > 0 && func_515(iParam1, -1658942149))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1658942149);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 17)) > 0 && func_515(iParam1, -1980913856))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1980913856);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 22)) > 0 && func_515(iParam1, 491764525))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 491764525);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 23)) > 0 && func_515(iParam1, -76015264))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -76015264);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 24)) > 0 && func_515(iParam1, 622113465))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 622113465);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 25)) > 0 && func_515(iParam1, 781533162))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 781533162);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 26)) > 0 && func_515(iParam1, -271415321))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -271415321);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 27)) > 0 && func_515(iParam1, -1683207356))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1683207356);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 28)) > 0 && func_515(iParam1, -254794762))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -254794762);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 29)) > 0 && func_515(iParam1, 609066278))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 609066278);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 30)) > 0 && func_515(iParam1, -1712783565))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1712783565);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 13)) > 0 && func_515(iParam1, 1544915253))
	{
...
void func_574(int iParam0)
{
	...
	func_610(iParam0, (1 << 9));
	func_610(iParam0, (1 << 10));
	func_610(iParam0, (1 << 11));
	func_610(iParam0, (1 << 12));
	func_610(iParam0, (1 << 16));
	func_610(iParam0, (1 << 14));
	func_610(iParam0, (1 << 18));
	func_610(iParam0, (1 << 19));
	func_610(iParam0, (1 << 20));
	func_610(iParam0, (1 << 21));
	func_610(iParam0, (1 << 15));
	func_610(iParam0, (1 << 17));
	func_610(iParam0, (1 << 27));
	func_610(iParam0, (1 << 30));
}
...
int func_576(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else if (iVar0 == joaat("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case joaat("GROUP_SHOTGUN"):
			case joaat("GROUP_RIFLE"):
				if (func_612(joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */))
				{
	...
	{
		func_613(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0.0f;
...
void func_582(struct<4> /*32*/ sParam0)
{
	int iVar0;
	int iVar1;
	...
	switch (sParam0.f_0)
	{
		...
		case 35:
		case 36:
			func_619(sParam0.f_0, sParam0.f_1, sParam0.f_2);
			break;
	}
}
...
{
	return (Global_1946054.f_57[func_580(iParam0, 1) /*11*/].f_10 & iParam1) != 0;
}
...
{
	Global_1946054.f_57[func_580(iParam0, 1) /*11*/].f_10 |= iParam1;
}
...
void func_592(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar0 = 10;
	if (func_584(joaat("MP_COMPONENT_TYPE_HEADWEAR"), 6))
	{
		if (bParam2)
		{
			func_589(iParam0, iVar0, func_252() != -1, 0, 0);
			func_588(joaat("MP_COMPONENT_TYPE_HEADWEAR"), 1, 6);
		}
		else
		{
			return;
	...
	else
	{
		...
		func_593(joaat("MP_COMPONENT_TYPE_HEADWEAR"), 1, 6);
	}
	Global_1946054.f_857++;
	if (!bParam1)
	{
...
int func_613(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
	...
	{
		sVar0 = { func_626(iParam0, 0, 1) /*5*/ };
		iVar5 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
		sVar6.f_9 = joaat("SLOTID_NONE");
		iVar28 = 0;
		while (iVar28 < 4)
		{
			iVar5 = func_627((398 + iVar28), 1);
			if (func_628(iParam0, &sVar0, iVar5, 0))
			{
				if (func_629(iParam0, &sVar6, iVar5))
				{
					sVar29 = { func_630(iParam0, sVar0, iVar5, 0) /*4*/ };
					func_631(iParam0, &sVar29, &sVar0, 1, joaat("REMOVE_REASON_DEFAULT"), 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_632(0))
				{
					...
					func_633(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> /*40*/ func_626(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;
	...
	switch (func_641(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_630(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_643(iParam0, 1))
			{
				...
				if (!func_628(iParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_628(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_629(iParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_630(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
...
struct<4> /*32*/ func_630(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
...
void func_634(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_652(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
void func_635(struct<4> /*32*/ sParam0)
{
	...
	if (func_617(sParam0.f_0))
	{
		...
		while (iVar0 < Global_1946054.f_852)
		{
			...
			if (Global_1946054.f_769[iVar1 /*4*/] == 34 && func_617(20))
			{
				return;
			}
			iVar0++;
...
struct<4> /*32*/ func_642(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_630(joaat("CARRIED_WEAPONS"), func_640(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_630(joaat("CARRIED_WEAPONS"), func_640(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_630(joaat("CARRIED_WEAPONS"), func_640(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_643(int iParam0, bool bParam1)
{
	if (func_579(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
struct<4> /*32*/ func_644(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_630(joaat("EMOTE_ITEM"), func_640(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_630(joaat("EMOTE_ITEM"), func_640(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
int func_647(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	...
	sVar0 = { func_630(iParam0, sParam1, iParam5, bParam6) /*4*/ };
...
bool func_648(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_649(0);
	*uParam1 = { func_630(iParam0, func_642(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
