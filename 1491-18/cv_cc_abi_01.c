...
void func_55(var uParam0, int iParam1, bool bParam2)
{
	...
	{
		case 1:
			if (!func_122(&(uParam0->f_107[iParam1 /*113*/].f_32.f_56)) || func_123(&(uParam0->f_107[iParam1 /*113*/].f_32.f_56)) > 1.0f)
			{
				...
				{
					func_125(&(uParam0->f_107[iParam1 /*113*/].f_32.f_56), 0.0f);
				}
			}
			if (!func_122(&(uParam0->f_1693)) || func_123(&(uParam0->f_1693)) > 1.0f)
			{
				if (func_126())
				{
					iVar3 = joaat("ARTHUR");
...
void func_70(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		PED::SET_PED_CONFIG_FLAG(func_142(iParam0), 137 /*PCF_0xE18960DE*/, true);
	}
}
...
void func_72(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		PED::SET_PED_CONFIG_FLAG(func_142(iParam0), 204 /*PCF_0x435F091E*/, true);
	}
	else
	{
		PED::SET_PED_CONFIG_FLAG(func_142(iParam0), 204 /*PCF_0x435F091E*/, false);
	}
}
...
void func_74(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_142(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_144(iParam0) < 10000.0f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_89(var uParam0)
{
	...
	func_161(uParam0, 0.0f, -1.6f, 0.0f, -2.75f, 3.9f, 6.5f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	...
	func_167(uParam0, iLocal_15, 1, joaat("WORLD_HUMAN_STARE_STOIC"), 0, -1, 0, 90.0f, 1065353216 /* Float: 1f */, 1);
	func_170(uParam0, iLocal_15, -130.0f, 1);
	func_171(uParam0, iLocal_15, 1.3f, 1065353216 /* Float: 1f */, 1092616192 /* Float: 10f */);
	func_168(uParam0, iLocal_15, 2, 1, 0, "Default_Angry", 0);
	func_172(uParam0, 20.0f, 30.0f);
	return true;
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_235(uParam0->f_107[iVar12 /*113*/].f_1));
				}
...
bool func_277(var uParam0, int iParam1, Vector3 vParam2)
{
	...
	if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(uParam0->f_107[iParam1 /*113*/].f_3, vParam2, true))
	{
		...
		{
			func_125(&(uParam0->f_107[iParam1 /*113*/].f_109), 0.0f);
		}
	}
	else
	{
...
bool func_278(var uParam0, int iParam1, Vector3 vParam2)
{
	...
	if (ENTITY::IS_ENTITY_OCCLUDED(uParam0->f_107[iParam1 /*113*/].f_5))
	{
		...
		{
			func_125(&(uParam0->f_107[iParam1 /*113*/].f_106), 0.0f);
		}
	}
	else
	{
...
bool func_305(var uParam0, int iParam1)
{
	...
	{
		func_125(&(uParam0->f_107[iParam1 /*113*/].f_32.f_52), 0.0f);
	}
...
void func_385(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_419(func_76(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_420(iParam0);
...
void func_417(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_142(iParam1), iParam0, false);
