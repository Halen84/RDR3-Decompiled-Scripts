...
bool func_73(var uParam0)
{
	...
	{
		func_153(uParam0, joaat("P_STOOL03X"), 0.0f, 0.0f, 0.0f, "STOOL" /* GXTEntry: "Stool" */, 0, 0, 1);
	}
	if (!func_154(1) && !func_154(2))
	{
	...
	func_159(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0, -1.0f, 1065353216 /* Float: 1f */, 1);
	...
	func_159(uParam0, iLocal_15, 4, joaat("WORLD_CAMP_JOHN_RECOVER"), "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0, -1.0f, 1065353216 /* Float: 1f */, 1);
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_272(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
