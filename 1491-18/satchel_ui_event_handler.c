					...
					case joaat("ITEM_SELECTED"):
						switch (sVar3.f_2)
						{
							...
							case 1086195311:
								...
								break;
							case joaat("DROP_ITEM") /* GXTEntry: "Discard" */:
...
int func_7()
{
	...
	switch (iVar0)
	{
		case 0:
			...
			func_78(joaat("SHOP_PEARSON_DONATE_CRAFT") /* GXTEntry: "Donate For Crafting" */);
			break;
		case 1:
			DATABINDING::_DATABINDING_WRITE_DATA_INT(Global_1935689.f_9456, 0);
			func_78(joaat("SHOP_PEARSON_DONATE_PROVISIONS") /* GXTEntry: "Donate For Provisions" */);
			break;
		case 2:
			fVar3 = (BUILTIN::TO_FLOAT(func_79(Global_1935689.f_9440, 0)) / 100.0f);
			DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_9456, MISC::VAR_STRING(10, "SHOP_ITEM_VALUE" /* GXTEntry: "$~1~" */, func_80(MISC::_GET_STRING_FROM_FLOAT(fVar3, 2), joaat("COLOR_PURE_WHITE"))));
			func_78(joaat("SHOP_PEARSON_DONATE_FUNDS") /* GXTEntry: "Donate For Funds" */);
			break;
	}
	return 1;
}
...
bool func_25(bool bParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_119(bParam0) == joaat("CLOTHING"))
	{
		if (func_121(bParam0) == joaat("CI_CATEGORY_WARDROBE_OUTFIT"))
		{
			...
			if (!func_122(bParam0))
			{
				func_123("SI_ITEM_OUTFIT_IS_LOCKED" /* GXTEntry: "You cannot change to that outfit right now." */, 10000, 0, 0, 0, 1);
				return iVar33;
			}
			...
			if (!bVar35)
			{
				...
				{
					func_123("SI_ITEM_USE_OUTFITS_STATIONARY" /* GXTEntry: "You must be stationary to swap outfits." */, 10000, 0, 0, 0, 1);
				}
				else
				{
					func_123("SI_ITEM_USE_OUTFITS_NEAR_HORSE" /* GXTEntry: "You must be near and facing your player saddled horse ~BLIP_HORSE_OWNED~ to acces" +
		...
		else
		{
			switch (func_121(bParam0))
			{
				...
				case joaat("CI_CATEGORY_WARDROBE_GLOVES"):
					...
					{
						func_130(Global_35, joaat("CLOTHING_ITEM_GLOVES_NONE") /* GXTEntry: "No Gloves" */, 0, joaat("MP_COMPONENT_TYPE_END"), 1, 1, 1, 0, 1, 0);
	...
	else
	{
		switch (bParam0)
		{
			...
			case joaat("KIT_WARDROBE") /* GXTEntry: "Wardrobe" */:
				...
				{
					func_123("SI_ITEM_WARDROBE_IS_LOCKED" /* GXTEntry: "The wardrobe is not accessible right now." */, 10000, 0, 0, 0, 1);
				}
				else
				{
					bVar35 = func_124(7, bParam0);
					...
					else
					{
						...
						if (!func_133(Global_1392040.f_1, 1) || func_133(Global_1392040.f_1, (1 << 9)))
						{
							...
							else if (func_122(joaat("KIT_CAMP") /* GXTEntry: "Camp" */))
							{
								if (func_139(1))
								{
									func_140(2);
								...
								{
									func_123("GC_SELECT_HELP_FOLLOWER_DEAD" /* GXTEntry: "You cannot place a Camp when Cripps is critically injured." */, 10000, 0, 0, 0, 1);
								}
								else
								{
									if (GANG::NETWORK_IS_GANG_LEADER(PLAYER::PLAYER_ID()))
									{
										func_123("GC_SELECT_GENERAL_FAIL" /* GXTEntry: "Can\'t place a Camp right now." */, 10000, 0, 0, 0, 1);
									}
									else
									{
										func_123("GC_SELECT_HELP_NOT_LEADER" /* GXTEntry: "Only the Posse Leader can place a Camp." */, 10000, 0, 0, 0, 1);
									}
						...
						if (bVar34)
						{
							func_123("PROPERTY_SHAVE_INV" /* GXTEntry: "You can only use this item at caravan camps to set up a new shaving location." */, 10000, 0, 0, 0, 1);
						}
						...
						func_149(bParam0, 1, 0, joaat("REMOVE_REASON_USED"), 0);
						func_152(joaat("PROVISION_BEAUS_GIFT_2") /* GXTEntry: "Beau\'s Bracelet" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
...
void func_28()
{
	...
	if (func_121(Global_1935689.f_9440) == joaat("CI_CATEGORY_WATCH"))
	{
		...
		{
			func_157(func_156(0), 0, joaat("CI_TAG_FOLDER_KIT_WATCHES") /* GXTEntry: "Watches" */);
		}
		else
		{
...
bool func_42(var uParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	if ((iParam3 & 128) == 0)
	{
		...
		if ((uParam0->f_10 || uParam0->f_12) || uParam0->f_8)
		{
			if (bParam2)
			{
				func_123("ITEM_UNUSABLE_FULLY_MOUNTED" /* GXTEntry: "Cannot use this item while mounted on a horse." */, 10000, 0, 0, 0, 1);
			}
			return false;
		}
	}
		...
		if (uParam0->f_8)
		{
			if (uParam0->f_12)
			{
				...
				if (!uParam0->f_16)
				{
					if (bParam2)
					{
						func_123("ITEM_UNUSABLE_HORSE_SPEED" /* GXTEntry: "You cannot use a horse item while the horse is moving faster than a trot." */, 10000, 0, 0, 0, 1);
					}
					return false;
				}
			}
	...
	if ((iParam3 & (1 << 10)) == 0)
	{
		if ((Global_1935496.f_7 & (1 << 16)) != 0)
		{
			if (bParam2)
			{
				func_123("ITEM_UNUSABLE_CINEMATIC_CAM" /* GXTEntry: "Cannot maintain this item while in cinematic camera mode." */, 10000, 0, 0, 0, 1);
			}
			return false;
		}
	}
	...
	if ((iParam3 & (1 << 15)) == 0)
	{
		...
		if (uParam0->f_18)
		{
			if (bParam2)
			{
				func_123("ITEM_UNUSABLE_SATCHEL_OPEN" /* GXTEntry: "Cannot use this item while the Satchel is open." */, 10000, 0, 0, 0, 1);
			}
			return false;
		}
	}
...
int func_64(var uParam0)
{
	...
	*uParam0 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER_FROM_PATH("", "Satchel");
	Global_1935689.f_9463 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*uParam0, "PromptSelectLabel", joaat("SATCHEL_PROMPT_USE") /* GXTEntry: "Use" */);
	...
	Global_1935689.f_9466 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*uParam0, "PromptHoldSelectLabel", joaat("SATCHEL_PROMPT_BREAKDOWN") /* GXTEntry: "Break Down" */);
	...
	Global_1935689.f_9471 = DATABINDING::_DATABINDING_ADD_DATA_STRING(*uParam0, "PromptDiscardAllLabel", HUD::GET_STRING_FROM_HASH_KEY(joaat("SATCHEL_PROMPT_DISCARD_ALL") /* GXTEntry: "Discard All" */));
	...
	Global_1935689.f_9472 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*uParam0, "PromptSendLabel", joaat("SATCHEL_PROMPT_USE") /* GXTEntry: "Use" */);
	...
	if ((func_62() == -1 && func_27(0)) && Global_1914319.f_16855 == 2)
	{
		Global_1935689.f_9457 = DATABINDING::_DATABINDING_ADD_DATA_STRING(iVar3, "PriceLabel", "SHOP_SEND" /* GXTEntry: "Send For" */);
	}
	else
	{
		Global_1935689.f_9457 = DATABINDING::_DATABINDING_ADD_DATA_STRING(iVar3, "PriceLabel", "SHOP_VALUE" /* GXTEntry: "Value" */);
	}
	...
	iVar5 = joaat("SATCHEL_TITLE"); /* GXTEntry: "Satchel" */
	if (func_209(joaat("CLOTHING_HL_PLAYER_SATCHEL_008_1") /* GXTEntry: "Legend of the East Satchel" */))
	{
	...
	if ((func_84() || func_86(Global_35, func_85(7), 1)) || (!func_87(7) | func_88(7) && func_27(0)))
	{
		func_210(iVar4, "saddle", -1186165261 /* GXTEntry: "SADDLE BAGS" */, "ALL", joaat("SLOTID_HORSE_SATCHEL"));
	}
...
int func_66(int iParam0)
{
	...
	{
		case 0:
			return joaat("ALL_TITLE") /* GXTEntry: "Recent" */;
		case joaat("SATCHEL_CATEGORY_MATERIALS"):
			return joaat("MATERIALS_TITLE") /* GXTEntry: "Materials" */;
		case joaat("SATCHEL_CATEGORY_INGREDIENTS"):
			return joaat("INGREDIENTS_TITLE") /* GXTEntry: "Ingredients" */;
		case joaat("SATCHEL_CATEGORY_REMEDIES"):
			return joaat("REMEDIES_TITLE") /* GXTEntry: "Tonics" */;
		case joaat("SATCHEL_CATEGORY_PROVISIONS"):
			return joaat("PROVISIONS_TITLE") /* GXTEntry: "Provisions" */;
		case joaat("SATCHEL_CATEGORY_VALUABLES"):
			return joaat("VALUABLES_TITLE") /* GXTEntry: "Valuables" */;
		case joaat("SATCHEL_CATEGORY_KIT"):
			return joaat("KIT_TITLE") /* GXTEntry: "Kit" */;
		case joaat("SATCHEL_CATEGORY_DOCUMENTS"):
			return joaat("DOCUMENTS_TITLE") /* GXTEntry: "Documents" */;
		case joaat("SATCHEL_CATEGORY_HORSE"):
			return joaat("HORSE_TITLE") /* GXTEntry: "Horse Cargo" */;
		case joaat("SATCHEL_CATEGORY_DONATIONS"):
			return joaat("DONATIONS_TITLE") /* GXTEntry: "Donations" */;
		case joaat("SATCHEL_CATEGORY_SEND"):
			return joaat("SEND_TITLE") /* GXTEntry: "Postable Items" */;
		case joaat("SATCHEL_CATEGORY_SELL"):
			if ((Global_1914319.f_17370 || Global_1914319.f_18996.f_1) && Global_1914319.f_16855 == 19)
			{
				return joaat("SHOP_PEARSON_DONATE") /* GXTEntry: "Donate" */;
			}
			else
			{
				return joaat("SELL_TITLE") /* GXTEntry: "Sell" */;
			}
			break;
	}
	return 0;
...
int func_69(int iParam0)
{
	...
	{
		case joaat("SATCHEL_CATEGORY_DONATIONS"):
			DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_9460, HUD::GET_STRING_FROM_HASH_KEY(818738914 /* GXTEntry: "No available items to donate." */));
			break;
		case joaat("SATCHEL_CATEGORY_SEND"):
			DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_9460, HUD::GET_STRING_FROM_HASH_KEY(-402412948 /* GXTEntry: "No available items to send." */));
			break;
		case joaat("SATCHEL_CATEGORY_SELL"):
			DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_9460, HUD::GET_STRING_FROM_HASH_KEY(-456150746 /* GXTEntry: "No available items to sell." */));
			break;
		default:
...
void func_77(bool bParam0, var uParam1)
{
	...
	if (func_220(bParam0))
	{
		...
		else
		{
			...
			if (PED::_IS_META_PED_USING_COMPONENT(iVar21, 43391475) || ENTITY::_IS_ENTITY_FULLY_LOOTED(iVar5))
			{
				iVar17 = 0;
			}
			else
...
char* func_80(char* sParam0, int iParam1)
{
	...
	return func_231(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}
...
void func_95()
{
	switch (Global_1935689.f_9439)
	{
		case joaat("SATCHEL_CATEGORY_KIT"):
			...
			break;
		case joaat("SATCHEL_CATEGORY_VALUABLES"):
			if (func_257(joaat("MONEY_LOANSHARK_GWEN_DEBT") /* GXTEntry: "Diamond Brooch" */, 1, 0))
			{
				func_258(joaat("MONEY_LOANSHARK_GWEN_DEBT") /* GXTEntry: "Diamond Brooch" */, 0);
			}
			break;
	}
}
...
void func_97(int iParam0)
{
	if (Global_1935689.f_19.f_203 > 16)
	{
		if (Global_1935689.f_7)
		{
			DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_9459, MISC::VAR_STRING(2, "ENTRY_COUNTER" /* GXTEntry: "~1~ of ~2~" */, iParam0 + 1, Global_1935689.f_9444));
		}
		else
		{
			DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_9459, MISC::VAR_STRING(2, "ENTRY_COUNTER" /* GXTEntry: "~1~ of ~2~" */, iParam0 + 1, Global_1935689.f_19.f_203));
		}
	}
	else
	{
...
void func_100(bool bParam0, var uParam1, var uParam2)
{
	...
	if (func_161(bParam0, 0))
	{
		...
		if (func_27(0) || func_68())
		{
			...
			{
				DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_9456, MISC::VAR_STRING(10, "SEND_ITEM_VALUE" /* GXTEntry: "$~1~" */, func_80(MISC::_GET_STRING_FROM_FLOAT(fVar8, 2), joaat("COLOR_PURE_WHITE"))));
			}
			else if (Global_1914319.f_16855 == 19)
			{
				if (uParam2->f_1)
			...
			{
				DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_9456, MISC::VAR_STRING(10, "SHOP_ITEM_VALUE" /* GXTEntry: "$~1~" */, func_80(MISC::_GET_STRING_FROM_FLOAT(fVar8, 2), joaat("COLOR_PURE_WHITE"))));
			}
		...
		if (bVar7)
		{
			if (iVar6 > 1)
			{
				...
				{
					DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_9460, MISC::VAR_STRING(2, "SATCHEL_TIP_CAPACITY_FULL" /* GXTEntry: "Carrying ~COLOR_RED~~1~ of ~2~~s~" */, iVar5, iVar6));
				}
				else
				{
					DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_9460, MISC::VAR_STRING(2, "SATCHEL_TIP_CAPACITY" /* GXTEntry: "Carrying ~1~ of ~2~" */, iVar5, iVar6));
				}
			}
			else if (iVar6 == 1)
			{
				DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_9460, MISC::VAR_STRING(2, "SATCHEL_TIP_UNIQUE" /* GXTEntry: "This is a unique item" */));
			}
			else
			{
				DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_9460, MISC::VAR_STRING(2, "SATCHEL_TIP_INFINITE" /* GXTEntry: "Carrying ~1~" */, iVar5));
			}
		}
		else if (func_251() == 2)
		{
		...
		{
			DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1935689.f_9460, MISC::VAR_STRING(2, "SHOP_H_NOT_ACCEPTED_ITEM" /* GXTEntry: "~s~The shopkeeper does not accept this item.~s~" */));
		}
	}
	else
	{
...
{
	if ((!func_111(bParam1, joaat("CI_TAG_CATEGORY_DOCUMENT")) && !func_111(bParam1, joaat("CI_TAG_FOLDER_LETTERS") /* GXTEntry: "Letters" */)) && !func_111(bParam1, joaat("CI_TAG_FOLDER_NOTES") /* GXTEntry: "Notes" */))
	{
		return;
	}
...
void func_112(bool bParam0, struct<11> /*88*/ sParam1, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, struct<2> /*16*/ sParam17, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, int iParam27, bool bParam28, int iParam29)
{
	switch (bParam0)
	{
		...
		case joaat("DOCUMENT_LETTER_MAYOR_REWARD2") /* GXTEntry: "Letter from the Mayor\'s Office" */:
			if (func_276())
			{
				func_277(joaat("JOURNAL_RC_MAYOR4_AR") /* GXTEntry: "It ain\'t John Mark. It\'s Jean Marc, you fool. And he\'s now the mayor. I guess tha" +
    ...
    "t\'s good. Lemieux\'s done for." */))
			{
				func_277(joaat("JOURNAL_RC_MAYOR4B_JN") /* GXTEntry: "It ain\'t John Mark. It\'s Jean Marc, Arthur.~n~~n~These fellas are French.~n~And h" +
    "e\'s now the mayor. I guess that\'s good. Sounds like Lemieux was pretty awful." */, 0);
		...
		case joaat("DOCUMENT_LETTER_MAYOR_REWARD2_JN") /* GXTEntry: "Letter from the Mayor\'s Office" */:
			func_277(joaat("JOURNAL_RC_MAYOR4A_JN") /* GXTEntry: "Jean Marc won.~n~~n~He\'s now the mayor and Lemieux is disgraced." */, 0);
			break;
		...
		case joaat("DOCUMENT_NOTE_ROCK_CARVINGS") /* GXTEntry: "Invitation from Francis Sinclair" */:
			if ((func_280() && !func_281(50)) && !func_293(32))
			{
				...
				if (!func_296(Global_1347702[50 /*49*/].f_15, 1))
				{
					if (func_276() == 1)
					{
						func_277(joaat("JOURNAL_RC_ROCKCARV15_AR") /* GXTEntry: "Sent him the location of those odd carvings. Now he wants me to go see him." */, 0);
					}
					...
					{
						func_277(joaat("JOURNAL_RC_ROCKCARV15_JN") /* GXTEntry: "Sent him the location of those odd carvings. Now he wants me to go see him." */, 0);
					}
				}
			}
			break;
	...
	switch (func_259(bParam0, joaat("TAG_INTERACTION_TYPE")))
	{
		...
		case joaat("CI_TAG_APPLY_POMADE"):
			if (!bParam1)
			{
				...
				{
					func_123("SI_ITEM_USE_POMADE_IS_ALREADY_APPLIED" /* GXTEntry: "Your previous pomade has yet to wear off." */, 10000, 0, 0, 0, 1);
				}
			}
			break;
		case -1239610997:
...
void func_129(bool bParam0)
{
	...
	if (bVar1 == bParam0)
	{
		...
		func_130(Global_35, joaat("CLOTHING_ITEM_HAT_NONE") /* GXTEntry: "No Hat" */, 0, joaat("MP_COMPONENT_TYPE_END"), 1, 1, 1, 0, 1, 0);
		func_131(bParam0, 0);
		return;
	}
...
int func_152(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (!bVar3)
	{
		...
		else if (func_111(bParam0, joaat("CI_TAG_ITEM_FISHING_LURE")))
		{
			switch (bParam0)
			{
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_LAKE") /* GXTEntry: "Special Lake Lure" */:
					if (!func_257(joaat("DOCUMENT_PAMPHLET_SPECIAL_LAKE_LURE") /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0))
					{
						func_152(joaat("DOCUMENT_PAMPHLET_SPECIAL_LAKE_LURE") /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_RIVER") /* GXTEntry: "Special River Lure" */:
					if (!func_257(joaat("DOCUMENT_PAMPHLET_SPECIAL_RIVER_LURE") /* GXTEntry: "Special River Lure Handbill" */, 1, 0))
					{
						func_152(joaat("DOCUMENT_PAMPHLET_SPECIAL_RIVER_LURE") /* GXTEntry: "Special River Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_SWAMP") /* GXTEntry: "Special Swamp Lure" */:
					if (!func_257(joaat("DOCUMENT_PAMPHLET_SPECIAL_SWAMP_LURE") /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0))
					{
						func_152(joaat("DOCUMENT_PAMPHLET_SPECIAL_SWAMP_LURE") /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_LAKE") /* GXTEntry: "Lake Lure" */:
					if (!func_257(joaat("DOCUMENT_PAMPHLET_LAKE_LURE") /* GXTEntry: "Lake Lure Handbill" */, 1, 0))
					{
						func_152(joaat("DOCUMENT_PAMPHLET_LAKE_LURE") /* GXTEntry: "Lake Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_RIVER") /* GXTEntry: "River Lure" */:
					if (!func_257(joaat("DOCUMENT_PAMPHLET_RIVER_LURE") /* GXTEntry: "River Lure Handbill" */, 1, 0))
					{
						func_152(joaat("DOCUMENT_PAMPHLET_RIVER_LURE") /* GXTEntry: "River Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_SWAMP") /* GXTEntry: "Swamp Lure" */:
					if (!func_257(joaat("DOCUMENT_PAMPHLET_SWAMP_LURE") /* GXTEntry: "Swamp Lure Handbill" */, 1, 0))
					{
						func_152(joaat("DOCUMENT_PAMPHLET_SWAMP_LURE") /* GXTEntry: "Swamp Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
			}
		}
		...
		switch (bParam0)
		{
			...
			case joaat("UPGRADE_OFFHAND_HOLSTER") /* GXTEntry: "Upgraded Off-Hand Holster" */:
				...
				{
					func_130(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_OFFHAND_HOLSTER") /* GXTEntry: "Upgraded Off-Hand Holster" */, 0, joaat("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_414(&bVar9, 0))
				{
			...
			case joaat("UPGRADE_BANDOLIER") /* GXTEntry: "Upgraded Bandolier" */:
				...
				{
					func_130(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_BANDOLIER") /* GXTEntry: "Upgraded Bandolier" */, 0, joaat("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case joaat("CONSUMABLE_AGED_PIRATE_RUM") /* GXTEntry: "Aged Pirate Rum" */:
				func_428(242, func_266(joaat("CONSUMABLE_AGED_PIRATE_RUM") /* GXTEntry: "Aged Pirate Rum" */), 0);
				break;
			case joaat("CONSUMABLE_GINSENG_ELIXIER") /* GXTEntry: "Ginseng Elixir" */:
				func_428(240, func_266(joaat("CONSUMABLE_GINSENG_ELIXIER") /* GXTEntry: "Ginseng Elixir" */), 0);
				break;
			case joaat("CONSUMABLE_VALERIAN_ROOT") /* GXTEntry: "Valerian Root" */:
				func_428(241, func_266(joaat("CONSUMABLE_VALERIAN_ROOT") /* GXTEntry: "Valerian Root" */), 0);
				break;
			...
			case joaat("CONSUMABLE_MOONSHINE") /* GXTEntry: "Moonshine" */:
				...
				{
					func_429(594, joaat("TF_FORTIFY_TANK1") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Health Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_RESTORATIVE") /* GXTEntry: "Bitters" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_429(594, joaat("TF_FORTIFY_TANK2") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Stamina Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_CHEWING_TOBACCO_USED") /* GXTEntry: "Opened Chewing Tobacco" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_429(594, joaat("TF_FORTIFY_TANK3") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Dead Eye Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_POTENT_TONIC") /* GXTEntry: "Potent Miracle Tonic" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_429(594, joaat("TF_FORTIFY_TANK4") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    ...
    "d Eye Bars." */, 1, 1);
			...
			case joaat("CONSUMABLE_MEAL_ROAST_BEEF") /* GXTEntry: "Roast Beef" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_429(595, joaat("TF_FORTIFY_CORE1") /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    "for a short period of time. This Provision will Fortify your Health Core." */, 1, 1);
			...
			case joaat("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL_EGGS") /* GXTEntry: "Regional Beef and Eggs Stew" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_429(595, joaat("TF_FORTIFY_CORE2") /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
	...
	switch (func_119(bParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_441(bParam0, 1))
			{
				...
				if (!func_442(bParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_442(bParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_443(bParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
...
bool func_160(bool bParam0)
{
	...
	iVar0 = func_259(bParam0, joaat("TAG_CRAFTING_GROUP"));
	bVar1 = false;
	if (iVar0 == 0)
	{
		return false;
...
bool func_162(bool bParam0)
{
	...
	else if ((func_257(joaat("KIT_CAMP_SIMPLE") /* GXTEntry: "Camp" */, 1, 0) && func_25(joaat("KIT_CAMP_SIMPLE") /* GXTEntry: "Camp" */, 0, 0, 0, 1, 0, 0)) || (func_257(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, 1, 0) && func_25(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, 0, 0, 0, 1, 0, 0)))
	{
...
bool func_173(bool bParam0, bool bParam1)
{
	...
	if (func_464())
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_HIDEOUT" /* GXTEntry: "Cannot set up camp while in a hideout." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (func_169(Global_35))
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_PICKUP_ITEM" /* GXTEntry: "Cannot set up camp while picking something up." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (PED::_IS_ANIMAL_INTERACTION_RUNNING(Global_35))
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_HORSE_INTERACTION" /* GXTEntry: "Cannot set up camp while interacting with your horse." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (func_465())
	{
		if (bParam0)
		{
			...
			{
				func_123("CAMP_UNUSABLE_CARAVAN_CAMP" /* GXTEntry: "Cannot set up camp while at the caravan." */, 10000, 0, 0, 0, 1);
			}
			else
			{
				func_123("CAMP_UNUSABLE_BEECHERS_HOPE" /* GXTEntry: "Cannot set up camp while on the ranch." */, 10000, 0, 0, 0, 1);
			}
		}
		return false;
	}
	...
	if (INTERIOR::IS_INTERIOR_SCENE())
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_IN_TOWN" /* GXTEntry: "Camp can only be set up in the wilderness." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (PED::IS_PED_IN_COMBAT(Global_35, 0))
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_IN_COMBAT" /* GXTEntry: "Cannot set up camp while in combat." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (func_466(PLAYER::PLAYER_ID(), 1, 1, 0))
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_WANTED" /* GXTEntry: "Cannot set up camp while wanted by the law or being pursued by bounty hunters." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (LAW::_0x26934083D3F2579C(PLAYER::PLAYER_ID()))
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_CRIME" /* GXTEntry: "Cannot set up camp when you\'ve recently committed a crime." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (bParam1)
	{
		if (TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1))
		{
			if (bParam0)
			{
				func_123("CAMP_UNUSABLE_ACTIVITY" /* GXTEntry: "You cannot create camp while there is activity nearby." */, 10000, 0, 0, 0, 1);
			}
			return false;
		}
	}
	...
	if ((((PED::IS_PED_IN_ANY_VEHICLE(Global_35, false) || (!PED::IS_PED_RAGDOLL(Global_35) && PED::IS_PED_ON_VEHICLE(Global_35, false))) || PED::IS_PED_IN_ANY_BOAT(Global_35)) || PLAYER::IS_PLAYER_RIDING_TRAIN(PLAYER::PLAYER_ID())) || PED::IS_PED_JACKING(Global_35))
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_ON_VEHICLE" /* GXTEntry: "Cannot set up camp while in a vehicle or train." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (func_470(0, 1, 1) && !func_471(1))
	{
		if (bParam0)
		{
			if (func_135(15))
			{
				func_123("CAMP_UNUSABLE_HUNTING" /* GXTEntry: "Cannot set up camp here." */, 10000, 0, 0, 0, 1);
			}
			else
			{
				func_123("CAMP_UNUSABLE_MISSIONS" /* GXTEntry: "Cannot set up camp right now." */, 10000, 0, 0, 0, 1);
			}
		}
		return false;
	}
	...
	if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("CAMERA_ITEM")) > 0)
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_CAMERA" /* GXTEntry: "Cannot set up camp while using the camera." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (func_473((1 << 23)))
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_ALREADY_SET_UP" /* GXTEntry: "The camp has already been set up." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (func_368((1 << 23)))
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_ALREADY_IN_A_CAMP" /* GXTEntry: "You are already at a campsite." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (func_474(func_144()))
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_LOCKDOWN" /* GXTEntry: "Cannot set up camp in an area under Lockdown." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	...
	if (func_170(Global_35))
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_LOOTING" /* GXTEntry: "Cannot set up camp while in the middle of looting a body or skinning an animal." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (func_479())
	...
	if (func_480(Global_35, Global_1935496.f_128, 4.0f, 1, 1))
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_TRAIN" /* GXTEntry: "Cannot set up camp while near train tracks." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (func_481(Global_36, 5.0f))
	{
		if (bParam0)
		{
			func_123("CAMP_UNUSABLE_NEAR_MISSION" /* GXTEntry: "Cannot set up camp while near someone with a mission for you." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
...
bool func_174(bool bParam0)
{
	if (PED::IS_PED_HOGTIED(Global_35))
	{
		if (bParam0)
		{
			func_123("ITEM_UNUSABLE_HOGTIED" /* GXTEntry: "Cannot use this item while hogtied." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (PED::IS_PED_HOGTYING(Global_35))
	{
		if (bParam0)
		{
			func_123("ITEM_UNUSABLE_HOGTYING" /* GXTEntry: "Cannot use this item while hogtying." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (PED::IS_PED_LASSOED(Global_35))
	{
		if (bParam0)
		{
			func_123("ITEM_UNUSABLE_LASSOED" /* GXTEntry: "Cannot use this item while lassoing." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
...
bool func_175(bool bParam0)
{
	if (PED::_IS_PED_SLIDING(Global_35))
	{
		if (bParam0)
		{
			func_123("ITEM_UNUSABLE_SLIDING" /* GXTEntry: "Cannot use this item while sliding." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (PED::IS_PED_SWIMMING(Global_35))
	{
		if (bParam0)
		{
			func_123("ITEM_UNUSABLE_SWIMMING" /* GXTEntry: "Cannot use this item while swimming." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (PED::IS_PED_CLIMBING(Global_35))
	{
		if (bParam0)
		{
			func_123("ITEM_UNUSABLE_CLIMBING" /* GXTEntry: "Cannot use this item while climbing." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (func_172(Global_35))
	{
		if (bParam0)
		{
			func_123("ITEM_UNUSABLE_SLEEPING" /* GXTEntry: "Cannot use this item while sleeping." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (PED::IS_PED_FALLING(Global_35))
	{
		if (bParam0)
		{
			func_123("ITEM_UNUSABLE_FALLING" /* GXTEntry: "Cannot use this item while falling." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	...
	if (PED::IS_PED_VAULTING(Global_35))
	{
		if (bParam0)
		{
			func_123("ITEM_UNUSABLE_JUMPING" /* GXTEntry: "Cannot use this item while in the air." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (TASK::IS_PED_GETTING_UP(Global_35))
...
bool func_176(bool bParam0)
{
	if (PED::IS_PED_HANGING_ON_TO_VEHICLE(Global_35))
	{
		if (bParam0)
		{
			func_123("ITEM_UNUSABLE_HANGING_ON_VEHICLE" /* GXTEntry: "Cannot use this item while hanging on a vehicle." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	return true;
...
bool func_177(int iParam0, bool bParam1)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (bParam1)
		{
			func_123("ITEM_UNUSABLE_NOT_DYING_HORSE" /* GXTEntry: "Can only use this item while the horse is critically injured" */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	if (!func_181(iVar0))
	{
		if (bParam1)
		{
			func_123("ITEM_UNUSABLE_NOT_A_HORSE" /* GXTEntry: "Can only use this item on a horse" */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
...
bool func_178(int iParam0, bool bParam1)
{
	...
	else if (PLAYER::GET_PLAYER_INTERACTION_TARGET_ENTITY(PLAYER::GET_PLAYER_INDEX(), &iVar0, false, false))
	{
		if (!func_181(iVar0))
		{
			if (bParam1)
			{
				func_123("ITEM_UNUSABLE_NOT_ILO_HORSE" /* GXTEntry: "Cannot use this item without focusing on a horse." */, 10000, 0, 0, 0, 1);
			}
			return false;
		}
		if (TASK::IS_PED_IN_WRITHE(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iVar0)))
		{
			if (bParam1)
			{
				func_123("ITEM_UNUSABLE_DYING_HORSE" /* GXTEntry: "Can only use this item while the horse is not critically injured" */, 10000, 0, 0, 0, 1);
			}
			return false;
		}
		if (func_237(iVar0, 1, 1) > 2.0f)
		{
			if (bParam1)
			{
				func_123("ITEM_UNUSABLE_NOT_NEAR_HORSE" /* GXTEntry: "Cannot use this item away from your horse." */, 10000, 0, 0, 0, 1);
			}
			return false;
		}
...
int func_192(bool bParam0)
{
	...
	if (func_484(1) && !Global_1392040.f_2)
	{
		if (bParam0)
		{
			func_123("ITEM_UNUSABLE_PICKING_UP" /* GXTEntry: "Cannot use this item while picking something up." */, 10000, 0, 0, 0, 1);
		}
		return 0;
	}
	if ((func_484(2) && !Global_1392040.f_2) && MISC::GET_GAME_TIMER() >= Global_36615)
	{
		if (bParam0)
		{
			...
			if (iVar0 != 0)
			{
				...
				{
					func_123("ITEM_UNUSABLE_SKINNING" /* GXTEntry: "Cannot use this item while skinning." */, 10000, 0, 0, 0, 1);
					return 0;
				}
			}
			func_123("ITEM_UNUSABLE_LOOTING" /* GXTEntry: "Cannot use this item while looting." */, 10000, 0, 0, 0, 1);
		}
		return 0;
	}
	if (func_484((1 << 22)))
...
int func_193(bool bParam0)
{
	if (PED::IS_PED_CARRYING_SOMETHING(Global_35) && !Global_1392040.f_2)
	{
		if (bParam0)
		{
			func_123("ITEM_UNUSABLE_CARRYING" /* GXTEntry: "Cannot use this item while carrying something." */, 10000, 0, 0, 0, 1);
		}
		return 0;
	}
	return 1;
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		switch (iVar1)
		{
			...
			case joaat("HANDCART"):
				if (bParam0)
				{
					func_123("ITEM_UNUSABLE_VEHICLE" /* GXTEntry: "Cannot use this item while in this vehicle." */, 10000, 0, 0, 0, 1);
				}
				return 0;
			...
			case joaat("HOTCHKISS_CANNON"):
				if (bParam0)
				{
					func_123("ITEM_UNUSABLE_CANNON" /* GXTEntry: "Cannot use this item while manning a turret." */, 10000, 0, 0, 0, 1);
				}
				return 0;
		}
...
{
	func_491(iParam0, joaat("WEAPON_KIT_BINOCULARS") /* GXTEntry: "Binoculars" */, func_32(32));
	func_491(iParam0, joaat("WEAPON_KIT_CAMERA") /* GXTEntry: "Camera" */, func_32(64));
	func_491(iParam0, joaat("KIT_HORSE_BRUSH") /* GXTEntry: "Horse Brush" */, func_32((1 << 10)));
...
void func_208(int iParam0)
{
	...
	func_504(iParam0, joaat("SATCHEL_CATEGORY_INGREDIENTS"), "Ingredients" /* GXTEntry: "Ingredients" */, joaat("SATCHEL_NAV_INGREDIENTS"));
...
void func_256()
{
	if (func_251() != 2)
	{
		if (func_257(joaat("WEAPON_KIT_BINOCULARS") /* GXTEntry: "Binoculars" */, 1, 0))
		{
			func_258(joaat("WEAPON_KIT_BINOCULARS") /* GXTEntry: "Binoculars" */, 0);
		}
		if (func_257(joaat("WEAPON_KIT_CAMERA") /* GXTEntry: "Camera" */, 1, 0))
		{
			func_258(joaat("WEAPON_KIT_CAMERA") /* GXTEntry: "Camera" */, 0);
		}
		func_542();
		if (func_257(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, 1, 0))
		{
			func_258(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, 0);
		}
		else if (func_257(joaat("KIT_CAMP_SIMPLE") /* GXTEntry: "Camp" */, 1, 0))
		{
			func_258(joaat("KIT_CAMP_SIMPLE") /* GXTEntry: "Camp" */, 0);
		}
		func_543();
	}
}
...
void func_262(bool bParam0, var uParam1)
{
	if (func_68())
	{
		...
		if (func_23())
		{
			DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING(func_548(), 75706034 /* GXTEntry: "Donate" */);
		}
		else
		{
			DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING(func_548(), joaat("SATCHEL_PROMPT_USE") /* GXTEntry: "Use" */);
		}
...
{
	func_547(0);
	DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING(func_548(), joaat("SATCHEL_PROMPT_OPEN") /* GXTEntry: "Open" */);
...
void func_360(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	strcpy_s(&cVar2, 32, func_635(iVar1 == 1, "ITEM_GET_PUMP" /* GXTEntry: "~1~" */, "ITEM_GET_PUMP_MULT" /* GXTEntry: "~2~x ~1~" */));
	if (iParam1 > 0)
	{
	}
	else
...
bool func_394(bool bParam0, int iParam1, int iParam2)
{
	...
	if (func_257(joaat("PROVISION_TRINKET_CROW_BEAK") /* GXTEntry: "Crow Beak Trinket" */, 1, 0) && iParam2 == joaat("ADD_REASON_LOOTED"))
	{
...
bool func_401()
{
	if (((((func_682(joaat("DOCUMENT_ARTHUR_MINOR_BOUNTY_1") /* GXTEntry: "Bounty Poster of Arthur" */, 400) || func_682(joaat("DOCUMENT_ARTHUR_MINOR_BOUNTY_2") /* GXTEntry: "Bounty Notice" */, 400)) || func_682(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_1") /* GXTEntry: "Bounty Hunter\'s Orders" */, 400)) || func_682(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_2") /* GXTEntry: "Poster of a Violent Criminal" */, 400)) || func_682(joaat("DOCUMENT_ARTHUR_HAS_POSTER_1") /* GXTEntry: "Bounty Hunter\'s Letter" */, 400)) || func_682(joaat("DOCUMENT_ARTHUR_HAS_POSTER_2") /* GXTEntry: "Bounty Page" */, 400))
	{
		return true;
	}
	return false;
...
void func_406(bool bParam0)
{
	...
	switch (bParam0)
	{
		case joaat("DOCUMENT_TAXIDERMY_ORDER_1") /* GXTEntry: "Hunting Request" */:
			...
			func_150(437, 0);
			func_150(440, 0);
			func_690(joaat("TAXIDERMY_ORDER_01"), joaat("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT") /* GXTEntry: "Perfect Squirrel Carcass" */, &sVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_2") /* GXTEntry: "Hunting Request" */:
			...
			func_690(joaat("TAXIDERMY_ORDER_02"), joaat("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT") /* GXTEntry: "Perfect Cardinal Carcass" */, &sVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_3") /* GXTEntry: "Hunting Request" */:
			...
			func_690(joaat("TAXIDERMY_ORDER_03"), joaat("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT") /* GXTEntry: "Perfect Chipmunk Carcass" */, &sVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_4") /* GXTEntry: "Hunting Request" */:
			...
			func_690(joaat("TAXIDERMY_ORDER_04"), joaat("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT") /* GXTEntry: "Perfect Songbird Carcass" */, &sVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_5") /* GXTEntry: "Hunting Request" */:
			...
			func_150(438, 0);
			func_690(joaat("TAXIDERMY_ORDER_05"), joaat("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT") /* GXTEntry: "Perfect Cedar Waxwing Carcass" */, &sVar0, 1, 0, 0);
...
void func_408(bool bParam0, int iParam1)
{
	...
	if (func_62() == -1)
	{
		...
		else if (func_111(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_01")))
		{
		...
		else if (func_111(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_02")))
		{
		...
		else if (func_111(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_03")))
		{
		...
		else if (func_111(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_04")))
		{
		...
		else if (func_111(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_05")))
		{
...
void func_411(bool bParam0, int iParam1, int iParam2)
{
	...
	if (func_62() == -1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam2))
		{
			...
			{
				func_402(0, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), iVar0);
				return;
			}
		}
	}
	switch (bParam0)
	{
		case joaat("MONEY_ONE_DOLLAR") /* GXTEntry: "$1.00" */:
			func_402(joaat("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_FIVE_DOLLARS") /* GXTEntry: "$5.00" */:
			func_402(joaat("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_TEN_DOLLARS") /* GXTEntry: "$10.00" */:
			func_402(joaat("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLFOLD") /* GXTEntry: "Bill Fold" */:
			func_402(joaat("REWARD_BILLFOLD"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLFOLD_SML") /* GXTEntry: "Small Bill Fold" */:
			func_402(joaat("REWARD_BILLFOLD_SML"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLSTACK") /* GXTEntry: "Bill Stack" */:
			func_402(joaat("REWARD_BILLSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COIN") /* GXTEntry: "Coin" */:
			func_402(joaat("REWARD_COIN"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINPURSE") /* GXTEntry: "Coin Purse" */:
			func_402(joaat("REWARD_COINPURSE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINSACK") /* GXTEntry: "Coin Sack" */:
			func_402(joaat("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINSTACK") /* GXTEntry: "Coin Stack" */:
			func_402(joaat("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYCLIP") /* GXTEntry: "Money Clip" */:
			func_402(joaat("REWARD_MONEYCLIP"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYSTACK") /* GXTEntry: "Money Stack" */:
			func_402(joaat("REWARD_MONEYSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYSTACK_LARGE") /* GXTEntry: "Money Pile" */:
			if (!func_702())
			{
				func_402(joaat("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			}
			break;
		case joaat("MONEY_COINCUP_SM") /* GXTEntry: "Change Cup" */:
			func_402(joaat("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINCUP_LG") /* GXTEntry: "Coin Cup" */:
			func_402(joaat("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
...
void func_438(bool bParam0, char* sParam1)
{
	...
	func_637(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP" /* GXTEntry: "~1w~ ~2~" */, sParam1, sVar0), "inventory_items", func_719(bParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
int func_457(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	if (iVar2 > 0)
	{
		...
		if (!bParam2)
		{
			func_123("SHOP_SELL_HORSE_SATCHEL" /* GXTEntry: "Items were sold from the Horse\'s Satchel." */, 10000, 0, 0, 0, 1);
		}
	}
	return 1;
}
...
int func_531(bool bParam0)
{
	...
	if (bParam0 != 0)
	{
		if (func_384(bParam0, (1 << 23)))
		{
			...
			{
				if (func_257(joaat("DOCUMENT_RARE_ORCHID_ORDER_1") /* GXTEntry: "Rare Orchids Order" */, 1, 0))
				{
					if (!func_772(48))
					{
						return 0;
...
void func_542()
{
	...
	if (func_257(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, 1, 0))
	{
		...
		{
			iVar0 = func_199(0);
			bVar1 = INVENTORY::_INVENTORY_IS_INVENTORY_ITEM_EQUIPPED(iVar0, joaat("KIT_CAMP") /* GXTEntry: "Camp" */, func_27(0));
			func_149(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, 1, 1, joaat("REMOVE_REASON_DEFAULT"), 0);
			func_152(joaat("KIT_CAMP_SIMPLE") /* GXTEntry: "Camp" */, 1, 1, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
			Global_1935496.f_125 = 0;
			Global_1935496.f_126 = 1;
			if (bVar1)
			{
				INVENTORY::_INVENTORY_DISABLE_ITEM(iVar0, joaat("KIT_CAMP_SIMPLE") /* GXTEntry: "Camp" */, 0);
			}
			else
			{
				INVENTORY::_INVENTORY_ENABLE_ITEM(iVar0, joaat("KIT_CAMP_SIMPLE") /* GXTEntry: "Camp" */);
			}
		}
	}
	else if (func_257(joaat("KIT_CAMP_SIMPLE") /* GXTEntry: "Camp" */, 1, 0))
	{
		...
		{
			iVar2 = func_199(0);
			bVar3 = INVENTORY::_INVENTORY_IS_INVENTORY_ITEM_EQUIPPED(iVar2, joaat("KIT_CAMP_SIMPLE") /* GXTEntry: "Camp" */, func_27(0));
			func_149(joaat("KIT_CAMP_SIMPLE") /* GXTEntry: "Camp" */, 1, 1, joaat("REMOVE_REASON_DEFAULT"), 0);
			func_152(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, 1, 1, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
			Global_1935496.f_125 = 1;
			Global_1935496.f_126 = 0;
			if (bVar3)
			{
				INVENTORY::_INVENTORY_DISABLE_ITEM(iVar2, joaat("KIT_CAMP") /* GXTEntry: "Camp" */, 0);
			}
			else
			{
				INVENTORY::_INVENTORY_ENABLE_ITEM(iVar2, joaat("KIT_CAMP") /* GXTEntry: "Camp" */);
			}
		}
	}
}
...
void func_549(bool bParam0)
{
	...
	else if (func_259(bParam0, 1224357681) == joaat("CI_TAG_FOLDER_KIT_KEEPSAKES"))
	{
		switch (bParam0)
		{
			case joaat("PROVISION_PEARSONS_NAVAL_COMPASS") /* GXTEntry: "Naval Compass" */:
			case joaat("PROVISION_MOLLYS_POCKET_MIRROR") /* GXTEntry: "Pocket Mirror" */:
			case joaat("PROVISION_BEAUS_GIFT_1") /* GXTEntry: "Beau\'s Gift" */:
				func_547(0);
				break;
			default:
				func_792();
...
int func_550(bool bParam0)
{
	if (DATABINDING::_DATABINDING_READ_DATA_BOOL(Global_1935689.f_9468))
	{
		if (func_111(bParam0, joaat("CI_TAG_ITEM_CAN_BREAKDOWN")))
		{
			return joaat("SATCHEL_PROMPT_BREAKDOWN") /* GXTEntry: "Break Down" */;
		}
		else if (func_159(bParam0, 1, 0))
		{
			return joaat("SATCHEL_PROMPT_COOK") /* GXTEntry: "Cook" */;
		}
	}
	else if (func_111(bParam0, joaat("CI_TAG_ITEM_CONSUMABLE")))
	{
		if (func_111(bParam0, joaat("CI_TAG_ITEM_HORSE_ITEM")))
		{
			return joaat("SATCHEL_PROMPT_USE") /* GXTEntry: "Use" */;
		}
		switch (func_259(bParam0, joaat("TAG_INTERACTION_TYPE")))
		{
			case -273840653:
			...
			case 1130235258:
			case 1177617310:
				return joaat("SATCHEL_PROMPT_DRINK") /* GXTEntry: "Drink" */;
			case -1915958659:
			case -809056541:
			case 89124942:
			case 1451036371:
			case 1859991422:
			case 1891031775:
				return joaat("SATCHEL_PROMPT_EAT") /* GXTEntry: "Eat" */;
			case -1919515848:
			case -262371497:
			case joaat("CI_TAG_APPLY_POMADE"):
			case joaat("CI_TAG_APPLY_LOTION"):
	...
	{
		return joaat("SATCHEL_PROMPT_EQUIP") /* GXTEntry: "Equip" */;
	}
	return joaat("SATCHEL_PROMPT_USE") /* GXTEntry: "Use" */;
}
...
char* func_574(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6)
{
	switch (iParam1)
	{
		case joaat("CIGARETTE_CARDS"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_CC_CARD_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Card Sets Posted" */, func_802(), 12);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_CC_CARD_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Card Sets Found" */, func_803(), 12);
			}
			break;
		case joaat("DINO_BONES"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_DB_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Dinosaur Bones Posted" */, func_804(), 30);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_DB_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Dinosaur Bones Found" */, func_688(), 30);
			}
			break;
		...
		case joaat("LEGENDARY_FISH"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_LF_CAUGHT_OBJ" /* GXTEntry: "~1~ of ~2~ Legendary Fish Caught and Posted" */, func_805(), 13);
			}
			break;
		case joaat("ROCK_CARVINGS"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_RC_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Rock Faces Found" */, func_689(), 10);
			}
			break;
		case joaat("TAXIDERMY"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_TX_CARCASS_COLLECTED_OBJ" /* GXTEntry: "~1~ of ~2~ Carcasses Collected" */, sParam4, func_573(iParam6, 20));
			}
			break;
	}
	return sParam3;
...
int func_622(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	bVar0 = func_854(0);
	if (iParam2 != 0 && func_855(bParam0, bVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
void func_640(bool bParam0, int iParam1)
{
	...
	if (func_62() == -1)
	{
		if (func_281(43))
		{
			if (func_111(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_01")))
			{
				func_692(joaat("EXOTIC_STAGE_01"));
				if (func_693() == 0)
				{
		...
		if (func_281(44))
		{
			if (func_111(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_02")))
			{
				func_692(joaat("EXOTIC_STAGE_02"));
				if (func_693() == 1)
				{
		...
		if (!func_281(45))
		{
			if (func_111(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_03")))
			{
				func_692(joaat("EXOTIC_STAGE_03"));
				if (func_693() == 2)
				{
		...
		if (!func_281(46))
		{
			if (func_111(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_04")))
			{
				func_692(joaat("EXOTIC_STAGE_04"));
				if (func_693() == 3)
				{
		...
		if (!func_281(47))
		{
			if (func_111(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_05")))
			{
				func_692(joaat("EXOTIC_STAGE_05"));
				if (func_693() == 4)
				{
...
bool func_653(bool bParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_647(bParam0) && WEAPON::IS_WEAPON_A_GUN(bParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
		{
			...
			else if (func_443(bParam0, &sVar4, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
			{
				return false;
			}
			if (func_441(bParam0, 1))
			{
				if (!func_442(bParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					return false;
				}
				else if (func_443(bParam0, &sVar4, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */))
				{
					return false;
				}
			}
...
void func_662(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_572("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_MANUAL_PAINT" /* GXTEntry: "Manual Painting" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_572("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_STAY_ACTIVE" /* GXTEntry: "Continued Free Fire" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_572("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_FATAL" /* GXTEntry: "Fatal Region Highlights" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_572("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_CRITICAL" /* GXTEntry: "Critical Region Highlights" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
...
int func_683(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1.0f;
	if (bParam1 && func_257(joaat("PROVISION_TRINKET_ELK_ANTLER") /* GXTEntry: "Elk Antler Trinket" */, 1, 0))
	{
		fVar0 += 0.1f;
	}
	sVar1.f_1 = 10;
...
void func_711(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_123(MISC::VAR_STRING(10, "OUT_JOURN_DONE" /* GXTEntry: "~1~ completed." */, MISC::VAR_STRING(0, bVar0)), 10000, 0, 0, 0, 1);
	}
	func_929(iParam0, 6);
	if (bParam2)
	{
...
{
	if (func_967(bParam0, joaat("DEFAULT") /* GXTEntry: "_" */) == 0)
	{
		return false;
	}
	return true;
...
int func_855(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
void func_893()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_389(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN") /* GXTEntry: "John\'s Cattleman Revolver" */);
		func_433(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN") /* GXTEntry: "John\'s Cattleman Revolver" */, 1, joaat("ADD_REASON_DEFAULT"));
		...
		func_389(joaat("WEAPON_MELEE_KNIFE_JOHN") /* GXTEntry: "John\'s Knife" */);
		func_433(joaat("WEAPON_MELEE_KNIFE_JOHN") /* GXTEntry: "John\'s Knife" */, 1, joaat("ADD_REASON_DEFAULT"));
...
void func_927(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_926(iParam0))
	{
		...
		if ((!func_928() && !bParam1) && !func_470(0, 0, 1))
		{
			func_123(MISC::VAR_STRING(10, "OUT_JOURN_ADD" /* GXTEntry: "~1~ discovered." */, func_1037(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
void func_1026(int iParam0, int iParam1, int iParam2)
{
	...
	func_570(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC" /* GXTEntry: "Hold ~INPUT_FEED_INTERACT~ for details" */, func_1110(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_1027()
{
	...
	func_1112(0);
	func_1113(7);
	func_330(joaat("KIT_BANDANA") /* GXTEntry: "Bandana" */, 1, 1, 0);
	if (func_610() == joaat("MPC_PLAYER_TYPE_SP_MARSTON"))
	{
		func_330(joaat("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000") /* GXTEntry: "John\'s Classic Hat" */, 1, 1, 1);
		func_330(joaat("CLOTHING_SP_MAR_OUTFIT_GUNSLINGER") /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
...
bool func_1061(int iParam0)
{
	switch (iParam0)
	{
		case joaat("CI_TAG_FOLDER_TAXIDERMIST_ORDERS") /* GXTEntry: "Hunting Requests" */:
		case joaat("CI_TAG_FOLDER_LETTERS") /* GXTEntry: "Letters" */:
		case joaat("CI_TAG_FOLDER_TREASURE_MAPS") /* GXTEntry: "Treasure Maps" */:
		case joaat("CI_TAG_FOLDER_PHOTOGRAPHS") /* GXTEntry: "Photographs" */:
		case joaat("CI_TAG_FOLDER_RECIPE_PAMPHLETS") /* GXTEntry: "Recipe Pamphlets" */:
		case joaat("CI_TAG_FOLDER_NEWSPAPER_SCRAPS") /* GXTEntry: "Newspaper Scraps" */:
		case joaat("CI_TAG_FOLDER_BUSINESS_CARDS") /* GXTEntry: "Business Cards" */:
		case joaat("CI_TAG_FOLDER_NEWSPAPERS") /* GXTEntry: "Newspapers" */:
		case joaat("CI_TAG_FOLDER_DINOSAUR_NOTES") /* GXTEntry: "Dinosaur Notes" */:
		case joaat("CI_TAG_FOLDER_ROCK_CARVING_NOTES") /* GXTEntry: "Rock Carving Notes" */:
		case joaat("CI_TAG_FOLDER_BOOKS") /* GXTEntry: "Books" */:
		case joaat("CI_TAG_FOLDER_DRAWINGS") /* GXTEntry: "Drawings" */:
		case joaat("CI_TAG_FOLDER_BOUNTY_POSTERS") /* GXTEntry: "Bounty Posters" */:
		case joaat("CI_TAG_FOLDER_MAPS") /* GXTEntry: "Maps" */:
		case joaat("CI_TAG_FOLDER_NOTES") /* GXTEntry: "Notes" */:
			return true;
	}
...
bool func_1062(int iParam0)
{
	switch (iParam0)
	{
		case joaat("CI_TAG_FOLDER_KIT_WATCHES") /* GXTEntry: "Watches" */:
			return true;
	}
	return false;
}
...
bool func_1064(int iParam0)
{
	switch (iParam0)
	{
		case joaat("CI_TAG_FOLDER_GAMEY_BIRD") /* GXTEntry: "Cooked Game Bird Meat" */:
		case joaat("CI_TAG_FOLDER_BIG_GAME") /* GXTEntry: "Cooked Big Game Meat" */:
		case joaat("CI_TAG_FOLDER_GRISTLY_MUTTON") /* GXTEntry: "Cooked Gristly Mutton" */:
		case joaat("CI_TAG_FOLDER_HERPTILE_MEAT") /* GXTEntry: "Cooked Herptile Meat" */:
		case joaat("CI_TAG_FOLDER_SUCCULENT_FISH") /* GXTEntry: "Cooked Succulent Fish" */:
		case joaat("CI_TAG_FOLDER_STRINGY_MEAT") /* GXTEntry: "Cooked Stringy Meat" */:
		case joaat("CI_TAG_FOLDER_MATURE_VENISON") /* GXTEntry: "Cooked Mature Venison" */:
		case joaat("CI_TAG_FOLDER_GAME") /* GXTEntry: "Cooked Game Meat" */:
		case joaat("CI_TAG_FOLDER_CRUSTACEAN") /* GXTEntry: "Cooked Crustacean Meat" */:
		case joaat("CI_TAG_FOLDER_FLAKEY_FISH") /* GXTEntry: "Cooked Flaky Fish" */:
		case joaat("CI_TAG_FOLDER_PLUMP_BIRD") /* GXTEntry: "Cooked Plump Birds" */:
		case joaat("CI_TAG_FOLDER_PRIME_BEEF") /* GXTEntry: "Cooked Beef" */:
		case joaat("CI_TAG_FOLDER_GRITTY_FISH") /* GXTEntry: "Cooked Gritty Fish" */:
		case joaat("CI_TAG_FOLDER_TENDER_PORK") /* GXTEntry: "Cooked Tender Pork" */:
		case joaat("CI_TAG_FOLDER_EXOTIC_BIRD") /* GXTEntry: "Cooked Exotic Birds" */:
			return true;
	}
	return false;
}
...
bool func_1127(int iParam0)
{
	switch (iParam0)
	{
		case joaat("CI_TAG_FOLDER_CIG_CARD_SPT_SET") /* GXTEntry: "Cigarette Cards" */:
		case joaat("CI_TAG_FOLDER_CIG_CARD_AML_SET") /* GXTEntry: "Cigarette Cards" */:
		case joaat("CI_TAG_FOLDER_CIG_CARD_GUN_SET") /* GXTEntry: "Cigarette Cards" */:
		case joaat("CI_TAG_FOLDER_CIG_CARD_GRL_SET") /* GXTEntry: "Cigarette Cards" */:
		case joaat("CI_TAG_FOLDER_CIG_CARD_LND_SET") /* GXTEntry: "Cigarette Cards" */:
		case joaat("CI_TAG_FOLDER_CIG_CARD_ACT_SET") /* GXTEntry: "Cigarette Cards" */:
		case joaat("CI_TAG_FOLDER_CIG_CARD_PLT_SET") /* GXTEntry: "Cigarette Cards" */:
		case joaat("CI_TAG_FOLDER_CIG_CARD_INV_SET") /* GXTEntry: "Cigarette Cards" */:
		case joaat("CI_TAG_FOLDER_CIG_CARD_ART_SET") /* GXTEntry: "Cigarette Cards" */:
		case joaat("CI_TAG_FOLDER_CIG_CARD_PAM_SET") /* GXTEntry: "Cigarette Cards" */:
		case joaat("CI_TAG_FOLDER_CIG_CARD_HOR_SET") /* GXTEntry: "Cigarette Cards" */:
		case joaat("CI_TAG_FOLDER_CIG_CARD_VEH_SET") /* GXTEntry: "Cigarette Cards" */:
			return true;
	}
	return false;
}
...
void func_1135(var uParam0, int iParam1, int iParam2)
{
	...
	uParam0->f_1 = PED::_REQUEST_META_PED_COMPONENT(iVar0, iParam1, 0, func_62() != -1, iParam2);
	*uParam0 = 1;
}
