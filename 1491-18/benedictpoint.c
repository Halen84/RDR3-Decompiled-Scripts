				...
				case 6:
					if (func_7(func_6(iLocal_170)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_170 /*35*/].f_11 > 0.0f)
							{
...
bool func_11()
{
	iLocal_163 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-5220.2f, -3472.4f, -20.6f, 0.0f, 0.0f, 0.0f, 100.0f, 125.0f, 70.0f, "m_volBenedictPoint");
	iLocal_164 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volBenedictPostOffice Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_164, -5226.037f, -3468.296f, -19.99f, 0.0f, 0.0f, 0.0f, 6.727f, 3.065f, 3.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_164, -5227.384f, -3470.978f, -19.99f, 0.0f, 0.0f, 0.0f, 2.011f, 2.184f, 3.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_164, -5230.431f, -3468.341f, -20.375f, 0.0f, 0.0f, 0.0f, 2.753f, 2.804f, 4.0f);
	iLocal_165 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volBenedictPostOfficePrompt Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_165, -5227.361f, -3470.487f, -20.226f, 0.0f, 0.0f, 0.0f, 1.695f, 1.082f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_165, -5229.832f, -3468.299f, -20.656f, 0.0f, 0.0f, 0.0f, 1.109f, 2.187f, 3.106f);
	iLocal_166 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5226.061f, -3468.279f, -21.52f, 0.0f, 0.0f, 0.0f, 6.85f, 3.25f, 4.0f, "m_volBenedictPostOfficeOffLimits");
	return true;
}
...
{
	func_51(2, 507, iLocal_164, iParam0, iLocal_165, iLocal_166, 491520, (12.5f * 2.0f), 0, 0);
...
void func_46()
{
	...
	uVar0 = 5;
	func_85(&sLocal_117, 507, &uVar0, 0, 0);
	sLocal_117[0 /*45*/].f_43 = 9110;
	sLocal_117[0 /*45*/].f_44 = 9286;
...
void func_51(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	vVar1 = { func_96(iVar0) /*3*/ };
	vVar4 = { func_97(iVar0) /*3*/ };
	if (func_98(vVar1))
	{
		return;
	}
...
void func_67(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_134(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_134(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_134(&cVar6, joaat("COLOR_PURE_WHITE")), func_134(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
int func_94(int iParam0, bool bParam1)
{
	...
	if (func_153(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			if (func_153(iParam0, (1 << 11)))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_116(iParam0));
				func_165(iParam0, (1 << 11));
			}
...
bool func_105(int iParam0, int iParam1)
{
	...
	if (func_99(iParam0, (1 << 14)) && !func_178(iParam0, 1))
	{
		return true;
	}
	if (!func_92(iParam1))
...
char* func_134(char* sParam0, int iParam1)
{
	...
	return func_196(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_135(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_139(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_149()
{
	...
	while (iVar0 < 1)
	{
		if (func_156(&(sLocal_117[iVar0 /*45*/].f_34)))
		{
			func_202(&(sLocal_117[iVar0 /*45*/].f_34));
		}
		func_203(sLocal_117[iVar0 /*45*/].f_38);
		func_203(sLocal_117[iVar0 /*45*/].f_39);
		iVar0++;
	}
}
...
void func_150(int iParam0)
{
	...
	func_206(iParam0, (1 << 14));
	func_206(iParam0, (1 << 15));
	func_206(iParam0, (1 << 17));
	func_206(iParam0, (1 << 24));
	func_206(iParam0, (1 << 19));
	func_206(iParam0, (1 << 20));
...
bool func_160(var uParam0, int iParam1)
{
	...
	if (!func_214(iVar0, iParam1, (1 << 10)))
	{
		if (func_215(uParam0) && func_216(0))
		{
			func_217(iVar0, iParam1, (1 << 10));
			uParam0->f_21 = -1;
			return true;
		}
	}
...
bool func_186(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (uParam0->f_30 == 1)
	{
		if (!func_230(uParam0, (1 << 16)) && func_231(Global_35, iVar0, 1) > 25.0f)
		{
			func_232(1, 1, 0);
		}
	...
	else
	{
		...
		if (func_231(Global_35, iVar0, 1) < 49.0f)
		{
...
char* func_191(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}
...
bool func_215(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
		if (func_231(Global_35, iVar0, 1) < 9.0f)
		{
			return true;
		}
	}
...
bool func_233(var uParam0, bool bParam1)
{
	...
	if (Global_1914319.f_17371 | func_271(func_158(*uParam0), 1, 1, 1, 0) || PED::IS_PED_HOGTIED(func_158(*uParam0)))
	{
		func_267(uParam0);
		return uParam0->f_30;
	}
	if (((func_272(PLAYER::PLAYER_ID(), 1, 0, 1) | func_273() || LAW::_0xF46108C50A22B029()) || LAW::ARE_WITNESSES_ACTIVE(PLAYER::PLAYER_ID())) || PLAYER::_0xD1F6B912785BFD35(PLAYER::PLAYER_ID()))
	{
		return false;
	}
	...
	if (!func_277(iVar0, func_230(uParam0, (1 << 11))))
	{
		return false;
	}
	if (uParam0->f_30 == 0)
	{
		if (!func_230(uParam0, (1 << 11)) && !func_230(uParam0, (1 << 15)))
		{
			...
			else if (func_230(uParam0, (1 << 10)))
			{
				if (func_278(&(uParam0->f_34)) < 5.0f)
				{
					return false;
				}
			}
			else if (func_278(&(uParam0->f_34)) < 25.0f)
			{
				return false;
			}
		}
...
bool func_238(var uParam0, int iParam1)
{
	...
	if (func_230(uParam0, 128))
	{
		...
		while (iVar0 < 5)
		{
			...
			if (func_241(iVar1, 0) && func_280(iVar1, iParam1, 1, 1) <= 4.0f)
			{
				uParam0->f_21 = iVar0;
				return true;
			}
	...
	if (!func_230(uParam0, (1 << 9)) && !func_230(uParam0, 256))
	{
		return true;
	}
...
void func_245(var uParam0)
{
	...
	func_157(&(uParam0->f_34), 1);
	uParam0->f_40 = { func_289() /*3*/ };
	uParam0->f_21 = -1;
	if (func_230(uParam0, (1 << 14)))
	{
		func_290(uParam0, (1 << 14));
	}
	func_290(uParam0, (1 << 15));
	func_290(uParam0, (1 << 10));
	func_202(&uLocal_15);
	if (func_230(uParam0, (1 << 12)))
	{
		...
		{
			func_291(iVar0, 0);
			func_290(uParam0, (1 << 13));
			func_290(uParam0, (1 << 12));
		}
	}
}
...
bool func_251(Vector3 vParam0, int iParam3)
{
	...
	func_293(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_294(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
bool func_284(int iParam0, int iParam1)
{
	...
	return func_183(Global_1914319.f_3[iParam0 /*446*/].f_10, (1 << 10));
}
