...
void func_7(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		case joaat("CONSUMABLE_GINSENG_ELIXIER") /* GXTEntry: "Ginseng Elixir" */:
			if (func_32(0) >= 7)
			{
				func_34(244, func_33(joaat("CONSUMABLE_GINSENG_ELIXIER") /* GXTEntry: "Ginseng Elixir" */), 1);
			}
			func_35(19);
			break;
		case joaat("CONSUMABLE_VALERIAN_ROOT") /* GXTEntry: "Valerian Root" */:
			if (func_32(2) >= 7)
			{
				func_34(243, func_33(joaat("CONSUMABLE_VALERIAN_ROOT") /* GXTEntry: "Valerian Root" */), 1);
			}
			func_35(50);
			break;
		case joaat("CONSUMABLE_AGED_PIRATE_RUM") /* GXTEntry: "Aged Pirate Rum" */:
			if (func_32(1) >= 7)
			{
				func_34(245, func_33(joaat("CONSUMABLE_AGED_PIRATE_RUM") /* GXTEntry: "Aged Pirate Rum" */), 1);
			}
			func_35(30);
			break;
...
int func_10(int iParam0)
{
	switch (iParam0)
	{
		case 1156231582 /* GXTEntry: "Buzzed" */:
			return -986108061;
		case joaat("CLOTHING_ITEM_HAIR_SWEPT_BACK") /* GXTEntry: "Swept Back" */:
			return -1051664629;
...
void func_31(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam0)
	{
		...
		case joaat("CONSUMABLE_HAYCUBE") /* GXTEntry: "Hay" */:
			func_83(func_86(joaat("USED"), joaat("FEED_BAG") /* GXTEntry: "Feed Bag" */), 1);
			break;
	}
	switch (iParam0)
	{
		...
		case joaat("CONSUMABLE_WHISKEY") /* GXTEntry: "Kentucky Bourbon" */:
			func_83(func_86(joaat("USED"), joaat("WHISKEY") /* GXTEntry: "Whiskey" */), 1);
			break;
...
int func_50(int iParam0)
{
	switch (iParam0)
	{
		...
		case -1051664629:
			return joaat("CLOTHING_ITEM_HAIR_SWEPT_BACK") /* GXTEntry: "Swept Back" */;
		case 1471627791:
...
struct<5> /*40*/ func_106(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_192(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_193(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_195(iParam0, 1))
			{
				...
				if (!func_196(iParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_196(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_197(iParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_193(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
...
int func_117(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	bVar0 = func_208(0);
	if (iParam2 != 0 && func_209(iParam0, bVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
void func_120(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0)
	{
		...
		else if (func_209(uParam0->f_1[iVar1 /*3*/], bVar2, iVar0, func_60() != -1) != -1)
		{
...
void func_184(int iParam0, int iParam1, int iParam2)
{
	...
	func_245(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC" /* GXTEntry: "Hold ~INPUT_FEED_INTERACT~ for details" */, func_244(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_162(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD" /* GXTEntry: "Cold" */, "PMPLAYER_CONDITION_TEMPERATURE_HOT" /* GXTEntry: "Hot" */);
					}
					break;
				case 2:
					return func_162(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD" /* GXTEntry: "Good" */, "PMPLAYER_CONDITION_HONOR_BAD" /* GXTEntry: "Bad" */);
			}
			break;
		case 1:
		case 2:
