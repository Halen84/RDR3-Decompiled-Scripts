...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.0875f, 0.1625f, 1.4875f, 0.0f, 3.345f, 3.06f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, -2.2875f, -5.8625f, 1.4875f, 0.0f, 1.2f, 1.2f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	iLocal_17 = func_152(uParam0, joaat("S_CRATESEAT03X"), -1.28962f, 0.762005f, -0.0126915f, 0, 1, 0, 1);
	func_152(uParam0, joaat("P_CS_SADDLE02X"), 0.0f, 0.0f, 0.0f, "p_cs_saddle02x", 0, 1, 1);
	func_152(uParam0, joaat("P_BRUSHHORSE01X"), 0.0f, 0.0f, 0.0f, "BRUSH", 0, 1, 1);
	...
	func_157(uParam0, iLocal_16, 3, joaat("WORLD_HUMAN_STARE_STOIC"), 0, -1, 1, 55.0f, 1065353216 /* Float: 1f */, 1);
...
void func_98(Vector3 vParam0, int iParam3)
{
	...
	while (iVar0 < Global_1911670)
	{
		...
		if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(iVar1))
		{
			...
			if (func_206(vVar2, vParam0, 2.0f, 1))
			{
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_207(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000.0f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_209(iParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_210(iParam0, 0));
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		PED::SET_PED_CONFIG_FLAG(func_225(iParam0), 137 /*PCF_0xE18960DE*/, true);
	}
}
...
void func_124(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		PED::SET_PED_CONFIG_FLAG(func_225(iParam0), 204 /*PCF_0x435F091E*/, true);
	}
	else
	{
		PED::SET_PED_CONFIG_FLAG(func_225(iParam0), 204 /*PCF_0x435F091E*/, false);
	}
}
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_225(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_227(iParam0) < 10000.0f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_143(var uParam0)
{
	...
	if (func_233(Global_1935630, (1 << 14)))
	{
		return true;
	}
	if (func_234(2))
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_240(uParam0->f_107[iVar0 /*113*/].f_1, (1 << 11)))
			{
				return true;
			}
...
{
	uParam0->f_23 = { func_247(iParam1) + Vector(fParam4, fParam3, fParam2) /*3*/ };
	uParam0->f_26 = { func_248(iParam1) /*3*/ };
}
...
int func_151(var uParam0, Vector3 vParam1, float fParam4, Vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_250(uParam0, vParam1) /*3*/ };
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_208(uParam0->f_107[iVar12 /*113*/].f_7, 1));
				}
			}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0 /*15*/].f_5 && !ENTITY::DOES_ENTITY_EXIST(uParam0->f_1711[iVar0 /*15*/].f_10))
			{
				...
				{
					vVar3 = { func_250(uParam0, uParam0->f_1711[iVar0 /*15*/].f_1) /*3*/ };
				}
				else
				{
...
void func_185(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_250(uParam0, uParam0->f_1976.f_1), 1, func_251(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
bool func_267(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1 /*15*/].f_5)
		{
			...
			{
				vVar2 = { func_250(uParam0, uParam0->f_1711[iVar1 /*15*/].f_1) /*3*/ };
			}
			else
			{
...
int func_287(int iParam0, struct<8> /*64*/ sParam1, int iParam9)
{
	int iVar0;
	var uVar1;
...
bool func_360(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_240(iParam0, (1 << 31)))
	{
		return true;
	}
	if (func_240(iParam0, (1 << 30)))
	{
		return true;
	}
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_SET_PERSCHAR_SCHEDULE(func_208(iParam0, 1), &cVar4);
				}
...
bool func_417(int iParam0, Vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489.f_12) || (bParam5 && Global_1359489.f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_208(iParam0, 1));
...
void func_419(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_225(iParam1), iParam0, false);
