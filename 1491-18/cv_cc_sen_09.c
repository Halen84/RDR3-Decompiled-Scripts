...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			vLocal_75 = { -144.0518f, -20.42944f, 95.08838f /*3*/ };
			break;
		case 2:
			func_150(uParam0, 701.3178f, -1234.53f, 43.9689f, 0.0f, 0.0f, -38.88f);
			vLocal_75 = { 678.2941f, -1248.784f, 43.00787f /*3*/ };
			break;
		default:
			return false;
	}
	...
	func_153(uParam0, 4.5375f, 3.1625f, 1.0f, 80.0f, 2.5f, 2.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	func_154(uParam0, joaat("P_STICKFIREPOKER01X"), 0.0f, 0.0f, 0.0f, "Stick", 0, 1, 1);
	...
	sLocal_45 = { func_159(uParam0, 4.618f, 3.518f, 1.07f, 80.88f, 6.5f, 0.345f, 0.4175f) /*10*/ };
	sLocal_25 = { func_159(uParam0, 4.618f, 3.518f, 1.07f, -122.78f, 6.09f, 0.075f, 0.66f) /*10*/ };
	sLocal_35 = { func_159(uParam0, 4.618f, 3.518f, 1.07f, -47.16f, 6.5f, 0.21f, 0.301f) /*10*/ };
	sLocal_55 = { func_159(uParam0, 4.618f, 3.518f, 1.07f, 164.0f, 6.5f, 0.1525f, 0.58f) /*10*/ };
	sLocal_65 = { func_159(uParam0, 4.618f, 3.518f, 1.07f, 44.0f, 6.5f, 0.0f, 0.7925f) /*10*/ };
...
bool func_86(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(func_8(uParam0, iLocal_24)))
	{
		...
		ENTITY::_SET_ENTITY_CARRYING_FLAG(func_8(uParam0, iLocal_24), 7, false);
		PED::SET_PED_CONFIG_FLAG(func_8(uParam0, iLocal_24), 243 /*PCF_0x0831CCD1*/, true);
...
bool func_93(var uParam0)
{
	...
	{
		if (func_199(uParam0, sLocal_25, 1, 0))
		{
			iLocal_23 = iLocal_17;
			func_189(uParam0, iLocal_23, 1);
		}
		else if (func_199(uParam0, sLocal_35, 1, 0))
		{
			iLocal_23 = iLocal_18;
			func_189(uParam0, iLocal_23, 1);
		}
		else if (func_199(uParam0, sLocal_45, 1, 0))
		{
			iLocal_23 = iLocal_19;
			func_189(uParam0, iLocal_23, 1);
		}
		else if (func_199(uParam0, sLocal_55, 1, 0))
		{
			iLocal_23 = iLocal_20;
			func_189(uParam0, iLocal_23, 1);
		}
		else if (func_199(uParam0, sLocal_65, 1, 0))
		{
			iLocal_23 = iLocal_21;
			func_189(uParam0, iLocal_23, 1);
		}
	...
	if (func_200(uParam0, iLocal_24))
	{
		...
		TASK::TASK_CARRIABLE(func_8(uParam0, iLocal_24), iLocal_80, func_8(uParam0, iLocal_14), 0, 0);
	}
	if (!bLocal_78)
	{
		if (func_201(uParam0, iLocal_14))
		{
			...
			{
				TASK::TASK_PLACE_CARRIED_ENTITY_AT_COORD(func_8(uParam0, iLocal_14), func_8(uParam0, iLocal_24), vLocal_75, 1.0f, 0);
				bLocal_78 = true;
			}
		}
	}
	if (bLocal_78)
	{
		if (TASK::GET_SCRIPT_TASK_STATUS(func_8(uParam0, iLocal_14), joaat("SCRIPT_TASK_PLACE_CARRIED_ENTITY_AT_COORD"), true) == 8 && !ENTITY::GET_CARRIABLE_ENTITY_STATE(func_8(uParam0, iLocal_24)) == 5)
		{
			func_202(uParam0, iLocal_14, 1, 1);
		}
		else if (!func_203(func_8(uParam0, iLocal_14), joaat("SCRIPT_TASK_PLACE_CARRIED_ENTITY_AT_COORD")))
		{
			TASK::TASK_PLACE_CARRIED_ENTITY_AT_COORD(func_8(uParam0, iLocal_14), func_8(uParam0, iLocal_24), vLocal_75, 1.0f, 0);
		}
	}
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_258(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_272(uParam0->f_107[iVar12 /*113*/].f_1));
				}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0 /*113*/].f_32.f_32 > -1)
			{
				...
				func_301(uParam0->f_107[iVar0 /*113*/].f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
...
bool func_199(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
void func_202(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_307(100.0f, 140.0f);
			}
		}
		...
		else if (func_20(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_373(&iVar2, func_372(iVar3)))
					{
...
int func_350(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_387(fVar9) /*3*/ };
			vVar13 = { func_388(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) /*3*/ };
...
int func_392(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_417(iParam0) && func_418(iParam0, &cVar4))
				{
...
void func_394(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_424(func_104(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_425(iParam0);
...
bool func_401(int iParam0, Vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_435(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) /*7*/ };
			if (!bParam6)
			{
				func_102(iParam0, 44, 1);
			}
...
void func_408(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_449(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_449(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
void func_422(int iParam0, int iParam1)
{
	...
	func_394(iParam1, func_450(iParam1, (1 << 13)), func_450(iParam1, (1 << 14)), 1);
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_395(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<7> /*56*/ func_435(int iParam0, int iParam1, Vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	struct<7> /*56*/ sVar0;
...
int func_449(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
