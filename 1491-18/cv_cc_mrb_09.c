...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.9125f, -1.625f, 0.85f, -14.5f, 1.0f, 1.0f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	iLocal_24 = func_152(uParam0, joaat("P_CS_SOCK01X"), 0.0f, 0.0f, 0.0f, "p_cs_sock", 0, 0, 1);
	iLocal_23 = func_152(uParam0, joaat("P_CS_SOCK01X"), 0.0f, 0.0f, 0.0f, "p_cs_sock1", 0, 0, 1);
	iLocal_21 = func_152(uParam0, joaat("P_CHAIR_CRATE15X"), -0.93809f, -1.52663f, -0.00883484f, 0, 1, 0, 1);
	iLocal_22 = func_152(uParam0, joaat("P_CHAIR_CRATE02X"), 0.0f, 0.0f, 0.0f, 0, 1, 0, 1);
	...
	func_156(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_B", iLocal_22, 0, -1073741824 /* Float: -2f */, 0.0f, 1);
	...
	func_156(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", iLocal_21, 0, -1073741824 /* Float: -2f */, 0.0f, 1);
	func_157(uParam0, iLocal_14, iLocal_23, "p_cs_sock01x_PH_L_HAND", 0, 0);
	sLocal_25 = { func_158(uParam0, -0.175f, -0.7325f, 0.564f, 67.5f, 6.6675f, 0.297f, 0.35f) /*10*/ };
	sLocal_35 = { func_158(uParam0, -0.175f, -0.733f, 0.564f, 124.92f, 6.6675f, 0.176f, 0.35f) /*10*/ };
	sLocal_45 = { func_158(uParam0, -0.175f, -0.733f, 0.564f, 165.96f, 6.6675f, 0.191f, 0.287f) /*10*/ };
	sLocal_55 = { func_158(uParam0, -0.175f, -0.733f, 0.564f, -146.52f, 6.6675f, 0.6125f, 0.35f) /*10*/ };
...
bool func_93(var uParam0)
{
	if (func_196(uParam0, iLocal_16))
	{
		...
		else if (func_197(uParam0, sLocal_55, 1, 0))
		{
			func_188(uParam0, iLocal_20, 1);
		}
		else if (func_197(uParam0, sLocal_45, 1, 0))
		{
...
void func_198(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_302(100.0f, 140.0f);
			}
		}
...
int func_347(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_385(fVar9) /*3*/ };
			vVar13 = { func_386(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) /*3*/ };
...
bool func_419(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_EQUIP_META_PED_OUTFIT(iParam1, func_449(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, false, true, true, true, false);
...
void func_420(int iParam0, int iParam1)
{
	...
	func_392(iParam1, func_448(iParam1, (1 << 13)), func_448(iParam1, (1 << 14)), 1);
}
...
void func_422(int iParam0, float fParam1, bool bParam2)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		fParam1 = func_451(fParam1, 0.0f, 1.0f);
...
void func_445(int iParam0)
{
	...
	func_462(iParam0, (1 << 9));
	func_462(iParam0, (1 << 10));
	func_462(iParam0, (1 << 11));
	func_462(iParam0, (1 << 12));
	func_462(iParam0, (1 << 16));
	func_462(iParam0, (1 << 14));
	func_462(iParam0, (1 << 18));
	func_462(iParam0, (1 << 19));
	func_462(iParam0, (1 << 20));
	func_462(iParam0, (1 << 21));
	func_462(iParam0, (1 << 15));
	func_462(iParam0, (1 << 17));
	func_462(iParam0, (1 << 27));
	func_462(iParam0, (1 << 30));
}
...
int func_447(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == joaat("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case joaat("GROUP_SHOTGUN"):
			case joaat("GROUP_RIFLE"):
				if (func_464(joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */))
				{
	...
	{
		func_465(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0.0f;
...
int func_465(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
	...
	{
		sVar0 = { func_472(iParam0, 0, 1) /*5*/ };
		iVar5 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
		sVar6.f_9 = joaat("SLOTID_NONE");
		iVar28 = 0;
		while (iVar28 < 4)
		{
			iVar5 = func_473((398 + iVar28), 1);
			if (func_474(iParam0, &sVar0, iVar5, 0))
			{
				if (func_475(iParam0, &sVar6, iVar5))
				{
					sVar29 = { func_476(iParam0, sVar0, iVar5, 0) /*4*/ };
					func_477(iParam0, &sVar29, &sVar0, 1, joaat("REMOVE_REASON_DEFAULT"), 1, 0);
				}
				else
				{
					iVar28++;
...
struct<5> /*40*/ func_472(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;
	...
	switch (func_484(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_476(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_486(iParam0, 1))
			{
				...
				if (!func_474(iParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_474(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_475(iParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_489(iParam0, joaat("CI_CATEGORY_CAMP")))
			{
				sVar0 = { func_476(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("KIT_CAMP") /* GXTEntry: "Camp" */);
			}
			else if (func_489(iParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_476(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("WARDROBE") /* GXTEntry: "Wardrobe" */);
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_490(sVar0, &sVar27, bParam1, 0))
				{
					sVar0.f_4 = 0;
				}
				else
...
struct<4> /*32*/ func_476(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_494(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}
...
bool func_477(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!func_490(*uParam1, &sVar0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_494(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
void func_480(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_497(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> /*32*/ func_485(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_476(joaat("CARRIED_WEAPONS"), func_483(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_476(joaat("CARRIED_WEAPONS"), func_483(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_476(joaat("CARRIED_WEAPONS"), func_483(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_486(int iParam0, bool bParam1)
{
	if (func_488(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
struct<4> /*32*/ func_487(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_476(joaat("EMOTE_ITEM"), func_483(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_476(joaat("EMOTE_ITEM"), func_483(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
bool func_490(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_494(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_491(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	iVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_494(bParam6), &sVar0, false);
	return iVar4;
}
...
bool func_492(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_494(0);
	*uParam1 = { func_476(iParam0, func_485(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
