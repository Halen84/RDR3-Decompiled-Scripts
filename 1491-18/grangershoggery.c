...
bool func_11()
{
	iLocal_14 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-73.33932f, -398.9078f, 72.24845f, 0.0f, 0.0f, 66.15892f, 99.58835f, 86.51411f, 42.63912f, "Granger's Hoggery - m_volTown");
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		iLocal_17 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Granger's Hoggery - m_volRancherThreat Agg");
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -68.82082f, -387.3279f, 72.49265f, 0.0f, 0.0f, 48.19205f, 0.916038f, 0.967821f, 6.513287f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -77.56838f, -392.186f, 72.49265f, 0.0f, 0.0f, 48.19205f, 2.563069f, 2.387336f, 6.513287f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -75.34951f, -388.4147f, 72.1382f, 0.0f, 0.0f, 22.97115f, 4.397328f, 4.863138f, 6.900121f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -62.42026f, -409.1303f, 68.97523f, 0.0f, 0.0f, 13.57845f, 13.41282f, 8.335032f, 6.900121f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -62.5439f, -392.4335f, 72.1382f, 0.0f, 0.0f, 29.04495f, 7.979648f, 6.063315f, 6.900121f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -68.68666f, -377.174f, 72.1382f, 0.0f, 0.0f, 76.32537f, 1.587863f, 1.493361f, 5.424076f);
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, -66.34515f, -395.8655f, 72.49265f, 0.0f, 0.0f, 20.19842f, 20.50491f, 22.65399f, 6.513287f);
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -66.34515f, -395.8655f, 72.49265f, 0.0f, 0.0f, 20.19842f, 44.28191f, 42.39419f, 6.513287f);
...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_107(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_107(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_107(&cVar6, joaat("COLOR_PURE_WHITE")), func_107(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
char* func_107(char* sParam0, int iParam1)
{
	...
	return func_143(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}
...
struct<2> /*16*/ func_112(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_123(int iParam0)
{
	...
	func_150(iParam0, (1 << 13));
	func_150(iParam0, (1 << 14));
	func_150(iParam0, (1 << 15));
	func_150(iParam0, (1 << 17));
	func_150(iParam0, (1 << 24));
	func_150(iParam0, (1 << 19));
	func_150(iParam0, (1 << 20));
...
bool func_137(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_87(iVar0) && func_166(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
bool func_167(Vector3 vParam0, int iParam3)
{
	...
	func_183(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_184(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
