					...
					case 3:
						...
						if (((func_68(&iLocal_168, iLocal_159, 2547.9f, -1215.18f, 52.3135f) & func_71(&(uLocal_164[0]), iLocal_160, &iVar0, func_69(0), func_70(0), 2, 0, 1)) & func_71(&(uLocal_164[1]), iLocal_161, &iVar0, func_69(1), func_70(1), 1, 0, 1)) & func_71(&(uLocal_164[2]), iLocal_162, &iVar0, func_69(2), func_70(2), 2, 0, 1))
						{
							if (((func_5(bLocal_163, 0) && func_5(uLocal_164[0], 0)) && func_5(uLocal_164[1], 0)) && func_5(uLocal_164[2], 0))
							{
								...
								func_79(&bLocal_163, &uLocal_183, joaat("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20.0f, -1082130432 /* Float: -1f */);
								if (func_64())
								{
...
int func_177(int iParam0)
{
	...
	iVar1 = 0;
	iVar0 = func_286(&bLocal_163, &(sLocal_256[iParam0 /*59*/]), 12.0f, &(sLocal_256[iParam0 /*59*/].f_21), 0.0f, 2, sLocal_256[iParam0 /*59*/].f_57, iVar1, sLocal_256[iParam0 /*59*/].f_56, 0, 0, 2, -1082130432 /* Float: -1f */);
	if (func_287())
	{
...
int func_499(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_475(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_503(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
