...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -2.2186f, -6.6304f, 1.0f, 0.0f, 1.0f, 1.0f, 2.75f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	func_151(uParam0, -0.44f, -0.875f, 0.0f, 65.0f, 2.765f, 1.745f, 4.0f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, -0.345f, -0.872f, 1.311f, 54.769f, 1.595358f, 1.221463f, 1.711148f, joaat("VOLCYLINDER"), 1);
	func_153(uParam0, joaat("P_CHAIR_CRATE15X"), -0.938435f, -1.52674f, -0.00881958f, "CRATE" /* GXTEntry: "Crate" */, 1, 0, 1);
	func_153(uParam0, joaat("P_CIGARETTE01X"), 0.0f, 0.0f, 0.0f, "CIGARETTE", 0, 0, 1);
	iLocal_16 = func_153(uParam0, joaat("P_CHAIR_CRATE02X"), 0.0f, 0.0f, 0.0f, 0, 1, 0, 1);
	iLocal_17 = func_153(uParam0, joaat("P_CS_BOOK04X"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 0, 1);
