	...
	switch (iParam0->f_4)
	{
		case 0:
			...
			while (iVar0 < 4)
			{
				...
				{
					PED::SET_PED_CONFIG_FLAG(iVar2, 113 /*PCF_DisableShockingEvents*/, true);
				}
				iVar0++;
			}
...
void func_197(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam2->f_12[iVar0 /*40*/].f_4)
	{
		...
		case 2:
			...
			break;
		case 3:
			if (func_260(uParam1, "Pickup" /* GXTEntry: "Pick up" */))
			{
...
int func_255(var uParam0, var uParam1, char* sParam2, bool bParam3)
{
	...
	sVar1.f_0 = iVar36;
	sVar1.f_1 = joaat("DEFAULT"); /* GXTEntry: "_" */
...
int func_267(var uParam0, int iParam1, Vector3 vParam2, int iParam5)
{
	...
	if (ENTITY::_IS_ENTITY_PLAYING_ANY_ANIM(iParam1, 1))
	{
