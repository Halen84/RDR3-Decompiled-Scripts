...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.3766f, -1.0093f, 1.0122f, -22.5144f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	func_151(uParam0, -3.4501f, 4.1917f, 1.0412f, -108.0f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	func_152(uParam0, 0.9f, -0.6f, 0.0f, 0.0f, 1.0f, 1.0f, 2.0f, joaat("VOLCYLINDER"), 1);
	iLocal_19 = func_153(uParam0, joaat("P_CHAIR_BARREL04B"), -0.482346f, -1.0508f, -0.000579834f, "BARREL", 1, 0, 1);
	iLocal_16 = func_153(uParam0, joaat("P_BOTTLEJD01X"), 0.0f, 0.0f, 0.0f, "BOTTLE", 0, 1, 1);
	func_153(uParam0, joaat("P_CIGAR01X"), 0.0f, 0.0f, 0.0f, "CIGAR", 0, 1, 1);
	if (!func_154(14))
	{
...
{
	vLocal_20 = { ENTITY::GET_ENTITY_COORDS(func_180(uParam0, iLocal_19), true, false) /*3*/ };
	vLocal_23 = { ENTITY::GET_ENTITY_ROTATION(func_180(uParam0, iLocal_19), 2) /*3*/ };
	return true;
}
...
bool func_95(var uParam0)
{
	if (ENTITY::IS_ENTITY_OCCLUDED(func_180(uParam0, iLocal_19)))
	{
		...
		{
			func_111(&uLocal_26, 0.0f);
		}
		if (func_109(&uLocal_26) > 5.0f)
		{
...
void func_159(var uParam0, int iParam1, Vector3 vParam2, float fParam5, int iParam6, bool bParam7)
{
	if (bParam7)
	{
		vParam2 = { func_259(uParam0, vParam2) /*3*/ };
...
{
	func_262(uParam0, iParam1, 0, 0, 0, -1, 0, 0.0f, 1065353216 /* Float: 1f */, 1);
}
