...
{
	func_33(uParam0, 10766, 10824, 11723);
}
...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_47(uParam0, 0, "DCCP_CAT", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 4.0f, 3.5f, 0.0f), (90.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "DCCP_DOG", iLocal_11, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (TASK::IS_PED_ACTIVE_IN_SCENARIO(uParam0->f_20[1 /*14*/], 1))
	{
		...
		{
			TASK::REACT_LOOK_AT(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 1, 1, 25.0f, 1, 0, 0, 0);
		}
	}
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				iLocal_15[0] = func_66(iLocal_12, uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, 0, 0);
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[0 /*14*/], iLocal_15[0], 0, 0, false, true, 0, false, -1.0f, false);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				iLocal_15[1] = func_66(iLocal_13, uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, 0, 0);
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[1 /*14*/], iLocal_15[1], 0, 0, false, true, 0, false, -1.0f, false);
		...
		case 1:
			if (func_68(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				...
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uParam0->f_20[0 /*14*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_20[0 /*14*/], 0.0f, 3.5f, 0.0f), 1.0f, -1, 0.25f, (1 << 13), 40000.0f);
				func_69(&uLocal_18);
				iLocal_9 = 2;
			}
			break;
		case 2:
			if (!func_70(uParam0->f_20[0 /*14*/], joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD")))
			{
			...
			break;
		case 3:
			if (func_71(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 1) < 16.0f && func_72(&uLocal_18, 2.0f))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					...
					TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 0, 256, -1.0f, -1, 0);
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, uParam0->f_20[0 /*14*/], 0.0f, 3.5f, 0.0f, 1.2f, iLocal_14, 0.1f, true, true, true, true, true, false);
					func_74(0, iLocal_13, uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, 1, 0, 0, -1082130432 /* Float: -1f */);
...
int func_32(var uParam0, var uParam1)
{
	...
	while (iVar0 < uParam0->f_19)
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_15[iVar0]))
		{
			TASK::_DELETE_SCENARIO_POINT(iLocal_15[iVar0]);
		}
		iVar0++;
	}
	return 1;
...
int func_66(int iParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, bool bParam7)
{
