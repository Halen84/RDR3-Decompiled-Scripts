...
bool func_11()
{
	...
	iLocal_15 = VOLUME::CREATE_VOLUME_CYLINDER(1411.869f, -7032.472f, 71.50774f, 0.0f, 0.0f, -25.35288f, 142.4495f, 133.1683f, 45.87774f);
	return true;
}
...
void func_66(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_53(iParam0) && func_58(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
...
void func_91(struct<16> /*128*/ sParam0, int iParam16)
{
	int iVar0;
...
bool func_183(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_199(&(Global_1109000.f_4), iVar0, 5);
	}
	if (iParam1 == func_200())
	{
		return func_199(&(Global_1109000.f_4), iVar0, 5);
	...
	{
		return func_199(&(Global_1108108[iParam1 /*27*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_188(Vector3 vParam0, int iParam3)
{
	...
	func_202(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_203(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
