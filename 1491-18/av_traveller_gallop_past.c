...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 37:
			...
			iVar0 = func_49(joaat("HORSE_CLASS_RIDING") /* GXTEntry: "Riding" */, 1);
			break;
		case 49:
...
int func_31(var uParam0)
{
	...
	switch (iLocal_9)
	{
		case 0:
			...
			{
				fVar0 = func_72(uParam0->f_20[0 /*14*/].f_5);
...
float func_72(Vector3 vParam0)
{
	...
	PATHFIND::GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(vParam0, &uVar1, &fVar0, 1, 3.0f, 0.0f);
	vVar4 = { Global_36 - vParam0 /*3*/ };
	vVar4.f_2 = 0.0f;
	vVar4 = { func_109(vVar4) /*3*/ };
	vVar7 = { -BUILTIN::SIN(fVar0), BUILTIN::COS(fVar0), 0.0f /*3*/ };
	if (func_110(vVar4, vVar7) < 0.0f)
	{
		fVar0 += 180.0f;
	}
	return fVar0;
...
int func_73(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_111(*uParam0, 0.0f, 0.0f, 0.0f))
	{
		return 1;
	}
	iVar1 = 0;
...
float func_110(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5)
{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if ((*uParam0 & 16) != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_182(1) || (*uParam0 & (1 << 13)) != 0))
				{
					func_9(uParam0, (1 << 25));
				}
			}
...
bool func_143(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_191(iParam0, !(*uParam1 & (1 << 28)) != 0, !(*uParam1 & (1 << 29)) != 0, !(*uParam1 & (1 << 30)) != 0, 0, 0))
		{
...
bool func_144(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85.0f;
	if (func_195(iParam1, !(*uParam2 & (1 << 28)) != 0, !(*uParam2 & (1 << 29)) != 0, !(*uParam2 & (1 << 30)) != 0, 0))
	{
...
bool func_149(int iParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < (float)func_198(uParam2))
	{
...
bool func_157(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_208(iParam0, iParam1, 1, 1) < 4.0f)
		{
		...
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(iVar0, &iVar5, &iVar4))
		{
			...
			else if (iVar4 == iVar5)
			{
				...
				while (iVar6 < iVar4)
				{
					...
					{
						if (func_210(iVar7, vVar1, 1) < 3.0f)
						{
		...
		case joaat("EVENT_SHOCKING_ENTITY_HOGTIED"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(iParam0, iVar4, -1.0f, -1.0f, -1.0f, -1.0f) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(iParam0, Global_35, -1.0f, -1.0f, -1.0f, -1.0f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iVar4, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					...
					{
						if (func_210(iVar4, Global_36, 1) < 7.0f)
						{
							return true;
						}
					}
...
bool func_191(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_208(iVar0, iParam0, 1, 1) <= 4.0f)
		{
			return true;
		}
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(iParam0, Global_35, -1.0f, -1.0f, -1.0f, -1.0f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
			{
				...
				{
					if (func_210(iVar1, Global_36, 1) < 5.0f)
					{
						return true;
					}
				}
