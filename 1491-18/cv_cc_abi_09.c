...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 10.8f, 6.13f, 0.0f, 19.44f, 1.2f, 1.75f, 3.0f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, 10.3375f, 6.425f, 0.95f, 108.7394f, 2.71f, 1.9675f, 1.38f, joaat("VOLCYLINDER"), 1);
	if (!func_153(15))
	{
	...
	sLocal_22 = { func_160(uParam0, 10.7666f, 6.7217f, 0.1771f, 111.24f, 7.0f, 0.402f, 0.438f) /*10*/ };
	sLocal_32 = { func_160(uParam0, 10.767f, 6.722f, 0.177f, -158.4f, 7.0f, 0.0f, 0.6f) /*10*/ };
	sLocal_42 = { func_160(uParam0, 10.767f, 6.722f, 0.177f, 17.64f, 7.0f, 0.6f, 0.0f) /*10*/ };
	func_161(uParam0, 1);
	if (func_153(15))
	{
...
bool func_87(var uParam0)
{
	...
	return (func_195(func_48(uParam0, iLocal_14), Global_35, 1, 20.0f, 0) && !func_196(Global_35, 1));
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_205(uParam0, sLocal_22, 1, 1))
		{
			func_194(uParam0, iLocal_18, 1);
		}
		else if (func_205(uParam0, sLocal_32, 1, 1))
		{
			func_194(uParam0, iLocal_19, 1);
		}
		else if (func_205(uParam0, sLocal_42, 1, 1))
		{
...
{
	func_261(uParam0, iParam1, 0, 0, 0, -1, 0, 0.0f, 1065353216 /* Float: 1f */, 1);
}
...
bool func_195(int iParam0, int iParam1, bool bParam2, float fParam3, bool bParam4)
{
	if (bParam2)
	{
		if (!func_299(iParam0, iParam1, 0.0f))
		{
			return false;
		}
	}
...
bool func_204(var uParam0, int iParam1)
{
	...
	if (func_308(uParam0, iParam1, 1.0f))
	{
		return true;
	}
...
void func_211(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_308(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
void func_281(var uParam0, int iParam1)
{
	...
	else if (!func_342(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
	{
...
bool func_312(var uParam0, int iParam1)
{
	...
	{
		if (!func_342(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_ANY")))
		{
			return true;
		}
	}
...
int func_388(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_420(fVar9) /*3*/ };
			vVar13 = { func_421(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) /*3*/ };
...
bool func_428(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_EQUIP_META_PED_OUTFIT(iParam1, func_460(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, false, true, true, true, false);
...
void func_429(int iParam0, int iParam1)
{
	...
	func_397(iParam1, func_459(iParam1, (1 << 13)), func_459(iParam1, (1 << 14)), 1);
}
...
void func_431(int iParam0, float fParam1, bool bParam2)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		fParam1 = func_462(fParam1, 0.0f, 1.0f);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_332(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_398(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_476(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	{
		sVar0 = { func_483(iParam0, 0, 1) /*5*/ };
		iVar5 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
		sVar6.f_9 = joaat("SLOTID_NONE");
		iVar28 = 0;
		while (iVar28 < 4)
		{
			iVar5 = func_484((398 + iVar28), 1);
			if (func_485(iParam0, &sVar0, iVar5, 0))
			{
				if (func_486(iParam0, &sVar6, iVar5))
				{
					sVar29 = { func_487(iParam0, sVar0, iVar5, 0) /*4*/ };
					func_488(iParam0, &sVar29, &sVar0, 1, joaat("REMOVE_REASON_DEFAULT"), 1, 0);
				}
				else
				{
					iVar28++;
...
struct<5> /*40*/ func_483(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;
	...
	switch (func_495(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_487(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_497(iParam0, 1))
			{
				...
				if (!func_485(iParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_485(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_486(iParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_500(iParam0, joaat("CI_CATEGORY_CAMP")))
			{
				sVar0 = { func_487(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("KIT_CAMP") /* GXTEntry: "Camp" */);
			}
			else if (func_500(iParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_487(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("WARDROBE") /* GXTEntry: "Wardrobe" */);
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_501(sVar0, &sVar27, bParam1, 0))
				{
					sVar0.f_4 = 0;
				}
				else
...
struct<4> /*32*/ func_487(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_505(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}
...
bool func_488(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!func_501(*uParam1, &sVar0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_505(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
void func_491(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_508(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> /*32*/ func_496(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_487(joaat("CARRIED_WEAPONS"), func_494(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_487(joaat("CARRIED_WEAPONS"), func_494(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_487(joaat("CARRIED_WEAPONS"), func_494(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_497(int iParam0, bool bParam1)
{
	if (func_499(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
struct<4> /*32*/ func_498(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_487(joaat("EMOTE_ITEM"), func_494(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_487(joaat("EMOTE_ITEM"), func_494(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
bool func_501(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_505(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_502(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	sVar0 = { func_487(iParam0, sParam1, iParam5, bParam6) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&sVar0))
	{
		return 0;
	}
	iVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_505(bParam6), &sVar0, false);
	return iVar4;
}
...
bool func_503(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_505(0);
	*uParam1 = { func_487(iParam0, func_496(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
