...
void func_5(int iParam0)
{
	...
	iVar0 = func_16(MISC::VAR_STRING(10, "ITEM_TASTED_PUMP_MULT" /* GXTEntry: "~2~x TASTED ~1~" */, MISC::VAR_STRING(0, func_15(func_14(iParam0))), 1), "", 0, 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
