...
bool func_11()
{
	if (func_20() == -1)
	{
		iLocal_9 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2842.175f, 139.552f, 183.0f, 0.0f, 0.0f, 20.486f, 13.713f, 16.738f, 5.708f, "Big Valley Trapper - m_volTrapper");
		iLocal_10 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2842.312f, 137.292f, 184.743f, 0.0f, 0.0f, 19.872f, 1.827f, 3.338f, 3.076f, "Big Valley Trapper - m_volTrapperPrompt");
		iLocal_11 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2845.167f, 136.356f, 184.743f, 0.0f, 0.0f, 19.872f, 2.976f, 4.365f, 3.076f, "Big Valley Trapper - m_volTrapperOfflimits");
	}
	return true;
}
...
void func_39(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0.0f, 0.0f, 0.0f) <= 5.0f || func_54(Global_1935630, (1 << 14))) || func_54(Global_1935630, (1 << 23)))
	{
		return;
	}
...
void func_50(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	vVar1 = { func_86(iVar0) /*3*/ };
	vVar4 = { func_87(iVar0) /*3*/ };
	if (func_88(vVar1))
	{
		return;
	}
...
bool func_56()
{
	return func_54(Global_1935630, (1 << 12));
}
...
void func_61(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_52(iParam0) && func_78(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_118(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_118(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_118(&cVar6, joaat("COLOR_PURE_WHITE")), func_118(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
bool func_95(int iParam0, int iParam1)
{
	...
	if (func_89(iParam0, (1 << 14)) && !func_155(iParam0, 1))
	{
		return true;
	}
	if (!func_82(iParam1))
...
char* func_118(char* sParam0, int iParam1)
{
	...
	return func_173(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_119(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_123(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_133(int iParam0)
{
	...
	func_181(iParam0, (1 << 13));
	func_181(iParam0, (1 << 14));
	func_181(iParam0, (1 << 15));
	func_181(iParam0, (1 << 17));
	func_181(iParam0, (1 << 24));
	func_181(iParam0, (1 << 19));
	func_181(iParam0, (1 << 20));
...
void func_147(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_162(iParam0, (1 << 10)))
		{
			func_163(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_162(iParam0, (1 << 10)))
	{
...
bool func_204(Vector3 vParam0, int iParam3)
{
	...
	func_216(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_217(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
