				...
				case 6:
					if (func_7(func_6(iLocal_18)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_18 /*35*/].f_11 > 0.0f)
							{
...
bool func_11()
{
	iLocal_14 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-337.0264f, -358.9087f, 88.0646f, 0.0f, 0.0f, 0.0f, 94.2006f, 77.56374f, 227.0f, "m_volSwansonStation");
	return true;
}
...
int func_51(var uParam0, bool bParam1, int iParam2)
{
	...
	bVar1 = func_91(uParam0->f_1, (1 << 17));
	func_92(uParam0->f_1);
	...
	if (bParam1)
	{
		func_94(uParam0->f_1, (1 << 16));
		if ((uParam0->f_1 == 1 || uParam0->f_1 == 2) || uParam0->f_1 == 0)
		{
			func_94(uParam0->f_1, (1 << 21));
		}
	}
	if (bVar1)
	{
		func_94(uParam0->f_1, (1 << 17));
	}
...
void func_62(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_116(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_116(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_116(&cVar6, joaat("COLOR_PURE_WHITE")), func_116(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
char* func_116(char* sParam0, int iParam1)
{
	...
	return func_159(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_117(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
void func_130(int iParam0)
{
	...
	func_166(iParam0, (1 << 13));
	func_166(iParam0, (1 << 14));
	func_166(iParam0, (1 << 15));
	func_166(iParam0, (1 << 17));
	func_166(iParam0, (1 << 24));
	func_166(iParam0, (1 << 19));
	func_166(iParam0, (1 << 20));
