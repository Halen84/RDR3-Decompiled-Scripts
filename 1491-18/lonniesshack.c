...
bool func_11()
{
	iLocal_14 = VOLUME::CREATE_VOLUME_CYLINDER(1621.408f, -369.203f, 77.527f, 0.0f, 0.0f, 0.0f, 55.0f, 50.0f, 20.0f);
	return true;
}
...
void func_65(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_55(iParam0) && func_82(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
...
char* func_115(char* sParam0, int iParam1)
{
	...
	return func_158(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}
...
bool func_152(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_182(iVar0) && func_187(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_169(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		{
			func_198(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_197(iParam0, (1 << 10)))
	{
...
int func_178(struct<2> /*16*/ sParam0, var uParam2)
{
	int iVar0;
...
bool func_189(Vector3 vParam0, int iParam3)
{
	...
	func_207(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_208(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
