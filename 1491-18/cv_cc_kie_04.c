...
bool func_72(var uParam0)
{
	...
	iLocal_15 = func_151(uParam0, joaat("P_CS_ROPE03BX"), 0.0f, 0.0f, 0.0f, "p_cs_rope03x", 0, 0, 1);
	func_152(uParam0, 0.3002f, -4.1348f, 0.9471f, 122.283f, 1.0f, 1.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	...
	func_156(uParam0, iLocal_14, 2, joaat("WORLD_CAMP_KIERAN_TREE_TIED"), "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1, -1.0f, 1065353216 /* Float: 1f */, 1);
	...
	iLocal_16 = func_162(uParam0, -2.6375f, -2.2877f, 1.0f, 0.0f, 0.0f, 0.0f, 4.0f, 9.9f, 5.0f, "TRIGGER", joaat("VOLBOX"));
	func_163(uParam0, 1);
	func_164(uParam0, iLocal_14, 1094713344 /* Float: 12f */, 1092616192 /* Float: 10f */);
	if (func_165(1))
	{
		uParam0->f_14 = 1;
	}
...
bool func_204(var uParam0, int iParam1)
{
	...
	{
		if (!func_307(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_ANY")))
		{
			return true;
		}
	}
...
void func_280(var uParam0, int iParam1)
{
	...
	else if (!func_307(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
	{
