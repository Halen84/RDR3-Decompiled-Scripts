...
bool func_28(var uParam0)
{
	...
	if ((!uParam0->f_469[3] && ENTITY::GET_ENTITY_SPEED(Global_35) < 8.0f) && func_60(uParam0, 1065353216 /* Float: 1f */, 25.0f, 4, 5.0f, 15.0f))
	{
		func_61(*uParam0, 0);
		uParam0->f_469[3] = 1;
		func_62(uParam0);
...
{
	func_122(Global_35, uParam0->f_20[0 /*14*/], &uLocal_39, 0.0f, 0.0f, 0.0f, 0, 0, 1, 1069547520 /* Float: 1.5f */, -1082130432 /* Float: -1f */, 1073069561, 1056964608 /* Float: 0.5f */, 1092616192 /* Float: 10f */, -1, 1, 0, 0, 0, 1);
	func_123(uParam0->f_20[0 /*14*/], Global_35, &uLocal_39, -1082130432 /* Float: -1f */, 0, 0, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1, 8, 0, 0, 1069547520 /* Float: 1.5f */, (1 << 30), 1050253722 /* Float: 0.3f */, 1067030938 /* Float: 1.2f */, 0, 0, -1, 1, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1);
	func_124(&cLocal_77);
}
...
void func_140(int iParam0, Vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_151(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
