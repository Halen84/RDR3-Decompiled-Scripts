...
{
	func_33(uParam0, 10741, 10792, 11607);
}
...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_47(uParam0, 0, "SWCMP_WOLF", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.0f, -18.5f, 0.0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
...
int func_31(var uParam0)
{
	...
	switch (iLocal_11)
	{
		case 0:
			...
			{
				iLocal_12[0] = func_63(joaat("STAND"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, 0, 0);
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[0 /*14*/], iLocal_12[0], 0, 0, false, true, 0, false, -1.0f, false);
				TASK::_SET_SCENARIO_POINT_FLAG(iLocal_12[0], 20, true);
				TASK::_SET_SCENARIO_POINT_FLAG(iLocal_12[0], 25, true);
				TASK::_SET_SCENARIO_POINT_FLAG(iLocal_12[0], 23, true);
				TASK::SET_PED_PATH_PREFER_TO_AVOID_WATER(uParam0->f_20[0 /*14*/], false, 1.0f);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				iLocal_12[1] = func_63(joaat("STAND"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, 0, 0);
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[1 /*14*/], iLocal_12[1], 0, 0, false, true, 0, false, -1.0f, false);
				TASK::_SET_SCENARIO_POINT_FLAG(iLocal_12[1], 20, true);
		...
		case 1:
			...
			{
				func_62(uParam0);
				vLocal_15 = { func_66(uParam0) /*3*/ };
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
				{
					func_64(&(uParam0->f_20[1 /*14*/]), 1, 1);
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_20[1 /*14*/], 0.0f, 20.0f, 0.0f), 3.0f, -1, 0.25f, 8193, 40000.0f);
					TASK::TASK_FLEE_PED(0, uParam0->f_20[0 /*14*/], 3, 256, -1.0f, -1, 0);
				...
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					func_64(&(uParam0->f_20[0 /*14*/]), 1, 1);
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, uParam0->f_20[1 /*14*/], 0.0f, 5.0f, 0.0f, 2.0f, 12000, 0.1f, true, true, false, true, true, false);
		...
		case 4:
			if (!bLocal_18)
			{
				if (func_69(uParam0->f_20[0 /*14*/], Global_35, 1) < 225.0f)
				{
					func_64(&(uParam0->f_20[0 /*14*/]), 0, 1);
					bLocal_18 = true;
				}
			}
			if (!func_70(uParam0->f_20[0 /*14*/], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
			{
				return 1;
			}
			break;
...
int func_63(int iParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, bool bParam7)
{
...
Vector3 func_66(var uParam0)
{
	...
	fVar3 = 1E+11f;
	vVar4[0 /*3*/] = { -2447.719f, -521.309f, 141.189f /*3*/ };
	vVar4[1 /*3*/] = { 619.494f, 2197.675f, 221.987f /*3*/ };
	vVar4[1 /*3*/] = { -1872.153f, 1824.989f, 234.83f /*3*/ };
	iVar11 = 0;
...
bool func_74(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, Vector3 vParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
bool func_99(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (Global_1935630.f_26 & func_132(PLAYER::PLAYER_ID(), 0, 1, (uParam2->f_1 & (1 << 19)) == 0))
		{
