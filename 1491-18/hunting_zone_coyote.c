		...
		else
		{
			if (uParam0->f_619 && uParam0->f_11 == 8)
			{
				if (func_21(Global_35) && ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(func_22(Global_35)) == uParam0->f_12)
				{
					...
					func_27(func_26(joaat("SKINNED") /* GXTEntry: "Skinned 1 ~a~" */, func_24(*uParam0)), 1);
...
bool func_5(var uParam0)
{
	...
	if (uParam0->f_11 > 0)
	{
		...
		if (func_34() || func_35(Global_1935630, (1 << 17)))
		{
			bVar0 = true;
		}
...
int func_15(int iParam0)
{
	...
	{
		case 0:
			return joaat("MAP_ANIMAL_LEGENDARY_BEAR");
		case 1:
			return joaat("MAP_ANIMAL_LEGENDARY_BEAVER");
		case 2:
			return joaat("MAP_ANIMAL_LEGENDARY_BIG_HORN");
		case 3:
			return joaat("MAP_ANIMAL_LEGENDARY_WHITE_BUFFALO");
		case 4:
			return joaat("MAP_ANIMAL_LEGENDARY_BOAR");
		case 5:
			return joaat("MAP_ANIMAL_LEGENDARY_BUCK");
		case 6:
			return joaat("MAP_ANIMAL_LEGENDARY_BUFFALO");
		case 7:
			return joaat("MAP_ANIMAL_LEGENDARY_BULLGATOR");
		case 8:
			return joaat("MAP_ANIMAL_LEGENDARY_COUGAR");
		case 9:
			return joaat("MAP_ANIMAL_LEGENDARY_COYOTE");
		case 10:
			return joaat("MAP_ANIMAL_LEGENDARY_ELK");
		case 11:
			return joaat("MAP_ANIMAL_LEGENDARY_FOX");
		case 12:
			return joaat("MAP_ANIMAL_LEGENDARY_MOOSE");
		case 13:
			return joaat("MAP_ANIMAL_LEGENDARY_PANTHER");
		case 14:
			return joaat("MAP_ANIMAL_LEGENDARY_PRONGHORN");
		case 15:
			return joaat("MAP_ANIMAL_LEGENDARY_WOLF");
		default:
			break;
	}
	return 0;
...
int func_16(int iParam0)
{
	...
	{
		case 0:
			return joaat("MAP_ANIMAL_LEGENDARY_BEAR_CROSS");
		case 1:
			return joaat("MAP_ANIMAL_LEGENDARY_BEAVER_CROSS");
		case 2:
			return joaat("MAP_ANIMAL_LEGENDARY_BIG_HORN_CROSS");
		case 3:
			return joaat("MAP_ANIMAL_LEGENDARY_WHITE_BUFFALO_CROSS");
		case 4:
			return joaat("MAP_ANIMAL_LEGENDARY_BOAR_CROSS");
		case 5:
			return joaat("MAP_ANIMAL_LEGENDARY_BUCK_CROSS");
		case 6:
			return joaat("MAP_ANIMAL_LEGENDARY_BUFFALO_CROSS");
		case 7:
			return joaat("MAP_ANIMAL_LEGENDARY_BULLGATOR_CROSS");
		case 8:
			return joaat("MAP_ANIMAL_LEGENDARY_COUGAR_CROSS");
		case 9:
			return joaat("MAP_ANIMAL_LEGENDARY_COYOTE_CROSS");
		case 10:
			return joaat("MAP_ANIMAL_LEGENDARY_ELK_CROSS");
		case 11:
			return joaat("MAP_ANIMAL_LEGENDARY_FOX_CROSS");
		case 12:
			return joaat("MAP_ANIMAL_LEGENDARY_MOOSE_CROSS");
		case 13:
			return joaat("MAP_ANIMAL_LEGENDARY_PANTHER_CROSS");
		case 14:
			return joaat("MAP_ANIMAL_LEGENDARY_PRONGHORN_CROSS");
		case 15:
			return joaat("MAP_ANIMAL_LEGENDARY_WOLF_CROSS");
		default:
			break;
	}
	return 0;
...
bool func_34()
{
	return (func_35(Global_1935630, (1 << 12)) || SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("RESPAWN_DUMP_BODY")) > 0);
}
...
bool func_42(var uParam0)
{
	*uParam0 = 9;
	...
	strcpy_s(&(uParam0->f_605), 64, "PD_Med_aged_carcass_Hvy_Hot");
	uParam0->f_12.f_5 = 1;
	uParam0->f_623 = 1;
...
bool func_47(var uParam0)
{
	...
	func_96(uParam0->f_3, "Hunting Zone Target Pending", 0, 0, (1 << 13), 0, -1082130432 /* Float: -1f */);
	return true;
}
...
bool func_49(var uParam0)
{
	...
	if (uParam0->f_12.f_1 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
		{
			if (uParam0->f_12.f_5)
			{
				uParam0->f_12 = PED::_CREATE_META_PED_OUTFIT_PED(uParam0->f_12.f_9, uParam0->f_12.f_10, 0.0f, true, true, false, false);
			}
			else
			{
...
void func_51(var uParam0)
{
	...
	while (iVar0 < uParam0->f_618)
	{
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_31[iVar0 /*36*/].f_1))
			{
				...
				if ((uParam0->f_31[iVar0 /*36*/].f_13 && fVar8 < 2500.0f) && ENTITY::IS_ENTITY_ON_SCREEN(uParam0->f_31[iVar0 /*36*/].f_1))
				{
					...
					if ((fVar8 < 6.25f && !func_109()) && !bVar6)
					{
						...
						{
							uParam0->f_31[iVar0 /*36*/].f_16 = func_110("INSPECT_GENERIC" /* GXTEntry: "Inspect" */, joaat("INPUT_CONTEXT_Y"), uParam0->f_31[iVar0 /*36*/].f_1, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("MEDIUM_TIMED_EVENT"), 0, 0);
		...
		else if (uParam0->f_31[iVar0 /*36*/].f_15)
		{
			...
			{
				func_118(uParam0->f_12, func_106(&(uParam0->f_31[iVar0 /*36*/].f_29)), 1, 0.762f, 1053609165 /* Float: 0.4f */, 0, 2.0f, 1);
...
int func_74(int iParam0, int iParam1)
{
	...
	{
		case 0:
			*iParam1 = joaat("A_C_BEAR_01");
			return 1;
		case 1:
			*iParam1 = joaat("A_C_BEAVER_01");
			return 1;
		case 2:
			*iParam1 = joaat("A_C_BIGHORNRAM_01");
			return 1;
		case 3:
			*iParam1 = joaat("A_C_BUFFALO_01");
			return 1;
		case 4:
			*iParam1 = joaat("A_C_BOAR_01");
			return 1;
		case 5:
			*iParam1 = joaat("A_C_BUCK_01");
			return 1;
		case 6:
			*iParam1 = joaat("A_C_BUFFALO_TATANKA_01");
			return 1;
		case 7:
			*iParam1 = joaat("A_C_ALLIGATOR_02");
			return 1;
		case 8:
			*iParam1 = joaat("A_C_COUGAR_01");
			return 1;
		case 9:
			*iParam1 = joaat("A_C_COYOTE_01");
			return 1;
		case 10:
			*iParam1 = joaat("A_C_ELK_01");
			return 1;
		case 11:
			*iParam1 = joaat("A_C_FOX_01");
			return 1;
		case 12:
			*iParam1 = joaat("A_C_MOOSE_01");
			return 1;
		case 13:
			*iParam1 = joaat("A_C_PANTHER_01");
			return 1;
		case 14:
			*iParam1 = joaat("A_C_PRONGHORN_01");
			return 1;
		case 15:
			*iParam1 = joaat("A_C_WOLF");
			return 1;
	}
	return 0;
}
	...
	*iParam2 = 0;
	...
	if (iVar11 != -1)
	{
		...
		while (iVar12 < iVar10)
		{
			...
			{
				if (func_129(iVar13, iParam1, &sVar14, &iVar45, 1, 0))
				{
					iVar46 = 0;
					while (iVar46 < iVar45)
					{
...
int func_76(int iParam0, int iParam1)
{
	...
	sVar5 = { func_132(iParam0, sVar0, sVar0.f_4, 0) /*4*/ };
...
bool func_77(int iParam0, int iParam1)
{
	...
	sVar0.f_4 = func_131(iParam1);
	if (!func_134(iParam0, sVar0.f_4))
	{
		return false;
	}
	iVar5 = func_135(iParam0, &sVar0, 1, 0);
...
bool func_78(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam1 == 1)
	{
		...
		{
			iVar0 = 0;
			if (func_75(iParam0, joaat("COST_CRAFTING_TRAPPER"), &iVar0))
			{
				iParam2 = iVar0;
			}
		}
	...
	sVar1 = { func_130(0) /*4*/ };
	if (!func_139(iParam0, &uVar6, &sVar1, iParam2, joaat("ADD_REASON_DEFAULT"), 1))
	{
		return false;
	}
	return true;
...
int func_80(int iParam0, int iParam1, int iParam2)
{
	switch (iParam0)
	{
		case joaat("AT_ARMADILLO") /* GXTEntry: "Armadillo" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_BADGER") /* GXTEntry: "Badger" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_BAT") /* GXTEntry: "Bat" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_BEAR_LEGENDARY"):
			...
			break;
		case joaat("AT_BEAVER") /* GXTEntry: "Beaver" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_BEAVER_LEGENDARY"):
			...
			break;
		case joaat("AT_BLUEJAY") /* GXTEntry: "Blue Jay" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_BOAR") /* GXTEntry: "Boar" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_BOAR_LEGENDARY"):
			...
			break;
		case joaat("AT_BUCK") /* GXTEntry: "Buck" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_BUCK_LEGENDARY"):
			...
			break;
		case joaat("AT_BUFFALO") /* GXTEntry: "Bison" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_BULL_HEREFORD"):
			...
			break;
		case joaat("AT_BULLFROG") /* GXTEntry: "Bullfrog" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_CALIFORNIACONDOR") /* GXTEntry: "Californian Condor" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_CARDINAL") /* GXTEntry: "Cardinal" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_CAT") /* GXTEntry: "Cat" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_CEDARWAXWING") /* GXTEntry: "Cedar Waxwing" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_CHICKEN") /* GXTEntry: "Chicken" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_CHICKEN_PRAIRIE") /* GXTEntry: "Chicken" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_CHICKEN_JAVA"):
			...
			break;
		case joaat("AT_CHIPMUNK") /* GXTEntry: "Chipmunk" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_CORMORANT") /* GXTEntry: "Cormorant" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_CORMORANT_NEO"):
			...
			break;
		case joaat("AT_COUGAR") /* GXTEntry: "Cougar" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_COUGAR_LEGENDARY"):
			...
			break;
		case joaat("AT_COW") /* GXTEntry: "Cow" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_COYOTE") /* GXTEntry: "Coyote" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_COYOTE_LEGENDARY"):
			...
			break;
		case joaat("AT_CRAB") /* GXTEntry: "Crab" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_CRANE") /* GXTEntry: "Crane" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_CRAYFISH"):
			...
			break;
		case joaat("AT_CROW") /* GXTEntry: "Crow" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_DEER") /* GXTEntry: "Deer" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_DOG_CHESAPEAKE"):
			...
			break;
		case joaat("AT_DOG_FOXHOUND") /* GXTEntry: "Dog" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_DOG_MUTT"):
			...
			break;
		case joaat("AT_DOG") /* GXTEntry: "Dog" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_DOG_POODLE"):
			...
			break;
		case joaat("AT_DONKEY") /* GXTEntry: "Donkey" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_DUCK") /* GXTEntry: "Duck" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_DUCK_PEKIN"):
			...
			break;
		case joaat("AT_EAGLE") /* GXTEntry: "Eagle" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_EAGLE_GOLDEN"):
			...
			break;
		case joaat("AT_EGRET") /* GXTEntry: "Egret" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_EGRET_SNOWY"):
			...
			break;
		case joaat("AT_ELK") /* GXTEntry: "Elk" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_ELK_LEGENDARY"):
			...
			break;
		case joaat("AT_FOX") /* GXTEntry: "Fox" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_FOX_LEGENDARY"):
			...
			break;
		case joaat("AT_GATOR") /* GXTEntry: "Alligator" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_GATOR_BULL"):
			...
			break;
		case joaat("AT_GILAMONSTER") /* GXTEntry: "Lizard" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_GOAT") /* GXTEntry: "Goat" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_GOOSE") /* GXTEntry: "Goose" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_HAWK_RED"):
			...
			break;
		case joaat("AT_HAWK") /* GXTEntry: "Hawk" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_HAWK_ROUGH"):
			...
			break;
		case joaat("AT_HERON") /* GXTEntry: "Heron" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_HERON_TRI"):
			...
			break;
		case joaat("AT_HORSE") /* GXTEntry: "Horse" */:
			...
			break;
		case joaat("AT_IGUANA") /* GXTEntry: "Iguana" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_IGUANA_DESERT"):
			...
			break;
		case joaat("AT_JAVELINA") /* GXTEntry: "Javelina" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_LOON") /* GXTEntry: "Loon" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_MULE"):
			...
			break;
		case joaat("AT_MUSKRAT") /* GXTEntry: "Muskrat" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_ORIOLE") /* GXTEntry: "Oriole" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_OWL") /* GXTEntry: "Owl" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_OX_DEVON"):
			...
			break;
		case joaat("AT_PANTHER") /* GXTEntry: "Panther" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_PANTHER_LEGENDARY"):
			...
			break;
		case joaat("AT_PARROT") /* GXTEntry: "Parrot" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_PARROT_SCARLET"):
			...
			break;
		case joaat("AT_PELICAN") /* GXTEntry: "Pelican" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_PELICAN_BROWN"):
			...
			break;
		case joaat("AT_PHEASANT") /* GXTEntry: "Pheasant" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_PHEASANT_CHINESE"):
			...
			break;
		case joaat("AT_PIG") /* GXTEntry: "Pig" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_PIG_SPOT"):
			...
			break;
		case joaat("AT_PIGEON") /* GXTEntry: "Pigeon" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_PIGEON_BAND"):
			...
			break;
		case joaat("AT_POSSUM") /* GXTEntry: "Opossum" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_PRONGHORN") /* GXTEntry: "Pronghorn" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_PRONGHORN_LEGENDARY"):
			...
			break;
		case joaat("AT_QUAIL") /* GXTEntry: "Quail" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_RABBIT") /* GXTEntry: "Rabbit" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_RACCOON") /* GXTEntry: "Raccoon" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_RAT_BLACK"):
			...
			break;
		case joaat("AT_RAT") /* GXTEntry: "Rat" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_RAVEN") /* GXTEntry: "Raven" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_REDFOOTEDBOOBY") /* GXTEntry: "Bird" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_ROBIN") /* GXTEntry: "Robin" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_ROOSTER") /* GXTEntry: "Rooster" */:
		case joaat("AT_ROOSTER_LEGHORN"):
			...
			break;
		case joaat("AT_ROSESPOONBILL") /* GXTEntry: "Spoonbill" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_SEAGULL_RING"):
			...
			break;
		case joaat("AT_SHEEP") /* GXTEntry: "Sheep" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_SKUNK") /* GXTEntry: "Skunk" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_SNAKE_BOA") /* GXTEntry: "Snake" */:
		...
		case joaat("AT_SNAKE_BOA_SUN"):
			...
			break;
		case joaat("AT_SNAKE_FERDELANCE") /* GXTEntry: "Snake" */:
		...
		case joaat("AT_SNAKE_COPPER_SOUTH"):
			...
			break;
		case joaat("AT_SNAKE_BLACK") /* GXTEntry: "Black-tailed Rattlesnake" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_SNAKE_DIAMOND"):
			...
			break;
		case joaat("AT_SONGBIRD") /* GXTEntry: "Songbird" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_SONGBIRD_SCARLET"):
			...
			break;
		case joaat("AT_SPARROW") /* GXTEntry: "Sparrow" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_SPARROW_GOLD"):
			...
			break;
		case joaat("AT_SQUIRREL") /* GXTEntry: "Squirrel" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_SQUIRREL_BLACK"):
			...
			break;
		case joaat("AT_TOAD") /* GXTEntry: "Toad" */:
		case joaat("AT_TOAD_DESERT"):
			...
			break;
		case joaat("AT_TURKEY") /* GXTEntry: "Turkey" */:
			if (iParam2 == 1)
			{
		...
		case joaat("AT_VULTURE_EAST"):
			...
			break;
		case joaat("AT_VULTURE") /* GXTEntry: "Vulture" */:
			if (iParam2 == 1)
			{
			...
			break;
		case joaat("AT_WOLF") /* GXTEntry: "Wolf" */:
			if (iParam2 == 1)
			{
...
int func_110(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_175(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_176(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_115(var uParam0, var uParam1)
{
	...
	if (uParam0->f_614 == 0)
	{
		...
		if (!MAP::DOES_BLIP_EXIST(uParam0->f_6))
		{
			...
			MAP::SET_BLIP_NAME_FROM_TEXT_FILE(uParam0->f_6, "ATZ_AREA_BLIP" /* GXTEntry: "Legendary Animal Territory" */);
		}
		if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_677))
		{
...
int func_118(int iParam0, char* sParam1, bool bParam2, float fParam3, float fParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
...
struct<4> /*32*/ func_132(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_133(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}
...
int func_135(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_GET_ITEM_ROLE_MAX_LEVEL_COUNT(func_133(bParam3), iParam0);
}
...
int func_136(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_133(bParam1), iParam0, false);
}
...
bool func_137(int iParam0)
{
	...
	if (func_196(iParam0, joaat("CI_TAG_SHOP_ANIMAL_LEGENDARY")))
	{
		return true;
	}
	return false;
...
bool func_139(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!INVENTORY::_INVENTORY_ADD_ITEM_WITH_GUID(func_133(0), uParam1, uParam2, iParam0, uParam2->f_4, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
Vector3 func_160()
{
	return func_204("ATZ_INS_EXC_CY" /* GXTEntry: "Coyote Dung" */);
}

Vector3 func_161()
{
	return func_204("ATZ_INS_FUR_CY" /* GXTEntry: "Coyote Fur" */);
}

Vector3 func_162()
{
	return func_204("ATZ_INS_KLR" /* GXTEntry: "Carcass" */);
}

Vector3 func_163()
{
	return func_204("ATZ_INS_BLD" /* GXTEntry: "Blood" */);
}

Vector3 func_164()
{
	return func_204("ATZ_INS_BRK" /* GXTEntry: "Broken Sticks" */);
}

Vector3 func_165()
{
	return func_204("ATZ_INS_TRB" /* GXTEntry: "Tree Rub" */);
}
...
{
	if (func_226(iParam0, joaat("DEFAULT") /* GXTEntry: "_" */) == 0)
	{
		return false;
	}
	return true;
...
bool func_197(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_228(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			sVar0 = { func_229(0) /*4*/ };
			sVar4.f_9 = joaat("SLOTID_NONE");
			if (!func_230(iParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
			{
				return false;
			}
			else if (func_231(iParam0, &sVar4, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
			{
				return false;
			}
			if (func_232(iParam0, 1))
			{
				if (!func_230(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					return false;
				}
				else if (func_231(iParam0, &sVar4, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */))
				{
					return false;
				}
			}
		}
		else if (!func_233(iParam0, &uVar26, 0))
		{
			return false;
		}
		return true;
	...
	{
		iVar28 = func_234(iParam0, *uParam1, uParam1->f_4, bParam4);
	}
	else
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_133(bParam4), iParam0, false);
	}
...
int func_227(var uParam0)
{
	...
	switch (*uParam0)
	{
		case joaat("UPGRADE_FSH_BAIT_CRICKET_TIN") /* GXTEntry: "Live Crickets" */:
			*uParam0 = joaat("UPGRADE_FSH_BAIT_CRICKET"); /* GXTEntry: "Cricket Bait" */
			return 1;
		case joaat("UPGRADE_FSH_BAIT_WORM_CAN") /* GXTEntry: "Live Worms" */:
			*uParam0 = joaat("UPGRADE_FSH_BAIT_WORM"); /* GXTEntry: "Worm Bait" */
			return 1;
		case joaat("CONSUMABLE_COCAINE_CHEWING_GUM_USED") /* GXTEntry: "Opened Cocaine Gum" */:
			*uParam0 = joaat("CONSUMABLE_COCAINE_CHEWING_GUM"); /* GXTEntry: "Cocaine Gum" */
			return 1;
		case joaat("CONSUMABLE_CHEWING_TOBACCO_USED") /* GXTEntry: "Opened Chewing Tobacco" */:
			*uParam0 = joaat("CONSUMABLE_CHEWING_TOBACCO"); /* GXTEntry: "Chewing Tobacco" */
			return 1;
		case joaat("CONSUMABLE_CIGARETTE_BOX_USED") /* GXTEntry: "Opened Cigarettes" */:
			*uParam0 = joaat("CONSUMABLE_CIGARETTE_BOX"); /* GXTEntry: "Premium Cigarettes" */
			return 1;
		default:
			break;
	}
...
{
	return func_234(iParam0, *uParam1, iParam2, bParam3) > 0;
}
...
bool func_231(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_246(iParam0, &uVar0, uParam1, iParam2))
	{
...
{
	if (func_191(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
...
bool func_233(int iParam0, var uParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
	...
	while (iVar29 < 4)
	{
		...
		if (func_230(iParam0, &sVar0, iVar5, 0))
		{
			bVar28 = func_231(iParam0, &sVar6, iVar5);
...
int func_234(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	sVar0 = { func_132(iParam0, sParam1, iParam5, bParam6) /*4*/ };
...
bool func_246(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_133(0);
	*uParam1 = { func_132(iParam0, func_229(0), iParam3, 0) /*4*/ };
...
struct<5> /*40*/ func_248(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;
	...
	switch (func_245(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_132(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_232(iParam0, 1))
			{
				...
				else if (!func_230(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_231(iParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_253(iParam0, joaat("CI_CATEGORY_CAMP")))
			{
				sVar0 = { func_132(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("KIT_CAMP") /* GXTEntry: "Camp" */);
			}
			else if (func_253(iParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_132(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("WARDROBE") /* GXTEntry: "Wardrobe" */);
			}
