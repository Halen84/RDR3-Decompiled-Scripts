		...
		if (MISC::GET_GAME_TIMER() > iLocal_329)
		{
			...
			switch (iLocal_328)
			{
				...
				case 1:
					...
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_330));
				...
				case 6:
					if (func_7(func_6(iLocal_330)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_330 /*35*/].f_11 > 0.0f)
							{
								PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1888801[iLocal_330 /*35*/].f_11);
							}
							Jump @856; // curOff = 837
							func_42(iVar0);
							iVar0 = (1 + iVar0);
						...
						{
							PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1888801[iLocal_330 /*35*/].f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	iLocal_267 = Global_1888801[78 /*35*/].f_4;
	VOLUME::_0xB469CFD9E065EB99(iLocal_267, 20);
	func_46();
	iLocal_275 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Annesburg - m_volPostOfficeOwner Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_275, 2935.558f, 1282.429f, 45.47895f, 0.0f, 0.0f, -110f, 12.3f, 6.147137f, 3.628f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_275, 2938.688f, 1280.857f, 45.15513f, 0.0f, 0.0f, 70.00001f, 4.134692f, 0.798306f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_275, 2939.422f, 1288.475f, 45.479f, 0.0f, 0.0f, -110.0f, 1.738f, 1.755f, 3.628f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_275, 2931.347f, 1283.163f, 45.744f, 0.0f, 0.0f, 160.0f, 2.301f, 3.055f, 3.645f);
	iLocal_276 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Annesburg - m_volPostOfficePrompt Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_276, 2939.491f, 1288.495f, 45.104f, 0.0f, 0.0f, 70.0f, 1.0f, 1.25f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_276, 2931.516f, 1283.127f, 45.104f, 0.0f, 0.0f, 160.0f, 1.25f, 2.0f, 3.0f);
	iLocal_277 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Annesburg - m_volPostOfficeOfflimits Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_277, 2935.558f, 1282.429f, 45.47895f, 0.0f, 0.0f, -110f, 12.3f, 6.147137f, 3.628f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_277, 2938.688f, 1280.857f, 45.15513f, 0.0f, 0.0f, 70.00001f, 4.134692f, 0.798306f, 3.0f);
	iLocal_278 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Annesburg - m_volPostOfficePARENT Agg");
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_278, iLocal_275);
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_278, iLocal_277);
	VOLUME::_0xB469CFD9E065EB99(iLocal_278, 10076);
	iLocal_268 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2930.0f, 1360.0f, 75.0f, 0.0f, 0.0f, 0.0f, 170.0f, 170.0f, 75.0f, "Annesburg - m_volTownRestriction");
	func_47(iLocal_268, 0);
	if (func_20() == -1)
	{
		func_48();
		iLocal_279 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2947.45f, 1344.723f, 44.552f, 0.0f, 0.0f, -20.1f, 1.417f, 1.446f, 3.716f, "ASB - newspaper boy");
	}
	func_49();
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	...
	iLocal_314 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Annesburg - m_volGunsmithWindowBlocking Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_314, 2948.085f, 1314.075f, 44.7143f, 0.0f, 0.0f, -20.0f, 3.0f, 0.5f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_314, 2951.619f, 1311.827f, 44.714f, 0.0f, 0.0f, -20.0f, 2.0f, 2.476f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_314, 2941.358f, 1318.47f, 44.7143f, 0.0f, 0.0f, -110f, 2.0f, 0.5f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_314, 2943.27f, 1323.726f, 44.7143f, 0.0f, 0.0f, -110f, 2.0f, 0.5f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_314, 2943.182f, 1321.971f, 44.7143f, 0.0f, 0.0f, -65.0f, 0.875f, 0.5f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_314, 2942.452f, 1319.803f, 44.7143f, 0.0f, 0.0f, -155.0f, 0.875f, 0.5f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_314, 2953.494f, 1319.269f, 44.7143f, 0.0f, 0.0f, -110f, 3.25f, 0.5f, 3.0f);
	return true;
}
...
void func_14(int iParam0)
{
	...
	func_52(joaat("DOOR_ANN_DEPOT_VAULT"), 1, 0, 0, 0, 0, 0, 0);
	func_53();
	if (func_20() == -1)
	{
...
bool func_15(int iParam0)
{
	...
	if (bVar0)
	{
		if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("TRAIN_ANNESBURG")) <= 0)
		{
			iVar2 = iLocal_322;
			SCRIPTS::START_NEW_SCRIPT_WITH_ARGS("train_annesburg", &iVar2, 1, (1 << 10));
...
{
	func_64(6, 385, iLocal_270, iParam0, iLocal_272, iLocal_273, 20, 35.0f, 0, 0);
	...
	func_64(2, 384, iLocal_275, iParam0, iLocal_276, iLocal_277, 491520, -1082130432 /* Float: -1f */, 0, 0);
	...
	func_64(22, 386, iLocal_279, iParam0, iLocal_279, 0, 4, -1082130432 /* Float: -1f */, 0, 0);
	func_68();
	if (func_69())
	{
		func_70(1, 1);
...
{
	iParam0 = iParam0;
	func_71(385, iLocal_274, 1);
	func_71(384, iLocal_278, 1);
}
...
{
	iParam0 = iParam0;
	func_74(uParam1, iLocal_267, 1);
	func_74(uParam1, iLocal_274, 2);
	func_74(uParam1, iLocal_278, 10);
}
...
void func_39(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0.0f, 0.0f, 0.0f) <= 5.0f || func_89(Global_1935630, (1 << 14))) || func_89(Global_1935630, (1 << 23)))
	{
		return;
	}
...
void func_46()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_270, 2946.756f, 1319.464f, 45.773f, 0.0f, 0.0f, 160.007f, 7.3f, 8.558f, 3.886f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_270, 2951.516f, 1315.413f, 45.87443f, 0.0f, 0.0f, 70.668f, 4.4f, 6.8f, 4.071f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_270, 2944.146f, 1323.42f, 45.34387f, 0.0f, 0.0f, 159.9526f, 1.313159f, 2.528442f, 3.275907f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_270, 2942.288f, 1318.186f, 45.34387f, 0.0f, 0.0f, 159.9526f, 1.313159f, 2.528442f, 3.275907f);
	iLocal_271 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2940.486f, 1321.557f, 44.432f, 0.0f, 0.0f, -21.5f, 3.914f, 11.0f, 3.253f, "Annesburg - m_volGunstmithPorch");
	iLocal_273 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Annesburg - m_volGunsmithOff Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_273, 2951.393f, 1315.45f, 45.71739f, 0.0f, 0.0f, 159.9526f, 4.981217f, 4.126322f, 3.783344f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_273, 2948.723f, 1318.755f, 45.71739f, 0.0f, 0.0f, 159.9526f, 1.816379f, 2.277752f, 3.783344f);
	iLocal_274 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Annesburg - m_volGunsmithPARENT Agg");
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_274, iLocal_270);
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_274, iLocal_273);
	iLocal_272 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2946.482f, 1320.09f, 45.71739f, 0.0f, 0.0f, 159.9526f, 1.28246f, 1.493367f, 3.783344f, "Annesburg - m_volGunsmithPrompt");
...
void func_48()
{
	if (!VOLUME::DOES_VOLUME_EXIST(iLocal_311))
	{
		iLocal_311 = VOLUME::CREATE_VOLUME_BOX(2946.003f, 1329.742f, 44.75553f, 0.0f, 0.0f, -20.59198f, 4.123681f, 4.526473f, 2.760351f);
	}
	func_114(13, 2946.003f, 1329.742f, 44.75553f, 0.0f, iLocal_311);
}
...
void func_49()
{
	...
	iLocal_269 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(func_115(78), 0.0f, 0.0f, 160.5434f, 7.539f, 7.226621f, 3.527f, "Annesberg - m_volSheriff");
	VOLUME::_0x3EFABB21E14A6BD1(iLocal_269, 5, 1);
	iVar0 = 0;
	func_116(&iVar0, 5);
	func_116(&iVar0, 0);
	func_116(&iVar0, 8);
	...
	func_116(&iVar3, 0);
	func_116(&iVar3, 18);
	COMPANION::_0x3CAAD93FA5B9579A(iLocal_274, 2, iVar1);
	COMPANION::_0x3CAAD93FA5B9579A(iLocal_267, 2, iVar3);
	COMPANION::_0x3CAAD93FA5B9579A(iLocal_269, 2, iVar2);
}

void func_50()
{
	iLocal_288 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Annesburg - m_volGuardRestrictedMines");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_288, 2778.796f, 1394.792f, 69.89557f, 0.0f, 0.0f, 162.6054f, 47.3562f, 17.70435f, 4.921822f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_288, 2731.457f, 1387.03f, 69.47391f, 0.0f, 0.0f, 174.5427f, 51.89223f, 75.50195f, 5.399319f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_288, 2766.449f, 1372.934f, 69.97977f, 0.0f, 0.0f, 179.7893f, 42.35742f, 40.00592f, 7.371945f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_288, 2745.149f, 1325.543f, 70.53976f, 0.0f, 0.0f, -124.3671f, 68.93018f, 48.94287f, 6.861679f);
	iLocal_289 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Annesburg - m_volGuardWarningMines");
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_289, iLocal_288);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_289, 2798.54f, 1378.204f, 71.38834f, 0.0f, 0.0f, 114.3251f, 12.14124f, 9.256836f, 2.566116f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_289, 2786.636f, 1340.301f, 72.13432f, 0.0f, 0.0f, -169.2597f, 36.0f, 20.0387f, 5.186172f);
	iLocal_287 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Annesburg - m_volGuardRegistrationMines Agg");
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_287, iLocal_289);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_287, 2746.364f, 1358.945f, 70.39893f, 0.0f, 0.0f, 0.0f, 84.91821f, 80.12947f, 16.40755f);
	sLocal_286 = "ANNESBURG_MINES";
	LAW::_CREATE_GUARD_ZONE(sLocal_286);
	LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_START(sLocal_286, iLocal_287);
	LAW::_SET_GUARD_ZONE_VOLUME_RESTRICTED(sLocal_286, iLocal_288);
	LAW::_SET_GUARD_ZONE_VOLUME_WARNING(sLocal_286, iLocal_289);
	LAW::_SET_GUARD_ZONE_POSITION(sLocal_286, 2751.873f, 1317.464f, 70.3442f);
	LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_END(sLocal_286, iLocal_287);
	iLocal_283 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Annesburg - m_volGuardThreatFactory");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_283, 2941.719f, 1379.844f, 54.23869f, 0.0f, 0.0f, -20.52175f, 20.0f, 9.64209f, 8.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_283, 2956.943f, 1374.144f, 56.70911f, 0.0f, 0.0f, -20.52175f, 8.0f, 9.64209f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_283, 2921.606f, 1378.958f, 57.36378f, 0.0f, 0.0f, -19.99977f, 9.862305f, 3.548828f, 4.311089f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_283, 2929.823f, 1391.119f, 57.1455f, 0.0f, 0.0f, 159.4647f, 10.5f, 4.0f, 5.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_283, 2890.918f, 1392.686f, 65.82047f, 0.0f, 0.0f, 159.4647f, 5.0f, 4.0f, 5.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_283, 2891.106f, 1397.907f, 65.7927f, 0.0f, 0.0f, 159.4647f, 8.0f, 8.0f, 4.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_283, 2882.034f, 1399.818f, 71.60069f, 0.0f, 0.0f, -18.42616f, 11.89791f, 14.37344f, 8.176727f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_283, 2873.382f, 1397.755f, 69.09045f, 0.0f, 0.0f, -109.1993f, 3.7f, 2.85f, 4.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_283, 2870.781f, 1405.204f, 69.09045f, 0.0f, 0.0f, -109.1993f, 8.0f, 12.75f, 5.5f);
	iLocal_282 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Annesburg - m_volGuardRestrictedFactory");
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_282, iLocal_283);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_282, 2947.967f, 1377.505f, 54.23869f, 0.0f, 0.0f, -20.52174f, 33.40112f, 9.64209f, 8.798882f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_282, 2921.375f, 1386.594f, 59.35508f, 0.0f, 0.0f, -19.9723f, 22.21967f, 10.34818f, 8.176826f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_282, 2903f, 1393.487f, 62.41521f, 0.0f, 22.36725f, -18.6568f, 20.50081f, 4.178955f, 4.300679f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_282, 2886.151f, 1398.552f, 67.75819f, 0.0f, 0.0f, -17.09603f, 20.41762f, 12.63306f, 8.176727f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_282, 2931.633f, 1376.08f, 53.74407f, 0.0f, 0.0f, -19.99976f, 10.0f, 4.548828f, 8.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_282, 2927.823f, 1391.53f, 56.10883f, 0.0f, 0.0f, 159.4647f, 14.87891f, 4.287598f, 5.781578f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_282, 2879.041f, 1385.799f, 76.87366f, 0.0f, 0.0f, 74.31805f, 7.497559f, 6.367218f, 15.01529f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_282, 2877.706f, 1411.105f, 68.60784f, 0.0f, 0.0f, -109.1993f, 8.661057f, 9.821352f, 5.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_282, 2868.376f, 1406.596f, 68.84293f, 0.0f, 0.0f, 70.84104f, 16.76896f, 14.31861f, 5.512192f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_282, 2961.819f, 1372.318f, 54.22138f, 0.0f, 0.0f, -20.52175f, 4.0f, 6.0f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_282, 2862.852f, 1453.412f, 68.60784f, 0.0f, 0.0f, 60f, 17.0f, 14.5f, 5.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_282, 2856.053f, 1440.646f, 68.60784f, 0.0f, 0.0f, 60f, 11.0f, 12.0f, 5.5f);
	iLocal_284 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Annesburg - m_volGuardWarningFactory");
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_284, iLocal_282);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_284, 2885.087f, 1390.311f, 64.77302f, 0.0f, 0.0f, 74.31805f, 11.0f, 5.055176f, 3.791058f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_284, 2873.519f, 1405.156f, 68.60784f, 0.0f, 0.0f, -109.1993f, 24.00397f, 30.25238f, 5.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_284, 2960.251f, 1380.218f, 52.1091f, 0.0f, 0.0f, 70.33841f, 4.079863f, 5.097966f, 4.737656f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_284, 2959.772f, 1382.529f, 51.43845f, 180.0f, 58.71566f, -109.6616f, 4.079863f, 2.205975f, 4.737656f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_284, 2921.698f, 1395.326f, 55.71815f, 0.0f, 0.0f, 74.31805f, 7.497559f, 7.223577f, 6.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_284, 2867.994f, 1460.895f, 68.84293f, 0.0f, 0.0f, 57.87753f, 36.40476f, 16.11485f, 5.512192f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_284, 2856.1f, 1439.699f, 68.84293f, 0.0f, 0.0f, 60.0f, 12.37818f, 13.83511f, 5.512192f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_284, 2875.003f, 1459.517f, 67.87074f, 0.0f, 0.0f, -27.09153f, 8.940713f, 19.95108f, 3.542988f);
	iLocal_281 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Annesburg - m_volGuardRegistrationFactory Agg");
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_281, iLocal_284);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_281, 2929.186f, 1382.264f, 6.988285f, 0.0f, 0.0f, 24.12213f, 101.644f, 161.2632f, 79.15946f);
	iLocal_285 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2860.579f, 1374.223f, 6.988285f, 0.0f, 0.0f, -18.32627f, 181.8184f, 201.7612f, 79.15946f, "Annesburg - m_volGuardDefensiveFactory");
	sLocal_280 = "ANNESBURG_FACTORY";
	LAW::_CREATE_GUARD_ZONE(sLocal_280);
	LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_START(sLocal_280, iLocal_281);
	LAW::_SET_GUARD_ZONE_VOLUME_RESTRICTED(sLocal_280, iLocal_282);
	LAW::_SET_GUARD_ZONE_VOLUME_THREAT(sLocal_280, iLocal_283);
	LAW::_SET_GUARD_ZONE_VOLUME_WARNING(sLocal_280, iLocal_284);
	LAW::_SET_GUARD_ZONE_POSITION(sLocal_280, 2922.172f, 1380.257f, 56.7411f);
	LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_END(sLocal_280, iLocal_285);
}
...
void func_52(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_121(iParam0))
	{
		...
		if (bParam3)
		{
			func_122(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_54(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, Vector3 vParam5, float fParam8, int iParam9, int iParam10)
{
	uParam0->f_1 = iParam1;
	uParam0->f_2 = iParam2;
	uParam0->f_3 = { func_127(sParam3) /*8*/ };
...
void func_55()
{
	...
	iVar0 = 7;
	iLocal_253[0] = VOLUME::_CREATE_VOLUME_LOCK(2902.642f, 1329.249f, 50.427f, 15.0f, iVar0, (1 << 14));
	iLocal_253[1] = VOLUME::_CREATE_VOLUME_LOCK(2905.855f, 1347.65f, 54.855f, 15.0f, iVar0, (1 << 14));
	iLocal_253[2] = VOLUME::_CREATE_VOLUME_LOCK(2906.833f, 1368.872f, 53.108f, 20.0f, iVar0, (1 << 14));
}
...
void func_56()
{
	...
	func_128(&sLocal_117, 382, &iVar0, 0, 0);
	sLocal_117[0 /*45*/].f_43 = 18882;
	sLocal_117[0 /*45*/].f_44 = 19385;
	func_131(&(sLocal_117[0 /*45*/]), (1 << 9));
	iVar6 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2945.357f, 1319.974f, 44.5f, 0.0f, 0.0f, 160.0072f, 16.0f, 8.557617f, 3.885772f, "SheriffCon1");
	sLocal_117[0 /*45*/].f_38 = iVar6;
	iVar7 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2933.323f, 1281.292f, 45.432f, 0.0f, 0.0f, -19.10631f, 12.0f, 27.0f, 4.0f, "SheriffCon2");
	sLocal_117[0 /*45*/].f_39 = iVar7;
	uVar8 = 5;
	iVar0[0] = 382;
	func_128(&sLocal_117, 385, &uVar8, 1, 1);
	sLocal_117[1 /*45*/].f_43 = 19462;
	sLocal_117[1 /*45*/].f_44 = 19385;
	func_131(&(sLocal_117[1 /*45*/]), (1 << 9));
	uVar14 = 5;
	func_128(&sLocal_117, 384, &uVar14, 2, 0);
	sLocal_117[2 /*45*/].f_43 = 20082;
	sLocal_117[2 /*45*/].f_44 = 19385;
	func_131(&(sLocal_117[2 /*45*/]), (1 << 9));
}
...
void func_57(int iParam0)
{
	...
	if (func_134(&iVar0))
	{
		if (Global_1934765.f_275[iVar0 /*2*/].f_1 != iParam0)
		{
			...
			STREAMING::SET_POPULATION_BUDGET_MULTIPLIER(func_135());
		}
		return;
	}
	iVar0 = func_136();
...
void func_59()
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_315))
	{
		...
		ENTITY::SET_ENTITY_ROTATION(iLocal_315, 0.0f, 0.0f, -20.0f, 0, false);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_316))
	{
		...
		ENTITY::SET_ENTITY_ROTATION(iLocal_316, 0.0f, 0.0f, -20.0f, 0, false);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_317))
	{
		...
		ENTITY::SET_ENTITY_ROTATION(iLocal_317, 0.0f, 0.0f, -20.0f, 0, false);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_318))
	{
		...
		ENTITY::SET_ENTITY_ROTATION(iLocal_318, 0.0f, 0.0f, -20.0f, 0, false);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_319))
	{
		...
		ENTITY::SET_ENTITY_ROTATION(iLocal_319, 0.0f, 0.0f, -20.0f, 0, false);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_320))
	{
		...
		ENTITY::SET_ENTITY_ROTATION(iLocal_320, 0.0f, 0.0f, -20.0f, 0, false);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_321))
	{
		...
		ENTITY::SET_ENTITY_ROTATION(iLocal_321, 0.0f, 0.0f, -20.0f, 0, false);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_322))
	{
		...
		ENTITY::SET_ENTITY_ROTATION(iLocal_322, 0.0f, 0.0f, -20.1736f, 0, false);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_323))
	{
		...
		ENTITY::SET_ENTITY_ROTATION(iLocal_323, 0.0f, 0.0f, -20.0f, 0, false);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_324))
	{
		...
		ENTITY::SET_ENTITY_ROTATION(iLocal_324, 0.0f, 0.0f, -20.0f, 0, false);
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_325))
	{
		...
		ENTITY::SET_ENTITY_ROTATION(iLocal_325, 0.0f, 0.0f, -20.0f, 0, false);
		ENTITY::FREEZE_ENTITY_POSITION(iLocal_325, true);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_315))
	{
		ENTITY::PLAY_ENTITY_ANIM(iLocal_315, "coalbin01_full", sLocal_326, 1.0f, true, false, false, 0.0f, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_316))
	{
		ENTITY::PLAY_ENTITY_ANIM(iLocal_316, "steameng01_full", sLocal_326, 1.0f, true, false, false, 0.0f, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_317))
	{
		ENTITY::PLAY_ENTITY_ANIM(iLocal_317, "conveyor01x_full", sLocal_326, 1.0f, true, false, false, 0.0f, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_318))
	{
		ENTITY::PLAY_ENTITY_ANIM(iLocal_318, "conveyor02x_full", sLocal_326, 1.0f, true, false, false, 0.0f, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_319))
	{
		ENTITY::PLAY_ENTITY_ANIM(iLocal_319, "annconvey03_full", sLocal_326, 1.0f, true, false, false, 0.0f, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_320))
	{
		ENTITY::PLAY_ENTITY_ANIM(iLocal_320, "annconvey04_full", sLocal_326, 1.0f, true, false, false, 0.0f, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_321))
	{
		ENTITY::PLAY_ENTITY_ANIM(iLocal_321, "annconvmid1x_full", sLocal_326, 1.0f, true, false, false, 0.0f, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_322))
	{
		ENTITY::PLAY_ENTITY_ANIM(iLocal_322, "annChute01_full", sLocal_326, 1.0f, true, false, false, 0.0f, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_323))
	{
		ENTITY::PLAY_ENTITY_ANIM(iLocal_323, "anngears03_full", sLocal_326, 1.0f, true, false, false, 0.0f, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_324))
	{
		ENTITY::PLAY_ENTITY_ANIM(iLocal_324, "anngears04_full", sLocal_326, 1.0f, true, false, false, 0.0f, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_325))
	{
		ENTITY::PLAY_ENTITY_ANIM(iLocal_325, "annsifter01_full", sLocal_326, 1.0f, true, false, false, 0.0f, 0);
	}
}
...
void func_64(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	vVar1 = { func_144(iVar0) /*3*/ };
	vVar4 = { func_145(iVar0) /*3*/ };
	if (func_146(vVar1))
	{
		return;
	}
...
void func_79(int iParam0)
{
	...
	while (iVar0 < Global_40.f_9829)
	{
		if (Global_40.f_9829[iVar0 /*4*/] == iParam0)
		{
			...
			{
				func_181(iVar0, 2);
				if (BUILTIN::VDIST(func_182(iVar2), Global_36) < 45.0f)
				{
...
void func_80(var uParam0)
{
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(PERSCHAR::_0x112DDF56300BC6E5(func_184(uParam0->f_1))))
			{
				*uParam0 = 9;
			}
			*uParam0 = 1;
		...
		case 7:
			...
			{
				PERSCHAR::_SET_PERSCHAR_SCHEDULE(func_184(uParam0->f_1), &(uParam0->f_3));
			}
			if (ENTITY::DOES_ENTITY_EXIST(PERSCHAR::_GET_PERSCHAR_PED_INDEX(PERSCHAR::_0x112DDF56300BC6E5(func_184(uParam0->f_1)))))
			{
				*uParam0 = 6;
			}
			else
...
void func_88(var uParam0)
{
	...
	{
		if (func_204(uParam0[iLocal_116 /*45*/], 1, 1))
		{
			func_205(uParam0[iLocal_116 /*45*/]);
		}
	}
	iLocal_116++;
}
...
bool func_91()
{
	return func_89(Global_1935630, (1 << 12));
}
...
bool func_93(int iParam0)
{
	...
	return ((Global_1888801[iParam0 /*35*/].f_20 == 1 || Global_1888801[iParam0 /*35*/].f_20 == 2) && !func_206(iParam0));
}
...
void func_96(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_75(iParam0) && func_113(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_220(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_220(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_220(&cVar6, joaat("COLOR_PURE_WHITE")), func_220(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
{
	func_72(0.775f, 0.2f, 0.025f, 0.0f);
	...
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_311))
	{
		VOLUME::DELETE_VOLUME(iLocal_311);
	}
	COMPANION::_0x7274F84B1501B523(iLocal_269);
	COMPANION::_0x7274F84B1501B523(iLocal_267);
...
void func_111(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_241(Global_1392240.f_1[iVar0 /*18*/].f_6[iVar1]);
...
void func_122(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (func_121(iParam0))
	{
...
struct<8> /*64*/ func_127(char* sParam0)
{
	char cVar0[64];
...
void func_128(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	if (!func_251(&((uParam0[iParam3 /*45*/])->f_34)))
	{
		func_252(&((uParam0[iParam3 /*45*/])->f_34), 1);
	}
	func_131(uParam0[iParam3 /*45*/], (1 << 15));
	func_131(uParam0[iParam3 /*45*/], (1 << 10));
...
Vector3 func_129(var uParam0)
{
	...
	{
		if (func_255(iVar0, uParam0->f_39, 1, 0) && TASK::IS_PED_ACTIVE_IN_SCENARIO(iVar0, 0))
		{
			func_131(uParam0, 16);
	...
	if (!func_254(uParam0, 4))
	{
		switch (uParam0->f_3[uParam0->f_21 /*3*/])
		{
			case 385:
				func_131(uParam0, 4);
				iVar1 = func_177(385);
				if (!ENTITY::DOES_ENTITY_EXIST(iVar1) || func_199(iVar1, 0))
				{
					return func_253("");
				}
	...
	if (!func_254(uParam0, 4))
	{
		switch (uParam0->f_3[uParam0->f_21 /*3*/])
		{
			case 382:
				func_131(uParam0, 4);
				iVar2 = func_177(382);
				if (!ENTITY::DOES_ENTITY_EXIST(iVar2) || func_199(iVar2, 0))
				{
					return func_253("");
				}
...
float func_135()
{
	return (func_261(150.0f, BUILTIN::TO_FLOAT(Global_1934765.f_286)) / BUILTIN::TO_FLOAT(300));
}
...
void func_148(int iParam0)
{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_241(Global_1914319.f_3[iParam0 /*446*/].f_317[iVar0 /*6*/]);
...
bool func_153(int iParam0, int iParam1)
{
	...
	if (func_147(iParam0, (1 << 14)) && !func_275(iParam0, 1))
	{
		return true;
	}
	if (!func_140(iParam1))
...
void func_167(int iParam0, bool bParam1)
{
	...
	if ((bParam1 && func_281(iParam0, (1 << 9))) || (!bParam1 && !func_281(iParam0, (1 << 9))))
	{
		return;
	}
	if (bParam1)
	{
		func_160(iParam0, (1 << 9));
	}
	else
	{
		func_159(iParam0, (1 << 9));
	}
	if (func_282(iParam0))
	{
...
void func_172(struct<16> /*128*/ sParam0, int iParam16)
{
	int iVar0;
	...
	{
		if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&(sParam0.f_10))) > 0 || func_170(&(sParam0.f_10)))
		{
			return;
		}
	}
...
void func_180(int iParam0, int iParam1, int iParam2)
{
	...
	sVar0.f_2 = iParam2;
	sVar10 = { sVar0 /*10*/ };
	strcpy_s(&(sVar10.f_10), 32, func_288(iParam0, iParam1));
	sVar10.f_14 = (1 << 10);
	sVar10.f_15 = 1;
	func_172(sVar10, 0);
}
...
bool func_188(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_11))
	{
		func_292(uParam0->f_13, 3.0f, 1, 0);
...
bool func_204(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (uParam0->f_30 == 1)
	{
		if (!func_254(uParam0, (1 << 16)) && func_293(Global_35, iVar0, 1) > 25.0f)
		{
			func_294(1, 1, 0);
		}
	...
	else
	{
		...
		if (func_293(Global_35, iVar0, 1) < 49.0f)
		{
...
char* func_220(char* sParam0, int iParam1)
{
	...
	return func_315(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_221(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_225(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_237()
{
	...
	while (iVar0 < 3)
	{
		if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(iLocal_253[iVar0]))
		{
			VOLUME::_RELEASE_LOCK_VOLUME(iLocal_253[iVar0]);
		}
		iVar0++;
	}
}
...
void func_239(int iParam0)
{
	...
	func_328(iParam0, (1 << 13));
	func_328(iParam0, (1 << 14));
	func_328(iParam0, (1 << 15));
	func_328(iParam0, (1 << 17));
	func_328(iParam0, (1 << 24));
	func_328(iParam0, (1 << 19));
	func_328(iParam0, (1 << 20));
...
bool func_245(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_334(iVar0) && func_335(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
bool func_259(var uParam0, int iParam1)
{
	...
	if (!func_340(iVar0, iParam1, (1 << 10)))
	{
		if (func_346(uParam0) && func_347(0))
		{
			func_348(iVar0, iParam1, (1 << 10));
			uParam0->f_21 = -1;
			return true;
		}
	}
...
char* func_260(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
void func_268(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_280(iParam0, (1 << 10)))
		{
			func_165(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_280(iParam0, (1 << 10)))
	{
...
void func_294(bool bParam0, bool bParam1, bool bParam2)
{
...
bool func_295(var uParam0, bool bParam1)
{
	...
	if (Global_1914319.f_17371 | func_372(func_177(*uParam0), 1, 1, 1, 0) || PED::IS_PED_HOGTIED(func_177(*uParam0)))
	{
		func_368(uParam0);
		return uParam0->f_30;
	}
	if (((func_373(PLAYER::PLAYER_ID(), 1, 0, 1) | func_374() || LAW::_0xF46108C50A22B029()) || LAW::ARE_WITNESSES_ACTIVE(PLAYER::PLAYER_ID())) || PLAYER::_0xD1F6B912785BFD35(PLAYER::PLAYER_ID()))
	{
		return false;
	}
	...
	if (!func_378(iVar0, func_254(uParam0, (1 << 11))))
	{
		return false;
	}
	if (uParam0->f_30 == 0)
	{
		if (!func_254(uParam0, (1 << 11)) && !func_254(uParam0, (1 << 15)))
		{
			...
			else if (func_254(uParam0, (1 << 10)))
			{
				if (func_379(&(uParam0->f_34)) < 5.0f)
				{
					return false;
				}
			}
			else if (func_379(&(uParam0->f_34)) < 25.0f)
			{
				return false;
			}
		}
...
bool func_300(var uParam0, int iParam1)
{
	...
	if (func_254(uParam0, 128))
	{
		...
		while (iVar0 < 5)
		{
			...
			if (func_303(iVar1, 0) && func_380(iVar1, iParam1, 1, 1) <= 4.0f)
			{
				uParam0->f_21 = iVar0;
				return true;
			}
	...
	if (!func_254(uParam0, (1 << 9)) && !func_254(uParam0, 256))
	{
		return true;
	}
	if (func_254(uParam0, (1 << 9)))
	{
		if (func_346(uParam0))
		{
			return true;
...
void func_308(var uParam0)
{
	...
	func_252(&(uParam0->f_34), 1);
	uParam0->f_40 = { func_387() /*3*/ };
	uParam0->f_21 = -1;
	if (func_254(uParam0, (1 << 14)))
	{
		func_388(uParam0, (1 << 14));
	}
	func_388(uParam0, (1 << 15));
	func_388(uParam0, (1 << 10));
	func_389(&uLocal_15);
	if (func_254(uParam0, (1 << 12)))
	{
		...
		{
			func_390(iVar0, 0);
			func_388(uParam0, (1 << 13));
			func_388(uParam0, (1 << 12));
		}
	}
}
...
char* func_311(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}
...
void func_322(struct<6> /*48*/ sParam0, var uParam6)
{
...
void func_337(int iParam0, bool bParam1)
{
	if (func_249(iParam0))
	{
		if (bParam1)
		{
			if (!func_396(iParam0))
			{
				func_52(iParam0, 1, 0.0f, 0, 0, 1.0f, 0, 0);
			}
		}
...
bool func_346(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
		if (func_293(Global_35, iVar0, 1) < 9.0f)
		{
			return true;
		}
	}
...
bool func_361(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_404(&(Global_1109000.f_4), iVar0, 5);
	}
	if (iParam1 == func_405())
	{
		return func_404(&(Global_1109000.f_4), iVar0, 5);
	...
	{
		return func_404(&(Global_1108108[iParam1 /*27*/].f_4), iVar0, 5);
	}
	return false;
}
...
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || func_199(iParam0, 0))
	{
		return false;
	}
	if (func_411(iParam0))
...
bool func_383(int iParam0, int iParam1)
{
	...
	return func_280(Global_1914319.f_3[iParam0 /*446*/].f_10, (1 << 10));
}
...
bool func_391(Vector3 vParam0, int iParam3)
{
	...
	func_416(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_417(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
