...
void func_15(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	iVar1 = func_50(joaat("HORSE_CLASS_RIDING") /* GXTEntry: "Riding" */, 1);
	func_51(uParam0, 0, "RR_HORSE", iVar1, vParam1, (0.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_51(uParam0, 1, "RR_MAN", iVar0, vParam1, (0.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_32(var uParam0)
{
	...
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_68(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 2, (1 << 30));
		...
		case 1:
			if (func_72(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
				{
					...
					TASK::TASK_STAND_STILL(0, BUILTIN::FLOOR((5.0f * 1000.0f)));
					if (bLocal_15)
					{
						TASK::TASK_PLAY_ANIM(0, "AI_GESTURES@GEN_MALE@STANDING@SPEAKER", "NEUTRAL_WAVE_FL_001", 4.0f, -4.0f, 1000, 8, 0.0f, false, 0, false, 0, false);
					}
					TASK::TASK_MOVE_IN_TRAFFIC(0, 1.0f, 4, 0);
