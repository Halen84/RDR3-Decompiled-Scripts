		...
		case 1:
			...
			if (((((bVar0 && !PED::IS_PED_CARRYING_SOMETHING(Global_35)) && func_15(1)) && !Global_1327590.f_19745) && !TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1)) && !(WEAPON::GET_CURRENT_PED_WEAPON(Global_35, &iVar2, true, 0, true) && (iVar2 == joaat("WEAPON_KIT_CAMERA") || iVar2 == joaat("WEAPON_KIT_BINOCULARS"))))
			{
				if (!MAP::DOES_BLIP_EXIST(iLocal_30))
				{
					...
					{
						case 1:
							MAP::SET_BLIP_SPRITE(iLocal_30, joaat("BLIP_MG_DOMINOES") /* GXTEntry: "Dominoes" */, true);
							break;
						case 2:
							MAP::SET_BLIP_SPRITE(iLocal_30, joaat("BLIP_MG_DOMINOES_ALL5S") /* GXTEntry: "Dominoes: All Fives" */, true);
							break;
						case 3:
							MAP::SET_BLIP_SPRITE(iLocal_30, joaat("BLIP_MG_DOMINOES_ALL3S") /* GXTEntry: "Dominoes: All Threes" */, true);
							break;
						default:
							MAP::SET_BLIP_SPRITE(iLocal_30, joaat("BLIP_MG_DOMINOES") /* GXTEntry: "Dominoes" */, true);
							break;
			...
			if (bVar0)
			{
				if (func_27(iLocal_14, 1))
				{
					...
					if (!VOLUME::DOES_VOLUME_EXIST(iLocal_31))
					{
						...
						func_28(iLocal_31, "TABLE" /* GXTEntry: "Table" */, 1, 0, 0, 0, -1082130432 /* Float: -1f */);
					}
					iVar4 = 0;
					while (iVar4 < 27)
					{
...
int func_150(int iParam0, int iParam1)
{
	...
	{
		return func_211(0, func_210(iParam1, 1), 11, joaat("CABR01") /* GXTEntry: "High and Low Finance" */);
	}
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_362(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD" /* GXTEntry: "Cold" */, "PMPLAYER_CONDITION_TEMPERATURE_HOT" /* GXTEntry: "Hot" */);
					}
					break;
				case 2:
					return func_362(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD" /* GXTEntry: "Good" */, "PMPLAYER_CONDITION_HONOR_BAD" /* GXTEntry: "Bad" */);
			}
			break;
		case 1:
		case 2:
