...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -4.8914f, 4.5717f, 1.3249f, 0.0f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, 1.419f, -2.8019f, 1.0068f, 0.0f, 1.5f, 1.75f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, joaat("P_CS_BOOK04X"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 1, 1);
	...
	func_154(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_BOOK_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_155(uParam0, "CDT24AU");
	sLocal_18 = { func_156(uParam0, 1.8823f, -0.2919f, 1.0249f, -144.72f, 8.0f, 0.63f, 0.63f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_195(uParam0, sLocal_18, 1, 0))
		{
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_251(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_265(uParam0->f_107[iVar12 /*113*/].f_1));
				}
...
bool func_195(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
