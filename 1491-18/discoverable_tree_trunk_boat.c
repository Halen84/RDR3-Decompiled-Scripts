#pragma region Local_Variables
	...
	int iLocal_17 = 0;
	int iLocal_18 = 0;
	struct<5> /*40*/ sLocal_19 = { 0, 0, 0, 0, -1 } ;
	var uLocal_24 = 0;
	var uLocal_25 = 0;
	var uLocal_26 = 0;
	var uLocal_27 = 0;
...
void __SCRIPT()
{
	fLocal_7 = 1.0f;
	fLocal_8 = 1.0f;
	iLocal_18 = sScriptParam_0.f_0;
	sLocal_19.f_1 = sScriptParam_0.f_1;
		...
		switch (iLocal_17)
		{
			case 0:
				if (func_3(&sLocal_19))
				{
					...
					if (sLocal_19.f_4 == -1)
					{
						sLocal_19.f_4 = func_4(&sLocal_19);
					}
				}
				break;
			case 1:
...
bool func_3(var uParam0)
{
	...
	if (sLocal_19.f_0 == 0)
	{
		...
		sLocal_19.f_0 = func_10(iVar0);
		return false;
	}
	if (func_11(sLocal_19.f_0, 4) || Global_40.f_8863.f_156)
	{
		func_1(uParam0);
		return false;
	}
...
{
	uParam0->f_6.f_2 = { func_59(uParam0, uParam0->f_4) /*3*/ };
...
int func_26(var uParam0)
{
	...
	return (func_68() - BUILTIN::ROUND((uParam0->f_1 * 1000.0f)));
}
...
void func_28(var uParam0)
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == joaat("DISCOVER_LOC_GRAVE_ARTHUR"))
		{
			if (func_49(*uParam0))
			{
				uParam0->f_6.f_8 = func_72("DISCO_FOCUS" /* GXTEntry: "View" */, joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
				func_34(uParam0->f_6.f_8, 0, 1);
			}
			else
			{
				uParam0->f_6.f_8 = func_72("DISCO_EXAMINE" /* GXTEntry: "Inspect" */, joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
			}
		}
		else if (*uParam0 == joaat("DISCOVER_LOC_GRAVE"))
		{
		...
		else if (*uParam0 == joaat("DISCOVER_LOC_BRAITHWAITES_SECRET"))
		{
			...
			{
				uParam0->f_6.f_8 = func_72("DISCO_EXAMINE" /* GXTEntry: "Inspect" */, joaat("INPUT_CONTEXT_Y"), Global_35, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("PLAYER_FOCUS_TIMING"), 0, 0);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_72("DISCO_EXAMINE" /* GXTEntry: "Inspect" */, joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("PLAYER_FOCUS_TIMING"), 0, 0);
		}
...
void func_32(int iParam0, int iParam1)
{
	...
	Global_40.f_8863[func_57(iParam0, 1)] |= iParam1;
}
...
void func_41(var uParam0)
{
	...
	uParam0->f_6.f_10 = { func_59(uParam0, uParam0->f_4) /*3*/ };
}
...
bool func_46(var uParam0)
{
	...
	{
		func_93(*uParam0, &sVar0);
		if (FIRE::GET_OWNER_OF_EXPLOSION_IN_ANGLED_AREA(-1, sVar0, sVar0.f_3, sVar0.f_6) == func_94(Global_35))
		{
			return true;
		}
...
bool func_69(var uParam0)
{
	...
	{
		case joaat("DISCOVER_LOC_ABANDONED_OIL_WELL"):
			if (func_109(Global_35, func_101(uParam0, 0), 3.0f, 1, 1))
			{
				return true;
			}
			break;
...
bool func_70(var uParam0, int iParam1)
{
	...
	if (!func_110(iParam1, (1 << 11)) && !func_114(0))
	{
		return false;
	}
	...
	else if (func_117(Global_35, joaat("SCRIPT_TASK_ENTER_ANIM_SCENE")))
	{
		return false;
	}
	else if (func_117(Global_35, joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD")))
	{
		return false;
	}
	return true;
...
int func_72(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 48)
	{
		if (func_118(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_119(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
bool func_88()
{
	...
	if (!func_123(joaat("DOCUMENT_PLAYER_JOURNAL") /* GXTEntry: "Journal" */, 1, 0))
	{
	...
	if (ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, -1) || func_117(Global_35, joaat("SCRIPT_TASK_ENTER_ANIM_SCENE")))
	{
		return false;
	}
	...
	if (INVENTORY::_INVENTORY_IS_INVENTORY_ITEM_EQUIPPED(func_125(0), iVar0, false))
	{
		return false;
	}
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_139(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS" /* GXTEntry: "+" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_139(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT" /* GXTEntry: "+" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_139(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG" /* GXTEntry: "~COLOR_RED~-~s~" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_139(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT" /* GXTEntry: "~COLOR_RED~-~s~" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
	sVar8 = { func_136(joaat("HONOR_CURRENT")) /*2*/ };
...
bool func_114(bool bParam0)
{
	if (PED::IS_PED_CARRYING_SOMETHING(Global_35) && !Global_1392040.f_2)
	{
		if (bParam0)
		{
			func_152("ITEM_UNUSABLE_CARRYING" /* GXTEntry: "Cannot use this item while carrying something." */, 10000, 0, 0, 0, 1);
		}
		return false;
	}
	return true;
...
bool func_115(int iParam0)
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if ((!func_110(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35)) && VEHICLE::GET_DRIVER_OF_VEHICLE(iVar0) == Global_35)
		{
			return false;
		}
	}
...
int func_128(int iParam0)
{
	...
	fVar1 = func_164(MISC::ABSF(fVar1) < 1.0f, func_164(fVar1 < 0.0f, -1.0f, 1.0f), fVar1);
...
struct<2> /*16*/ func_136(int iParam0)
{
	struct<2> /*16*/ sVar0;
...
int func_139(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, bool bParam8)
{
	struct<4> /*32*/ sVar0;
	struct<7> /*56*/ sVar13;
	int iVar20;
...
bool func_143()
{
	if (func_180(joaat("WS_GRAVE_ARTHUR_GOOD")))
	{
		return true;
	}
	return false;
...
bool func_144()
{
	if (func_180(joaat("WS_GRAVE_ARTHUR_BAD")))
	{
		return true;
	}
	return false;
...
int func_152(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	struct<4> /*32*/ sVar0;
	struct<2> /*16*/ sVar13;
	int iVar15;
...
bool func_160(int iParam0, int iParam1)
{
	...
	if (func_186("ALL WEAPONS", &iVar1, &iVar2, joaat("SLOTID_NONE"), 0))
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_187(&sVar4, iVar3, iVar1, iVar2))
			{
			}
			else if (!func_188(sVar4.f_4))
			{
			}
...
int func_161(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_125(bParam2), iParam0, false);
	return iVar2;
}
...
int func_185(int iParam0, int iParam1)
{
	...
	if (func_194(iParam0, joaat("CI_TAG_ITEM_AMMOBOX")))
	{
...
int func_190(int iParam0, bool bParam1)
{
	...
	sVar0 = { func_196(iParam0, joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0) /*18*/ };
	if (bParam1)
	{
		func_198(&sVar0, func_197(0));
	}
	if (!func_199(&sVar0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_189(iVar18);
...
struct<18> /*144*/ func_196(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
struct<4> /*32*/ func_197(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_203(joaat("CARRIED_WEAPONS"), func_202(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_203(joaat("CARRIED_WEAPONS"), func_202(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_203(joaat("CARRIED_WEAPONS"), func_202(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

void func_198(var uParam0, struct<4> /*32*/ sParam1)
{
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_125(bParam3), uParam0, iParam2);
	if (*uParam1 >= 0)
	{
		return true;
	}
...
struct<4> /*32*/ func_203(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_125(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}

struct<4> /*32*/ func_204()
{
	struct<4> /*32*/ sVar0;
