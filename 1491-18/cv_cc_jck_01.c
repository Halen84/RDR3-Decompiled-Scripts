...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -4.6948f, -6.0379f, 0.5953f, 0.0f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	func_152(uParam0, -0.6181f, -4.9017f, 1.0264f, 0.0f, 2.0f, 2.5f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	func_153(uParam0, joaat("P_HAMMER02X"), 0.0f, 0.0f, 0.0f, "HAMMER", 0, 0, 1);
	func_153(uParam0, joaat("P_NAILSINGLE01X"), 0.0f, 0.0f, 0.0f, "NAIL", 0, 0, 1);
	func_153(uParam0, joaat("P_NAILBOX01X"), 0.0f, 0.0f, 0.0f, "NAILBOX", 0, 0, 1);
	func_153(uParam0, joaat("P_STICKFIREPOKER01X"), 0.0f, 0.0f, 0.0f, "STICK", 0, 0, 1);
	if (func_148(uParam0) == 1)
	{
		func_153(uParam0, joaat("P_NAILSINGLE01X"), 0.0f, 0.0f, 0.0f, "NAIL1", 0, 0, 1);
		func_153(uParam0, joaat("P_NAILSINGLE01X"), 0.0f, 0.0f, 0.0f, "NAIL2", 0, 0, 1);
	...
	sLocal_20 = { func_157(uParam0, -0.5328f, -4.6082f, 1.0467f, 115.92f, 7.0f, 0.5f, 0.5f) /*10*/ };
	sLocal_30 = { func_157(uParam0, -0.533f, -4.608f, 1.047f, -100.44f, 7.0f, 0.3f, 0.3f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	if (func_195(uParam0, iLocal_16))
	{
		if (func_196(uParam0, sLocal_20, 1, 0))
		{
			...
			PLAYER::_0x3946FC742AC305CD(PLAYER::GET_PLAYER_INDEX(), func_48(uParam0, iLocal_15), "CCJCK_CNV_1", 0.0f, 0.0f, 0.0f, 0, 0);
...
bool func_96(var uParam0)
{
	if (func_148(uParam0) == 1)
	{
		if (!TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(joaat("HSO_VIGNETTE_WAGON_PROPS")))
		{
			if (CAM::IS_SPHERE_VISIBLE(-110.1304f, -45.78891f, 94.60996f, 1.0f))
			{
			...
			{
				func_111(&uLocal_40, 0.0f);
			}
			if (func_109(&uLocal_40) >= 3.0f)
			{
