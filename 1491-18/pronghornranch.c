		...
		if (MISC::GET_GAME_TIMER() > iLocal_227)
		{
			...
			switch (iLocal_226)
			{
				...
				case 1:
					...
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_228));
				...
				case 6:
					if (func_7(func_6(iLocal_228)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_228 /*35*/].f_11 > 0.0f)
							{
								PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1888801[iLocal_228 /*35*/].f_11);
							}
							Jump @785; // curOff = 766
							func_42(iVar0);
							iVar0 = (1 + iVar0);
						...
						{
							PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1888801[iLocal_228 /*35*/].f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	...
	if (!func_52(joaat("WS_PRONGHORN_RANCH_EXIST")))
	{
		return true;
	}
...
bool func_38(int iParam0)
{
	...
	if (func_20() == -1)
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Global_35) && !ENTITY::IS_ENTITY_DEAD(Global_35)) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Global_35, false, false), func_60(), true) <= 100.0f)
		{
			func_63(&uLocal_162, (1 << 10), &uLocal_162, func_61(), 0, func_62(), 0, 0, 0);
		}
		func_64();
		bVar0 = func_65();
		if (!bVar0)
...
void func_46()
{
	...
	func_93(&iLocal_222, -2547.255f, 405.9721f, 160.379f, 0.0f, 0.0f, -6.0f, 130.0f, 214.0f, 60.0f, joaat("VOLBOX"));
	func_93(&iLocal_222, -2600.745f, 471.1957f, 160.0371f, 0.0f, 0.0f, -6.0f, 19.0f, 52.0f, 60.0f, joaat("VOLCYLINDER"));
	func_94(&iLocal_223, -2548.949f, 325.763f, 160.0f, 0.0f, 0.0f, 9.000001f, 55.0f, 13.0f, 60.0f, joaat("VOLBOX"));
	func_94(&iLocal_223, -2579.138f, 330.9276f, 160.0f, 0.0f, 0.0f, -30.0f, 19.0f, 16.0f, 60.0f, joaat("VOLCYLINDER"));
	func_94(&iLocal_223, -2518.681f, 397.0634f, 160.0f, 0.0f, 0.0f, -4.5f, 25.0f, 127.0f, 60.0f, joaat("VOLBOX"));
	func_94(&iLocal_223, -2534.318f, 495.423f, 160.0f, 0.0f, 0.0f, -9.000002f, 13.0f, 10.0f, 60.0f, joaat("VOLBOX"));
	func_94(&iLocal_223, -2600.49f, 392.029f, 160.0f, 0.0f, 0.0f, -3.0f, 10.0f, 34.0f, 60.0f, joaat("VOLBOX"));
	func_94(&iLocal_223, -2518.894f, 334.922f, 160.0f, 0.0f, 0.0f, -12f, 7.0f, 11.0f, 60.0f, joaat("VOLCYLINDER"));
	func_94(&iLocal_223, -2505.076f, 442.9265f, 160.0f, 0.0f, 0.0f, -6.0f, 4.0f, 22.0f, 60.0f, joaat("VOLCYLINDER"));
	func_94(&iLocal_223, -2552.524f, 396.2589f, 160.0f, 0.0f, 0.0f, 0.0f, 64.0f, 145.0f, 60.0f, joaat("VOLBOX"));
	func_94(&iLocal_223, -2505.803f, 461.1734f, 160.0f, 0.0f, 0.0f, 2.000002f, 10.0f, 13.0f, 60.0f, joaat("VOLBOX"));
	func_94(&iLocal_223, -2522.517f, 477.1015f, 160.0f, 0.0f, 0.0f, 42f, 19.0f, 25.0f, 60.0f, joaat("VOLCYLINDER"));
	func_94(&iLocal_223, -2610.8f, 450.1638f, 160.0f, 0.0f, 0.0f, 13f, 4.0f, 16.0f, 60.0f, joaat("VOLCYLINDER"));
	func_94(&iLocal_223, -2589.791f, 359.6104f, 160.0f, 0.0f, 0.0f, 6.0f, 16.0f, 43.0f, 60.0f, joaat("VOLCYLINDER"));
	func_94(&iLocal_223, -2568.966f, 463.1732f, 160.0f, 0.0f, 0.0f, 25f, 86.0f, 43.0f, 60.0f, joaat("VOLBOX"));
	func_94(&iLocal_223, -2593.714f, 423.6152f, 160.0f, 0.0f, 0.0f, 9.000002f, 28.0f, 76.0f, 60.0f, joaat("VOLBOX"));
	iVar0 = iLocal_223;
	...
	if (!func_121(uParam0->f_3, iVar0))
	{
		if (func_121(uParam0->f_3, 2))
		{
			if (!SCRIPTS::IS_THREAD_ACTIVE(*uParam2, false))
			{
				...
				{
					uParam0->f_52 = { func_123(iParam1) /*3*/ };
					uParam0->f_5 = func_119(func_117(iParam1), 0, 3, func_118(iParam1));
...
bool func_66()
{
	...
	if (VOLUME::DOES_VOLUME_EXIST(iLocal_223) && VOLUME::IS_POINT_IN_VOLUME(iLocal_223, Global_36))
	{
		...
		HUD::_ENABLE_HUD_CONTEXT_THIS_FRAME(joaat("HUD_CTX_IN_CAMP"));
		return true;
	}
	return false;
}
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_58(iParam0) && func_91(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_140(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_140(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_140(&cVar6, joaat("COLOR_PURE_WHITE")), func_140(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
void func_93(int iParam0, Vector3 vParam1, Vector3 vParam4, Vector3 vParam7, int iParam10)
{
	...
	{
		fVar0 = func_165((vParam7.x - 4.0f), 0.1f);
		fVar1 = func_165((vParam7.y - 4.0f), 0.1f);
		vVar2 = { fVar0, fVar1, vParam7.z /*3*/ };
		iVar5 = VOLUME::_CREATE_VOLUME_BY_HASH(iParam10, vParam1, vParam4, vVar2);
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(*iParam0, iVar5);
	}
}
...
void func_94(int iParam0, Vector3 vParam1, Vector3 vParam4, Vector3 vParam7, int iParam10)
{
	...
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(*iParam0, iVar0);
	func_166(&iVar1, vParam1, vParam4, vParam7, 6, iParam10, 0, 1);
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(*iParam0, iVar1);
}
...
bool func_122(var uParam0)
{
	...
	if ((!func_121(uParam0->f_3, (1 << 15)) && func_185(uParam0->f_1, &fVar1)) && func_186(uParam0->f_1, 0, &fVar0))
	{
		fVar2 = func_187();
		if ((func_187() - fVar1) >= fVar0)
		{
			func_184(&(uParam0->f_3), (1 << 15));
		}
	}
	if (func_121(uParam0->f_3, (1 << 15)))
	{
		return true;
	}
	return false;
...
bool func_124()
{
	...
	uVar0 = 5;
	func_188(&sLocal_116, 714, &uVar0, 0, 0);
	sLocal_116[0 /*45*/].f_43 = 27465;
	sLocal_116[0 /*45*/].f_44 = 27765;
	func_191(&(sLocal_116[0 /*45*/]), (1 << 9));
	return true;
}
...
int func_141(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_145(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_157()
{
	if (func_205(&(sLocal_116[0 /*45*/].f_34)))
	{
		func_206(&(sLocal_116[0 /*45*/].f_34));
	}
	func_207(sLocal_116[0 /*45*/].f_38);
	func_207(sLocal_116[0 /*45*/].f_39);
}
...
void func_166(int iParam0, Vector3 vParam1, Vector3 vParam4, Vector3 vParam7, int iParam10, int iParam11, int iParam12, bool bParam13)
{
	float fVar0[4];
	int iVar5;
	int iVar6;
...
void func_188(var uParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	func_191(uParam0[iParam3 /*45*/], (1 << 15));
	func_191(uParam0[iParam3 /*45*/], (1 << 10));
...
void func_213(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_256(iParam0, (1 << 10)))
		{
			func_257(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_256(iParam0, (1 << 10)))
	{
...
bool func_249(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (uParam0->f_30 == 1)
	{
		if (!func_245(uParam0, (1 << 16)) && func_272(Global_35, iVar0, 1) > 25.0f)
		{
			func_273(1, 1, 0);
		}
	...
	else
	{
		...
		if (func_272(Global_35, iVar0, 1) < 49.0f)
		{
...
bool func_251(Vector3 vParam0, int iParam3)
{
	...
	func_288(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_289(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
bool func_274(var uParam0, bool bParam1)
{
	...
	if (!func_308(bVar0, func_245(uParam0, (1 << 11))))
	{
		return false;
	}
	if (uParam0->f_30 == 0)
	{
		if (!func_245(uParam0, (1 << 11)) && !func_245(uParam0, (1 << 15)))
		{
			...
			else if (func_245(uParam0, (1 << 10)))
			{
				if (func_309(&(uParam0->f_34)) < 5.0f)
				{
					return false;
				}
			}
			else if (func_309(&(uParam0->f_34)) < 25.0f)
			{
				return false;
			}
		}
...
bool func_279(var uParam0, int iParam1)
{
	...
	if (func_245(uParam0, 128))
	{
		...
		while (iVar0 < 5)
		{
			...
			if (func_282(iVar1, 0) && func_311(iVar1, iParam1, 1, 1) <= 4.0f)
			{
				uParam0->f_21 = iVar0;
				return true;
			}
	...
	if (!func_245(uParam0, (1 << 9)) && !func_245(uParam0, 256))
	{
		return true;
	}
	if (func_245(uParam0, (1 << 9)))
	{
		if (func_312(uParam0))
		{
			return true;
...
void func_287(var uParam0)
{
	...
	func_242(&(uParam0->f_34), 1);
	uParam0->f_40 = { func_321() /*3*/ };
	uParam0->f_21 = -1;
	if (func_245(uParam0, (1 << 14)))
	{
		func_322(uParam0, (1 << 14));
	}
	func_322(uParam0, (1 << 15));
	func_322(uParam0, (1 << 10));
	func_206(&uLocal_15);
	if (func_245(uParam0, (1 << 12)))
	{
		...
		{
			func_324(iVar0, 0);
			func_322(uParam0, (1 << 13));
			func_322(uParam0, (1 << 12));
		}
	}
}
...
bool func_312(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
		if (func_272(Global_35, iVar0, 1) < 9.0f)
		{
			return true;
		}
	}
...
bool func_317(int iParam0, int iParam1)
{
	...
	return func_256(Global_1914319.f_3[iParam0 /*446*/].f_10, (1 << 10));
}
