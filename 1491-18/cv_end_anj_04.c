...
bool func_72(var uParam0)
{
	...
	func_157(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_CROUCH_INSPECT"), "WORLD_HUMAN_CROUCH_INSPECT_MALE_C", -1, 1, 1.0f, 1065353216 /* Float: 1f */, 1);
...
int func_345(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_384(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) /*3*/ };
