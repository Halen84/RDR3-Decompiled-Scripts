				...
				case 6:
					if (func_7(func_6(iLocal_22)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_22 /*35*/].f_11 > 0.0f)
							{
...
bool func_11()
{
	iLocal_14 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-2395.549f, -2409.981f, 35.0f, 0.0f, 0.0f, -2.0f, 115.0f, 87.0f, 50.0f, "m_volMacFarlanesRanch");
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		iLocal_18 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("MacFarlanes' Ranch - m_volLivestockOwnership Agg");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2397.539f, -2380.358f, 63.54964f, 0.0f, 0.0f, 69.87278f, 9.356425f, 9.762298f, 16.92971f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2454.959f, -2384.037f, 35.0f, 0.0f, 0.0f, 25.5349f, 24.66208f, 30.76534f, 39.15789f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2411.945f, -2374.556f, 63.25839f, 0.0f, 0.0f, -16.81672f, 11.05804f, 16.78223f, 9.688599f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2465.952f, -2383.441f, 27.18244f, 0.0f, 0.0f, 21.15438f, 14.65817f, 21.71472f, 39.15789f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2455.885f, -2398.27f, 43.6138f, 0.0f, 0.0f, 31.47044f, 15.61658f, 17.41739f, 30.62743f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2453.473f, -2398.197f, 43.6138f, 0.0f, 0.0f, 31.47043f, 16.73191f, 17.41739f, 30.62743f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2457.314f, -2396.39f, 43.6138f, 0.0f, 0.0f, 44.06578f, 16.73191f, 17.41739f, 30.62743f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2432.721f, -2360.609f, 66.342f, 0.0f, 0.0f, -59.51217f, 44.12811f, 56.53022f, 19.75536f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2429.221f, -2392.539f, 64.86296f, 0.0f, 0.0f, 30.36721f, 35.19614f, 20.94381f, 14.33946f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2405.119f, -2471.914f, 63.25839f, 0.0f, 0.0f, 16.82132f, 13.84418f, 7.762568f, 9.688599f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2418.703f, -2436.631f, 63.54964f, 0.0f, 0.0f, 18.87025f, 14.41697f, 14.95155f, 16.92971f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2407.512f, -2449.14f, 64.5022f, 0.0f, 0.0f, 48.91291f, 13.99343f, 21.49771f, 12.90299f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2416.311f, -2452.443f, 64.20742f, 0.0f, 0.0f, 3.371748f, 14.65324f, 19.53584f, 12.77374f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2399.068f, -2464.15f, 64.86296f, 0.0f, 0.0f, 18.69488f, 16.30252f, 23.22957f, 14.33946f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -2414.51f, -2467.064f, 61.83258f, 0.0f, 0.0f, -78.00346f, 14.14975f, 15.2253f, 17.07607f);
		iLocal_17 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("MacFarlanes' Ranch - m_volRancherThreat Agg");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -2367.028f, -2392.284f, 62.65725f, 0.0f, 0.0f, 80.66904f, 7.899721f, 3.250947f, 3.33819f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -2397.539f, -2380.358f, 63.54964f, 0.0f, 0.0f, 69.87278f, 9.356425f, 9.762298f, 16.92971f);
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, -2395.549f, -2409.981f, 35.0f, 0.0f, 0.0f, -2.0f, 115.0f, 87.0f, 50.0f);
		...
		LAW::_SET_GUARD_ZONE_VOLUME_WARNING(sLocal_15, iLocal_17);
...
void func_56()
{
	...
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar2) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(joaat("RANCHES_PLAYER_USABLE")))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(joaat("RANCHES_PLAYER_USABLE"), false);
			return;
		}
	...
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar3) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(joaat("RANCHES_PLAYER_USABLE")))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(joaat("RANCHES_PLAYER_USABLE"), false);
			return;
		}
	}
	if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(iVar4))
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar4) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(joaat("RANCHES_PLAYER_USABLE")))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(joaat("RANCHES_PLAYER_USABLE"), false);
			return;
		}
	}
	if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(iVar5))
	{
		if (!PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar5) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(joaat("RANCHES_PLAYER_USABLE")))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(joaat("RANCHES_PLAYER_USABLE"), false);
		}
		else if (PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(iVar5) && !TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(joaat("RANCHES_PLAYER_USABLE")))
		{
...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_105(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_105(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_105(&cVar6, joaat("COLOR_PURE_WHITE")), func_105(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
void func_76(int iParam0)
{
	...
	func_52(0.775f, 0.2f, 0.025f, 0.0f);
}
...
char* func_105(char* sParam0, int iParam1)
{
	...
	return func_140(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_106(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_110(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_121(int iParam0)
{
	...
	func_148(iParam0, (1 << 13));
	func_148(iParam0, (1 << 14));
	func_148(iParam0, (1 << 15));
	func_148(iParam0, (1 << 17));
	func_148(iParam0, (1 << 24));
	func_148(iParam0, (1 << 19));
	func_148(iParam0, (1 << 20));
...
void func_151(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_173(iParam0, (1 << 10)))
		{
			func_174(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_173(iParam0, (1 << 10)))
	{
		func_175(iParam0, (1 << 10));
		INVENTORY::_0x9B4E793B1CB6550A();
	}
	func_176(iParam0);
}
...
bool func_165(Vector3 vParam0, int iParam3)
{
	...
	func_181(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_182(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
