...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, joaat("P_CHAIRFOLDING02X"), 0.0f, 0.0f, 0.0f, "CHAIR" /* GXTEntry: "Chair" */, 1, 0, 1);
	func_152(uParam0, joaat("P_BOTTLEBEER01X"), 0.0f, 0.0f, 0.0f, "BOTTLE", 0, 0, 1);
	if (func_148(uParam0) == 1)
	{
		func_152(uParam0, joaat("P_BASKET02X"), 0.0f, 0.0f, 0.0f, "BASKET" /* GXTEntry: "Basket" */, 0, 0, 1);
	}
