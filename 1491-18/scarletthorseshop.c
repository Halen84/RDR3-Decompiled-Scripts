		...
		if (MISC::GET_GAME_TIMER() > iLocal_237)
		{
			...
			switch (iLocal_236)
			{
				...
				case 1:
					...
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_238));
				...
				case 6:
					if (func_7(func_6(iLocal_238)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_238 /*35*/].f_11 > 0.0f)
							{
								PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1888801[iLocal_238 /*35*/].f_11);
							}
							Jump @788; // curOff = 769
							func_42(iVar0);
							iVar0 = (1 + iVar0);
						...
						{
							PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1888801[iLocal_238 /*35*/].f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	iLocal_229 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(1209.053f, -193.1814f, 101.852f, 0.0f, 0.0f, 19.83985f, 6.216366f, 11.62523f, 3.695f, "ScarlettMeadows Horse Shop - m_volHorseShop");
	iLocal_230 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(1207.376f, -186.3412f, 100.5991f, 0.0f, 0.0f, 17f, 4.0f, 4.18f, 7.0f, "ScarlettMeadows Horse Shop - m_volHorseShopOutsideDoor");
	func_46(9, iLocal_230);
	iLocal_231 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("SCH_HORSESHOP_GUARD");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_231, 1193.417f, -220.1935f, 101.9785f, 0.0f, 0.0f, 14.80028f, 34.68813f, 24.66934f, 23.864f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_231, 1214.513f, -212.8789f, 101.9785f, 0.0f, 0.0f, 15.60754f, 23.67516f, 28.10355f, 23.864f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_231, 1187.173f, -208.151f, 105.1929f, 0.0f, 0.0f, 43.4823f, 32.91484f, 13.00947f, 30.26328f);
	iLocal_232 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(1209.053f, -193.1814f, 101.9785f, 0.0f, 0.0f, 19.83985f, 100.2164f, 100.6252f, 30.88881f, "ScarlettMeadows Horse Shop - GUARDS REGISTER");
	return true;
}
...
int func_15(int iParam0)
{
	...
	return func_50(&uLocal_22, (1 << 18), &uLocal_22, func_48(), 0, func_49(), 0, 0, 0);
}
...
void func_27(int iParam0)
{
	...
	func_58(9, 1889654345, -1.0f, 1);
	func_58(9, -937753286, 1.0f, 1);
	if (func_59(15))
	{
		func_60(35, 9, 0, 0);
	}
...
void func_47()
{
	...
	uVar0 = 5;
	func_92(&sLocal_183, 804, &uVar0, 0, 0);
	sLocal_183[0 /*45*/].f_43 = 10136;
	sLocal_183[0 /*45*/].f_44 = 10231;
	func_95(&(sLocal_183[0 /*45*/]), (1 << 9));
}
	...
	if (!func_106(uParam0->f_3, iVar0))
	{
		if (func_106(uParam0->f_3, 2))
		{
			if (!SCRIPTS::IS_THREAD_ACTIVE(*uParam2, false))
			{
				...
				{
					uParam0->f_52 = { func_108(iParam1) /*3*/ };
					uParam0->f_5 = func_104(func_102(iParam1), 0, 3, func_103(iParam1));
...
void func_55(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	vVar1 = { func_116(iVar0) /*3*/ };
	vVar4 = { func_117(iVar0) /*3*/ };
	if (func_98(vVar1))
	{
		return;
	}
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_62(iParam0) && func_91(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_164(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_164(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_164(&cVar6, joaat("COLOR_PURE_WHITE")), func_164(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
void func_92(var uParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	func_95(uParam0[iParam3 /*45*/], (1 << 15));
	func_95(uParam0[iParam3 /*45*/], (1 << 10));
...
bool func_107(var uParam0)
{
	...
	if ((!func_106(uParam0->f_3, (1 << 15)) && func_203(uParam0->f_1, &fVar1)) && func_204(uParam0->f_1, 0, &fVar0))
	{
		fVar2 = func_205();
		if ((func_205() - fVar1) >= fVar0)
		{
			func_202(&(uParam0->f_3), (1 << 15));
		}
	}
	if (func_106(uParam0->f_3, (1 << 15)))
	{
		return true;
	}
	return false;
...
bool func_123(int iParam0, int iParam1)
{
	...
	if (func_118(iParam0, (1 << 14)) && !func_217(iParam0, 1))
	{
		return true;
	}
	if (!func_112(iParam1))
...
bool func_143(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (uParam0->f_30 == 1)
	{
		if (!func_226(uParam0, (1 << 16)) && func_227(Global_35, iVar0, 1) > 25.0f)
		{
			func_228(1, 1, 0);
		}
	...
	else
	{
		...
		if (func_227(Global_35, iVar0, 1) < 49.0f)
		{
...
char* func_164(char* sParam0, int iParam1)
{
	...
	return func_251(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_165(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_169(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_179()
{
	if (func_187(&(sLocal_183[0 /*45*/].f_34)))
	{
		func_256(&(sLocal_183[0 /*45*/].f_34));
	}
	func_257(sLocal_183[0 /*45*/].f_38);
	func_257(sLocal_183[0 /*45*/].f_39);
}
...
void func_181(int iParam0)
{
	...
	func_260(iParam0, (1 << 13));
	func_260(iParam0, (1 << 14));
	func_260(iParam0, (1 << 15));
	func_260(iParam0, (1 << 17));
	func_260(iParam0, (1 << 24));
	func_260(iParam0, (1 << 19));
	func_260(iParam0, (1 << 20));
...
void func_214(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_221(iParam0, (1 << 10)))
		{
			func_222(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_221(iParam0, (1 << 10)))
	{
		func_291(iParam0, (1 << 10));
		INVENTORY::_0x9B4E793B1CB6550A();
	}
	func_292(iParam0);
}
...
bool func_229(var uParam0, bool bParam1)
{
	...
	if (!func_307(bVar0, func_226(uParam0, (1 << 11))))
	{
		return false;
	}
	if (uParam0->f_30 == 0)
	{
		if (!func_226(uParam0, (1 << 11)) && !func_226(uParam0, (1 << 15)))
		{
			...
			else if (func_226(uParam0, (1 << 10)))
			{
				if (func_308(&(uParam0->f_34)) < 5.0f)
				{
					return false;
				}
			}
			else if (func_308(&(uParam0->f_34)) < 25.0f)
			{
				return false;
			}
		}
...
bool func_231(int iParam0)
{
	...
	return func_221(iParam0, (1 << 30));
}

void func_232(int iParam0)
{
	func_291(iParam0, (1 << 30));
}
...
bool func_234(var uParam0, int iParam1)
{
	...
	if (func_226(uParam0, 128))
	{
		...
		while (iVar0 < 5)
		{
			...
			if (func_237(iVar1, 0) && func_309(iVar1, iParam1, 1, 1) <= 4.0f)
			{
				uParam0->f_21 = iVar0;
				return true;
			}
	...
	if (!func_226(uParam0, (1 << 9)) && !func_226(uParam0, 256))
	{
		return true;
	}
...
void func_242(var uParam0)
{
	...
	func_188(&(uParam0->f_34), 1);
	uParam0->f_40 = { func_317() /*3*/ };
	uParam0->f_21 = -1;
	if (func_226(uParam0, (1 << 14)))
	{
		func_318(uParam0, (1 << 14));
	}
	func_318(uParam0, (1 << 15));
	func_318(uParam0, (1 << 10));
	func_256(&uLocal_82);
	if (func_226(uParam0, (1 << 12)))
	{
		...
		{
			func_319(iVar0, 0);
			func_318(uParam0, (1 << 13));
			func_318(uParam0, (1 << 12));
		}
	}
}
...
bool func_269(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
		if (func_227(Global_35, iVar0, 1) < 9.0f)
		{
			return true;
		}
	}
...
bool func_313(int iParam0, int iParam1)
{
	...
	return func_221(Global_1914319.f_3[iParam0 /*446*/].f_10, (1 << 10));
}
...
bool func_320(Vector3 vParam0, int iParam3)
{
	...
	func_345(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_346(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
