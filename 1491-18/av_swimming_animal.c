	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[0 /*14*/], iLocal_17, 0, 0, false, true, 0, false, -1.0f, false);
			...
			break;
		case 1:
			if (func_68(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */) || func_69(&uLocal_14, 6.0f))
			{
				func_65(uParam0);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uParam0->f_20[0 /*14*/], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_20[0 /*14*/], 0.0f, 12.0f, 0.0f), 1.0f, -1, 0.25f, 8193, 40000.0f);
				iLocal_10 = 3;
			}
			break;
		case 3:
			...
			if (!func_71(uParam0->f_20[0 /*14*/], joaat("SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD")))
			{
				return 1;
			}
			break;
