...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.45f, -0.15f, 1.007f, 85.5f, 2.5575f, 1.875f, 2.365f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, -3.575f, -0.7f, 1.0195f, 87.75f, 2.0f, 2.0f, 2.335f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, -3.87134f, -1.09542f, 1.00508f, 0.0f, 1.0f, 1.0f, 2.0f, joaat("VOLCYLINDER"), 1);
	func_153(uParam0, joaat("P_CHAIR24X"), -4.62596f, -1.37365f, -0.000255585f, "p_chair24x", 1, 0, 1);
	func_153(uParam0, joaat("P_CIGARETTE01X"), 0.0f, 0.0f, 0.0f, "p_cigarette01x", 0, 1, 1);
	iLocal_16 = func_153(uParam0, joaat("P_CS_BOOK04X"), 0.0f, 0.0f, 0.0f, "p_cs_book03x", 0, 0, 1);
	...
	func_158(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, iLocal_14, iLocal_16, "p_cs_book04x_PH_R_HAND", 0, 0);
	func_156(uParam0, iLocal_14, 4, 2, 0, 0, 0);
	sLocal_19 = { func_160(uParam0, -4.265f, -1.51f, 1.07f, -62.75f, 4.8025f, 0.0f, 0.82f) /*10*/ };
	iLocal_29 = func_161(uParam0, 3.3625f, 1.3387f, 2.4264f, 0.0f, 0.0f, 174.515f, 16.4725f, 16.24f, 5.0f, "Start_Trigger", joaat("VOLBOX"));
	func_162(uParam0, 1);
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_202(uParam0, sLocal_19, 1, 1))
		{
...
bool func_245(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_320(iVar0) && func_321(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_328(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_398(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
