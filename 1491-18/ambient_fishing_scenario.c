...
bool func_20(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(sLocal_5.f_5) && ENTITY::DOES_ENTITY_EXIST(sLocal_5.f_6))
	{
		if (!PHYSICS::DOES_ROPE_EXIST(sLocal_5.f_8))
		{
			...
			PHYSICS::_CREATE_ROPE_WINDING_ABILITY(sLocal_5.f_8, 0, 0, -1.0f, true);
		...
		if (!PHYSICS::DOES_ROPE_EXIST(sLocal_5.f_9))
		{
			...
			PHYSICS::_CREATE_ROPE_WINDING_ABILITY(sLocal_5.f_9, 0, 0, -1.0f, true);
...
bool func_22(int iParam0)
{
	...
	else if (PHYSICS::_ROPE_GET_FORCED_LENGTH(sLocal_5.f_8) >= sLocal_5.f_12)
	{
...
bool func_23()
{
	...
	else if (PHYSICS::_ROPE_GET_FORCED_LENGTH(sLocal_5.f_8) <= sLocal_5.f_10)
	{
		PHYSICS::STOP_ROPE_UNWINDING_FRONT(sLocal_5.f_8);
		sLocal_5.f_17 = 0;
		PHYSICS::SET_DAMPING(sLocal_5.f_5, 0, sLocal_5.f_15);
