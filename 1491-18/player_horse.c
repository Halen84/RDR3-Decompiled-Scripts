	...
	*uParam1 = 0;
	...
	if (func_71(iParam0))
	{
		...
		*uParam1 = func_88(iParam0);
		...
		uParam1->f_5 = { ENTITY::GET_ENTITY_COORDS(*uParam1, true, false) /*3*/ };
...
void func_23(Vector3 vParam0, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11)
{
	if (vParam0.z)
	{
		if (func_76(64))
		{
			PED::SET_PED_RESET_FLAG(vParam0.x, 6 /*PRF_InfiniteStamina*/, true);
		}
	}
}
...
void func_41(int iParam0)
{
	...
	if (TASK::DOES_SCENARIO_POINT_EXIST(iVar6))
	{
		...
		PED::SET_PED_CONFIG_FLAG(iVar0, 355 /*PCF_0xEEBAF435*/, true);
...
void func_57(struct<4> /*32*/ sParam0, var uParam4, var uParam5, var uParam6, struct<5> /*40*/ sParam7, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19)
{
	...
	{
		func_243(0, joaat("HONOR_EVENT_ANIMAL_BLEEDOUT") /* GXTEntry: "Watched Animal Bleedout" */, 0, 0, 0, 0, 1065353216 /* Float: 1f */, 0);
		func_244(iParam19);
		func_241(iParam19, iVar1);
	}
}
	...
	while (iVar198 < 3)
	{
		...
		else
		{
			...
			if (STREAMING::IS_MODEL_A_PED(sVar1.f_0))
			{
				...
				sVar1.f_92 = 0;
				if (PED::_IS_META_PED_USING_COMPONENT(iVar195, 43391475) || ENTITY::_IS_ENTITY_FULLY_LOOTED(iVar194))
				{
					sVar1.f_92 = 1;
				}
				...
				else
				{
					...
					bVar204 = Global_40.f_1095.f_1[iParam0 /*436*/].f_15[iVar196 /*94*/].f_1;
					if (func_284(sVar1.f_1, 0) && func_284(bVar204, 0))
					{
						if (sVar1.f_1 != bVar204)
						{
							if (func_285(bVar0, bVar204, 1, 1, joaat("REMOVE_REASON_DEFAULT")))
							{
...
void func_86(int iParam0)
{
	...
	if (bVar71)
	{
		PED::SET_PED_CONFIG_FLAG(iVar1, 186 /*PCF_CorpseIsPersistent*/, false);
	}
	else
	{
		PED::SET_PED_CONFIG_FLAG(iVar1, 186 /*PCF_CorpseIsPersistent*/, true);
	}
...
void func_119(bool bParam0)
{
	...
	if (PED::GET_PED_CONFIG_FLAG(bParam0, 6 /*PCF_DontInfluenceWantedLevel*/, true))
	{
		bVar1 = false;
	}
	if (bVar1)
...
void func_127()
{
	...
	if (bVar2)
	{
		if (func_430())
		{
			if (func_431(bVar1, joaat("CI_TAG_ITEM_CONSUMABLE")))
			{
				func_432(bVar1, 1, 0, joaat("REMOVE_REASON_USED"), 0);
			}
			func_433(iVar0, bVar1);
		}
		else
		{
			func_416(7);
...
void func_144(int iParam0)
{
	...
	if (bVar5)
	{
		if (func_457(iVar4, joaat("HONOR_EVENT_TRAMPLED_INNOCENT") /* GXTEntry: "Trampled Innocent" */))
		{
			func_243(0, joaat("HONOR_EVENT_TRAMPLED_INNOCENT") /* GXTEntry: "Trampled Innocent" */, 0, 0, iVar4, 0, 1065353216 /* Float: 1f */, 0);
		}
	}
	else if (func_456(iVar4))
	{
	}
	else if (!func_458(iVar4, joaat("HONOR_EVENT_TRAMPLED_INNOCENT") /* GXTEntry: "Trampled Innocent" */))
	{
		func_243(0, joaat("HONOR_EVENT_TRAMPLED_INNOCENT") /* GXTEntry: "Trampled Innocent" */, 0, 0, iVar4, 0, 1065353216 /* Float: 1f */, 0);
	}
...
void func_153(int iParam0)
{
	...
	if (sVar0.f_4 & func_465(sVar0.f_2))
	{
		...
		PED::SET_PED_CONFIG_FLAG(bVar7, 186 /*PCF_CorpseIsPersistent*/, true);
	...
	if (sVar0.f_4 & func_474(sVar0.f_2))
	{
		...
		PED::SET_PED_CONFIG_FLAG(bVar7, 186 /*PCF_CorpseIsPersistent*/, false);
...
void func_154(int iParam0)
{
	...
	bVar5 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(sVar0.f_1);
	iVar6 = sVar0.f_2;
	bVar7 = sVar0.f_3;
	if (iVar4 != Global_35)
	{
...
void func_162(int iParam0)
{
	...
	if (func_388(bVar8))
	{
		...
		bVar11 = false;
		bVar11 = func_510(iVar6);
		if (func_284(bVar11, 0))
		{
			if (func_511(bVar11))
			{
				if (ENTITY::_0xF59FDE7B4D31A630(iVar6))
				{
					func_512(iVar10, bVar11, 1);
				}
			}
		}
	}
	...
	{
		bVar12 = func_510(iVar6);
		if (func_284(bVar12, 0))
		{
			if ((func_511(bVar12) && func_513(bVar12) != 0) && func_514(func_513(bVar12), &iVar13))
			{
...
void func_188(int iParam0, int iParam1)
{
	...
	if (bVar2)
	{
		if (bVar3)
		{
			...
			DECORATOR::DECOR_SET_STRING(iVar1, "loot_long_custom_anim_data_set", "DEAD_HORSE_SADDLE_SWAP_LONG_LOOT_ANIM_DATA");
		}
	}
	if (iParam1 == 2)
	{
...
void func_202(int iParam0, bool bParam1)
{
	...
	PED::_CLEAR_ACTIVE_ANIMAL_OWNER(bVar1, true);
	if (bVar2)
	{
		if (bParam1)
		{
...
bool func_233()
{
	...
	if (PED::GET_PED_CONFIG_FLAG(Global_35, 440 /*PCF_0xDBD31C9C*/, true))
	{
		return false;
	}
	return true;
...
bool func_235()
{
	...
	if (PED::GET_PED_CONFIG_FLAG(Global_35, 439 /*PCF_0x8519377E*/, true))
	{
		return false;
	}
	return true;
...
bool func_237()
{
	...
	if (PED::GET_PED_CONFIG_FLAG(Global_35, 438 /*PCF_0x14013CF9*/, true))
	{
		return false;
	}
	return true;
...
void func_254(struct<4> /*32*/ sParam0, var uParam4, var uParam5, var uParam6, Vector3 vParam7, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, Vector3 vParam19, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30)
{
	...
	{
		iVar12 = 0;
		MISC::COPY_SCRIPT_STRUCT(&sVar0, &vParam7, 12);
	}
	else if (vParam19.z)
	{
		iVar12 = 1;
		MISC::COPY_SCRIPT_STRUCT(&sVar0, &vParam19, 12);
	}
	if (!func_71(iVar12))
	{
		return;
	...
	if (TASK::_0x3F8387DB1B9F31B7(sVar0.f_0, 0) && !func_505())
	{
		if (!func_205(57) && !func_205(58))
		{
			...
			if (func_280())
			{
				if (func_560(joaat("CONSUMABLE_SPECIAL_HORSE_REVIVER_CRAFTED") /* GXTEntry: "Special Horse Reviver" */))
				{
					func_283(57, 0);
				}
				else
...
void func_256(struct<6> /*48*/ sParam0, var uParam6, struct<11> /*88*/ sParam7, var uParam18, struct<11> /*88*/ sParam19, var uParam30)
{
	...
	{
		iVar12 = 0;
		MISC::COPY_SCRIPT_STRUCT(&sVar0, &sParam7, 12);
	}
	else if (sParam19.f_10)
	{
		iVar12 = 1;
		MISC::COPY_SCRIPT_STRUCT(&sVar0, &sParam19, 12);
	}
	else
	{
		return;
...
void func_259(struct<5> /*40*/ sParam0, var uParam5, var uParam6)
{
	...
	MAP::SET_BLIP_SPRITE(iVar4, joaat("BLIP_SHOP_HORSE") /* GXTEntry: "Stable" */, true);
...
int func_271()
{
	...
	iVar2 = 0;
	bVar3 = WEAPON::_0xAFFD0CCF31F469B8(bVar0);
	if (func_284(bVar3, 0))
	{
		iVar2 = 1;
	}
...
{
	MISC::COPY_SCRIPT_STRUCT(iParam1, uParam0, 94);
}
...
void func_278(bool bParam0, int iParam1)
{
	...
	{
		if (func_431(bParam0, joaat("CI_TAG_ITEM_COLLECTIBLE")))
		{
			func_617(bParam0, iParam1);
		}
		if (func_431(bParam0, joaat("CI_TAG_ITEM_TAXIDERMY")) && func_431(bParam0, joaat("CI_TAG_ITEM_MATERIAL")))
		{
			func_618(bParam0, iParam1, 1, 0);
		}
	}
}
...
bool func_282(bool bParam0, int iParam1)
{
	if (iParam1 == 101)
	{
		return func_620(bParam0);
	}
	if (func_621(bParam0, iParam1))
	{
		return false;
	}
	return func_622(bParam0, iParam1);
}
...
int func_285(bool bParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	if (func_388(bParam0))
	{
		...
		if (func_284(bParam1, 0))
		{
			if (func_511(bParam1))
			{
				func_625(iVar1, bParam1, iParam2);
			}
		}
	}
	return func_626(iVar0, bParam1, iParam2, bParam3, iParam4);
}
...
int func_286(bool bParam0, int iParam1)
{
	...
	{
		bVar1 = func_515(iParam1);
		if (!func_284(bVar1, 0))
		{
			bVar1 = func_510(iParam1);
		}
	}
	else
	{
...
char* func_312(int iParam0)
{
	...
	{
		case joaat("A_C_HORSE_BUELL_WARVETS"):
			return "HORSE_NAME_BUELL_WARVETS" /* GXTEntry: "Buell" */;
		case joaat("A_C_HORSE_JOHN_ENDLESSSUMMER"):
			return "HORSE_NAME_JOHN_ENDLESSSUMMER" /* GXTEntry: "Rachel" */;
	}
	return "";
}
...
void func_324(int iParam0)
{
	...
	if (iParam0 == func_201())
	{
		sVar9 = { func_355() /*6*/ };
		bVar15 = sVar9.f_1;
		if (func_284(bVar15, 0))
		{
			sVar16.f_1 = 20;
			ITEMDATABASE::_ITEMDATABASE_FILLOUT_ITEM_EFFECT_IDS(bVar15, &sVar16);
			iVar45 = 0;
		...
		{
			sVar46.f_1 = 20;
			ITEMDATABASE::_ITEMDATABASE_FILLOUT_ITEM_EFFECT_IDS(bVar15, &sVar46);
			iVar75 = 0;
...
struct<4> /*32*/ func_331(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_666(bParam6), &uParam1, bParam0, iParam5, &sVar0);
	return sVar0;
}

int func_332(bool bParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	sVar0 = { func_331(bParam0, sParam1, iParam5, bParam6) /*4*/ };
...
bool func_334(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	if (!func_284(bParam0, 0))
	{
	}
	...
	if (func_667(bParam0, uParam2, iParam3, bParam5, 0))
	{
		return false;
	}
	if (!func_668(0))
	...
	if (!INVENTORY::_INVENTORY_ADD_ITEM_WITH_GUID(func_666(0), uParam1, uParam2, bParam0, uParam2->f_4, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
void func_343(bool bParam0)
{
	...
	PED::_CLEAR_ACTIVE_ANIMAL_OWNER(bParam0, false);
	PED::SET_PED_OWNS_ANIMAL(Global_35, bParam0, false);
	PED::_SET_PED_PERSONALITY(bParam0, joaat("PLAYER_HORSE"));
	...
	if (func_388(bParam0))
	{
		...
		if (func_675(iVar3))
		{
			PED::SET_PED_CONFIG_FLAG(bParam0, 324 /*PCF_0x8D1AEDEF*/, true);
		}
	}
	PED::SET_PED_CONFIG_FLAG(bParam0, 211 /*PCF_GiveAmbientDefaultTaskIfMissionPed*/, true);
	PED::SET_PED_CONFIG_FLAG(bParam0, 208 /*PCF_0x010FB89C*/, true);
	PED::SET_PED_CONFIG_FLAG(bParam0, 209 /*PCF_0xC44343FA*/, true);
	PED::SET_PED_CONFIG_FLAG(bParam0, 400 /*PCF_0x3EECBCF6*/, true);
	PED::SET_PED_CONFIG_FLAG(bParam0, 297 /*PCF_ForceInteractionLockonOnTargetPed*/, true);
	PED::SET_PED_CONFIG_FLAG(bParam0, 136 /*PCF_CannotBeMounted*/, false);
	PED::SET_PED_CONFIG_FLAG(bParam0, 312 /*PCF_DisableHorseGunshotFleeResponse*/, false);
	PED::SET_PED_CONFIG_FLAG(bParam0, 113 /*PCF_DisableShockingEvents*/, false);
	PED::SET_PED_CONFIG_FLAG(bParam0, 301 /*PCF_DisableInteractionLockonOnTargetPed*/, false);
	PED::SET_PED_CONFIG_FLAG(bParam0, 277 /*PCF_0x5FE313B3*/, true);
	PED::SET_PED_CONFIG_FLAG(bParam0, 319 /*PCF_EnableAsVehicleTransitionDestination*/, true);
	PED::SET_PED_CONFIG_FLAG(bParam0, 6 /*PCF_DontInfluenceWantedLevel*/, true);
...
void func_346(int iParam0, var uParam1)
{
	...
	while (iVar2 < 57)
	{
		...
		else
		{
			...
			{
				iVar6 = func_627(iVar1, bVar4, iVar5);
			}
		}
		iVar2++;
	}
...
void func_347(int iParam0)
{
	...
	while (iVar1 < 3)
	{
		bVar2 = Global_40.f_1095.f_1[iParam0 /*436*/].f_356[iVar1 /*5*/];
		if (func_284(bVar2, 0))
		{
			bVar3 = bVar2;
						...
						else
						{
							...
							if (sVar10.f_8 != 0)
							{
								...
								if (sVar10.f_92)
								{
									...
									if (PED::_DOES_META_PED_SUBOUTFIT_EXIST_FOR_PED_MODEL(sVar10.f_8, iVar116, sVar10.f_0))
									{
							...
							if (sVar10.f_2 == 2)
							{
								...
								PED::SET_PED_CONFIG_FLAG(iVar2, 517 /*PCF_0x159D6478*/, true);
								PERSISTENCE::_0xF5622FA6ACFCA7DB(iVar2, 0);
							}
							if (sVar10.f_92)
							{
								PED::SET_LOOTING_FLAG(iVar2, 0, false);
								ENTITY::_SET_ENTITY_FULLY_LOOTED(iVar2, true);
							}
							iVar9 = func_698(iVar114);
							...
							bVar117 = func_515(iVar2);
							if (func_284(bVar117, 0))
							{
								if (bVar117 != sVar10.f_1)
								{
									Global_40.f_1095.f_1[iParam0 /*436*/].f_15[iVar112 /*94*/].f_1 = bVar117;
									sVar10.f_1 = bVar117;
								}
							}
...
void func_377()
{
	...
	switch (iVar0)
	{
		case 1:
			...
			{
				func_381("WHISTLE_NEAR_UNBONDED" /* GXTEntry: "A horse will only respond to your commands once you\'ve achieved Bonding Level 1 w" +
    "ith it." */, 10000, 0, 0, 0, 1);
			}
			else
			{
				func_381("WHISTLE_HORSE_DEAD" /* GXTEntry: "Your horse has died. You can get a new horse by stealing one, breaking one from t" +
    "he wild, or visiting the stables." */, 10000, 0, 0, 0, 1);
			}
			break;
		case 2:
			func_381("WHISTLE_HORSE_STOLEN" /* GXTEntry: "Your horse has been stolen. Steal, purchase, unstable, or find a horse in the wil" +
    "d." */, 10000, 0, 0, 0, 1);
			break;
	}
}
...
void func_383(int iParam0)
{
	...
	switch (func_384(iParam0))
	{
			...
			if (!sVar0.f_11)
			{
				...
				if (bVar40)
				{
					...
					else
					{
						if (iParam0 == 0)
						{
							MISC::COPY_SCRIPT_STRUCT(&sVar44, &sVar27, 12);
						}
						else if (iParam0 == 1)
						{
							MISC::COPY_SCRIPT_STRUCT(&sVar44, &sVar15, 12);
						}
						if (sVar44.f_1)
						{
							if (!sVar44.f_11)
		...
		case 3:
			...
			if (!func_707(&(Global_1900383[iParam0 /*45*/].f_4), Global_36, vVar62, sVar0.f_0, 1065353216 /* Float: 1f */))
			{
				if (Global_1900383[iParam0 /*45*/].f_4.f_1)
				{
					if (!func_375())
					{
						func_381("WHISTLE_NOSPAWN_AREA" /* GXTEntry: "Your horse could not find you. Try moving to a more open area and whistling again" +
    "." */, 10000, 0, 0, 0, 1);
					}
					func_315(iParam0);
...
void func_413(bool bParam0)
{
	...
	if (!func_76((1 << 11)))
	{
		if (bVar1)
		{
			if (!func_458(bParam0, joaat("HONOR_EVENT_STEAL_DONKEY") /* GXTEntry: "Stole Donkey" */))
			{
				iVar3 = joaat("HONOR_EVENT_STEAL_DONKEY"); /* GXTEntry: "Stole Donkey" */
			}
		}
		else if (bVar2)
		{
			if (!func_458(bParam0, joaat("HONOR_EVENT_STEAL_MULE") /* GXTEntry: "Stole Mule" */))
			{
				iVar3 = joaat("HONOR_EVENT_STEAL_MULE"); /* GXTEntry: "Stole Mule" */
			}
		}
		else if (!func_458(bParam0, joaat("HONOR_EVENT_STEAL_HORSE") /* GXTEntry: "Stole Horse" */))
		{
			iVar3 = joaat("HONOR_EVENT_STEAL_HORSE"); /* GXTEntry: "Stole Horse" */
		}
		if (iVar3 != 0)
		{
...
int func_432(bool bParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (bVar3 != 0)
	{
		...
		if (!bParam2)
		{
			func_732(bParam0, -iParam1, bVar0, bVar1, bVar2);
		}
		return 0;
	}
	if (!func_733(bParam0, 1, bParam4))
	{
		return 0;
	}
	sVar5 = { func_734(bParam0) /*2*/ };
	if (STATS::STAT_ID_IS_VALID(&sVar5))
	{
		if ((func_735(bParam0, 0, 0) - iParam1) >= 0)
		{
			STATS::_STAT_ID_DECREMENT_INT(&sVar5, iParam1);
		}
		else if ((func_735(bParam0, 0, 0) - iParam1) < 0)
		{
			func_432(bParam0, func_735(bParam0, 0, 0), bParam2, iParam3, bParam4);
			return 0;
		}
	}
	if (func_736(bParam0) == joaat("WEAPON"))
	{
		if (!func_737(bParam0, iParam1, 0, iParam3))
		{
			return 0;
		}
	}
	else if (!func_738(bParam0, iParam1, iParam3, bParam2, bParam4))
	{
		return 0;
	}
...
void func_433(int iParam0, bool bParam1)
{
	...
	if (func_726(bParam1))
	{
		func_741(iParam0, bParam1);
		return;
	}
	if (func_727(bParam1))
	{
		func_504(iParam0, bParam1);
		return;
	}
	if (func_728(bParam1))
	{
	...
	if (func_730(bParam1))
	{
		func_743(iParam0, bParam1);
		return;
	}
	if (func_729(bParam1))
	{
		iVar0 = func_744();
		func_745(iParam0, bParam1, iVar0);
		return;
	}
}
...
void func_453(int iParam0, float fParam1)
{
	...
	{
		case 0:
			sVar0 = "HORSE_XP_TRUST_EARNED" /* GXTEntry: "Trust Earned +~1~" */;
			break;
		case 1:
		case 2:
		case 3:
			return;
		case 4:
			sVar0 = "HORSE_XP_LEADING" /* GXTEntry: "Led Horse +~1~" */;
			break;
		case 11:
		case 12:
			sVar0 = "HORSE_XP_HITCH" /* GXTEntry: "Hitched Horse +~1~" */;
			break;
		case 5:
			return;
		case 6:
			sVar0 = "HORSE_XP_BREAK_HORSE" /* GXTEntry: "Broke Horse +~1~" */;
			break;
		case 13:
		case 14:
		case 15:
			sVar0 = "HORSE_XP_FED" /* GXTEntry: "Fed Horse +~1~" */;
			break;
		case 16:
			sVar0 = "HORSE_XP_TREAT" /* GXTEntry: "Horse Treat +~1~" */;
			break;
		case 17:
		case 18:
		case 19:
			sVar0 = "HORSE_XP_GROOM" /* GXTEntry: "Groomed Horse +~1~" */;
			break;
		case 20:
			sVar0 = "HORSE_XP_OINTMENT" /* GXTEntry: "Ointment +~1~" */;
			break;
		case 7:
		case 8:
			sVar0 = "HORSE_XP_PATTED" /* GXTEntry: "Patted Horse +~1~" */;
			break;
		case 9:
		case 10:
			sVar0 = "HORSE_XP_CALM" /* GXTEntry: "Calmed Horse +~1~" */;
			break;
		case 21:
		case 22:
			sVar0 = "HORSE_XP_LIGHT_LOAD" /* GXTEntry: "Lightened Load +~1~" */;
			break;
		default:
			return;
	}
	...
	{
		sVar0 = MISC::VAR_STRING(2, "HORSE_XP_GENERIC_EARNED" /* GXTEntry: "+~1~" */);
	}
...
void func_463()
{
	...
	{
		iVar20 = iVar6;
		sVar13.f_0 = PED::_REQUEST_META_PED_COMPONENT(iVar12, iVar20, iVar19, 0, 0);
	}
	if (func_762(iVar7))
	{
		iVar21 = iVar7;
		sVar13.f_1 = PED::_REQUEST_META_PED_COMPONENT(iVar12, iVar21, iVar19, 0, 0);
	}
	if (func_762(iVar8))
	{
		iVar22 = iVar8;
		sVar13.f_2 = PED::_REQUEST_META_PED_COMPONENT(iVar12, iVar22, iVar19, 0, 0);
	}
	if (func_762(iVar9))
	{
		iVar23 = iVar9;
		sVar13.f_3 = PED::_REQUEST_META_PED_COMPONENT(iVar12, iVar23, iVar19, 0, 0);
	}
	if (func_762(iVar10))
	{
		iVar24 = iVar10;
		sVar13.f_4 = PED::_REQUEST_META_PED_COMPONENT(iVar12, iVar24, iVar19, 0, 0);
	}
	if (func_762(iVar11))
	{
		iVar25 = iVar11;
		sVar13.f_5 = PED::_REQUEST_META_PED_COMPONENT(iVar12, iVar25, iVar19, 0, 0);
	}
	func_763(sVar13);
}
...
void func_476(bool bParam0)
{
	...
	if (PED::_IS_META_PED_USING_COMPONENT(bParam0, joaat("HORSE_HARNESSES")))
	{
		PED::REMOVE_TAG_FROM_META_PED(bParam0, joaat("HORSE_HARNESSES"), 1);
	}
	if (PED::_IS_META_PED_USING_COMPONENT(bParam0, joaat("ACCESSORIES")))
	{
		PED::REMOVE_TAG_FROM_META_PED(bParam0, joaat("ACCESSORIES"), 1);
	}
	if (PED::_IS_META_PED_USING_COMPONENT(bParam0, joaat("HORSE_ACCESSORIES")))
	{
		PED::REMOVE_TAG_FROM_META_PED(bParam0, joaat("HORSE_ACCESSORIES"), 1);
	}
	if (PED::_IS_META_PED_USING_COMPONENT(bParam0, joaat("HORSE_LOADOUT")))
	{
		PED::REMOVE_TAG_FROM_META_PED(bParam0, joaat("HORSE_LOADOUT"), 1);
	}
}
...
void func_479()
{
	...
	sVar0 = { func_778() /*6*/ };
	PED::_RELEASE_META_PED_ASSET_REQUEST(sVar0.f_0);
	PED::_RELEASE_META_PED_ASSET_REQUEST(sVar0.f_1);
	PED::_RELEASE_META_PED_ASSET_REQUEST(sVar0.f_2);
	PED::_RELEASE_META_PED_ASSET_REQUEST(sVar0.f_3);
	PED::_RELEASE_META_PED_ASSET_REQUEST(sVar0.f_4);
	PED::_RELEASE_META_PED_ASSET_REQUEST(sVar0.f_5);
	func_779();
}
...
void func_498(int iParam0)
{
	...
	func_788(joaat("KIT_HORSE_BRUSH") /* GXTEntry: "Horse Brush" */, bVar11);
}
...
int func_504(bool bParam0, bool bParam1)
{
	...
	switch (bParam1)
	{
		case joaat("CONSUMABLE_HORSE_REVIVER") /* GXTEntry: "Horse Reviver" */:
			break;
	}
	func_790(bParam0, bParam1);
...
bool func_505()
{
	if (func_733(joaat("CONSUMABLE_HORSE_REVIVER") /* GXTEntry: "Horse Reviver" */, 1, 0) || func_733(joaat("CONSUMABLE_SPECIAL_HORSE_REVIVER_CRAFTED") /* GXTEntry: "Special Horse Reviver" */, 1, 0))
	{
		return true;
	}
	return false;
...
void func_512(int iParam0, bool bParam1, int iParam2)
{
	...
	bVar0 = func_793(bParam1);
	iVar1 = func_794(bVar0, 1);
...
int func_513(bool bParam0)
{
	switch (bParam0)
	{
		case joaat("PROVISION_BEAR_LEGENDARY_FUR_PRISTINE") /* GXTEntry: "Legendary Bear Pelt" */:
		...
		case joaat("PROVISION_WHITE_BUFFALO_LEGENDARY_FUR_PRISTINE") /* GXTEntry: "Legendary White Bison Pelt" */:
		...
		case joaat("PROVISION_TAKANTA_BUFFALO_LEGENDARY_FUR_PRISTINE") /* GXTEntry: "Legendary Tatanka Bison Pelt" */:
			return joaat("A_C_BUFFALO_TATANKA_01");
		case joaat("PROVISION_ALLIGATOR_LEGENDARY_SKIN_PRISTINE") /* GXTEntry: "Legendary Alligator Skin" */:
		...
		case joaat("PROVISION_ELK_LEGENDARY_FUR_PRISTINE") /* GXTEntry: "Legendary Elk Pelt" */:
		...
		case joaat("PROVISION_MOOSE_LEGENDARY_FUR_PRISTINE") /* GXTEntry: "Legendary Moose Pelt" */:
...
int func_517(int iParam0, int iParam1)
{
	...
	if (ENTITY::GET_IS_ANIMAL(iParam1) || ENTITY::_GET_IS_BIRD(iParam1))
	{
		bVar0 = func_515(iParam1);
		if (!func_284(bVar0, 0))
		{
			bVar0 = func_510(iParam1);
		}
	}
	else
	{
	...
	iVar1 = func_285(iParam0, bVar0, 1, 1, joaat("REMOVE_REASON_DEFAULT"));
	return iVar1;
}
...
void func_537(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_812("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_MANUAL_PAINT" /* GXTEntry: "Manual Painting" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_812("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_STAY_ACTIVE" /* GXTEntry: "Continued Free Fire" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_812("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_FATAL" /* GXTEntry: "Fatal Region Highlights" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_812("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_CRITICAL" /* GXTEntry: "Critical Region Highlights" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 24:
			...
			if (func_2() == -1)
			{
				if (!func_813(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) || func_814(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					...
					if (!func_733(bVar0, 1, 0))
					{
						func_815(bVar0, 1, joaat("ADD_REASON_DEFAULT"));
					}
					func_816(Global_35, bVar0, 0, joaat("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
				}
			}
			break;
		case 48:
...
int func_543(int iParam0, bool bParam1)
{
	...
	sVar1 = { func_330(0) /*4*/ };
	sVar1.f_4 = iVar0;
	if (!func_334(bParam1, &uVar6, &sVar1, 1, joaat("ADD_REASON_DEFAULT"), 0))
	{
		return 0;
	}
	return 1;
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_754(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS" /* GXTEntry: "+" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_754(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT" /* GXTEntry: "+" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_754(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG" /* GXTEntry: "~COLOR_RED~-~s~" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_754(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT" /* GXTEntry: "~COLOR_RED~-~s~" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
bool func_560(bool bParam0)
{
	...
	while (iVar48 < iVar0)
	{
		...
		{
			if (sVar1.f_2 == joaat("COST_TYPE_CRAFT") && !func_835(bParam0, sVar1.f_0, 1))
			{
				return true;
			}
		}
...
bool func_566(int iParam0)
{
	...
	iVar1 = PLAYER::GET_DISCOVERABLE_NAME_HASH_AND_TYPE_FOR_ENTITY(iParam0, &iVar0);
	if (PLAYER::_GET_HAS_PLAYER_DISCOVERED_CHARACTER_NAME_SP(PLAYER::PLAYER_ID(), iVar0, iVar1))
	{
		return true;
	}
	return false;
...
bool func_607(int iParam0)
{
	...
	if (func_398(iParam0, &iVar0, -1082130432 /* Float: -1f */))
	{
...
bool func_614()
{
	if (func_733(joaat("PROVISION_TRINKET_PRONGHORN_ANTLER") /* GXTEntry: "Pronghorn Horn Trinket" */, 1, 0))
	{
		return true;
	}
	return false;
...
bool func_616()
{
	if (func_733(joaat("PROVISION_TRINKET_BEAVER_TOOTH") /* GXTEntry: "Beaver Tooth Trinket" */, 1, 0))
	{
		return true;
	}
	return false;
...
void func_617(bool bParam0, int iParam1)
{
	...
	if (func_2() == -1)
	{
		if (func_850(43))
		{
			if (func_431(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_01")))
			{
				func_851(joaat("EXOTIC_STAGE_01"));
				if (func_852() == 0)
				{
					func_853(0, 10);
					iVar0 = func_854(bParam0, iParam1, 1);
					...
					{
						if (func_855(bParam0) < func_856(bParam0))
						{
							func_857(43, bParam0, iParam1, joaat("EXOTIC_STAGE_01"), iVar0, 1, -1, 0);
						}
					}
				}
			}
		...
		if (func_850(44))
		{
			if (func_431(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_02")))
			{
				func_851(joaat("EXOTIC_STAGE_02"));
				if (func_852() == 1)
				{
					func_853(0, 10);
					iVar0 = func_854(bParam0, iParam1, 2);
					if ((bParam0 == joaat("PROVISION_HERON_FEATHER") || bParam0 == joaat("PROVISION_RO_FLOWER_LADY_SLIPPER")) || bParam0 == joaat("PROVISION_RO_FLOWER_MOCCASIN"))
					{
						if (func_855(bParam0) < func_856(bParam0))
						{
							func_857(43, bParam0, iParam1, joaat("EXOTIC_STAGE_02"), iVar0, 1, -1, 0);
						}
					}
				}
			}
		...
		if (!func_850(45))
		{
			if (func_431(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_03")))
			{
				func_851(joaat("EXOTIC_STAGE_03"));
				if (func_852() == 2)
				{
					func_853(0, 10);
					iVar0 = func_854(bParam0, iParam1, 4);
					if (((bParam0 == joaat("PROVISION_GATOR_EGG") || bParam0 == joaat("PROVISION_RO_FLOWER_ACUNAS_STAR")) || bParam0 == joaat("PROVISION_RO_FLOWER_CIGAR")) || bParam0 == joaat("PROVISION_RO_FLOWER_GHOST"))
					{
						if (func_855(bParam0) < func_856(bParam0))
						{
							func_857(43, bParam0, iParam1, joaat("EXOTIC_STAGE_03"), iVar0, 1, -1, 0);
						}
					}
				}
			}
		...
		if (!func_850(46))
		{
			if (func_431(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_04")))
			{
				func_851(joaat("EXOTIC_STAGE_04"));
				if (func_852() == 3)
				{
					func_853(0, 10);
					iVar0 = func_854(bParam0, iParam1, 8);
					if (((bParam0 == joaat("PROVISION_SPOONBILL_FEATHER") || bParam0 == joaat("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || bParam0 == joaat("PROVISION_RO_FLOWER_RAT_TAIL")) || bParam0 == joaat("PROVISION_RO_FLOWER_SPIDER"))
					{
						if (func_855(bParam0) < func_856(bParam0))
						{
							func_857(43, bParam0, iParam1, joaat("EXOTIC_STAGE_04"), iVar0, 1, -1, 0);
						}
					}
				}
			}
		...
		if (!func_850(47))
		{
			if (func_431(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_05")))
			{
				func_851(joaat("EXOTIC_STAGE_05"));
				if (func_852() == 4)
				{
					func_853(0, 10);
					iVar0 = func_854(bParam0, iParam1, 16);
					if (((bParam0 == joaat("PROVISION_RO_FLOWER_CLAMSHELL") || bParam0 == joaat("PROVISION_RO_FLOWER_DRAGONS")) || bParam0 == joaat("PROVISION_RO_FLOWER_SPARROWS")) || bParam0 == joaat("PROVISION_RO_FLOWER_QUEENS"))
					{
						if (func_855(bParam0) < func_856(bParam0))
						{
							func_857(43, bParam0, iParam1, joaat("EXOTIC_STAGE_05"), iVar0, 1, -1, 0);
						}
					}
				}
			}
...
void func_618(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	while (iVar1 < 5)
	{
		...
		if (func_733(func_858(iVar0, 10), 1, 0))
		{
			if (bParam2)
			{
				func_859(bParam0, iVar0, sVar2, iParam1, bParam2);
			}
			else
			{
				func_860(bParam0, iVar0, bParam3);
			}
		}
		iVar1++;
	}
...
bool func_621(bool bParam0, int iParam1)
{
	if (func_2() == -1)
	{
		if (iParam1 == 61)
		{
			if (func_431(bParam0, joaat("CI_TAG_ITEM_ALCOHOL")))
			{
				return true;
			}
		}
...
void func_625(int iParam0, bool bParam1, int iParam2)
{
	bool bVar0;
	int iVar1;
...
int func_626(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (!func_868(iParam0, bParam1, 1))
	{
		return 0;
	}
	sVar3 = { func_734(bParam1) /*2*/ };
	if (STATS::STAT_ID_IS_VALID(&sVar3))
	{
		if ((func_869(iParam0, bParam1) - iParam2) >= 0)
		{
			STATS::_STAT_ID_DECREMENT_INT(&sVar3, iParam2);
		}
		else if ((func_869(iParam0, bParam1) - iParam2) < 0)
		{
			func_626(iParam0, bParam1, func_735(bParam1, 0, 0), bParam3, iParam4);
			return 0;
		}
	}
	if (!func_870(iParam0, bParam1, iParam2, iParam4, bParam3))
	{
		return 0;
	}
	if (!func_668(0))
	...
	{
		func_732(bParam1, -iParam2, bVar0, bVar1, bVar2);
	}
	return 1;
}
...
int func_627(int iParam0, bool bParam1, int iParam2)
{
	...
	sVar5 = { func_872(iParam0, bParam1, sVar0, sVar0.f_4) /*4*/ };
	if (INVENTORY::_INVENTORY_ADD_ITEM_WITH_GUID(iParam0, &sVar5, &sVar0, bParam1, sVar0.f_4, iParam2, joaat("ADD_REASON_DEFAULT")))
	{
		if (func_431(bParam1, joaat("CI_TAG_ITEM_MEAT_FISH")) && func_873(bParam1, 4))
		{
			if (!func_850(42))
			{
				func_874(bParam1);
...
char* func_638(char* sParam0, int iParam1)
{
	...
	return func_887(MISC::VAR_STRING(10, "PLAYER_STRING" /* GXTEntry: "~fg~~1p~~fo~" */, sParam0), iParam1);
}
...
bool func_667(bool bParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	struct<4> /*32*/ sVar0;
	struct<10> /*80*/ sVar4;
	var uVar26;
	...
	if (func_904(bParam0) && WEAPON::IS_WEAPON_A_GUN(bParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
		{
			sVar0 = { func_905(0) /*4*/ };
			sVar4.f_9 = joaat("SLOTID_NONE");
			if (!func_906(bParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
			{
				return false;
			}
			else if (func_907(bParam0, &sVar4, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
			{
				return false;
			}
			if (func_908(bParam0, 1))
			{
				if (!func_906(bParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					return false;
				}
				else if (func_907(bParam0, &sVar4, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */))
				{
					return false;
				}
			}
		}
		else if (!func_909(bParam0, &uVar26, 0))
		{
			return false;
		}
		return true;
	}
	iVar27 = func_910(bParam0, uParam1, bParam3, bParam4);
	if (iVar27 < 0)
	{
		return false;
	}
	...
	if (bParam3 || !func_911(bParam0))
	{
		iVar28 = func_332(bParam0, *uParam1, uParam1->f_4, bParam4);
	}
	else
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_666(bParam4), bParam0, false);
	}
...
void func_717(bool bParam0, int iParam1, int iParam2)
{
	...
	bVar4 = func_542(iVar3);
	func_543(iParam1, bVar4);
}
...
bool func_724(bool bParam0)
{
	switch (bParam0)
	{
		...
		case joaat("CONSUMABLE_HERB_HUMMINGBIRD_SAGE") /* GXTEntry: "Hummingbird Sage" */:
		...
		case joaat("CONSUMABLE_CRAFTED_SUPER_MEAL") /* GXTEntry: "Horse Meal" */:
		case joaat("CONSUMABLE_BEETS") /* GXTEntry: "Beets" */:
		...
		case joaat("CONSUMABLE_PEPPERMINT") /* GXTEntry: "Peppermint" */:
		case joaat("CONSUMABLE_HERB_CHANTERELLES") /* GXTEntry: "Chanterelle" */:
		case joaat("CONSUMABLE_CORN") /* GXTEntry: "Corn" */:
		...
		case joaat("CONSUMABLE_HERB_BLACK_CURRANT") /* GXTEntry: "Blackcurrant" */:
		case joaat("CONSUMABLE_HERB_AMERICAN_GINSENG") /* GXTEntry: "American Ginseng" */:
		case joaat("CONSUMABLE_HERB_GOLDEN_CURRANT") /* GXTEntry: "Golden Currant" */:
		case joaat("CONSUMABLE_HERB_VIOLET_SNOWDROP") /* GXTEntry: "Violet Snowdrop" */:
		case joaat("CONSUMABLE_HERB_RED_SAGE") /* GXTEntry: "Red Sage" */:
		case joaat("CONSUMABLE_HERB_MILKWEED") /* GXTEntry: "Milkweed" */:
		case joaat("CONSUMABLE_HERB_PRAIRIE_POPPY") /* GXTEntry: "Prairie Poppy" */:
		case joaat("CONSUMABLE_PEACH") /* GXTEntry: "Peach" */:
		case joaat("CONSUMABLE_HERB_DESERT_SAGE") /* GXTEntry: "Desert Sage" */:
		case joaat("CONSUMABLE_CARROT") /* GXTEntry: "Carrot" */:
		...
		case joaat("CONSUMABLE_PEAR") /* GXTEntry: "Pear" */:
		...
		case joaat("CONSUMABLE_APPLE") /* GXTEntry: "Apple" */:
		case joaat("CONSUMABLE_HERB_ALASKAN_GINSENG") /* GXTEntry: "Alaskan Ginseng" */:
		case joaat("CONSUMABLE_CELERY") /* GXTEntry: "Celery" */:
...
bool func_725(bool bParam0)
{
	switch (bParam0)
	{
		...
		case joaat("CONSUMABLE_SPECIAL_HORSE_MEDICINE") /* GXTEntry: "Special Horse Medicine" */:
		case joaat("CONSUMABLE_HORSE_MEDICINE_USED") /* GXTEntry: "Opened Horse Medicine" */:
		case joaat("CONSUMABLE_POTENT_HORSE_MEDICINE") /* GXTEntry: "Potent Horse Medicine" */:
			return true;
	}
	return false;
}
...
bool func_726(bool bParam0)
{
	switch (bParam0)
	{
		case joaat("CONSUMABLE_HORSE_STIMULANT") /* GXTEntry: "Horse Stimulant" */:
		case joaat("CONSUMABLE_HORSE_STIMULANT_USED") /* GXTEntry: "Opened Horse Stimulant" */:
		case joaat("CONSUMABLE_POTENT_HORSE_STIMULANT") /* GXTEntry: "Potent Horse Stimulant" */:
		case joaat("CONSUMABLE_SPECIAL_HORSE_STIMULANT_CRAFTED") /* GXTEntry: "Special Horse Stimulant" */:
			return true;
	}
	return false;
}
...
bool func_727(bool bParam0)
{
	switch (bParam0)
	{
		case joaat("CONSUMABLE_SPECIAL_HORSE_REVIVER_CRAFTED") /* GXTEntry: "Special Horse Reviver" */:
		case joaat("CONSUMABLE_HORSE_REVIVER") /* GXTEntry: "Horse Reviver" */:
			return true;
	}
	return false;
...
bool func_728(bool bParam0)
{
	switch (bParam0)
	{
		case joaat("CONSUMABLE_HORSE_OINTMENT_CRAFTED") /* GXTEntry: "Horse Ointment" */:
			return true;
	}
	return false;
}
...
bool func_729(bool bParam0)
{
	switch (bParam0)
	{
		case joaat("KIT_HORSE_BRUSH") /* GXTEntry: "Horse Brush" */:
			return true;
	}
	return false;
}
...
bool func_730(bool bParam0)
{
	switch (bParam0)
	{
		case joaat("CONSUMABLE_HORSE_CARE_PACKAGE") /* GXTEntry: "Horse Care Package" */:
			return true;
	}
	return false;
}
...
bool func_731(bool bParam0, int iParam1)
{
	...
	if (func_431(bParam0, joaat("CI_TAG_ITEM_AMMOBOX")))
	{
		func_942(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return false;
}

void func_732(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	int iVar1;
	char cVar2[32];
	...
	if (!func_943())
	{
		func_944(bParam0, iParam1, bParam2, bParam4);
		return;
	}
	bVar0 = false;
	iVar1 = MISC::ABSI(iParam1);
	strcpy_s(&cVar2, 32, func_945(iVar1 == 1, "ITEM_GET_PUMP" /* GXTEntry: "~1~" */, "ITEM_GET_PUMP_MULT" /* GXTEntry: "~2~x ~1~" */));
	if (iParam1 > 0)
	{
	}
	else
	{
		...
		else if (bParam2 && func_873(bParam0, (1 << 21)))
		{
	...
	else if (!func_946(bParam0, &sVar7, iVar11, iVar10, 0, joaat("UI_ITEMVIEWER")))
	{
	...
	sVar15 = func_887(MISC::VAR_STRING(10, &cVar2, MISC::VAR_STRING(0, func_947(bParam0)), iVar1), iVar12);
	if (((((iParam1 == 1 || func_431(bParam0, joaat("CI_TAG_SMOKING_CIGARETTE"))) || bParam0 == joaat("CONSUMABLE_CIGARETTE_BOX")) || bParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_USED")) || bParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || bParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
		sVar15 = MISC::VAR_STRING(0, func_947(bParam0));
	}
	func_754(sVar15, sVar7.f_1, MISC::GET_HASH_KEY(sVar7.f_0), iVar14, iVar12, "Transaction_Feed_Sounds", sVar13, 0, 1);
}

bool func_733(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	...
	{
		if (!func_948(bParam0, 1))
		{
			return false;
		}
	}
	return func_735(bParam0, 0, bParam2) >= iParam1;
}

struct<2> /*16*/ func_734(bool bParam0)
{
	struct<2> /*16*/ sVar0;
	struct<2> /*16*/ sVar2;
	...
	if (func_431(bParam0, joaat("CI_TAG_ITEM_DEADEYE")))
	{
		if (func_2() == -1)
		{
			if (func_431(bParam0, joaat("CI_TAG_ITEM_MEDICINE")))
			{
	...
	else if (func_431(bParam0, joaat("CI_TAG_ITEM_MEDICINE")))
	{
		return func_832(joaat("MEDICINE_ITEMS"));
	}
	if (func_431(bParam0, joaat("CI_TAG_ITEM_LOCK_BREAKER")))
	{
...
int func_735(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		return func_949(bParam0, 0);
	}
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_666(bParam2), bParam0, false);
	return iVar2;
}
...
bool func_737(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	struct<18> /*144*/ sVar0;
	int iVar18;
	int iVar19;
	...
	sVar0 = { func_950(bParam0, joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0) /*18*/ };
	if (bParam2)
	{
	...
	while (iVar39 < iVar19)
	{
		...
		else
		{
			...
			else
			{
				...
				sVar34 = { sVar20.f_5 /*4*/ };
				if (func_819(bParam0, &sVar20, &sVar34, 1, iParam3, 0, 0))
				{
					iVar40++;
				}
			}
...
bool func_738(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	struct<5> /*40*/ sVar0;
	struct<4> /*32*/ sVar5;
	...
	sVar0 = { func_955(bParam0, bParam4, 1) /*5*/ };
	if (sVar0.f_4 == joaat("SLOTID_SATCHEL"))
	{
		return func_956(bParam0, iParam1, iParam2, bParam3, bParam4);
	}
	sVar5 = { func_331(bParam0, sVar0, sVar0.f_4, bParam4) /*4*/ };
	return func_819(bParam0, &sVar5, &sVar0, iParam1, iParam2, bParam3, bParam4);
}
...
{
	if (PED::_GET_SHOP_ITEM_COMPONENT_CATEGORY(iParam0, 3, false) == 0)
	{
		return false;
	}
	return true;
...
void func_766(int iParam0, var uParam1, bool bParam2)
{
	...
	while (iVar1 < 57)
	{
		...
		else
		{
			...
			{
				iVar5 = func_285(iVar0, bVar3, iVar4, bParam2, joaat("REMOVE_REASON_DEFAULT"));
			}
		}
		iVar1++;
	}
...
int func_788(bool bParam0, bool bParam1)
{
	...
	if (func_727(bParam0) && TASK::IS_PED_IN_WRITHE(iVar0))
	{
		if (func_994(iVar0, bParam0))
		{
			return 1;
		}
		return 0;
...
bool func_789()
{
	...
	iVar0[0] = joaat("CONSUMABLE_HAYCUBE"); /* GXTEntry: "Hay" */
	iVar0[1] = joaat("CONSUMABLE_OAT_CAKES"); /* GXTEntry: "Classic Oatcakes" */
	iVar0[2] = joaat("CONSUMABLE_APPLE"); /* GXTEntry: "Apple" */
	iVar0[3] = joaat("CONSUMABLE_BEETS"); /* GXTEntry: "Beets" */
	iVar0[4] = joaat("CONSUMABLE_PEAR"); /* GXTEntry: "Pear" */
	iVar0[5] = joaat("CONSUMABLE_PEACH"); /* GXTEntry: "Peach" */
	iVar0[6] = joaat("CONSUMABLE_CELERY"); /* GXTEntry: "Celery" */
	iVar0[7] = joaat("CONSUMABLE_CARROT"); /* GXTEntry: "Carrot" */
	iVar0[8] = joaat("CONSUMABLE_CORN"); /* GXTEntry: "Corn" */
	iVar0[9] = joaat("CONSUMABLE_PEPPERMINT"); /* GXTEntry: "Peppermint" */
	iVar0[10] = joaat("CONSUMABLE_SUGARCUBE"); /* GXTEntry: "Sugar Cube" */
	iVar12 = 0;
	while (iVar12 < iVar0)
	{
	...
	iVar13[0] = joaat("CONSUMABLE_HERB_ALASKAN_GINSENG"); /* GXTEntry: "Alaskan Ginseng" */
	iVar13[1] = joaat("CONSUMABLE_HERB_AMERICAN_GINSENG"); /* GXTEntry: "American Ginseng" */
	iVar13[2] = joaat("CONSUMABLE_HERB_BAY_BOLETE"); /* GXTEntry: "Bay Bolete" */
	iVar13[3] = joaat("CONSUMABLE_HERB_BLACK_BERRY"); /* GXTEntry: "Blackberry" */
	iVar13[4] = joaat("CONSUMABLE_HERB_BLACK_CURRANT"); /* GXTEntry: "Blackcurrant" */
	iVar13[5] = joaat("CONSUMABLE_HERB_BURDOCK_ROOT"); /* GXTEntry: "Burdock Root" */
	iVar13[6] = joaat("CONSUMABLE_HERB_CHANTERELLES"); /* GXTEntry: "Chanterelle" */
	iVar13[7] = joaat("CONSUMABLE_HERB_CREEPING_THYME"); /* GXTEntry: "Creeping Thyme" */
	iVar13[8] = joaat("CONSUMABLE_HERB_DESERT_SAGE"); /* GXTEntry: "Desert Sage" */
	iVar13[9] = joaat("CONSUMABLE_HERB_HUMMINGBIRD_SAGE"); /* GXTEntry: "Hummingbird Sage" */
	iVar13[10] = joaat("CONSUMABLE_HERB_GOLDEN_CURRANT"); /* GXTEntry: "Golden Currant" */
	iVar13[11] = joaat("CONSUMABLE_HERB_OLEANDER_SAGE"); /* GXTEntry: "Oleander Sage" */
	iVar13[12] = joaat("CONSUMABLE_HERB_PARASOL_MUSHROOM"); /* GXTEntry: "Parasol Mushroom" */
	iVar13[13] = joaat("CONSUMABLE_HERB_RAMS_HEAD"); /* GXTEntry: "Ram\'s Head" */
	iVar13[14] = joaat("CONSUMABLE_HERB_RED_RASPBERRY"); /* GXTEntry: "Raspberry" */
	iVar13[15] = joaat("CONSUMABLE_HERB_RED_SAGE"); /* GXTEntry: "Red Sage" */
	iVar13[16] = joaat("CONSUMABLE_HERB_WILD_FEVERFEW"); /* GXTEntry: "Wild Feverfew" */
	iVar13[17] = joaat("CONSUMABLE_HERB_WILD_MINT"); /* GXTEntry: "Wild Mint" */
	iVar13[18] = joaat("CONSUMABLE_HERB_GINSENG"); /* GXTEntry: "Ginseng" */
	iVar13[19] = joaat("CONSUMABLE_HERB_SAGE"); /* GXTEntry: "Sage" */
	iVar13[20] = joaat("CONSUMABLE_HERB_WINTERGREEN_BERRY"); /* GXTEntry: "Wintergreen Berry" */
	iVar13[21] = joaat("CONSUMABLE_HERB_CURRANT"); /* GXTEntry: "Currant" */
	iVar13[22] = joaat("CONSUMABLE_HERB_OREGANO"); /* GXTEntry: "Oregano" */
	iVar13[23] = joaat("CONSUMABLE_HERB_WILD_CARROTS"); /* GXTEntry: "Wild Carrot" */
	iVar13[24] = joaat("CONSUMABLE_HERB_COMMON_BULRUSH"); /* GXTEntry: "Common Bulrush" */
	iVar13[25] = joaat("CONSUMABLE_HERB_ENGLISH_MACE"); /* GXTEntry: "English Mace" */
	iVar12 = 0;
	iVar12 = 0;
	while (iVar12 < iVar13)
	{
		bVar40 = iVar13[iVar12];
		if (func_724(bVar40) && func_735(bVar40, 0, 0) > 0)
		{
			return bVar40;
		}
		iVar12++;
...
void func_790(bool bParam0, bool bParam1)
{
	...
	sVar2.f_1 = 20;
	ITEMDATABASE::_ITEMDATABASE_FILLOUT_ITEM_EFFECT_IDS(bParam1, &sVar2);
	iVar33 = 0;
...
int func_802(int iParam0)
{
	switch (iParam0)
	{
		case joaat("LEGENDARY_FISHING_SPOT_01"):
			return joaat("MAP_ANIMAL_FISH_CATFISH_BULLHEAD");
		case joaat("LEGENDARY_FISHING_SPOT_02"):
			return joaat("MAP_ANIMAL_FISH_PICKERAL_CHAIN");
		case joaat("LEGENDARY_FISHING_SPOT_03"):
			return joaat("MAP_ANIMAL_FISH_STURGEON_LAKE");
		case joaat("LEGENDARY_FISHING_SPOT_04"):
			return joaat("MAP_ANIMAL_FISH_BASS_LARGE_MOUTH");
		case joaat("LEGENDARY_FISHING_SPOT_05"):
			return joaat("MAP_ANIMAL_FISH_GAR_LONG_NOSE");
		case joaat("LEGENDARY_FISHING_SPOT_06"):
			return joaat("MAP_ANIMAL_FISH_MUSKIE");
		case joaat("LEGENDARY_FISHING_SPOT_07"):
			return joaat("MAP_ANIMAL_FISH_PERCH");
		case joaat("LEGENDARY_FISHING_SPOT_08"):
			return joaat("MAP_ANIMAL_FISH_PICKERAL_REDFIN");
		case joaat("LEGENDARY_FISHING_SPOT_09"):
			return joaat("MAP_ANIMAL_FISH_BASS_ROCK");
		case joaat("LEGENDARY_FISHING_SPOT_10"):
			return joaat("MAP_ANIMAL_FISH_BASS_SMALL_MOUTH");
		case joaat("LEGENDARY_FISHING_SPOT_11"):
			return joaat("MAP_ANIMAL_FISH_SALMON_SOCKEYE");
		case joaat("LEGENDARY_FISHING_SPOT_12"):
			return joaat("MAP_ANIMAL_FISH_TROUT_STEELHEAD");
		case joaat("LEGENDARY_FISHING_SPOT_13"):
			return joaat("MAP_ANIMAL_FISH_BLUEGILL");
		default:
			break;
	}
	return 0;
...
int func_803(int iParam0)
{
	...
	{
		case joaat("LEGENDARY_FISHING_SPOT_01"):
			return joaat("MAP_ANIMAL_FISH_CATFISH_BULLHEAD_CROSS");
		case joaat("LEGENDARY_FISHING_SPOT_02"):
			return joaat("MAP_ANIMAL_FISH_PICKERAL_CHAIN_CROSS");
		case joaat("LEGENDARY_FISHING_SPOT_03"):
			return joaat("MAP_ANIMAL_FISH_STURGEON_LAKE_CROSS");
		case joaat("LEGENDARY_FISHING_SPOT_04"):
			return joaat("MAP_ANIMAL_FISH_BASS_LARGE_MOUTH_CROSS");
		case joaat("LEGENDARY_FISHING_SPOT_05"):
			return joaat("MAP_ANIMAL_FISH_GAR_LONG_NOSE_CROSS");
		case joaat("LEGENDARY_FISHING_SPOT_06"):
			return joaat("MAP_ANIMAL_FISH_MUSKIE_CROSS");
		case joaat("LEGENDARY_FISHING_SPOT_07"):
			return joaat("MAP_ANIMAL_FISH_PERCH_CROSS");
		case joaat("LEGENDARY_FISHING_SPOT_08"):
			return joaat("MAP_ANIMAL_FISH_PICKERAL_REDFIN_CROSS");
		case joaat("LEGENDARY_FISHING_SPOT_09"):
			return joaat("MAP_ANIMAL_FISH_BASS_ROCK_CROSS");
		case joaat("LEGENDARY_FISHING_SPOT_10"):
			return joaat("MAP_ANIMAL_FISH_BASS_SMALL_MOUTH_CROSS");
		case joaat("LEGENDARY_FISHING_SPOT_11"):
			return joaat("MAP_ANIMAL_FISH_SALMON_SOCKEYE_CROSS");
		case joaat("LEGENDARY_FISHING_SPOT_12"):
			return joaat("MAP_ANIMAL_FISH_TROUT_STEELHEAD_CROSS");
		case joaat("LEGENDARY_FISHING_SPOT_13"):
			return joaat("MAP_ANIMAL_FISH_BLUEGILL_CROSS");
		default:
			break;
	}
	return 0;
...
bool func_805(int iParam0, bool bParam1)
{
	...
	sVar29 = { func_331(bParam1, sVar0, joaat("SLOTID_HORSE_MANE"), 0) /*4*/ };
...
bool func_806(int iParam0, bool bParam1)
{
	...
	sVar29 = { func_331(bParam1, sVar0, joaat("SLOTID_HORSE_TAIL"), 0) /*4*/ };
	return func_335(sVar29, 1);
}
...
bool func_815(bool bParam0, int iParam1, int iParam2)
{
	...
	sVar0 = { func_955(bParam0, 0, 1) /*5*/ };
	sVar5 = { func_331(bParam0, sVar0, sVar0.f_4, 0) /*4*/ };
	return func_334(bParam0, &sVar5, &sVar0, iParam1, iParam2, 0);
}

int func_816(int iParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	struct<5> /*40*/ sVar0;
	int iVar5;
	...
	if (!func_1009(bParam1, iParam2, func_1007(iParam3, 1), bParam4, bParam9))
	{
		return 0;
	}
	...
	switch (iParam3)
	{
		...
		case joaat("MP_COMPONENT_TYPE_NECKWEAR_1"):
			if (bParam8 && bParam1 != Global_1946054.f_57[func_1007(iParam3, 1) /*11*/])
			{
				func_1011(31, 0, 0, 0, 0);
			}
			break;
		case joaat("MP_COMPONENT_TYPE_HEADWEAR"):
			if (func_1012((1 << 15)) && bParam1 != Global_1946054.f_57[func_1007(iParam3, 1) /*11*/])
			{
				func_1013();
...
void func_817()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_1018(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN") /* GXTEntry: "John\'s Cattleman Revolver" */);
		func_815(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN") /* GXTEntry: "John\'s Cattleman Revolver" */, 1, joaat("ADD_REASON_DEFAULT"));
		...
		func_1018(joaat("WEAPON_MELEE_KNIFE_JOHN") /* GXTEntry: "John\'s Knife" */);
		func_815(joaat("WEAPON_MELEE_KNIFE_JOHN") /* GXTEntry: "John\'s Knife" */, 1, joaat("ADD_REASON_DEFAULT"));
...
bool func_819(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	struct<12> /*96*/ sVar0;
	int iVar14;
...
{
	return func_736(bParam0) == joaat("HORSE");
}
...
void func_831(bool bParam0)
{
	...
	if (func_1024(&iVar4))
	{
		...
		while (iVar5 < iVar4)
		{
			if (func_1025(iVar5, &bVar2, &iVar0))
			{
				if (!func_284(bVar2, 0))
				{
				}
				...
				{
					bVar1 = func_1026(bVar2);
					if (UNLOCK::UNLOCK_IS_UNLOCKED(bVar1))
					{
						if (bParam0)
						{
							UNLOCK::UNLOCK_SET_UNLOCKED(bVar1, false);
						}
					else
					{
						}
						...
						{
							if (func_736(bVar2) == joaat("WEAPON_MOD"))
							{
								if (iVar0 == 1014511709)
								{
									bVar3 = func_825() <= -160;
							...
							if (bVar3)
							{
								UNLOCK::UNLOCK_SET_UNLOCKED(bVar1, true);
								bVar3 = false;
							}
						}
						iVar5++;
...
bool func_835(bool bParam0, int iParam1, bool bParam2)
{
	var uVar0[10];
	int iVar11;
	int iVar12;
	...
	if (!func_1030(bParam0, iParam1, &uVar0, &iVar11) || iVar11 < 1)
	{
		return false;
	}
	iVar12 = 0;
...
int func_852()
{
	...
	while (iVar1 < 5)
	{
		if (func_1035(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, joaat("EXOTIC_ITEMS"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_854(bool bParam0, int iParam1, int iParam2)
{
	...
	iVar1 = func_855(bVar9);
	iVar2 = func_855(bVar10);
	iVar3 = func_855(bVar11);
	if (iParam2 != 2)
	{
		iVar4 = func_855(bVar12);
	}
	iVar5 = func_856(bVar9);
	iVar6 = func_856(bVar10);
	iVar7 = func_856(bVar11);
	if (iParam2 != 2)
	{
		iVar8 = func_856(bVar12);
	}
	if (iVar1 >= iVar5)
	{
		iVar0 += iVar5;
...
int func_855(bool bParam0)
{
	...
	if (func_733(bParam0, 1, 0))
	{
		iVar0 = func_735(bParam0, 0, 0);
	}
	return iVar0;
}
...
void func_857(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, bool bParam5, int iParam6, bool bParam7)
{
	char* sVar0;
	char* sVar1;
	char* sVar2;
	...
	if (func_1045(iParam0, iVar13, iVar14, iParam3, bParam1, iParam6, iVar9, iParam2, iVar10, bParam5))
	{
	}
...
void func_859(bool bParam0, int iParam1, char* sParam2, int iParam3, bool bParam4)
{
	if ((((bParam0 == func_858(iParam1, 5) || bParam0 == func_858(iParam1, 6)) || bParam0 == func_858(iParam1, 7)) || bParam0 == func_858(iParam1, 8)) || bParam0 == func_858(iParam1, 9))
	{
		func_1048(iParam1, bParam0, &sParam2, 0, iParam3, bParam4);
		func_857(51, 0, 0, iParam1, sParam2, 0, -1, 0);
		func_1049(51, 0, 0, 0, 0, -1, 0);
	}
}

void func_860(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	...
	if ((((bParam0 == func_858(iParam1, 5) || bParam0 == func_858(iParam1, 6)) || bParam0 == func_858(iParam1, 7)) || bParam0 == func_858(iParam1, 8)) || bParam0 == func_858(iParam1, 9))
	{
		if (func_1048(iParam1, bParam0, &iVar0, 0, 0, 0))
		{
			func_857(51, bParam0, 0, iParam1, iVar0, 0, -1, 0);
			if (!bParam2)
			{
...
bool func_868(int iParam0, bool bParam1, int iParam2)
{
	if (!func_284(bParam1, 0))
	{
		return false;
	}
	return func_869(iParam0, bParam1) >= iParam2;
}
...
int func_869(int iParam0, bool bParam1)
{
	...
	sVar0 = { func_1052(iParam0, bParam1) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&sVar0))
	{
		return 0;
	}
...
int func_870(int iParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	struct<5> /*40*/ sVar0;
	struct<4> /*32*/ sVar5;
	...
	sVar0 = { func_871(iParam0) /*5*/ };
	sVar5 = { func_872(iParam0, bParam1, sVar0, sVar0.f_4) /*4*/ };
	return func_1053(iParam0, bParam1, &sVar5, iParam2, iParam3, bParam4);
}
...
struct<4> /*32*/ func_872(int iParam0, bool bParam1, var uParam2, int iParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> /*32*/ sVar0;
...
bool func_873(bool bParam0, int iParam1)
{
	if (!func_284(bParam0, 0))
	{
		return false;
...
float func_891(int iParam0, int iParam1)
{
	...
	if (func_733(joaat("PROVISION_TALISMAN_BOAR_TUSK") /* GXTEntry: "Boar Tusk Talisman" */, 1, 0))
	{
		fVar0 += -0.1f;
	}
...
{
	return func_736(bParam0) == joaat("WEAPON");
}
...
bool func_906(bool bParam0, var uParam1, int iParam2, bool bParam3)
{
	return func_332(bParam0, *uParam1, iParam2, bParam3) > 0;
}

bool func_907(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;

	if (func_1070(bParam0, &uVar0, uParam1, iParam2))
	{
...
bool func_908(bool bParam0, bool bParam1)
{
	if (func_1071(bParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
...
bool func_909(bool bParam0, var uParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
	...
	while (iVar29 < 4)
	{
		...
		if (func_906(bParam0, &sVar0, iVar5, 0))
		{
			bVar28 = func_907(bParam0, &sVar6, iVar5);
...
int func_910(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (!func_284(bParam0, 0))
	{
		return 0;
	...
	if (bParam2 || !func_911(bParam0))
	{
		return INVENTORY::_GET_ITEM_SLOT_MAX_COUNT(bParam0, uParam1->f_4);
	}
	return INVENTORY::_GET_ITEM_ROLE_MAX_LEVEL_COUNT(func_666(bParam3), bParam0);
}

bool func_911(bool bParam0)
{
	if (func_1073(bParam0, joaat("DEFAULT") /* GXTEntry: "_" */) == 0)
	{
		return false;
	}
	return true;
...
bool func_919(bool bParam0, int iParam1)
{
	...
	if (bParam0 != 0)
	{
		iVar5 = func_1071(bParam0);
		if (iVar5 != 0)
		{
			iVar6 = func_1079(bParam0);
			iVar0 = 0;
			while (iVar0 < iVar6)
			{
...
int func_935(bool bParam0)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(bParam0);
	if (!PED::_DOES_META_PED_OUTFIT_EXIST_FOR_PED_MODEL(joaat("META_HORSE_SADDLE_ONLY"), iVar0))
	{
		return 0;
	}
...
void func_942(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
void func_944(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
...
bool func_946(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_948(bool bParam0, int iParam1)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	bVar0 = func_731(bParam0, iParam1);
	sVar4.f_9 = joaat("SLOTID_NONE");
...
struct<18> /*144*/ func_950(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
struct<5> /*40*/ func_955(bool bParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;
	...
	switch (func_736(bParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_331(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_908(bParam0, 1))
			{
				...
				else if (!func_906(bParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_907(bParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_1094(bParam0, joaat("CI_CATEGORY_CAMP")))
			{
				sVar0 = { func_331(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(bParam0, joaat("KIT_CAMP") /* GXTEntry: "Camp" */);
			}
			else if (func_1094(bParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_331(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(bParam0, joaat("WARDROBE") /* GXTEntry: "Wardrobe" */);
			}
...
bool func_956(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_ITEMID(func_666(bParam4), bParam0, iParam1, iParam2))
	{
		return false;
	}
	return true;
...
void func_985(int iParam0, int iParam1)
{
	...
	if (iParam1 == 1)
	{
		sVar2 = "HORSE_BONDED" /* GXTEntry: "Horse Bonding Achieved" */;
	}
	else if (iParam1 == iVar1)
	{
		sVar2 = "HORSE_BONDING_MAXIMUM" /* GXTEntry: "Horse Bonding Maximum" */;
	}
	else
	{
		sVar2 = "HORSE_BONDING_LEVELUP" /* GXTEntry: "Horse Bonding Increased" */;
	}
	func_812(sVar2, MISC::VAR_STRING(2, "HORSE_BONDING_LEVEL" /* GXTEntry: "Level ~1~" */, iParam1), joaat("HUD_TOASTS"), joaat("TOAST_HORSE_BOND"), -2, "HUD_Toast_Soundset", "horse_bonding", 0, 0, 1, 1);
}
...
void func_987(int iParam0, char* sParam1)
{
	...
	{
		case 0:
			sVar1 = "RPG_HEALTH" /* GXTEntry: "Health" */;
			break;
		case 1:
			sVar1 = "RPG_STAMINA" /* GXTEntry: "Stamina" */;
			break;
		default:
			return;
	}
	sVar2 = MISC::VAR_STRING(2, "HORSE_RPG_LEVEL_PROGRESS" /* GXTEntry: "Increased to Level ~1~" */, sParam1);
	switch (iParam0)
	{
		case 0:
...
int func_991(bool bParam0)
{
	...
	iVar0 = 1;
	fVar1 = PED::_GET_CHAR_EXPRESSION(bParam0, 41611);
	if (fVar1 == 1.0f)
	{
		iVar0 = 2;
	}
...
bool func_994(int iParam0, bool bParam1)
{
	...
	PED::SET_PED_CONFIG_FLAG(Global_35, 176 /*PCF_EnableAllyRevive*/, true);
	TASK::CLEAR_PED_TASKS(Global_35, true, false);
	TASK::TASK_REVIVE_TARGET(Global_35, iParam0, bParam1);
	func_432(bParam1, 1, 0, joaat("REMOVE_REASON_DEFAULT"), 0);
	return true;
}
...
bool func_1009(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	struct<5> /*40*/ sVar0;
	int iVar5;
	int iVar6;
	...
	if (func_431(bParam0, joaat("CI_TAG_ITEM_TALISMAN")) && func_1101(&(Global_1946054.f_1378)) >= 2)
	{
		return false;
	}
	if ((func_1012((1 << 15)) && iParam2 == 10) && bParam0 != Global_1946054.f_57[iParam2 /*11*/])
	{
	...
	func_1106(&(Global_1946054.f_1378), bParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1;
	}
	Global_1946054.f_1378.f_1[iParam2 /*3*/] = bParam0;
	Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1 = func_1107(bParam0, iParam2, iParam1, func_2() != -1);
	if (bParam4)
	{
...
void func_1017()
{
	...
	func_1118(0);
	func_1119(7);
	func_1120(joaat("KIT_BANDANA") /* GXTEntry: "Bandana" */, 1, 1, 0);
	if (func_1121() == joaat("MPC_PLAYER_TYPE_SP_MARSTON"))
	{
		func_1120(joaat("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000") /* GXTEntry: "John\'s Classic Hat" */, 1, 1, 1);
		func_1120(joaat("CLOTHING_SP_MAR_OUTFIT_GUNSLINGER") /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
...
bool func_1025(int iParam0, bool bParam1, int iParam2)
{
	struct<4> /*32*/ sVar0;
	var uVar5;
...
bool func_1030(bool bParam0, int iParam1, var uParam2, var uParam3)
{
	struct<37> /*296*/ sVar0;
	int iVar47;
...
char* func_1041(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6)
{
	switch (iParam1)
	{
		case joaat("CIGARETTE_CARDS"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_CC_CARD_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Card Sets Posted" */, func_1126(), 12);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_CC_CARD_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Card Sets Found" */, func_1127(), 12);
			}
			break;
		case joaat("DINO_BONES"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_DB_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Dinosaur Bones Posted" */, func_1129(), 30);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_DB_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Dinosaur Bones Found" */, func_1128(), 30);
			}
			break;
		...
		case joaat("LEGENDARY_FISH"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_LF_CAUGHT_OBJ" /* GXTEntry: "~1~ of ~2~ Legendary Fish Caught and Posted" */, func_1130(), 13);
			}
			break;
		case joaat("ROCK_CARVINGS"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_RC_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Rock Faces Posted" */, func_1132(), 10);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_RC_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Rock Faces Found" */, func_1131(), 10);
			}
			break;
		case joaat("TAXIDERMY"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_TX_CARCASS_COLLECTED_OBJ" /* GXTEntry: "~1~ of ~2~ Carcasses Collected" */, sParam4, func_1040(iParam6, 20));
			}
			break;
	}
	return sParam3;
...
bool func_1045(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	while (iVar0 < iParam6)
	{
		if (iParam2 == joaat("CIGARETTE_CARDS"))
		{
			...
			{
				bVar1 = (func_733(bVar2, 1, 0) || func_1135(func_1134(bVar2)));
			}
			if (iParam5 == 8)
			{
				bVar1 = true;
		...
		{
			bVar2 = func_858(iParam3, func_1138(iVar0));
			if (iParam5 == 8)
			{
				bVar1 = true;
			}
			else if (bParam9)
			{
				if (bParam4 == bVar2)
				{
					bVar1 = (func_855(bVar2) - iParam7) >= func_1040(iParam3, func_1139(iVar0));
				}
				else
				{
					bVar1 = func_855(bVar2) >= func_1040(iParam3, func_1139(iVar0));
				}
			}
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_1140(bVar2)), func_1140(bVar2), bVar1, true, false);
		}
		...
		if (iParam2 == joaat("TAXIDERMY"))
		{
			...
			if (bParam9)
			{
				if (bParam4 == bVar2)
				{
					bVar1 = (func_855(bVar2) - iParam7) >= true;
				}
				else
				{
					bVar1 = func_1143(bVar2);
				}
			}
			else if (bParam4 == bVar2)
			{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_1144(bVar2)), func_1144(bVar2), bVar1, true, false);
		}
		iVar0++;
	}
	return true;
...
bool func_1048(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	else if (iParam0 == joaat("TAXIDERMY_ORDER_02"))
	{
		...
		if (func_1143(bVar0) && func_1143(bVar1))
		{
			return true;
		}
	}
	else if (iParam0 == joaat("TAXIDERMY_ORDER_03"))
	{
		...
		if ((func_1143(bVar0) && func_1143(bVar1)) && func_1143(bVar2))
		{
			return true;
		}
	}
	else
	{
		...
		if (((func_1143(bVar0) && func_1143(bVar1)) && func_1143(bVar2)) && func_1143(bVar3))
		{
			return true;
		}
	}
...
struct<4> /*32*/ func_1052(int iParam0, bool bParam1)
{
	struct<5> /*40*/ sVar0;

	sVar0 = { func_871(iParam0) /*5*/ };
	return func_872(iParam0, bParam1, sVar0, sVar0.f_4);
}

int func_1053(int iParam0, bool bParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	struct<12> /*96*/ sVar0;
...
bool func_1070(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_666(0);
	*uParam1 = { func_331(bParam0, func_905(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
...
void func_1095(int iParam0, float fParam1, int iParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return;
...
void func_1106(var uParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iVar2)
	{
		...
		case joaat("CI_CATEGORY_WARDROBE_SHIRT"):
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_1161(bParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && joaat("CI_CATEGORY_WARDROBE_SPATS") == func_1071(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
int func_1107(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	bool bVar0;

	bVar0 = func_1162(0);
	if (iParam2 != 0 && func_1163(bParam0, bVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
	if (func_1164(bParam0, func_1099(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_1119(int iParam0)
{
	...
	while (iVar0 < Global_1946054.f_2657.f_19)
	{
		...
		if (func_1071(bVar2) != joaat("CI_CATEGORY_WARDROBE_OUTFIT"))
		{
			func_1177(&(Global_1946054.f_2657.f_26.f_26), bVar2, iVar0);
		}
		if (func_1178(bVar2, 0))
		{
...
void func_1120(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	bool bVar1;
	...
	if (func_1185(iVar0))
	{
		INVENTORY::_INVENTORY_DISABLE_ITEM(func_666(0), bParam0, 0);
	}
...
int func_1127()
{
	...
	while (iVar1 < 12)
	{
		bVar2 = func_1188(iVar1);
		if (func_733(bVar2, 1, 0) || func_1135(func_1134(bVar2)))
		{
			iVar0++;
		}
		iVar1++;
...
{
	if (func_1192(bParam0) && func_733(bParam0, 1, 0))
	{
		return true;
	}
	else if (func_1193(bParam0) & func_1194(bParam0))
	{
		return true;
	}
	return false;
...
char* func_1144(bool bParam0)
{
	if (!func_284(bParam0, 0))
	{
		return "";
	}
	return HUD::GET_STRING_FROM_HASH_KEY(func_947(bParam0));
}
...
int func_1163(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
bool func_1164(bool bParam0, int iParam1, int iParam2)
{
	*iParam2 = joaat("BASE");
	return true;
}
...
int func_1166(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;

	if (bParam0 == Global_1946054.f_57[func_1007(iParam1, 1) /*11*/])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_1175(bool bParam0, bool bParam1, bool bParam2)
{
	bool bVar0;
	...
	{
		case joaat("CI_CATEGORY_WARDROBE_HAT"):
			bVar0 = func_1204(bParam0, &(Global_1946054.f_2657.f_21));
			break;
		case joaat("CI_CATEGORY_WARDROBE_MASK"):
			bVar0 = func_1204(bParam0, &(Global_1946054.f_2657.f_23));
			break;
		case joaat("CI_CATEGORY_WARDROBE_OUTFIT"):
			bVar0 = func_1204(bParam0, &(Global_1946054.f_2657.f_20));
			break;
		case joaat("CI_CATEGORY_WARDROBE_BIG_MASK"):
			bVar0 = func_1204(bParam0, &(Global_1946054.f_2657.f_22));
			break;
		case joaat("CI_CATEGORY_WARDROBE_GLOVES"):
			bVar0 = func_1204(bParam0, &(Global_1946054.f_2657.f_24));
			break;
		case joaat("CI_CATEGORY_WARDROBE_BADGE"):
			bVar0 = func_1204(bParam0, &(Global_1946054.f_2657.f_25));
			break;
	}
	if (!bVar0)
	{
...
void func_1177(var uParam0, bool bParam1, int iParam2)
{
	...
	func_1206(&(uParam0->f_1[*uParam0 /*5*/]), bParam1, -1, 1, 0);
	*uParam0++;
}

bool func_1178(bool bParam0, bool bParam1)
{
	struct<5> /*40*/ sVar0;
	struct<4> /*32*/ sVar5;

	sVar0 = { func_955(bParam0, 0, 0) /*5*/ };
	sVar5 = { func_331(bParam0, sVar0, sVar0.f_4, 0) /*4*/ };
	if (func_332(bParam0, sVar0, sVar0.f_4, 0) <= 0)
	{
		return false;
	}
...
int func_1181(bool bParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (bParam3 && !func_1178(bParam0, 0))
	{
		return 0;
	}
	Global_1946054.f_2657[Global_1946054.f_2657.f_19] = iVar1;
	if (func_1071(bParam0) != joaat("CI_CATEGORY_WARDROBE_OUTFIT"))
	{
		func_1177(&(Global_1946054.f_2657.f_26.f_26), bParam0, Global_1946054.f_2657.f_19);
	}
...
int func_1204(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
...
void func_1206(var uParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (iParam2 == -1)
	{
		uParam0->f_1 = func_1007(func_1214(bParam1), 1);
		if (uParam0->f_1 == -1)
		{
		}
	}
...
void func_1222(var uParam0, int iParam1, int iParam2)
{
	...
	uParam0->f_1 = PED::_REQUEST_META_PED_COMPONENT(iVar0, iParam1, 0, func_2() != -1, iParam2);
	*uParam0 = 1;
}
