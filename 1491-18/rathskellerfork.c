				...
				case 6:
					if (func_7(func_6(iLocal_21)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_21 /*35*/].f_11 > 0.0f)
							{
...
bool func_11()
{
	iLocal_14 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-5201.7f, -2134.3f, -13.7f, 0.0f, 0.0f, 0.0f, 116.361f, 111.159f, 70.0f, "m_volRathskellerFork");
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		iLocal_17 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Rathskeller Fork - m_volRancherInner Agg");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -5193.958f, -2150.221f, 14.60039f, 0.0f, 0.0f, 43.94339f, 30.9764f, 20.35678f, 20.57744f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -5183.694f, -2097.742f, 14.60039f, 0.0f, 0.0f, 44.16594f, 20.21152f, 34.85038f, 20.57744f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -5158.286f, -2115.092f, 14.60039f, 0.0f, 0.0f, 47.64177f, 8.714133f, 1.633199f, 20.57744f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -5230.49f, -2124.006f, 14.60039f, 0.0f, 0.0f, 44.16594f, 15.32629f, 8.306676f, 20.57744f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -5157.303f, -2119.695f, 14.60039f, 0.0f, 0.0f, 44.16594f, 12.39145f, 8.306676f, 20.57744f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -5213.393f, -2110.535f, 14.60039f, 0.0f, 0.0f, 44.16594f, 34.53635f, 13.98279f, 20.57744f);
		...
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, -67.73256f, -399.212f, 72.24845f, 0.0f, 0.0f, 52.56716f, 42.4006f, 47.27523f, 14.85572f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, -5186.615f, -2154.339f, 14.60039f, 0.0f, 0.0f, 46.12168f, 36.16204f, 4.894577f, 20.57744f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_16, -5194.527f, -2122.047f, 14.60039f, 0.0f, 0.0f, 43.94178f, 70.70334f, 56.27375f, 20.57744f);
		...
		LAW::_SET_GUARD_ZONE_VOLUME_WARNING(sLocal_15, iLocal_16);
...
void func_28(int iParam0)
{
	...
	VOLUME::_0x53D05D60E5F5B40C(iLocal_16, 3, 1, func_51(784));
}
...
void func_39(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0.0f, 0.0f, 0.0f) <= 5.0f || func_55(Global_1935630, (1 << 14))) || func_55(Global_1935630, (1 << 23)))
	{
		return;
	}
...
bool func_57()
{
	return func_55(Global_1935630, (1 << 12));
}
...
void func_62(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_53(iParam0) && func_79(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
...
int func_85(int iParam0, bool bParam1)
{
	...
	if (func_122(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			if (func_122(iParam0, (1 << 11)))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_51(iParam0));
				func_126(iParam0, (1 << 11));
			}
...
char* func_103(char* sParam0, int iParam1)
{
	...
	return func_137(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}
...
struct<2> /*16*/ func_108(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_118(int iParam0)
{
	...
	func_145(iParam0, (1 << 13));
	func_145(iParam0, (1 << 14));
	func_145(iParam0, (1 << 15));
	func_145(iParam0, (1 << 17));
	func_145(iParam0, (1 << 24));
	func_145(iParam0, (1 << 19));
...
bool func_131(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_159(iVar0) && func_160(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_148(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_170(iParam0, (1 << 10)))
		{
			func_171(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_170(iParam0, (1 << 10)))
	{
...
bool func_162(Vector3 vParam0, int iParam3)
{
	...
	func_178(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_179(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
