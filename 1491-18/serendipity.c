		...
		if (MISC::GET_GAME_TIMER() > iLocal_46)
		{
			...
			switch (iLocal_45)
			{
				...
				case 1:
					...
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_47));
				...
				case 6:
					if (func_7(func_6(iLocal_47)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_47 /*35*/].f_11 > 0.0f)
							{
								PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1888801[iLocal_47 /*35*/].f_11);
							}
							Jump @785; // curOff = 766
							func_42(iVar0);
							iVar0 = (1 + iVar0);
						...
						{
							PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1888801[iLocal_47 /*35*/].f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
void func_27(int iParam0)
{
	if (func_20() == -1)
	{
		if (!func_51(0, 0, 1))
		{
			...
			func_52(joaat("KTORU"), 1, 0, 0, 0, 0, 0, 0);
		}
		else
		{
			...
			func_52(joaat("KTORU"), 0, 0, 0, 1, 0, 0, 0);
		}
	}
}
...
void func_62(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_113(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_113(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_113(&cVar6, joaat("COLOR_PURE_WHITE")), func_113(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
char* func_113(char* sParam0, int iParam1)
{
	...
	return func_151(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_114(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
void func_159(struct<6> /*48*/ sParam0, var uParam6)
{
...
void func_167(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		{
			func_187(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_186(iParam0, (1 << 10)))
	{
