...
bool func_97(var uParam0)
{
	if (!MAP::DOES_BLIP_EXIST(iLocal_57))
	{
		...
		MAP::SET_BLIP_SPRITE(iLocal_57, joaat("BLIP_AMBIENT_SECRET") /* GXTEntry: "Companion" */, true);
	}
...
{
	func_167(uParam0, iParam1, 0, 0, 0, -1, 0, 0.0f, 1065353216 /* Float: 1f */, 1);
}
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_283(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
...
void func_221(var uParam0)
{
	...
	{
		iLocal_43 = func_336("GREET_ACC" /* GXTEntry: "Accept" */, joaat("INPUT_INTERACT_LOCKON_POS"), func_8(uParam0, iLocal_16), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	...
	{
		iLocal_44 = func_336("GREET_REJ" /* GXTEntry: "Reject" */, joaat("INPUT_INTERACT_LOCKON_NEG"), func_8(uParam0, iLocal_16), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
...
void func_224(var uParam0)
{
	...
	{
		iLocal_46 = func_336("VIG_FLARE" /* GXTEntry: "FLARE" */, joaat("INPUT_CONTEXT_X"), func_8(uParam0, iLocal_16), 2, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		func_349(iLocal_46, 6.0f, 1);
		func_338(iLocal_46, 0, 1);
	}
	if (!func_49(iLocal_45))
	{
		iLocal_45 = func_336("LEAVE" /* GXTEntry: "Leave" */, joaat("INPUT_CONTEXT_B"), func_8(uParam0, iLocal_16), 2, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
...
int func_336(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_236(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_405(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_351(var uParam0)
{
	...
	fVar0 = PAD::GET_CONTROL_NORMAL(0, joaat("INPUT_MOVE_LR") /* GXTEntry: "Move left/right" */);
	if (fVar0 > 0.1f)
	{
		iLocal_32 = iLocal_23;
		return;
...
int func_455(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_488(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) /*3*/ };
...
void func_478(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_523(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_523(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
