...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.2233f, -1.6019f, 1.2509f, 0.0f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	func_152(uParam0, joaat("P_CS_BOOK02X"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 1, 1);
	func_152(uParam0, joaat("P_CHAIRFOLDING02X"), -0.258326f, -1.19728f, 0.0305557f, "CHAIR" /* GXTEntry: "Chair" */, 1, 0, 1);
	...
	sLocal_20 = { func_156(uParam0, -0.2675f, -1.8369f, 1.1388f, -9.72f, 6.5f, 0.9377f, 0.7505f) /*10*/ };
	func_157(uParam0, 1);
...
{
	return func_189(uParam0, sLocal_20, 1, 0);
}
...
bool func_189(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
	...
	if (!func_291(sParam1, sParam1.f_6, Global_36))
	{
		return false;
	}
	if (func_291(sParam1, sParam1.f_3, Global_36))
	{
		return false;
	}
	if (bParam12)
...
bool func_291(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5, struct<2> /*16*/ sParam6, var uParam8)
{
