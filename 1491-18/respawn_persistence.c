			...
			case 5:
				if (!Global_1934266.f_59)
				{
					if (Global_1310720.f_7)
					{
						...
						Global_1935630.f_3 = func_15(&cLocal_14, "ALERT_PLAYER_DEAD" /* GXTEntry: "DEAD" */, 0, 1);
					}
...
Vector3 func_28(Vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	vVar0 = { func_87(vParam0, iParam3, iParam4, iParam5, iParam6, 1, iParam7, bParam8, bParam9, bParam10, -1, 1103626240 /* Float: 25f */) /*3*/ };
	if (func_25(vVar0))
	{
		vVar0 = { func_87(vParam0, iParam3, iParam4, 0, 1, 1, iParam7, bParam8, 0, 0, -1, 1103626240 /* Float: 25f */) /*3*/ };
	}
	return vVar0;
}
...
bool func_246()
{
	...
	return (PED::_IS_META_PED_USING_COMPONENT(Global_35, joaat("HATS")) || func_329(joaat("CI_CATEGORY_WARDROBE_HAT"), &uVar0));
}
...
char* func_360(char* sParam0, int iParam1)
{
	...
	return func_389(MISC::VAR_STRING(10, "PLAYER_STRING" /* GXTEntry: "~fg~~1p~~fo~" */, sParam0), iParam1);
}
