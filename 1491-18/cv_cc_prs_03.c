...
bool func_1(var uParam0)
{
	...
	{
		TASK::_DISASSOCIATE_PROP_FROM_SCENARIO(uParam0->f_107[iLocal_14 /*113*/].f_32.f_21, "KNIFE" /* GXTEntry: "Knife" */);
...
bool func_73(var uParam0)
{
	...
	func_154(uParam0, joaat("P_CS_DEERCARCASS"), 0.0f, 0.0f, 0.0f, "CARCASS" /* GXTEntry: "Carcass" */, 0, 0, 1);
	iLocal_20 = func_154(uParam0, joaat("P_CS_DEERCARCASSARM"), 0.0f, 0.0f, 0.0f, "LEG", 0, 1, 1);
	iLocal_21 = func_154(uParam0, joaat("P_KNIFE03X"), 0.0f, 0.0f, 0.0f, "KNIFE" /* GXTEntry: "Knife" */, 0, 1, 1);
	...
	func_159(uParam0, iLocal_14, iLocal_21, "Knife" /* GXTEntry: "Knife" */, 1, "KNIFE" /* GXTEntry: "Knife" */);
