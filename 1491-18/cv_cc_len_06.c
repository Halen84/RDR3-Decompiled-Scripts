...
bool func_72(var uParam0)
{
	...
	if (func_152(10))
	{
		iLocal_16 = func_153(uParam0, joaat("P_CHAIRFOLDING02X"), -0.00632575f, -0.96194f, 0.0307617f, "CHAIR" /* GXTEntry: "Chair" */, 1, 0, 1);
	}
	else
	{
		iLocal_16 = func_153(uParam0, joaat("P_CHAIRFOLDING02X"), -0.258326f, -1.19728f, 0.0322266f, "CHAIR" /* GXTEntry: "Chair" */, 1, 0, 1);
	}
	...
	if (func_152(10))
	{
		func_157(uParam0, iLocal_14, 3, joaat("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_A", iLocal_17, 0, -1.0f, 1065353216 /* Float: 1f */, 1);
	}
	else
	{
