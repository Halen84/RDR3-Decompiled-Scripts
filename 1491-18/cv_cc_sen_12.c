...
bool func_73(var uParam0)
{
	...
	func_157(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_KNIFE_BADASS"), "PROP_HUMAN_SEAT_CHAIR_KNIFE_BADASS_SHARPEN_MALE_B", iLocal_16, 0, 30.0f, 1065353216 /* Float: 1f */, 1);
