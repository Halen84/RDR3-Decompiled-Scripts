...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.8728f, 0.6017f, 0.5052f, 34.7662f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	func_151(uParam0, -0.254f, -0.9561f, 0.6086f, -27.0658f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	func_152(uParam0, -1.06f, -0.34f, 1.0005f, 0.0f, 0.6f, 0.8f, 3.0f, joaat("VOLCYLINDER"), 1);
	iLocal_22 = func_153(uParam0, joaat("S_CRATESEAT03X"), -1.28888f, 0.763515f, 0.0f, "CRATE" /* GXTEntry: "Crate" */, 1, 0, 1);
	func_153(uParam0, joaat("P_CHAIR_BARREL04B"), -0.584518f, -1.37169f, 0.0f, "BARREL", 1, 0, 1);
	iLocal_20 = func_153(uParam0, joaat("P_CS_LEDGER01X"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 1, 1);
	iLocal_21 = func_153(uParam0, joaat("P_PEN01X"), 0.0f, 0.0f, 0.0f, "PEN", 0, 1, 1);
	...
	sLocal_23 = { func_159(uParam0, -1.1728f, 0.7517f, 0.5052f, -100.4843f, 8.0f, 0.6f, 0.6f) /*10*/ };
	sLocal_33 = { func_159(uParam0, -1.173f, 0.752f, 0.505f, 160.48f, 8.0f, 0.5f, 0.5f) /*10*/ };
	return true;
}
...
{
	vLocal_44 = { ENTITY::GET_ENTITY_COORDS(func_190(uParam0, iLocal_20), true, false) /*3*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	if (!bLocal_43)
	{
		if (func_198(uParam0, iLocal_16))
		{
			...
			else if (func_199(uParam0, sLocal_33, 1, 0))
			{
...
bool func_95(var uParam0)
{
	...
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_44, 1.0f))
	{
		return true;
	}
	return false;
