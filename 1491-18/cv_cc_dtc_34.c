...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.125f, -0.4001f, 1.4875f, 0.0f, 1.1f, 1.1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_15 = func_152(uParam0, joaat("P_CHAIRFOLDING02X"), 0.0f, 0.0f, 0.0f, "Chair" /* GXTEntry: "Chair" */, 1, 0, 1);
	...
	func_157(uParam0, iLocal_14, 3, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_C", iLocal_15, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	sLocal_17 = { func_162(uParam0, 0.0f, -0.3f, 0.9877f, 169.0f, 6.5f, 0.705f, 0.4425f) /*10*/ };
	return true;
}
...
{
	return func_193(uParam0, sLocal_17, 1, 0);
}
...
int func_193(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
	...
	if (!func_296(sParam1, sParam1.f_6, Global_36))
	{
		return 0;
	}
	if (func_296(sParam1, sParam1.f_3, Global_36))
	{
		return 0;
	}
	if (bParam12)
...
bool func_296(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5, struct<2> /*16*/ sParam6, var uParam8)
{
