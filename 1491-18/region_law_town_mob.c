...
void func_17()
{
	...
	while (iVar0 < iLocal_46)
	{
		...
		if (iVar0 == 0)
		{
			...
			if (UNLOCK::UNLOCK_IS_UNLOCKED(joaat("WEAPON_SHOTGUN_DOUBLEBARREL") /* GXTEntry: "Double-Barreled Shotgun" */))
			{
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_46[iVar0], joaat("WEAPON_SHOTGUN_DOUBLEBARREL") /* GXTEntry: "Double-Barreled Shotgun" */, 999, true, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
			}
			else
			{
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_46[iVar0], joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */, 999, true, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
			}
		}
		else
		{
			...
			if (func_6(iLocal_46[iVar0], 0))
			{
				...
				{
					WEAPON::GIVE_WEAPON_TO_PED(iLocal_46[iVar0], joaat("WEAPON_REVOLVER_CATTLEMAN") /* GXTEntry: "Cattleman Revolver" */, 999, true, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
					WEAPON::GIVE_WEAPON_TO_PED(iLocal_46[iVar0], joaat("WEAPON_MELEE_TORCH") /* GXTEntry: "Torch" */, 999, true, false, 1, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
				}
				else
				{
					WEAPON::GIVE_WEAPON_TO_PED(iLocal_46[iVar0], joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */, 999, true, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
		...
		if (func_6(iLocal_46[iVar0], 0))
		{
			...
			func_33(&iVar5, 15);
			func_33(&iVar5, 16);
			COMPANION::_ADD_COMPANION_FLAG(iLocal_46[iVar0], iVar5);
		}
		iVar0++;
	}
}
