		...
		if (MISC::GET_GAME_TIMER() > iLocal_28)
		{
			...
			switch (iLocal_27)
			{
				...
				case 1:
					...
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_29));
				...
				case 6:
					if (func_7(func_6(iLocal_29)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_29 /*35*/].f_11 > 0.0f)
							{
								PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1888801[iLocal_29 /*35*/].f_11);
							}
							Jump @788; // curOff = 769
							func_42(iVar0);
							iVar0 = (1 + iVar0);
						...
						{
							PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1888801[iLocal_29 /*35*/].f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
bool func_11()
{
	...
	iLocal_17 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(3350.781f, -675.869f, 63.768f, 0.0f, 0.0f, 0.0f, 116.5f, 87.5f, 50.0f, "Sisika - m_volGTower");
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, 3321.868f, -610.395f, 48.57418f, 0.0f, 0.0f, 40.0f, 15.0f, 75.0f, 20.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, 3319.213f, -584.038f, 47.83653f, 0.0f, 0.0f, 40.0f, 15.0f, 29.0f, 20.0f);
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3353.973f, -672.1495f, 63.768f, 0.0f, 0.0f, 14.62307f, 68.21951f, 54.663f, 50.0f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3315.974f, -656.2813f, 75.25407f, 0.0f, 0.0f, 40.4587f, 4.165449f, 4.203612f, 25.19653f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3382.837f, -665.3976f, 63.76801f, 0.0f, 0.0f, -59.89402f, 51.37444f, 37.32103f, 50.0f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3381f, -693.5285f, 48.96563f, 0.0f, 0.0f, 50.13634f, 11.37222f, 36.9617f, 50.0f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3364.015f, -686.8185f, 63.76801f, 0.0f, 0.0f, 60.3014f, 66.63422f, 46.65413f, 50.0f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3376.356f, -691.6537f, 63.76801f, 0.0f, 0.0f, 50.13634f, 65.99199f, 37.71349f, 50.0f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3328.904f, -704.5117f, 75.25407f, 0.0f, 0.0f, 40.4587f, 4.165449f, 5.205996f, 25.19653f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3368.851f, -726.5292f, 75.25407f, 0.0f, 0.0f, 40.4587f, 4.165449f, 4.203612f, 25.19653f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3410.578f, -679.0173f, 75.25407f, 0.0f, 0.0f, 40.45871f, 4.165449f, 4.203612f, 25.19653f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_21, 3386.604f, -637.0076f, 75.25407f, 0.0f, 0.0f, 40.45871f, 4.165449f, 4.203612f, 25.19653f);
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, 3187.881f, -392.378f, 59.70001f, 0.0f, 0.0f, -60.2991f, 106.109f, 89.50376f, 100.0f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, 3203.627f, -637.6728f, 59.70001f, 0.0f, 0.0f, -63.6916f, 207.2567f, 107.2578f, 100.0f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, 3186.952f, -695.6421f, 59.70001f, 0.0f, 0.0f, -63.6916f, 129.2146f, 107.2578f, 100.0f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, 3297.383f, -592.1081f, 59.70001f, 0.0f, 0.0f, -63.6916f, 173.9582f, 92.46152f, 100.0f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_20, 3375.808f, -710.6785f, 59.7f, 0.0f, 0.0f, -61.08491f, 129.6087f, 116.591f, 100.0f);
		iLocal_22 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Sisika - m_volGuardWarning Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_22, iLocal_20);
		iLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Sisika - m_volGuardRegistration Agg");
		VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_19, iLocal_22);
		sLocal_23 = "SISIKA";
		LAW::_CREATE_GUARD_ZONE(sLocal_23);
		LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_START(sLocal_23, iLocal_19);
		LAW::_SET_GUARD_ZONE_VOLUME_WARNING(sLocal_23, iLocal_22);
		LAW::_SET_GUARD_ZONE_VOLUME_RESTRICTED(sLocal_23, iLocal_20);
		LAW::_SET_GUARD_ZONE_VOLUME_THREAT(sLocal_23, iLocal_21);
		LAW::_SET_GUARD_ZONE_POSITION(sLocal_23, 3355.869f, -676.4202f, 49.5715f);
		LAW::_SET_GUARD_ZONE_VOLUME_REGISTRATION_END(sLocal_23, iLocal_19);
	}
	return true;
}
...
void func_46()
{
	...
	iVar0 = 7;
	iLocal_14[0] = VOLUME::_CREATE_VOLUME_LOCK(3360.208f, -678.505f, 41.488f, 60.0f, iVar0, (1 << 14));
}
...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_52(iParam0) && func_81(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_110(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_110(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_110(&cVar6, joaat("COLOR_PURE_WHITE")), func_110(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
char* func_110(char* sParam0, int iParam1)
{
	...
	return func_147(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}
...
struct<2> /*16*/ func_115(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_125()
{
	...
	while (iVar0 < 1)
	{
		if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(iLocal_14[iVar0]))
		{
			VOLUME::_RELEASE_LOCK_VOLUME(iLocal_14[iVar0]);
		}
		iVar0++;
	}
}
...
void func_158(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		{
			func_182(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_181(iParam0, (1 << 10)))
	{
