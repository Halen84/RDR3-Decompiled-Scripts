...
{
	return func_48(&uLocal_14, (1 << 17), &uLocal_14, func_46(), 0, func_47(), 0, 0, 0);
}
...
char* func_114(char* sParam0, int iParam1)
{
	...
	return func_163(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}
...
void func_130(int iParam0)
{
	...
	func_171(iParam0, (1 << 13));
	func_171(iParam0, (1 << 14));
	func_171(iParam0, (1 << 15));
	func_171(iParam0, (1 << 17));
	func_171(iParam0, (1 << 24));
	func_171(iParam0, (1 << 19));
	func_171(iParam0, (1 << 20));
...
void func_174(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_209(iParam0, (1 << 10)))
		{
			func_210(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_209(iParam0, (1 << 10)))
	{
		func_211(iParam0, (1 << 10));
		INVENTORY::_0x9B4E793B1CB6550A();
	}
	func_212(iParam0);
}
...
bool func_201(Vector3 vParam0, int iParam3)
{
	...
	func_221(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_222(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
