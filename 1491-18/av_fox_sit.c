#pragma region Local_Variables
	...
	struct<23> /*184*/ sLocal_45 = { 0, 0, 0, 0, -1, 0, 0, 0, 2, 1, 1, 1, 0, 1, 2, 2, 3, 0, 0, 3, 1, 3, 3 } ;
	var uLocal_68 = 0;
	var uLocal_69 = 0;
...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_49(uParam0, 0, "FS_ANIMAL", iLocal_9, vParam1, (0.0f + vParam4.z), iVar0, 1, 1, 1, iLocal_12, 1);
}
...
int func_30(var uParam0)
{
	...
	func_65(&uLocal_17, 5.0f);
	sLocal_45 = { 0.0f, 0.0f, 0.0f /*3*/ };
	sLocal_45.f_8 = 4;
	sLocal_45.f_4 = 21030;
	sLocal_45.f_21 = 3;
	sLocal_45.f_22 = 3;
	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], iLocal_11, uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
			...
			break;
		case 1:
			if (func_71(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */) || func_72(&uLocal_13, 20.0f))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					...
					{
						TASK::TASK_STAND_STILL(uParam0->f_20[0 /*14*/], BUILTIN::FLOOR((5.0f * 1000.0f)));
					}
					func_68(&(uParam0->f_20[0 /*14*/]), 0, 1);
				}
				func_67(uParam0);
			...
			else if (*uParam0 == 172)
			{
				if (!bLocal_16)
				{
					TASK::REACT_LOOK_AT(uParam0->f_20[0 /*14*/], Global_35, 1, 1, 30000.0f, 1, 0, 0, 0);
					sLocal_45.f_3 = Global_35;
					sLocal_45.f_7 = 0;
					func_70(&uLocal_13);
					bLocal_16 = true;
				}
				...
				{
					IK::_INVERSE_KINEMATICS_REQUEST_LOOK_AT(uParam0->f_20[0 /*14*/], &sLocal_45);
				}
			}
			break;
		case 2:
			if (func_72(&uLocal_13, 5.0f))
			{
				if (*uParam0 != 172)
				{
