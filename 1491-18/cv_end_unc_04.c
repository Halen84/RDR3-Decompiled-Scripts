...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			func_149(uParam0, -1591.96f, -1424.587f, 80.51f, 0.0f, 0.0f, 92.16f);
			break;
		default:
			return false;
	}
	iLocal_14 = func_150(uParam0, 4, 0);
	iLocal_15 = func_151(uParam0, joaat("P_PITCHFORK01X"), 0.0f, 0.0f, 0.0f, "PITCHFORK", 0, 0, 1);
	func_151(uParam0, joaat("S_HORSEPOOP01X"), 0.0f, 0.0f, 0.0f, "POOP_01", 0, 0, 1);
	func_151(uParam0, joaat("S_HORSEPOOP02X"), 0.0f, 0.0f, 0.0f, "POOP_02", 0, 0, 1);
	func_151(uParam0, joaat("S_HORSEPOOP02X"), 0.0f, 0.0f, 0.0f, "POOP_02^1", 0, 0, 1);
	func_151(uParam0, joaat("S_HORSEPOOP03X"), 0.0f, 0.0f, 0.0f, "POOP_03", 0, 0, 1);
	func_151(uParam0, joaat("P_WHEELBARROW01X"), 0.0f, 0.0f, 0.0f, "WHEELBARROW", 0, 0, 1);
	...
	iLocal_18 = func_154(uParam0, -0.18f, 3.03f, 1.9f, 0.0f, 0.0f, 136.28f, 10.12f, 9.24f, 4.0f, "volTriggerBeecherUncle4", joaat("VOLBOX"));
	func_155(uParam0, 1);
	func_156(uParam0, iLocal_14, 1094713344 /* Float: 12f */, 1092616192 /* Float: 10f */);
	func_157(uParam0, iLocal_14, 1, -1);
	func_158(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_PITCH_FORK_PUT_DOWN"), "WORLD_HUMAN_PITCH_FORK_PUT_DOWN_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_93(var uParam0)
{
	...
	if (((func_201(uParam0, iLocal_17) && MISC::GET_GAME_TIMER() > iLocal_19) && !func_192(uParam0, &iLocal_18, 1)) && !ENTITY::IS_ENTITY_ON_SCREEN(func_48(uParam0, iLocal_14)))
	{
...
int func_154(var uParam0, Vector3 vParam1, Vector3 vParam4, Vector3 vParam7, char* sParam10, int iParam11)
{
	...
	vVar1 = { func_253(uParam0, vParam1) /*3*/ };
...
void func_186(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_253(uParam0, uParam0->f_1976.f_1), 1, func_289(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
