				...
				case 6:
					if (func_7(func_6(iLocal_76)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_76 /*35*/].f_11 > 0.0f)
							{
...
int func_15(int iParam0)
{
	...
	if (func_49((1 << 15), 0, &uVar0))
	{
	}
	if (func_47(28, func_46(0)) && !func_48(28))
	{
		return func_52(&uLocal_14, (1 << 15), &uLocal_14, func_50(), 0, func_51(), 1, 1, 1);
	}
	return 0;
}
	...
	if (!func_98(uParam0->f_3, iVar0))
	{
		if (func_98(uParam0->f_3, 2))
		{
			if (!SCRIPTS::IS_THREAD_ACTIVE(*uParam2, false))
			{
				...
				{
					uParam0->f_52 = { func_100(iParam1) /*3*/ };
					uParam0->f_5 = func_88(func_86(iParam1), 0, 3, func_87(iParam1));
...
void func_66(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_57(iParam0) && func_83(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_122(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_122(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_122(&cVar6, joaat("COLOR_PURE_WHITE")), func_122(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
int func_84(int iParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		case 3:
			...
			iVar0 += func_144(iParam0, 2);
			iVar0 += func_144(iParam0, 11);
			return iVar0;
		case 0:
			iVar0 = func_144(iParam0, 1);
			iVar0 += func_144(iParam0, 7);
			iVar0 += func_144(iParam0, 6);
			iVar0 += func_144(iParam0, 12);
			return iVar0;
		case 2:
			iVar0 = func_144(iParam0, 3);
			iVar0 += func_144(iParam0, 10);
			return iVar0;
		case 1:
			iVar0 = func_144(iParam0, 4);
			iVar0 += func_144(iParam0, 9);
			return iVar0;
		case 4:
			return func_144(iParam0, 8);
		case 5:
			iVar0 = func_144(iParam0, 13);
			iVar0 += func_144(iParam0, 14);
			iVar0 += func_144(iParam0, 15);
			iVar0 += func_144(iParam0, 16);
			return iVar0;
		default:
			break;
	}
...
bool func_95(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_152(iVar0) && func_153(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
bool func_99(var uParam0)
{
	...
	if ((!func_98(uParam0->f_3, (1 << 15)) && func_157(uParam0->f_1, &fVar1)) && func_49(uParam0->f_1, 0, &fVar0))
	{
		fVar2 = func_158();
		if ((func_158() - fVar1) >= fVar0)
		{
			func_156(&(uParam0->f_3), (1 << 15));
		}
	}
	if (func_98(uParam0->f_3, (1 << 15)))
	{
		return true;
	}
	return false;
...
char* func_122(char* sParam0, int iParam1)
{
	...
	return func_171(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_123(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_127(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_138(int iParam0)
{
	...
	func_179(iParam0, (1 << 13));
	func_179(iParam0, (1 << 14));
	func_179(iParam0, (1 << 15));
	func_179(iParam0, (1 << 17));
	func_179(iParam0, (1 << 24));
	func_179(iParam0, (1 << 19));
	func_179(iParam0, (1 << 20));
...
bool func_207(Vector3 vParam0, int iParam3)
{
	...
	func_227(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_228(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
