...
bool func_72(var uParam0)
{
	...
	func_155(uParam0, iLocal_14, 2, joaat("WORLD_CAMP_KIERAN_TREE_TIED"), "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1, -1.0f, 1065353216 /* Float: 1f */, 1);
...
{
	func_155(uParam0, iParam1, 0, 0, 0, -1, 0, 0.0f, 1065353216 /* Float: 1f */, 1);
}
