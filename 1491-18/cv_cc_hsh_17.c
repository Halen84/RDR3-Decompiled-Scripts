...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, 4.1112f, -7.5077f, 0.7655f, 0.0f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	func_150(uParam0, 1.53f, 0.16f, 1.0f, 0.0f, 3.0f, 3.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	func_151(uParam0, 1.47142f, 0.305939f, 1.00063f, 0.0f, 1.0f, 1.0f, 3.0f, joaat("VOLCYLINDER"), 1);
	...
	sLocal_20 = { func_157(uParam0, 1.252f, 0.159f, 0.994f, 142.92f, 8.0f, 0.5f, 0.5f) /*10*/ };
	sLocal_30 = { func_157(uParam0, 1.2517f, 0.1585f, 0.9939f, -51.84f, 8.0f, 0.4f, 0.4f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_196(uParam0, sLocal_20, 1, 0))
		{
			func_187(uParam0, iLocal_17, 1);
		}
		else if (func_196(uParam0, sLocal_30, 1, 0))
		{
...
struct<10> /*80*/ func_157(var uParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	...
	fVar0 = func_249(uParam0, (fParam4 + (fParam6 * 90.0f)));
	fVar1 = func_249(uParam0, (fParam4 - (fParam7 * 90.0f)));
	sVar2 = { func_248(uParam0, vParam1) /*3*/ };
...
bool func_195(var uParam0, int iParam1)
{
	...
	if (func_295(uParam0, iParam1, 1.0f))
	{
		return true;
	}
...
bool func_196(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_297(sParam1, sParam1.f_6, Global_36))
	{
		return false;
	}
	if (func_297(sParam1, sParam1.f_3, Global_36))
	{
		return false;
	}
	if (bParam12)
...
void func_202(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_295(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
bool func_238(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_311(iVar0) && func_312(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_271(var uParam0, int iParam1)
{
	...
	else if (!func_328(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
	{
...
int func_282(int iParam0, struct<8> /*64*/ sParam1, int iParam9)
{
	int iVar0;
	var uVar1;
...
bool func_297(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
bool func_299(var uParam0, int iParam1)
{
	...
	{
		if (!func_328(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_ANY")))
		{
			return true;
		}
	}
...
void func_384(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_418(func_104(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_419(iParam0);
