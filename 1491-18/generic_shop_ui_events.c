			...
			if (UIEVENTS::EVENTS_UI_PEEK_MESSAGE(iScriptParam_0, &sVar3))
			{
				...
				switch (sVar3.f_0)
				{
					...
					case joaat("DATA_ADJUSTABLE_CHANGED"):
						if (sVar3.f_2 == joaat("GENERIC_SHOP_UI_PALETTE_FOCUS"))
						{
							func_4(sVar3.f_1);
							func_3(4);
							func_3(2);
					...
					case joaat("ITEM_FOCUSED"):
						...
						if (sVar3.f_2 != joaat("GENERIC_SHOP_UI_NEXT_PAGE"))
						{
							func_3(2);
						}
						else
					...
					case joaat("ITEM_SELECTED"):
						if (sVar3.f_2 != joaat("GENERIC_SHOP_UI_SECONDARY_SELECT"))
						{
							func_12(sVar3.f_1);
							iVar2 = func_13();
							func_14(&(sVar3.f_3));
						...
						func_16(sVar3.f_2);
						if (sVar3.f_2 == joaat("GENERIC_SHOP_UI_EXIT"))
						{
							func_3((1 << 10));
						}
						func_3(16);
						...
						break;
					case joaat("NEW_PAGE"):
						if (sVar3.f_2 == joaat("GENERIC_SHOP_UI_NEXT_SCENE"))
						{
							func_3(256);
						}
						else if (sVar3.f_2 != joaat("GENERIC_SHOP_UI_PREV_SCENE"))
						{
							if (sVar3.f_2 != joaat("GENERIC_SHOP_UI_NEXT_PAGE"))
							{
								if (sVar3.f_2 == joaat("GENERIC_SHOP_UI_PREV_PAGE"))
								{
									func_3((1 << 9));
								}
							}
					...
					case joaat("NEW_ACTIVITY"):
						if (sVar3.f_2 == joaat("GENERIC_SHOP_UI_ENTRY"))
						{
							Global_1914319.f_16855.f_3.f_3 = 1;
						}
						else if (sVar3.f_2 == joaat("GENERIC_SHOP_UI_BYPASS"))
						{
