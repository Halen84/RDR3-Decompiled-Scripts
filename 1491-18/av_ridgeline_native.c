...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	iVar1 = func_48(joaat("HORSE_CLASS_RIDING") /* GXTEntry: "Riding" */, 1);
	...
	if (!bParam1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iParam2 /*14*/]))
		{
			if (!func_104(uParam0->f_20[iParam2 /*14*/], joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
			{
				...
				PED::SET_PED_CONFIG_FLAG(uParam0->f_20[iParam2 /*14*/], 146 /*PCF_0x861831C4*/, true);
				func_107(&(uParam0->f_20[iParam2 /*14*/]), 1, 1);
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[iParam2 /*14*/], joaat("WEAPON_BOW") /* GXTEntry: "Bow" */, 500, false, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), true, 0.0f, false);
				WEAPON::SET_CURRENT_PED_WEAPON(uParam0->f_20[iParam2 /*14*/], joaat("WEAPON_BOW") /* GXTEntry: "Bow" */, true, 0, true, false);
				return;
			}
		}
	}
