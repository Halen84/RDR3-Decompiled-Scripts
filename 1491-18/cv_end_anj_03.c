...
bool func_75(var uParam0)
{
	...
	func_161(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 2.0f, 1);
	...
	func_161(uParam0, iLocal_15, 2, joaat("PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_LEFT"), "PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_MALE_A", -1, 0, 640.0f, 1065353216 /* Float: 1f */, 1);
...
bool func_87(var uParam0)
{
	...
	{
		func_182(iLocal_19, uParam0->f_1984[iLocal_16], "DOOR" /* GXTEntry: "Door" */);
		func_182(iLocal_19, uParam0->f_1984[iLocal_17], "DOOR" /* GXTEntry: "Door" */);
	}
	return true;
}
