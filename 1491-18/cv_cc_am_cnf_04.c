...
bool func_79(var uParam0)
{
	...
	func_168(uParam0, iLocal_18, 2, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_A", iLocal_37, 0, 110.0f, 1065353216 /* Float: 1f */, 1);
	...
	if (iLocal_49 >= 3 && iLocal_49 < 6)
	{
		...
		if (func_225(&uLocal_98))
		{
			...
			else
			{
				...
				func_168(uParam0, iLocal_18, 2, joaat("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", iLocal_37, 0, 110.0f, 1065353216 /* Float: 1f */, 1);
			}
			func_227(uParam0, iLocal_23, "b_WaitLoop", 1);
			func_216(9);
			return false;
...
void func_211(int iParam0, int iParam1, var uParam2, var uParam3)
{
	if (!func_51(*iParam0))
	{
		*iParam0 = func_330("GREET_ACC" /* GXTEntry: "Accept" */, joaat("INPUT_INTERACT_LOCKON_POS"), func_8(uParam2, *uParam3), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		func_331(*iParam0, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(func_8(uParam2, *uParam3)), 0, 1);
	}
	if (!func_51(*iParam1))
	{
		*iParam1 = func_330("GREET_REJ" /* GXTEntry: "Reject" */, joaat("INPUT_INTERACT_LOCKON_NEG"), func_8(uParam2, *uParam3), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
...
void func_234(var uParam0)
{
	...
	{
		iLocal_53 = func_330("VIG_LEAVE_CONVERSATION" /* GXTEntry: "Leave Conversation" */, joaat("INPUT_GAME_MENU_CANCEL"), func_8(uParam0, iLocal_18), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	}
...
int func_330(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_244(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_400(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
int func_413(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_456(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) /*3*/ };
...
struct<5> /*40*/ func_542(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_554(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_546(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_546(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
