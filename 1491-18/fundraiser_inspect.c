...
bool func_1(struct<2> /*16*/ sParam0, var uParam2)
{
	switch (iLocal_10)
	{
		case 0:
			...
			{
				iLocal_0 = func_3("INSPECT_GENERIC" /* GXTEntry: "Inspect" */, joaat("INPUT_CONTEXT_Y"), TASK::_GET_SCENARIO_POINT_COORDS(sParam0.f_1, true), 4.0f, 1, 1, 0, 3, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0);
...
int func_3(char* sParam0, int iParam1, Vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16)
{
	...
	if (iVar1 != 0)
	{
		func_16(iVar1, iParam1, sParam0, 4, iParam6, iParam7, vParam2, fParam5, 0, 0, 2, iParam8, iParam9, iParam10, iParam11, iParam12, iParam13, iParam14, 1065353216 /* Float: 1f */, 0, 0, 0, bParam15, iParam16);
		return iVar1;
	}
	return 0;
}
