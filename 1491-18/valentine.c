#pragma region Local_Variables
	...
	int iLocal_834 = 0;
	int iLocal_835 = 0;
	Vector3 vLocal_836 = { 0.0f, 0.0f, 0.0f };
	int iLocal_839 = 0;
...
void __SCRIPT()
{
	...
	iLocal_696 = 23;
	vLocal_836 = { -277.3855f, 805.2767f, 119.1796f /*3*/ };
		...
		if (MISC::GET_GAME_TIMER() > iLocal_851)
		{
			...
			switch (iLocal_850)
			{
				...
				case 1:
					...
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_852));
				...
				case 6:
					if (func_7(func_6(iLocal_852)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_852 /*35*/].f_11 > 0.0f)
							{
...
void func_2()
{
	if (((!func_43(joaat("WS_VALENTINE_SHOOTOUT")) && func_20() == -1) && !STREAMING::IS_IPL_ACTIVE_HASH(1186533019)) && !STREAMING::IS_LOAD_SCENE_ACTIVE())
	{
		func_44(-892659042);
		func_45();
	}
...
bool func_11()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_725, -369.4457f, 786.6935f, 115.9904f, 0.0f, 0.0f, 3.414876f, 13.87923f, 13.7288f, 5.892247f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_725, -367.6902f, 770.4435f, 116.8526f, 0.0f, 0.0f, 4.150415f, 26.09184f, 5.747657f, 4.724637f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_725, -391.6759f, 778.7041f, 116.8526f, 0.0f, 0.0f, 4.150415f, 23.39705f, 25.94251f, 4.724637f);
	iLocal_726 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Valentine - m_volAuctionStables");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_726, -257.2065f, 634.5588f, 114.0751f, 0.0f, 0.0f, 49.48943f, 11.4594f, 25.36694f, 3.427747f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_726, -221.2732f, 673.6355f, 114.0751f, 0.0f, 0.0f, 49.48943f, 11.4594f, 25.36694f, 3.427747f);
	iLocal_723 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-369.4457f, 786.6935f, 115.9904f, 0.0f, 0.0f, 3.414876f, 13.87923f, 13.7288f, 6.241f, "Valentine - m_volHorseShop");
	if (!func_53(15))
	{
		iLocal_724 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-361.3393f, 787.48f, 116.4301f, 0.0f, 0.0f, 3.999999f, 3.741607f, 3.652877f, 5.744031f, "Valentine - m_volHorseShopOutsideDoor");
		func_54(9, iLocal_724);
	}
	VOLUME::_0xB469CFD9E065EB99(iLocal_723, 10067);
	iLocal_783 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-280.6662f, 915.7495f, 133.066f, 0.0f, 0.0f, 0.0f, 23.88504f, 24.41234f, 15.89547f, "Valentine - m_volGuardDogOwner");
	iLocal_730 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-269.754f, 785.441f, 118.489f, 0.0f, 0.0f, 0.0f, 3.185f, 2.036f, 2.693f, "Valentine - newspaper boy");
	iLocal_731 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Valentine - m_volHotel Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_731, -325.0124f, 767.5158f, 119.4827f, 0.0f, 0.0f, -170.2021f, 8.15436f, 18.38504f, 9.051786f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_731, -317.872f, 761.7268f, 118.0002f, 0.0f, 0.0f, 11.41397f, 4.27525f, 4.046098f, 2.733858f);
	iLocal_732 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-326.9005f, 777.8173f, 117.6158f, 0.0f, 0.0f, -171.616f, 8.5f, 3.390837f, 2.634366f, "Valentine - m_volHotelPorch");
	iLocal_733 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-325.7273f, 774.2453f, 117.7346f, 0.0f, 0.0f, -171.616f, 2.732852f, 1.390837f, 2.634366f, "Valentine - m_volHotelPrompt");
	iLocal_734 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-325.6349f, 772.4476f, 117.7346f, 0.0f, 0.0f, -171.616f, 1.740315f, 1.864735f, 2.634366f, "Valentine - m_volHotelOfflimits");
	iLocal_735 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Valentine - m_volHotelMuteAgg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_735, -325.298f, 767.432f, 122.368f, 0.0f, 0.0f, -171.616f, 9.71f, 19.745f, 3.774f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_735, -317.643f, 761.773f, 118.0f, 0.0f, 0.0f, 11.414f, 4.574f, 4.322f, 2.734f);
	iLocal_777 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-306.3821f, 771.3976f, 119.9888f, 0.0f, 0.0f, 10.06205f, 10.22391f, 17.49704f, 4.699401f, "Valentine - m_volBank");
	iLocal_778 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-308.2203f, 776.1706f, 118.8547f, 0.0f, 0.0f, 7.323684f, 1.907036f, 1.483034f, 2.606343f, "Valentine - m_volBankPrompt");
	iLocal_779 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Valentine - m_volBankShopOfflimits Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_779, -302.2217f, 769.743f, 118.8547f, 0.0f, 0.0f, 10.50366f, 2.072344f, 8.025318f, 2.606343f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_779, -309.0788f, 772.8509f, 118.8547f, 0.0f, 0.0f, 8.049957f, 5.213456f, 4.413345f, 3.353561f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_779, -311.414f, 775.411f, 118.8547f, 0.0f, 0.0f, 8.049957f, 1.633f, 1.085f, 3.354f);
	VOLUME::_0xB469CFD9E065EB99(iLocal_777, 10058);
	iLocal_727 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-339.5029f, 767.1139f, 116.61f, 0.0f, 0.0f, -171.616f, 9.604842f, 7.286813f, 4.891439f, "Valentine - m_volButcher");
	iLocal_728 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-341.169f, 767.2f, 116.816f, 0.0f, 0.0f, -171.203f, 1.376f, 2.537f, 2.48f, "Valentine - m_volButcherPrompt");
	iLocal_729 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-338.5402f, 767.6559f, 116.5175f, 0.0f, 0.0f, -171.2032f, 2.147837f, 2.102079f, 2.480459f, "Valentine - m_volButcherOfflimits");
	VOLUME::_0xB469CFD9E065EB99(iLocal_727, 10061);
	iLocal_705 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-306.5829f, 812.947f, 118.7894f, 0.0f, 0.0f, 100.1415f, 6.023165f, 3.919236f, 2.442381f, "Valentine - m_volBarberOwner");
	iLocal_704 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-307.1545f, 812.8f, 118.9254f, 0.0f, 0.0f, 100.923f, 4.783854f, 2.636788f, 1.990557f, "Valentine - m_volBarberPrompt");
	VOLUME::_0xB469CFD9E065EB99(iLocal_705, 10059);
	iLocal_706 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-307.4f, 813.5f, 118.83f, 0.0f, 0.0f, 11.0f, 1.9f, 2.3f, 2.195668f, "Valentine - m_volBarberAvoidance");
	POPULATION::_ADD_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_706, 0, 0, 0, -1, -1, 0);
	iLocal_750 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Valentine - m_volPostOfficeOwner");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_750, -176.659f, 629.779f, 114.438f, 0.0f, 0.0f, -34.98428f, 3.47f, 6.531f, 2.881f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_750, -175.5493f, 627.7673f, 114.545f, 0.0f, 0.0f, -34.84247f, 1.351312f, 3.832321f, 2.880646f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_750, -174.048f, 633.669f, 114.545f, 0.0f, 0.0f, -34.84247f, 1.996f, 2.553f, 2.881f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_750, -179.166f, 626.498f, 114.545f, 0.0f, 0.0f, -34.84247f, 2.314f, 2.553f, 2.881f);
	iLocal_751 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Valentine - m_volPostOfficePrompt Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_751, -178.982f, 626.715f, 114.531f, 0.0f, 0.0f, -34.84247f, 1.767f, 1.396f, 2.881f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_751, -174.439f, 633.098f, 114.4684f, 0.0f, 0.0f, -34.84247f, 1.746f, 1.385f, 2.881f);
	iLocal_752 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Valentine - m_volPostOfficeOfflimits Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_752, -176.4711f, 629.9696f, 114.5366f, 0.0f, 0.0f, -34.98428f, 3.19526f, 6.32671f, 2.880646f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_752, -175.5493f, 627.7673f, 114.545f, 0.0f, 0.0f, -34.84247f, 1.351312f, 3.832321f, 2.880646f);
	VOLUME::_0xB469CFD9E065EB99(iLocal_750, 10068);
	iLocal_707 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-309.497f, 809.019f, 119.378f, 0.0f, 0.0f, 99.715f, 21.384f, 11.9942f, 3.513f, "Valentine - m_volBartenderOwner");
	iLocal_708 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-313.4598f, 806.1182f, 118.3f, 0.0f, 0.0f, 15.4f, 1.391205f, 4.438885f, 2.6f, "Valentine - m_volBartenderBlocking");
	iLocal_709 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-238.893f, 770.575f, 117.168f, 0.0f, 0.0f, 110.026f, 3.985781f, 1.312562f, 1.206507f, "Valentine - m_volKeaBartenderBlocking");
	iLocal_719 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-312.9f, 799.0f, 119.3f, 0.0f, 0.0f, 97.7f, 2.9f, 1.2f, 2.6f, "Valentine - m_volPianoPlayerOwner");
	iLocal_720 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-278.0329f, 807.903f, 119.4f, 0.0f, 0.0f, -79.7f, 11.40093f, 8.344561f, 10.8f, "Valentine - m_volSheriffOwner");
	iLocal_722 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Valentine - m_volSheriffStation Agg");
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_722, iLocal_720);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_722, -272.7689f, 809.2057f, 120.423f, 0.0f, 0.0f, -79.7f, 8.085273f, 4.505096f, 4.33611f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_722, -277.0814f, 800.534f, 119.4f, 0.0f, 0.0f, -79.7f, 3.711809f, 7.095345f, 4.0f);
	iLocal_721 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-277.2282f, 807.1215f, 119.472f, 0.0f, 0.0f, 9.89185f, 5.00473f, 8.940674f, 2.321479f, "Valentine - m_volSheriffStation Agg");
	VOLUME::_0x3EFABB21E14A6BD1(iLocal_721, 5, 1);
	iLocal_740 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-230.464f, 817.354f, 126.643f, 0.0f, 0.0f, -34.207f, 19.604f, 29.858f, 13.22f, "BRL_VALENTINE - m_volChurch");
	iLocal_827 = VEHICLE::ADD_ROAD_NODE_SPEED_ZONE(-290.7f, 728.9f, 118.8f, 100.0f, 2.5f, 2.5f, 0, 6.0f, 10.0f, 25.0f, 7.5f);
	func_55();
	func_56();
	iLocal_780 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-348.1926f, 698.6607f, 117.8f, 0.0f, 0.0f, 14.96148f, 7.556051f, 14.13844f, 5.0f, "Valentine - m_VolMagicLantern");
	iLocal_782 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-436.7751f, 497.4727f, 98.05497f, 0.0f, 0.0f, 0.0f, 150.0f, 150.0f, 120.0f, "Valentine - m_volCastors");
	iLocal_847 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Valentine - m_volBankWindowBlocking Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_847, -305.0354f, 780.8205f, 118.3766f, 0.0f, 0.0f, 9.999997f, 3.0f, 0.5f, 2.5f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_847, -311.0379f, 779.762f, 118.3766f, 0.0f, 0.0f, 9.999997f, 3.0f, 0.5f, 2.5f);
	iLocal_848 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Valentine - m_volDocWindowBlocking Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_848, -281.8028f, 805.8524f, 119.1915f, 0.0f, 0.0f, -78.0f, 1.5f, 0.5f, 4.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_848, -287.733f, 801.902f, 118.901f, 0.0f, 0.0f, -168.0f, 1.5f, 2.34f, 3.0f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_848, -285.112f, 802.48f, 118.901f, 0.0f, 0.0f, -168.0f, 1.5f, 2.135f, 3.0f);
	return true;
}
...
bool func_15(int iParam0)
{
	...
	{
		func_44(joaat("VAL05_RC_SP_MARY_REMOVEDOORBLOCK"));
	}
	return bVar0;
}
...
void func_24()
{
	...
	vVar0.f_2 = -1;
	func_73(3);
	if (!func_43(joaat("WS_VALENTINE_LOCKDOWN_SALOON")))
	{
		func_74(32, &vVar0, 1);
		func_75(&vVar0, 1, 1);
	}
	if (!func_43(joaat("WS_SAINT_DENIS_LOCKDOWN_SALOON_SLUMS_DOORS")))
	{
		func_74(19, &vVar0, 1);
		func_75(&vVar0, 1, 1);
	}
...
void func_26()
{
	func_76(joaat("WS_VALENTINE_SALOON_BED_BLOODY"), 0, 0);
	func_77(0, -308.9729f, 807.0829f, 117.9797f, iLocal_737, 76);
	func_77(1, -241.294f, 770.0f, 118.14f, iLocal_738, 76);
}
...
void func_27(int iParam0)
{
	...
	func_60(joaat("DOOR_VAL_DOC_BACK"), 1, 0.0f, 0, 0, 0, 0, 0);
	func_60(joaat("DOOR_VAL_DOC_BACK_RM"), 1, 0.0f, 0, 0, 0, 0, 0);
	...
	func_78(6, 9, iLocal_717, iParam0, iLocal_699, iLocal_700, 20, 35.0f, 0, 0);
	...
	func_88(9, (1 << 14));
	func_89(9, 1);
	func_79(9, joaat("VAL_03_STABLE_FRONT_LEFT"), -1.0f, 1);
	func_79(9, joaat("VAL_03_STABLE_FRONT_RIGHT"), 1.0f, 1);
	func_79(9, 1876749464, 0, 0);
	func_79(9, 1331491364, 0, 0);
	func_90(&uLocal_753, 12, iLocal_777, iLocal_778, iLocal_779);
	if (func_91())
	{
		func_60(joaat("DOOR_VAL_JAIL_FRONT"), 1, 0, 0, 0, 0, 0, 0);
		func_60(joaat("DOOR_VAL_JAIL_SIDE"), 1, 0, 0, 0, 0, 0, 0);
		func_60(joaat("DOOR_VAL_JAIL_BACK"), 1, 0, 0, 0, 0, 0, 0);
		if (TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(joaat("VALENTINE_POSTBOUNTY1")))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(joaat("VALENTINE_POSTBOUNTY1"), false);
		}
		bLocal_828 = true;
	}
	else
	{
		func_60(joaat("DOOR_VAL_JAIL_FRONT"), 0, 0, 0, 1, 0, 0, 0);
		func_60(joaat("DOOR_VAL_JAIL_BACK"), 0, 0, 0, 1, 0, 0, 0);
		if (!TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(joaat("VALENTINE_POSTBOUNTY1")))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(joaat("VALENTINE_POSTBOUNTY1"), true);
		}
		bLocal_828 = false;
	}
	if (func_92(joaat("DOOR_VAL_JAIL_BACK")))
	{
		if (!func_93(joaat("DOOR_VAL_JAIL_BACK")))
		{
			func_60(joaat("DOOR_VAL_JAIL_BACK"), 1, 0, 0, 0, 0, 0, 0);
		}
	}
...
bool func_38(int iParam0)
{
	...
	if (bVar0)
	{
		if (!func_111(Global_1935630, (1 << 22)))
		{
			if (iLocal_829 >= 3)
			{
				func_112(0);
	...
	switch (iLocal_829)
	{
		...
		case 4:
			...
			break;
		case 5:
			if (((!STREAMING::IS_LOAD_SCENE_ACTIVE() && !func_43(joaat("WS_VALENTINE_SHOOTOUT"))) && !STREAMING::IS_IPL_ACTIVE_HASH(1186533019)) && !func_118(-892659042))
			{
				if (func_119(72) && func_120(72) == 1)
				{
					if (func_43(joaat("WS_VALENTINE_BUTCHER_ACTIVE")))
					{
						func_121(joaat("WS_VALENTINE_BUTCHER_ACTIVE"));
					}
					func_122();
				}
				else
				{
					if (!func_43(joaat("WS_VALENTINE_BUTCHER_ACTIVE")))
					{
						func_123(joaat("WS_VALENTINE_BUTCHER_ACTIVE"));
					}
					func_45();
				}
			}
		...
		case 6:
			...
			break;
		case 7:
			if (!STREAMING::IS_LOAD_SCENE_ACTIVE() && !func_43(joaat("WS_VALENTINE_SHOOTOUT")))
			{
				if (!func_118(1573766063))
				{
					if (func_119(74) && func_120(74) == 1)
					{
						if (func_43(joaat("WS_VALENTINE_GENSTORE_ACTIVE")))
						{
							func_121(joaat("WS_VALENTINE_GENSTORE_ACTIVE"));
						}
					}
					else if (!func_43(joaat("WS_VALENTINE_GENSTORE_ACTIVE")))
					{
						func_123(joaat("WS_VALENTINE_GENSTORE_ACTIVE"));
					}
				}
			}
			if (func_127())
...
void func_39(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0.0f, 0.0f, 0.0f) <= 5.0f || func_111(Global_1935630, (1 << 14))) || func_111(Global_1935630, (1 << 23)))
	{
		return;
	}
...
void func_49()
{
	iLocal_701 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-285.803f, 805.0234f, 119.5f, 0.0f, 0.0f, 9.527998f, 1.792473f, 2.89884f, 2.223762f, "Valentine - m_volDoctorPrompt");
	iLocal_710 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Valentine - m_volDoctorShop Agg");
	iLocal_711 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-286.4778f, 815.4984f, 119.8f, 0.0f, 0.0f, -80.4f, 4.936636f, 10.4535f, 2.819574f, "Valentine - m_volDoctorBackroom");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_710, -286.6589f, 808.6324f, 119.8f, 0.0f, 0.0f, -80.4f, 10.38628f, 7.7f, 2.8f);
	VOLUME::_ADD_BOUNDS_TO_AGGREGATE_VOLUME(iLocal_710, iLocal_711);
	iLocal_713 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Valentine - m_volDoctorShopOff Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_713, -288.5862f, 804.4559f, 119.5f, 0.0f, 0.0f, 9.527998f, 1.8573f, 2.649464f, 2.223762f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_713, -289.418f, 811.402f, 119.5f, 0.0f, 0.0f, 9.528f, 3.349f, 3.978f, 2.224f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_713, -287.157f, 810.98f, 119.5f, 0.0f, 0.0f, 9.528f, 1.762f, 2.396f, 2.224f);
	iLocal_712 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-285.485f, 801.6973f, 119.458f, 0.0f, 0.0f, 10.32594f, 7.936f, 3.558567f, 2.381096f, "Valentine - m_volDoctorPORCH");
...
void func_50()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_714, -323.731f, 801.595f, 118.2f, 0.0f, 0.0f, 99.9f, 10.817f, 8.418f, 4.843f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_714, -323.7844f, 801.5854f, 117.6888f, 0.0f, 0.0f, 99.89999f, 10.968f, 8.698736f, 5.80101f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_714, -323.4476f, 799.6556f, 116.5133f, 0.0f, 0.0f, 99.89999f, 6.387919f, 8.698736f, 12.47566f);
	iLocal_715 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Valentine - m_volGeneralPORCH Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_715, -322.9185f, 794.5805f, 117.8986f, 0.0f, 0.0f, 10.32594f, 9.0f, 3.558567f, 2.381096f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_715, -326.9613f, 807.4636f, 118.0324f, 0.0f, 0.0f, 8.726971f, 2.76311f, 2.301893f, 4.510351f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_715, -329.273f, 799.3444f, 118.0324f, 0.0f, 0.0f, 8.72697f, 3.0f, 14.5f, 4.510351f);
	iLocal_702 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-322.0786f, 803.658f, 117.7309f, 0.0f, 0.0f, 8.710198f, 2.1f, 3.644517f, 1.698559f, "Valentine - m_volGeneralPrompt");
	iLocal_716 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-324.8168f, 803.7786f, 117.7309f, 0.0f, 0.0f, 10.4864f, 2.206109f, 1.908514f, 1.698559f, "Valentine - m_volGeneralCounterOff");
	iLocal_703 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Valentine - m_volGeneralCounterMute");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_703, -327.309f, 801.647f, 120.068f, 0.0f, 0.0f, 10.4864f, 2.206f, 5.596f, 6.414f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_703, -326.547f, 797.528f, 121.542f, 0.0f, 0.0f, 10.4864f, 2.206f, 3.398f, 3.708f);
	VOLUME::_0xB469CFD9E065EB99(iLocal_714, 10065);
}

void func_51()
{
	iLocal_699 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-281.686f, 781.058f, 119.929f, 0.0f, 0.0f, 0.0f, 2.382f, 1.711f, 2.813f, "Valentine - m_volGunsmith - PROMPT");
	iLocal_717 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-279.9107f, 780.475f, 119.8105f, 0.0f, 0.0f, 179.9f, 8.518225f, 7.656958f, 2.7f, "Valentine - m_volGunsmithShop");
	iLocal_718 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-280.124f, 786.2109f, 119.6072f, 0.0f, 0.0f, 0.0f, 7.936f, 3.558567f, 2.381096f, "Valentine - m_volGunsmithPORCH");
	iLocal_700 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Valentine - m_volGunsmithCounterOff Agg");
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_700, -279.9358f, 778.0059f, 119.7747f, 0.0f, 0.0f, 0.0f, 8.469496f, 2.69515f, 2.516554f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_700, -277.336f, 778.941f, 119.775f, 0.0f, 0.0f, 0.0f, 3.326f, 4.079f, 2.517f);
...
void func_52()
{
	...
	{
		iLocal_781 = VOLUME::CREATE_VOLUME_BOX(-325.2049f, 760.376f, 121.764f, 0.0f, 0.0f, 10.24361f, 5.77748f, 4.490859f, 2.289593f);
	}
	func_161(8, -324.5534f, 760.3503f, 120.6335f, 0.0f, iLocal_781);
}
...
void func_55()
{
	...
	iLocal_736 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-309.4941f, 809.1079f, 122.1578f, 0.0f, 0.0f, 10.47275f, 12.236f, 27.58529f, 9.179325f, "Valentine - m_volSaloonSmith");
	iLocal_741 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-307.2447f, 794.5436f, 118.2722f, 0.0f, 0.0f, 12.47275f, 15.63692f, 5.292129f, 4.462742f, "Valentine - volMuster");
	iLocal_742 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-308.3434f, 799.5107f, 120.3475f, 0.0f, 0.0f, 12.47275f, 15.63692f, 25.95621f, 11.77894f, "Valentine - volMusterTrigger");
	iLocal_743 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-278.4223f, 780.4918f, 119.1488f, 0.0f, 0.0f, 179.9f, 10.80282f, 14.18014f, 3.877091f, "Valentine - volGunSmithComp");
	iLocal_744 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-323.3039f, 798.7211f, 117.4371f, 0.0f, 0.0f, -79.44261f, 14.53232f, 9.127385f, 6.699043f, "Valentine - volGeneralStoreComp");
	iLocal_745 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-285.4544f, 803.0476f, 118.7046f, 0.0f, 0.0f, -168.9688f, 8.444459f, 12.54634f, 4.54561f, "Valentine - volDoctorComp");
	iLocal_739 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-242.293f, 770.493f, 119.697f, 0.0f, 0.0f, 109.243f, 11.12521f, 13.01104f, 7.987384f, "Valentine - volSaloonKeanesComp");
	iLocal_746 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-306.1782f, 769.7928f, 118.4643f, 0.0f, 0.0f, 10.06204f, 10.40922f, 21.46974f, 5.961294f, "Valentine - volBankComp");
	iLocal_747 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-177.4061f, 632.5018f, 116.4897f, 0.0f, 0.0f, -35.02556f, 14.93716f, 28.02779f, 4.25f, "Valentine - volPostOfficeComp");
	iLocal_748 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-177.4061f, 632.5018f, 116.4897f, 0.0f, 0.0f, -35.02556f, 14.93716f, 28.02779f, 4.25f, "Valentine - volTrainStationComp");
	iLocal_749 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-325.9436f, 772.7791f, 117.927f, 0.0f, 0.0f, -171.616f, 8.731f, 7.675f, 3.555f, "Valentine - volHotelComp");
	iVar0 = 0;
	func_163(&iVar0, 5);
	func_163(&iVar0, 0);
	func_163(&iVar0, 8);
...
void func_56()
{
	iLocal_737 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-309.3924f, 808.4083f, 119.378f, 0.0f, 0.0f, 99.71499f, 22.62186f, 12.374f, 8.647388f, "volSaloonSmithfieldsInterior");
	iLocal_738 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-241.294f, 770.0f, 118.14f, 0.0f, 0.0f, 110.709f, 9.286f, 8.345f, 5.0f, "volSaloonKeanesInterior");
}
...
void func_57(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, Vector3 vParam5, char* sParam8)
{
	...
	sLocal_14.f_0 = iParam0;
	sLocal_14.f_6 = sParam1;
	sLocal_14.f_7 = sParam2;
	sLocal_14.f_8 = sParam3;
	sLocal_14.f_9 = sParam4;
	sLocal_14.f_11 = { vParam5 /*3*/ };
	sLocal_14.f_10 = sParam8;
	sLocal_14.f_15 = 1;
}
...
void func_58(int iParam0, int iParam1, int iParam2)
{
	...
	func_168(&iVar0);
	iVar1 = 0;
	while (iVar1 <= (sLocal_14.f_5 - 1))
	{
		func_168(&(sLocal_14.f_1[iVar1]));
		if (sLocal_14.f_1[iVar1] == iVar0)
		{
			return;
		}
		iVar1++;
	}
	sLocal_14.f_1[sLocal_14.f_5] = iVar0;
	sLocal_14.f_5++;
	func_169(&(sLocal_14.f_1), sLocal_14.f_5);
}
...
void func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	Global_1394141.f_7[iParam0 /*31*/].f_1 = { func_181(iParam1) /*3*/ };
...
void func_62()
{
	...
	iVar0 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-309.497f, 809.019f, 119.378f, 0.0f, 0.0f, 99.715f, 20.984f, 11.374f, 3.713f, "m_volSaloon");
	iVar1[0] = 1;
	func_185(&sLocal_188, 3, &iVar1, 1, 1);
	sLocal_188[1 /*45*/].f_43 = 36505;
	sLocal_188[1 /*45*/].f_44 = 36984;
	uVar7 = 5;
	func_185(&sLocal_188, 8, &uVar7, 2, 0);
	sLocal_188[2 /*45*/].f_43 = 37173;
	sLocal_188[2 /*45*/].f_44 = 36984;
	func_189(&(sLocal_188[2 /*45*/]), (1 << 9));
	uVar13 = 5;
	func_185(&sLocal_188, 10, &uVar13, 3, 0);
	sLocal_188[3 /*45*/].f_43 = 37718;
	sLocal_188[3 /*45*/].f_44 = 36984;
	func_189(&(sLocal_188[3 /*45*/]), (1 << 9));
	uVar19 = 5;
	func_185(&sLocal_188, 9, &uVar19, 4, 0);
	sLocal_188[4 /*45*/].f_43 = 38130;
	sLocal_188[4 /*45*/].f_44 = 36984;
	func_189(&(sLocal_188[4 /*45*/]), (1 << 9));
	uVar25 = 5;
	func_185(&sLocal_188, 11, &uVar25, 5, 0);
	sLocal_188[5 /*45*/].f_43 = 39172;
	sLocal_188[5 /*45*/].f_44 = 36984;
	func_189(&(sLocal_188[5 /*45*/]), (1 << 9));
	uVar31 = 5;
	func_185(&sLocal_188, 2, &uVar31, 6, 0);
	sLocal_188[6 /*45*/].f_43 = 39673;
	sLocal_188[6 /*45*/].f_44 = 36984;
	func_189(&(sLocal_188[6 /*45*/]), (1 << 9));
	uVar37 = 5;
	func_185(&sLocal_188, 1, &uVar37, 7, 0);
	sLocal_188[7 /*45*/].f_43 = 40402;
	sLocal_188[7 /*45*/].f_44 = 36984;
	sLocal_188[7 /*45*/].f_38 = iVar0;
	func_189(&(sLocal_188[7 /*45*/]), 256);
	func_189(&(sLocal_188[7 /*45*/]), (1 << 9));
	uVar43 = 5;
	func_185(&sLocal_188, 16, &uVar43, 8, 0);
	sLocal_188[8 /*45*/].f_43 = 41242;
	sLocal_188[8 /*45*/].f_44 = 36984;
	func_189(&(sLocal_188[8 /*45*/]), (1 << 9));
	uVar49 = 5;
	func_185(&sLocal_188, 45, &uVar49, 9, 0);
	sLocal_188[9 /*45*/].f_43 = 41436;
	sLocal_188[9 /*45*/].f_44 = 36984;
	func_189(&(sLocal_188[9 /*45*/]), (1 << 9));
	uVar55 = 5;
	func_185(&sLocal_188, 5, &uVar55, 10, 0);
	sLocal_188[10 /*45*/].f_43 = 41541;
	sLocal_188[10 /*45*/].f_44 = 36984;
	func_189(&(sLocal_188[10 /*45*/]), (1 << 9));
}
...
void func_63(int iParam0)
{
	...
	switch (iParam0)
	{
		case 1:
			...
			{
				strcpy_s(&(sVar0.f_10), 32, "town_secrets_sd_trelawny");
			}
			break;
		case 2:
			strcpy_s(&(sVar0.f_10), 32, "town_secrets_er_daughter");
			break;
		case 3:
			strcpy_s(&(sVar0.f_10), 32, "town_secrets_val_moira");
			break;
		default:
			break;
	}
	if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&(sVar0.f_10))) > 0)
	{
		return;
	}
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(sVar0.f_10)))
	{
		sVar0.f_14 = (1 << 10);
		sVar0.f_15 = 1;
		func_199(sVar0, 0);
...
void func_64(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, Vector3 vParam5, float fParam8, int iParam9, int iParam10)
{
	uParam0->f_1 = iParam1;
	uParam0->f_2 = iParam2;
	uParam0->f_3 = { func_200(sParam3) /*8*/ };
...
int func_75(var uParam0, bool bParam1, int iParam2)
{
	...
	bVar1 = func_217(uParam0->f_1, (1 << 17));
	...
	if (bParam1)
	{
		func_220(uParam0->f_1, (1 << 16));
		if ((uParam0->f_1 == 1 || uParam0->f_1 == 2) || uParam0->f_1 == 0)
		{
			func_220(uParam0->f_1, (1 << 21));
		}
	}
	if (bVar1)
	{
		func_220(uParam0->f_1, (1 << 17));
	}
...
void func_76(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case joaat("WS_DOWNS_RANCH_DOWNS"):
			func_123(joaat("WS_DOWNS_RANCH_DOWNS"));
			func_121(joaat("WS_DOWNS_RANCH_EDITH"));
			func_121(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_121(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_DOWNS_RANCH_EDITH"):
			func_121(joaat("WS_DOWNS_RANCH_DOWNS"));
			func_123(joaat("WS_DOWNS_RANCH_EDITH"));
			func_121(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_121(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_DOWNS_RANCH_EMPTY"):
			func_121(joaat("WS_DOWNS_RANCH_DOWNS"));
			func_121(joaat("WS_DOWNS_RANCH_EDITH"));
			func_123(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_121(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_DOWNS_RANCH_REPOPULATED"):
			...
			func_121(joaat("WS_DOWNS_RANCH_EDITH"));
			func_121(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_123(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_PRONGHORN_RANCH_FENCE_FIXED"):
		case joaat("WS_PRONGHORN_RANCH_EXIST"):
		case joaat("WS_PRONGHORN_RANCH_EMPTY"):
			func_121(joaat("WS_PRONGHORN_RANCH_EXIST"));
			func_121(joaat("WS_PRONGHORN_RANCH_EMPTY"));
			func_121(joaat("WS_PRONGHORN_RANCH_FENCE_FIXED"));
			func_123(iParam0);
			break;
		...
		case joaat("WS_GUARMA3_TOWER_NORMAL"):
			func_121(joaat("WS_GUARMA3_TOWER_FRAG"));
			func_121(joaat("WS_GUARMA3_TOWER_DESTROYED"));
			func_123(joaat("WS_GUARMA3_TOWER_NORMAL"));
			break;
		case joaat("WS_GUARMA3_TOWER_FRAG"):
			func_121(joaat("WS_GUARMA3_TOWER_NORMAL"));
			func_121(joaat("WS_GUARMA3_TOWER_DESTROYED"));
			func_123(joaat("WS_GUARMA3_TOWER_FRAG"));
			break;
		case joaat("WS_GUARMA3_TOWER_DESTROYED"):
			func_121(joaat("WS_GUARMA3_TOWER_NORMAL"));
			func_121(joaat("WS_GUARMA3_TOWER_FRAG"));
			func_123(joaat("WS_GUARMA3_TOWER_DESTROYED"));
			break;
		case joaat("WS_RHODES_GRAVE_NORMAL"):
			func_121(joaat("WS_RHODES_GRAVE_FRESHLY_DUG"));
			func_121(joaat("WS_RHODES_GRAVE_OPEN"));
			func_123(joaat("WS_RHODES_GRAVE_NORMAL"));
			break;
		case joaat("WS_RHODES_GRAVE_FRESHLY_DUG"):
			func_121(joaat("WS_RHODES_GRAVE_NORMAL"));
			func_121(joaat("WS_RHODES_GRAVE_OPEN"));
			func_123(joaat("WS_RHODES_GRAVE_FRESHLY_DUG"));
			break;
		case joaat("WS_RHODES_GRAVE_OPEN"):
			func_121(joaat("WS_RHODES_GRAVE_NORMAL"));
			func_121(joaat("WS_RHODES_GRAVE_FRESHLY_DUG"));
			func_123(joaat("WS_RHODES_GRAVE_OPEN"));
			break;
		case joaat("WS_RHODES_SALOON_TABLE_UP"):
			func_121(joaat("WS_RHODES_SALOON_TABLE_DOWN"));
			func_123(joaat("WS_RHODES_SALOON_TABLE_UP"));
			break;
		case joaat("WS_RHODES_SALOON_TABLE_DOWN"):
			func_121(joaat("WS_RHODES_SALOON_TABLE_UP"));
			func_123(joaat("WS_RHODES_SALOON_TABLE_DOWN"));
			break;
		case joaat("WS_UTOPIA_TREE_STANDING"):
			func_121(joaat("WS_UTOPIA_TREE_MISSION"));
			func_121(joaat("WS_UTOPIA_TREE_FALLEN"));
			func_121(joaat("WS_UTOPIA_TREE_STUMP"));
			func_123(joaat("WS_UTOPIA_TREE_STANDING"));
			break;
		case joaat("WS_UTOPIA_TREE_MISSION"):
			func_121(joaat("WS_UTOPIA_TREE_STANDING"));
			func_121(joaat("WS_UTOPIA_TREE_FALLEN"));
			func_121(joaat("WS_UTOPIA_TREE_STUMP"));
			func_123(joaat("WS_UTOPIA_TREE_MISSION"));
			break;
		case joaat("WS_UTOPIA_TREE_FALLEN"):
			func_121(joaat("WS_UTOPIA_TREE_STANDING"));
			func_121(joaat("WS_UTOPIA_TREE_MISSION"));
			func_121(joaat("WS_UTOPIA_TREE_STUMP"));
			func_123(joaat("WS_UTOPIA_TREE_FALLEN"));
			break;
		case joaat("WS_UTOPIA_TREE_STUMP"):
			func_121(joaat("WS_UTOPIA_TREE_STANDING"));
			func_121(joaat("WS_UTOPIA_TREE_MISSION"));
			func_121(joaat("WS_UTOPIA_TREE_FALLEN"));
			func_123(joaat("WS_UTOPIA_TREE_STUMP"));
			break;
		case joaat("WS_MICAH_CAMP_EMPTY"):
			func_121(joaat("WS_MICAH_CAMP"));
			func_121(joaat("WS_MICAH_CAMP_POST"));
			func_123(joaat("WS_MICAH_CAMP_EMPTY"));
			break;
		case joaat("WS_MICAH_CAMP"):
			func_121(joaat("WS_MICAH_CAMP_EMPTY"));
			func_121(joaat("WS_MICAH_CAMP_POST"));
			func_123(joaat("WS_MICAH_CAMP"));
			break;
		case joaat("WS_MICAH_CAMP_POST"):
			func_121(joaat("WS_MICAH_CAMP_EMPTY"));
			func_121(joaat("WS_MICAH_CAMP"));
			func_123(joaat("WS_MICAH_CAMP_POST"));
			break;
		case joaat("WS_NBX_ART_EXHIBIT_OPEN"):
			if (bParam1)
			{
				func_121(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
				func_123(joaat("WS_NBX_ART_EXHIBIT_OPEN"));
			}
			else
			{
				func_121(joaat("WS_NBX_ART_EXHIBIT_OPEN"));
				func_121(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
			}
			break;
		case joaat("WS_NBX_ART_EXHIBIT_CANCELLED"):
			if (func_43(joaat("WS_NBX_ART_EXHIBIT_OPEN")))
			{
				if (bParam1)
				{
					func_123(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
				}
				else
				{
					func_121(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
		...
		case joaat("WS_HERE_KITTY_3_CLUE_TRAIL_OFF"):
			func_121(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_ON"));
			func_123(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_OFF"));
			break;
		case joaat("WS_HERE_KITTY_3_CLUE_TRAIL_ON"):
			func_121(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_OFF"));
			func_123(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_ON"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_GONE"):
			func_121(joaat("WS_HERE_KITTY_WAGONS_TRASHED"));
			func_121(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_121(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_121(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_123(joaat("WS_HERE_KITTY_WAGONS_GONE"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_TRASHED"):
			func_121(joaat("WS_HERE_KITTY_WAGONS_GONE"));
			func_121(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_121(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_121(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_123(joaat("WS_HERE_KITTY_WAGONS_TRASHED"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"):
			...
			func_121(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_121(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_123(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"):
			...
			func_121(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_121(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_123(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"):
			...
			func_121(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_121(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_123(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			break;
		case joaat("WS_NEW_COM_BANK_BEFORE"):
			func_121(joaat("WS_NEW_COM_BANK_START"));
			func_121(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_121(joaat("WS_NEW_COM_BANK_AFTER"));
			func_121(joaat("WS_NEW_COM_BANK_POST"));
			func_123(joaat("WS_NEW_COM_BANK_BEFORE"));
			break;
		case joaat("WS_NEW_COM_BANK_START"):
			func_121(joaat("WS_NEW_COM_BANK_BEFORE"));
			func_121(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_121(joaat("WS_NEW_COM_BANK_AFTER"));
			func_121(joaat("WS_NEW_COM_BANK_POST"));
			func_123(joaat("WS_NEW_COM_BANK_START"));
			break;
		case joaat("WS_NEW_COM_BANK_SHOOTOUT"):
			...
			func_121(joaat("WS_NEW_COM_BANK_AFTER"));
			func_121(joaat("WS_NEW_COM_BANK_POST"));
			func_123(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			break;
		case joaat("WS_NEW_COM_BANK_AFTER"):
			...
			func_121(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_121(joaat("WS_NEW_COM_BANK_POST"));
			func_123(joaat("WS_NEW_COM_BANK_AFTER"));
			break;
		case joaat("WS_NEW_COM_BANK_POST"):
			...
			func_121(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_121(joaat("WS_NEW_COM_BANK_AFTER"));
			func_123(joaat("WS_NEW_COM_BANK_POST"));
			break;
		case joaat("WS_NO_ANIMALS_GRIZZLIES"):
			func_121(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			func_121(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			func_121(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			func_123(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			break;
		case joaat("WS_LIGHT_ANIMALS_GRIZZLIES"):
			func_121(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			func_121(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			func_121(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			func_123(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			break;
		case joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"):
			func_121(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			func_121(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			func_121(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			func_123(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			break;
		case joaat("WS_NORMAL_ANIMALS_GRIZZLIES"):
			func_121(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			func_121(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			func_121(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			func_123(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			break;
		case joaat("WS_STRAWBERRY_HOUSE_STAGE_0"):
			func_123(joaat("WS_STRAWBERRY_HOUSE_STAGE_0"));
			func_121(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_121(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_121(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			break;
		case joaat("WS_STRAWBERRY_HOUSE_STAGE_1"):
			func_121(joaat("WS_STRAWBERRY_HOUSE_STAGE_0"));
			func_123(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_121(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_121(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			break;
		case joaat("WS_STRAWBERRY_HOUSE_STAGE_2"):
			func_121(joaat("WS_STRAWBERRY_HOUSE_STAGE_0"));
			func_121(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_123(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_121(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			break;
		case joaat("WS_STRAWBERRY_HOUSE_STAGE_3"):
			...
			func_121(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_121(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_123(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			break;
		case joaat("WS_CALIGA_HALL_TABACCO_START"):
			func_123(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_121(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_121(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			func_121(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			break;
		case joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"):
			func_123(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_121(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_121(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			func_121(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			break;
		case joaat("WS_CALIGA_HALL_TABACCO_BURNING"):
			func_123(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			func_121(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_121(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_121(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			break;
		case joaat("WS_CALIGA_HALL_TABACCO_BURNT"):
			func_123(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			func_121(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_121(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_121(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			break;
		case joaat("WS_VALENTINE_BURIAL_DRUNK"):
			func_123(joaat("WS_VALENTINE_BURIAL_DRUNK"));
			func_121(joaat("WS_VALENTINE_BURIAL_POST_DRUNK"));
			break;
		case joaat("WS_VALENTINE_BURIAL_POST_DRUNK"):
			func_123(joaat("WS_VALENTINE_BURIAL_POST_DRUNK"));
			func_121(joaat("WS_VALENTINE_BURIAL_DRUNK"));
			break;
		case joaat("WS_VALENTINE_BURIAL_MURDER"):
			func_123(joaat("WS_VALENTINE_BURIAL_MURDER"));
			func_121(joaat("WS_VALENTINE_BURIAL_POST_MURDER"));
			break;
		case joaat("WS_VALENTINE_BURIAL_POST_MURDER"):
			func_123(joaat("WS_VALENTINE_BURIAL_POST_MURDER"));
			func_121(joaat("WS_VALENTINE_BURIAL_MURDER"));
			break;
		case 0:
			func_123(0);
			func_121(joaat("WS_BRAITHWAITE_MANSION_BURNED"));
			func_121(joaat("WS_BRAITHWAITE_MANSION_ENDLESS_SUMMER"));
			break;
		case joaat("WS_BRAITHWAITE_MANSION_BURNED"):
			func_123(joaat("WS_BRAITHWAITE_MANSION_BURNED"));
			func_121(0);
			func_121(joaat("WS_BRAITHWAITE_MANSION_ENDLESS_SUMMER"));
			break;
		case joaat("WS_BRAITHWAITE_MANSION_ENDLESS_SUMMER"):
			func_123(joaat("WS_BRAITHWAITE_MANSION_ENDLESS_SUMMER"));
			func_121(0);
			func_121(joaat("WS_BRAITHWAITE_MANSION_BURNED"));
			break;
		case joaat("WS_GRAVE_ARTHUR_GOOD"):
			func_123(joaat("WS_GRAVE_ARTHUR_GOOD"));
			func_121(joaat("WS_GRAVE_ARTHUR_BAD"));
			break;
		case joaat("WS_GRAVE_ARTHUR_BAD"):
			func_123(joaat("WS_GRAVE_ARTHUR_BAD"));
			func_121(joaat("WS_GRAVE_ARTHUR_GOOD"));
			break;
		case joaat("WS_OLDFORTWALLACE_WALL_INTACT"):
			func_123(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			func_121(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_121(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_121(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			break;
		case joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"):
			func_123(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_121(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			func_121(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_121(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			break;
		case joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"):
			func_123(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_121(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_121(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			func_121(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			break;
		case joaat("WS_OLDFORTWALLACE_WALL_BROKEN"):
			func_123(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			func_121(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_121(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_121(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			break;
		case joaat("WS_SHADY_BELLE_HIDEOUT"):
			if (bParam1)
			{
				func_123(joaat("WS_SHADY_BELLE_HIDEOUT"));
			}
			else
			{
				func_121(joaat("WS_SHADY_BELLE_HIDEOUT"));
			}
			func_121(joaat("WS_SHADY_BELLE_GANG_0_2"));
			func_121(joaat("WS_SHADY_BELLE_ABANDON"));
			break;
		case joaat("WS_SHADY_BELLE_ABANDON"):
			func_123(joaat("WS_SHADY_BELLE_ABANDON"));
			func_121(joaat("WS_SHADY_BELLE_GANG_0_2"));
			func_121(joaat("WS_SHADY_BELLE_HIDEOUT"));
			break;
		case joaat("WS_SHADY_BELLE_GANG_0_2"):
			func_123(joaat("WS_SHADY_BELLE_GANG_0_2"));
			func_121(joaat("WS_SHADY_BELLE_HIDEOUT"));
			func_121(joaat("WS_SHADY_BELLE_ABANDON"));
			break;
		case joaat("WS_BLACKWATER_PHOTOGRAPHER_FURNITURE"):
			if (bParam1)
			{
				func_123(joaat("WS_BLACKWATER_PHOTOGRAPHER_FURNITURE"));
			}
			else
			{
				func_121(joaat("WS_BLACKWATER_PHOTOGRAPHER_FURNITURE"));
			}
			break;
		case joaat("WS_SAINT_DENIS_PHOTOGRAPHER_FURNITURE"):
			if (bParam1)
			{
				func_123(joaat("WS_SAINT_DENIS_PHOTOGRAPHER_FURNITURE"));
			}
			else
			{
				func_121(joaat("WS_SAINT_DENIS_PHOTOGRAPHER_FURNITURE"));
			}
			break;
		default:
			if (bParam1)
...
void func_78(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	vVar1 = { func_231(iVar0) /*3*/ };
	vVar4 = { func_232(iVar0) /*3*/ };
	if (func_164(vVar1))
	{
		return;
	}
...
void func_103()
{
	if (func_265(-367.15f, 788.29f, 116.0f, 1) < 300.0f)
	{
		func_266();
		bLocal_845 = true;
	}
...
void func_104()
{
	...
	{
		if (((!bLocal_826 && !func_269(iVar0, 0)) && AUDIO::_0xBE28DB99556FF8D9(iVar1) != 0) && PED::IS_PED_USING_SCENARIO_HASH(iVar1, joaat("PROP_HUMAN_PIANO")))
		{
		...
		else if (bLocal_826 && !PED::IS_PED_USING_SCENARIO_HASH(iVar1, joaat("PROP_HUMAN_PIANO")))
		{
			bLocal_826 = false;
		}
	}
...
void func_105()
{
	...
	if (sLocal_14.f_26 > MISC::GET_GAME_TIMER())
	{
		return;
	}
	if ((!ENTITY::DOES_ENTITY_EXIST(sLocal_14.f_17) && sLocal_14.f_14 > 1) && sLocal_14.f_0 != 0)
	{
		if (func_270() && func_271(Global_36, sLocal_14.f_11) < 100.0f)
		{
			if (sLocal_14.f_18 == 0)
			{
				sLocal_14.f_18 = ENTITY::PIN_CLOSEST_MAP_ENTITY(sLocal_14.f_0, sLocal_14.f_11, 11);
			}
			else if (ENTITY::IS_MAP_ENTITY_PINNED(sLocal_14.f_18))
			{
				sLocal_14.f_17 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(ENTITY::_GET_PINNED_MAP_ENTITY(sLocal_14.f_18));
			}
		}
		sLocal_14.f_26 = MISC::GET_GAME_TIMER() + 1800;
	}
	switch (sLocal_14.f_14)
	{
		case 0:
			func_272();
			sLocal_14.f_14 = 1;
		...
		case 2:
			if (func_274())
			{
				...
				sLocal_14.f_24 = 0;
				sLocal_14.f_21 = 0;
				sLocal_14.f_22 = func_276(func_275());
				if (sLocal_14.f_22 > 12)
				{
					sLocal_14.f_22 = (sLocal_14.f_22 % 12);
				}
			}
			break;
		case 3:
			...
			{
				if (ENTITY::DOES_ENTITY_HAVE_DRAWABLE(sLocal_14.f_17))
				{
					sLocal_14.f_25 = 0;
					ENTITY::PLAY_ENTITY_ANIM(sLocal_14.f_17, sLocal_14.f_7, sLocal_14.f_6, 1000.0f, false, true, false, 0.0f, 0);
					sLocal_14.f_14 = 4;
				}
			}
			if (sLocal_14.f_21 >= sLocal_14.f_22)
			{
				sLocal_14.f_14 = 2;
			}
			break;
		case 4:
			if (func_277(sLocal_14.f_17, sLocal_14.f_6, sLocal_14.f_7, 0))
			{
				ENTITY::PLAY_ENTITY_ANIM(sLocal_14.f_17, sLocal_14.f_8, sLocal_14.f_6, 1000.0f, true, true, false, 0.0f, 0);
				sLocal_14.f_23 = MISC::GET_GAME_TIMER() + 1800;
				sLocal_14.f_14 = 5;
			}
			break;
		case 5:
			if (sLocal_14.f_24 < MISC::GET_GAME_TIMER())
			{
				sLocal_14.f_21++;
				sLocal_14.f_24 = MISC::GET_GAME_TIMER() + 1800;
			}
			if (sLocal_14.f_21 >= sLocal_14.f_22 && func_277(sLocal_14.f_17, sLocal_14.f_6, sLocal_14.f_8, 0.02f))
			{
				ENTITY::PLAY_ENTITY_ANIM(sLocal_14.f_17, sLocal_14.f_9, sLocal_14.f_6, 8.0f, false, false, false, 0.0f, 0);
				sLocal_14.f_14 = 2;
			}
			break;
	}
	if (sLocal_14.f_25 && sLocal_14.f_14 > 2)
	{
		if (AUDIO::_HAS_SOUND_AUDIO_NAME_FINISHED(sLocal_14.f_10, "CHURCH_BELL_SOUNDS") && sLocal_14.f_24 < MISC::GET_GAME_TIMER())
		{
			sLocal_14.f_24 = MISC::GET_GAME_TIMER() + 1800;
			AUDIO::_PLAY_SOUND_FROM_POSITION(sLocal_14.f_10, sLocal_14.f_11, "CHURCH_BELL_SOUNDS", false, 0, true, 0);
			sLocal_14.f_21++;
		}
	}
}
...
bool func_108(int iParam0, int iParam1)
{
	...
	return func_285(Global_1914319.f_3[iParam0 /*446*/].f_10, (1 << 10));
}
...
void func_113()
{
	if (func_287(func_10(76), joaat("TSTAG_LOCKDOWN_SALOON"), 1))
	{
		...
		if (PED::GET_PED_CONFIG_FLAG(iLocal_825, 130 /*PCF_DisableTalkTo*/, false))
		{
			PED::SET_PED_CONFIG_FLAG(iLocal_825, 130 /*PCF_DisableTalkTo*/, false);
			PED::SET_PED_CONFIG_FLAG(iLocal_825, 315 /*PCF_0xD38AEF95*/, false);
			PLAYER::_MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::PLAYER_ID(), iLocal_825, 3, 1, false);
			PLAYER::_MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::PLAYER_ID(), iLocal_825, 4, 1, true);
			PLAYER::_MODIFY_PLAYER_UI_PROMPT_FOR_PED(PLAYER::PLAYER_ID(), iLocal_825, 7, 1, true);
		}
	}
}
	...
	if (((!func_293(Global_1392194[1 /*10*/].f_1, 1) && !func_294(16)) && !func_294(2)) && !func_294(1))
	{
		if (!VOLUME::DOES_VOLUME_EXIST(Global_1898092.f_26.f_5))
		{
			if (func_295(Global_35, iLocal_782, 1, 0))
			{
				...
				vVar0 = { VOLUME::GET_VOLUME_SCALE(iLocal_782) /*3*/ };
				vVar0 = { vVar0 + Vector(15.0f, 15.0f, 15.0f) /*3*/ };
				Global_1898092.f_26.f_5 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(VOLUME::GET_VOLUME_COORDS(iLocal_782), VOLUME::GET_VOLUME_ROTATION(iLocal_782), vVar0, "Event Area - volShutdown");
				func_296(16);
			}
		}
	}
...
void func_116(int iParam0)
{
	...
	while (iVar0 < Global_40.f_9829)
	{
		if (Global_40.f_9829[iVar0 /*4*/] == iParam0)
		{
			...
			{
				func_301(iVar0, 2);
				if (BUILTIN::VDIST(func_302(iVar2), Global_36) < 45.0f)
				{
...
{
	if (func_285(iParam0, (1 << 15)) || func_285(iParam0, (1 << 14)))
	{
		return true;
	}
	return false;
...
bool func_127()
{
	...
	if (!func_315(&uLocal_830) || func_316(&uLocal_830, 3.0f))
	{
		func_317(&uLocal_830);
		return true;
	}
...
void func_130(var uParam0)
{
	...
	switch (*uParam0)
	{
		...
		case 7:
			...
			{
				PERSCHAR::_SET_PERSCHAR_SCHEDULE(func_323(uParam0->f_1), &(uParam0->f_3));
			}
			if (ENTITY::DOES_ENTITY_EXIST(PERSCHAR::_GET_PERSCHAR_PED_INDEX(PERSCHAR::_0x112DDF56300BC6E5(func_323(uParam0->f_1)))))
			{
				*uParam0 = 6;
			}
			else
...
void func_131()
{
	...
	if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("LAW_ARREST")) > 0 || !func_91())
	{
		if (func_332(joaat("DOOR_VAL_JAIL_FRONT")))
		{
			func_60(joaat("DOOR_VAL_JAIL_FRONT"), 0, 0, 0, 1, 0, 0, 0);
			if (!TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(joaat("VALENTINE_POSTBOUNTY1")))
			{
	...
	else if (func_333(joaat("DOOR_VAL_JAIL_FRONT")))
	{
		if (func_334(0, 0, 1))
		{
			return;
...
void func_132()
{
	if (BUILTIN::VDIST2(Global_36, vLocal_836) > 100.0f)
	{
		return;
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_834))
	{
		...
		{
			iLocal_834 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(ENTITY::_GET_PINNED_MAP_ENTITY(iLocal_835));
		}
	}
	else
	{
		func_337(&uLocal_833, &iLocal_834, vLocal_836, iLocal_839, joaat("DOCUMENT_LEDGER_VALENTINE_JAIL") /* GXTEntry: "Jail Ledger" */);
		TASK::_0xA6A76D666A281F2D(iLocal_834, joaat("DOCUMENT_LEDGER_VALENTINE_JAIL") /* GXTEntry: "Jail Ledger" */);
	}
}
...
void func_133(var uParam0)
{
	...
	if (uParam0->f_17 > 0)
	{
		...
		{
			if (func_338(uParam0, (1 << 16), 0, 1))
			{
				func_339(uParam0, 1);
				uParam0->f_17 = 3;
			}
		}
		if (func_340(Global_35, 1, 0, 0) != joaat("WEAPON_UNARMED") && func_338(uParam0, (1 << 12), 0, 1))
		{
			func_339(uParam0, 1);
			uParam0->f_17 = 3;
		}
		if (func_341(Global_35, uParam0->f_5) && func_338(uParam0, (1 << 11), 0, 1))
		{
			func_339(uParam0, 1);
			uParam0->f_17 = 3;
		}
	...
	switch (uParam0->f_17)
	{
		...
		case 3:
			...
			{
				if (!func_347(Global_35, joaat("SCRIPT_TASK_COWER")))
				{
					TASK::TASK_COWER(uParam0->f_4, -1, Global_35, 0);
				}
				if (func_338(uParam0, (1 << 20), 0, 1))
				{
				}
				uParam0->f_17 = 4;
			}
			...
			{
				bVar3 = false;
				if (func_338(uParam0, (1 << 13), 0, 0))
				{
					bVar3 = true;
				}
				else if (func_338(uParam0, (1 << 14), 0, 0))
				{
					bVar3 = true;
				}
				else if (func_338(uParam0, (1 << 15), 0, 0))
				{
					bVar3 = true;
				}
				if (bVar3)
				{
					func_348(uParam0, (1 << 16));
					func_348(uParam0, 256);
					func_348(uParam0, (1 << 12));
					func_339(uParam0, 0);
					uParam0->f_17 = 0;
				}
			}
...
bool func_136()
{
	return func_111(Global_1935630, (1 << 12));
}
...
void func_141(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_100(iParam0) && func_160(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
...
{
	func_97(0.775f, 0.2f, 0.025f, 0.0f);
...
void func_185(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	func_189(uParam0[iParam3 /*45*/], (1 << 15));
	func_189(uParam0[iParam3 /*45*/], (1 << 10));
		...
		if (!func_400(uParam0, 16))
		{
			if (func_408(uParam0))
			{
				if (func_405(76, iVar1, 256, 0))
				{
					...
					{
						if (func_405(76, iVar1, (1 << 9), 0))
						{
							if ((func_409() == 1 && func_258(5)) && !func_410(2))
							{
								func_189(uParam0, 16);
								uParam0->f_21 = -1;
								func_110(76, iVar1, (1 << 9));
...
Vector3 func_191(var uParam0)
{
	...
	if (func_407())
	{
		...
		if (func_404(74, 1, 0) && func_405(76, iVar1, (1 << 9), 1))
		{
			return func_401("VALRG_GUN_SRGEN");
		}
		if (func_404(73, 1, 0) && func_405(76, iVar1, (1 << 11), 1))
		{
			return func_401("VALRG_GUN_SRDOC");
		}
	}
	if (func_411(Global_35, joaat("TS_VAL_INSPECT_PLACED_ARTIFACT")))
	{
		if (func_407())
		{
			if (func_405(76, iVar1, (1 << 12), 1))
			{
				uParam0->f_21 = -1;
				return func_401("TSVAL_GUNS_1A");
			}
			else if (func_405(76, iVar1, (1 << 13), 1))
			{
				uParam0->f_21 = -1;
				return func_401("TSVAL_GUNS_2A");
			}
			else if (func_405(76, iVar1, (1 << 14), 1))
			{
				uParam0->f_21 = -1;
				return func_401("TSVAL_GUNS_2A");
			}
		}
		else if (func_405(76, iVar1, (1 << 15), 1))
		{
			uParam0->f_21 = -1;
			return func_401("TSVAL_GUNS_1J");
		}
		else if (func_405(76, iVar1, (1 << 16), 1))
		{
			uParam0->f_21 = -1;
			return func_401("TSVAL_GUNS_2J");
		}
		else if (func_405(76, iVar1, (1 << 17), 1))
		{
			uParam0->f_21 = -1;
			return func_401("TSVAL_GUNS_2J");
		}
...
Vector3 func_192(var uParam0)
{
	...
	if (!func_400(uParam0, 4))
	{
		if (func_404(73, 0, 1) && func_405(76, iVar1, (1 << 11), 1))
		{
			func_189(uParam0, 4);
			if (func_405(76, iVar1, (1 << 9), 1))
			{
				if (func_407())
				{
...
Vector3 func_194(var uParam0)
{
	...
	if (func_405(76, iVar1, (1 << 12), 0) && func_414(108, (1 << 21)) > 1)
	{
		if (func_400(uParam0, (1 << 13)))
		{
			switch (uParam0->f_23)
	...
	if (func_407())
	{
		if ((func_405(76, iVar1, 2, 0) && func_409() == 1) && func_258(5))
		{
			if (!func_400(uParam0, 4))
			{
				if (func_410(2) && func_405(76, iVar1, (1 << 13), 1))
				{
					func_189(uParam0, 4);
					uParam0->f_21 = -1;
...
Vector3 func_196(var uParam0)
{
	...
	strcpy_s(&cVar1, 24, func_421(uParam0, "VALRG_LIVSICK_1", "VALRG_LIVSICK_2", "VALRG_LIVSICK_3"));
...
void func_199(struct<16> /*128*/ sParam0, int iParam16)
{
	...
	{
		if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&(sParam0.f_10))) > 0 || func_260(&(sParam0.f_10)))
		{
			return;
		}
	}
...
int func_206(int iParam0, bool bParam1)
{
	...
	if (func_385(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			if (func_385(iParam0, (1 << 11)))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_96(iParam0));
				func_431(iParam0, (1 << 11));
			}
...
void func_226()
{
	func_121(joaat("WS_COLTER_STAGE_WINTER1_INTRO"));
	func_121(joaat("WS_COLTER_STAGE_CABIN_BURNING"));
	func_121(joaat("WS_COLTER_STAGE_HIGH_SNOW"));
	func_121(joaat("WS_COLTER_STAGE_MEDIUM_SNOW"));
	func_121(joaat("WS_COLTER_STAGE_THAWED_SNOW"));
	func_121(joaat("WS_COLTER_STAGE_MUDTOWN1"));
	func_121(joaat("WS_COLTER_STAGE_MP"));
}

void func_227()
{
	func_121(joaat("WS_BEECHERS_SHACK"));
	func_121(joaat("WS_BEECHERS_SHACK_WITH_FIRE"));
	func_121(joaat("WS_BEECHERS_CAMP_WITH_SHACK"));
	func_121(joaat("WS_BEECHERS_CAMP_WITH_RUBBLE"));
	func_121(joaat("WS_BEECHERS_CAMP_WITH_SUPPLIES"));
	func_121(joaat("WS_BEECHERS_HOUSE_FINISHED"));
	func_121(joaat("WS_BEECHERS_BARN_FINISHED"));
	func_121(joaat("WS_BEECHERS_HOUSE_DECORATED"));
	func_121(joaat("WS_BEECHERS_HOUSE_ABIGAIL3"));
	func_121(joaat("WS_BEECHERS_HOUSE_FULLY_DECORATED"));
}
...
void func_228(int iParam0)
{
	...
	func_442(iParam0, (1 << 13));
	func_442(iParam0, (1 << 14));
	func_442(iParam0, (1 << 15));
	func_442(iParam0, (1 << 17));
	func_442(iParam0, (1 << 24));
	func_442(iParam0, (1 << 19));
	func_442(iParam0, (1 << 20));
...
bool func_239(int iParam0, int iParam1)
{
	...
	if (func_233(iParam0, (1 << 14)) && !func_452(iParam0, 1))
	{
		return true;
	}
	if (!func_183(iParam1))
...
void func_252(int iParam0, bool bParam1)
{
	...
	if ((bParam1 && func_454(iParam0, (1 << 9))) || (!bParam1 && !func_454(iParam0, (1 << 9))))
	{
		return;
	}
	if (bParam1)
	{
		func_245(iParam0, (1 << 9));
	}
	else
	{
		func_244(iParam0, (1 << 9));
	}
	if (func_455(iParam0))
	{
...
void func_272()
{
	if (sLocal_14.f_0 != 0)
	{
		STREAMING::REQUEST_ANIM_DICT(sLocal_14.f_6);
		STREAMING::REQUEST_MODEL(sLocal_14.f_0, false);
		sLocal_14.f_16 = 1;
	}
}
...
bool func_273()
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_14.f_6))
	{
		return STREAMING::HAS_ANIM_DICT_LOADED(sLocal_14.f_6);
	}
	return true;
}
...
bool func_274()
{
	...
	iVar0 = 0;
	while (iVar0 <= (sLocal_14.f_5 - 1))
	{
		iVar4 = func_276(sLocal_14.f_1[iVar0]);
		iVar5 = func_360(sLocal_14.f_1[iVar0]);
	...
	if (func_463(&bLocal_684))
	{
		...
		switch (Global_1935183.f_29)
		{
			case 1:
				...
				{
					case 0:
						vVar3 = { func_401("GRIZZ_BARTEN_A") /*3*/ };
						iVar6 = 2;
						break;
					case 1:
						vVar3 = { func_401("GRIZZ_BARTEN_B") /*3*/ };
						iVar6 = 4;
						break;
					case 2:
						vVar3 = { func_401("GRIZZ_BARTEN_C") /*3*/ };
						iVar6 = 8;
						break;
					case 3:
						vVar3 = { func_401("GRIZZ_BARTEN_D") /*3*/ };
						iVar6 = 16;
						break;
					case 4:
						vVar3 = { func_401("GRIZZ_BARTEN_E") /*3*/ };
						iVar6 = 32;
						break;
					case 5:
						vVar3 = { func_401("GRIZZ_BARTEN_F") /*3*/ };
						iVar6 = 64;
						break;
					case 6:
						vVar3 = { func_401("GRIZZ_BARTEN_G") /*3*/ };
						iVar6 = 128;
						break;
					case 7:
						vVar3 = { func_401("GRIZZ_BARTEN_H") /*3*/ };
						iVar6 = 256;
						break;
					case 8:
						vVar3 = { func_401("GRIZZ_BARTEN_I") /*3*/ };
						iVar6 = (1 << 9);
						break;
					case 9:
						vVar3 = { func_401("GRIZZ_BARTEN_J") /*3*/ };
						iVar6 = (1 << 11);
						break;
					case 10:
						vVar3 = { func_401("GRIZZ_BARTEN_K") /*3*/ };
						iVar6 = (1 << 12);
						break;
				}
			...
			case 0:
				...
				{
					case 0:
						vVar3 = { func_401("BARB_BAR7A") /*3*/ };
						iVar6 = 2;
						break;
					case 1:
						vVar3 = { func_401("BARB_BAR7B") /*3*/ };
						iVar6 = 4;
						break;
					case 2:
						vVar3 = { func_401("BARB_BAR7C") /*3*/ };
						iVar6 = 8;
						break;
					case 3:
						vVar3 = { func_401("BARB_BAR7D") /*3*/ };
						iVar6 = 16;
						break;
					case 4:
						vVar3 = { func_401("BARB_BAR7E") /*3*/ };
						iVar6 = 32;
						break;
					case 5:
						vVar3 = { func_401("BARB_BAR7F") /*3*/ };
						iVar6 = 64;
						break;
					case 6:
						vVar3 = { func_401("BARB_BAR7G") /*3*/ };
						iVar6 = 128;
						break;
					case 7:
						vVar3 = { func_401("BARB_BAR7H") /*3*/ };
						iVar6 = 256;
						break;
					case 8:
						vVar3 = { func_401("BARB_BAR7I") /*3*/ };
						iVar6 = (1 << 9);
						break;
					case 9:
						vVar3 = { func_401("BARB_BAR7J") /*3*/ };
						iVar6 = (1 << 11);
						break;
					case 10:
						vVar3 = { func_401("BARB_BAR7K") /*3*/ };
						iVar6 = (1 << 12);
						break;
					case 11:
						vVar3 = { func_401("BARB_BAR7L") /*3*/ };
						iVar6 = (1 << 13);
						break;
				}
			...
			case 2:
				...
				sVar2 = "VAL_Bartender";
				vVar3 = { func_401("VALRG_FBAR_APOL") /*3*/ };
				bVar0 = true;
				break;
			case 4:
					...
					else
					{
						...
						else
						{
							...
							if (!func_474(uParam0->f_1))
							{
								...
								else if (func_479(&(uParam0->f_12)) > 15.0f)
								{
									func_478(&(uParam0->f_12));
									uParam0->f_8 = 256;
								}
							...
							else
							{
								...
								else if (func_479(&(uParam0->f_12)) > 3.0f)
								{
									uParam0->f_8 = 128;
								}
								...
								if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1))
								{
									...
									if (!func_464(1))
									{
										iVar1 = TASK::FIND_SCENARIO_OF_TYPE_HASH(func_481(), joaat("WORLD_HUMAN_LEAN_BACK_WALL_SMOKING_BAR_CA"), 3.0f, 1, false);
										TASK::OPEN_SEQUENCE_TASK(&iVar0);
...
bool func_281(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (uParam0->f_30 == 1)
	{
		if (!func_400(uParam0, (1 << 16)) && func_486(Global_35, iVar0, 1) > 25.0f)
		{
			func_480(1, 1, 0);
		}
	...
	else
	{
		...
		if (func_486(Global_35, iVar0, 1) < 49.0f)
		{
...
void func_290(int iParam0)
{
	...
	{
		if (func_462(Global_35, Global_1914319.f_3[3 /*446*/].f_11, 1) > 80.0f)
		{
			return;
		}
	}
	...
	{
		if (func_462(Global_35, Global_1914319.f_3[0 /*446*/].f_11, 1) > 100.0f)
		{
			return;
		}
	}
...
void func_292()
{
	...
	if (!func_504(joaat("WEAPON_SNIPERRIFLE_CARCANO") /* GXTEntry: "Carcano Rifle" */))
	{
		return;
	}
	func_503(7, 76);
...
void func_300(int iParam0, int iParam1, int iParam2)
{
	...
	sVar0.f_2 = iParam2;
	sVar10 = { sVar0 /*10*/ };
	strcpy_s(&(sVar10.f_10), 32, func_505(iParam0, iParam1));
	sVar10.f_14 = (1 << 10);
	sVar10.f_15 = 1;
	func_199(sVar10, 0);
}
...
bool func_303(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	{
		iVar3 = PERSCHAR::_FORCE_SPAWN_PERSCHAR(func_96(iParam0), false);
	}
	if (!func_164(vVar0))
	{
...
bool func_327(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_11))
	{
		func_522(uParam0->f_13, 3.0f, 1, 0);
...
bool func_334(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_456(iVar0) && func_525(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
{
	if (func_526(Global_35, vParam2, 1) > 225.0f)
	{
		return 1;
	}
	if (*uParam0)
...
{
	if (joaat("MASK_UP") == func_531(joaat("CI_CATEGORY_WARDROBE_MASK")))
	{
		if (func_532(uParam0))
		{
			return true;
	...
	else if (func_533(joaat("CI_CATEGORY_WARDROBE_BIG_MASK"), uParam0))
	{
		if (func_532(uParam0))
		{
			return true;
...
bool func_345(var uParam0, int iParam1)
{
	...
	if (func_479(&(uParam0->f_18)) > (float)iParam1)
	{
		return true;
	}
	return false;
...
char* func_362(char* sParam0, int iParam1)
{
	...
	return func_541(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_363(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
void func_377()
{
	if (ENTITY::DOES_ENTITY_EXIST(sLocal_14.f_17))
	{
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(sLocal_14.f_17, sLocal_14.f_6, sLocal_14.f_7, 1))
		{
			ENTITY::STOP_ENTITY_ANIM(sLocal_14.f_17, sLocal_14.f_6, sLocal_14.f_7, -1000.0f);
		}
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(sLocal_14.f_17, sLocal_14.f_6, sLocal_14.f_8, 1))
		{
			ENTITY::STOP_ENTITY_ANIM(sLocal_14.f_17, sLocal_14.f_6, sLocal_14.f_8, -1000.0f);
		}
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(sLocal_14.f_17, sLocal_14.f_6, sLocal_14.f_9, 1))
		{
			ENTITY::STOP_ENTITY_ANIM(sLocal_14.f_17, sLocal_14.f_6, sLocal_14.f_9, -1000.0f);
		}
	}
	if (sLocal_14.f_16)
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_14.f_6))
		{
			STREAMING::REMOVE_ANIM_DICT(sLocal_14.f_6);
		}
		sLocal_14.f_16 = 0;
	}
	if (sLocal_14.f_18 != 0)
	{
		ENTITY::_UNPIN_MAP_ENTITY(sLocal_14.f_18);
	}
}
...
void func_382(int iParam0)
{
	...
	{
		case 1:
			if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("TOWN_SECRETS_SD_TRELAWNY")) > 0)
			{
				SCRIPTS::_REQUEST_THREAD_EXIT_FOR_ALL_THREADS_WITH_THIS_NAME(joaat("TOWN_SECRETS_SD_TRELAWNY"));
			}
			break;
		case 2:
			if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("TOWN_SECRETS_ER_DAUGHTER")) > 0)
			{
				SCRIPTS::_REQUEST_THREAD_EXIT_FOR_ALL_THREADS_WITH_THIS_NAME(joaat("TOWN_SECRETS_ER_DAUGHTER"));
			}
			break;
		case 3:
			if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("TOWN_SECRETS_VAL_MOIRA")) > 0)
			{
...
bool func_408(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
		if (func_486(Global_35, iVar0, 1) < 9.0f)
		{
			return true;
		}
	}
...
bool func_412(var uParam0, int iParam1)
{
	...
	if (!func_552(iVar0, iParam1, (1 << 10)))
	{
		if (func_408(uParam0) && func_346(0))
		{
			func_110(iVar0, iParam1, (1 << 10));
			uParam0->f_21 = -1;
			return true;
		}
	}
...
int func_428(var uParam0)
{
	...
	{
		strcpy_s(&(uParam0->f_15), 24, "SCVT_1057A");
		strcpy_s(&(uParam0->f_18), 24, "SCVT_1057B");
	...
	if (func_413(5) && func_553(5))
	{
		...
		{
			strcpy_s(&(uParam0->f_15), 24, "SCVTF_1056A");
			strcpy_s(&(uParam0->f_18), 24, "SCVTF_1056B");
	...
	if (func_413(6))
	{
		...
		{
			strcpy_s(&(uParam0->f_15), 24, "SCVT_0976A");
			strcpy_s(&(uParam0->f_18), 24, "SCVT_0976B");
	...
	{
		strcpy_s(&(uParam0->f_15), 24, "SCVT_0971A");
		strcpy_s(&(uParam0->f_18), 24, "SCVT_0971B");
		uParam0->f_7 = "SALOON_0971";
		return 1;
	}
	if (func_405(76, iVar0, 64, 1))
	{
		strcpy_s(&(uParam0->f_15), 24, "SCVT_0975A");
		strcpy_s(&(uParam0->f_18), 24, "SCVT_0975B");
...
void func_433(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			if (bParam1)
			{
				if (func_43(joaat("WS_RHODES_BANK_LIGHTS_OFF")))
				{
					func_121(joaat("WS_RHODES_BANK_LIGHTS_OFF"));
				}
			}
			else if (!func_43(joaat("WS_RHODES_BANK_LIGHTS_OFF")))
			{
				func_123(joaat("WS_RHODES_BANK_LIGHTS_OFF"));
			}
			break;
		case 2:
	...
	if (iParam0 == 2)
	{
		if (bParam1)
		{
			if (func_43(joaat("WS_VALENTINE_BANK_SHUTTERS_CLOSED")))
			{
				func_121(joaat("WS_VALENTINE_BANK_SHUTTERS_CLOSED"));
			}
		}
		else if (!func_43(joaat("WS_VALENTINE_BANK_SHUTTERS_CLOSED")))
		{
			func_123(joaat("WS_VALENTINE_BANK_SHUTTERS_CLOSED"));
		}
	}
}
...
void func_445(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_285(iParam0, (1 << 10)))
		{
			func_250(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_285(iParam0, (1 << 10)))
	{
		func_249(iParam0, (1 << 10));
		INVENTORY::_0x9B4E793B1CB6550A();
	}
	func_575(iParam0);
}
...
bool func_463(bool bParam0)
{
	...
	iVar0 = ENTITY::GET_MATCHING_ENTITIES(0, iVar1, 1, 2, joaat("CS_GRIZZLEDJON"), 0);
	if (iVar0 <= 0)
	{
...
bool func_468(var uParam0, Vector3 vParam1, Vector3 vParam4, bool bParam7, int iParam8)
{
	...
	else if (func_587(uParam0, vParam1, iParam8, -1, 0, 0))
	{
		...
		if ((ENTITY::DOES_ENTITY_EXIST(bVar0) && !func_311(bVar0, 0)) && (ENTITY::DOES_ENTITY_EXIST(bVar1) && !func_311(bVar1, 0)))
		{
			if (!func_164(vParam4))
			{
				TASK::TASK_LOOK_AT_COORD(bVar0, vParam4, 8000, 0, 51, false);
				TASK::TASK_LOOK_AT_COORD(bVar1, vParam4, 8000, 0, 51, false);
			}
			else if (bParam7)
			{
...
bool func_471(var uParam0)
{
	...
	iVar0 = ENTITY::_GET_ENTITIES_NEAR_POINT(func_588(PLAYER::PLAYER_ID()), 2.5f, iVar3, 1);
	if (iVar0 <= 0)
	{
...
bool func_474(int iParam0)
{
	...
	if (func_591(Global_35, iParam0, 1, 1) > 5.0f)
	{
		return true;
	}
	return false;
...
void func_483(var uParam0)
{
	...
	{
		uParam0->f_2 = VOLUME::CREATE_VOLUME_BOX(-304.5192f, 801.1588f, 119.0438f, 0.0f, 0.0f, 7.519171f, 3.653174f, 4.387049f, 2.46598f);
	}
	uParam0->f_1 = 1;
}
...
bool func_487(var uParam0, bool bParam1)
{
	...
	if (!func_476(bVar0, func_400(uParam0, (1 << 11))))
	{
		return false;
	}
	if (uParam0->f_30 == 0)
	{
		if (!func_400(uParam0, (1 << 11)) && !func_400(uParam0, (1 << 15)))
		{
			...
			else if (func_400(uParam0, (1 << 10)))
			{
				if (func_479(&(uParam0->f_34)) < 5.0f)
				{
					return false;
				}
			}
			else if (func_479(&(uParam0->f_34)) < 25.0f)
			{
				return false;
			}
		}
...
bool func_492(var uParam0, int iParam1)
{
	...
	if (func_400(uParam0, 128))
	{
		...
		while (iVar0 < 5)
		{
			...
			if (func_288(bVar1, 0) && func_591(bVar1, iParam1, 1, 1) <= 4.0f)
			{
				uParam0->f_21 = iVar0;
				return true;
			}
	...
	if (!func_400(uParam0, (1 << 9)) && !func_400(uParam0, 256))
	{
		return true;
	}
	if (func_400(uParam0, (1 << 9)))
	{
		if (func_408(uParam0))
		{
			return true;
...
void func_496(var uParam0)
{
	...
	func_399(&(uParam0->f_34), 1);
	uParam0->f_40 = { func_467() /*3*/ };
	uParam0->f_21 = -1;
	if (func_400(uParam0, (1 << 14)))
	{
		func_415(uParam0, (1 << 14));
	}
	func_415(uParam0, (1 << 15));
	func_415(uParam0, (1 << 10));
	func_478(&uLocal_50);
	if (func_400(uParam0, (1 << 12)))
	{
...
void func_503(int iParam0, int iParam1)
{
	...
	{
		Global_1415402 = SCRIPTS::START_NEW_SCRIPT_WITH_ARGS(func_608(iParam0), &iParam1, 1, (1 << 10));
...
{
	if (func_533(joaat("CI_CATEGORY_WARDROBE_MASK"), uParam0))
	{
		return true;
	}
	if (func_533(joaat("CI_CATEGORY_WARDROBE_BIG_MASK"), uParam0))
	{
		return true;
	}
	return false;
...
void func_549(int iParam0, bool bParam1)
{
	if (func_92(iParam0))
	{
		if (bParam1)
		{
			if (!func_93(iParam0))
			{
				func_60(iParam0, 1, 0.0f, 0, 0, 1.0f, 0, 0);
			}
		}
...
float func_591(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
...
bool func_593(var uParam0, Vector3 vParam1, int iParam4, int iParam5, float fParam6)
{
	if (AUDIO::_IS_SCRIPTED_CONVERSATION_CREATED(&vParam1))
	{
		return true;
...
void func_615(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_436(iParam0) == 3 || (func_436(iParam0) == 1 && STATS::STATSTRACKER_IS_INITIALIZED(func_569(iParam0))))
	{
		...
		if ((!func_439(Global_1572864.f_8) && !func_334(0, 1, 0)) && !func_111(Global_1935630, (1 << 15)))
		{
...
bool func_625(int iParam0, int iParam1)
{
	...
	if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&(Global_1310750[iParam0 /*111*/].f_40))) > 0)
	{
		return false;
	}
	if (func_670(iParam0, (1 << 21)))
	{
		return false;
	}
	if (!func_671(iParam0))
...
int func_626(int iParam0, Vector3 vParam1)
{
	...
	{
		vVar1 = { func_676(iParam0, iVar0) /*3*/ };
...
bool func_635(Vector3 vParam0, int iParam3)
{
	...
	func_681(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_682(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
void func_662(bool bParam0)
{
	if (bParam0)
	{
		...
		func_697(&Global_1935630, (1 << 22));
	}
	else
	{
		PLAYER::SET_WANTED_LEVEL_MULTIPLIER(0.0f);
		func_366(&Global_1935630, (1 << 22));
	}
...
{
	if (!bParam0 && func_43(joaat("WS_GUARMA_EXISTS")))
	{
		return 0;
	}
...
void func_665(int iParam0, bool bParam1)
{
	...
	if (func_698(iParam0))
	{
		if (bParam1)
		{
			func_699(joaat("CI_CATEGORY_WARDROBE_BIG_MASK"));
		}
		else
		{
			func_700(joaat("CI_CATEGORY_WARDROBE_BIG_MASK"));
		}
	}
}
...
{
	if (func_672(iParam0, (1 << 11)))
	{
		return true;
	}
	if (func_672(iParam0, (1 << 12)))
	{
...
bool func_673(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 6:
			...
			else if (!func_504(joaat("WEAPON_SHOTGUN_DOUBLEBARREL") /* GXTEntry: "Double-Barreled Shotgun" */))
			{
				return false;
			}
			return true;
		...
		case 16:
			...
			if (!func_716(joaat("CONSUMABLE_WHISKEY") /* GXTEntry: "Kentucky Bourbon" */, 1, 0))
			{
				return false;
			}
			return true;
		...
		case 33:
			...
			else if (func_140() == 1 && func_462(Global_35, -1374.053f, -741.9763f, 90.7132f, 1) < 200.0f)
			{
				if (func_715(49, 0))
				{
					return false;
		...
		case 28:
			...
			{
				if (func_265(-1063.709f, -520.2658f, 82.0255f, 1) < 110.0f || func_265(-815.6782f, -520.9415f, 45.4979f, 1) < 110.0f)
				{
					return false;
				}
			}
		...
		case 44:
			...
			switch (func_140())
			{
				...
				case 11:
					...
					else if (func_265(1624.51f, -1818.45f, 49.6045f, 1) < 225.0f)
					{
						if (SCRIPTS::HAS_SCRIPT_LOADED("gang_enc_lemoyne_church") || !func_730((1 << 16), 2))
						{
							return false;
						}
					}
		...
		case 101:
			...
			if (func_731(92, (1 << 16)) || func_732(92))
			{
				return true;
			}
			return false;
		...
		case 108:
			if (func_212() == 76)
			{
				if (func_703(108, (1 << 21)) > 0 && (func_705(0) || func_706(0)))
				{
					return false;
				}
				if (func_714(76, 1, 0))
		...
		case 109:
			...
			return true;
		case 58:
			if ((func_715(119, 0) || func_555(119)) && func_265(-1006.029f, 458.253f, 55.49393f, 1) < 200.0f)
			{
				return false;
			}
		...
		case 64:
			...
			if (func_751(iVar11))
			{
				if (func_752(iVar11, Global_36) <= 400.0f)
				{
					return false;
				}
			}
		...
		case 66:
			...
			if (func_716(joaat("DOCUMENT_TREASURE_MAP_04") /* GXTEntry: "High Stakes Treasure Map 1" */, 1, 0))
			{
				return false;
			}
			return true;
...
bool func_716(bool bParam0, int iParam1, bool bParam2)
{
	int iVar0;
	...
	return func_776(bParam0, 0, bParam2) >= iParam1;
}
...
int func_720()
{
	...
	else if (func_479(&(Global_1359489.f_55)) < (float)iVar0)
	{
		return 3;
	}
...
bool func_725(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_285(iParam1, (1 << 20)))
	{
		*uParam2 = 4;
		return true;
	}
	if (func_111(Global_1935630, (1 << 21)))
	{
		*uParam2 = 4;
		return true;
	}
...
float func_757(int iParam0)
{
	...
	if (func_793() && func_372(iParam0, (1 << 24)))
	{
		if (func_806())
		{
			return 1.25f;
...
void func_773(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar4 += func_550(iVar0, iVar1);
		iVar3--;
		iVar0 = BUILTIN::ROUND(func_823(BUILTIN::TO_FLOAT(iVar0 + 1), 0.0f, 12.0f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
bool func_775(bool bParam0, int iParam1)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	bVar0 = func_824(bParam0, iParam1);
	sVar4.f_9 = joaat("SLOTID_NONE");
	if (func_825("ALL WEAPONS", &iVar1, &iVar2, joaat("SLOTID_NONE"), 0))
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_826(&sVar4, iVar3, iVar1, iVar2))
			{
			}
			else if (!func_800(sVar4.f_4))
			{
			}
...
int func_776(bool bParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_761(bParam2), bParam0, false);
	return iVar2;
}
...
bool func_787(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (Global_1935630.f_26 && func_256(PLAYER::PLAYER_ID(), 0, 1, (uParam2->f_1 & (1 << 19)) == 0))
		{
...
int func_805(int iParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		case 3:
			...
			iVar0 += func_704(iParam0, 2);
			iVar0 += func_704(iParam0, 11);
			return iVar0;
		case 0:
			iVar0 = func_704(iParam0, 1);
			iVar0 += func_704(iParam0, 7);
			iVar0 += func_704(iParam0, 6);
			iVar0 += func_704(iParam0, 12);
			return iVar0;
		case 2:
			iVar0 = func_704(iParam0, 3);
			iVar0 += func_704(iParam0, 10);
			return iVar0;
		case 1:
			iVar0 = func_704(iParam0, 4);
			iVar0 += func_704(iParam0, 9);
			return iVar0;
		case 4:
			return func_704(iParam0, 8);
		case 5:
			iVar0 = func_704(iParam0, 13);
			iVar0 += func_704(iParam0, 14);
			iVar0 += func_704(iParam0, 15);
			iVar0 += func_704(iParam0, 16);
			return iVar0;
		default:
			break;
	}
...
bool func_814(int iParam0)
{
	if (func_535())
	{
		if (func_525(Global_1347702[iParam0 /*49*/].f_12, (1 << 21)))
		{
			return false;
		}
	}
...
bool func_824(bool bParam0, int iParam1)
{
	...
	if (func_882(bParam0, joaat("CI_TAG_ITEM_AMMOBOX")))
	{
		func_883(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return false;
}
...
int func_829(Vector3 vParam0)
{
	...
	iVar0 = func_888(vParam0, 0.0f, 0.0f, 0, 2);
...
bool func_830(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_825("ALL WEAPONS", &iVar1, &iVar2, joaat("SLOTID_NONE"), 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_889(iParam1, (1 << 9)) && func_890(sVar4.f_4, &uVar19, &sVar23, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */)) && !sVar23.f_21)
			{
			}
			else if (!bVar18 || WEAPON::IS_PED_CARRYING_WEAPON(Global_35, sVar4.f_4))
			{
				if (((WEAPON::_IS_WEAPON_ONE_HANDED(sVar4.f_4) && (!WEAPON::IS_WEAPON_SHOTGUN(sVar4.f_4) || func_889(iParam1, 32))) && (!WEAPON::IS_WEAPON_PISTOL(sVar4.f_4) || !func_889(iParam1, (1 << 24)))) && (!WEAPON::IS_WEAPON_REVOLVER(sVar4.f_4) || !func_889(iParam1, (1 << 25))))
				{
...
int func_835(int iParam0)
{
	...
	{
		case 2:
			return joaat("CONSUMABLE_SPECIAL_MEDICINE_CRAFTED") /* GXTEntry: "Special Health Cure" */;
		case 3:
			return joaat("CONSUMABLE_POTENT_MEDICINE") /* GXTEntry: "Potent Health Cure" */;
		case 6:
			return joaat("CONSUMABLE_SPECIAL_HORSE_STIMULANT_CRAFTED") /* GXTEntry: "Special Horse Stimulant" */;
		case 7:
			return joaat("CONSUMABLE_HORSE_REVIVER") /* GXTEntry: "Horse Reviver" */;
		case 13:
			return joaat("CONSUMABLE_POTENT_RESTORATIVE") /* GXTEntry: "Potent Bitters" */;
		case 15:
			return joaat("CONSUMABLE_SPECIAL_MEDICINE_CRAFTED") /* GXTEntry: "Special Health Cure" */;
		case 18:
			return joaat("CONSUMABLE_POTENT_HORSE_STIMULANT") /* GXTEntry: "Potent Horse Stimulant" */;
		case 19:
			return joaat("CONSUMABLE_POTENT_TONIC") /* GXTEntry: "Potent Miracle Tonic" */;
		case 20:
			return joaat("CONSUMABLE_POTENT_SNAKE_OIL") /* GXTEntry: "Potent Snake Oil" */;
		case 23:
			return joaat("CONSUMABLE_SPECIAL_TONIC_CRAFTED") /* GXTEntry: "Special Miracle Tonic" */;
		case 26:
			return joaat("CONSUMABLE_COVER_SCENT") /* GXTEntry: "Cover Scent Lotion" */;
		case 29:
			return joaat("CONSUMABLE_POTENT_RESTORATIVE") /* GXTEntry: "Potent Bitters" */;
		case 34:
			return joaat("CONSUMABLE_SPECIAL_RESTORATIVE_CRAFTED") /* GXTEntry: "Special Bitters" */;
		case 38:
			return joaat("CONSUMABLE_POTENT_HERBIVORE_BAIT") /* GXTEntry: "Potent Herbivore Bait" */;
		case 40:
			return joaat("CONSUMABLE_SPECIAL_RESTORATIVE_CRAFTED") /* GXTEntry: "Special Bitters" */;
		case 43:
			return joaat("CONSUMABLE_POTENT_MEDICINE") /* GXTEntry: "Potent Health Cure" */;
...
bool func_836(bool bParam0)
{
	...
	while (iVar48 < iVar0)
	{
		...
		{
			if (sVar1.f_2 == joaat("COST_TYPE_CRAFT") && !func_893(bParam0, sVar1.f_0, 1))
			{
				return true;
			}
		}
	...
	switch (iParam0->f_6)
	{
		case 0:
			if ((*iParam0 & 16) != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_896(1) || (*iParam0 & (1 << 13)) != 0))
				{
					func_506(iParam0, (1 << 25));
				}
			}
			break;
		case 1:
...
bool func_840(int iParam0, int iParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_905(iParam0, !(*iParam1 & (1 << 28)) != 0, !(*iParam1 & (1 << 29)) != 0, !(*iParam1 & (1 << 30)) != 0, 0, 0))
		{
...
bool func_841(int iParam0, int iParam1, int iParam2)
{
	...
	fVar0 = 85.0f;
	if (func_602(iParam1, !(*iParam2 & (1 << 28)) != 0, !(*iParam2 & (1 << 29)) != 0, !(*iParam2 & (1 << 30)) != 0, 0))
	{
...
bool func_845(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam2->f_12 < (float)func_910(iParam2))
	{
...
bool func_853(bool bParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_591(bParam0, iParam1, 1, 1) < 4.0f)
		{
		...
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(iVar0, &iVar5, &iVar4))
		{
			...
			else if (iVar4 == iVar5)
			{
				...
				while (iVar6 < iVar4)
				{
					...
					{
						if (func_462(iVar7, vVar1, 1) < 3.0f)
						{
		...
		case joaat("EVENT_SHOCKING_ENTITY_HOGTIED"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(iParam0, iVar4, -1.0f, -1.0f, -1.0f, -1.0f) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(iParam0, Global_35, -1.0f, -1.0f, -1.0f, -1.0f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iVar4, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					...
					{
						if (func_462(iVar4, Global_36, 1) < 7.0f)
						{
							return true;
						}
					}
...
bool func_873()
{
	...
	iVar1 = func_237(func_931((1 << 16)), 0, 3, func_932((1 << 16)));
	if (func_439(iVar1))
	{
...
bool func_882(bool bParam0, int iParam1)
{
	if (bParam0 == 0)
	{
		return false;
...
void func_883(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
struct<4> /*32*/ func_885(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_935(joaat("CARRIED_WEAPONS"), func_934(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_935(joaat("CARRIED_WEAPONS"), func_934(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_935(joaat("CARRIED_WEAPONS"), func_934(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}
...
bool func_890(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_761(0);
	*uParam1 = { func_935(bParam0, func_885(0), iParam3, 0) /*4*/ };
...
bool func_893(bool bParam0, int iParam1, bool bParam2)
{
	var uVar0[10];
	int iVar11;
	int iVar12;
	...
	if ((bParam2 && func_20() == 0) && !UNLOCK::UNLOCK_IS_VISIBLE(bParam0))
	{
		return false;
	}
	if (!func_936(bParam0, iParam1, &uVar0, &iVar11) || iVar11 < 1)
	{
		return false;
	}
	iVar12 = 0;
...
float func_900(bool bParam0, int iParam1)
{
	return func_591(bParam0, iParam1, 1, 1);
}
...
bool func_905(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(bVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_591(bVar0, iParam0, 1, 1) <= 4.0f)
		{
			return true;
		}
	}
...
int func_925(bool bParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(iParam0, Global_35, -1.0f, -1.0f, -1.0f, -1.0f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
			{
				...
				{
					if (func_462(iVar1, Global_36, 1) < 5.0f)
					{
						return true;
					}
				}
...
{
	return func_935(joaat("CHARACTER"), func_946(), joaat("SLOTID_NONE"), bParam0);
}

struct<4> /*32*/ func_935(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_761(bParam6), &uParam1, bParam0, iParam5, &sVar0);
	return sVar0;
}

bool func_936(bool bParam0, int iParam1, var uParam2, int iParam3)
{
	struct<37> /*296*/ sVar0;
	int iVar47;
