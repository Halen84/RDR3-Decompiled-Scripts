...
int func_19(var uParam0)
{
	...
	sLocal_28 = "MUD3AUD";
	sLocal_29 = "MUD3" /* GXTEntry: "Polite Society, Valentine Style" */;
...
void func_62()
{
	...
	else if (bLocal_32)
	{
		if (func_98(bLocal_16, Global_35) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_16, Global_35, true, true))
		{
			...
			{
				func_100(3, 0, 0, "MUD3_HG_KILL" /* GXTEntry: "Killed Jimmy Brooks" */, bLocal_16, 0, 1065353216 /* Float: 1f */, 0);
				bLocal_33 = true;
			}
...
void func_63()
{
	...
	if (!bLocal_32)
	{
		...
		{
			iLocal_158 = func_104("MUD3_H_HONOR_02" /* GXTEntry: "You lost honor. Continue to perform negative actions to become more dishonorable." +
    "" */, 10000, 0, 0, 0, 1);
			return;
		}
	...
	if (func_110(bVar0))
	{
		if (func_111(&iLocal_40, "MUD3_H_RETURN" /* GXTEntry: "You can return the horse you stole to its owner in Valentine to gain honor." */, bVar0, &bLocal_36))
		{
...
bool func_110(bool bParam0)
{
	if (func_175(15))
	{
		return func_111(&iLocal_39, "MUD3_H_THORSEA" /* GXTEntry: "A horse blipped with ~BLIP_HORSE_TEMP~ is your temporary horse. Equip it with you" +
    "r saddle to make it your main horse." */, bParam0, &bLocal_35);
	}
	return func_111(&iLocal_39, "MUD3_H_THORSE" /* GXTEntry: "A horse blipped with ~BLIP_HORSE_TEMP~ is your temporary horse." */, bParam0, &bLocal_35);
}
...
bool func_113(bool bParam0)
{
	if (func_175(15))
	{
		return func_111(&iLocal_41, "MUD3_H_SADDLEA" /* GXTEntry: "This horse does not have your saddle on it. Your weapons and equipment are stored" +
    " on your saddle, which can be transferred between horses." */, bParam0, &bLocal_37);
	}
	return func_111(&iLocal_41, "MUD3_H_SADDLE" /* GXTEntry: "This horse does not have your saddle on it. Your weapons and equipment are stored" +
    " with your saddle." */, bParam0, &bLocal_37);
}
...
void func_115(int iParam0)
{
	...
	switch (iLocal_159)
	{
		...
		case 5:
			...
			TASK::TASK_PERFORM_SEQUENCE(bLocal_14, iVar0);
			TASK::CLEAR_SEQUENCE_TASK(&iVar0);
			func_100(13, 0, 0, "MUD3_HG_HORSE" /* GXTEntry: "Returned stolen horse" */, bLocal_14, 0, 1065353216 /* Float: 1f */, 0);
			break;
		case 6:
			func_28(&iLocal_18);
		...
		case 9:
			...
			PED::SET_PED_KEEP_TASK(bLocal_14, true);
			TASK::CLEAR_PED_TASKS(bLocal_14, true, false);
			LAW::_LAW_WITNESS_RESPONSE_TASK(bLocal_14, Global_35, bLocal_14, Global_36, joaat("CRIME_THEFT_HORSE") /* GXTEntry: "Horse Theft" */);
			TASK::OPEN_SEQUENCE_TASK(&iVar0);
			...
			func_178(32, 0, 1);
			func_178(64, 0, 1);
			func_100(2, joaat("HONOR_EVENT_STEAL_HORSE") /* GXTEntry: "Stole Horse" */, 0, 0, bLocal_14, 0, 1065353216 /* Float: 1f */, 0);
			break;
		case 10:
			func_28(&iLocal_18);
			PED::SET_PED_KEEP_TASK(bLocal_14, true);
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_277(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS" /* GXTEntry: "+" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_277(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT" /* GXTEntry: "+" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_277(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG" /* GXTEntry: "~COLOR_RED~-~s~" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_277(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT" /* GXTEntry: "~COLOR_RED~-~s~" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
bool func_430(bool bParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_446(bParam0) && WEAPON::IS_WEAPON_A_GUN(bParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
		{
			...
			if (!func_448(bParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
			{
				return false;
			}
			else if (func_449(bParam0, &sVar4, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
			{
				return false;
			}
			if (func_450(bParam0, 1))
			{
				if (!func_448(bParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					return false;
				}
				else if (func_449(bParam0, &sVar4, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */))
				{
					return false;
				}
			}
...
char* func_432(char* sParam0, int iParam1)
{
	...
	return func_456(MISC::VAR_STRING(10, "PLAYER_STRING" /* GXTEntry: "~fg~~1p~~fo~" */, sParam0), iParam1);
}
...
{
	if (func_472(bParam0, joaat("DEFAULT") /* GXTEntry: "_" */) == 0)
	{
		return false;
	}
	return true;
	...
	switch (func_400(bParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_450(bParam0, 1))
			{
				...
				else if (!func_448(bParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_449(bParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
