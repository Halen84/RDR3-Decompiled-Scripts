...
void func_4()
{
	switch (iLocal_44)
	{
		...
		case 2:
			...
			if (STREAMING::HAS_MODEL_LOADED(iLocal_45) && PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY())
			{
				iLocal_44 = 4;
			}
			break;
...
bool func_10(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	struct<11> /*88*/ sVar0;
	int iVar17;
	struct<11> /*88*/ sVar18;
...
bool func_14()
{
	...
	fVar0 = 55.0f;
	fVar1 = 90.0f;
	iVar2 = func_18(iLocal_46, sLocal_47.f_2);
	fVar3 = ((float)iVar2 * 25.0f);
	fVar4 = (fVar3 + 45.0f);
	if (fVar3 > 150.0f)
	{
		fVar3 = 150.0f;
	...
	if (!func_19(Global_36, &sLocal_47, &uVar5, 1, 1, fVar4, 50.0f, fVar0, fVar1, fVar3))
	{
		return false;
	}
	vLocal_41 = { sLocal_47.f_3 /*3*/ };
	return true;
}
	...
	if (fParam8 == -0.01f)
	{
		switch (iParam5)
		{
			...
			case 36:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_30(10.0f, 40.0f, 5.0f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_30(30.0f, 60.0f, 5.0f, iParam1));
			...
			case 37:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_30(40.0f, 80.0f, 5.0f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_30(50.0f, 90.0f, 5.0f, iParam1));
				TASK::_0x450080DDEDB91258(*uParam0, 10.0f);
			...
			case 38:
				TASK::_0x2EB977293923C723(*uParam0, 30.0f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_30(30.0f, 60.0f, 5.0f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_30(50.0f, 80.0f, 5.0f, iParam1));
			...
			case 39:
				TASK::_0x2EB977293923C723(*uParam0, 10.0f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_30(0.0f, 10.0f, 1.0f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_30(5.0f, 15.0f, 1.0f, iParam1));
			...
			case 40:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_30(60.0f, 120.0f, 10.0f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_30(100.0f, 130.0f, 5.0f, iParam1));
			...
			case 41:
				TASK::_0x2EB977293923C723(*uParam0, 10.0f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_30(10.0f, 35.0f, 5.0f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_30(25.0f, 50.0f, 5.0f, iParam1));
			...
			case 45:
				TASK::_0x2EB977293923C723(*uParam0, 40.0f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_30(50.0f, 80.0f, 10.0f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_30(75.0f, 95.0f, 5.0f, iParam1));
				TASK::_0x450080DDEDB91258(*uParam0, 15.0f);
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			case 43:
				TASK::_0x2EB977293923C723(*uParam0, func_30(95.0f, 90.0f, 80.0f, iParam1));
				TASK::_0x954451EA2D2120FB(*uParam0, func_30(95.0f, 90.0f, 80.0f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_30(125.0f, 115.0f, 100.0f, iParam1));
				TASK::_0x450080DDEDB91258(*uParam0, 5.0f);
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 10.0f);
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
