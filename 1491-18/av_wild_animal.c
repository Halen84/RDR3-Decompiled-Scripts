...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_48(uParam0, 0, "WAP_ANIMAL_1", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], iLocal_10, uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
				func_67(&(uParam0->f_20[0 /*14*/]), 0, 1);
			}
			iLocal_11 = 2;
			break;
		case 2:
			if (func_68(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */) || *uParam0 == 236)
			{
				func_64(uParam0);
				if (*uParam0 != 236)
				{
		...
		case 3:
			if (*uParam0 == 236)
			{
				if (func_69(uParam0, 1.0f, 85.0f, 4, joaat("ACTION"), 0))
				{
					func_65(uParam0);
					return 1;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
				{
					...
					{
						if ((func_105(Global_35, uParam0->f_20[iVar0 /*14*/], 1) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[iVar0 /*14*/])) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[iVar0 /*14*/]))
						{
							if (!func_106(&(uParam0->f_490)))
							{
