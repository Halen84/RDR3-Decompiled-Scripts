...
bool func_72(var uParam0)
{
	...
	iLocal_18 = func_153(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 0, 1);
	iLocal_19 = func_153(uParam0, joaat("P_CHAIRFOLDING02X"), 0.0f, 0.0f, 0.0f, 0, 1, 0, 1);
	...
	func_157(uParam0, iLocal_14, 2, joaat("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, iLocal_18, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	func_159(uParam0, iLocal_14, 2, -1);
	sLocal_20 = { func_160(uParam0, 0.02f, 0.16f, 0.782f, 180.0f, 7.0f, 0.7f, 0.7f) /*10*/ };
	func_161(uParam0, 1);
...
{
	return func_193(uParam0, sLocal_20, 1, 0);
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_193(uParam0, sLocal_20, 1, 0))
		{
