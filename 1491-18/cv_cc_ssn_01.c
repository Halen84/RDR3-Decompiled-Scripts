...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.33949f, 0.232226f, 1.00873f, 3.0f, 0.9f, 0.9f, 2.5f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, 0.476543f, -0.0842055f, 0.549286f, 3.0f, 0.8f, 2.0f, 2.0f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	func_152(uParam0, joaat("P_CS_RAG02X"), 0.0f, 0.0f, 0.0f, "RAG", 0, 1, 1);
	iLocal_16 = func_152(uParam0, joaat("P_STOOL03X"), 0.0f, 0.0f, 0.0f, "stool" /* GXTEntry: "Stool" */, 0, 0, 1);
	...
	func_156(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 0.0f, 1);
	...
	func_156(uParam0, iLocal_15, 4, joaat("WORLD_CAMP_JOHN_RECOVER"), "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0, -1.0f, 0.0f, 1);
	func_159(uParam0, iLocal_15, 4, 1);
	func_157(uParam0, iLocal_15, 1, -1);
	sLocal_22 = { func_160(uParam0, 0.8462f, 0.4096f, 1.0084f, -151.0f, 3.555f, 0.4f, 0.4f) /*10*/ };
	sLocal_32 = { func_160(uParam0, 0.8462f, 0.4096f, 1.0084f, -9.75f, 2.41f, 0.4f, 0.745f) /*10*/ };
	if (func_161(2))
	{
		uParam0->f_14 = 1;
	}
...
{
	if (func_192(uParam0, sLocal_22, 1, 0))
	{
		func_191(uParam0, iLocal_17, 1);
		iLocal_21 = iLocal_19;
		return true;
	}
	else if (func_192(uParam0, sLocal_32, 1, 0))
	{
...
bool func_192(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
	...
	if (!func_298(sParam1, sParam1.f_6, Global_36))
	{
		return false;
	}
	if (func_298(sParam1, sParam1.f_3, Global_36))
	{
		return false;
	}
	if (bParam12)
