...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -11.581f, 7.1445f, 0.0f, -68.75f, 1.0625f, 1.0275f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, 1.1315f, -1.743f, 0.0f, -56.0f, 1.2f, 1.2f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	func_151(uParam0, -0.4685f, 1.932f, 0.0f, -56.0f, 1.0625f, 1.0275f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	iLocal_20 = func_152(uParam0, joaat("P_BRUSHDISH01X"), 0.0f, 0.0f, 0.0f, "BRUSH", 0, 0, 1);
	...
	func_154(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_18, 0, -1073741824 /* Float: -2f */, 0.0f, 1);
	...
	func_154(uParam0, iLocal_14, 2, joaat("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_19, 0, -1073741824 /* Float: -2f */, 0.0f, 1);
...
bool func_93(var uParam0)
{
	...
	{
		fLocal_23 = (ANIMSCENE::_GET_ANIM_SCENE_DURATION(uParam0->f_1984[iLocal_22]) * 2.0f);
...
void func_198(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_301(100.0f, 140.0f);
			}
		}
...
int func_344(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_382(fVar9) /*3*/ };
			vVar13 = { func_383(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) /*3*/ };
...
void func_417(int iParam0, int iParam1)
{
	...
	func_389(iParam1, func_445(iParam1, (1 << 13)), func_445(iParam1, (1 << 14)), 1);
}
