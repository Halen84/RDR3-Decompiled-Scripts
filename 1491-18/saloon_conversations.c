...
bool func_20(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 6:
			...
			else if (!func_47(joaat("WEAPON_SHOTGUN_DOUBLEBARREL") /* GXTEntry: "Double-Barreled Shotgun" */))
			{
				return false;
			}
			return true;
		...
		case 16:
			...
			if (!func_62(joaat("CONSUMABLE_WHISKEY") /* GXTEntry: "Kentucky Bourbon" */, 1, 0))
			{
				return false;
			}
			return true;
		...
		case 66:
			...
			if (func_62(joaat("DOCUMENT_TREASURE_MAP_04") /* GXTEntry: "High Stakes Treasure Map 1" */, 1, 0))
			{
				return false;
			}
			return true;
...
bool func_240(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_234("ALL WEAPONS", &iVar1, &iVar2, joaat("SLOTID_NONE"), 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_315(iParam1, (1 << 9)) && func_316(sVar4.f_4, &uVar19, &sVar23, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */)) && !sVar23.f_21)
			{
			}
