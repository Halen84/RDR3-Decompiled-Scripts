...
int func_35(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (!bVar3)
	{
		...
		switch (iParam0)
		{
			...
			case joaat("UPGRADE_OFFHAND_HOLSTER") /* GXTEntry: "Upgraded Off-Hand Holster" */:
				...
				{
					func_150(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_OFFHAND_HOLSTER") /* GXTEntry: "Upgraded Off-Hand Holster" */, 0, joaat("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_151(&iVar9, 0))
				{
			...
			case joaat("UPGRADE_BANDOLIER") /* GXTEntry: "Upgraded Bandolier" */:
				...
				{
					func_150(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_BANDOLIER") /* GXTEntry: "Upgraded Bandolier" */, 0, joaat("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case joaat("CONSUMABLE_AGED_PIRATE_RUM") /* GXTEntry: "Aged Pirate Rum" */:
				func_166(242, func_165(joaat("CONSUMABLE_AGED_PIRATE_RUM") /* GXTEntry: "Aged Pirate Rum" */), 0);
				break;
			case joaat("CONSUMABLE_GINSENG_ELIXIER") /* GXTEntry: "Ginseng Elixir" */:
				func_166(240, func_165(joaat("CONSUMABLE_GINSENG_ELIXIER") /* GXTEntry: "Ginseng Elixir" */), 0);
				break;
			case joaat("CONSUMABLE_VALERIAN_ROOT") /* GXTEntry: "Valerian Root" */:
				func_166(241, func_165(joaat("CONSUMABLE_VALERIAN_ROOT") /* GXTEntry: "Valerian Root" */), 0);
				break;
			...
			case joaat("CONSUMABLE_MOONSHINE") /* GXTEntry: "Moonshine" */:
				...
				{
					func_167(594, joaat("TF_FORTIFY_TANK1") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Health Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_RESTORATIVE") /* GXTEntry: "Bitters" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_167(594, joaat("TF_FORTIFY_TANK2") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Stamina Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_CHEWING_TOBACCO_USED") /* GXTEntry: "Opened Chewing Tobacco" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_167(594, joaat("TF_FORTIFY_TANK3") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Dead Eye Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_POTENT_TONIC") /* GXTEntry: "Potent Miracle Tonic" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_167(594, joaat("TF_FORTIFY_TANK4") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    ...
    "d Eye Bars." */, 1, 1);
			...
			case joaat("CONSUMABLE_MEAL_ROAST_BEEF") /* GXTEntry: "Roast Beef" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_167(595, joaat("TF_FORTIFY_CORE1") /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    "for a short period of time. This Provision will Fortify your Health Core." */, 1, 1);
			...
			case joaat("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL_EGGS") /* GXTEntry: "Regional Beef and Eggs Stew" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_167(595, joaat("TF_FORTIFY_CORE2") /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
...
int func_71(int iParam0)
{
	switch (iParam0)
	{
		case joaat("DOCUMENT_NEWSPAPER_ED_01") /* GXTEntry: "Blackwater Ledger No. 62" */:
			...
			{
				return joaat("NEWSPAPERS/NEWSPAPER_BL_01_B");
			}
			break;
		case joaat("DOCUMENT_NEWSPAPER_ED_02") /* GXTEntry: "Blackwater Ledger No. 63" */:
			return joaat("NEWSPAPERS/NEWSPAPER_BL_02");
		case joaat("DOCUMENT_NEWSPAPER_ED_03") /* GXTEntry: "Blackwater Ledger No. 64" */:
			return joaat("NEWSPAPERS/NEWSPAPER_BL_03");
		case joaat("DOCUMENT_NEWSPAPER_ED_04") /* GXTEntry: "Blackwater Ledger No. 65" */:
			return joaat("NEWSPAPERS/NEWSPAPER_BL_04");
		case joaat("DOCUMENT_NEWSPAPER_ED_05") /* GXTEntry: "Blackwater Ledger No. 66" */:
			return joaat("NEWSPAPERS/NEWSPAPER_BL_05");
		case joaat("DOCUMENT_NEWSPAPER_ED_06") /* GXTEntry: "Blackwater Ledger No. 67" */:
			return joaat("NEWSPAPERS/NEWSPAPER_BL_06");
		case joaat("DOCUMENT_NEWSPAPER_ED_07") /* GXTEntry: "Blackwater Ledger No. 68" */:
			return joaat("NEWSPAPERS/NEWSPAPER_BL_07");
		case joaat("DOCUMENT_NEWSPAPER_ED_08") /* GXTEntry: "Blackwater Ledger No. 69" */:
			return joaat("NEWSPAPERS/NEWSPAPER_BL_08");
		case joaat("DOCUMENT_NEWSPAPER_ED_09") /* GXTEntry: "Blackwater Ledger No. 70" */:
			return joaat("NEWSPAPERS/NEWSPAPER_BL_09");
		case joaat("DOCUMENT_NEWSPAPER_ED_10") /* GXTEntry: "Blackwater Ledger No. 71" */:
			return joaat("NEWSPAPERS/NEWSPAPER_BL_10");
		case joaat("DOCUMENT_NEWSPAPER_ED_11") /* GXTEntry: "Blackwater Ledger No. 72" */:
			return joaat("NEWSPAPERS/NEWSPAPER_BL_11");
		case joaat("DOCUMENT_NEWSPAPER_ED_12") /* GXTEntry: "Blackwater Ledger No. 73" */:
			return joaat("NEWSPAPERS/NEWSPAPER_BL_12");
		case joaat("DOCUMENT_NEWSPAPER_ED_13") /* GXTEntry: "Blackwater Ledger No. 74" */:
			return joaat("NEWSPAPERS/NEWSPAPER_BL_13");
		case joaat("DOCUMENT_NEWSPAPER_ED_14") /* GXTEntry: "Blackwater Ledger No. 75" */:
		...
		case joaat("DOCUMENT_NEWSPAPER_ED_01_NH") /* GXTEntry: "New Hanover Gazette No. 27" */:
			...
			{
				return joaat("NEWSPAPERS/NEWSPAPER_NH_01_B");
			}
			break;
		case joaat("DOCUMENT_NEWSPAPER_ED_02_NH") /* GXTEntry: "New Hanover Gazette No. 28" */:
			return joaat("NEWSPAPERS/NEWSPAPER_NH_02");
		case joaat("DOCUMENT_NEWSPAPER_ED_03_NH") /* GXTEntry: "New Hanover Gazette No. 29" */:
			return joaat("NEWSPAPERS/NEWSPAPER_NH_03");
		case joaat("DOCUMENT_NEWSPAPER_ED_04_NH") /* GXTEntry: "New Hanover Gazette No. 30" */:
			return joaat("NEWSPAPERS/NEWSPAPER_NH_04");
		case joaat("DOCUMENT_NEWSPAPER_ED_05_NH") /* GXTEntry: "New Hanover Gazette No. 31" */:
			return joaat("NEWSPAPERS/NEWSPAPER_NH_05");
		case joaat("DOCUMENT_NEWSPAPER_ED_06_NH") /* GXTEntry: "New Hanover Gazette No. 32" */:
			return joaat("NEWSPAPERS/NEWSPAPER_NH_06");
		case joaat("DOCUMENT_NEWSPAPER_ED_07_NH") /* GXTEntry: "New Hanover Gazette No. 33" */:
			return joaat("NEWSPAPERS/NEWSPAPER_NH_07");
		case joaat("DOCUMENT_NEWSPAPER_ED_08_NH") /* GXTEntry: "New Hanover Gazette No. 34" */:
			return joaat("NEWSPAPERS/NEWSPAPER_NH_08");
		case joaat("DOCUMENT_NEWSPAPER_ED_09_NH") /* GXTEntry: "New Hanover Gazette No. 35" */:
			return joaat("NEWSPAPERS/NEWSPAPER_NH_09");
		case joaat("DOCUMENT_NEWSPAPER_ED_10_NH") /* GXTEntry: "New Hanover Gazette No. 36" */:
			return joaat("NEWSPAPERS/NEWSPAPER_NH_10");
		case joaat("DOCUMENT_NEWSPAPER_ED_11_NH") /* GXTEntry: "New Hanover Gazette No. 37" */:
			return joaat("NEWSPAPERS/NEWSPAPER_NH_11");
		case joaat("DOCUMENT_NEWSPAPER_ED_12_NH") /* GXTEntry: "New Hanover Gazette No. 38" */:
			return joaat("NEWSPAPERS/NEWSPAPER_NH_12");
		case joaat("DOCUMENT_NEWSPAPER_ED_13_NH") /* GXTEntry: "New Hanover Gazette No. 39" */:
			return joaat("NEWSPAPERS/NEWSPAPER_NH_13");
		case joaat("DOCUMENT_NEWSPAPER_ED_14_NH") /* GXTEntry: "New Hanover Gazette No. 40" */:
		...
		case joaat("DOCUMENT_NEWSPAPER_ED_01_SD") /* GXTEntry: "Saint Denis Times No. 43" */:
			...
			{
				return joaat("NEWSPAPERS/NEWSPAPER_SD_01_B");
			}
			break;
		case joaat("DOCUMENT_NEWSPAPER_ED_02_SD") /* GXTEntry: "Saint Denis Times No. 44" */:
			return joaat("NEWSPAPERS/NEWSPAPER_SD_02");
		case joaat("DOCUMENT_NEWSPAPER_ED_03_SD") /* GXTEntry: "Saint Denis Times No. 45" */:
			return joaat("NEWSPAPERS/NEWSPAPER_SD_03");
		case joaat("DOCUMENT_NEWSPAPER_ED_04_SD") /* GXTEntry: "Saint Denis Times No. 46" */:
			return joaat("NEWSPAPERS/NEWSPAPER_SD_04");
		case joaat("DOCUMENT_NEWSPAPER_ED_05_SD") /* GXTEntry: "Saint Denis Times No. 47" */:
			return joaat("NEWSPAPERS/NEWSPAPER_SD_05");
		case joaat("DOCUMENT_NEWSPAPER_ED_06_SD") /* GXTEntry: "Saint Denis Times No. 48" */:
			return joaat("NEWSPAPERS/NEWSPAPER_SD_06");
		case joaat("DOCUMENT_NEWSPAPER_ED_07_SD") /* GXTEntry: "Saint Denis Times No. 49" */:
			return joaat("NEWSPAPERS/NEWSPAPER_SD_07");
		case joaat("DOCUMENT_NEWSPAPER_ED_08_SD") /* GXTEntry: "Saint Denis Times No. 50" */:
			return joaat("NEWSPAPERS/NEWSPAPER_SD_08");
		case joaat("DOCUMENT_NEWSPAPER_ED_09_SD") /* GXTEntry: "Saint Denis Times No. 51" */:
			return joaat("NEWSPAPERS/NEWSPAPER_SD_09");
		case joaat("DOCUMENT_NEWSPAPER_ED_10_SD") /* GXTEntry: "Saint Denis Times No. 52" */:
			return joaat("NEWSPAPERS/NEWSPAPER_SD_10");
		case joaat("DOCUMENT_NEWSPAPER_ED_11_SD") /* GXTEntry: "Saint Denis Times No. 53" */:
			return joaat("NEWSPAPERS/NEWSPAPER_SD_11");
		case joaat("DOCUMENT_NEWSPAPER_ED_12_SD") /* GXTEntry: "Saint Denis Times No. 54" */:
			return joaat("NEWSPAPERS/NEWSPAPER_SD_12");
		case joaat("DOCUMENT_NEWSPAPER_ED_13_SD") /* GXTEntry: "Saint Denis Times No. 55" */:
			return joaat("NEWSPAPERS/NEWSPAPER_SD_13");
		case joaat("DOCUMENT_NEWSPAPER_ED_14_SD") /* GXTEntry: "Saint Denis Times No. 56" */:
...
void func_74(int iParam0, var uParam1)
{
    ...
    "a." */
		...
		case 22:
			...
			break;
		case 23:
			(*uParam1)[1] = 694865154; /* GXTEntry: "BRAWL AT CHÂTENAY ART EXHIBITION" */
			(*uParam1)[2] = 992018002; /* GXTEntry: "ART EXHIBIT ENDS IN A ROW" */
			(*uParam1)[3] = 89821894; /* GXTEntry: "PATRONS ENGAGE IN FISTICUFFS" */
			(*uParam1)[5] = 2116883103; /* GXTEntry: @"A brawl broke out at an exhibition of the works of French artist Charles Châtenay, sending the Saint Denis art world into disarray and shock as several prominent art patrons were injured. Extensive damage was also reported to the gallery's permanent collection. The disruption is thought to have begun as a reaction to the crude, naïve art works, which were described as gaudily colorful and shocking in their detail." */
			(*uParam1)[6] = -305630760; /* GXTEntry: "One patron indicated that the horror of the work is to blame for the behavior of " +
    "the crowd, appealing to their most dour and base elements. Châtenay wasn\'t able " +
    "to be located for comment." */
			break;
		case 24:
			(*uParam1)[1] = -544747299; /* GXTEntry: "COLLECTORS RAVE ON CHÂTENAY" */
			(*uParam1)[2] = 1149473811; /* GXTEntry: "ART VALUES SOAR" */
			(*uParam1)[3] = 0;
			(*uParam1)[5] = 762780430; /* GXTEntry: @"In a remarkable exhibition at The Halston Gallery in New York City, a new series of works by French artist Charles Châtenay demanded huge sums and sold quickly. His previous work has failed to gain much critical success in Paris and Saint Denis, however the New York art world quickly embraced his crude, innocent style, and a new South Pacific subject matter, with critics saying the work shows a sensitivity lacking in seemingly accomplished artists of today, and that the primitive style and subject matter complement one another perfectly." */
...
void func_92(var uParam0, var uParam1, int iParam2)
{
	...
	if (UIAPPS::IS_UIAPP_RUNNING_BY_HASH(joaat("TRANSLATION_OVERLAY")))
	{
		...
		if (bVar2)
		{
			...
			{
				uParam1->f_1 = func_217("NEWS_PREV_ARTICLE" /* GXTEntry: "Previous Article" */, joaat("INPUT_DOCUMENT_PAGE_PREV"), 0, 570, 4000, 10, (1 << 30), 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
			}
		...
		if (bVar1)
		{
			if (!func_42(*uParam1))
			{
				*uParam1 = func_217("NEWS_NEXT_ARTICLE" /* GXTEntry: "Next Article" */, joaat("INPUT_DOCUMENT_PAGE_NEXT"), 0, 570, 4000, 10, (1 << 30), 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
			}
...
bool func_137()
{
	if (((((func_290(joaat("DOCUMENT_ARTHUR_MINOR_BOUNTY_1") /* GXTEntry: "Bounty Poster of Arthur" */, 400) || func_290(joaat("DOCUMENT_ARTHUR_MINOR_BOUNTY_2") /* GXTEntry: "Bounty Notice" */, 400)) || func_290(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_1") /* GXTEntry: "Bounty Hunter\'s Orders" */, 400)) || func_290(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_2") /* GXTEntry: "Poster of a Violent Criminal" */, 400)) || func_290(joaat("DOCUMENT_ARTHUR_HAS_POSTER_1") /* GXTEntry: "Bounty Hunter\'s Letter" */, 400)) || func_290(joaat("DOCUMENT_ARTHUR_HAS_POSTER_2") /* GXTEntry: "Bounty Page" */, 400))
	{
		return true;
	}
	return false;
...
void func_142(int iParam0)
{
	...
	switch (iParam0)
	{
		case joaat("DOCUMENT_TAXIDERMY_ORDER_1") /* GXTEntry: "Hunting Request" */:
			...
			func_105(437, 0);
			func_105(440, 0);
			func_302(joaat("TAXIDERMY_ORDER_01"), joaat("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT") /* GXTEntry: "Perfect Squirrel Carcass" */, &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_2") /* GXTEntry: "Hunting Request" */:
			...
			func_302(joaat("TAXIDERMY_ORDER_02"), joaat("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT") /* GXTEntry: "Perfect Cardinal Carcass" */, &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_3") /* GXTEntry: "Hunting Request" */:
			...
			func_302(joaat("TAXIDERMY_ORDER_03"), joaat("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT") /* GXTEntry: "Perfect Chipmunk Carcass" */, &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_4") /* GXTEntry: "Hunting Request" */:
			...
			func_302(joaat("TAXIDERMY_ORDER_04"), joaat("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT") /* GXTEntry: "Perfect Songbird Carcass" */, &cVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_5") /* GXTEntry: "Hunting Request" */:
			...
			func_105(438, 0);
			func_302(joaat("TAXIDERMY_ORDER_05"), joaat("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT") /* GXTEntry: "Perfect Cedar Waxwing Carcass" */, &cVar0, 1, 0, 0);
...
void func_177(int iParam0, char* sParam1)
{
	...
	func_352(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP" /* GXTEntry: "~1w~ ~2~" */, sParam1, sVar0), "inventory_items", func_351(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_178(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	strcpy_s(&cVar2, 32, func_355(iVar1 == 1, "ITEM_GET_PUMP" /* GXTEntry: "~1~" */, "ITEM_GET_PUMP_MULT" /* GXTEntry: "~2~x ~1~" */));
	if (iParam1 > 0)
	{
	}
	else
...
struct<5> /*40*/ func_234(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_115(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_272(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_390(iParam0, 1))
			{
				...
				if (!func_270(iParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_270(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_271(iParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_272(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
...
bool func_238(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_230(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_271(iParam0, &sVar4, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
			{
				return false;
			}
			if (func_390(iParam0, 1))
			{
				if (!func_270(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					return false;
				}
				else if (func_271(iParam0, &sVar4, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */))
				{
					return false;
				}
			}
...
char* func_252(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6)
{
	switch (iParam1)
	{
		case joaat("CIGARETTE_CARDS"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_CC_CARD_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Card Sets Posted" */, func_415(), 12);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_CC_CARD_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Card Sets Found" */, func_416(), 12);
			}
			break;
		case joaat("DINO_BONES"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_DB_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Dinosaur Bones Posted" */, func_417(), 30);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_DB_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Dinosaur Bones Found" */, func_300(), 30);
			}
			break;
		...
		case joaat("LEGENDARY_FISH"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_LF_CAUGHT_OBJ" /* GXTEntry: "~1~ of ~2~ Legendary Fish Caught and Posted" */, func_418(), 13);
			}
			break;
		case joaat("ROCK_CARVINGS"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_RC_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Rock Faces Posted" */, func_419(), 10);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_RC_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Rock Faces Found" */, func_301(), 10);
			}
			break;
		case joaat("TAXIDERMY"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_TX_CARCASS_COLLECTED_OBJ" /* GXTEntry: "~1~ of ~2~ Carcasses Collected" */, sParam4, func_251(iParam6, 20));
			}
			break;
	}
	return sParam3;
...
void func_265(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_261("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_MANUAL_PAINT" /* GXTEntry: "Manual Painting" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_261("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_STAY_ACTIVE" /* GXTEntry: "Continued Free Fire" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_261("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_FATAL" /* GXTEntry: "Fatal Region Highlights" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_261("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_CRITICAL" /* GXTEntry: "Critical Region Highlights" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
...
void func_293(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iParam0 += iVar2;
		iVar1 += iVar2;
		func_352(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN" /* GXTEntry: "Total Take ~1$~" */, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_TOTAL_TAKE"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		iParam0 -= iVar0;
		if (iVar0 > 0)
		{
			func_460(iVar0);
		...
		func_352(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN" /* GXTEntry: "Your Share ~1$~" */, iVar1), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
void func_340(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_508(MISC::VAR_STRING(10, "OUT_JOURN_DONE" /* GXTEntry: "~1~ completed." */, MISC::VAR_STRING(0, iVar0)), 10000, 0, 0, 0, 1);
	}
	func_509(iParam0, 6);
	if (bParam2)
	{
...
{
	if (func_562(iParam0, joaat("DEFAULT") /* GXTEntry: "_" */) == 0)
	{
		return false;
	}
	return true;
...
void func_443()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_123(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN") /* GXTEntry: "John\'s Cattleman Revolver" */);
		func_171(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN") /* GXTEntry: "John\'s Cattleman Revolver" */, 1, joaat("ADD_REASON_DEFAULT"));
		...
		func_123(joaat("WEAPON_MELEE_KNIFE_JOHN") /* GXTEntry: "John\'s Knife" */);
		func_171(joaat("WEAPON_MELEE_KNIFE_JOHN") /* GXTEntry: "John\'s Knife" */, 1, joaat("ADD_REASON_DEFAULT"));
...
int func_479(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	bVar0 = func_597(0);
	if (iParam2 != 0 && func_598(iParam0, bVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
void func_504(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_503(iParam0))
	{
		...
		if ((!func_507() && !bParam1) && !func_50(0, 0, 1))
		{
			func_508(MISC::VAR_STRING(10, "OUT_JOURN_ADD" /* GXTEntry: "~1~ discovered." */, func_612(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
void func_570(int iParam0, int iParam1, int iParam2)
{
	...
	func_259(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC" /* GXTEntry: "Hold ~INPUT_FEED_INTERACT~ for details" */, func_659(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_578()
{
	...
	func_663(0);
	func_664(7);
	func_665(joaat("KIT_BANDANA") /* GXTEntry: "Bandana" */, 1, 1, 0);
	if (func_341() == joaat("MPC_PLAYER_TYPE_SP_MARSTON"))
	{
		func_665(joaat("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000") /* GXTEntry: "John\'s Classic Hat" */, 1, 1, 1);
		func_665(joaat("CLOTHING_SP_MAR_OUTFIT_GUNSLINGER") /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_355(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD" /* GXTEntry: "Cold" */, "PMPLAYER_CONDITION_TEMPERATURE_HOT" /* GXTEntry: "Hot" */);
					}
					break;
				case 2:
					return func_355(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD" /* GXTEntry: "Good" */, "PMPLAYER_CONDITION_HONOR_BAD" /* GXTEntry: "Bad" */);
			}
			break;
		case 1:
		case 2:
...
void func_776(var uParam0, var uParam1, int iParam2)
{
	...
	uParam0->f_1 = PED::_REQUEST_META_PED_COMPONENT(iVar0, uParam1, 0, func_122() != -1, iParam2);
	*uParam0 = 1;
}
