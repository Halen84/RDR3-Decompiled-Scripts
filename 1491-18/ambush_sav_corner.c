...
bool func_16()
{
	...
	sLocal_274.f_61[iVar0] = PED::_CREATE_META_PED_OUTFIT_PED(sLocal_274.f_13[iVar0], vVar1, fVar4, true, true, true, false);
	if (ENTITY::DOES_ENTITY_EXIST(sLocal_274.f_61[iVar0]))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(sLocal_274.f_61[iVar0], true);
		PED::SET_PED_CONFIG_FLAG(sLocal_274.f_61[iVar0], 277 /*PCF_0x5FE313B3*/, true);
		...
		PED::SET_PED_CONFIG_FLAG(sLocal_274.f_61[iVar0], 38 /*PCF_RemoveDeadExtraFarAway*/, false);
	}
	else
	{
		uLocal_15.f_220--;
...
bool func_20()
{
	...
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(uLocal_15[iVar0], 0, 1))
		{
			...
			func_131(uLocal_15[iVar0], joaat("WEAPON_MELEE_KNIFE") /* GXTEntry: "Hunting Knife" */, 1, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
			switch (iVar0)
			{
				case 0:
					func_132(uLocal_15[iVar0], joaat("WEAPON_BOW") /* GXTEntry: "Bow" */, 1, 0);
					break;
				case 1:
					func_132(uLocal_15[iVar0], joaat("WEAPON_BOW") /* GXTEntry: "Bow" */, 1, 1);
					break;
				case 2:
...
void func_75()
{
	...
	if (uLocal_15.f_19 < uLocal_15.f_215)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_15[iVar0]))
		{
			...
			{
				if (func_225(uLocal_15[iVar0], 200.0f, -1082130432 /* Float: -1f */, uLocal_15.f_9[iVar0], -1082130432 /* Float: -1f */))
				{
	...
	else if (uLocal_15.f_19 < (uLocal_15.f_215 + uLocal_15.f_216))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_15.f_40[iVar0]))
		{
			...
			{
				if (func_225(uLocal_15.f_40[iVar0], 200.0f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
				{
	...
	else if (uLocal_15.f_19 < ((uLocal_15.f_215 + uLocal_15.f_216) + uLocal_15.f_217))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_15.f_49[iVar0]))
		{
			if (!func_232(&uLocal_15, iVar0, 8))
			{
				...
				{
					if (func_233(uLocal_15.f_49[iVar0], 200.0f, -1082130432 /* Float: -1f */))
					{
...
int func_92(int iParam0)
{
	if (uLocal_15.f_57[iParam0] == 0)
	{
		...
		{
			uLocal_15.f_57[iParam0] = func_256(joaat("HORSE_CLASS_RIDING") /* GXTEntry: "Riding" */, 1);
		}
		else
		{
...
bool func_95()
{
	switch (sLocal_274.f_0)
	{
		...
		case 1:
			...
			sLocal_274.f_13[0] = PED::_REQUEST_META_PED_OUTFIT(joaat("A_M_M_UNICORPSE_01"), -2024019335);
		...
		case 2:
			...
			if (!PED::_HAS_META_PED_OUTFIT_LOADED(sLocal_274.f_13[0]))
			{
				return false;
			}
			sLocal_274.f_0 = 3;
...
void func_132(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	switch (iParam1)
	{
		case joaat("GROUP_REVOLVER"):
			if (func_281(joaat("WEAPON_REVOLVER_DOUBLEACTION") /* GXTEntry: "Double-Action Revolver" */))
			{
				iParam1 = joaat("WEAPON_REVOLVER_DOUBLEACTION"); /* GXTEntry: "Double-Action Revolver" */
			}
			else if (func_281(joaat("WEAPON_REVOLVER_DOUBLEACTION") /* GXTEntry: "Double-Action Revolver" */))
			{
				iParam1 = joaat("WEAPON_REVOLVER_SCHOFIELD"); /* GXTEntry: "Schofield Revolver" */
			}
			break;
		case joaat("GROUP_REPEATER"):
			if (func_281(joaat("WEAPON_REPEATER_HENRY") /* GXTEntry: "Litchfield Repeater" */))
			{
				iParam1 = joaat("WEAPON_REPEATER_HENRY"); /* GXTEntry: "Litchfield Repeater" */
			}
			break;
	}
...
void func_148()
{
	if (!func_116(&sLocal_274, 2))
	{
		if (!func_116(&sLocal_274, (1 << 14)))
		{
			...
			{
				if (func_301(Global_35, sLocal_274.f_61[0], "AMBUSH_SCR_BODY_REACT", -1082130432 /* Float: -1f */, 1, joaat("SPEECH_PARAMS_BEAT_SPOKEN_CRITICAL")))
				{
...
void func_149()
{
	...
	if (uLocal_15.f_227)
	{
		...
		{
			if (func_304(uLocal_15[0], joaat("BLINEHOLA"), "bLineHola", func_303(), 1067030938 /* Float: 1.2f */, 1))
			{
	...
	{
		if (func_304(uLocal_15[0], joaat("BLINEYELL"), "bLineYell", func_303(), 1067030938 /* Float: 1.2f */, 1))
		{
			func_305(&sLocal_274, 0, 2);
		}
	}
	...
	if (!func_302(&sLocal_274, 0, 2))
	{
		if (func_304(uLocal_15[0], joaat("BLINEBYPASS"), "bLineBypass", func_303(), 1067030938 /* Float: 1.2f */, 1))
		{
			func_305(&sLocal_274, 0, 2);
		}
	}
...
void func_169()
{
	...
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(uLocal_15[iVar0], 0, 1))
		{
			...
			{
				func_301(uLocal_15[iVar0], 0, "AMBUSH_SCR_ADJUST", -1082130432 /* Float: -1f */, 1, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CLEAR"));
...
void func_171()
{
	...
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(uLocal_15[iVar0], 0, 1))
		{
			...
			if (MISC::ARE_STRINGS_EQUAL(sVar2, "0257_G_M_M_UniMountainMen_02_WHITE_01") || MISC::ARE_STRINGS_EQUAL(sVar2, "0258_G_M_M_UniMountainMen_02_WHITE_02"))
			{
				func_301(uLocal_15[iVar0], 0, "AMBUSH_SCR_ADVANCE", -1082130432 /* Float: -1f */, 1, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CLEAR"));
...
void func_172()
{
	...
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(uLocal_15[iVar0], 0, 1))
		{
			...
			if (MISC::ARE_STRINGS_EQUAL(sVar2, "0257_G_M_M_UniMountainMen_02_WHITE_01") || MISC::ARE_STRINGS_EQUAL(sVar2, "0258_G_M_M_UniMountainMen_02_WHITE_02"))
			{
				func_301(uLocal_15[iVar0], 0, "AMBUSH_SCR_FLEE", -1082130432 /* Float: -1f */, 1, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CLEAR"));
...
bool func_175()
{
	...
	if (WEAPON::IS_PED_CARRYING_WEAPON(uLocal_15[sLocal_274.f_68], joaat("WEAPON_MELEE_KNIFE") /* GXTEntry: "Hunting Knife" */))
	{
		iVar0 = joaat("WEAPON_MELEE_KNIFE"); /* GXTEntry: "Hunting Knife" */
	}
	else if (WEAPON::IS_PED_CARRYING_WEAPON(uLocal_15[sLocal_274.f_68], joaat("WEAPON_MELEE_HATCHET_MELEEONLY") /* GXTEntry: "Hatchet (Melee Only)" */))
	{
...
{
	if (func_366(iParam1, 1114636288 /* Float: 60f */) || func_368(iParam1, 1, 1) <= 30.0f)
	{
		return false;
	}
	return true;
...
void func_254(var uParam0, float fParam1)
{
	...
	func_382(uParam0->f_237, "ambush_restriction", 1, 0, (1 << 9), 0, -1082130432 /* Float: -1f */);
	vVar0 = { uParam0->f_209 + Vector(-40.0f, -fParam1, -fParam1) /*3*/ };
	vVar3 = { uParam0->f_209 + Vector(40.0f, fParam1, fParam1) /*3*/ };
	vVar6 = { func_369(vVar0, vVar3, 0) /*3*/ };
	vVar9 = { func_370(vVar0, vVar3, 0) /*3*/ };
...
int func_280(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == joaat("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case joaat("GROUP_SHOTGUN"):
			case joaat("GROUP_RIFLE"):
				if (func_281(joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */))
				{
...
void func_291()
{
	if (!func_116(&sLocal_274, (1 << 15)))
	{
		...
		{
			if (func_301(uLocal_15[3], Global_35, "ARRIVAL_ENTER_TRAP", -1082130432 /* Float: -1f */, 1, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CLEAR")))
			{
...
bool func_321(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_430(iParam0, joaat("CURRENCY_CASH") /* GXTEntry: "Money" */, iParam1, iVar0);
	}
...
void func_435(var uParam0, int iParam1, int iParam2)
{
	...
	{
		uVar6 = 1;
		iVar8 = func_513(&uVar1, &uVar6, 4, ENTITY::GET_ENTITY_COORDS((*uParam0)[iParam1], true, false), 10.0f, 0, 1, 1, joaat("ANIMAL_HORSE"), 1, 0, -1082130432 /* Float: -1f */, 0, 0);
		iVar9 = 0;
		while (iVar9 < iVar8)
		{
	...
	switch (func_524(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_526(iParam0, 1))
			{
				...
				if (!func_462(iParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_462(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_463(iParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
...
char* func_626(char* sParam0, int iParam1)
{
	...
	return func_637(MISC::VAR_STRING(10, "PLAYER_STRING" /* GXTEntry: "~fg~~1p~~fo~" */, sParam0), iParam1);
}
