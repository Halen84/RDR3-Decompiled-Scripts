...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -4.0f, 0.0f, 0.0f, -155.0f, 4.0f, 4.0f, 2.5f, joaat("VOLCYLINDER"), -1, 1, 1, 1);
	func_152(uParam0, joaat("P_SHEEPSHEERS01X"), 0.0f, 0.0f, 0.0f, "SHEERS", 0, 1, 1);
	...
	sLocal_29 = { func_156(uParam0, -1.0025f, -1.4119f, 1.1388f, 57.2941f, 6.5f, 0.5f, 0.5f) /*10*/ };
	func_157(uParam0, "BUNC1AU");
	func_158(uParam0, 3.0f, 20.0f);
...
bool func_89(var uParam0)
{
	...
	return func_192(uParam0, sLocal_29, 1, 0);
}
...
bool func_93(var uParam0)
{
	...
	{
		func_111(&uLocal_23, 0.0f);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(func_8(uParam0, iLocal_14), true);
		TASK::OPEN_SEQUENCE_TASK(&iVar0);
		TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, -1584.05f, -1433.536f, 80.3732f, fLocal_21, -1, 0.25f, 4194305, 40000.0f);
		TASK::TASK_START_SCENARIO_AT_POSITION(0, joaat("WORLD_ANIMAL_SHEEP_EATING_GROUND"), -1608.52f, -1419.41f, 80.95f, 44.308f, 30000, true, false, 0, -1.0f, false);
...
bool func_95(var uParam0)
{
	...
	else if (func_109(&uLocal_23) > 15.0f)
	{
		return true;
	}
	return false;
...
void func_304(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_344(100.0f, 140.0f);
			}
		}
