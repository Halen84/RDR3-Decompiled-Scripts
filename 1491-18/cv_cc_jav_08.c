...
void __SCRIPT()
{
	...
	fLocal_7 = 1.0f;
	fLocal_8 = 1.0f;
	iLocal_55 = joaat("WEAPON_REVOLVER_DOUBLEACTION"); /* GXTEntry: "Double-Action Revolver" */
	sVar0 = -1;
	sVar0.f_1 = -1;
	sVar0.f_2 = -1;
	sVar0.f_17 = 10;
...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -2.3021f, -3.5906f, 0.0f, 0.0f, 1.3f, 1.3f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	func_150(uParam0, 0.1375f, 0.2f, 0.6f, 2.0f, 3.7175f, 3.495f, 2.685f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_151(uParam0, -0.32f, -1.6f, 1.0028f, 0.0f, 1.3f, 1.3f, 2.0f, joaat("VOLCYLINDER"), 1);
	iLocal_14 = func_152(uParam0, 6, 0);
	iLocal_15 = func_152(uParam0, 2, 0);
	func_153(uParam0, joaat("P_CIGARETTE_CS01X"), 0.0f, 0.0f, 0.0f, "CIGARETTE", 0, 0, 1);
	func_153(uParam0, joaat("P_CHAIR_BARREL04B"), -0.584473f, -1.37158f, -0.00269318f, "CHAIRBARREL", 1, 0, 1);
	iLocal_30 = func_153(uParam0, joaat("P_CS_RAG02X"), 0.0f, 0.0f, 0.0f, "RAG", 0, 0, 1);
	...
	sLocal_31 = { func_155(uParam0, 1.2835f, -0.326f, 0.9877f, -174.0f, 6.0f, 0.41f, 0.19f) /*10*/ };
	sLocal_41 = { func_155(uParam0, 1.284f, -0.5185f, 0.9877f, 52.0f, 5.0f, 0.424f, 0.459f) /*10*/ };
	...
	func_158(uParam0, iLocal_14, 3, joaat("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", iLocal_29, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	if (!WEAPON::HAS_PED_GOT_WEAPON(func_48(uParam0, iLocal_14), iLocal_55, 0, false))
	{
		WEAPON::GIVE_WEAPON_TO_PED(func_48(uParam0, iLocal_14), iLocal_55, 1, true, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), true, 0.0f, false);
	}
	else
	{
...
bool func_93(var uParam0)
{
	...
	{
		if (func_205(uParam0, sLocal_31, 1, 0))
		{
		...
		else if (func_205(uParam0, sLocal_41, 1, 0))
		{
			fLocal_52 = MISC::GET_DISTANCE_BETWEEN_COORDS(Global_36, func_206(uParam0, 1.375f, -0.663f, 0.472f), true);
			iLocal_51 = iLocal_19;
...
{
	uParam0->f_23 = { func_259(iParam1) + Vector(fParam4, fParam3, fParam2) /*3*/ };
	uParam0->f_26 = { func_260(iParam1) /*3*/ };
}
...
int func_150(var uParam0, Vector3 vParam1, float fParam4, Vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_206(uParam0, vParam1) /*3*/ };
...
struct<10> /*80*/ func_155(var uParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	float fVar0;
	float fVar1;
	struct<10> /*80*/ sVar2;
	...
	sVar2 = { func_206(uParam0, vParam1) /*3*/ };
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0 /*15*/].f_5 && !ENTITY::DOES_ENTITY_EXIST(uParam0->f_1711[iVar0 /*15*/].f_10))
			{
				...
				{
					vVar3 = { func_206(uParam0, uParam0->f_1711[iVar0 /*15*/].f_1) /*3*/ };
				}
				else
				{
...
void func_189(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_206(uParam0, uParam0->f_1976.f_1), 1, func_261(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
void func_196(var uParam0, int iParam1, char* sParam2)
{
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		{
			func_303(*iParam1, uParam0->f_1984[iVar0], sParam2);
		}
		iVar0++;
	}
}
...
int func_208(var uParam0)
{
	...
	switch (uParam0->f_1699)
	{
		case 0:
			...
			break;
		case 1:
			uParam0->f_1707 = func_315("INTERACT_INSULT" /* GXTEntry: "Antagonize" */, joaat("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, (1 << 30), 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
			func_316(uParam0->f_1707, iVar0, 0, 1, -1);
			if (uParam0->f_1709)
			{
				uParam0->f_1708 = func_315("INTERACT_GREET" /* GXTEntry: "Greet" */, joaat("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, (1 << 30), 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
		...
		case 3:
			...
			func_319(Global_35, &sVar1, 0, iVar0, 1, 0, 0, 1);
			uParam0->f_1699++;
			break;
		case 4:
			if (!AUDIO::IS_ANY_SPEECH_PLAYING(Global_35))
			{
				...
				func_319(iVar0, &sVar1, 0, Global_35, 1, 0, 0, 1);
				uParam0->f_1699++;
			}
			break;
		case 5:
...
void func_209(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_321(100.0f, 140.0f);
			}
		}
...
bool func_277(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1 /*15*/].f_5)
		{
			...
			{
				vVar2 = { func_206(uParam0, uParam0->f_1711[iVar1 /*15*/].f_1) /*3*/ };
			}
			else
			{
...
int func_315(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, float fParam8, bool bParam9, int iParam10, int iParam11, bool bParam12)
{
	int iVar0;
	int iVar1;
