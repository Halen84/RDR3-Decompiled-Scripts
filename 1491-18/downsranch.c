...
bool func_11()
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -861.1559f, 337.3949f, 97.83562f, 0.0f, 0.0f, -10.52764f, 11.36256f, 15.17971f, 10.22759f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -864.7891f, 321.0681f, 94.98614f, 0.0f, 0.0f, -10.52764f, 8.645713f, 12.50398f, 4.525191f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -62.5439f, -392.4335f, 72.1382f, 0.0f, 0.0f, 29.04495f, 7.979648f, 6.063315f, 6.900121f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -851.4187f, 361.481f, 97.83562f, 0.0f, 0.0f, -13.36656f, 0.863879f, 8.798125f, 5.594934f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -846.2698f, 364.2993f, 96.90186f, 0.0f, 0.0f, -7.59012f, 9.607594f, 16.13778f, 4.525191f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -854.8633f, 319.2234f, 94.98614f, 0.0f, 0.0f, -10.52763f, 11.77066f, 11.27451f, 4.525191f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -790.8695f, 346.954f, 98.00078f, 0.0f, 0.0f, -8.615136f, 13.37762f, 8.146093f, 7.736006f);
		...
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -817.6839f, 353.5158f, 98.00078f, 0.0f, 0.0f, -9.719018f, 10.09804f, 10.20509f, 7.736006f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -874.6434f, 323.2318f, 94.98614f, 0.0f, 0.0f, -10.52763f, 12.96012f, 12.50398f, 4.525191f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -883.0225f, 334.1583f, 94.98614f, 0.0f, 0.0f, -23.19702f, 8.645713f, 14.33108f, 4.525191f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -857.598f, 357.7791f, 94.98614f, 0.0f, 0.0f, -4.378916f, 9.184352f, 2.478699f, 4.525191f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -868.0872f, 338.0298f, 94.98614f, 0.0f, 0.0f, -10.52763f, 22.80199f, 22.79938f, 4.525191f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -859.0131f, 352.2604f, 94.98614f, 0.0f, 0.0f, -10.52763f, 9.726913f, 9.194143f, 4.525191f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -868.4409f, 352.2944f, 95.5f, 0.0f, 0.0f, 121.5158f, 4.6843f, 11.06676f, 5.382992f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -879.6567f, 344.2453f, 95.5f, 0.0f, 0.0f, -38.53438f, 2.935173f, 7.713624f, 5.382992f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -882.3352f, 327.0211f, 95.5f, 0.0f, 0.0f, 156.2253f, 7.625237f, 7.713624f, 5.382992f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_19, -810.5886f, 353.7103f, 98.00078f, 0.0f, 0.0f, -9.719017f, 3.779373f, 6.791281f, 7.736006f);
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -858.1369f, 346.6224f, 95.5f, 0.0f, 0.0f, -0.107f, 36.56057f, 35.55415f, 44.0f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_18, -815.7545f, 352.5984f, 105.6908f, 0.0f, 0.0f, -12.06673f, 85.78142f, 37.62513f, 28.168f);
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_17, -834.0826f, 345.0585f, 95.5f, 0.0f, 0.0f, -0.107f, 73.14397f, 44.90614f, 45.70249f);
		...
		LAW::_SET_GUARD_ZONE_VOLUME_RESTRICTED(sLocal_15, iLocal_18);
		LAW::_SET_GUARD_ZONE_VOLUME_THREAT(sLocal_15, iLocal_19);
...
int func_59(int iParam0)
{
	...
	iVar0 = PERSCHAR::_GET_PERSCHAR_PED_INDEX(func_56(iParam0));
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_60(iParam0) && func_88(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
...
void func_83(int iParam0)
{
	...
	func_130(0.775f, 0.2f, 0.025f, 0.0f);
...
char* func_116(char* sParam0, int iParam1)
{
	...
	return func_150(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}
...
void func_132(int iParam0)
{
	...
	func_157(iParam0, (1 << 13));
	func_157(iParam0, (1 << 14));
	func_157(iParam0, (1 << 15));
	func_157(iParam0, (1 << 17));
	func_157(iParam0, (1 << 24));
	func_157(iParam0, (1 << 19));
	func_157(iParam0, (1 << 20));
...
bool func_144(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_98(iVar0) && func_172(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_160(int iParam0, bool bParam1)
{
	...
	else if (func_179(iParam0, (1 << 10)))
	{
		func_181(iParam0, (1 << 10));
		INVENTORY::_0x9B4E793B1CB6550A();
	}
	func_182(iParam0);
}
