...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			func_149(uParam0, -154.916f, -33.909f, 94.234f, 0.0f, 0.0f, 23.118f);
			break;
		default:
			return false;
	}
	...
	func_151(uParam0, -2.2125f, -3.875f, 1.4875f, 0.0f, 2.0f, 2.0f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_ADLERS"), 1, 1, 1);
	if (!func_152(10))
	{
	...
	if (func_152(10))
	{
		...
		func_157(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_SAD"), "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", -1, 0, -1.0f, 1065353216 /* Float: 1f */, 1);
...
void func_162(var uParam0, int iParam1, Vector3 vParam2, float fParam5, int iParam6, bool bParam7)
{
	if (bParam7)
	{
		vParam2 = { func_252(uParam0, vParam2) /*3*/ };
