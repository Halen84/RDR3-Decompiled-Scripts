...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 1.3527f, 1.6955f, 1.0578f, -94.52f, 2.8f, 2.8f, 3.0f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_153(uParam0, 1.35f, 1.65f, 0.0f, 0.0f, 1.5f, 1.5f, 3.0f, joaat("VOLCYLINDER"), 1);
	func_154(uParam0, joaat("P_CS_BUCKET01BX"), 0.0f, 0.0f, 0.0f, "BUCKET" /* GXTEntry: "Bucket" */, 0, 0, 1);
	func_154(uParam0, joaat("P_STOOL02X"), 0.0f, 0.0f, 0.0f, "STOOL" /* GXTEntry: "Stool" */, 0, 0, 1);
	...
	iLocal_18 = func_159(uParam0, -2.25f, 2.1f, 1.95f, 0.0f, 0.0f, -4.0f, 10.75f, 7.48f, 4.0f, "volTrigger", joaat("VOLBOX"));
	func_160(uParam0, 1);
...
{
	PED::_SET_PED_SCALE(uParam0->f_107[iLocal_17 /*113*/].f_5, 1.0f);
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		TASK::TASK_START_SCENARIO_IN_PLACE_HASH(func_48(uParam0, iLocal_17), joaat("STAND"), 0, false, 0, -1.0f, false);
...
bool func_95(var uParam0)
{
	...
	if (ENTITY::IS_ENTITY_OCCLUDED(func_48(uParam0, iLocal_17)) && func_208(func_48(uParam0, iLocal_17), Global_35, 1) >= 144.0f)
	{
