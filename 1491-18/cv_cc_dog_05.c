...
bool func_72(var uParam0)
{
	...
	func_153(uParam0, joaat("P_KNIFE02X"), 0.0f, 0.0f, 0.0f, "Knife" /* GXTEntry: "Knife" */, 0, 1, 1);
...
int func_342(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_380(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) /*3*/ };
