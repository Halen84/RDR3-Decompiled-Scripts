...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -3.55f, -5.1475f, 0.0f, 0.0f, 1.0f, 1.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	func_150(uParam0, -0.5375f, 0.3275f, 0.0f, -25.0f, 2.1825f, 4.2175f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	iLocal_16 = func_151(uParam0, joaat("P_CS_RAG02X"), 0.0f, 0.0f, 0.0f, "RAG", 0, 0, 1);
