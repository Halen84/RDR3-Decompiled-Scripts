		...
		case 1:
			...
			if (((((bVar0 && !PED::IS_PED_CARRYING_SOMETHING(Global_35)) && func_12(0)) && !Global_1327590.f_19745) && !TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1)) && !(WEAPON::GET_CURRENT_PED_WEAPON(Global_35, &iVar2, true, 0, true) && (iVar2 == joaat("WEAPON_KIT_CAMERA") || iVar2 == joaat("WEAPON_KIT_BINOCULARS"))))
			{
				if (!MAP::DOES_BLIP_EXIST(iLocal_31))
				{
					...
					MAP::SET_BLIP_SPRITE(iLocal_31, joaat("BLIP_MG_POKER") /* GXTEntry: "Poker" */, true);
					func_13(iLocal_31, func_8());
					iVar3 = func_14(joaat("CA_POKER_CAMP"));
					if (iVar3 != 0)
					{
				...
				if (!func_4(iLocal_14))
				{
					iLocal_14 = func_16(func_15(joaat("CA_POKER_CAMP")), joaat("INPUT_CONTEXT_X"), vLocal_23, fLocal_27, 1, 1, 0, 5, 570, 4000, 10, (1 << 30), 0, joaat("MEDIUM_TIMED_EVENT"), 0);
				}
				else
				{
...
bool func_12(int iParam0)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			if (!func_63(joaat("CA_POKER_CAMP")))
			{
				return false;
			}
			if (!(iVar2 < 2 || iVar2 > 10))
			...
			if (func_64(joaat("CA_POKER_CAMP")))
			{
				return false;
			}
			break;
		case 1:
			...
			if (!func_63(joaat("CA_DOMINOES_CAMP")))
			{
				return false;
			}
			if (!(iVar2 > 6 && iVar2 < 20))
			...
			if (func_64(joaat("CA_DOMINOES_CAMP")))
			{
				return false;
			}
			break;
...
int func_126(int iParam0, int iParam1)
{
	...
	{
		return func_185(0, func_184(iParam1, 1), 11, joaat("CABR01") /* GXTEntry: "High and Low Finance" */);
	}
		...
		case 0:
			switch (iParam1)
			{
				case 1:
					...
					{
						return func_335(bParam3, "PMPLAYER_CONDITION_TEMPERATURE_COLD" /* GXTEntry: "Cold" */, "PMPLAYER_CONDITION_TEMPERATURE_HOT" /* GXTEntry: "Hot" */);
					}
					break;
				case 2:
					return func_335(bParam2, "PMPLAYER_CONDITION_HONOR_GOOD" /* GXTEntry: "Good" */, "PMPLAYER_CONDITION_HONOR_BAD" /* GXTEntry: "Bad" */);
			}
			break;
		case 1:
		case 2:
