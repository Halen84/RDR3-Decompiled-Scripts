...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_48(uParam0, 4, "carcass" /* GXTEntry: "Carcass" */, joaat("A_C_DEER_01"), vParam1, vParam4.z, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
bool func_28(var uParam0)
{
	...
	PED::_REQUEST_MOTION_TYPE_ASSET(joaat("PANIC_REACTION"), uParam0->f_20[2 /*14*/]);
	if ((!PED::HAS_MOTION_TYPE_ASSET_LOADED(joaat("PANIC_REACTION"), uParam0->f_20[0 /*14*/]) || !PED::HAS_MOTION_TYPE_ASSET_LOADED(joaat("PANIC_REACTION"), uParam0->f_20[1 /*14*/])) || !PED::HAS_MOTION_TYPE_ASSET_LOADED(joaat("PANIC_REACTION"), uParam0->f_20[2 /*14*/]))
	{
		return false;
	}
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[4 /*14*/]))
	{
		...
		PED::SET_PED_CONFIG_FLAG(uParam0->f_20[4 /*14*/], 243 /*PCF_0x0831CCD1*/, true);
				...
				if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(uParam0->f_3.f_1, "pbl_action"))
						{
							...
							while (iVar0 <= 2)
							{
								if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[iVar0 /*14*/], joaat("PREPARE_FLEE")))
								{
