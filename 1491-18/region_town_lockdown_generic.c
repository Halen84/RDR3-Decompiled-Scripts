	...
	if (iLocal_145 < 13)
	{
		if (!func_47(sLocal_65[iLocal_145 /*6*/]))
		{
			...
			if (func_8(sLocal_65[iLocal_145 /*6*/].f_5, 0))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(sLocal_65[iLocal_145 /*6*/].f_5, joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */, 100, true, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
...
bool func_23()
{
	...
	if (iLocal_145 < 3)
	{
		...
		else if ((iLocal_145 % 3) == 0)
		{
			...
			{
				WEAPON::GIVE_WEAPON_TO_PED(sLocal_44[iLocal_144 /*5*/][iLocal_145], joaat("WEAPON_MELEE_TORCH") /* GXTEntry: "Torch" */, 100, true, false, 1, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
			}
		}
		else
		{
			WEAPON::GIVE_WEAPON_TO_PED(sLocal_44[iLocal_144 /*5*/][iLocal_145], joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */, 100, true, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
		}
		iLocal_145++;
	}
	else
