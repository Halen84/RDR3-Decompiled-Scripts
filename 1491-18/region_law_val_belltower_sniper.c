...
void func_16()
{
	...
	WEAPON::GIVE_WEAPON_TO_PED(iLocal_42, joaat("WEAPON_SNIPERRIFLE_CARCANO") /* GXTEntry: "Carcano Rifle" */, 999, true, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
