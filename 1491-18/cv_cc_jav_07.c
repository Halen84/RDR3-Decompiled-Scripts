...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.4375f, -0.4375f, 0.993f, -46.8f, 3.0f, 3.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	func_151(uParam0, -2.8108f, -2.6885f, 0.9931f, 134.1287f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	sLocal_21 = { func_152(uParam0, -0.925f, -0.76f, 1.07f, -32.5f, 6.5f, 0.4725f, 0.96f) /*10*/ };
	iLocal_20 = func_153(uParam0, joaat("P_BOTTLEBEER01X"), 0.0f, 0.0f, 0.0f, "BOTTLE", 0, 1, 1);
	iLocal_19 = func_153(uParam0, joaat("P_CHAIR_BARREL04B"), -0.584473f, -1.37158f, 0.0f, 0, 1, 0, 1);
...
bool func_93(var uParam0)
{
	...
	{
		PED::FORCE_PED_MOTION_STATE(func_48(uParam0, iLocal_18), joaat("MOTIONSTATE_JOG"), false, 1, false);
	}
	return true;
}
...
struct<10> /*80*/ func_152(var uParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	float fVar0;
	float fVar1;
	struct<10> /*80*/ sVar2;
