...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	if (uParam0->f_489 == 1)
	{
		func_49(uParam0, 1, "ACR_ANIMAL", iVar1, vParam1 + Vector(0.0f, 2.0f, 2.0f), vParam4.z, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	}
}
...
int func_31(var uParam0)
{
	...
	if (!bLocal_43)
	{
		if (func_61(uParam0, &uLocal_15, 0))
		{
			...
			{
				TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], Global_35, 3, 0, -1.0f, -1, 0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				TASK::TASK_FLEE_PED(uParam0->f_20[1 /*14*/], Global_35, 3, 0, -1.0f, -1, 0);
			}
			if (!bLocal_44)
			{
	...
	switch (iLocal_14)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uParam0->f_20[0 /*14*/], Global_36, 2.0f, -1, 0.25f, 0, 40000.0f);
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]) && uParam0->f_489 == 1)
				{
					...
					PED::_SET_PED_INTERACTION_PERSONALITY(uParam0->f_20[0 /*14*/], joaat("AVOID"));
				}
				if (uParam0->f_489 == 3)
				{
					PED::_SET_PED_INTERACTION_PERSONALITY(uParam0->f_20[0 /*14*/], joaat("SCRIPTEDOUTLAW"));
					func_64(uParam0->f_20[0 /*14*/], joaat("WEAPON_REVOLVER_CATTLEMAN") /* GXTEntry: "Cattleman Revolver" */, 1, 0, 0, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				}
				else
				{
					PED::_SET_PED_INTERACTION_PERSONALITY(uParam0->f_20[0 /*14*/], joaat("AVOID"));
			...
			break;
		case 1:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]) && func_65(uParam0->f_20[0 /*14*/], Global_35, 0, 50.0f, 0))
			{
				PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 297 /*PCF_ForceInteractionLockonOnTargetPed*/, true);
				PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 146 /*PCF_0x861831C4*/, false);
				PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 6 /*PCF_DontInfluenceWantedLevel*/, false);
				PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 130 /*PCF_DisableTalkTo*/, false);
				if (uParam0->f_489 == 3)
				{
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 148 /*PCF_0x0DD984BE*/, true);
				}
				...
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]) && uParam0->f_489 == 1)
				{
					...
					PED::_REQUEST_PED_FACIAL_MOOD_THIS_FRAME(uParam0->f_20[1 /*14*/], joaat("MOODANGRY"), 6);
					PED::SET_PED_USING_ACTION_MODE(uParam0->f_20[1 /*14*/], true, -1, 0);
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_GO_TO_ENTITY(0, Global_35, -1, 10.0f, 1.5f, (1 << 30), 0);
					...
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 178 /*PCF_AllowNonTempExceptionEvents*/, true);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 168 /*PCF_EnableShockingEvents*/, true);
				...
				sVar1.f_0 = Global_35;
				sVar1.f_1 = uParam0->f_20[0 /*14*/];
				sVar1.f_2 = joaat("CRIME_ROBBERY"); /* GXTEntry: "Robbery" */
				sVar1.f_3 = { Global_36 /*3*/ };
				sVar1.f_6 = func_70(func_69(), 1, 1);
				sVar1.f_7 = 100;
				sVar1.f_8 = 1;
				sVar1.f_9 = 1;
				sVar1.f_10 = 1;
				LAW::_0x318F0F9A4426CFA2(uParam0->f_20[0 /*14*/], &sVar1);
				LAW::_0xD7494DED50C6EF52(PLAYER::PLAYER_ID(), joaat("CRIME_ROBBERY") /* GXTEntry: "Robbery" */, 1);
				if (!bLocal_45)
				{
					func_63(*uParam0, 1);
					bLocal_45 = true;
		...
		case 3:
			...
			if (func_74(Global_35, uParam0->f_20[0 /*14*/], 0, 1) > 1600.0f)
			{
				return 1;
			}
			break;
...
bool func_50(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_90(iVar0) && func_91(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
int func_64(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else if (iVar0 == joaat("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case joaat("GROUP_SHOTGUN"):
			case joaat("GROUP_RIFLE"):
				if (func_107(joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */))
				{
	...
	{
		func_108(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0.0f;
...
bool func_65(int iParam0, int iParam1, bool bParam2, float fParam3, bool bParam4)
{
	if (bParam2)
	{
		if (!func_111(iParam0, iParam1, 0.0f))
		{
			return false;
		}
	}
...
int func_67(int iParam0, bool bParam1, int iParam2)
{
	...
	while (iVar24 < sVar1.f_0)
	{
		...
		else
		{
			...
			if (func_114(iVar25, 0) && func_115(iVar25, joaat("CI_TAG_ITEM_MONEY")))
			{
				return BUILTIN::CEIL(((float)sVar1.f_12[iVar24] * fVar0));
			}
		}
...
bool func_68(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_117(iParam0, joaat("CURRENCY_CASH") /* GXTEntry: "Money" */, iParam1, iVar0);
	}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
				{
					...
					{
						if ((func_126(Global_35, uParam0->f_20[iVar0 /*14*/], 1) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[iVar0 /*14*/])) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[iVar0 /*14*/]))
						{
...
bool func_77(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, Vector3 vParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
bool func_79(Vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_133(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1.0f, 0))
			{
				return true;
			}
		}
...
bool func_102(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (Global_1935630.f_26 & func_154(PLAYER::PLAYER_ID(), 0, 1, (uParam2->f_1 & (1 << 19)) == 0))
		{
...
void func_104(int iParam0, Vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_133(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
int func_108(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
	...
	{
		sVar0 = { func_179(iParam0, 0, 1) /*5*/ };
		iVar5 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
		sVar6.f_9 = joaat("SLOTID_NONE");
		iVar28 = 0;
		while (iVar28 < 4)
		{
			iVar5 = func_180((398 + iVar28), 1);
			if (func_181(iParam0, &sVar0, iVar5, 0))
			{
				if (func_182(iParam0, &sVar6, iVar5))
				{
					sVar29 = { func_183(iParam0, sVar0, iVar5, 0) /*4*/ };
					func_184(iParam0, &sVar29, &sVar0, 1, joaat("REMOVE_REASON_DEFAULT"), 1, 0);
				}
				else
				{
					iVar28++;
...
bool func_117(int iParam0, int iParam1, var uParam2, int iParam3)
{
	struct<13> /*104*/ sVar0;
	int iVar23;
	...
	switch (uParam0->f_6)
	{
		case 0:
			if ((*uParam0 & 16) != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_208(1) || (*uParam0 & (1 << 13)) != 0))
				{
					func_9(uParam0, (1 << 25));
				}
			}
...
bool func_151(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_217(iParam0, !(*uParam1 & (1 << 28)) != 0, !(*uParam1 & (1 << 29)) != 0, !(*uParam1 & (1 << 30)) != 0, 0, 0))
		{
...
bool func_152(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85.0f;
	if (func_221(iParam1, !(*uParam2 & (1 << 28)) != 0, !(*uParam2 & (1 << 29)) != 0, !(*uParam2 & (1 << 30)) != 0, 0))
	{
...
bool func_157(int iParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < (float)func_224(uParam2))
	{
...
bool func_165(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_74(iParam0, iParam1, 1, 1) < 4.0f)
		{
		...
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(iVar0, &iVar5, &iVar4))
		{
			...
			else if (iVar4 == iVar5)
			{
				...
				while (iVar6 < iVar4)
				{
					...
					{
						if (func_235(iVar7, vVar1, 1) < 3.0f)
						{
		...
		case joaat("EVENT_SHOCKING_ENTITY_HOGTIED"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(iParam0, iVar4, -1.0f, -1.0f, -1.0f, -1.0f) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(iParam0, Global_35, -1.0f, -1.0f, -1.0f, -1.0f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iVar4, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					...
					{
						if (func_235(iVar4, Global_36, 1) < 7.0f)
						{
							return true;
						}
					}
...
struct<5> /*40*/ func_179(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;
	...
	switch (func_189(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_183(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
			...
			break;
		case joaat("WEAPON"):
			sVar0 = { func_247(bParam1) /*4*/ };
			if (bParam2 && func_248(iParam0, 1))
			{
				sVar5.f_9 = joaat("SLOTID_NONE");
				if (!func_181(iParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_181(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_182(iParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_251(iParam0, joaat("CI_CATEGORY_CAMP")))
			{
				sVar0 = { func_183(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("KIT_CAMP") /* GXTEntry: "Camp" */);
			}
			else if (func_251(iParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_183(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("WARDROBE") /* GXTEntry: "Wardrobe" */);
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_252(sVar0, &sVar27, bParam1, 0))
				{
					sVar0.f_4 = 0;
				}
				else
...
struct<4> /*32*/ func_183(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_255(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}
...
bool func_184(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!func_252(*uParam1, &sVar0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_255(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_185(bool bParam0)
{
	...
	return INVENTORY::_INVENTORY_ARE_LOCAL_CHANGES_ALLOWED(func_255(bParam0));
}
...
void func_187(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_258(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
bool func_190(int iParam0, int iParam1)
{
	...
	if (func_260("ALL WEAPONS", &iVar1, &iVar2, joaat("SLOTID_NONE"), 0))
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_261(&sVar4, iVar3, iVar1, iVar2))
			{
			}
			else if (!func_105(sVar4.f_4))
			{
			}
...
int func_191(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_255(bParam2), iParam0, false);
	return iVar2;
}
...
bool func_211(int iParam0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_217(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_74(iVar0, iParam0, 1, 1) <= 4.0f)
		{
			return true;
		}
	}
...
bool func_219(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_221(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
bool func_226(int iParam0, Vector3 vParam1, Vector3 vParam4)
{
...
bool func_230(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
bool func_234(int iParam0, int iParam1, Vector3 vParam2)
{
	float fVar0;
...
bool func_240(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(iParam0, Global_35, -1.0f, -1.0f, -1.0f, -1.0f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
			{
				...
				{
					if (func_235(iVar1, Global_36, 1) < 5.0f)
					{
						return true;
					}
				}
...
{
	return func_183(joaat("CHARACTER"), func_277(), joaat("SLOTID_NONE"), bParam0);
}

struct<4> /*32*/ func_247(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_183(joaat("CARRIED_WEAPONS"), func_246(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_183(joaat("CARRIED_WEAPONS"), func_246(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_183(joaat("CARRIED_WEAPONS"), func_246(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_248(int iParam0, bool bParam1)
{
	if (func_250(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
struct<4> /*32*/ func_249(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_183(joaat("EMOTE_ITEM"), func_246(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_183(joaat("EMOTE_ITEM"), func_246(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
bool func_252(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_255(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_253(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	sVar0 = { func_183(iParam0, sParam1, iParam5, bParam6) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&sVar0))
	{
		return 0;
	}
	iVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_255(bParam6), &sVar0, false);
	return iVar4;
}

bool func_254(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_255(0);
	*uParam1 = { func_183(iParam0, func_247(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
...
int func_259(int iParam0, int iParam1)
{
	...
	if (func_115(iParam0, joaat("CI_TAG_ITEM_AMMOBOX")))
	{
...
bool func_260(char* sParam0, int iParam1, int* iParam2, int iParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_255(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_261(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (iParam2 < 0)
	{
		return false;
...
int func_263(int iParam0, bool bParam1)
{
	...
	sVar0 = { func_279(iParam0, joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0) /*18*/ };
	if (bParam1)
	{
		func_280(&sVar0, func_247(0));
	}
...
bool func_271(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
...
bool func_272(Vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
struct<18> /*144*/ func_279(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_255(bParam3), uParam0, iParam2);
	if (*uParam1 >= 0)
	{
		return true;
	}
