...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.85f, -1.3375f, 0.85f, 0.0f, 4.4575f, 3.4825f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, 0.2f, 4.525f, 0.85f, -65.75f, 1.0f, 1.0f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, 0.614285f, -1.53936f, 1.00907f, 0.0f, 1.2f, 1.2f, 3.2f, joaat("VOLCYLINDER"), 1);
	func_153(uParam0, joaat("P_BROOM02X"), 0.0f, 0.0f, 0.0f, "BROOM", 0, 1, 1);
	...
	func_157(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_BROOM_WORKING"), "WORLD_HUMAN_BROOM_WORKING_FEMALE_B", -1, 1, 45.0f, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_WAITING_IMPATIENT"), "WORLD_HUMAN_WAITING_IMPATIENT_FEMALE_A", -1, 1);
	func_157(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_WAITING_IMPATIENT"), "WORLD_HUMAN_WAITING_IMPATIENT_FEMALE_A", -1, 0, 55.0f, 1065353216 /* Float: 1f */, 1);
...
void func_98(Vector3 vParam0, int iParam3)
{
	...
	while (iVar0 < Global_1911670)
	{
		...
		if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(iVar1))
		{
			...
			if (func_204(vVar2, vParam0, 2.0f, 1))
			{
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_205(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000.0f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_207(iParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_208(iParam0, 0));
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		PED::SET_PED_CONFIG_FLAG(func_223(iParam0), 137 /*PCF_0xE18960DE*/, true);
	}
}
...
void func_124(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		PED::SET_PED_CONFIG_FLAG(func_223(iParam0), 204 /*PCF_0x435F091E*/, true);
	}
	else
	{
		PED::SET_PED_CONFIG_FLAG(func_223(iParam0), 204 /*PCF_0x435F091E*/, false);
	}
}
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_223(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_225(iParam0) < 10000.0f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_143(var uParam0)
{
	...
	if (func_231(Global_1935630, (1 << 14)))
	{
		return true;
	}
	if (func_232(2))
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_238(uParam0->f_107[iVar0 /*113*/].f_1, (1 << 11)))
			{
				return true;
			}
...
{
	uParam0->f_23 = { func_245(iParam1) + Vector(fParam4, fParam3, fParam2) /*3*/ };
	uParam0->f_26 = { func_246(iParam1) /*3*/ };
}
...
int func_151(var uParam0, Vector3 vParam1, float fParam4, Vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_248(uParam0, vParam1) /*3*/ };
...
void func_158(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1 /*113*/].f_32.f_5 = { func_253(func_148(uParam0), func_252(uParam0, iParam1), func_19(uParam0), 1) /*3*/ };
			break;
		default:
			sVar0 = { func_254(func_148(uParam0), func_252(uParam0, iParam1), func_19(uParam0), 1) /*4*/ };
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_206(uParam0->f_107[iVar12 /*113*/].f_7, 1));
				}
			}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0 /*15*/].f_5 && !ENTITY::DOES_ENTITY_EXIST(uParam0->f_1711[iVar0 /*15*/].f_10))
			{
				...
				{
					vVar3 = { func_248(uParam0, uParam0->f_1711[iVar0 /*15*/].f_1) /*3*/ };
				}
				else
				{
...
void func_183(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_248(uParam0, uParam0->f_1976.f_1), 1, func_249(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
struct<4> /*32*/ func_254(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 1:
...
bool func_266(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1 /*15*/].f_5)
		{
			...
			{
				vVar2 = { func_248(uParam0, uParam0->f_1711[iVar1 /*15*/].f_1) /*3*/ };
			}
			else
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_SET_PERSCHAR_SCHEDULE(func_206(iParam0, 1), &cVar4);
				}
...
bool func_415(int iParam0, Vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489.f_12) || (bParam5 && Global_1359489.f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_206(iParam0, 1));
...
void func_417(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_223(iParam1), iParam0, false);
