...
bool func_97(var uParam0)
{
	if (!MAP::DOES_BLIP_EXIST(iLocal_54))
	{
		...
		MAP::SET_BLIP_SPRITE(iLocal_54, joaat("BLIP_AMBIENT_SECRET") /* GXTEntry: "Companion" */, true);
	}
...
void func_212(var uParam0)
{
	...
	{
		iLocal_41 = func_323("GREET_ACC" /* GXTEntry: "Accept" */, joaat("INPUT_INTERACT_LOCKON_POS"), func_8(uParam0, iLocal_16), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	...
	{
		iLocal_42 = func_323("GREET_REJ" /* GXTEntry: "Reject" */, joaat("INPUT_INTERACT_LOCKON_NEG"), func_8(uParam0, iLocal_16), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
...
void func_215(var uParam0)
{
	...
	{
		iLocal_43 = func_323("VIG_FLARE" /* GXTEntry: "FLARE" */, joaat("INPUT_CONTEXT_X"), func_8(uParam0, iLocal_16), 2, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		func_333(iLocal_43, 6.0f, 1);
		func_325(iLocal_43, 0, 1);
	}
	if (!func_49(iLocal_44))
	{
		iLocal_44 = func_323("LEAVE" /* GXTEntry: "Leave" */, joaat("INPUT_CONTEXT_B"), func_8(uParam0, iLocal_16), 2, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
...
int func_323(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_227(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_386(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
int func_435(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_470(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) /*3*/ };
