...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.7063f, 0.0071f, 0.0f, 1.5f, 2.0f, 2.0f, 5.0f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, joaat("P_CRATE22X_SMALL"), 0.0f, 0.0f, 0.0f, "CRATE" /* GXTEntry: "Crate" */, iVar0, 0, 1);
	...
	strcpy_s(&(uParam0->f_2236[0 /*8*/]), 64, sLocal_20);
...
bool func_93(var uParam0)
{
	if (func_199(uParam0, iLocal_14))
	{
		if (!bLocal_19)
		{
			...
			bLocal_19 = true;
			TASK::TASK_PLAY_ANIM(func_48(uParam0, iLocal_15), &(uParam0->f_2236[0 /*8*/]), "exit_back", 1000.0f, -8.0f, -1, (1 << 13), 0.0f, false, 0, false, 0, false);
