...
bool func_73(var uParam0)
{
	...
	func_152(uParam0, -5.8f, 6.8f, 0.0f, 0.0f, 2.0f, 2.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	func_152(uParam0, 0.0f, 1.0f, 0.0f, 0.0f, 1.5f, 1.5f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	vLocal_53 = { func_153(uParam0, -0.039f, 1.165f, 0.0346f) /*3*/ };
	func_154(uParam0, joaat("P_BARREL05X"), 0.0f, 0.0f, 0.0f, "BARREL", 0, 0, 1);
	iLocal_21 = func_154(uParam0, joaat("P_PEN01X"), 0.0f, 0.0f, 0.0f, "PEN", 0, 1, 1);
	iLocal_22 = func_154(uParam0, joaat("P_CS_LEDGER01X"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 1, 1);
	func_154(uParam0, joaat("P_BOTTLEJD01X"), 0.0f, 0.0f, 0.0f, "BOTTLE", 0, 1, 1);
	iLocal_20 = func_154(uParam0, joaat("P_STOOLFOLDING01X"), -0.039f, 1.165f, 0.0346f, 0, 1, 0, 1);
	func_155(uParam0, iLocal_15, joaat("WEAPON_REVOLVER_CATTLEMAN_HOSEA_DUALWIELD") /* GXTEntry: "Hosea\'s Cattleman Revolver" */, "GUN" /* GXTEntry: "Gun Fight" */);
	...
	sLocal_23 = { func_162(uParam0, 0.1564f, 1.1727f, 0.5404f, 138.0f, 7.0f, 0.4f, 0.4f) /*10*/ };
	sLocal_33 = { func_162(uParam0, 0.156f, 1.173f, 0.54f, -150.0f, 7.0f, 0.4f, 0.4f) /*10*/ };
	sLocal_43 = { func_162(uParam0, 0.156f, 1.173f, 0.54f, 66.0f, 7.0f, 0.4f, 0.4f) /*10*/ };
	return true;
}
...
bool func_87(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(func_22(uParam0, iLocal_20)))
	{
		vLocal_56 = { ENTITY::GET_ENTITY_COORDS(func_22(uParam0, iLocal_20), true, false) /*3*/ };
...
bool func_94(var uParam0)
{
	if (!bLocal_60)
	{
		...
		{
			if (func_202(uParam0, sLocal_23, 1, 0))
			{
				func_192(uParam0, iLocal_17, 1);
			}
			else if (func_202(uParam0, sLocal_33, 1, 0))
			{
				func_192(uParam0, iLocal_18, 1);
			}
			else if (func_202(uParam0, sLocal_43, 1, 0))
			{
...
bool func_96(var uParam0)
{
	...
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_53, 1.0f))
	{
		return true;
	}
	return false;
...
int func_152(var uParam0, Vector3 vParam1, float fParam4, Vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_153(uParam0, vParam1) /*3*/ };
...
struct<10> /*80*/ func_162(var uParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	float fVar0;
	float fVar1;
	struct<10> /*80*/ sVar2;
	...
	sVar2 = { func_153(uParam0, vParam1) /*3*/ };
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0 /*15*/].f_5 && !ENTITY::DOES_ENTITY_EXIST(uParam0->f_1711[iVar0 /*15*/].f_10))
			{
				...
				{
					vVar3 = { func_153(uParam0, uParam0->f_1711[iVar0 /*15*/].f_1) /*3*/ };
				}
				else
				{
...
void func_187(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_153(uParam0, uParam0->f_1976.f_1), 1, func_256(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
bool func_202(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
bool func_269(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1 /*15*/].f_5)
		{
			...
			{
				vVar2 = { func_153(uParam0, uParam0->f_1711[iVar1 /*15*/].f_1) /*3*/ };
			}
			else
			{
...
void func_277(var uParam0, int iParam1)
{
	...
	else if (!func_336(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
	{
...
bool func_308(var uParam0, int iParam1)
{
	...
	{
		if (!func_336(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_ANY")))
		{
			return true;
		}
	}
...
int func_351(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_389(fVar9) /*3*/ };
			vVar13 = { func_390(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) /*3*/ };
...
int func_394(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_419(iParam0) && func_420(iParam0, &cVar4))
				{
...
void func_396(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_426(func_105(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_427(iParam0);
...
bool func_403(int iParam0, Vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_437(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) /*7*/ };
			if (!bParam6)
			{
				func_103(iParam0, 44, 1);
			}
...
void func_410(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_451(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_451(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
bool func_423(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_EQUIP_META_PED_OUTFIT(iParam1, func_453(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, false, true, true, true, false);
...
void func_424(int iParam0, int iParam1)
{
	...
	func_396(iParam1, func_452(iParam1, (1 << 13)), func_452(iParam1, (1 << 14)), 1);
}
...
void func_426(int iParam0, float fParam1, bool bParam2)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		fParam1 = func_455(fParam1, 0.0f, 1.0f);
...
struct<7> /*56*/ func_437(int iParam0, int iParam1, Vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	struct<7> /*56*/ sVar0;
...
void func_449(int iParam0)
{
	...
	func_466(iParam0, (1 << 9));
	func_466(iParam0, (1 << 10));
	func_466(iParam0, (1 << 11));
	func_466(iParam0, (1 << 12));
	func_466(iParam0, (1 << 16));
	func_466(iParam0, (1 << 14));
	func_466(iParam0, (1 << 18));
	func_466(iParam0, (1 << 19));
	func_466(iParam0, (1 << 20));
	func_466(iParam0, (1 << 21));
	func_466(iParam0, (1 << 15));
	func_466(iParam0, (1 << 17));
	func_466(iParam0, (1 << 27));
	func_466(iParam0, (1 << 30));
}
...
int func_451(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else if (iVar0 == joaat("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case joaat("GROUP_SHOTGUN"):
			case joaat("GROUP_RIFLE"):
				if (func_468(joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */))
				{
	...
	{
		func_469(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0.0f;
...
int func_469(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
...
bool func_473(bool bParam0, bool bParam1)
{
...
struct<5> /*40*/ func_476(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_488(iParam0))
	{
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_493(iParam0, joaat("CI_CATEGORY_CAMP")))
			{
			...
			else if (func_493(iParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_480(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("WARDROBE") /* GXTEntry: "Wardrobe" */);
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_494(sVar0, &sVar27, bParam1, 0))
				{
					sVar0.f_4 = 0;
				}
				else
...
struct<4> /*32*/ func_480(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_498(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}
...
bool func_481(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!func_494(*uParam1, &sVar0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
...
void func_484(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_501(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> /*32*/ func_489(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_480(joaat("CARRIED_WEAPONS"), func_487(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_480(joaat("CARRIED_WEAPONS"), func_487(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_480(joaat("CARRIED_WEAPONS"), func_487(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_490(int iParam0, bool bParam1)
{
	if (func_492(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
struct<4> /*32*/ func_491(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_480(joaat("EMOTE_ITEM"), func_487(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_480(joaat("EMOTE_ITEM"), func_487(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
bool func_496(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_498(0);
	*uParam1 = { func_480(iParam0, func_489(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
