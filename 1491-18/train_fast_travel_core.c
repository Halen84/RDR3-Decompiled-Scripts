...
int func_1()
{
	...
	if (func_41(joaat("DOCUMENT_TRAIN_TICKET") /* GXTEntry: "Train Ticket" */, func_40(0), joaat("SLOTID_SATCHEL"), 1) >= 1)
	{
		func_42(joaat("DOCUMENT_TRAIN_TICKET") /* GXTEntry: "Train Ticket" */, 1, joaat("REMOVE_REASON_DEFAULT"), 0, 0);
	}
	if (bLocal_106)
	{
...
float func_66(bool bParam0, Vector3 vParam1, var uParam4)
{
	...
	if (!func_67(vParam1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(bParam0) && !ENTITY::IS_ENTITY_DEAD(bParam0))
		{
			...
			if (iVar3 >= 0)
			{
				vVar0 = { VEHICLE::_GET_STATION_COORDS_FROM_TRAIN_STATION_DATA(iVar4, iVar3) /*3*/ };
				if (!func_67(vVar0))
				{
...
struct<5> /*40*/ func_79(bool bParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_111(bParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_76(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_113(bParam0, 1))
			{
				...
				if (!func_114(bParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_114(bParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_115(bParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_76(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
