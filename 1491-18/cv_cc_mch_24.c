...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 3.6829f, -3.9259f, 1.0f, -88.92f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, 0.0376f, -0.1f, 1.0f, -88.92f, 3.2f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_152(uParam0, joaat("P_CIGARETTE_CS02X"), 0.0f, 0.0f, 0.0f, "CIGARETTE", 0, 1, 1);
	func_152(uParam0, joaat("P_CS_RAG01X"), 0.0f, 0.0f, 0.0f, "RAG", 0, 0, 1);
...
{
	iLocal_18 = WEAPON::_CREATE_WEAPON_OBJECT(joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */, 1, uParam0->f_23, true, 1.0f);
	return true;
}
