	...
	switch (iLocal_73)
	{
		...
		case 2:
			...
			if (func_25(iLocal_56, 1))
			{
				...
				iLocal_42 = iVar0;
				func_26();
				iLocal_61 = func_28("PAY_CASH" /* GXTEntry: "Donate $~1~" */, joaat("INPUT_GAME_MENU_ACCEPT"), Global_35, 1, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
				func_30(iLocal_61, "PAY_CASH" /* GXTEntry: "Donate $~1~" */, func_29(MISC::_GET_STRING_FROM_FLOAT((BUILTIN::TO_FLOAT(iLocal_42) / 100.0f), 2), joaat("COLOR_PURE_WHITE")));
				func_31(iLocal_61, 763444929, 0, 1);
				iLocal_59 = func_28("SET_CASH_UP" /* GXTEntry: "Increase Amount" */, joaat("INPUT_TITHING_INCREASE_AMOUNT"), Global_35, 1, 0, 0, 0, 3, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
				func_31(iLocal_59, 763444929, 0, 1);
				iLocal_60 = func_28("SET_CASH_DOWN" /* GXTEntry: "Lower Amount" */, joaat("INPUT_TITHING_DECREASE_AMOUNT"), Global_35, 1, 0, 0, 0, 3, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
				func_31(iLocal_60, 763444929, 0, 1);
				iLocal_62 = func_28("BACK_TITHE" /* GXTEntry: "Back" */, joaat("INPUT_GAME_MENU_CANCEL"), Global_35, 1, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		...
		case 11:
			...
			break;
		case 3:
			HUD::_UI_PROMPT_SET_ACTIVE_GROUP_THIS_FRAME(763444929, "CASH_TITHE" /* GXTEntry: "Cash Donation" */, 1, 0, 0, 0);
			...
			if (func_46(iLocal_61, 1))
			{
				...
				{
					func_48("BROKE_TITHE" /* GXTEntry: "You must have sufficient funds to make a donation to the gang." */, 10000, 0, 0, 0, 1);
				}
			}
		...
		case 10:
			...
			if (bVar1)
			{
				...
				func_52(MISC::VAR_STRING(10, "GIVE_ITEM_TITHE" /* GXTEntry: "Donate Items $~a~" */, func_29(MISC::_GET_STRING_FROM_FLOAT((BUILTIN::TO_FLOAT(iLocal_42) * 0.01f), 2), joaat("COLOR_PURE_WHITE"))), "ITEMTYPE_TEXTURES", joaat("TRANSACTION_CAMP_GANG"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
				func_47();
				func_17(12);
			}
			break;
...
void func_23()
{
	...
	{
		iLocal_56 = func_28("MONEY_TITHE" /* GXTEntry: "Give Money" */, joaat("INPUT_GAME_MENU_ACCEPT"), Global_35, 1, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	}
	if (!func_24(iLocal_57))
	{
		iLocal_57 = func_28("TRINK_TITHE" /* GXTEntry: "Give Item" */, joaat("INPUT_GAME_MENU_OPTION"), Global_35, 1, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	...
	{
		iLocal_58 = func_28("LEAVE_TITHE" /* GXTEntry: "Leave" */, joaat("INPUT_GAME_MENU_CANCEL"), Global_35, 1, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	}
}
...
int func_28(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_79(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_80(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
char* func_29(char* sParam0, int iParam1)
{
	...
	return func_81(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}
...
void func_60()
{
	...
	iVar0[0] = joaat("MONEY_LOANSHARK_SELLHORSE_DEBT"); /* GXTEntry: "Wróbel\'s Valuables" */
	iVar0[1] = joaat("MONEY_LOANSHARK_LILLY_DEBT"); /* GXTEntry: "Lilly\'s Debt Money" */
	iVar0[2] = joaat("MONEY_LOANSHARK_WINTON_DEBT"); /* GXTEntry: "Winton\'s Debt Money" */
	iVar0[3] = joaat("MONEY_LOANSHARK_GWEN_DEBT"); /* GXTEntry: "Diamond Brooch" */
	iVar0[4] = joaat("MONEY_LOANSHARK_CATFISH_DEBT"); /* GXTEntry: "Algie\'s Debt Money" */
	iVar0[5] = joaat("MONEY_LOANSHARK_HORSE_CHASE_DEBT"); /* GXTEntry: "Chick\'s Debt Money" */
	iVar0[6] = joaat("MONEY_LOANSHARK_DOWNES_DEBT"); /* GXTEntry: "Edith Downes\'s Debt Money" */
	iVar8 = 0;
	while (iVar8 < 7)
	{
		if (func_99(iVar0[iVar8], 1, 0))
		{
			...
			if (iVar9 > 0)
			{
				func_52(MISC::VAR_STRING(2, "FEED_DEBT_RECOVERED" /* GXTEntry: "Returned Debt ~1$~" */, iVar9), "ITEMTYPE_TEXTURES", joaat("TRANSACTION_CAMP_GANG"), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
			}
			if (iVar10 > 0)
			{
				func_104(iVar10, 0, 1065353216 /* Float: 1f */, 1, joaat("ADD_REASON_DEFAULT"));
				func_52(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN" /* GXTEntry: "Your Share ~1$~" */, iVar10), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
			}
		}
		iVar8++;
	}
...
int func_101(int iParam0)
{
	switch (iParam0)
	{
		case joaat("MONEY_LOANSHARK_GWEN_DEBT") /* GXTEntry: "Diamond Brooch" */:
			return 4500;
		case joaat("MONEY_LOANSHARK_LILLY_DEBT") /* GXTEntry: "Lilly\'s Debt Money" */:
			return 3600;
		case joaat("MONEY_LOANSHARK_CATFISH_DEBT") /* GXTEntry: "Algie\'s Debt Money" */:
			return 2900;
		case joaat("MONEY_LOANSHARK_WINTON_DEBT") /* GXTEntry: "Winton\'s Debt Money" */:
			return 3800;
		case joaat("MONEY_LOANSHARK_HORSE_CHASE_DEBT") /* GXTEntry: "Chick\'s Debt Money" */:
			return 4000;
		case joaat("MONEY_LOANSHARK_SELLHORSE_DEBT") /* GXTEntry: "Wróbel\'s Valuables" */:
			return 4300;
		default:
			break;
	}
...
void func_104(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iParam0 += iVar2;
		iVar1 += iVar2;
		func_52(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN" /* GXTEntry: "Total Take ~1$~" */, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_TOTAL_TAKE"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		iParam0 -= iVar0;
		if (iVar0 > 0)
		{
			func_156(iVar0);
		...
		func_52(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN" /* GXTEntry: "Your Share ~1$~" */, iVar1), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
void func_107(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	strcpy_s(&cVar2, 32, func_162(iVar1 == 1, "ITEM_GET_PUMP" /* GXTEntry: "~1~" */, "ITEM_GET_PUMP_MULT" /* GXTEntry: "~2~x ~1~" */));
	if (iParam1 > 0)
	{
	}
	else
...
int func_150(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1.0f;
	if (bParam1 && func_99(joaat("PROVISION_TRINKET_ELK_ANTLER") /* GXTEntry: "Elk Antler Trinket" */, 1, 0))
	{
		fVar0 += 0.1f;
	}
	sVar1.f_1 = 10;
	...
	switch (func_110(bParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_211(bParam0, 1))
			{
				...
				if (!func_212(bParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_212(bParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_213(bParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
...
void func_171(bool bParam0, int iParam1)
{
	...
	if (func_82() == -1)
	{
		if (func_221(43))
		{
			if (func_133(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_01")))
			{
		...
		if (func_221(44))
		{
			if (func_133(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_02")))
			{
		...
		if (!func_221(45))
		{
			if (func_133(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_03")))
			{
		...
		if (!func_221(46))
		{
			if (func_133(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_04")))
			{
		...
		if (!func_221(47))
		{
			if (func_133(bParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_05")))
			{
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_52(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS" /* GXTEntry: "+" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_52(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT" /* GXTEntry: "+" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_52(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG" /* GXTEntry: "~COLOR_RED~-~s~" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_52(MISC::VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT" /* GXTEntry: "~COLOR_RED~-~s~" */), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
...
char* func_267(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6)
{
	switch (iParam1)
	{
		case joaat("CIGARETTE_CARDS"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_CC_CARD_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Card Sets Posted" */, func_293(), 12);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_CC_CARD_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Card Sets Found" */, func_294(), 12);
			}
			break;
		case joaat("DINO_BONES"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_DB_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Dinosaur Bones Posted" */, func_296(), 30);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_DB_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Dinosaur Bones Found" */, func_295(), 30);
			}
			break;
		...
		case joaat("LEGENDARY_FISH"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_LF_CAUGHT_OBJ" /* GXTEntry: "~1~ of ~2~ Legendary Fish Caught and Posted" */, func_297(), 13);
			}
			break;
		case joaat("ROCK_CARVINGS"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_RC_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Rock Faces Posted" */, func_299(), 10);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_RC_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Rock Faces Found" */, func_298(), 10);
			}
			break;
		case joaat("TAXIDERMY"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_TX_CARCASS_COLLECTED_OBJ" /* GXTEntry: "~1~ of ~2~ Carcasses Collected" */, sParam4, func_266(iParam6, 20));
			}
			break;
	}
	return sParam3;
