...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 4.505f, 7.6925f, 0.85f, -65.75f, 1.0f, 1.0f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, 8.1249f, 2.6499f, 0.85f, 0.0f, 4.4575f, 3.4825f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	func_152(uParam0, 1);
	...
	func_158(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 0, 50.0f, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, iLocal_15, 3, 0);
	func_157(uParam0, iLocal_15, 1, -1);
	sLocal_21 = { func_160(uParam0, 8.8275f, 2.715f, 1.8254f, 176.75f, 7.0f, 0.21f, 0.4225f) /*10*/ };
	sLocal_41 = { func_160(uParam0, 8.7175f, 2.685f, 1.8254f, 127.5f, 7.0f, 0.12f, 0.415f) /*10*/ };
	sLocal_31 = { func_160(uParam0, 8.73f, 2.685f, 1.8254f, -80.64f, 7.0f, 0.0425f, 0.415f) /*10*/ };
	return true;
}
...
bool func_86(var uParam0)
{
	...
	while (iVar0 < 3)
	{
		...
		{
			TASK::TASK_GO_STRAIGHT_TO_COORD(Global_1357549.f_1675[iVar0 /*5*/].f_3, 2371.127f, 1340.22f, 106.0719f, 1.0f, 20000, 40000.0f, 0.5f, 0);
		}
		iVar0++;
	}
	return true;
