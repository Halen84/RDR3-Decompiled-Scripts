...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_48(uParam0, 0, "beaver", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_38 == 1)
		{
			if (func_65(uParam0, &uLocal_10, 1) || func_66(Global_35, uParam0->f_20[0 /*14*/], 1) <= 64.0f)
			{
				bLocal_38 = true;
			}
		}
	...
	if (uParam0->f_469[0])
	{
		if (func_72(&uLocal_39, 2.0f))
		{
			PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 133 /*PCF_ForceNoTimesliceIntelligenceUpdate*/, false);
			return 1;
		}
	}
	if (!uParam0->f_469[0])
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[4])
			{
				if (func_74(uParam0, 0.5f, 40.0f, 4, joaat("ACTION"), 1))
				{
					func_69(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[4] = 1;
				}
...
void func_71(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 133 /*PCF_ForceNoTimesliceIntelligenceUpdate*/, true);
