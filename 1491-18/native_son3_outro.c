...
bool func_6(var uParam0)
{
	...
	switch (iLocal_4)
	{
		case 0:
			...
			if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(iLocal_8, "pbl_Cough_A"))
			{
				if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(iLocal_8, "pbl_Cough_A"))
				{
					ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_8, "pbl_Cough_A");
				}
				bVar0 = false;
			}
			if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(iLocal_8, "pbl_Cough_B"))
			{
				if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(iLocal_8, "pbl_Cough_B"))
				{
					ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_8, "pbl_Cough_B");
				}
				bVar0 = false;
			}
			if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(iLocal_8, "pbl_Labored_Breath"))
			{
				if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(iLocal_8, "pbl_Labored_Breath"))
				{
					ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(iLocal_8, "pbl_Labored_Breath");
				}
				bVar0 = false;
			}
			if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(iLocal_8, "pbl_Wipe_Face"))
			{
				if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(iLocal_8, "pbl_Wipe_Face"))
				{
...
bool func_46()
{
	...
	if (bLocal_11 == 1)
	{
		fVar1 = PAD::GET_CONTROL_NORMAL(0, joaat("INPUT_MOVE_UD") /* GXTEntry: "Move up/down" */);
		if (((fVar1 >= 0.5f || fVar1 <= -0.5f) || PAD::IS_CONTROL_JUST_PRESSED(0, joaat("INPUT_SPRINT") /* GXTEntry: "Sprint" */)) || bLocal_10)
		{
			if (!bLocal_10)
			{
				bLocal_10 = true;
...
int func_64(var uParam0)
{
	...
	return (func_83() - BUILTIN::ROUND((uParam0->f_1 * 1000.0f)));
}
...
{
	if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(iLocal_8, sParam0))
	{
		if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADING(iLocal_8, sParam0))
		{
