...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -3.3384f, -3.0037f, 1.156f, 17.0847f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	func_151(uParam0, -0.7301f, 0.5311f, 0.5295f, -0.2848f, 2.2f, 2.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	func_152(uParam0, -1.0257f, 0.9388f, 1.0341f, 0.0f, 0.72f, 0.72f, 3.0f, joaat("VOLCYLINDER"), 1);
	iLocal_21 = func_153(uParam0, joaat("P_CS_RAG02X"), 0.0f, 0.0f, 0.0f, "RAG", 0, 1, 1);
	iLocal_22 = func_153(uParam0, joaat("P_STOOLFOLDING01X"), 0.0114404f, 1.02168f, 0.0306778f, 0, 1, 0, 1);
	func_154(uParam0, iLocal_14, joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN") /* GXTEntry: "John\'s Cattleman Revolver" */, "REVOLVER");
	...
	func_157(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_CLEAN_PISTOL"), "PROP_HUMAN_SEAT_CHAIR_TABLE_CLEAN_PISTOL_MALE_A", iLocal_22, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, iLocal_21, "p_cs_rag02x_PH_L_HAND", 0, 0);
	func_159(uParam0, iLocal_14, 1, 2, 0, 0, 0);
	sLocal_23 = { func_160(uParam0, -1.5559f, 0.4947f, 1.0665f, -3.96f, 7.0f, 0.6f, 0.6f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_199(uParam0, sLocal_23, 1, 0))
		{
...
bool func_96(var uParam0)
{
	...
	{
		PED::SET_PED_SHOULD_PLAY_DIRECTED_NORMAL_SCENARIO_EXIT(func_48(uParam0, iLocal_14), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(func_48(uParam0, iLocal_14), 1.0f, 0.0f, 0.0f));
		bLocal_20 = true;
	}
	return true;
}
...
bool func_198(var uParam0, int iParam1)
{
	...
	if (func_301(uParam0, iParam1, 1.0f))
	{
		return true;
	}
...
bool func_199(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_303(sParam1, sParam1.f_6, Global_36))
	{
		return false;
	}
	if (func_303(sParam1, sParam1.f_3, Global_36))
	{
		return false;
	}
	if (bParam12)
...
void func_207(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_301(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
bool func_243(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_317(iVar0) && func_318(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
bool func_303(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5, struct<2> /*16*/ sParam6, var uParam8)
{
