...
bool func_1(var uParam0)
{
	...
	PED::SET_PED_CONFIG_FLAG(iVar0, 441 /*PCF_0xB61CE793*/, false);
	PED::SET_PED_CONFIG_FLAG(iVar0, 1 /*PCF_0x24B45566*/, false);
	PED::SET_PED_CONFIG_FLAG(iVar0, 54 /*PCF_PreventAllMeleeTaunts*/, false);
	PED::SET_PED_CONFIG_FLAG(iVar0, 121 /*PCF_ForceIgnoreMeleeActiveCombatant*/, false);
	PED::SET_PED_CONFIG_FLAG(iVar0, 302 /*PCF_DisableMeleeKnockout*/, false);
	PED::SET_PED_CONFIG_FLAG(iVar0, 419 /*PCF_BlockMountHorsePrompt*/, false);
	PED::SET_PED_CONFIG_FLAG(iVar0, 471 /*PCF_DisableHorseKick*/, false);
	func_9(iVar0, 0);
...
bool func_73(var uParam0)
{
	...
	uParam0->f_23 = { uParam0->f_23 + Vector(0.04f, 0.0f, 0.0f) /*3*/ };
	iLocal_14 = func_151(uParam0, 18, "LeoStrauss");
	iLocal_15 = func_152(uParam0, joaat("CS_EDITHDOWN"), "EdithDown");
	iLocal_16 = func_152(uParam0, func_153(joaat("HORSE_CLASS_RIDING") /* GXTEntry: "Riding" */, 1), "Horse");
	func_154(uParam0, -8.7436f, 6.0821f, 0.0f, 0.0f, 1.2f, 1.2f, 5.0f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_154(uParam0, -0.15f, -0.1125f, 0.0f, 0.0f, 3.335f, 2.7475f, 5.0f, joaat("VOLBOX"), -1, 1, 1, 1);
	iLocal_17 = func_155(uParam0, joaat("P_CHAIRFOLDING02X"), -0.274352f, -1.19492f, -0.00502014f, "p_chairfolding02x", 1, 0, 1);
	iLocal_18 = func_155(uParam0, joaat("P_CS_BOOK04X"), 0.0f, 0.0f, 0.0f, "p_cs_ledger01x", 0, 1, 1);
	func_155(uParam0, joaat("P_FOLDEDBILLS01X"), 0.0f, 0.0f, 0.0f, "P_FOLDEDBILLS01X", 0, 1, 1);
	...
	func_159(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_87(var uParam0)
{
	...
	PED::SET_PED_CONFIG_FLAG(iVar0, 441 /*PCF_0xB61CE793*/, true);
	PED::SET_PED_CONFIG_FLAG(iVar0, 1 /*PCF_0x24B45566*/, true);
	PED::SET_PED_CONFIG_FLAG(iVar0, 54 /*PCF_PreventAllMeleeTaunts*/, true);
	PED::SET_PED_CONFIG_FLAG(iVar0, 121 /*PCF_ForceIgnoreMeleeActiveCombatant*/, true);
	PED::SET_PED_CONFIG_FLAG(iVar0, 302 /*PCF_DisableMeleeKnockout*/, true);
	PED::SET_PED_CONFIG_FLAG(iVar0, 419 /*PCF_BlockMountHorsePrompt*/, true);
	PED::SET_PED_CONFIG_FLAG(iVar0, 471 /*PCF_DisableHorseKick*/, true);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(func_8(uParam0, iLocal_15), joaat("REL_PLAYER_ALLY"));
	func_9(iVar0, 1);
	TASK::TASK_START_SCENARIO_AT_POSITION(iVar0, joaat("WORLD_ANIMAL_HORSE_GRAZING"), -104.9883f, -18.30921f, 94.85979f, -48.94f, 0, false, true, 0, -1.0f, false);
	return true;
}
...
bool func_96(var uParam0)
{
	...
	if (bLocal_19)
	{
		if (func_206(Global_35, func_8(uParam0, iLocal_15), 1) < 5625.0f && func_207(Global_35))
		{
		...
		if (ENTITY::DOES_ENTITY_EXIST(func_8(uParam0, iLocal_15)))
		{
			...
			if (func_206(Global_35, func_8(uParam0, iLocal_15), 1) > 10000.0f || func_110(&uLocal_20) > 2.0f)
			{
				PED::DELETE_PED(&(uParam0->f_107[iLocal_15 /*113*/].f_5));
				PED::DELETE_PED(&(uParam0->f_107[iLocal_16 /*113*/].f_5));
				return true;
	...
	if (!bLocal_19)
	{
		...
		vVar0.f_3 = 1.2f;
		vVar0.f_4 = -1;
		vVar0 = { -106.2463f, -18.00144f, 94.88023f /*3*/ };
		TASK::OPEN_SEQUENCE_TASK(&iVar7);
		TASK::TASK_FOLLOW_PAVEMENT_TO_COORD(0, &vVar0);
		TASK::TASK_MOUNT_ANIMAL(0, func_8(uParam0, iLocal_16), 20000, -1, 1.0f, 1, 0, 0);
		TASK::TASK_MOVE_FOLLOW_ROAD_USING_NAVMESH(0, 3.0f, -22.18789f, 57.58458f, 90.87619f, 1);
		TASK::TASK_MOVE_IN_TRAFFIC(0, 3.0f, 256, 0);
...
int func_108(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_121(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_206(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000.0f))
			{
...
void func_204(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_304(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
int func_292(var uParam0, int iParam1)
{
	...
	if (func_304(uParam0, iParam1, 1.0f))
	{
		return 1;
	}
		...
		else if (func_21(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_360(&iVar2, func_359(iVar3)))
					{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_394(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, (1 << 30));
			}
			else if (bParam16)
			{
...
int func_376(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_408(fVar9) /*3*/ };
			vVar13 = { func_409(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) /*3*/ };
...
int func_383(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_412(iParam0) && func_413(iParam0, &cVar4))
				{
		...
		case 3:
			...
			if ((bParam2 && !func_208(vVar0)) && !func_209(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_394(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, (1 << 30));
			}
			if (bParam1)
			{
				if (!ENTITY::_DOES_THREAD_OWN_THIS_ENTITY(Global_1360165[iParam0 /*1157*/].f_124))
...
void func_385(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_419(func_105(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_420(iParam0);
...
bool func_392(int iParam0, Vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_430(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) /*7*/ };
			if (!bParam6)
			{
				func_103(iParam0, 44, 1);
			}
...
void func_399(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_444(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_444(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
bool func_416(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_EQUIP_META_PED_OUTFIT(iParam1, func_448(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, false, true, true, true, false);
...
void func_417(int iParam0, int iParam1)
{
	...
	func_385(iParam1, func_447(iParam1, (1 << 13)), func_447(iParam1, (1 << 14)), 1);
}
...
void func_419(int iParam0, float fParam1, bool bParam2)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		fParam1 = func_450(fParam1, 0.0f, 1.0f);
...
struct<7> /*56*/ func_430(int iParam0, int iParam1, Vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	struct<7> /*56*/ sVar0;
...
void func_441(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 12)) > 0 && func_401(iParam1, 879715242))
	{
	...
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 9)) > 0 && func_401(iParam1, 1064646155))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1064646155);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 10)) > 0 && func_401(iParam1, -536694793))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -536694793);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 11)) > 0 && func_401(iParam1, -1304053509))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1304053509);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 31)) > 0 && func_401(iParam1, 718939204))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 718939204);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 16)) > 0 && func_401(iParam1, -972364774))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -972364774);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 14)) > 0 && func_401(iParam1, -1100875244))
	{
	...
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 18)) > 0 && func_401(iParam1, 1153596794))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1153596794);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 19)) > 0 && func_401(iParam1, 1016389820))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1016389820);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 20)) > 0 && func_401(iParam1, -726966617))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -726966617);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 21)) > 0 && func_401(iParam1, 1365901568))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1365901568);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 15)) > 0 && func_401(iParam1, -1658942149))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1658942149);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 17)) > 0 && func_401(iParam1, -1980913856))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1980913856);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 22)) > 0 && func_401(iParam1, 491764525))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 491764525);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 23)) > 0 && func_401(iParam1, -76015264))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -76015264);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 24)) > 0 && func_401(iParam1, 622113465))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 622113465);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 25)) > 0 && func_401(iParam1, 781533162))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 781533162);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 26)) > 0 && func_401(iParam1, -271415321))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -271415321);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 27)) > 0 && func_401(iParam1, -1683207356))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1683207356);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 28)) > 0 && func_401(iParam1, -254794762))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -254794762);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 29)) > 0 && func_401(iParam1, 609066278))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 609066278);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 30)) > 0 && func_401(iParam1, -1712783565))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1712783565);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 13)) > 0 && func_401(iParam1, 1544915253))
	{
...
void func_442(int iParam0)
{
	...
	func_461(iParam0, (1 << 9));
	func_461(iParam0, (1 << 10));
	func_461(iParam0, (1 << 11));
	func_461(iParam0, (1 << 12));
	func_461(iParam0, (1 << 16));
	func_461(iParam0, (1 << 14));
	func_461(iParam0, (1 << 18));
	func_461(iParam0, (1 << 19));
	func_461(iParam0, (1 << 20));
	func_461(iParam0, (1 << 21));
	func_461(iParam0, (1 << 15));
	func_461(iParam0, (1 << 17));
	func_461(iParam0, (1 << 27));
	func_461(iParam0, (1 << 30));
}
...
int func_444(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else if (iVar0 == joaat("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case joaat("GROUP_SHOTGUN"):
			case joaat("GROUP_RIFLE"):
				if (func_463(joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */))
				{
	...
	{
		func_464(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0.0f;
...
int func_464(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
	...
	{
		sVar0 = { func_471(iParam0, 0, 1) /*5*/ };
		iVar5 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
		sVar6.f_9 = joaat("SLOTID_NONE");
		iVar28 = 0;
		while (iVar28 < 4)
		{
			iVar5 = func_472((398 + iVar28), 1);
			if (func_473(iParam0, &sVar0, iVar5, 0))
			{
				if (func_474(iParam0, &sVar6, iVar5))
				{
					sVar29 = { func_475(iParam0, sVar0, iVar5, 0) /*4*/ };
					func_476(iParam0, &sVar29, &sVar0, 1, joaat("REMOVE_REASON_DEFAULT"), 1, 0);
				}
				else
				{
					iVar28++;
...
struct<5> /*40*/ func_471(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;
	...
	switch (func_483(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_475(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_485(iParam0, 1))
			{
				...
				if (!func_473(iParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_473(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_474(iParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_488(iParam0, joaat("CI_CATEGORY_CAMP")))
			{
				sVar0 = { func_475(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("KIT_CAMP") /* GXTEntry: "Camp" */);
			}
			else if (func_488(iParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_475(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("WARDROBE") /* GXTEntry: "Wardrobe" */);
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_489(sVar0, &sVar27, bParam1, 0))
				{
					sVar0.f_4 = 0;
				}
				else
...
struct<4> /*32*/ func_475(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
...
bool func_476(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!func_489(*uParam1, &sVar0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
...
void func_479(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_496(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> /*32*/ func_484(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_475(joaat("CARRIED_WEAPONS"), func_482(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_475(joaat("CARRIED_WEAPONS"), func_482(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_475(joaat("CARRIED_WEAPONS"), func_482(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_485(int iParam0, bool bParam1)
{
	if (func_487(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
struct<4> /*32*/ func_486(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_475(joaat("EMOTE_ITEM"), func_482(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_475(joaat("EMOTE_ITEM"), func_482(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
int func_490(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	sVar0 = { func_475(iParam0, sParam1, iParam5, bParam6) /*4*/ };
...
bool func_491(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_493(0);
	*uParam1 = { func_475(iParam0, func_484(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
