...
void func_39(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0.0f, 0.0f, 0.0f) <= 5.0f || func_52(Global_1935630, (1 << 14))) || func_52(Global_1935630, (1 << 23)))
	{
		return;
	}
...
void func_59(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_50(iParam0) && func_76(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_98(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_98(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_98(&cVar6, joaat("COLOR_PURE_WHITE")), func_98(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
int func_82(int iParam0, bool bParam1)
{
	...
	if (func_117(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			if (func_117(iParam0, (1 << 11)))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_121(iParam0));
				func_122(iParam0, (1 << 11));
			}
...
char* func_98(char* sParam0, int iParam1)
{
	...
	return func_132(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_99(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_103(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_113(int iParam0)
{
	...
	func_140(iParam0, (1 << 13));
	func_140(iParam0, (1 << 14));
	func_140(iParam0, (1 << 15));
	func_140(iParam0, (1 << 17));
	func_140(iParam0, (1 << 24));
	func_140(iParam0, (1 << 19));
	func_140(iParam0, (1 << 20));
...
bool func_126(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_154(iVar0) && func_155(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_143(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_165(iParam0, (1 << 10)))
		{
			func_166(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_165(iParam0, (1 << 10)))
	{
		func_167(iParam0, (1 << 10));
		INVENTORY::_0x9B4E793B1CB6550A();
	}
	func_168(iParam0);
}
...
bool func_157(Vector3 vParam0, int iParam3)
{
	...
	func_174(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_175(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
