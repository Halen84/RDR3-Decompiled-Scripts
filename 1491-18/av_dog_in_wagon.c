...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_49(uParam0, 0, "DIWP_MAN", iVar0, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, -3.0f, -2.0f, 0.0f), (94.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 1, "DIWP_DOG", joaat("A_C_DOGBLUETICKCOONHOUND_01"), OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, -5.0f, -2.0f, 0.0f), (-85.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	...
	func_50(uParam0, "WAGON" /* GXTEntry: "Wagon" */, joaat("WAGON02X"), vParam1, vParam4.z, 0, 0, 0, 0);
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				func_69(uParam0->f_20[0 /*14*/], uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 2, (1 << 30));
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				func_69(uParam0->f_20[1 /*14*/], uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 2, (1 << 30));
				...
				PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 262 /*PCF_0x124BE9DD*/, true);
		...
		case 1:
			...
			{
				func_67(uParam0);
				TASK::TASK_ENTER_VEHICLE(uParam0->f_20[1 /*14*/], uParam0->f_453, -1, 3, 1.0f, 1, 0);
				TASK::TASK_ENTER_VEHICLE(uParam0->f_20[0 /*14*/], uParam0->f_453, -1, -1, 1.0f, (1 << 17), 0);
		...
		case 2:
			...
			else
			{
				if (!bVar1)
				{
					if (!func_75(uParam0->f_20[1 /*14*/], joaat("SCRIPT_TASK_ENTER_VEHICLE")))
					{
						TASK::TASK_ENTER_VEHICLE(uParam0->f_20[1 /*14*/], uParam0->f_453, -1, 3, 1.0f, 1, 0);
					}
				}
				if (!bVar0)
				{
					if (!func_75(uParam0->f_20[0 /*14*/], joaat("SCRIPT_TASK_ENTER_VEHICLE")))
					{
						TASK::TASK_ENTER_VEHICLE(uParam0->f_20[0 /*14*/], uParam0->f_453, -1, -1, 1.0f, (1 << 17), 0);
					}
				}
			...
			break;
		case 3:
			if (func_76(&uLocal_38, 6.0f))
			{
				TASK::TASK_VEHICLE_DRIVE_WANDER(uParam0->f_20[0 /*14*/], uParam0->f_453, MISC::GET_RANDOM_FLOAT_IN_RANGE(3.0f, 5.0f), 524311);
				return 1;
			}
			break;
	}
...
int func_68(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_107(*uParam0, 0.0f, 0.0f, 0.0f))
	{
		return 1;
	}
	iVar1 = 0;
