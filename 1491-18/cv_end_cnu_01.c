...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.5001f, 1.2125f, 0.0f, 0.0f, 1.0f, 1.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	func_151(uParam0, -0.0251f, -1.175f, 0.0f, 0.0f, 1.0f, 1.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_CHARLES"), 1, 1, 1);
	func_152(uParam0, -0.15f, 0.0f, 0.0f, 12.0f, 0.94f, 1.57f, 3.0f, joaat("VOLCYLINDER"), 1);
	iLocal_16 = func_153(uParam0, joaat("P_BOTTLEBEER01X"), 0.0f, 0.0f, 0.0f, "S_INV_WHISKEY01X", 0, 0, 1);
	iLocal_17 = func_153(uParam0, joaat("P_JAVIERKNIFE_TEMP"), 0.0f, 0.0f, 0.0f, "w_melee_knife06", 0, 0, 1);
	iLocal_18 = func_153(uParam0, joaat("P_WOODWHITTLE01X"), 0.0f, 0.0f, 0.0f, "p_woodWhittle01x", 0, 0, 1);
	iLocal_19 = func_153(uParam0, joaat("P_CHAIR_BARREL04B"), -0.434831f, 1.30266f, -0.00206757f, "p_chair_barrel04b", 1, 0, 1);
	iLocal_20 = func_153(uParam0, joaat("P_CHAIR_CRATE15X"), 0.0f, 0.0f, 0.0f, "p_chair_crate15x", 0, 0, 1);
...
{
	return func_192(Global_35, uParam0->f_23, 60.0f, 1, 0);
}
