...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 2.5206f, -3.032f, 0.4558f, 10.44f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, 1.0272f, -3.2717f, 0.5389f, 10.68f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	func_152(uParam0, 1.75f, -3.35f, 0.5f, 12.0f, 1.0f, 0.56f, 3.0f, joaat("VOLCYLINDER"), 1);
	func_153(uParam0, joaat("P_CHAIR05X"), 0.0f, 0.0f, 0.0f, "CHAIR_0", 0, 0, 1);
	iLocal_21 = func_153(uParam0, joaat("P_CHAIR05X"), 0.0f, 0.0f, 0.0f, "CHAIR_1", 0, 0, 1);
	func_153(uParam0, joaat("P_CS_SOCK01X"), 0.0f, 0.0f, 0.0f, "SOCK", 0, 0, 1);
	...
	func_157(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_PORCH"), "PROP_HUMAN_SEAT_CHAIR_PORCH_MALE_A", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_15, 1, -1);
	sLocal_22 = { func_159(uParam0, 1.027f, -3.272f, 0.539f, -165.24f, 7.0f, 0.5f, 0.5f) /*10*/ };
	sLocal_32 = { func_159(uParam0, 1.027f, -3.272f, 0.539f, 96.02f, 7.0f, 0.597f, 0.4f) /*10*/ };
	sLocal_42 = { func_159(uParam0, 1.027f, -3.272f, 0.539f, -84.23f, 7.0f, 0.597f, 0.4f) /*10*/ };
	return true;
}
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_256(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_270(uParam0->f_107[iVar12 /*113*/].f_1));
				}
