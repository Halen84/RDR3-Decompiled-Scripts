...
void __SCRIPT()
{
	...
	func_2(&sLocal_16, &uScriptParam_0);
	while (!func_3(&sLocal_16))
	{
		func_4(&sLocal_16);
		switch (func_5(sLocal_16))
		{
			case 0:
				if (func_6(&sLocal_16))
				{
...
{
	return HUD::TEXT_BLOCK_IS_LOADED("NTV1" /* GXTEntry: "Archeology for Beginners" */);
}
...
{
	HUD::_TEXT_BLOCK_DELETE("NTV1" /* GXTEntry: "Archeology for Beginners" */);
	return 1;
}
...
{
	HUD::TEXT_BLOCK_REQUEST("NTV1" /* GXTEntry: "Archeology for Beginners" */);
}
