...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			break;
		case 2:
			func_150(uParam0, 705.439f, -1244.025f, 44.15f, 0.0f, 0.0f, -43.56f);
			break;
		default:
			return false;
	}
	...
	func_152(uParam0, 1.15f, -0.7f, 0.22f, 0.0f, 4.0f, 4.0f, 5.0f, joaat("VOLCYLINDER"), -1, 1, 1, 1);
	...
	func_155(uParam0, iLocal_14, 1.4f, 1065353216 /* Float: 1f */, 1092616192 /* Float: 10f */);
	func_154(uParam0, iLocal_15, 2, 1, 0, 0, 0);
	func_156(uParam0, "ABI6AUD");
	func_157(uParam0, 20.0f, 30.0f);
	iLocal_30 = func_158(uParam0, 1.6236f, 2.5306f, 1.0664f, 0.0f, 0.0f, 0.0f, 6.0f, 5.0f, 2.0f, "BackTrigger", joaat("VOLBOX"));
	iLocal_29 = func_158(uParam0, 1.6236f, -2.4694f, 1.0664f, 0.0f, 0.0f, 0.0f, 6.0f, 5.0f, 2.0f, "FrontTrigger", joaat("VOLBOX"));
	return true;
}
...
int func_158(var uParam0, Vector3 vParam1, Vector3 vParam4, Vector3 vParam7, char* sParam10, int iParam11)
{
	...
	vVar1 = { func_250(uParam0, vParam1) /*3*/ };
