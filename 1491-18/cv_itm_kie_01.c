...
bool func_76(var uParam0)
{
	...
	func_161(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_HORSE_TEND_BRUSH_LINK"), "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 18.0f, 1065353216 /* Float: 1f */, 1);
...
int func_200(var uParam0)
{
	...
	{
		iLocal_32 = func_309("INTERACT_GREET" /* GXTEntry: "Greet" */, joaat("INPUT_INTERACT_LOCKON_POS"), func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
...
int func_309(char* sParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_220(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_368(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, bParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_373(joaat("AMMO_REVOLVER_AMMOBOX_HIGH_VELOCITY") /* GXTEntry: "Revolver Cartridges - High Velocity" */);
		...
		case 2:
			...
			uParam0->f_22 = func_373(joaat("CONSUMABLE_HORSE_REVIVER") /* GXTEntry: "Horse Reviver" */);
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_373(joaat("CONSUMABLE_PREDATOR_BAIT") /* GXTEntry: "Predator Bait" */);
		...
		case 7:
			...
			uParam0->f_22 = func_373(joaat("CONSUMABLE_POTENT_MEDICINE") /* GXTEntry: "Potent Health Cure" */);
		...
		case 8:
			...
			uParam0->f_22 = func_373(joaat("CONSUMABLE_CHOCOLATE_BAR") /* GXTEntry: "Chocolate Bar" */);
		...
		case 11:
			...
			uParam0->f_22 = func_373(joaat("CONSUMABLE_HORSE_STIMULANT") /* GXTEntry: "Horse Stimulant" */);
		...
		case 13:
			...
			uParam0->f_22 = func_373(joaat("PROVISION_GOLDRING") /* GXTEntry: "Gold Wedding Ring" */);
			break;
		case 14:
			...
			uParam0->f_22 = func_373(joaat("CONSUMABLE_CIGAR") /* GXTEntry: "Cigar" */);
		...
		case 16:
			...
			uParam0->f_22 = func_373(joaat("CONSUMABLE_RUM") /* GXTEntry: "Guarma Rum" */);
		...
		case 17:
			...
			uParam0->f_22 = func_373(joaat("KIT_GUN_OIL") /* GXTEntry: "Gun Oil" */);
		...
		case 19:
			...
			uParam0->f_22 = func_373(joaat("CONSUMABLE_POTENT_TONIC") /* GXTEntry: "Potent Miracle Tonic" */);
		...
		case 20:
			...
			uParam0->f_22 = func_373(joaat("CONSUMABLE_MEDICINE") /* GXTEntry: "Health Cure" */);
...
void func_320(int iParam0)
{
	...
	{
		case 9:
			if (func_374(joaat("PROVISION_JACKS_THIMBLE") /* GXTEntry: "Thimble" */, 0, 0) < 1)
			{
				func_375();
...
void func_321(var uParam0)
{
	...
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		...
		if (*uParam0 == 21)
		{
			func_382(1, joaat("CONSUMABLE_WHISKEY") /* GXTEntry: "Kentucky Bourbon" */, 0);
			func_382(2, joaat("CONSUMABLE_PEPPERMINT") /* GXTEntry: "Peppermint" */, 0);
			func_382(3, joaat("CONSUMABLE_HERB_MILKWEED") /* GXTEntry: "Milkweed" */, 0);
			func_382(4, joaat("CONSUMABLE_HAIR_GREASE") /* GXTEntry: "Hair Pomade" */, 0);
			func_382(5, 0, joaat("AT_SKUNK") /* GXTEntry: "Skunk" */);
			iVar3 = 0;
			while (iVar3 < 6)
			{
				if (iVar3 == 0)
...
void func_383(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		...
		if (bParam4)
		{
			...
			Global_1359489.f_361.f_194 = func_431("CAMP_REQUEST" /* GXTEntry: "Item Request" */, "CAMP_REQUEST_DETAIL" /* GXTEntry: "Log Updated" */, 1997120069, MISC::GET_HASH_KEY(func_379(uParam0->f_3)), joaat("PLAYER_MENU"), "INPUT_FEED_INTERACT_GENERIC" /* GXTEntry: "Hold ~INPUT_FEED_INTERACT~ for details" */, joaat("SP_MISSIONS"), 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
char* func_388(char* sParam0, int iParam1)
{
	...
	return func_438(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}
...
int func_446(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_486(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) /*3*/ };
...
void func_468(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_519(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_519(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
struct<5> /*40*/ func_547(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_426(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_521(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_521(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
