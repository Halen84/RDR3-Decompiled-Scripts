...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.5375f, -9.325f, 1.4875f, 0.0f, 1.0f, 1.0f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
...
bool func_238(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_289(iVar0) && func_311(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_416(int iParam0, int iParam1)
{
	...
	func_383(iParam1, func_444(iParam1, (1 << 13)), func_444(iParam1, (1 << 14)), 1);
}
