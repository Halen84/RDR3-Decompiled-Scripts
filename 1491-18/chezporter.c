				...
				case 6:
					if (func_7(func_6(iLocal_20)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_20 /*35*/].f_11 > 0.0f)
							{
...
bool func_11()
{
	iLocal_14 = VOLUME::CREATE_VOLUME_CYLINDER(-380.2749f, 1922.471f, 295.698f, 0.0f, 0.0f, 0.0f, 45.0f, 45.0f, 60.0f);
	return true;
}
...
void func_25()
{
	...
	iLocal_15 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-410.2579f, 1722.699f, 212.61f, 0.0f, 0.0f, 103.7064f, 121.5021f, 67.59155f, 24.51105f, "m_volAmbRestriction");
	POPULATION::_ADD_AMBIENT_AVOIDANCE_RESTRICTION(iLocal_15, 192, (1 << 14), 0, -1, -1, 0);
	POPULATION::_ADD_AMBIENT_SPAWN_RESTRICTION(iLocal_15, 192, (1 << 14), 0, -1, -1, 0);
}
...
void func_57()
{
	...
	if (((func_105(3, 1) || func_105(3, 2)) || (func_105(3, (1 << 27)) && func_106() != joaat("CA_HOMEROBBERY"))) || (func_105(3, 16) && !func_107()))
	{
...
void func_66(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_54(iParam0) && func_83(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_131(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_131(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_131(&cVar6, joaat("COLOR_PURE_WHITE")), func_131(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
char* func_131(char* sParam0, int iParam1)
{
	...
	return func_178(MISC::VAR_STRING(10, "LITERAL_STRING" /* GXTEntry: "~1p~" */, sParam0), iParam1);
}

int func_132(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_136(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_147(int iParam0)
{
	...
	func_186(iParam0, (1 << 13));
	func_186(iParam0, (1 << 14));
	func_186(iParam0, (1 << 15));
	func_186(iParam0, (1 << 17));
	func_186(iParam0, (1 << 24));
	func_186(iParam0, (1 << 19));
	func_186(iParam0, (1 << 20));
...
bool func_172(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_202(iVar0) && func_209(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_189(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_219(iParam0, (1 << 10)))
		{
			func_220(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_219(iParam0, (1 << 10)))
	{
...
int func_198(struct<2> /*16*/ sParam0, var uParam2)
{
	int iVar0;
...
void func_206(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar4 += func_232(iVar0, iVar1);
		iVar3--;
		iVar0 = BUILTIN::ROUND(func_233(BUILTIN::TO_FLOAT(iVar0 + 1), 0.0f, 12.0f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
bool func_211(Vector3 vParam0, int iParam3)
{
	...
	func_236(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_237(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
