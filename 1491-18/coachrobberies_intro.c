...
void __SCRIPT()
{
	...
	while (true)
	{
		...
		if (func_6(sLocal_73.f_0, 0))
		{
			...
			if (!func_8())
			{
				func_10(&sLocal_73, &iLocal_242, func_9(), &uLocal_263, 0.0f, 3, 0, 0, 1, 0, 0, 2, -1082130432 /* Float: -1f */);
			}
...
void func_1()
{
	...
	if (func_6(sLocal_73.f_0, 0))
	{
		...
		if (PED::GET_PED_CONFIG_FLAG(sLocal_73.f_0, 413 /*PCF_0xD291BB15*/, true))
		{
			PED::SET_PED_CONFIG_FLAG(sLocal_73.f_0, 413 /*PCF_0xD291BB15*/, false);
		}
		if (PED::GET_PED_CONFIG_FLAG(sLocal_73.f_0, 330 /*PCF_0x7C7AF264*/, true))
		{
			PED::SET_PED_CONFIG_FLAG(sLocal_73.f_0, 330 /*PCF_0x7C7AF264*/, false);
		}
		if (ENTITY::_IS_ENTITY_PLAYING_ANY_ANIM(sLocal_73.f_0, 1))
		{
	...
	HUD::_TEXT_BLOCK_DELETE("SCRB" /* GXTEntry: @"An invaluable remedy for any and all disorders. Serves as a preventative care for all maladies including dyspepsia and constipation. Contains the finest bitters, elderberry roots and fermented rye extracts. A true medical wonder that cures pain when it will not subdue.~n~" */);
...
void func_13()
{
	...
	switch (iLocal_66)
	{
		...
		case 1:
			...
			break;
		case 2:
			HUD::TEXT_BLOCK_REQUEST("SCRB" /* GXTEntry: @"An invaluable remedy for any and all disorders. Serves as a preventative care for all maladies including dyspepsia and constipation. Contains the finest bitters, elderberry roots and fermented rye extracts. A true medical wonder that cures pain when it will not subdue.~n~" */);
			...
			break;
		case 3:
			if (!HUD::TEXT_BLOCK_IS_LOADED("SCRB" /* GXTEntry: @"An invaluable remedy for any and all disorders. Serves as a preventative care for all maladies including dyspepsia and constipation. Contains the finest bitters, elderberry roots and fermented rye extracts. A true medical wonder that cures pain when it will not subdue.~n~" */))
			{
				bVar0 = false;
			}
		...
		case 5:
			...
			func_83(sLocal_73.f_2, 6.0f, "Coach_robbery_intro", 1, 0, 0, 0, -1082130432 /* Float: -1f */);
...
void func_14()
{
	...
	switch (iLocal_68)
	{
		case 0:
			...
			{
				func_25(1);
				PED::SET_PED_CONFIG_FLAG(sLocal_73.f_0, 297 /*PCF_ForceInteractionLockonOnTargetPed*/, true);
				PED::SET_PED_CONFIG_FLAG(sLocal_73.f_0, 315 /*PCF_0xD38AEF95*/, true);
				iLocal_68 = 1;
			}
			break;
		case 1:
		...
		case 2:
			...
			if (func_92(&(sLocal_73.f_8), 0.2f))
			{
				...
				if (PED::GET_PED_CONFIG_FLAG(sLocal_73.f_0, 301 /*PCF_DisableInteractionLockonOnTargetPed*/, true))
				{
					PED::SET_PED_CONFIG_FLAG(sLocal_73.f_0, 301 /*PCF_DisableInteractionLockonOnTargetPed*/, false);
				}
				iLocal_68 = 4;
			}
			break;
			...
			if (func_79())
			{
				...
				if (!func_95(sLocal_73.f_23))
				{
					...
					if (iLocal_62 == 13)
					{
						...
						{
							sLocal_73.f_23 = func_97("CR_C_RTL2" /* GXTEntry: "~o~Ask about moonshine" */, joaat("INPUT_INTERACT_LOCKON_A"), sLocal_73.f_0, 1, 0, 0, 0, 5, fVar0, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
						}
						else
						{
							func_86(&(sLocal_73.f_23), 1, 1);
					...
					{
						sLocal_73.f_23 = func_97("CR_C_PAYTIP" /* GXTEntry: "Coach Robbery Tip $~1~" */, joaat("INPUT_INTERACT_LOCKON_A"), sLocal_73.f_0, 1, 0, 0, 0, 5, fVar0, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
						func_98(sLocal_73.f_23, "CR_C_PAYTIP" /* GXTEntry: "Coach Robbery Tip $~1~" */, 2, 1);
					}
					if (func_95(sLocal_73.f_23))
					{
					...
					else if (func_103(ENTITY::GET_ENTITY_COORDS(sLocal_73.f_0, true, false), Global_35))
					{
						...
						if (func_109(sLocal_73.f_23, 1) || bLocal_29)
						{
							...
							if (bLocal_29 == 0)
							{
								...
								PED::SET_PED_CONFIG_FLAG(sLocal_73.f_0, 301 /*PCF_DisableInteractionLockonOnTargetPed*/, true);
								iLocal_67 = 1;
							}
						}
					}
...
int func_18(int iParam0)
{
	...
	{
		case 4:
			return joaat("DOCUMENT_COACH_ROBBERY_NOTE_01") /* GXTEntry: "North Scarlett Meadows Coach Tip" */;
		case 5:
			return joaat("DOCUMENT_COACH_ROBBERY_NOTE_02") /* GXTEntry: "South Scarlett Meadows Coach Tip" */;
		case 6:
			return joaat("DOCUMENT_COACH_ROBBERY_NOTE_03") /* GXTEntry: "Coach Convoy Tip" */;
		case 12:
			return joaat("DOCUMENT_COACH_ROBBERY_NOTE_04") /* GXTEntry: "Siltwater Strand Coach Tip" */;
		case 13:
			return joaat("DOCUMENT_COACH_ROBBERY_NOTE_05") /* GXTEntry: "Bluewater Marsh Coach Tip" */;
		case 0:
			return joaat("DOCUMENT_COACH_ROBBERY_NOTE_07") /* GXTEntry: "Fort Riggs Coach Tip" */;
		case 1:
			return joaat("DOCUMENT_COACH_ROBBERY_NOTE_08") /* GXTEntry: "Appleseed Timber Coach Tip" */;
		case 2:
			return joaat("DOCUMENT_COACH_ROBBERY_NOTE_09") /* GXTEntry: "Owanjila Coach Tip" */;
		default:
			break;
	}
	return joaat("DOCUMENT_COACH_ROBBERY_NOTE_01") /* GXTEntry: "North Scarlett Meadows Coach Tip" */;
...
int func_37()
{
	...
	{
		case 4:
			return joaat("UI_COACH_AMB1") /* GXTEntry: "Head North up the road past face rock. Wagon full of antiques coming from the Nor" +
    ...
    " to Seamus at Emerald Ranch. Careful not to damage the wagon or the cargo. X" */;
		case 5:
			return joaat("UI_COACH_AMB2") /* GXTEntry: "Road southwest of Bolger Glade. Look for a carriage coming from the South. Passen" +
    "ger is a wealthy merchant, probably keeps his cash hidden so might need some per" +
    "suasion. Xxxx" */;
		case 6:
			return joaat("UI_COACH_AMB3") /* GXTEntry: "Railway bridge Northeast of Hill Haven Ranch. Convoy of coaches coming from the N" +
    "orth. Expect good money but lots of guards. Be real careful. Xxxxxxxxxxxxx" */;
		case 12:
			return joaat("UI_COACH_AMB4") /* GXTEntry: "Coach coming south down the river road through Siltwater Strand. Valuables in str" +
    "ongbox. Passenger is the very wealthy Mrs Chester Damsen. Aspiring but appalling" +
    " opera singer. Use your imagination!" */;
		case 13:
			return joaat("UI_COACH_AMB5") /* GXTEntry: "Bridge in Bluewater Marsh north of Saint Denis. Look for a wagon coming south, sh" +
    "ould be carrying a load of moonshine bottles in the back. Drive careful with it." +
    " X" */;
		case 0:
			return joaat("UI_COACH_AMB7") /* GXTEntry: "River road near Fort Riggs. Coach coming from Blackwater heading for Riggs Statio" +
    "n. Should be carrying cash in the strongbox at the back. Expect a couple of guar" +
    "ds." */;
		case 1:
			return joaat("UI_COACH_AMB8") /* GXTEntry: "Railway bridge north of Appleseed Timber Co. Coach coming west headed for Applese" +
    "ed carrying wages, cash should be in the back. Expect a couple of guards." */;
		case 2:
			return joaat("UI_COACH_AMB9") /* GXTEntry: "Head out west past Owanjila. Banking coach coming from the North. Armored with he" +
...
void func_67()
{
	...
	func_197("CR_H_NOTE" /* GXTEntry: "Inspect the note from your Satchel to find out the details of the robbery, and to" +
    " mark the location on your map." */, 10000, 0, 0, 0, 1);
	if (iLocal_62 == 2)
	{
		if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, joaat("WEAPON_THROWN_DYNAMITE") /* GXTEntry: "Dynamite" */, 0, false))
		{
			func_198(Global_35, joaat("WEAPON_THROWN_DYNAMITE") /* GXTEntry: "Dynamite" */, 0, 0, 0, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 3, 0, 0, 0, 0);
		}
		else
		{
			WEAPON::_ADD_AMMO_TO_PED(Global_35, joaat("WEAPON_THROWN_DYNAMITE") /* GXTEntry: "Dynamite" */, 3, joaat("ADD_REASON_DEFAULT"));
		}
	}
	bLocal_15 = true;
}
...
bool func_77(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if (func_70(sLocal_73.f_1))
	{
		...
		PED::SET_PED_CONFIG_FLAG(sLocal_73.f_0, 130 /*PCF_DisableTalkTo*/, true);
		...
		{
			PLAYER::_SET_PLAYER_HAS_DISCOVERED_CHARACTER_NAME_SP(PLAYER::GET_PLAYER_INDEX(), 0, PLAYER::GET_DISCOVERABLE_NAME_HASH_AND_TYPE_FOR_ENTITY(sLocal_73.f_0, &uVar0));
		}
		if (bParam0 || bParam1)
		{
			func_21(1);
		...
		sLocal_73.f_28 = 1;
		PED::SET_PED_CONFIG_FLAG(sLocal_73.f_0, 413 /*PCF_0xD291BB15*/, true);
		PED::SET_PED_CONFIG_FLAG(sLocal_73.f_0, 330 /*PCF_0x7C7AF264*/, true);
		return true;
	}
	return false;
}
	...
	switch (iLocal_72)
	{
		case 0:
			...
			if (!func_95(sLocal_73.f_23))
			{
				...
				sLocal_73.f_23 = func_97("CR_C_TALK" /* GXTEntry: "Greet" */, joaat("INPUT_INTERACT_LOCKON_POS"), sLocal_73.f_0, 1, 0, 0, 0, 0, fVar3, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
				HUD::_UI_PROMPT_SET_GROUP(Global_1945188[func_99(sLocal_73.f_23) /*18*/].f_3, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(sLocal_73.f_0), 0);
			}
		...
		case 2:
			if (ENTITY::_GET_ENTITY_ANIM_CURRENT_TIME(sLocal_73.f_0, sVar5, "action_pt01_hector") > 0.99f)
			{
				...
				PLAYER::_SET_PLAYER_HAS_DISCOVERED_CHARACTER_NAME_SP(PLAYER::GET_PLAYER_INDEX(), 0, PLAYER::GET_DISCOVERABLE_NAME_HASH_AND_TYPE_FOR_ENTITY(sLocal_73.f_0, &uVar6));
...
int func_97(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_225(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_226(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
bool func_115(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_241(iParam0, joaat("CURRENCY_CASH") /* GXTEntry: "Money" */, iParam1, iVar0);
	}
...
void func_194()
{
	...
	iVar0[0] = joaat("DOCUMENT_COACH_ROBBERY_NOTE_01"); /* GXTEntry: "North Scarlett Meadows Coach Tip" */
	iVar0[1] = joaat("DOCUMENT_COACH_ROBBERY_NOTE_02"); /* GXTEntry: "South Scarlett Meadows Coach Tip" */
	iVar0[2] = joaat("DOCUMENT_COACH_ROBBERY_NOTE_03"); /* GXTEntry: "Coach Convoy Tip" */
	iVar0[3] = joaat("DOCUMENT_COACH_ROBBERY_NOTE_04"); /* GXTEntry: "Siltwater Strand Coach Tip" */
	iVar0[4] = joaat("DOCUMENT_COACH_ROBBERY_NOTE_07"); /* GXTEntry: "Fort Riggs Coach Tip" */
	iVar0[5] = joaat("DOCUMENT_COACH_ROBBERY_NOTE_08"); /* GXTEntry: "Appleseed Timber Coach Tip" */
	iVar0[6] = joaat("DOCUMENT_COACH_ROBBERY_NOTE_09"); /* GXTEntry: "Owanjila Coach Tip" */
	iVar8 = 0;
	while (iVar8 < 7)
	{
...
int func_195(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	{
		if ((!func_344(iParam0, joaat("CI_TAG_ITEM_TALISMAN")) && !func_344(iParam0, joaat("CI_TAG_ITEM_UPGRADE"))) && !func_344(iParam0, joaat("CI_TAG_ITEM_IS_SATCHEL")))
		{
			bVar3 = true;
		}
	}
	...
	if (!bVar3)
	{
		...
		else if (func_344(iParam0, joaat("CI_TAG_ITEM_FISHING_LURE")))
		{
			switch (iParam0)
			{
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_LAKE") /* GXTEntry: "Special Lake Lure" */:
					if (!func_19(joaat("DOCUMENT_PAMPHLET_SPECIAL_LAKE_LURE") /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0))
					{
						func_195(joaat("DOCUMENT_PAMPHLET_SPECIAL_LAKE_LURE") /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_RIVER") /* GXTEntry: "Special River Lure" */:
					if (!func_19(joaat("DOCUMENT_PAMPHLET_SPECIAL_RIVER_LURE") /* GXTEntry: "Special River Lure Handbill" */, 1, 0))
					{
						func_195(joaat("DOCUMENT_PAMPHLET_SPECIAL_RIVER_LURE") /* GXTEntry: "Special River Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_SWAMP") /* GXTEntry: "Special Swamp Lure" */:
					if (!func_19(joaat("DOCUMENT_PAMPHLET_SPECIAL_SWAMP_LURE") /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0))
					{
						func_195(joaat("DOCUMENT_PAMPHLET_SPECIAL_SWAMP_LURE") /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_LAKE") /* GXTEntry: "Lake Lure" */:
					if (!func_19(joaat("DOCUMENT_PAMPHLET_LAKE_LURE") /* GXTEntry: "Lake Lure Handbill" */, 1, 0))
					{
						func_195(joaat("DOCUMENT_PAMPHLET_LAKE_LURE") /* GXTEntry: "Lake Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_RIVER") /* GXTEntry: "River Lure" */:
					if (!func_19(joaat("DOCUMENT_PAMPHLET_RIVER_LURE") /* GXTEntry: "River Lure Handbill" */, 1, 0))
					{
						func_195(joaat("DOCUMENT_PAMPHLET_RIVER_LURE") /* GXTEntry: "River Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_SWAMP") /* GXTEntry: "Swamp Lure" */:
					if (!func_19(joaat("DOCUMENT_PAMPHLET_SWAMP_LURE") /* GXTEntry: "Swamp Lure Handbill" */, 1, 0))
					{
						func_195(joaat("DOCUMENT_PAMPHLET_SWAMP_LURE") /* GXTEntry: "Swamp Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
			}
		}
		...
		else if (func_344(iParam0, joaat("CI_TAG_ITEM_IS_SATCHEL")))
		{
			iVar8 = 0;
			switch (iParam0)
			{
		...
		switch (iParam0)
		{
			...
			case joaat("UPGRADE_OFFHAND_HOLSTER") /* GXTEntry: "Upgraded Off-Hand Holster" */:
				...
				{
					func_376(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_OFFHAND_HOLSTER") /* GXTEntry: "Upgraded Off-Hand Holster" */, 0, joaat("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_377(&iVar9, 0))
				{
			...
			case joaat("UPGRADE_BANDOLIER") /* GXTEntry: "Upgraded Bandolier" */:
				...
				{
					func_376(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_BANDOLIER") /* GXTEntry: "Upgraded Bandolier" */, 0, joaat("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case joaat("CONSUMABLE_AGED_PIRATE_RUM") /* GXTEntry: "Aged Pirate Rum" */:
				func_392(242, func_391(joaat("CONSUMABLE_AGED_PIRATE_RUM") /* GXTEntry: "Aged Pirate Rum" */), 0);
				break;
			case joaat("CONSUMABLE_GINSENG_ELIXIER") /* GXTEntry: "Ginseng Elixir" */:
				func_392(240, func_391(joaat("CONSUMABLE_GINSENG_ELIXIER") /* GXTEntry: "Ginseng Elixir" */), 0);
				break;
			case joaat("CONSUMABLE_VALERIAN_ROOT") /* GXTEntry: "Valerian Root" */:
				func_392(241, func_391(joaat("CONSUMABLE_VALERIAN_ROOT") /* GXTEntry: "Valerian Root" */), 0);
				break;
			...
			case joaat("CONSUMABLE_MOONSHINE") /* GXTEntry: "Moonshine" */:
				...
				{
					func_393(594, joaat("TF_FORTIFY_TANK1") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Health Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_RESTORATIVE") /* GXTEntry: "Bitters" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_393(594, joaat("TF_FORTIFY_TANK2") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Stamina Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_CHEWING_TOBACCO_USED") /* GXTEntry: "Opened Chewing Tobacco" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_393(594, joaat("TF_FORTIFY_TANK3") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Dead Eye Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_POTENT_TONIC") /* GXTEntry: "Potent Miracle Tonic" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_393(594, joaat("TF_FORTIFY_TANK4") /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    ...
    "d Eye Bars." */, 1, 1);
			...
			case joaat("CONSUMABLE_MEAL_ROAST_BEEF") /* GXTEntry: "Roast Beef" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_393(595, joaat("TF_FORTIFY_CORE1") /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    "for a short period of time. This Provision will Fortify your Health Core." */, 1, 1);
			...
			case joaat("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL_EGGS") /* GXTEntry: "Regional Beef and Eggs Stew" */:
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_393(595, joaat("TF_FORTIFY_CORE2") /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
...
int func_198(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (iVar0 == joaat("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case joaat("GROUP_SHOTGUN"):
			case joaat("GROUP_RIFLE"):
				if (func_405(joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */))
				{
...
void func_242()
{
	...
	switch (iLocal_71)
	{
		...
		case 5:
			...
			if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(sLocal_73.f_162, false))
			{
				if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, joaat("PLAYERLEAVES")) || ANIMSCENE::HAS_ENTITY_EXITED_ANIM_SCENE(sLocal_73.f_162, sVar6))
				{
					if (func_8())
					{
...
void func_327(int iParam0, bool bParam1)
{
	...
	switch (func_526(iParam0, joaat("TAG_INTERACTION_TYPE")))
	{
...
bool func_356(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_19(joaat("PROVISION_TRINKET_CROW_BEAK") /* GXTEntry: "Crow Beak Trinket" */, 1, 0) && iParam2 == joaat("ADD_REASON_LOOTED"))
	{
...
bool func_363()
{
	if (((((func_566(joaat("DOCUMENT_ARTHUR_MINOR_BOUNTY_1") /* GXTEntry: "Bounty Poster of Arthur" */, 400) || func_566(joaat("DOCUMENT_ARTHUR_MINOR_BOUNTY_2") /* GXTEntry: "Bounty Notice" */, 400)) || func_566(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_1") /* GXTEntry: "Bounty Hunter\'s Orders" */, 400)) || func_566(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_2") /* GXTEntry: "Poster of a Violent Criminal" */, 400)) || func_566(joaat("DOCUMENT_ARTHUR_HAS_POSTER_1") /* GXTEntry: "Bounty Hunter\'s Letter" */, 400)) || func_566(joaat("DOCUMENT_ARTHUR_HAS_POSTER_2") /* GXTEntry: "Bounty Page" */, 400))
	{
		return true;
	}
	return false;
...
void func_368(int iParam0)
{
	...
	switch (iParam0)
	{
		case joaat("DOCUMENT_TAXIDERMY_ORDER_1") /* GXTEntry: "Hunting Request" */:
			...
			func_334(437, 0);
			func_334(440, 0);
			func_578(joaat("TAXIDERMY_ORDER_01"), joaat("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT") /* GXTEntry: "Perfect Squirrel Carcass" */, &sVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_2") /* GXTEntry: "Hunting Request" */:
			...
			func_578(joaat("TAXIDERMY_ORDER_02"), joaat("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT") /* GXTEntry: "Perfect Cardinal Carcass" */, &sVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_3") /* GXTEntry: "Hunting Request" */:
			...
			func_578(joaat("TAXIDERMY_ORDER_03"), joaat("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT") /* GXTEntry: "Perfect Chipmunk Carcass" */, &sVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_4") /* GXTEntry: "Hunting Request" */:
			...
			func_578(joaat("TAXIDERMY_ORDER_04"), joaat("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT") /* GXTEntry: "Perfect Songbird Carcass" */, &sVar0, 1, 0, 0);
		...
		case joaat("DOCUMENT_TAXIDERMY_ORDER_5") /* GXTEntry: "Hunting Request" */:
			...
			func_334(438, 0);
			func_578(joaat("TAXIDERMY_ORDER_05"), joaat("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT") /* GXTEntry: "Perfect Cedar Waxwing Carcass" */, &sVar0, 1, 0, 0);
...
void func_370(int iParam0, int iParam1)
{
	...
	if (func_127() == -1)
	{
		...
		else if (func_344(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_01")))
		{
		...
		else if (func_344(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_02")))
		{
		...
		else if (func_344(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_03")))
		{
		...
		else if (func_344(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_04")))
		{
		...
		else if (func_344(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_05")))
		{
...
void func_373(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_127() == -1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam2))
		{
			...
			{
				func_364(0, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), iVar0);
				return;
			}
		}
	}
	switch (iParam0)
	{
		case joaat("MONEY_ONE_DOLLAR") /* GXTEntry: "$1.00" */:
			func_364(joaat("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_FIVE_DOLLARS") /* GXTEntry: "$5.00" */:
			func_364(joaat("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_TEN_DOLLARS") /* GXTEntry: "$10.00" */:
			func_364(joaat("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLFOLD") /* GXTEntry: "Bill Fold" */:
			func_364(joaat("REWARD_BILLFOLD"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLFOLD_SML") /* GXTEntry: "Small Bill Fold" */:
			func_364(joaat("REWARD_BILLFOLD_SML"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLSTACK") /* GXTEntry: "Bill Stack" */:
			func_364(joaat("REWARD_BILLSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COIN") /* GXTEntry: "Coin" */:
			func_364(joaat("REWARD_COIN"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINPURSE") /* GXTEntry: "Coin Purse" */:
			func_364(joaat("REWARD_COINPURSE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINSACK") /* GXTEntry: "Coin Sack" */:
			func_364(joaat("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINSTACK") /* GXTEntry: "Coin Stack" */:
			func_364(joaat("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYCLIP") /* GXTEntry: "Money Clip" */:
			func_364(joaat("REWARD_MONEYCLIP"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYSTACK") /* GXTEntry: "Money Stack" */:
			func_364(joaat("REWARD_MONEYSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYSTACK_LARGE") /* GXTEntry: "Money Pile" */:
			if (!func_590())
			{
				func_364(joaat("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			}
			break;
		case joaat("MONEY_COINCUP_SM") /* GXTEntry: "Change Cup" */:
			func_364(joaat("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINCUP_LG") /* GXTEntry: "Coin Cup" */:
			func_364(joaat("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
...
void func_403(int iParam0, char* sParam1)
{
	...
	func_422(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP" /* GXTEntry: "~1w~ ~2~" */, sParam1, sVar0), "inventory_items", func_623(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_404(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	strcpy_s(&cVar2, 32, func_626(iVar1 == 1, "ITEM_GET_PUMP" /* GXTEntry: "~1~" */, "ITEM_GET_PUMP_MULT" /* GXTEntry: "~2~x ~1~" */));
	if (iParam1 > 0)
	{
	}
	else
	...
	if (((((iParam1 == 1 || func_344(iParam0, joaat("CI_TAG_SMOKING_CIGARETTE"))) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
...
void func_427()
{
	if (iLocal_62 == 0)
	{
		...
		ANIMSCENE::SET_ANIM_SCENE_ENTITY(sLocal_73.f_162, "note" /* GXTEntry: "Note" */, sLocal_73.f_159, 0);
		if (!ENTITY::DOES_ENTITY_EXIST(sLocal_73.f_160))
		{
		...
		ANIMSCENE::SET_ANIM_SCENE_ENTITY(sLocal_73.f_162, "MONEY" /* GXTEntry: "~$~" */, sLocal_73.f_160, 1);
		return;
	}
	if (func_6(sLocal_73.f_0, 0))
	{
...
bool func_525(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_517(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_551(iParam0, &sVar4, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
			{
				return false;
			}
			if (func_671(iParam0, 1))
			{
				if (!func_550(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					return false;
				}
				else if (func_551(iParam0, &sVar4, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */))
				{
					return false;
				}
			}
...
char* func_536(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6)
{
	switch (iParam1)
	{
		case joaat("CIGARETTE_CARDS"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_CC_CARD_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Card Sets Posted" */, func_693(), 12);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_CC_CARD_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Card Sets Found" */, func_694(), 12);
			}
			break;
		case joaat("DINO_BONES"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_DB_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Dinosaur Bones Posted" */, func_695(), 30);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_DB_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Dinosaur Bones Found" */, func_576(), 30);
			}
			break;
		...
		case joaat("LEGENDARY_FISH"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_LF_CAUGHT_OBJ" /* GXTEntry: "~1~ of ~2~ Legendary Fish Caught and Posted" */, func_696(), 13);
			}
			break;
		case joaat("ROCK_CARVINGS"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_RC_POSTED_OBJ" /* GXTEntry: "~1~ of ~2~ Rock Faces Posted" */, func_697(), 10);
			}
			else
			{
				sParam3 = MISC::VAR_STRING(2, "COL_RC_FOUND_OBJ" /* GXTEntry: "~1~ of ~2~ Rock Faces Found" */, func_577(), 10);
			}
			break;
		case joaat("TAXIDERMY"):
			...
			{
				sParam3 = MISC::VAR_STRING(2, "COL_TX_CARCASS_COLLECTED_OBJ" /* GXTEntry: "~1~ of ~2~ Carcasses Collected" */, sParam4, func_535(iParam6, 20));
			}
			break;
	}
	return sParam3;
...
bool func_540(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		...
		{
			if (func_705(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, joaat("LEGENDARY_FISH"), 0)))
			{
				bVar1 = true;
			}
			else if (iParam5 == 8)
...
void func_547(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_545("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_MANUAL_PAINT" /* GXTEntry: "Manual Painting" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_545("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_STAY_ACTIVE" /* GXTEntry: "Continued Free Fire" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_545("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_FATAL" /* GXTEntry: "Fatal Region Highlights" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_545("DEADEYE_ABILITY_UNLOCK" /* GXTEntry: "Dead Eye Ability Unlocked" */, "DEADEYE_ABILITY_CRITICAL" /* GXTEntry: "Critical Region Highlights" */, joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
...
int func_567(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1.0f;
	if (bParam1 && func_19(joaat("PROVISION_TRINKET_ELK_ANTLER") /* GXTEntry: "Elk Antler Trinket" */, 1, 0))
	{
		fVar0 += 0.1f;
	}
	sVar1.f_1 = 10;
...
void func_569(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iParam0 += iVar2;
		iVar1 += iVar2;
		func_422(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN" /* GXTEntry: "Total Take ~1$~" */, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_TOTAL_TAKE"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		iParam0 -= iVar0;
		if (iVar0 > 0)
		{
			func_733(iVar0);
		...
		func_422(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN" /* GXTEntry: "Your Share ~1$~" */, iVar1), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_581()
{
	...
	while (iVar1 < 5)
	{
		if (func_740(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, joaat("EXOTIC_ITEMS"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_613(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_197(MISC::VAR_STRING(10, "OUT_JOURN_DONE" /* GXTEntry: "~1~ completed." */, MISC::VAR_STRING(0, iVar0)), 10000, 0, 0, 0, 1);
	}
	func_780(iParam0, 6);
	if (bParam2)
	{
...
void func_669(int iParam0, int iParam1)
{
	...
	if (func_127() == -1)
	{
		if (func_333(43))
		{
			if (func_344(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_01")))
			{
				func_580(joaat("EXOTIC_STAGE_01"));
				if (func_581() == 0)
				{
		...
		if (func_333(44))
		{
			if (func_344(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_02")))
			{
				func_580(joaat("EXOTIC_STAGE_02"));
				if (func_581() == 1)
				{
		...
		if (!func_333(45))
		{
			if (func_344(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_03")))
			{
				func_580(joaat("EXOTIC_STAGE_03"));
				if (func_581() == 2)
				{
		...
		if (!func_333(46))
		{
			if (func_344(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_04")))
			{
				func_580(joaat("EXOTIC_STAGE_04"));
				if (func_581() == 3)
				{
		...
		if (!func_333(47))
		{
			if (func_344(iParam0, joaat("CI_TAG_ITEM_EXOTIC_STAGE_05")))
			{
				func_580(joaat("EXOTIC_STAGE_05"));
				if (func_581() == 4)
				{
...
{
	if (func_799(iParam0, joaat("DEFAULT") /* GXTEntry: "_" */) == 0)
	{
		return false;
	}
	return true;
...
int func_696()
{
	...
	while (iVar1 < 14)
	{
		if (func_705(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, joaat("LEGENDARY_FISH"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_720()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_350(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN") /* GXTEntry: "John\'s Cattleman Revolver" */);
		func_397(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN") /* GXTEntry: "John\'s Cattleman Revolver" */, 1, joaat("ADD_REASON_DEFAULT"));
		...
		func_350(joaat("WEAPON_MELEE_KNIFE_JOHN") /* GXTEntry: "John\'s Knife" */);
		func_397(joaat("WEAPON_MELEE_KNIFE_JOHN") /* GXTEntry: "John\'s Knife" */, 1, joaat("ADD_REASON_DEFAULT"));
...
int func_751(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	bVar0 = func_823(0);
	if (iParam2 != 0 && func_824(iParam0, bVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
void func_776(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_775(iParam0))
	{
		...
		if ((!func_779() && !bParam1) && !func_65(0, 0, 1))
		{
			func_197(MISC::VAR_STRING(10, "OUT_JOURN_ADD" /* GXTEntry: "~1~ discovered." */, func_838(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
void func_807(int iParam0, int iParam1, int iParam2)
{
	...
	func_543(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC" /* GXTEntry: "Hold ~INPUT_FEED_INTERACT~ for details" */, func_861(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
bool func_880(int iParam0)
{
	...
	if (func_344(iParam0, joaat("CI_TAG_ITEM_EQUIPMENT_HOLSTER")))
	{
		return true;
	}
	return false;
...
bool func_881(int iParam0)
{
	...
	if (func_344(iParam0, joaat("CI_TAG_ITEM_EQUIPMENT_OFFHAND")))
	{
		return true;
	}
	return false;
...
void func_930(var uParam0, var uParam1, int iParam2)
{
	...
	uParam0->f_1 = PED::_REQUEST_META_PED_COMPONENT(iVar0, uParam1, 0, func_127() != -1, iParam2);
	*uParam0 = 1;
}
