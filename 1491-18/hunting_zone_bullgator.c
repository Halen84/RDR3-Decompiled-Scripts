...
void func_23(int iParam0, bool bParam1)
{
	...
	if (iVar4 > 0 && iVar4 < 15)
	{
		...
		{
			iVar0 = 0;
			if (func_76(uVar5[iVar3], joaat("COST_CRAFTING_TRAPPER"), &iVar0))
			{
				iVar0 -= func_77(uVar5[iVar3], 1);
				if (iVar0 > 0)
				{
			...
			if (bParam1 && func_76(uVar5[iVar3], joaat("COST_CRAFTING_FENCE"), &iVar0))
			{
				iVar0 -= func_77(uVar5[iVar3], 0);
				if (iVar0 > 0)
				{
...
bool func_48(var uParam0)
{
	...
	func_99(uParam0->f_3, "Hunting Zone Target Pending", 0, 0, (1 << 13), 0, -1082130432 /* Float: -1f */);
	return true;
}
...
bool func_50(var uParam0)
{
	...
	uParam0->f_12.f_13 = { 0.0f, 0.0f, func_102(0) /*3*/ };
	if (uParam0->f_12.f_1 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
		{
		...
		if (uParam0->f_31[iVar0 /*36*/].f_4 != 0)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_31[iVar0 /*36*/].f_1) && uParam0->f_31[iVar0 /*36*/].f_28 < 3)
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_31[iVar0 /*36*/].f_1))
				{
					...
					vVar7 = { func_107(vVar4, 1.5f) /*3*/ };
					vVar10 = { func_107(vVar4, fVar13) /*3*/ };
					...
					TASK::_CREATE_WAYPOINT_PATH(func_109(&(uParam0->f_31[iVar0 /*36*/].f_29)), &(uParam0->f_630), 5, 0);
				}
...
void func_52(var uParam0)
{
	...
	while (iVar0 < uParam0->f_618)
	{
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_31[iVar0 /*36*/].f_1))
			{
				...
				if ((uParam0->f_31[iVar0 /*36*/].f_13 && fVar8 < 2500.0f) && ENTITY::IS_ENTITY_ON_SCREEN(uParam0->f_31[iVar0 /*36*/].f_1))
				{
					...
					if ((fVar8 < 6.25f && !func_112()) && !bVar6)
					{
						...
						{
							uParam0->f_31[iVar0 /*36*/].f_16 = func_113("INSPECT_GENERIC" /* GXTEntry: "Inspect" */, joaat("INPUT_CONTEXT_Y"), uParam0->f_31[iVar0 /*36*/].f_1, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, (1 << 30), 0, joaat("MEDIUM_TIMED_EVENT"), 0, 0);
						...
						{
							HUD::_UI_PROMPT_SET_AMBIENT_GROUP_THIS_FRAME(Global_35, 2.5f, 2, 1, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(uParam0->f_31[iVar0 /*36*/].f_1), func_109(&(uParam0->f_31[iVar0 /*36*/].f_31)), 2);
						}
						else
						{
							HUD::_UI_PROMPT_SET_AMBIENT_GROUP_THIS_FRAME(uParam0->f_31[iVar0 /*36*/].f_1, 2.5f, 2, 1, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(uParam0->f_31[iVar0 /*36*/].f_1), func_109(&(uParam0->f_31[iVar0 /*36*/].f_31)), 2);
						}
		...
		else if (uParam0->f_31[iVar0 /*36*/].f_15)
		{
			...
			{
				HUD::_UI_PROMPT_SET_AMBIENT_GROUP_THIS_FRAME(Global_35, 2.5f, 2, 1, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(uParam0->f_31[iVar0 /*36*/].f_1), func_109(&(uParam0->f_31[iVar0 /*36*/].f_33)), 2);
			}
			else
			{
				HUD::_UI_PROMPT_SET_AMBIENT_GROUP_THIS_FRAME(uParam0->f_31[iVar0 /*36*/].f_1, 2.5f, 2, 1, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(uParam0->f_31[iVar0 /*36*/].f_1), func_109(&(uParam0->f_31[iVar0 /*36*/].f_33)), 2);
			}
			iVar9 = MISC::GET_GAME_TIMER();
			if ((iVar9 - uParam0->f_31[iVar0 /*36*/].f_25) > iVar3 || ((iVar9 - uParam0->f_31[iVar0 /*36*/].f_25) > iVar1 && !func_119(Global_35, joaat("SCRIPT_TASK_PERFORM_SEQUENCE"))))
			{
			...
			{
				func_121(uParam0->f_12, func_109(&(uParam0->f_31[iVar0 /*36*/].f_29)), 1, 0.762f, 1053609165 /* Float: 0.4f */, 0, 2.0f, 1);
	...
	if (uParam0->f_614 > 0)
	{
		if (!uParam0->f_624)
		{
			...
			else if (func_110(Global_35, uParam0->f_12.f_10, 1) > 400.0f && !CAM::IS_SPHERE_VISIBLE(uParam0->f_12.f_10, 1.0f))
			{
				uParam0->f_621 = 1;
				func_124(uParam0);
				uParam0->f_624 = 1;
...
void func_53(var uParam0)
{
	...
	{
		if (((func_110(uParam0->f_12, uParam0->f_12.f_16, 1) >= 2500.0f && func_111(Global_35, uParam0->f_12, 1) > 400.0f) && !PED::IS_PED_INJURED(uParam0->f_12)) && !func_119(uParam0->f_12, joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
		{
			func_125(uParam0);
			uParam0->f_12.f_2 = 1;
			fVar1 = 3.0f;
	...
	else if (func_110(uParam0->f_12, uParam0->f_12.f_16, 1) >= 100.0f)
	{
		uParam0->f_12.f_2 = 0;
	}
}
...
bool func_76(bool bParam0, int iParam1, int iParam2)
{
	...
	*iParam2 = 0;
	sVar0 = { func_131(joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0, iParam1, 0, -1, 0, 0) /*10*/ };
	...
	if (iVar11 != -1)
	{
		...
		while (iVar12 < iVar10)
		{
			...
			{
				if (func_132(bVar13, iParam1, &sVar14, &iVar45, 1, 0))
				{
					iVar46 = 0;
					while (iVar46 < iVar45)
					{
...
int func_77(bool bParam0, int iParam1)
{
	...
	sVar0 = { func_133(0) /*4*/ };
	sVar0.f_4 = func_134(iParam1);
	sVar5 = { func_135(bParam0, sVar0, sVar0.f_4, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&sVar5))
	{
		return 0;
	}
	iVar9 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_136(0), &sVar5, false);
	return iVar9;
}
...
bool func_78(bool bParam0, int iParam1)
{
	...
	sVar0.f_4 = func_134(iParam1);
	if (!func_137(bParam0, sVar0.f_4))
	{
		return false;
	}
	iVar5 = func_138(bParam0, &sVar0, 1, 0);
	iVar6 = func_139(bParam0, 0);
...
bool func_79(bool bParam0, int iParam1, int iParam2)
{
	...
	if (iParam1 == 1)
	{
		if (func_140(bParam0) && func_141(bParam0))
		{
			iVar0 = 0;
			if (func_76(bParam0, joaat("COST_CRAFTING_TRAPPER"), &iVar0))
			{
				iParam2 = iVar0;
			}
		}
	}
	sVar1.f_4 = func_134(iParam1);
	sVar1 = { func_133(0) /*4*/ };
	if (!func_142(bParam0, &uVar6, &sVar1, iParam2, joaat("ADD_REASON_DEFAULT"), 1))
	{
		return false;
	}
	return true;
...
bool func_92(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((Global_1898164.f_163 && !func_153(iParam0, 1)) || func_154((1 << 15)))
	{
		if (!func_153(iParam0, (1 << 18)) || !Global_1905944.f_5696)
		{
			return false;
		}
	}
...
void func_101(var uParam0, int iParam1, int iParam2)
{
	...
	uParam0->f_31[uParam0->f_618 /*36*/].f_17 = { func_159(iParam1, iParam2) /*3*/ };
	...
	else if (uParam0->f_580[iParam1] == 5)
	{
		...
		uParam0->f_31[uParam0->f_618 /*36*/].f_33 = { func_166() /*3*/ };
	}
	...
	if (iParam1 == 0)
	{
		...
		func_167(&(uParam0->f_31[uParam0->f_618 /*36*/].f_10), uParam0->f_31[uParam0->f_618 /*36*/].f_17, 0.0f, 0.0f, 0.0f, uParam0->f_7, uParam0->f_7, uParam0->f_7, "volHerbBlocking - Legendary Tracking Clue");
	...
	{
		uParam0->f_31[uParam0->f_618 /*36*/].f_20 = { func_159(iParam1 + 1, iParam2) /*3*/ };
	}
	else
	{
		uParam0->f_31[uParam0->f_618 /*36*/].f_20 = { func_169(iParam2) /*3*/ };
	}
}
...
int func_113(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_176(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_177(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_118(var uParam0, var uParam1)
{
	...
	if (uParam0->f_614 == 0)
	{
		...
		uParam0->f_12.f_10 = { func_169(uParam0->f_615) /*3*/ };
		uParam0->f_12.f_16 = { func_169(uParam0->f_615) /*3*/ };
	...
	if (!uParam0->f_614 >= func_100())
	{
		...
		while (iVar0 < iVar1)
		{
			...
			{
				func_167(&(uParam0->f_31[iVar0 /*36*/].f_10), uParam0->f_31[iVar0 /*36*/].f_17, 0.0f, 0.0f, 0.0f, uParam0->f_7, uParam0->f_7, uParam0->f_7, "volHerbBlocking - Legendary Tracking Clue");
				if (VOLUME::DOES_VOLUME_EXIST(uParam0->f_31[iVar0 /*36*/].f_10))
				{
...
int func_121(bool bParam0, char* sParam1, bool bParam2, float fParam3, float fParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
...
void func_124(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
	{
		func_187(uParam0->f_12, uParam0->f_12.f_10, func_102(uParam0->f_615), 2, (1 << 30));
...
void func_125(var uParam0)
{
	...
	uParam0->f_616 = iVar0;
	uParam0->f_12.f_16 = { func_169(iVar0) /*3*/ };
}
...
struct<10> /*80*/ func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	struct<10> /*80*/ sVar0;
...
bool func_132(bool bParam0, int iParam1, var uParam2, int iParam3, bool bParam4, bool bParam5)
{
	struct<37> /*296*/ sVar0;
	int iVar47;
	...
	*iParam3 = sVar0.f_3;
	...
	if (bParam4)
	{
		func_190(bParam0, iParam1, uParam2, *iParam3);
	}
	return true;
}
...
struct<4> /*32*/ func_135(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_136(bParam6), &uParam1, bParam0, iParam5, &sVar0);
	return sVar0;
}
...
int func_138(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (!func_130(bParam0, 0))
	{
		return 0;
	...
	if (bParam2 || !func_195(bParam0))
	{
		return INVENTORY::_GET_ITEM_SLOT_MAX_COUNT(bParam0, uParam1->f_4);
	}
	return INVENTORY::_GET_ITEM_ROLE_MAX_LEVEL_COUNT(func_136(bParam3), bParam0);
}
...
int func_139(bool bParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_136(bParam1), bParam0, false);
}
...
bool func_140(bool bParam0)
{
	...
	if (func_197(bParam0, joaat("CI_TAG_SHOP_ANIMAL_LEGENDARY")))
	{
		return true;
	}
	return false;
...
bool func_142(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	if (!func_130(bParam0, 0))
	{
	}
	...
	if (func_198(bParam0, uParam2, iParam3, bParam5, 0))
	{
		return false;
	}
	if (!func_194(0))
	...
	if (!INVENTORY::_INVENTORY_ADD_ITEM_WITH_GUID(func_136(0), uParam1, uParam2, bParam0, uParam2->f_4, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_152(int iParam0)
{
	...
	if (!func_153(iParam0, (1 << 16)) && !func_153(iParam0, (1 << 15)))
	{
		return false;
	}
	iVar0 = 0;
	while (iVar0 < Global_40.f_7756)
	{
		if (Global_40.f_7756[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			if (iVar2 < 1800 && func_153(iParam0, (1 << 15)))
			{
				return true;
			}
		}
...
Vector3 func_159(int iParam0, int iParam1)
{
	...
	{
		case 0:
			vVar0 = { func_204(1, iParam1) /*3*/ };
			break;
		case 1:
			vVar0 = { func_204(2, iParam1) /*3*/ };
			break;
		case 2:
			vVar0 = { func_204(3, iParam1) /*3*/ };
			break;
	}
	return vVar0;
}
...
Vector3 func_161()
{
	return func_205("ATZ_INS_EXC" /* GXTEntry: "Dung" */);
}

Vector3 func_162()
{
	return func_205("ATZ_INS_FUR" /* GXTEntry: "Fur" */);
}

Vector3 func_163()
{
	return func_205("ATZ_INS_KLR" /* GXTEntry: "Carcass" */);
}

Vector3 func_164()
{
	return func_205("ATZ_INS_BLD" /* GXTEntry: "Blood" */);
}

Vector3 func_165()
{
	return func_205("ATZ_INS_BRK" /* GXTEntry: "Broken Sticks" */);
}

Vector3 func_166()
{
	return func_205("ATZ_INS_TRB" /* GXTEntry: "Tree Rub" */);
}
...
void func_171(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_208(iParam1))
		{
			func_209(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_190(bool bParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
{
	if (func_227(bParam0, joaat("DEFAULT") /* GXTEntry: "_" */) == 0)
	{
		return false;
	}
	return true;
...
bool func_198(bool bParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	struct<4> /*32*/ sVar0;
	struct<10> /*80*/ sVar4;
	var uVar26;
	...
	if (func_229(bParam0) && WEAPON::IS_WEAPON_A_GUN(bParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
		{
			sVar0 = { func_230(0) /*4*/ };
			sVar4.f_9 = joaat("SLOTID_NONE");
			if (!func_231(bParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
			{
				return false;
			}
			else if (func_232(bParam0, &sVar4, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
			{
				return false;
			}
			if (func_233(bParam0, 1))
			{
				if (!func_231(bParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					return false;
				}
				else if (func_232(bParam0, &sVar4, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */))
				{
					return false;
				}
			}
		}
		else if (!func_234(bParam0, &uVar26, 0))
		{
			return false;
		}
		return true;
	}
	iVar27 = func_138(bParam0, uParam1, bParam3, bParam4);
	if (iVar27 < 0)
	{
		return false;
	}
	...
	if (bParam3 || !func_195(bParam0))
	{
		iVar28 = func_235(bParam0, *uParam1, uParam1->f_4, bParam4);
	}
	else
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_136(bParam4), bParam0, false);
	}
...
{
	return func_246(bParam0) == joaat("WEAPON");
}
...
struct<4> /*32*/ func_230(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_135(joaat("CARRIED_WEAPONS"), func_133(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_135(joaat("CARRIED_WEAPONS"), func_133(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_135(joaat("CARRIED_WEAPONS"), func_133(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_231(bool bParam0, var uParam1, int iParam2, bool bParam3)
{
	return func_235(bParam0, *uParam1, iParam2, bParam3) > 0;
}

bool func_232(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;

	if (func_247(bParam0, &uVar0, uParam1, iParam2))
	{
...
{
	if (func_192(bParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
...
bool func_234(bool bParam0, var uParam1, bool bParam2)
{
	...
	while (iVar29 < 4)
	{
		...
		if (func_231(bParam0, &sVar0, iVar5, 0))
		{
			bVar28 = func_232(bParam0, &sVar6, iVar5);
...
int func_235(bool bParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	sVar0 = { func_135(bParam0, sParam1, iParam5, bParam6) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&sVar0))
	{
		return 0;
	}
	iVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_136(bParam6), &sVar0, false);
	return iVar4;
}
...
bool func_247(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_136(0);
	*uParam1 = { func_135(bParam0, func_230(0), iParam3, 0) /*4*/ };
...
struct<5> /*40*/ func_249(bool bParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;

	sVar0 = { func_133(bParam1) /*4*/ };
	sVar0.f_4 = joaat("SLOTID_SATCHEL");
	switch (func_246(bParam0))
	{
		case joaat("CLOTHING"):
			if (!INVENTORY::_INVENTORY_FITS_SLOT_ID(bParam0, joaat("SLOTID_WARDROBE")))
			{
				sVar0 = { func_135(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_233(bParam0, 1))
			{
				...
				else if (!func_231(bParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_232(bParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_254(bParam0, joaat("CI_CATEGORY_CAMP")))
			{
				sVar0 = { func_135(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(bParam0, joaat("KIT_CAMP") /* GXTEntry: "Camp" */);
			}
			else if (func_254(bParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_135(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(bParam0, joaat("WARDROBE") /* GXTEntry: "Wardrobe" */);
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(bParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_255(sVar0, &sVar27, bParam1, 0))
				{
					sVar0.f_4 = 0;
				}
				else
...
struct<4> /*32*/ func_253(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_135(joaat("EMOTE_ITEM"), func_133(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_135(joaat("EMOTE_ITEM"), func_133(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
