...
bool func_72(var uParam0)
{
	...
	func_153(uParam0, iLocal_14, joaat("WEAPON_REVOLVER_DOUBLEACTION_MICAH") /* GXTEntry: "Micah\'s Revolver" */, "REVOLVER");
	func_152(uParam0, joaat("P_CHAIRFOLDING02X"), -0.258326f, -1.19728f, 0.0305557f, "Chair" /* GXTEntry: "Chair" */, 1, 0, 1);
	func_152(uParam0, joaat("P_STOOLFOLDING01X"), 0.0114404f, 1.02168f, 0.0306778f, "Stool" /* GXTEntry: "Stool" */, 1, 0, 1);
