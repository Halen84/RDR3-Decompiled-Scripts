...
int func_21(var uParam0)
{
	...
	if (func_45(Global_1835011[72 /*74*/].f_1) == 0)
	{
		...
		HUD::TEXT_BLOCK_REQUEST("SAD5" /* GXTEntry: "An Honest Day\'s Labors" */);
		if (!HUD::TEXT_BLOCK_IS_LOADED("SAD5" /* GXTEntry: "An Honest Day\'s Labors" */))
		{
			return 0;
		}
		func_48(&uLocal_19, iLocal_15, "SAD5_FINLEY" /* GXTEntry: "Shane Finley" */, 0);
		PED::SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(Global_35, true);
		PED::_SET_PED_PROMPT_NAME_FROM_GXT_ENTRY(iLocal_15, joaat("SAD5_FINLEY") /* GXTEntry: "Shane Finley" */);
	}
	return 1;
}
...
{
	func_92(iLocal_15, "SAD5_FINLEY" /* GXTEntry: "Shane Finley" */, 5.0f, 0, 0, 4);
	...
	switch (iLocal_120)
	{
		case 0:
			...
			if (func_99(PLAYER::PLAYER_ID(), iLocal_15))
			{
				...
				{
					iLocal_117[0] = func_101("INTERACT_GREET" /* GXTEntry: "Greet" */, joaat("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, (1 << 30), 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
					func_102(iLocal_117[0], iLocal_15, 0, 0, 1);
				}
				if (!func_100(iLocal_117[1]))
				{
					iLocal_117[1] = func_101("INTERACT_INSULT" /* GXTEntry: "Antagonize" */, joaat("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, (1 << 30), 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
...
void func_82(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_140(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_140(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
bool func_140(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	else if (bVar0 == joaat("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case joaat("GROUP_SHOTGUN"):
			case joaat("GROUP_RIFLE"):
				if (func_180(joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */))
				{
	...
	switch (func_203(bParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_205(bParam0, 1))
			{
				...
				if (!func_194(bParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_194(bParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_195(bParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
