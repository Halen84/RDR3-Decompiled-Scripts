...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.5312f, -0.05f, 1.0f, -2.52f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	func_151(uParam0, 3.9922f, -2.9079f, 0.9898f, -6.84f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	...
	sLocal_18 = { func_155(uParam0, -0.9496f, -2.2948f, 1.0f, -139.46f, 7.0f, 0.55f, 0.55f) /*10*/ };
	sLocal_28 = { func_155(uParam0, -0.95f, -2.295f, 1.0f, 121.54f, 7.0f, 0.55f, 0.55f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_194(uParam0, sLocal_18, 1, 0))
		{
			func_185(uParam0, iLocal_16, 1);
		}
		else if (func_194(uParam0, sLocal_28, 1, 0))
		{
...
void func_98(Vector3 vParam0, int iParam3)
{
	...
	while (iVar0 < Global_1911670)
	{
		...
		if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(iVar1))
		{
			...
			if (func_203(vVar2, vParam0, 2.0f, 1))
			{
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_204(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000.0f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_206(iParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_207(iParam0, 0));
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		PED::SET_PED_CONFIG_FLAG(func_222(iParam0), 137 /*PCF_0xE18960DE*/, true);
	}
}
...
void func_124(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		PED::SET_PED_CONFIG_FLAG(func_222(iParam0), 204 /*PCF_0x435F091E*/, true);
	}
	else
	{
		PED::SET_PED_CONFIG_FLAG(func_222(iParam0), 204 /*PCF_0x435F091E*/, false);
	}
}
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_222(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_224(iParam0) < 10000.0f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_143(var uParam0)
{
	...
	if (func_230(Global_1935630, (1 << 14)))
	{
		return true;
	}
	if (func_231(2))
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_237(uParam0->f_107[iVar0 /*113*/].f_1, (1 << 11)))
			{
				return true;
			}
...
{
	uParam0->f_23 = { func_244(iParam1) + Vector(fParam4, fParam3, fParam2) /*3*/ };
	uParam0->f_26 = { func_245(iParam1) /*3*/ };
}
...
struct<10> /*80*/ func_155(var uParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	...
	fVar0 = func_248(uParam0, (fParam4 + (fParam6 * 90.0f)));
	fVar1 = func_248(uParam0, (fParam4 - (fParam7 * 90.0f)));
	sVar2 = { func_247(uParam0, vParam1) /*3*/ };
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_205(uParam0->f_107[iVar12 /*113*/].f_7, 1));
				}
			}
...
void func_268(var uParam0, int iParam1)
{
	...
	else if (!func_326(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
	{
...
bool func_297(var uParam0, int iParam1)
{
	...
	{
		if (!func_326(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_ANY")))
		{
			return true;
		}
	}
...
void func_298(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_338(100.0f, 140.0f);
			}
		}
...
bool func_355(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_237(iParam0, (1 << 31)))
	{
		return true;
	}
	if (func_237(iParam0, (1 << 30)))
	{
		return true;
	}
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_SET_PERSCHAR_SCHEDULE(func_205(iParam0, 1), &cVar4);
				}
...
bool func_412(int iParam0, Vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489.f_12) || (bParam5 && Global_1359489.f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_205(iParam0, 1));
...
void func_414(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_222(iParam1), iParam0, false);
