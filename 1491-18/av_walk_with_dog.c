...
void __SCRIPT()
{
	...
	iLocal_50 = joaat("STAND");
	iLocal_51 = joaat("WORLD_HUMAN_CROUCH_INSPECT");
	sVar0.f_1 = -1;
	sVar0.f_3.f_9 = 3;
	sVar0.f_20 = 25;
...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 72:
			...
			iLocal_50 = joaat("STAND");
			func_50(uParam0, 1, "WWD_MAN", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 2.0f, 1.0f, 0.0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 0, "WWD_DOG", iLocal_11, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 2.0f, 3.0f, 0.0f), (180.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			break;
		case 73:
			iLocal_10 = func_48(func_47(), 1, 0, 1, 0, 0, 0);
			iLocal_11 = joaat("A_C_OX_01");
			iLocal_50 = joaat("WORLD_ANIMAL_OX_GRAZING");
			func_50(uParam0, 1, "WWD_MAN", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 2.0f, 1.0f, 0.0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 0, "WWD_DOG", iLocal_11, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 2.0f, 5.0f, 0.0f), (180.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			break;
	}
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				{
					bVar0 = true;
					FLOCK::SET_ANIMAL_TUNING_FLOAT_PARAM(uParam0->f_20[0 /*14*/], 73, 0.0f);
				}
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], iLocal_50, uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[1 /*14*/], joaat("WEAPON_REVOLVER_CATTLEMAN") /* GXTEntry: "Cattleman Revolver" */, 5000, false, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), true, 0.0f, false);
				func_71(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], &uLocal_12, 0.0f, 0.0f, 0.0f, 0, 0, 1, 1069547520 /* Float: 1.5f */, -1082130432 /* Float: -1f */, 1073069561, 1.0f, 1092616192 /* Float: 10f */, -1, 1, 0, 0, 0, 1);
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], iLocal_51, uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				TASK::TASK_MOVE_IN_TRAFFIC(uParam0->f_20[1 /*14*/], 1.0f, 0, 0);
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				if (!PED::IS_PED_USING_SCENARIO_HASH(uParam0->f_20[1 /*14*/], iLocal_51))
				{
					...
					func_74(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], &uLocal_12, -1082130432 /* Float: -1f */, 0, 0, -1082130432 /* Float: -1f */, 1.0f, 1, 32, fVar1, fVar2, 1.0f, (1 << 30), 1050253722 /* Float: 0.3f */, 1067030938 /* Float: 1.2f */, 0, 0, -1, 1, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1);
					iLocal_9 = 5;
				}
			}
			break;
...
void func_71(int iParam0, int iParam1, var uParam2, Vector3 vParam3, char* sParam6, int iParam7, int iParam8, float fParam9, float fParam10, float fParam11, float fParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	...
	else if (!func_109(vParam3, 0.0f, 0.0f, 0.0f))
	{
		sVar11.f_0 = 0;
...
{
	func_119(uParam0, 0.0f);
}

void func_74(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, float fParam6, float fParam7, bool bParam8, int iParam9, float fParam10, float fParam11, float fParam12, float fParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	struct<7> /*56*/ sVar0;
...
bool func_80(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, Vector3 vParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
bool func_82(Vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_120(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1.0f, 0))
			{
				return true;
			}
		}
...
bool func_105(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (Global_1935630.f_26 & func_141(PLAYER::PLAYER_ID(), 0, 1, (uParam2->f_1 & (1 << 19)) == 0))
		{
