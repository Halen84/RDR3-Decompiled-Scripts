...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	iLocal_9 = func_48(joaat("HORSE_CLASS_RIDING") /* GXTEntry: "Riding" */, 1);
	func_49(uParam0, 0, "DHP_HORSE", iLocal_9, vParam1, vParam4.z, 1, 1, 0, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	if (*uParam0 == 150)
	{
		func_49(uParam0, 1, "RDED1_DOG_1", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 1.25f, 0.2f, 0.0f), (90.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	}
}
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				iLocal_15 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(uParam0->f_20[0 /*14*/].f_5, 1.0f, 1, 36, 0);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], joaat("WORLD_ANIMAL_DOG_SNIFFING_GROUND"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
...
int func_47(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_83(*uParam0, 0.0f, 0.0f, 0.0f))
	{
		return 1;
	}
	iVar1 = 0;
...
int func_50(var uParam0, Vector3 vParam1)
{
	...
	{
		if (func_84(iVar0, vParam1, 1) <= 1.0f)
		{
...
bool func_74(Vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_112(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1.0f, 0))
			{
				return true;
			}
		}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if ((*uParam0 & 16) != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_170(1) || (*uParam0 & (1 << 13)) != 0))
				{
					func_9(uParam0, (1 << 25));
				}
			}
...
bool func_131(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_179(iParam0, !(*uParam1 & (1 << 28)) != 0, !(*uParam1 & (1 << 29)) != 0, !(*uParam1 & (1 << 30)) != 0, 0, 0))
		{
...
bool func_132(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85.0f;
	if (func_183(iParam1, !(*uParam2 & (1 << 28)) != 0, !(*uParam2 & (1 << 29)) != 0, !(*uParam2 & (1 << 30)) != 0, 0))
	{
...
bool func_137(int iParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < (float)func_186(uParam2))
	{
