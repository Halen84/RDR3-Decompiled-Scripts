...
void __SCRIPT()
{
	...
	func_2(&sLocal_9, &uScriptParam_0);
	while (!func_3(&sLocal_9))
	{
		func_4(&sLocal_9);
		switch (func_5(sLocal_9))
		{
			case 0:
				if (func_6(&sLocal_9))
				{
...
int func_21(var uParam0)
{
	...
	PLAYER::START_PLAYER_TELEPORT(PLAYER::GET_PLAYER_INDEX(), Global_1835011[4 /*74*/].f_18, 0.0f, false, true, true, false);
	func_25(&uLocal_3, 0);
	MISC::SET_BIT(&(Global_1955830.f_1), 5);
	return 1;
}
...
void func_35(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		PED::SET_PED_CONFIG_FLAG(func_54(iParam0), 137 /*PCF_0xE18960DE*/, true);
	}
}
...
void func_37(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		PED::SET_PED_CONFIG_FLAG(func_54(iParam0), 204 /*PCF_0x435F091E*/, true);
	}
	else
	{
		PED::SET_PED_CONFIG_FLAG(func_54(iParam0), 204 /*PCF_0x435F091E*/, false);
	}
}
...
int func_61(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_32(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_69(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000.0f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_71(iParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_72(iParam0, 0));
