...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			break;
		case 2:
			func_149(uParam0, 67, 0.0f, 0.0f, -0.07f);
			break;
		case 3:
	...
	func_151(uParam0, -1.5f, -2.6333f, 1.0f, 0.0f, 6.0f, 5.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_20 = func_152(uParam0, joaat("P_CHAIRFOLDING02X"), 0.0f, 0.0f, 0.0f, "CHAIR" /* GXTEntry: "Chair" */, 0, 0, 1);
	iLocal_21 = func_152(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 1, 1);
	func_152(uParam0, joaat("P_CIGARETTE_CS01X"), 0.0f, 0.0f, 0.0f, "CIGARETTE", 0, 1, 1);
	iLocal_22 = func_152(uParam0, joaat("P_MUGCOFFEE01X"), 0.0f, 0.0f, 0.0f, "MUG", 0, 1, 1);
	...
	func_155(uParam0, iLocal_15, 1, joaat("WORLD_HUMAN_COFFEE_DRINK"), 0, -1, 0, 90.0f, 1065353216 /* Float: 1f */, 1);
	...
	sLocal_23 = { func_158(uParam0, 0.1451f, -2.8832f, 1.0f, -177.1645f, 7.0f, 0.7f, 0.7f) /*10*/ };
	return true;
}
