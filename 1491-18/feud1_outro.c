...
bool func_6(var uParam0)
{
	...
	{
		if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_3))
		{
	...
	{
		if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_3) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_3, true, false))
		{
			func_22(&iLocal_4, 8);
		}
	}
	...
	if (func_46(&iLocal_9, &uLocal_12, 1, 1, 0, 0, 0, 0))
	{
		if (!PED::IS_PED_INJURED(uLocal_12[0]))
		{
			...
			if (!PED::IS_PED_USING_SCENARIO_HASH(uLocal_12[0], joaat("WORLD_HUMAN_STERNGUY_IDLES")))
			{
				...
				ENTITY::_SET_ENTITY_COORDS_AND_HEADING(uLocal_12[0], 628.2734f, -1246.48f, 40.6f, 125.0f, true, false, true);
		...
		if (!PED::IS_PED_INJURED(uLocal_12[1]))
		{
			...
			if (func_48(134))
			{
				...
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 651.8143f, -1238.561f, 42.8871f, 1.0f, 40000, (0.25f * 2.0f), 5242885, 40000.0f);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 673.747f, -1252.87f, 43.01056f, 1.0f, 40000, (0.25f * 2.0f), 5242885, 40000.0f);
			...
			else
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar0);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 651.8143f, -1238.561f, 42.8871f, 1.0f, 40000, (0.25f * 2.0f), 5242885, 40000.0f);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 675.2244f, -1246.993f, 42.726f, 1.0f, 40000, (0.25f * 2.0f), 5242885, 40000.0f);
				TASK::CLOSE_SEQUENCE_TASK(iVar0);
			}
...
bool func_25(var uParam0)
{
	if (!func_21(iLocal_4, 16))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_8) && !ENTITY::IS_ENTITY_DEAD(iLocal_8))
		{
			if (!PED::IS_PED_INJURED(uLocal_12[1]))
			{
				if (!func_48(134))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_12[1], joaat("SCRIPT_TASK_PERFORM_SEQUENCE"), true) == 8 || (TASK::GET_SCRIPT_TASK_STATUS(uLocal_12[1], joaat("SCRIPT_TASK_PERFORM_SEQUENCE"), true) == 1 && func_49(uLocal_12[1], 675.2244f, -1246.993f, 42.726f, (0.25f * 6.0f), 1, 1)))
					{
						if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_3) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_3, true, false))
						{
							...
							TASK::TASK_ENTER_ANIM_SCENE(uLocal_12[1], iLocal_3, "cs_hoseamatthews", "pbl_drop", 1.48f, true, 9, 20000, -1.0f);
							func_22(&iLocal_4, 16);
						}
					}
				}
				else if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_12[1], joaat("SCRIPT_TASK_PERFORM_SEQUENCE"), true) == 8 || (TASK::GET_SCRIPT_TASK_STATUS(uLocal_12[1], joaat("SCRIPT_TASK_PERFORM_SEQUENCE"), true) == 1 && func_49(uLocal_12[1], 673.747f, -1252.87f, 43.01056f, 0.25f, 1, 1)))
				{
					func_50(477);
	...
	{
		if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_3) && ANIMSCENE::IS_ANIM_SCENE_FINISHED(iLocal_3, false))
		{
			func_22(&iLocal_4, 32);
		}
	}
	if (!func_21(iLocal_4, (1 << 31)))
	{
		if (func_51(&uLocal_5) && func_52(&uLocal_5) > 30.0f)
		{
			func_15(iLocal_9[0], 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
			func_22(&iLocal_4, (1 << 31));
		}
	}
	if ((func_51(&uLocal_5) && func_52(&uLocal_5) > 90.0f) || (func_21(iLocal_4, 16) && func_21(iLocal_4, 32)))
	{
		return true;
	}
	return false;
...
int func_59(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_35(iVar0, 0))
	{
		if (func_35(PED::_GET_RIDER_OF_MOUNT(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_56(iParam0)) || func_57(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_76(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000.0f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_78(iParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_79(iParam0, 0));
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_90(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, (1 << 30));
			}
			else if (bParam16)
			{
...
float func_76(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_71(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
bool func_87(int iParam0, Vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_109(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) /*7*/ };
			if (!bParam6)
			{
				func_34(iParam0, 44, 1);
			}
...
void func_90(int iParam0, Vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_114(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_115(iParam0))
	{
		if (func_116(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0)))
		{
			PHYSICS::_UNHITCH_HORSE(iParam0);
		}
	}
	if (func_21(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		iVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0);
	...
	if (func_21(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_21(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_21(iParam5, 32), true);
	...
	else if (func_21(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iParam0, vParam1, func_21(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0) == Global_35 && !func_21(iParam5, 64))
		{
...
void func_97(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_127(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_127(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD") /* GXTEntry: "Sadie\'s Cattleman Revolver" */, 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
struct<7> /*56*/ func_109(int iParam0, int iParam1, Vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	struct<7> /*56*/ sVar0;
...
void func_124(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & 1) > 0 && func_120(iParam1, 860729266))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 860729266);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 12)) > 0 && func_120(iParam1, 879715242))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 879715242);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & 128) > 0 && func_120(iParam1, 1606325429))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1606325429);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & 256) > 0 && func_120(iParam1, 1743550585))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1743550585);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 9)) > 0 && func_120(iParam1, 1064646155))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1064646155);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 10)) > 0 && func_120(iParam1, -536694793))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -536694793);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 11)) > 0 && func_120(iParam1, -1304053509))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1304053509);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 31)) > 0 && func_120(iParam1, 718939204))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 718939204);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 16)) > 0 && func_120(iParam1, -972364774))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -972364774);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 14)) > 0 && func_120(iParam1, -1100875244))
	{
	...
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 18)) > 0 && func_120(iParam1, 1153596794))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1153596794);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 19)) > 0 && func_120(iParam1, 1016389820))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1016389820);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 20)) > 0 && func_120(iParam1, -726966617))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -726966617);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 21)) > 0 && func_120(iParam1, 1365901568))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1365901568);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 15)) > 0 && func_120(iParam1, -1658942149))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1658942149);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 17)) > 0 && func_120(iParam1, -1980913856))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1980913856);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 22)) > 0 && func_120(iParam1, 491764525))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 491764525);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 23)) > 0 && func_120(iParam1, -76015264))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -76015264);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 24)) > 0 && func_120(iParam1, 622113465))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 622113465);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 25)) > 0 && func_120(iParam1, 781533162))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 781533162);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 26)) > 0 && func_120(iParam1, -271415321))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -271415321);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 27)) > 0 && func_120(iParam1, -1683207356))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1683207356);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 28)) > 0 && func_120(iParam1, -254794762))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -254794762);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 29)) > 0 && func_120(iParam1, 609066278))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 609066278);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 30)) > 0 && func_120(iParam1, -1712783565))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1712783565);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 13)) > 0 && func_120(iParam1, 1544915253))
	{
...
void func_125(int iParam0)
{
	...
	func_144(iParam0, (1 << 9));
	func_144(iParam0, (1 << 10));
	func_144(iParam0, (1 << 11));
	func_144(iParam0, (1 << 12));
	func_144(iParam0, (1 << 16));
	func_144(iParam0, (1 << 14));
	func_144(iParam0, (1 << 18));
	func_144(iParam0, (1 << 19));
	func_144(iParam0, (1 << 20));
	func_144(iParam0, (1 << 21));
	func_144(iParam0, (1 << 15));
	func_144(iParam0, (1 << 17));
	func_144(iParam0, (1 << 27));
	func_144(iParam0, (1 << 30));
}
...
int func_127(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else if (iVar0 == joaat("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case joaat("GROUP_SHOTGUN"):
			case joaat("GROUP_RIFLE"):
				if (func_146(joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */))
				{
	...
	{
		func_147(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0.0f;
...
int func_147(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
	...
	{
		sVar0 = { func_154(iParam0, 0, 1) /*5*/ };
		iVar5 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
		sVar6.f_9 = joaat("SLOTID_NONE");
		iVar28 = 0;
		while (iVar28 < 4)
		{
			iVar5 = func_155((398 + iVar28), 1);
			if (func_156(iParam0, &sVar0, iVar5, 0))
			{
				if (func_157(iParam0, &sVar6, iVar5))
				{
					sVar29 = { func_158(iParam0, sVar0, iVar5, 0) /*4*/ };
					func_159(iParam0, &sVar29, &sVar0, 1, joaat("REMOVE_REASON_DEFAULT"), 1, 0);
				}
				else
				{
					iVar28++;
...
struct<5> /*40*/ func_154(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;

	sVar0 = { func_164(bParam1) /*4*/ };
	...
	switch (func_165(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_158(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
			...
			break;
		case joaat("WEAPON"):
			sVar0 = { func_166(bParam1) /*4*/ };
			if (bParam2 && func_167(iParam0, 1))
			{
				sVar5.f_9 = joaat("SLOTID_NONE");
				if (!func_156(iParam0, &sVar0, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else if (!func_156(iParam0, &sVar0, joaat("SLOTID_WEAPON_1") /* GXTEntry: "Left" */, 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1"); /* GXTEntry: "Left" */
				}
				else if (func_157(iParam0, &sVar5, joaat("SLOTID_WEAPON_0") /* GXTEntry: "Right" */))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0"); /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_170(iParam0, joaat("CI_CATEGORY_CAMP")))
			{
				sVar0 = { func_158(joaat("KIT_CAMP") /* GXTEntry: "Camp" */, sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("KIT_CAMP") /* GXTEntry: "Camp" */);
			}
			else if (func_170(iParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_158(joaat("WARDROBE") /* GXTEntry: "Wardrobe" */, sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("WARDROBE") /* GXTEntry: "Wardrobe" */);
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_171(sVar0, &sVar27, bParam1, 0))
				{
					sVar0.f_4 = 0;
				}
				else
...
struct<4> /*32*/ func_158(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_175(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}
...
bool func_159(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!func_171(*uParam1, &sVar0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_175(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
void func_162(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_178(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> /*32*/ func_164(bool bParam0)
{
...
struct<4> /*32*/ func_166(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_158(joaat("CARRIED_WEAPONS"), func_164(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_158(joaat("CARRIED_WEAPONS"), func_164(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_158(joaat("CARRIED_WEAPONS"), func_164(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_167(int iParam0, bool bParam1)
{
	if (func_169(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
struct<4> /*32*/ func_168(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_158(joaat("EMOTE_ITEM"), func_164(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_158(joaat("EMOTE_ITEM"), func_164(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
bool func_171(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_175(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_172(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	sVar0 = { func_158(iParam0, sParam1, iParam5, bParam6) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&sVar0))
	{
		return 0;
	}
	iVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_175(bParam6), &sVar0, false);
	return iVar4;
}
...
bool func_173(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_175(0);
	*uParam1 = { func_158(iParam0, func_166(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
