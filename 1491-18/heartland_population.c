...
void func_8()
{
	func_28(&uLocal_89, &uLocal_91, &uLocal_90, vLocal_92, iLocal_87, joaat("DOCUMENT_NOTE_DUTCH") /* GXTEntry: "Dutch\'s Speech Notes" */, iLocal_88);
}
...
void func_23()
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_77))
	{
		...
		{
			if (func_30(joaat("CONSUMABLE_VALERIAN_ROOT") /* GXTEntry: "Valerian Root" */))
			{
