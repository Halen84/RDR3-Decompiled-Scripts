...
bool func_72(var uParam0)
{
	...
	func_153(uParam0, iLocal_14, joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */, "w_repeater_carbine01");
	func_153(uParam0, iLocal_15, joaat("WEAPON_REVOLVER_DOUBLEACTION") /* GXTEntry: "Double-Action Revolver" */, "w_revolver_cattleman01");
