...
void __SCRIPT()
{
	...
	iLocal_70 = func_1(joaat("HORSE_CLASS_RIDING") /* GXTEntry: "Riding" */, 1);
	...
	switch (uParam0->f_464)
	{
		case 0:
			...
			if (bVar0)
			{
				...
				{
					uParam0->f_497 = VOLUME::CREATE_VOLUME_CYLINDER(uParam0->f_483, 0.0f, 0.0f, 0.0f, func_16(uParam0));
		...
		case 5:
			if (func_20(uParam0))
			{
				...
				if (func_22(*uParam0))
				{
					func_23(uParam0->f_483, 6.0f, 1, 1, 0, 0, 0);
				}
				uParam0->f_464 = 4;
			}
			else
...
void func_15(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_51(uParam0, 0, "MPDHP_HORSE", iLocal_70, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.0f, 0.0f, 0.0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_51(uParam0, 1, "MPDHP_MAN", iVar0, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, -2.0f, 0.0f, 0.0f), (10.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	if (*uParam0 != 71)
	{
		func_51(uParam0, 2, "WHCDP_ANIMAL", iLocal_69, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, -3.0f, 0.0f, 0.0f), (10.0f + vParam4.z), iVar1, 1, 1, 1, iLocal_68, 1);
	}
}
...
int func_32(var uParam0)
{
	...
	{
		PED::SET_PED_RESET_FLAG(uParam0->f_20[1 /*14*/], 42 /*PRF_UseHeadOrientationForPerception*/, true);
	}
	if (!uParam0->f_469[1])
	{
		...
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					...
					PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 442 /*PCF_0x78525B66*/, true);
					...
					if (*uParam0 == 71)
					{
						if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
						{
							PED::_EQUIP_META_PED_OUTFIT(uParam0->f_20[0 /*14*/], iLocal_67);
							PED::_UPDATE_PED_VARIATION(uParam0->f_20[0 /*14*/], false, true, true, true, false);
							PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 388 /*PCF_DisableFatallyWoundedBehaviour*/, true);
							PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 136 /*PCF_CannotBeMounted*/, true);
							PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 209 /*PCF_0xC44343FA*/, true);
							PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 214 /*PCF_0x3B611ABF*/, true);
							PED::SET_PED_CONFIG_FLAG(uParam0->f_20[0 /*14*/], 419 /*PCF_BlockMountHorsePrompt*/, true);
					...
					else if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
					{
						...
						PED::APPLY_PED_DAMAGE_PACK(uParam0->f_20[2 /*14*/], sLocal_71, 1.0f, 1.0f);
					...
					{
						TASK::TASK_FOLLOW_AND_CONVERSE_WITH_PED(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 0, 0, 3.0f, 3.0f, 160, 2.0f, -2.5f, 1.5f, (1 << 30));
					}
					PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
				}
				WEAPON::REMOVE_ALL_PED_WEAPONS(uParam0->f_20[1 /*14*/], true, true);
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[1 /*14*/], joaat("WEAPON_REPEATER_CARBINE") /* GXTEntry: "Carbine Repeater" */, 999, bLocal_72, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
				if (*uParam0 == 53 || *uParam0 == 46)
				{
					WEAPON::SET_CURRENT_PED_WEAPON(uParam0->f_20[1 /*14*/], joaat("WEAPON_UNARMED") /* GXTEntry: "Unarmed" */, true, 0, false, false);
				}
				func_74(&uLocal_11, uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 0);
				...
				func_78(uParam0->f_20[1 /*14*/], uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 34, (1 << 30));
				TASK::TASK_MOVE_IN_TRAFFIC(uParam0->f_20[1 /*14*/], 1.0f, 128, 0);
			}
			iLocal_9 = 1;
			break;
		case 1:
...
bool func_38(int iParam0, Vector3 vParam1)
{
	switch (iParam0)
	{
		case 58:
...
bool func_40(Vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8)
{
	bool bVar0;
	int iVar1[3];
	var uVar5;
...
void func_52(var uParam0)
{
	...
	iLocal_74 = PED::_REQUEST_META_PED_OUTFIT(iLocal_70, iLocal_67);
}
...
void func_66(var uParam0, bool bParam1)
{
	if (bParam1)
	{
		func_10(&(uParam0->f_1), (1 << 10));
	}
	else
	{
		func_108(&(uParam0->f_1), (1 << 10));
	}
}
...
void func_70(var uParam0, bool bParam1)
{
	if (bParam1)
	{
		func_108(uParam0, (1 << 20));
	}
	else
	{
		func_10(uParam0, (1 << 20));
	}
}
...
bool func_71(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (Global_1935630.f_26 & func_115(PLAYER::PLAYER_ID(), 0, 1, (uParam2->f_1 & (1 << 19)) == 0))
		{
		...
		{
			if (func_116(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!(uParam2->f_1 & 4) != 0)
				{
...
int func_76(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_147(*uParam0, 0.0f, 0.0f, 0.0f))
	{
		return 1;
	}
	iVar1 = 0;
...
bool func_88(Vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_162(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1.0f, 0))
			{
				return true;
			}
		}
...
void func_102(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_172(iParam1))
		{
			func_173(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_107(var uParam0, bool bParam1)
{
	if (bParam1)
	{
		func_108(uParam0, (1 << 10));
	}
	else
	{
		func_10(uParam0, (1 << 10));
	}
}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if ((*uParam0 & 16) != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_179(1) || (*uParam0 & (1 << 13)) != 0))
				{
					func_10(uParam0, (1 << 25));
				}
			}
			break;
		case 1:
...
bool func_112(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_188(iParam0, !(*uParam1 & (1 << 28)) != 0, !(*uParam1 & (1 << 29)) != 0, !(*uParam1 & (1 << 30)) != 0, 0, 0))
		{
...
bool func_113(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85.0f;
	if (func_192(iParam1, !(*uParam2 & (1 << 28)) != 0, !(*uParam2 & (1 << 29)) != 0, !(*uParam2 & (1 << 30)) != 0, 0))
	{
...
bool func_118(int iParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < (float)func_195(uParam2))
	{
		...
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(iVar0, &iVar5, &iVar4))
		{
			...
			else if (iVar4 == iVar5)
			{
				...
				while (iVar6 < iVar4)
				{
					...
					{
						if (func_207(iVar7, vVar1, 1) < 3.0f)
						{
		...
		case joaat("EVENT_SHOCKING_ENTITY_HOGTIED"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(iParam0, iVar4, -1.0f, -1.0f, -1.0f, -1.0f) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(iParam0, Global_35, -1.0f, -1.0f, -1.0f, -1.0f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iVar4, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					...
					{
						if (func_207(iVar4, Global_36, 1) < 7.0f)
						{
							return true;
						}
					}
...
int func_146(int iParam0, int iParam1, int iParam2)
{
	...
	sVar0 = { func_222(iParam0) /*5*/ };
	sVar5 = { func_223(iParam0, iParam1, sVar0, sVar0.f_4) /*4*/ };
	if (INVENTORY::_INVENTORY_ADD_ITEM_WITH_GUID(iParam0, &sVar5, &sVar0, iParam1, sVar0.f_4, iParam2, joaat("ADD_REASON_DEFAULT")))
	{
		if (func_224(iParam1, joaat("CI_TAG_ITEM_MEAT_FISH")) && func_225(iParam1, 4))
		{
			if (!func_226(42))
			{
				func_227(iParam1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(iParam0, Global_35, -1.0f, -1.0f, -1.0f, -1.0f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
			{
				...
				{
					if (func_207(iVar1, Global_36, 1) < 5.0f)
					{
						return true;
					}
				}
...
void func_218(int iParam0, Vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_162(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
struct<5> /*40*/ func_222(int iParam0)
{
	struct<5> /*40*/ sVar0;

	sVar0 = { func_223(iParam0, joaat("CHARACTER"), func_253(), joaat("SLOTID_NONE")) /*4*/ };
	sVar0.f_4 = joaat("SLOTID_SATCHEL");
	return sVar0;
}

struct<4> /*32*/ func_223(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> /*32*/ sVar0;
...
bool func_263(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((Global_1898164.f_163 && !func_272(iParam0, 1)) || func_273((1 << 15)))
	{
		if (!func_272(iParam0, (1 << 18)) || !Global_1905944.f_5696)
		{
			return false;
		}
	}
...
bool func_271(int iParam0)
{
	...
	if (!func_272(iParam0, (1 << 16)) && !func_272(iParam0, (1 << 15)))
	{
		return false;
	}
	iVar0 = 0;
	while (iVar0 < Global_40.f_7756)
	{
		if (Global_40.f_7756[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			if (iVar2 < 1800 && func_272(iParam0, (1 << 15)))
			{
				return true;
			}
		}
