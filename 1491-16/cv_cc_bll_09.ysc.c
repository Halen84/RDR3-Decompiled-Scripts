...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -2.2375f, -0.6f, 1.15f, -42.44f, 4.4f, 2.0f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	func_151(uParam0, -1.1621f, 0.6703f, 0.6545f, -130.68f, 1.0f, 1.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	func_152(uParam0, joaat("P_BOTTLEBEER01X"), 0.0f, 0.0f, 0.0f, "BOTTLE_BILL", 0, 1, 1);
	func_152(uParam0, joaat("P_BOTTLEJD01X"), 0.0f, 0.0f, 0.0f, "BOTTLE_PEARSON", 0, 1, 1);
	...
	{
		func_161(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SIT_BACK_EXHAUSTED"), "WORLD_HUMAN_SIT_BACK_EXHAUSTED_MALE_A", -1, 0, 100.0f, 1065353216, 1);
		func_162(uParam0, iLocal_15, 3, 0);
	}
	sLocal_20 = { func_163(uParam0, -1.081f, -1.97f, 1.0f, 56.8f, 7.0f, 0.5f, 0.5f) /*10*/ };
	sLocal_30 = { func_163(uParam0, -1.0807f, -1.9698f, 1.0f, 146.88f, 7.0f, 0.5f, 0.5f) /*10*/ };
	if (func_153(15))
	{
...
bool func_93(var uParam0)
{
	...
	{
		if (func_208(uParam0, sLocal_20, 1, 0))
		{
			func_199(uParam0, iLocal_18, 1);
		}
		else if (func_208(uParam0, sLocal_30, 1, 0))
		{
...
void func_162(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1 /*113*/].f_32.f_5 = { func_265(func_148(uParam0), func_264(uParam0, iParam1), func_19(uParam0), 1) /*3*/ };
			break;
		default:
			sVar0 = { func_266(func_148(uParam0), func_264(uParam0, iParam1), func_19(uParam0), 1) /*4*/ };
...
{
	func_161(uParam0, iParam1, 0, 0, 0, -1, 0, 0.0f, 1065353216, 1);
}
...
bool func_208(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
struct<4> /*32*/ func_266(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 1:
...
void func_316(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_336(100.0f, 140.0f);
			}
		}
...
int func_392(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_424(fVar9) /*3*/ };
			vVar13 = { func_425(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
void func_433(int iParam0, int iParam1)
{
	...
	func_401(iParam1, func_463(iParam1, (1 << 13)), func_463(iParam1, (1 << 14)), 1);
}
...
void func_458(int iParam0)
{
	...
	func_477(iParam0, (1 << 9));
	func_477(iParam0, (1 << 10));
	func_477(iParam0, (1 << 11));
	func_477(iParam0, (1 << 12));
	func_477(iParam0, (1 << 16));
	func_477(iParam0, (1 << 14));
	func_477(iParam0, (1 << 18));
	func_477(iParam0, (1 << 19));
	func_477(iParam0, (1 << 20));
	func_477(iParam0, (1 << 21));
	func_477(iParam0, (1 << 15));
	func_477(iParam0, (1 << 17));
	func_477(iParam0, (1 << 27));
	func_477(iParam0, (1 << 30));
}
...
int func_460(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_480(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0.0f;
...
int func_480(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
...
struct<5> /*40*/ func_487(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_499(iParam0))
	{
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_504(iParam0, joaat("CI_CATEGORY_CAMP")))
			{
			...
			else if (func_504(iParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_491(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("WARDROBE"));
			}
...
struct<4> /*32*/ func_491(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_509(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}
...
bool func_492(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_509(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
void func_495(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_512(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> /*32*/ func_500(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_491(joaat("CARRIED_WEAPONS"), func_498(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_491(joaat("CARRIED_WEAPONS"), func_498(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_491(joaat("CARRIED_WEAPONS"), func_498(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_501(int iParam0, bool bParam1)
{
	if (func_503(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
struct<4> /*32*/ func_502(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_491(joaat("EMOTE_ITEM"), func_498(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_491(joaat("EMOTE_ITEM"), func_498(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
bool func_505(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_509(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_506(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	...
	iVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_509(bParam6), &sVar0, false);
	return iVar4;
}
...
bool func_507(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_509(0);
	*uParam1 = { func_491(iParam0, func_500(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
