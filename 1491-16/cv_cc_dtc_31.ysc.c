...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, joaat("P_CHAIRFOLDING02X"), 0.0f, 0.0f, 0.0f, "Chair", 0, 0, 1);
	func_152(uParam0, 0.0501f, -2.8875f, 1.4875f, 0.0f, 1.1f, 1.1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	...
	func_155(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_STERNGUY_IDLES"), 0, -1, 0, MISC::GET_RANDOM_FLOAT_IN_RANGE(30.0f, 50.0f), 1065353216, 1);
	func_156(uParam0, iLocal_14, 3, 0);
	func_157(uParam0, iLocal_14, 1);
	func_158(uParam0, iLocal_14, 3, -1);
	sLocal_16 = { func_159(uParam0, 0.0775f, -2.3185f, 0.9877f, 169.0f, 6.5f, 0.705f, 0.4425f) /*10*/ };
	func_160(uParam0, 1);
...
bool func_93(var uParam0)
{
	if (!func_108(&uLocal_26))
	{
		...
		{
			func_202(&uLocal_26);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(func_48(uParam0, iLocal_14), 2357.7f, 1396.42f, 104.98f, 1.2f, -1, 0.25f, 1, 40000.0f);
			PED::FORCE_PED_MOTION_STATE(func_48(uParam0, iLocal_14), joaat("MOTIONSTATE_WALK"), false, 0, false);
		}
	}
	else if (func_109(&uLocal_26) < 5.0f)
	{
		return false;
	}
	else
...
int func_355(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_393(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
