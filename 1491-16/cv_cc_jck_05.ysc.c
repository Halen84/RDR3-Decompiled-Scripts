...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -3.85f, 2.375f, -0.218f, 80.0f, 1.0f, 1.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	func_151(uParam0, -2.225f, -1.75f, -0.218f, 135.75f, 1.7025f, 2.1125f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_16 = func_152(uParam0, joaat("P_CS_BOOK04X"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 0, 1);
	func_152(uParam0, joaat("P_STICKFIREPOKER01X"), 0.0f, 0.0f, 0.0f, "STICK", 0, 1, 1);
	...
	func_157(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824, 0.0f, 1);
	func_158(uParam0, iLocal_14, iLocal_16, "p_cs_book04x_PH_R_HAND", 0, 0);
	sLocal_22 = { func_159(uParam0, -1.2375f, -0.785f, -0.02f, 159.0f, 6.5f, 0.26f, 0.66f) /*10*/ };
	sLocal_32 = { func_159(uParam0, -1.238f, -0.785f, -0.02f, -126.25f, 6.5f, 0.0f, 0.567f) /*10*/ };
	sLocal_42 = { func_159(uParam0, -1.238f, -0.785f, -0.02f, 60.09f, 6.5f, 0.4375f, 0.0475f) /*10*/ };
	return true;
}
