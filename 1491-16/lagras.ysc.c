...
bool func_11()
{
	...
	iLocal_15 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2162.926f, -618.1368f, 42.473f, 0.0f, 0.0f, 44.5f, 10.521f, 13.0f, 4.0f, "Lagras - m_volBaitShop");
	iLocal_16 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2162.323f, -619.085f, 43.189f, 0.0f, 0.0f, -44.0f, 2.27f, 2.954f, 2.579f, "Lagras - m_volBaitPrompt");
...
{
	func_50(17, 645, iLocal_15, iParam0, iLocal_16, 0, 12, 50.0f, 0, 0);
...
void func_50(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	vVar1 = { func_89(iVar0) /*3*/ };
	vVar4 = { func_90(iVar0) /*3*/ };
	if (func_91(vVar1))
	{
		return;
	}
...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_55(iParam0) && func_81(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_125(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_125(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_125(&cVar6, joaat("COLOR_PURE_WHITE")), func_125(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
{
	func_53(0.775f, 0.2f, 0.025f, 0.0f);
	iParam0 = iParam0;
}
...
bool func_98(int iParam0, int iParam1)
{
	...
	if (func_92(iParam0, (1 << 14)) && !func_161(iParam0, 1))
	{
		return true;
	}
	if (!func_85(iParam1))
...
char* func_125(char* sParam0, int iParam1)
{
	...
	return func_178(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

int func_126(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_130(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_153(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_167(iParam0, (1 << 10)))
		{
			func_168(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_167(iParam0, (1 << 10)))
	{
...
bool func_172(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_205(iVar0) && func_206(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
bool func_208(Vector3 vParam0, int iParam3)
{
	...
	func_220(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_221(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
