...
void __SCRIPT()
{
	...
	fLocal_7 = 1.0f;
	fLocal_8 = 1.0f;
	vLocal_41 = { 2.12531f, 2.91148f, 0.00697327f /*3*/ };
	iLocal_44 = joaat("CAMP_CONVO_PROP_WASHBOARD");
	sVar0 = -1;
	sVar0.f_1 = -1;
	sVar0.f_2 = -1;
	sVar0.f_17 = 10;
...
bool func_73(var uParam0)
{
	...
	{
		case 1:
			vLocal_35 = { -111.98f, -37.59f, 94.73f /*3*/ };
			func_150(uParam0, 144, 0, 0, 0);
			break;
		case 2:
			vLocal_35 = { 678.39f, -1265.06f, 42.98f /*3*/ };
			func_150(uParam0, 77, 0, 0, 0);
			break;
		case 3:
			vLocal_35 = { 1882.42f, -1882.1f, 41.81f /*3*/ };
	...
	func_152(uParam0, -0.9083f, 7.1176f, 1.0f, 0.0f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
	func_152(uParam0, 1.5425f, 2.3927f, 1.0f, 67.68f, 3.0f, 2.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	func_153(uParam0, 1.5425f, 2.3927f, 1.0f, 67.68f, 3.0f, 2.0f, 3.0f, joaat("VOLBOX"), 1);
	iLocal_24 = func_154(uParam0, joaat("P_POCKETMIRROR01X"), 0.0f, 0.0f, 0.0f, "MIRROR", 0, 1, 1);
	iLocal_21 = func_154(uParam0, joaat("P_CS_RAG02X"), 0.0f, 0.0f, 0.0f, "RAG", 0, 1, 1);
	iLocal_22 = func_154(uParam0, joaat("P_WASHBOARD01X"), 0.0f, 0.0f, 0.0f, "WASHBOARD", 0, 1, 1);
	...
	func_158(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_WASHBOARD"), "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 10.0f, 1065353216, 1);
	...
	sLocal_25 = { func_160(uParam0, 0.9128f, 2.0361f, 1.1128f, 59.76f, 5.0f, 0.7f, 0.7f) /*10*/ };
	return true;
}
...
bool func_87(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		vLocal_38 = { ENTITY::GET_ENTITY_COORDS(iVar0, false, false) /*3*/ };
...
bool func_94(var uParam0)
{
	if (!bLocal_45)
	{
		...
		if (!func_200(uParam0, sLocal_25, 1, 0) && func_202(uParam0, iLocal_19))
		{
...
bool func_96(var uParam0)
{
	...
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_35, 1.0f))
	{
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(iLocal_44, true);
		ENTITY::SET_ENTITY_COORDS(func_8(uParam0, iLocal_23), vLocal_38, true, false, true, true);
		bLocal_47 = true;
...
int func_152(var uParam0, Vector3 vParam1, float fParam4, Vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_191(uParam0, vParam1) /*3*/ };
...
struct<10> /*80*/ func_160(var uParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	...
	sVar2 = { func_191(uParam0, vParam1) /*3*/ };
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0 /*15*/].f_5 && !ENTITY::DOES_ENTITY_EXIST(uParam0->f_1711[iVar0 /*15*/].f_10))
			{
				...
				{
					vVar3 = { func_191(uParam0, uParam0->f_1711[iVar0 /*15*/].f_1) /*3*/ };
				}
				else
				{
...
void func_185(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_191(uParam0, uParam0->f_1976.f_1), 1, func_255(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
bool func_269(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1 /*15*/].f_5)
		{
			...
			{
				vVar2 = { func_191(uParam0, uParam0->f_1711[iVar1 /*15*/].f_1) /*3*/ };
			}
			else
			{
