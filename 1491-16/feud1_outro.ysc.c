	...
	if (func_46(&iLocal_9, &uLocal_12, 1, 1, 0, 0, 0, 0))
	{
		if (!PED::IS_PED_INJURED(uLocal_12[0]))
		{
			...
			if (!PED::IS_PED_USING_SCENARIO_HASH(uLocal_12[0], joaat("WORLD_HUMAN_STERNGUY_IDLES")))
			{
				...
				func_47(uLocal_12[0], joaat("WORLD_HUMAN_STERNGUY_IDLES"), 0, 0, 0, -1082130432);
			}
		}
...
struct<5> /*40*/ func_154(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_165(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_158(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_167(iParam0, 1))
			{
				...
				if (!func_156(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_156(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_157(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_158(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
