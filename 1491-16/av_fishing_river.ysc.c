...
int func_31(var uParam0)
{
	...
	if (!bLocal_82)
	{
		...
		{
			func_71(uParam0->f_20[0 /*14*/], Global_35, "GREET_MALE", 0, -1082130432, 1, 0, 0, 1, 1, 1, joaat("SPEECH_PARAMS_BEAT_SPOKEN_NORMAL"), 1, 0, 0);
			bLocal_82 = true;
		}
	}
	if (!bLocal_83)
	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[0 /*14*/], joaat("WEAPON_FISHINGROD"), 1, true, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), true, 0.0f, false);
		...
		case 1:
			...
			{
				if (func_81(uParam0, 8.0f, 1116471296, 4, joaat("ACTION"), 0))
				{
					func_69(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[2] = 1;
				}
...
void func_112(int iParam0, Vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_137(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
