...
bool func_2()
{
	...
	switch (iLocal_0)
	{
		...
		case 4:
			...
			func_20(joaat("DOCUMENT_TRAIN_TICKET"), 1, joaat("REMOVE_REASON_DEFAULT"), 0, 0);
			func_6(5);
			break;
		case 5:
			if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_19))
...
struct<5> /*40*/ func_25(bool bParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_35(bParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_27(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_37(bParam0, 1))
			{
				...
				if (!func_38(bParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_38(bParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_39(bParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_27(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
