	...
	while (!SCRIPTS::IS_THREAD_EXIT_REQUESTED())
	{
		...
		switch (iVar0)
		{
			...
			case 21:
				...
				if (!func_29(1))
				{
					func_30(joaat("WEATHER_GROUP_LIGHT_PRECIPITATION"), 1, 0, 1103626240);
				}
				func_2(&iVar6);
				ENTITY::FREEZE_ENTITY_POSITION(Global_35, false);
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_136(iVar3, 6) || uParam0->f_1[iVar1 /*3*/] == Global_1946054.f_57[iVar1 /*11*/]) || uParam0->f_1[iVar1 /*3*/].f_1 == 289238755)
				{
