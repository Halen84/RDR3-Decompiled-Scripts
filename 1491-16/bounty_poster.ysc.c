...
void __EntryFunction__()
{
	...
	if (SCRIPTS::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("BOUNTY_POSTER")) > 1)
	{
		func_2(&sLocal_20, -1);
	}
...
void func_42(int iParam0)
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&cVar0))
	{
		...
		func_108(iParam0, &cVar1, sVar3, -1082130432);
	}
}
	...
	switch (iLocal_147)
	{
		case 0:
			if (func_47(uParam0->f_6, 0))
			{
				...
				{
					func_128(&(sLocal_180[0 /*17*/]), "INTERACT_GREET", " ", joaat("INPUT_INTERACT_LOCKON_POS"), 0, 0, 0, 1, 0);
					func_128(&(sLocal_180[1 /*17*/]), "INTERACT_INSULT", " ", joaat("INPUT_INTERACT_LOCKON_NEG"), 0, 0, 0, 1, 0);
					func_125(&(sLocal_180[0 /*17*/]), 0, 0);
					func_125(&(sLocal_180[1 /*17*/]), 0, 0);
					iLocal_147 = 1;
				}
				...
				{
					func_128(&(sLocal_180[0 /*17*/]), "INTERACT_QUESTION", " ", joaat("INPUT_INTERACT_LOCKON_POS"), 0, 0, 0, 1, 0);
					func_128(&(sLocal_180[1 /*17*/]), "INTERACT_INSULT", " ", joaat("INPUT_INTERACT_LOCKON_NEG"), 0, 0, 0, 1, 0);
			...
			break;
		case 1:
			iVar1 = func_129(&(uParam0->f_6), &iLocal_159, 8.0f, &sLocal_180, 0.0f, 3, 1, 0, 3, uParam0->f_112, 2, -1082130432);
			if (iLocal_145 >= 3)
			{
				func_125(&(sLocal_180[0 /*17*/]), 1, 0);
		...
		case 7:
			...
			break;
		case 8:
			iVar1 = func_129(&(uParam0->f_6), &iLocal_159, 8.0f, &sLocal_180, 0.0f, 3, 1, 0, 2, uParam0->f_112, 2, -1082130432);
			if (iVar1 == 0)
			{
...
{
	if (-1829635046 == func_268(joaat("CI_CATEGORY_WARDROBE_MASK")))
	{
		if (func_269(uParam0))
		{
			return true;
...
int func_293(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1.0f;
	if (bParam1 && func_395(joaat("PROVISION_TRINKET_ELK_ANTLER"), 1, 0))
	{
		fVar0 += 0.1f;
	}
	sVar1.f_1 = 10;
