...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_50(uParam0, 0, "MSRP_HORSE", iVar1, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 2.0f, 2.2f, 0.0f), (60.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, 1, "MSRP_MAN", iVar0, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.0f, 0.0f, 0.0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				func_75(uParam0->f_20[1 /*14*/], joaat("WORLD_HUMAN_SIT_GROUND_READING_BOOK_STOW"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, 0, 1, 0, -1082130432);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("WORLD_ANIMAL_HORSE_GRAZING"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
				func_76(&(uParam0->f_20[0 /*14*/]), 0, 1);
				PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
			}
			iLocal_38 = GRAPHICS::ADD_VEG_MODIFIER_SPHERE(uParam0->f_20[1 /*14*/].f_5, 4.0f, 1, 36, 0);
