...
void __SCRIPT()
{
	...
	fLocal_7 = 1.0f;
	fLocal_8 = 1.0f;
	vLocal_41 = { -1640.0f, -1358.0f, 83.0f /*3*/ };
	sVar0 = -1;
	sVar0.f_1 = -1;
	sVar0.f_2 = -1;
	sVar0.f_17 = 10;
		...
		else if (func_52(uParam0->f_107[iVar0 /*113*/].f_7))
		{
			...
			else
			{
				...
				if (func_52(uParam0->f_107[iVar0 /*113*/].f_1))
				{
					...
					{
						func_58(uParam0->f_107[iVar0 /*113*/].f_1, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
					}
				}
			}
			iVar0++;
...
bool func_74(var uParam0)
{
	...
	func_153(uParam0, 0.1f, -0.35f, 0.5f, 0.0f, 3.36f, 3.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_154(uParam0, 0.65f, -0.5f, 0.5f, 0.0f, 0.4f, 0.4f, 3.0f, joaat("VOLCYLINDER"), 1);
	iLocal_20 = func_155(uParam0, joaat("P_BROOM02X"), 0.0f, 0.0f, 0.0f, "BROOM", 0, 0, 1);
	...
	sLocal_21 = { func_165(uParam0, 0.2714f, -1.4657f, 1.0383f, 128.88f, 4.25f, 0.5f, 0.5f) /*10*/ };
	sLocal_31 = { func_165(uParam0, 0.271f, -1.466f, 1.038f, -128.88f, 3.15f, 0.5f, 0.635f) /*10*/ };
	func_166(uParam0, 1);
	return true;
}
...
bool func_88(var uParam0)
{
	func_8(119);
	func_9(118);
	iLocal_44 = INTERIOR::GET_INTERIOR_AT_COORDS(-1640.0f, -1358.0f, 83.0f);
...
bool func_95(var uParam0)
{
	if (!bLocal_46)
	{
		...
		{
			if (func_205(uParam0, sLocal_21, 1, 0))
			{
				func_196(uParam0, iLocal_18, 1);
			}
			else if (func_205(uParam0, sLocal_31, 1, 0))
			{
...
{
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_41, 2.0f))
	{
		func_8(118);
		func_9(119);
		INTERIOR::ACTIVATE_INTERIOR_ENTITY_SET(iLocal_44, "bee_01_house_chair", 0);
...
void func_162(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1 /*113*/].f_32.f_5 = { func_263(func_150(uParam0), func_262(uParam0, iParam1), func_21(uParam0), 1) /*3*/ };
			break;
		default:
			sVar0 = { func_264(func_150(uParam0), func_262(uParam0, iParam1), func_21(uParam0), 1) /*4*/ };
...
void func_313(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_333(100.0f, 140.0f);
			}
		}
		...
		{
			func_58(uParam0->f_107[iParam1 /*113*/].f_1, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
		}
	}
}
...
void func_398(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_432(func_106(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_433(iParam0);
...
void func_430(int iParam0, int iParam1)
{
	...
	func_398(iParam1, func_460(iParam1, (1 << 13)), func_460(iParam1, (1 << 14)), 1);
}
