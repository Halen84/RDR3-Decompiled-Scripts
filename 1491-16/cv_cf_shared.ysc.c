	...
	if (iVar0 >= 343 && iVar0 <= 384)
	{
		switch (iVar0)
		{
			...
			case 354:
				...
				func_159(uParam0, iLocal_20, 2, joaat("WORLD_CAMP_FIRE_SEATED_GROUND"), "WORLD_CAMP_FIRE_SIT_GROUND_RECLINE_MALE_A", -1, 1, -1073741824, 0.0f, 1);
			...
			case 374:
				...
				func_152(uParam0, -0.943556f, 1.90609f, 0.964859f, -147.0107f, 2.2f, 1.2f, 3.0f, joaat("VOLBOX"), -1, 1, 0, 1);
				iLocal_28 = func_151(uParam0, joaat("P_BOTTLEBEER01X"), 0.0f, 0.0f, 0.0f, "BEER", 0, 0, 1);
	...
	else
	{
		switch (iVar0)
		{
			...
			case 405:
				...
				func_159(uParam0, iLocal_18, 3, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_26, 0, -1073741824, 1065353216, 1);
				func_158(uParam0, iLocal_20, 3, joaat("WORLD_CAMP_FIRE_SEATED_GROUND"), "WORLD_CAMP_FIRE_SIT_GROUND_RECLINE_MALE_C", -1, 1);
				func_159(uParam0, iLocal_20, 2, joaat("WORLD_CAMP_FIRE_SEATED_GROUND"), "WORLD_CAMP_FIRE_SIT_GROUND_RECLINE_MALE_C", -1, 1, 18.0f, 1065353216, 1);
			...
			if (func_149(uParam0) == 6)
			{
				func_183(uParam0, 5.0f, 1097859072, 10.0f, 5.0f);
			}
			return true;
		}
...
{
	func_159(uParam0, iParam1, 0, 0, 0, -1, 0, 0.0f, 1065353216, 1);
}
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_290(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
...
void func_344(var uParam0)
{
	...
	{
		UILOG::_UILOG_ADD_ENTRY_HASH(8, iVar0, func_403(func_23()), 1307979820, func_404(*uParam0), 0);
...
void func_347(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		func_406(uParam0, 1896170705, MISC::VAR_STRING(168, iVar0, sVar2, sVar3, sVar1), 0, bParam1, 0);
	}
	else
	{
		func_406(uParam0, 1896170705, HUD::GET_STRING_FROM_HASH_KEY(iVar0), 0, bParam1, 0);
	}
}
...
int func_391(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_446(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
char* func_411(char* sParam0, int iParam1)
{
	...
	return func_461(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
struct<5> /*40*/ func_556(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_449(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_530(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_530(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
