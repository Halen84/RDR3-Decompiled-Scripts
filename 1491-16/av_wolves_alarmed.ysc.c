...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_47(uParam0, 0, "WAP_WOLF_1", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "WAP_WOLF_2", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.75f, 0.5f, 0.0f), (20.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 2, "WAP_WOLF_3", iLocal_9, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 4.0f, 3.5f, 0.0f), (120.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 3, "WAP_WOLF_4", iLocal_10, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 3.5f, -2.5f, 0.0f), (-110.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("WORLD_ANIMAL_WOLF_SLEEPING"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
				func_65(&(uParam0->f_20[0 /*14*/]), 1, 1);
			}
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				func_64(&(uParam0->f_20[1 /*14*/].f_5), 50, 10, 0);
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], joaat("WORLD_ANIMAL_WOLF_SITTING"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
			...
			while (iVar0 <= 3)
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
				{
					...
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[iVar0 /*14*/], joaat("WORLD_ANIMAL_WOLF_RESTING"), uParam0->f_20[iVar0 /*14*/].f_5, uParam0->f_20[iVar0 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
		...
		case 1:
			if (func_66(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				TASK::REACT_LOOK_AT(uParam0->f_20[3 /*14*/], Global_35, 1, 1, 15.0f, 1, 0, 0, 0);
				func_67(&uLocal_15);
				iLocal_11 = 3;
			}
			break;
		case 3:
			if (!func_68(uParam0->f_20[0 /*14*/], joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")))
			{
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(uParam0->f_20[0 /*14*/], Global_35, 0, -1.0f, -1.0f, -1.0f);
			}
			if (!func_68(uParam0->f_20[2 /*14*/], joaat("SCRIPT_TASK_TURN_PED_TO_FACE_ENTITY")))
			{
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(uParam0->f_20[2 /*14*/], Global_35, 0, -1.0f, -1.0f, -1.0f);
			}
			if (func_69(uParam0->f_20[0 /*14*/], Global_35, 1) < 324.0f || func_70(&uLocal_15, 12.5f))
			{
...
void func_62(var uParam0)
{
	...
	while (iVar0 <= 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
		{
			...
			TASK::TASK_FLEE_PED(0, Global_35, 2, 256, -1.0f, -1, 0);
...
int func_64(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_103(*uParam0, 0.0f, 0.0f, 0.0f))
	{
		return 1;
	}
	iVar1 = 0;
