...
void __SCRIPT()
{
	...
	vLocal_40 = { -2.558f, -0.295f, 0.0037f /*3*/ };
	sVar0 = -1;
	sVar0.f_1 = -1;
	sVar0.f_2 = -1;
	sVar0.f_17 = 10;
...
bool func_1(var uParam0)
{
	if (!bLocal_43)
	{
		if (uParam0->f_9 && TASK::DOES_SCENARIO_POINT_EXIST(uParam0->f_107[iLocal_14 /*113*/].f_8.f_23))
		{
			...
			TASK::TASK_USE_SCENARIO_POINT(uParam0->f_107[iLocal_14 /*113*/].f_5, uParam0->f_107[iLocal_14 /*113*/].f_8.f_23, uParam0->f_107[iLocal_14 /*113*/].f_8.f_2, 0, false, true, 0, false, 1.0f, false);
			PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(uParam0->f_107[iLocal_14 /*113*/].f_5, false, false);
			func_9(uParam0->f_107[iLocal_14 /*113*/].f_1, 0, 0, 0, 15.0f, 1, 1, 0, 0, 0, 0);
			bLocal_43 = true;
			return false;
		}
	}
		...
		else if (func_50(uParam0->f_107[iVar0 /*113*/].f_7))
		{
			...
			else
			{
				...
				if (func_50(uParam0->f_107[iVar0 /*113*/].f_1))
				{
					...
					{
						func_9(uParam0->f_107[iVar0 /*113*/].f_1, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
					}
				}
			}
			iVar0++;
...
void func_62(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		PED::SET_PED_CONFIG_FLAG(func_129(iParam0), 137 /*PCF_0xE18960DE*/, true);
	}
}
...
void func_64(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		PED::SET_PED_CONFIG_FLAG(func_129(iParam0), 204 /*PCF_0x435F091E*/, true);
	}
	else
	{
		PED::SET_PED_CONFIG_FLAG(func_129(iParam0), 204 /*PCF_0x435F091E*/, false);
	}
}
...
void func_66(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_129(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_131(iParam0) < 10000.0f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
void func_77(var uParam0, int iParam1, bool bParam2)
{
	...
	{
		case 1:
			if (!func_123(&(uParam0->f_107[iParam1 /*113*/].f_32.f_56)) || func_140(&(uParam0->f_107[iParam1 /*113*/].f_32.f_56)) > 1.0f)
			{
				...
				{
					func_142(&(uParam0->f_107[iParam1 /*113*/].f_32.f_56), 0.0f);
				}
			}
			if (!func_123(&(uParam0->f_1693)) || func_140(&(uParam0->f_1693)) > 1.0f)
			{
				if (func_143())
				{
					iVar3 = joaat("ARTHUR");
...
bool func_94(var uParam0)
{
	...
	func_167(uParam0, -2.2375f, -0.5425f, 0.0f, 18.75f, 1.15f, 1.275f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_CHARLES"), 1, 1, 1);
	iLocal_17 = func_168(uParam0, joaat("P_CS_ARROW01X"), 0.0f, 0.0f, 0.0f, "ARROW", 0, 1, 1);
	func_168(uParam0, joaat("S_RC_POISONEDWATER01X"), 0.0f, 0.0f, 0.0f, "Poison", 0, 0, 1);
	iLocal_18 = func_168(uParam0, joaat("P_CS_MOONSHINERAG01X"), 0.0f, 0.0f, 0.0f, "RAG", 0, 0, 1);
	iLocal_19 = func_168(uParam0, joaat("P_CHAIR_CRATE02X"), -1.86272f, -0.829352f, -0.0207291f, 0, 1, 0, 1);
	vLocal_37 = { func_169(uParam0, vLocal_40) /*3*/ };
	...
	sLocal_20 = { func_177(uParam0, -1.7f, -0.8975f, 0.5054f, 96.5507f, 5.5f, 0.65f, 0.65f) /*10*/ };
	func_178(uParam0, 1);
	return true;
}
...
bool func_97(var uParam0)
{
	if (!bLocal_31)
	{
		...
		{
			MISC::CLEAR_AREA(vLocal_37, 1.0f, (1 << 21));
			bLocal_31 = true;
		}
	}
	return bLocal_31;
...
bool func_112(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(func_11(uParam0, iLocal_14)))
	{
		PLAYER::_0x3946FC742AC305CD(PLAYER::PLAYER_ID(), func_11(uParam0, iLocal_14), sLocal_36, 0.0f, 0.0f, 0.0f, 0, sLocal_36);
		MISC::UNREGISTER_INTERACTION_LOCKON_PROMPT(func_11(uParam0, iLocal_14));
	}
...
int func_135(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_59(iVar0, 0))
	{
		if (func_59(PED::_GET_RIDER_OF_MOUNT(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
...
void func_137(Vector3 vParam0, int iParam3)
{
	...
	while (iVar0 < Global_1911670)
	{
		...
		if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(iVar1))
		{
			...
			if (func_240(vVar2, vParam0, 2.0f, 1))
			{
...
int func_167(var uParam0, Vector3 vParam1, float fParam4, Vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_169(uParam0, vParam1) /*3*/ };
...
struct<10> /*80*/ func_177(var uParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	float fVar0;
	float fVar1;
	struct<10> /*80*/ sVar2;

	fVar0 = func_267(uParam0, (fParam4 + (fParam6 * 90.0f)));
	fVar1 = func_267(uParam0, (fParam4 - (fParam7 * 90.0f)));
	sVar2 = { func_169(uParam0, vParam1) /*3*/ };
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_269(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_229(uParam0->f_107[iVar12 /*113*/].f_1));
				}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0 /*15*/].f_5 && !ENTITY::DOES_ENTITY_EXIST(uParam0->f_1711[iVar0 /*15*/].f_10))
			{
				...
				{
					vVar3 = { func_169(uParam0, uParam0->f_1711[iVar0 /*15*/].f_1) /*3*/ };
				}
				else
				{
...
void func_203(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_169(uParam0, uParam0->f_1976.f_1), 1, func_267(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
void func_207(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_300(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iVar2 /*113*/].f_5, true, false));
				iVar1 = func_300(uParam0->f_107[iVar2 /*113*/].f_96);
				if (iVar0 | iVar1)
				{
...
void func_210(var uParam0, int iParam1, char* sParam2)
{
	int iVar0;
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		{
			func_298(iParam1, uParam0->f_1984[iVar0], sParam2);
		}
		iVar0++;
	}
}
...
{
	if (!func_307(uParam0, sLocal_20, 1, 0))
	{
		func_10(&iLocal_33, 1, 1);
		if (!ENTITY::IS_ENTITY_DEAD(func_11(uParam0, iLocal_14)))
		{
	...
	if (!bLocal_30)
	{
		MISC::REGISTER_INTERACTION_LOCKON_PROMPT(func_11(uParam0, iLocal_14), "", 6.0f, 0.0f, 0, 0.0f, 0.0f, 0, false, -1);
		bLocal_30 = true;
	}
	iLocal_34 = 0;
	PLAYER::GET_PLAYER_INTERACTION_TARGET_ENTITY(PLAYER::PLAYER_ID(), &iLocal_34, false, false);
	if (iLocal_34 == 0)
	{
		func_10(&iLocal_33, 1, 1);
		return 0;
	...
	{
		iLocal_33 = func_308("INTERACT_GREET", joaat("INPUT_INTERACT_LOCKON_POS"), func_11(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		func_309(iLocal_33, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(func_11(uParam0, iLocal_14)), 0, 1);
	}
...
void func_226(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_331(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
bool func_256(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_340(iVar0) && func_341(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
bool func_280(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1 /*15*/].f_5)
		{
			...
			{
				vVar2 = { func_169(uParam0, uParam0->f_1711[iVar1 /*15*/].f_1) /*3*/ };
			}
			else
			{
...
bool func_288(var uParam0, int iParam1, Vector3 vParam2)
{
	...
	if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(uParam0->f_107[iParam1 /*113*/].f_3, vParam2, true))
	{
		...
		{
			func_142(&(uParam0->f_107[iParam1 /*113*/].f_109), 0.0f);
		}
	}
	else
	{
...
bool func_289(var uParam0, int iParam1, Vector3 vParam2)
{
	...
	if (ENTITY::IS_ENTITY_OCCLUDED(uParam0->f_107[iParam1 /*113*/].f_5))
	{
		...
		{
			func_142(&(uParam0->f_107[iParam1 /*113*/].f_106), 0.0f);
		}
	}
	else
	{
...
int func_299(int iParam0, struct<8> /*64*/ sParam1, int iParam9)
{
	int iVar0;
	var uVar1;
...
int func_305(var uParam0, int iParam1)
{
	...
	if (func_331(uParam0, iParam1, 1.0f))
	{
		return 1;
	}
...
bool func_307(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
	...
	if (!func_363(sParam1, sParam1.f_6, Global_36))
	{
		return false;
	}
	if (func_363(sParam1, sParam1.f_3, Global_36))
	{
		return false;
	}
	if (bParam12)
...
int func_308(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 48)
	{
		if (func_238(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_364(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_319(var uParam0)
{
	...
	{
		UILOG::_UILOG_ADD_ENTRY_HASH(8, iVar0, func_376(func_26()), 1307979820, func_377(*uParam0), 0);
...
void func_322(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		sVar3 = func_384(&cVar4, joaat("COLOR_PURE_WHITE"));
		sVar2 = func_385(uParam0->f_3, 0);
		func_379(uParam0, 1896170705, MISC::VAR_STRING(168, iVar0, sVar2, sVar3, sVar1), 0, bParam1, 0);
	}
	else
	{
		func_379(uParam0, 1896170705, HUD::GET_STRING_FROM_HASH_KEY(iVar0), 0, bParam1, 0);
	}
}
...
struct<2> /*16*/ func_325(int iParam0)
{
	struct<2> /*16*/ sVar0;
...
void func_329(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_349(100.0f, 140.0f);
			}
		}
		...
		{
			func_9(uParam0->f_107[iParam1 /*113*/].f_1, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
		}
	}
}
...
bool func_330(var uParam0, int iParam1)
{
	...
	{
		func_142(&(uParam0->f_107[iParam1 /*113*/].f_32.f_52), 0.0f);
	}
		...
		else if (func_23(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_405(&iVar2, func_404(iVar3)))
					{
...
void func_360(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_411(iParam1))
		{
			func_412(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_363(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
int func_370(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_425(bParam2), iParam0, false);
	return iVar2;
}
...
void func_379(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(8, func_373(*uParam0), iParam1, sParam2, bParam3, bParam5, false);
		if (bParam4)
		{
...
bool func_381(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((Global_1898164.f_163 && !func_431(iParam0, 1)) || func_432((1 << 15)))
	{
		if (!func_431(iParam0, (1 << 18)) || !Global_1905944.f_5696)
		{
			return false;
		}
	}
...
char* func_384(char* sParam0, int iParam1)
{
	...
	return func_434(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
int func_397(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	...
	iVar0 = func_68(iParam1);
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !func_59(iVar0, 0)) || (bParam3 && !func_76(iParam1)))
	{
		if (bParam2)
		{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0) && func_59(iVar0, 0))
	{
		*uParam0 = 2;
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_459(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, (1 << 30));
			}
			else if (bParam16)
			{
...
int func_423(int iParam0, int iParam1)
{
	...
	if (func_470(iParam0, joaat("CI_TAG_ITEM_AMMOBOX")))
	{
...
int func_424(int iParam0, bool bParam1)
{
	...
	sVar0 = { func_472(iParam0, joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0) /*18*/ };
	if (bParam1)
	{
		func_474(&sVar0, func_473(0));
	}
	if (!func_475(&sVar0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_476(iVar18);
...
int func_427(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, bool bParam13)
{
	struct<5> /*40*/ sVar0;
	struct<8> /*64*/ sVar13;
	int iVar21;
...
bool func_430(int iParam0)
{
	...
	if (!func_431(iParam0, (1 << 16)) && !func_431(iParam0, (1 << 15)))
	{
		return false;
	}
	iVar0 = 0;
	while (iVar0 < Global_40.f_7756)
	{
		if (Global_40.f_7756[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			if (iVar2 < 1800 && func_431(iParam0, (1 << 15)))
			{
				return true;
			}
		}
...
int func_442(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_481(fVar9) /*3*/ };
			vVar13 = { func_482(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
int func_449(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !func_239(vVar0)) && !func_240(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608, 1))
			{
				if (ENTITY::IS_ENTITY_ATTACHED(Global_1360165[iParam0 /*1157*/].f_124))
				{
					ENTITY::DETACH_ENTITY(Global_1360165[iParam0 /*1157*/].f_124, true, true);
				}
				func_459(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, (1 << 30));
			}
			if (bParam1)
			{
				if (!ENTITY::_DOES_THREAD_OWN_THIS_ENTITY(Global_1360165[iParam0 /*1157*/].f_124))
...
void func_451(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_492(func_68(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_493(iParam0);
...
void func_459(int iParam0, Vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_127(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		iVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0);
	...
	if (func_127(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_127(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_127(iParam5, 32), true);
	...
	else if (func_127(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iParam0, vParam1, func_127(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0) == Global_35 && !func_127(iParam5, 64))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
			}
...
struct<18> /*144*/ func_472(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
struct<4> /*32*/ func_473(bool bParam0)
{
	int iVar0;
...
void func_474(var uParam0, struct<4> /*32*/ sParam1)
{
...
bool func_475(var uParam0, int iParam1, int* iParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_425(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_489(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_EQUIP_META_PED_OUTFIT(iParam1, func_522(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, false, true, true, true, false);
...
void func_490(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_129(iParam1), iParam0, false);
		PED::_0xED1C764997A86D5A(func_129(iParam1), iParam0);
	...
	func_451(iParam1, func_521(iParam1, (1 << 13)), func_521(iParam1, (1 << 14)), 1);
}
...
void func_492(int iParam0, float fParam1, bool bParam2)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		fParam1 = func_524(fParam1, 0.0f, 1.0f);
...
void func_513(int iParam0)
{
	...
	func_534(iParam0, (1 << 9));
	func_534(iParam0, (1 << 10));
	func_534(iParam0, (1 << 11));
	func_534(iParam0, (1 << 12));
	func_534(iParam0, (1 << 16));
	func_534(iParam0, (1 << 14));
	func_534(iParam0, (1 << 18));
	func_534(iParam0, (1 << 19));
	func_534(iParam0, (1 << 20));
	func_534(iParam0, (1 << 21));
	func_534(iParam0, (1 << 15));
	func_534(iParam0, (1 << 17));
	func_534(iParam0, (1 << 27));
	func_534(iParam0, (1 << 30));
}
...
int func_515(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_537(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0.0f;
...
struct<4> /*32*/ func_517(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_425(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}
...
int func_537(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
		...
		while (iVar28 < 4)
		{
			...
			if (func_547(iParam0, &sVar0, iVar5, 0))
			{
				if (func_548(iParam0, &sVar6, iVar5))
				{
					...
					func_549(iParam0, &sVar29, &sVar0, 1, joaat("REMOVE_REASON_DEFAULT"), 1, 0);
				}
				else
				{
					iVar28++;
...
struct<5> /*40*/ func_545(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_422(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_517(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_558(iParam0, joaat("CI_CATEGORY_CAMP")))
			{
				sVar0 = { func_517(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("KIT_CAMP"));
			}
			else if (func_558(iParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_517(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("WARDROBE"));
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_559(sVar0, &sVar27, bParam1, 0))
				{
					sVar0.f_4 = 0;
				}
				else
...
bool func_549(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!func_559(*uParam1, &sVar0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
...
{
	if (func_557(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
int func_560(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
...
bool func_561(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_425(0);
	*uParam1 = { func_517(iParam0, func_473(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
