...
bool func_1(var uParam0)
{
	...
	{
		STREAMING::_REMOVE_SCENARIO_ASSET(iLocal_27);
	}
	if (STREAMING::_HAS_SCENARIO_TYPE_LOADED(iLocal_28, false))
	{
		STREAMING::_REMOVE_SCENARIO_ASSET(iLocal_28);
	}
...
bool func_73(var uParam0)
{
	...
	iLocal_16 = func_154(uParam0, joaat("P_GUITAR01X"), 0.0f, 0.0f, 0.0f, "GUITAR", 0, 0, 1);
	iLocal_17 = func_154(uParam0, joaat("P_BOTTLEBEER01X"), 0.0f, 0.0f, 0.0f, "BOTTLE_BEER", 0, 1, 1);
	iLocal_21 = func_154(uParam0, joaat("S_LOOTABLECAMPCASE"), 0.0f, 0.0f, 0.0f, "CASE", 1, 0, 1);
	iLocal_18 = func_154(uParam0, joaat("P_BOTTLEJD01X"), 0.0f, 0.0f, 0.0f, "BOTTLE_JD", 0, 0, 1);
	func_154(uParam0, joaat("P_FOLDEDBILLS01X"), 0.0f, 0.0f, 0.0f, "BILLS", 0, 1, 1);
	vVar0 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vLocal_37, vLocal_40.z, 0.5754f, 1.2328f, 0.6545f) /*3*/ };
	vVar3 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vLocal_37, vLocal_40.z, 1.3504f, -0.4797f, 0.6545f) /*3*/ };
	fVar6 = func_155(-24.75f, vLocal_40.z);
	fVar7 = func_155(-15.57f, vLocal_40.z);
	func_156(uParam0, vVar0, fVar6, 1.0f, 1.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 0, 1, 1);
	func_156(uParam0, vVar3, fVar7, 1.0f, 1.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 0, 1, 1);
	func_156(uParam0, 0.5f, 0.0f, 0.0f, 0.0f, 4.0f, 3.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	func_157(uParam0, vLocal_37, 0.0f, 4.0f, 4.0f, 3.0f, joaat("VOLCYLINDER"), 0);
...
{
	vLocal_33 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vLocal_37, vLocal_40.z, 1.259f, -0.428f, 0.522f) /*3*/ };
	fLocal_36 = func_155(71.105f, vLocal_40.z);
	vLocal_29 = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vLocal_37, vLocal_40.z, 0.639f, 1.222f, 0.492f) /*3*/ };
	fLocal_32 = func_155(159.648f, vLocal_40.z);
	iLocal_44 = TASK::CREATE_SCENARIO_POINT_HASH(iLocal_28, vLocal_33, fLocal_36, 0.0f, 0.0f, false);
	iLocal_43 = TASK::CREATE_SCENARIO_POINT_HASH(iLocal_27, vLocal_29, fLocal_32, 0.0f, 0.0f, false);
...
bool func_94(var uParam0)
{
	if (func_201(uParam0, iLocal_14))
	{
		...
		{
			TASK::TASK_USE_SCENARIO_POINT(func_49(uParam0, iLocal_19), iLocal_43, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY_MALE_D", 0, true, false, 0, true, -1.0f, false);
		...
		if ((!bLocal_23 && !ENTITY::IS_ENTITY_DEAD(func_49(uParam0, iLocal_20))) && TASK::DOES_SCENARIO_POINT_EXIST(iLocal_44))
		{
			...
			{
				TASK::TASK_USE_SCENARIO_POINT(func_49(uParam0, iLocal_20), iLocal_44, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", 0, true, false, 0, true, -1.0f, false);
				bLocal_23 = true;
			}
		}
	}
	if (bLocal_23 && bLocal_22)
	{
		if (!ENTITY::IS_ENTITY_DEAD(func_49(uParam0, iLocal_19)) && !ENTITY::IS_ENTITY_DEAD(func_49(uParam0, iLocal_20)))
		{
			...
			{
				iLocal_45 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(TASK::GET_PROP_FOR_SCENARIO_POINT(iLocal_44, "p_bottleBeer01x_PH_R_HAND"));
				iLocal_46 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(TASK::GET_PROP_FOR_SCENARIO_POINT(iLocal_43, "p_bottleJD01x_ph_r_hand"));
...
void func_193(var uParam0)
{
	...
	ANIMSCENE::SET_ANIM_SCENE_ORIGIN(uParam0->f_1984[iLocal_15], vLocal_37, vLocal_40, 2);
	if (ANIMSCENE::GET_ANIM_SCENE_ENTITY_LOCATION_DATA(uParam0->f_1984[iLocal_15], "GUITAR", &sVar0, false, 0, 2))
	{
		ENTITY::SET_ENTITY_COORDS(func_22(uParam0, iLocal_16), sVar0, true, false, true, true);
		ENTITY::SET_ENTITY_ROTATION(func_22(uParam0, iLocal_16), sVar0.f_3, 2, true);
...
{
	vLocal_37 = { func_327(iParam0) /*3*/ };
	vLocal_40 = { func_328(iParam0) /*3*/ };
}
...
void func_395(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_425(func_105(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_426(iParam0);
