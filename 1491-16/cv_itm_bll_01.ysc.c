...
bool func_209(var uParam0)
{
	...
	{
		iLocal_64 = func_326("INTERACT_GREET", joaat("INPUT_INTERACT_LOCKON_POS"), func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_378(joaat("AMMO_REVOLVER_AMMOBOX_HIGH_VELOCITY"));
		...
		case 2:
			...
			uParam0->f_22 = func_378(joaat("CONSUMABLE_HORSE_REVIVER"));
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_378(joaat("CONSUMABLE_PREDATOR_BAIT"));
		...
		case 7:
			...
			uParam0->f_22 = func_378(joaat("CONSUMABLE_POTENT_MEDICINE"));
		...
		case 8:
			...
			uParam0->f_22 = func_378(joaat("CONSUMABLE_CHOCOLATE_BAR"));
		...
		case 11:
			...
			uParam0->f_22 = func_378(joaat("CONSUMABLE_HORSE_STIMULANT"));
		...
		case 13:
			...
			uParam0->f_22 = func_378(joaat("PROVISION_GOLDRING"));
			break;
		case 14:
			...
			uParam0->f_22 = func_378(joaat("CONSUMABLE_CIGAR"));
		...
		case 16:
			...
			uParam0->f_22 = func_378(joaat("CONSUMABLE_RUM"));
		...
		case 17:
			...
			uParam0->f_22 = func_378(joaat("KIT_GUN_OIL"));
		...
		case 19:
			...
			uParam0->f_22 = func_378(joaat("CONSUMABLE_POTENT_TONIC"));
		...
		case 20:
			...
			uParam0->f_22 = func_378(joaat("CONSUMABLE_MEDICINE"));
...
void func_317(int iParam0)
{
	...
	{
		case 9:
			if (func_379(joaat("PROVISION_JACKS_THIMBLE"), 0, 0) < 1)
			{
				func_380();
...
void func_318(var uParam0)
{
	...
	{
		UILOG::_UILOG_ADD_ENTRY_HASH(8, iVar0, func_385(func_24()), 1307979820, func_386(*uParam0), 0);
...
void func_321(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		func_388(uParam0, 1896170705, MISC::VAR_STRING(168, iVar0, sVar2, sVar3, sVar1), 0, bParam1, 0);
	}
	else
	{
		func_388(uParam0, 1896170705, HUD::GET_STRING_FROM_HASH_KEY(iVar0), 0, bParam1, 0);
	}
}
...
int func_326(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_217(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_395(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
int func_373(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_430(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
void func_388(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		...
		if (bParam4)
		{
			...
			Global_1359489.f_361.f_194 = func_438("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, MISC::GET_HASH_KEY(func_384(uParam0->f_3)), joaat("PLAYER_MENU"), "INPUT_FEED_INTERACT_GENERIC", joaat("SP_MISSIONS"), 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
char* func_393(char* sParam0, int iParam1)
{
	...
	return func_445(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
