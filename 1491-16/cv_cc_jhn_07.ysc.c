...
bool func_72(var uParam0)
{
	...
	{
		case 2:
			func_149(uParam0, 622.968f, -1253.664f, 40.79f, 0.0f, 0.0f, 129.57f);
			break;
		case 3:
			func_149(uParam0, 1909.35f, -1819.12f, 40.9299f, 0.0f, 0.0f, -17.555f);
			break;
		default:
			return false;
	}
	...
	func_151(uParam0, -1.04f, -0.08f, 0.0f, -1.44f, 2.56f, 2.2475f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	func_151(uParam0, -2.5686f, -10.618f, 0.0f, -11.5f, 1.41f, 1.325f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_20 = func_152(uParam0, joaat("P_CIGAR02X"), 0.0f, 0.0f, 0.0f, "CIGAR", 0, 1, 1);
	iLocal_19 = func_152(uParam0, joaat("P_CIGARETTE_CS01X"), 0.0f, 0.0f, 0.0f, "CIGARETTE", 0, 0, 1);
	...
	sLocal_21 = { func_158(uParam0, -1.59f, -1.9876f, 0.988f, -180.0f, 7.12f, 0.325f, 0.51f) /*10*/ };
	return true;
}
