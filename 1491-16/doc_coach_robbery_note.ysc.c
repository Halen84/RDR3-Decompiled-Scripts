...
void func_20(var uParam0, var uParam1)
{
	...
	*uParam1 = func_36(uParam0);
	uParam1->f_4 = func_68(*uParam1, joaat("TAG_INTERACTION_TYPE"));
...
{
	switch (func_68(iParam0, joaat("TAG_INTERACTION_TYPE")))
	{
...
void func_178(var uParam0)
{
	...
	while (iVar0 < 3)
	{
		if (func_78((*uParam0)[iVar0 /*9*/], 0))
		{
			(uParam0[iVar0 /*9*/])->f_4 = func_68((*uParam0)[iVar0 /*9*/], joaat("TAG_INTERACTION_TYPE"));
		}
		iVar0++;
	}
}
...
{
	switch (func_68(iParam1, joaat("TAG_INTERACTION_TYPE")))
	{
		case joaat("CI_TAG_PAPER_W15_24_H10_16"):
		case joaat("CI_TAG_PAPER_W11_5_H20_5"):
		case joaat("CI_TAG_PAPER_W18_9_H28_2_FOLDVERTICALX2"):
...
bool func_496(int iParam0, int iParam1, bool bParam2)
{
	...
	switch (iParam1)
	{
		...
		case joaat("SATCHEL_CATEGORY_DONATIONS"):
			...
			else if (func_68(iParam0, joaat("TAG_INTERACTION_TYPE")) == joaat("CI_TAG_POCKET_WATCH") && iParam0 != joaat("KIT_PLAYER_POCKETWATCH"))
			{
				return true;
			}
			else
