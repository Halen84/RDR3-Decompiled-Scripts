...
void func_16(var uParam0, var uParam1)
{
	...
	func_65((*uParam1)[0 /*9*/], 0, 1, 0, 0.0f);
...
int func_35(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	{
		if ((!func_31(iParam0, joaat("CI_TAG_ITEM_TALISMAN")) && !func_31(iParam0, joaat("CI_TAG_ITEM_UPGRADE"))) && !func_31(iParam0, 1248798204))
		{
			bVar3 = true;
		}
	}
	...
	if (!bVar3)
	{
		...
		else if (func_31(iParam0, 589988438))
		{
			if (func_131())
			{
				func_132(joaat("REWARD_SMALL"), 0, 1065353216, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		switch (iParam0)
		{
			...
			case joaat("CONSUMABLE_MOONSHINE"):
				...
				{
					func_161(594, joaat("TF_FORTIFY_TANK1"), 1, 1);
			...
			case joaat("CONSUMABLE_RESTORATIVE"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_161(594, joaat("TF_FORTIFY_TANK2"), 1, 1);
					Global_1935689.f_9447 = MISC::GET_GAME_TIMER();
				}
				break;
			...
			case joaat("CONSUMABLE_CHEWING_TOBACCO_USED"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_161(594, joaat("TF_FORTIFY_TANK3"), 1, 1);
					Global_1935689.f_9447 = MISC::GET_GAME_TIMER();
				}
				break;
			...
			case joaat("CONSUMABLE_POTENT_TONIC"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_161(594, joaat("TF_FORTIFY_TANK4"), 1, 1);
					Global_1935689.f_9447 = MISC::GET_GAME_TIMER();
				}
				break;
			...
			case joaat("CONSUMABLE_MEAL_ROAST_BEEF"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_161(595, joaat("TF_FORTIFY_CORE1"), 1, 1);
					Global_1935689.f_9447 = MISC::GET_GAME_TIMER();
				}
				break;
			...
			case joaat("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL_EGGS"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_161(595, joaat("TF_FORTIFY_CORE2"), 1, 1);
					Global_1935689.f_9447 = MISC::GET_GAME_TIMER();
				}
				break;
...
int func_49(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		if (func_183(Global_1347702[iParam0 /*49*/].f_12, (1 << 21)))
		{
...
bool func_50(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_47(iVar0) && func_183(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
char* func_57(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)
{
	...
	return MISC::VAR_STRING(2, func_189(sParam1));
}
...
void func_88(var uParam0, int iParam1)
{
	...
	else if (func_68(iParam1, 1224357681) == joaat("CI_TAG_FOLDER_BOUNTY_POSTERS"))
	{
...
void func_108(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == joaat("CIGARETTE_CARDS"))
	{
		...
		{
			func_246(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, func_245(func_101(iParam6))), iVar5, iVar4, -2, 0, 0, 0, 0, 1, 1);
			func_244(MISC::VAR_STRING(2, sVar0), MISC::VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else
		{
...
bool func_119(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, iParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			iVar5 = func_254((398 + iVar28), 1);
			if (func_255(iParam0, &sVar0, iVar5, 0))
			{
				if (func_256(iParam0, &sVar6, iVar5))
				{
					sVar29 = { func_257(iParam0, sVar0, iVar5, 0) /*4*/ };
					func_258(iParam0, &sVar29, &sVar0, 1, joaat("REMOVE_REASON_DEFAULT"), 1, 0);
				}
				else
				{
					iVar28++;
...
bool func_123(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_60(joaat("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == joaat("ADD_REASON_LOOTED"))
	{
...
void func_124(int iParam0)
{
	...
	if ((iParam0 == joaat("PROVISION_TALISMAN_EAGLE_TALON") && !func_266()) || iParam0 != joaat("PROVISION_TALISMAN_EAGLE_TALON"))
	{
...
void func_133(int iParam0)
{
	switch (iParam0)
	{
		...
		case joaat("DOCUMENT_NOTE_EXOTICS_STAGE_01"):
			func_106(43, 0, 0, joaat("EXOTIC_STAGE_01"), func_283(1), 0, -1, 0);
			func_284(1);
			break;
		case joaat("DOCUMENT_NOTE_EXOTICS_STAGE_02"):
			func_106(43, 0, 0, joaat("EXOTIC_STAGE_02"), func_283(2), 0, -1, 0);
			func_284(2);
			break;
		case joaat("DOCUMENT_NOTE_EXOTICS_STAGE_03"):
			func_106(43, 0, 0, joaat("EXOTIC_STAGE_03"), func_283(4), 0, -1, 0);
			func_284(4);
			break;
		case joaat("DOCUMENT_NOTE_EXOTICS_STAGE_04"):
			func_106(43, 0, 0, joaat("EXOTIC_STAGE_04"), func_283(8), 0, -1, 0);
			func_284(8);
			break;
		case joaat("DOCUMENT_NOTE_EXOTICS_STAGE_05"):
			func_106(43, 0, 0, joaat("EXOTIC_STAGE_05"), func_283(16), 0, -1, 0);
			func_284(16);
			break;
	}
}
...
void func_136(int iParam0)
{
	...
	switch (iParam0)
	{
		case joaat("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_99(437, 0);
			func_99(440, 0);
			func_287(joaat("TAXIDERMY_ORDER_01"), joaat("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &cVar0, 1, 0, 0);
			func_106(51, 0, 0, joaat("TAXIDERMY_ORDER_01"), cVar0, 0, -1, 0);
			func_108(51, 0, 0, cVar0, func_236(joaat("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_279(1);
			func_288(joaat("WS_TAXIDERMY_NOTICES"), 0, 0);
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_2"):
			COLLECTION::_COLLECTABLE_INCREMENT_NUM_FOUND(joaat("TAXIDERMY_ORDER_02"), 1);
			func_287(joaat("TAXIDERMY_ORDER_02"), joaat("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &cVar0, 1, 0, 0);
			func_106(51, 0, 0, joaat("TAXIDERMY_ORDER_02"), cVar0, 0, -1, 0);
			func_108(51, 0, 0, cVar0, func_236(joaat("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_279(8);
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_COLLECTABLE_INCREMENT_NUM_FOUND(joaat("TAXIDERMY_ORDER_03"), 1);
			func_287(joaat("TAXIDERMY_ORDER_03"), joaat("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &cVar0, 1, 0, 0);
			func_106(51, 0, 0, joaat("TAXIDERMY_ORDER_03"), cVar0, 0, -1, 0);
			func_108(51, 0, 0, cVar0, func_236(joaat("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_279(64);
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_COLLECTABLE_INCREMENT_NUM_FOUND(joaat("TAXIDERMY_ORDER_04"), 1);
			func_287(joaat("TAXIDERMY_ORDER_04"), joaat("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &cVar0, 1, 0, 0);
			func_106(51, 0, 0, joaat("TAXIDERMY_ORDER_04"), cVar0, 0, -1, 0);
			func_108(51, 0, 0, cVar0, func_236(joaat("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_279((1 << 9));
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_COLLECTABLE_INCREMENT_NUM_FOUND(joaat("TAXIDERMY_ORDER_05"), 1);
			func_99(438, 0);
			func_287(joaat("TAXIDERMY_ORDER_05"), joaat("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &cVar0, 1, 0, 0);
			func_106(51, 0, 0, joaat("TAXIDERMY_ORDER_05"), cVar0, 0, -1, 0);
			func_108(51, 0, 0, cVar0, func_236(joaat("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_279((1 << 15));
			break;
		default:
			func_99(439, 0);
	...
	if (func_116() == -1)
	{
		...
		else if (func_31(iParam0, -1478961327))
		{
			...
			if (func_290() == 2)
			{
				...
				if (iParam0 == joaat("PROVISION_GATOR_EGG"))
				{
					if (!func_294(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, joaat("GATOR_EGGS"), 0)) >= 25)
					{
						func_295(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, joaat("GATOR_EGGS"), 0), 1);
						func_230(48);
					}
					if (func_292(iParam0) < func_293(iParam0))
					{
...
void func_140(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar1 < 5)
	{
		...
		if (func_60(func_296(iVar0, 10), 1, 0))
		{
			if (bParam2)
			{
				func_297(iParam0, iVar0, cVar2, iParam1, bParam2);
			}
			else
			{
...
void func_141(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_116() == -1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam2))
		{
			...
			{
				func_132(0, 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), iVar0);
				return;
			}
		}
	}
	switch (iParam0)
	{
		case joaat("MONEY_ONE_DOLLAR"):
			func_132(joaat("REWARD_BILL"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_FIVE_DOLLARS"):
			func_132(joaat("REWARD_FIVE_DOLLARS"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_TEN_DOLLARS"):
			func_132(joaat("REWARD_TEN_DOLLARS"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLFOLD"):
			func_132(joaat("REWARD_BILLFOLD"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLFOLD_SML"):
			func_132(joaat("REWARD_BILLFOLD_SML"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLSTACK"):
			func_132(joaat("REWARD_BILLSTACK"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COIN"):
			func_132(joaat("REWARD_COIN"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINPURSE"):
			func_132(joaat("REWARD_COINPURSE"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINSACK"):
			func_132(joaat("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINSTACK"):
			func_132(joaat("REWARD_COINS"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYCLIP"):
			func_132(joaat("REWARD_MONEYCLIP"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYSTACK"):
			func_132(joaat("REWARD_MONEYSTACK"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYSTACK_LARGE"):
			if (!func_299())
			{
				func_132(joaat("REWARD_MONEYSTACK_LARGE"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			}
			break;
		case joaat("MONEY_COINCUP_SM"):
			func_132(joaat("REWARD_COINCUP_SM"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINCUP_LG"):
			func_132(joaat("REWARD_COINCUP_LG"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("CURRENCY_CASH"):
			func_132(joaat("REWARD_BILL"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_CARD_SET_COMMON"):
			func_132(joaat("REWARD_CARD_SET_COMMON"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_CARD_SET_RARE"):
			func_132(joaat("REWARD_CARD_SET_RARE"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_CARD_SET_ALL"):
			func_132(joaat("REWARD_CARD_SET_ALL"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_RARE_FISH"):
			func_132(joaat("REWARD_RARE_FISH"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_TAXIDERMY_STAGE_1"):
			func_132(joaat("REWARD_TAXIDERMY_STAGE_1"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_TAXIDERMY_STAGE_2"):
			func_132(joaat("REWARD_TAXIDERMY_STAGE_2"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_TAXIDERMY_STAGE_3"):
			func_132(joaat("REWARD_TAXIDERMY_STAGE_3"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_TAXIDERMY_STAGE_4"):
			func_132(joaat("REWARD_TAXIDERMY_STAGE_4"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_TAXIDERMY_STAGE_5"):
			func_132(joaat("REWARD_TAXIDERMY_STAGE_5"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_CALLOWAY_LETTER"):
			func_132(joaat("REWARD_CALLOWAY_LETTER"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
	}
}
...
int func_144(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		...
		case joaat("MP_COMPONENT_TYPE_NECKWEAR_1"):
			if (bParam8 && iParam1 != Global_1946054.f_57[func_305(iParam3, 1) /*11*/])
			{
				func_308(31, 0, 0, 0, 0);
			}
			break;
		case joaat("MP_COMPONENT_TYPE_HEADWEAR"):
			if (func_309((1 << 15)) && iParam1 != Global_1946054.f_57[func_305(iParam3, 1) /*11*/])
			{
				func_310();
...
bool func_145(int iParam0, bool bParam1)
{
	...
	*iParam0 = 0;
	...
	if (func_314("ALL WEAPONS", &iVar0, &iVar1, joaat("SLOTID_NONE"), 0))
	{
		iVar2 = 0;
		while (iVar2 < iVar1)
		{
			if (func_315(&sVar3, iVar2, iVar0, iVar1))
			{
...
int func_165(int iParam0, int iParam1, int iParam2)
{
	...
	sVar0 = { func_220(iParam0, 0, 1) /*5*/ };
	sVar5 = { func_257(iParam0, sVar0, sVar0.f_4, 0) /*4*/ };
	return func_321(iParam0, &sVar5, &sVar0, iParam1, iParam2, 0);
}
...
void func_166(int iParam0)
{
	...
	switch (func_113(iParam0))
	{
		case joaat("CI_CATEGORY_WARDROBE_MASK"):
			if (iParam0 == joaat("KIT_BANDANA") && func_322(joaat("CI_CATEGORY_WARDROBE_MASK"), 0) <= 0)
			{
		...
		case joaat("CI_CATEGORY_WARDROBE_OUTFIT"):
			...
			if (func_326() == joaat("MPC_PLAYER_TYPE_SP_ARTHUR") || func_326() == joaat("MPC_PLAYER_TYPE_SP_ARTHUR_SICK"))
			{
				switch (iParam0)
				{
			...
			else if (func_326() == joaat("MPC_PLAYER_TYPE_SP_MARSTON"))
			{
				switch (iParam0)
				{
		...
		case joaat("CI_CATEGORY_WARDROBE_BIG_MASK"):
			if (!func_327(joaat("CI_CATEGORY_WARDROBE_BIG_MASK"), 0))
			{
				if (func_328(joaat("CI_CATEGORY_WARDROBE_BIG_MASK"), &iVar1))
				{
...
int func_168(int iParam0, int iParam1)
{
	...
	sVar4.f_1 = 10;
	func_331(&sVar4, joaat("LOOT_TYPE_NORMAL"));
	return func_332(iParam0, &sVar4, &uVar0, iParam1);
}
...
void func_171(int iParam0, char* sParam1)
{
	...
	func_337(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_336(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_172(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	strcpy_s(&cVar2, 32, func_340(iVar1 == 1, "ITEM_GET_PUMP", "ITEM_GET_PUMP_MULT"));
	if (iParam1 > 0)
	{
	}
	else
	...
	else if (!func_341(iParam0, &sVar7, iVar11, iVar10, 0, joaat("UI_ITEMVIEWER")))
	{
	...
	sVar15 = func_342(MISC::VAR_STRING(10, &cVar2, MISC::VAR_STRING(0, func_159(iParam0)), iVar1), iVar12);
	...
	func_337(sVar15, sVar7.f_1, MISC::GET_HASH_KEY(sVar7.f_0), iVar14, iVar12, "Transaction_Feed_Sounds", sVar13, 0, 1);
}
...
int func_173(var uParam0, int iParam1)
{
	...
	if (func_314("ALL SATCHEL", &(uParam0->f_1.f_1), &(uParam0->f_1), joaat("SLOTID_SATCHEL"), 0))
	{
		uParam0->f_145 = 1;
		iVar0 = 0;
		iVar1 = 0;
		if (uParam0->f_1 > 0)
		{
			...
			while (iVar0 >= 0)
			{
				if (!func_315(&sVar2, iVar0, uParam0->f_1.f_1, uParam0->f_1))
				{
				}
				else
				{
...
bool func_174(var uParam0, var uParam1)
{
	...
	{
		if (func_315(&sVar0, iVar14, uParam0->f_1.f_1, uParam0->f_1))
		{
			if (func_344((*uParam1)[0 /*9*/], sVar0.f_4))
			{
				if (!bVar15)
				{
...
int func_182(char* sParam0, int iParam1, int iParam2, bool bParam3)
{
...
bool func_190(int iParam0, int iParam1)
{
	...
	if (func_314("ALL WEAPONS", &iVar1, &iVar2, joaat("SLOTID_NONE"), 0))
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_315(&sVar4, iVar3, iVar1, iVar2))
			{
			}
			else if (!func_253(sVar4.f_4))
			{
			}
...
struct<5> /*40*/ func_220(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_109(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_257(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_369(iParam0, 1))
			{
				...
				if (!func_255(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_255(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_256(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_257(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
...
bool func_224(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_216(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_256(iParam0, &sVar4, joaat("SLOTID_WEAPON_0")))
			{
				return false;
			}
			if (func_369(iParam0, 1))
			{
				if (!func_255(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					return false;
				}
				else if (func_256(iParam0, &sVar4, joaat("SLOTID_WEAPON_1")))
				{
					return false;
				}
			}
...
void func_230(int iParam0)
{
	...
	func_337(MISC::VAR_STRING(6, func_385(iParam0), fVar1), "itemtype_textures", func_386(iVar0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
bool func_233(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((Global_1898164.f_163 && !func_319(iParam0, 1)) || func_391((1 << 15)))
	{
		if (!func_319(iParam0, (1 << 18)) || !Global_1905944.f_5696)
		{
			return false;
		}
	}
...
bool func_241(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		if (iParam2 == joaat("CIGARETTE_CARDS"))
		{
			...
			{
				bVar1 = (func_60(iVar2, 1, 0) || func_401(func_400(iVar2)));
			}
			if (iParam5 == 8)
			{
				bVar1 = true;
			}
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_245(func_399(iVar0))), func_245(func_399(iVar0)), bVar1, true, false);
		}
		...
		{
			iVar2 = func_296(iParam3, func_403(iVar0));
			if (iParam5 == 8)
			{
				bVar1 = true;
			}
			else if (bParam9)
			{
				if (iParam4 == iVar2)
				{
					bVar1 = (func_292(iVar2) - iParam7) >= func_236(iParam3, func_404(iVar0));
				}
				else
				{
					bVar1 = func_292(iVar2) >= func_236(iParam3, func_404(iVar0));
				}
			}
		...
		{
			if (func_406(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, 1995362678, 0)))
			{
				bVar1 = true;
			}
			else if (iParam5 == 8)
...
struct<4> /*32*/ func_257(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
...
int func_276(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1.0f;
	if (bParam1 && func_60(joaat("PROVISION_TRINKET_ELK_ANTLER"), 1, 0))
	{
		fVar0 += 0.1f;
	}
	sVar1.f_1 = 10;
...
void func_277(int iParam0, char* sParam1, int iParam2)
{
	...
	func_337(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_278(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iParam0 += iVar2;
		iVar1 += iVar2;
		func_337(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_TOTAL_TAKE"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		iParam0 -= iVar0;
		if (iVar0 > 0)
		{
			func_439(iVar0);
		...
		func_337(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
	...
	if (iVar1 > 0)
	{
		...
		func_127(func_333(joaat("CAREER_CASH")), iVar1);
	}
}
...
int func_290()
{
	...
	while (iVar1 < 5)
	{
		if (func_447(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_297(int iParam0, int iParam1, char[4] cParam2, int iParam3, bool bParam4)
{
	...
	{
		func_287(iParam1, iParam0, &cParam2, 0, iParam3, bParam4);
...
void func_298(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((((iParam0 == func_296(iParam1, 5) || iParam0 == func_296(iParam1, 6)) || iParam0 == func_296(iParam1, 7)) || iParam0 == func_296(iParam1, 8)) || iParam0 == func_296(iParam1, 9))
	{
		if (func_287(iParam1, iParam0, &cVar0, 0, 0, 0))
		{
			func_106(51, iParam0, 0, iParam1, cVar0, 0, -1, 0);
			if (!bParam2)
			{
				func_108(51, 0, 0, cVar0, func_236(iParam1, 20), 1, 0);
			}
		}
		else
		{
...
bool func_306(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (iParam2 == 39)
	{
		...
		iParam2 = func_305(func_304(sVar0.f_4), 1);
	}
	...
	if ((func_309((1 << 15)) && iParam2 == 10) && iParam0 != Global_1946054.f_57[iParam2 /*11*/])
	{
...
void func_325(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_346(MISC::VAR_STRING(10, "OUT_JOURN_DONE", MISC::VAR_STRING(0, iVar0)), 10000, 0, 0, 0, 1);
	}
	func_487(iParam0, 6);
	if (bParam2)
	{
...
{
	return func_322(iParam0, 0) < func_488(iParam0, bParam1);
}
...
int func_332(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	func_492(uParam2, iParam0, sVar1);
	return 1;
}
...
int func_337(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, bool bParam8)
{
	struct<4> /*32*/ sVar0;
	struct<7> /*56*/ sVar13;
	int iVar20;
...
bool func_344(int iParam0, int iParam1)
{
	switch (func_68(iParam1, -949239683))
	{
		...
		case joaat("CI_TAG_PAPER_W15_1_H24_FOLDVERTICAL"):
		case joaat("CI_TAG_PAPER_W17_78_H12_7"):
			if (Global_1935689.f_9439 != joaat("SATCHEL_CATEGORY_DOCUMENTS") || func_68(iParam0, 1224357681) == func_68(iParam1, 1224357681))
			{
				return true;
			}
			break;
...
int func_346(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	struct<4> /*32*/ sVar0;
	struct<2> /*16*/ sVar13;
	int iVar15;
...
void func_351(int iParam0, bool bParam1)
{
	...
	if (MAP::DOES_BLIP_EXIST(Global_1347702[iParam0 /*49*/].f_37))
	{
		...
		if ((!func_510(PLAYER::PLAYER_ID(), 1, 0, 1) || Global_43891) || bParam1)
		{
			...
			func_508(&(Global_1347702[iParam0 /*49*/].f_13), (1 << 12));
			func_511(&(Global_1347702[iParam0 /*49*/].f_37));
		}
		else
		{
			func_512(iParam0, (1 << 14));
...
void func_353(int iParam0, Vector3 vParam1, bool bParam4, bool bParam5)
{
	...
	{
		Global_1347702[iParam0 /*49*/].f_37 = MAP::BLIP_ADD_FOR_RADIUS(Global_1347702[iParam0 /*49*/].f_38, func_517(iParam0), Global_1347702[iParam0 /*49*/].f_18);
		if (!MAP::DOES_BLIP_EXIST(Global_1347702[iParam0 /*49*/].f_37))
		{
			return;
		}
	...
	if (Global_1347702[iParam0 /*49*/].f_13 & 1 == 0)
	{
		...
		if (((!func_516(iParam0) || func_183(Global_1347702[iParam0 /*49*/].f_12, 1)) || func_183(Global_1347702[iParam0 /*49*/].f_12, (1 << 9))) || func_527(Global_1347702[iParam0 /*49*/].f_13, (1 << 11)))
		{
	...
	if (Global_1347702[iParam0 /*49*/].f_13 & (1 << 15) == 0)
	{
		...
		{
			func_504(&(Global_1347702[iParam0 /*49*/].f_13), (1 << 15));
		}
	}
	if (Global_1347702[iParam0 /*49*/].f_12 & 8 != 0 && Global_40.f_490.f_402[iParam0] & 2 == 0)
	{
		...
		else
		{
			...
			Global_1347702[iParam0 /*49*/].f_40 = func_346(MISC::VAR_STRING(2, &cVar3, sVar6), 10000, 0, 0, 0, 1);
		}
		func_51(iParam0, 2);
	}
}
...
void func_364(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	iVar0 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER(iParam1, func_532(iParam0));
	DATABINDING::_DATABINDING_ADD_DATA_HASH(iVar0, "style", func_533(iParam0));
...
struct<4> /*32*/ func_368(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_257(joaat("CARRIED_WEAPONS"), func_367(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_257(joaat("CARRIED_WEAPONS"), func_367(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_257(joaat("CARRIED_WEAPONS"), func_367(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}
...
struct<4> /*32*/ func_370(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_257(joaat("EMOTE_ITEM"), func_367(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_257(joaat("EMOTE_ITEM"), func_367(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
{
	if (func_536(iParam0, joaat("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
bool func_375(int iParam0, var uParam1, bool bParam2)
{
	...
	while (iVar29 < 4)
	{
		iVar5 = func_254((398 + iVar29), 1);
		if (func_255(iParam0, &sVar0, iVar5, 0))
		{
			bVar28 = func_256(iParam0, &sVar6, iVar5);
...
int func_376(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	...
	sVar0 = { func_257(iParam0, sParam1, iParam5, bParam6) /*4*/ };
...
void func_384(int iParam0, float fParam1, bool bParam2)
{
	...
	if (func_539(iParam0) & func_540(iParam0))
	{
		if (!bParam2)
		{
			iVar3 = func_541(fVar1, fParam1);
			if (fParam1 > (float)func_542(iParam0) && (iVar2 > iVar0 || iVar3 != 0))
			{
				if (!HUD::IS_RADAR_HIDDEN() && !Global_16)
				{
					if (iVar2 > iVar0)
					{
						func_99(func_543(iParam0), 0);
					}
					func_544(iParam0, iVar2, iVar3);
...
bool func_390(int iParam0)
{
	...
	if (!func_319(iParam0, (1 << 16)) && !func_319(iParam0, (1 << 15)))
	{
		return false;
	}
	iVar0 = 0;
	while (iVar0 < Global_40.f_7756)
	{
		if (Global_40.f_7756[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			if (iVar2 < 1800 && func_319(iParam0, (1 << 15)))
			{
				return true;
			}
		}
...
int func_395()
{
	...
	while (iVar1 < 12)
	{
		...
		if (func_60(iVar2, 1, 0) || func_401(func_400(iVar2)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_396()
{
	...
	while (iVar1 < 30)
	{
		if (func_548(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_397()
{
	...
	while (iVar1 < 14)
	{
		if (func_406(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, 1995362678, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
{
	if (func_549(iParam0) && func_60(iParam0, 1, 0))
	{
		return true;
	}
	else if (func_550(iParam0) & func_551(iParam0))
	{
		return true;
	}
	return false;
...
void func_422()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_165(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN"), 1, joaat("ADD_REASON_DEFAULT"));
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN"), true, 2, false, false);
		func_117(joaat("WEAPON_MELEE_KNIFE_JOHN"));
		func_165(joaat("WEAPON_MELEE_KNIFE_JOHN"), 1, joaat("ADD_REASON_DEFAULT"));
...
bool func_423(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_227(0);
	*uParam1 = { func_257(iParam0, func_368(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
...
void func_427(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	func_560(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
bool func_431(int iParam0, var uParam1)
{
	...
	iVar1 = func_305(func_561(iParam0), 1);
	if (iVar1 >= 39)
	{
		return false;
	}
...
int func_432(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam0 == Global_1946054.f_57[func_305(iParam1, 1) /*11*/])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_440(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_438())
	{
		func_337(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_GANG_SAVINGS_SPECIAL"), 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_337(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_GANG_SAVINGS"), 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
void func_457(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_569(iParam2, (1 << 16)) && uParam0->f_1[iVar1 /*3*/] == -452402570)
	{
	...
	if (func_329(joaat("MP_COMPONENT_TYPE_LOADOUT_9")) && func_569(iParam2, (1 << 19)))
	{
		iVar1 = 33;
		uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
		uParam0->f_1[iVar1 /*3*/].f_1 = 0;
	...
	switch (iVar2)
	{
		case joaat("CI_CATEGORY_WARDROBE_VEST"):
			...
			func_570(uParam0, (1 && bParam4), (1 && bParam4), (1 && bParam4), bParam3);
			break;
		case joaat("CI_CATEGORY_WARDROBE_SHIRT"):
			func_570(uParam0, 0, (1 && bParam4), (1 && bParam4), bParam3);
			iVar1 = 22;
			...
			else
			{
				...
				func_570(uParam0, (1 && bParam4), (1 && bParam4), 0, bParam3);
				iVar1 = 22;
				if (uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/])
				{
					uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
				...
				func_570(uParam0, (1 && bParam4), 0, 1, bParam3);
...
int func_458(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	iVar0 = func_571(0);
	if (iParam2 != 0 && func_572(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
	if (func_573(iParam0, func_451(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_459(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_574(iVar5, 6) || uParam0->f_1[iVar0 /*3*/] == Global_1946054.f_57[iVar0 /*11*/])
			{
			}
			else
			{
...
{
	Global_1946054.f_57[func_305(iParam0, 1) /*11*/].f_10 -= Global_1946054.f_57[func_305(iParam0, 1) /*11*/].f_10 & iParam1;
}
...
void func_461(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_576(uParam0->f_2[iVar0 /*2*/], bParam1, bParam2);
		iVar0++;
	}
	if (func_116() == -1)
	{
...
void func_463(struct<4> /*32*/ sParam0)
{
	...
	switch (sParam0.f_0)
	{
		...
		case 35:
		case 36:
			func_313(sParam0.f_0, sParam0.f_1, sParam0.f_2);
			break;
	}
}
...
void func_467(struct<4> /*32*/ sParam0)
{
	...
	if (func_580(sParam0.f_0))
	{
		...
		while (iVar0 < Global_1946054.f_852)
		{
			...
			if (Global_1946054.f_769[iVar1 /*4*/] == 34 && func_580(20))
			{
				return;
			}
			iVar0++;
...
void func_483(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_482(iParam0))
	{
		...
		if ((!func_486() && !bParam1) && !func_50(0, 0, 1))
		{
			func_346(MISC::VAR_STRING(10, "OUT_JOURN_ADD", func_586(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
void func_492(var uParam0, int iParam1, struct<14> /*112*/ sParam2)
{
	int iVar0;
	struct<21> /*168*/ sVar1;
...
bool func_496(int iParam0, int iParam1, bool bParam2)
{
	...
	bVar0 = false;
	if (((iParam1 == 0 || iParam1 == joaat("SATCHEL_CATEGORY_DONATIONS")) || bParam2) || func_498(0))
	{
		bVar0 = true;
	}
	if (!bParam2)
	...
	switch (iParam1)
	{
		...
		case 0:
			if (!func_498(0))
			{
				...
				if ((((((((((func_496(iParam0, joaat("SATCHEL_CATEGORY_MATERIALS"), 1) || func_496(iParam0, joaat("SATCHEL_CATEGORY_INGREDIENTS"), 1)) || func_496(iParam0, joaat("SATCHEL_CATEGORY_REMEDIES"), 1)) || func_496(iParam0, joaat("SATCHEL_CATEGORY_PROVISIONS"), 1)) || func_496(iParam0, joaat("SATCHEL_CATEGORY_VALUABLES"), 1)) || func_496(iParam0, joaat("SATCHEL_CATEGORY_KIT"), 1)) || func_496(iParam0, joaat("SATCHEL_CATEGORY_DOCUMENTS"), 1)) || func_496(iParam0, joaat("SATCHEL_CATEGORY_DONATIONS"), 1)) || func_496(iParam0, joaat("SATCHEL_CATEGORY_SEND"), 1)) || func_496(iParam0, joaat("SATCHEL_CATEGORY_SELL"), 1)) || func_597(iParam0))
				{
					return true;
				}
			}
		...
		case joaat("SATCHEL_CATEGORY_DONATIONS"):
			...
			else if (func_68(iParam0, -949239683) == joaat("CI_TAG_POCKET_WATCH") && iParam0 != joaat("KIT_PLAYER_POCKETWATCH"))
			{
				return true;
			}
			else
		...
		case joaat("SATCHEL_CATEGORY_SELL"):
			if (func_599(iParam0, Global_1914319.f_16855.f_1))
			{
				return true;
			}
			break;
...
bool func_506(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	while (iVar0 < 27)
	{
		if (func_602(iVar0, &iParam0))
		{
			Global_40.f_4942[iVar0 /*60*/].f_59 = iParam1;
			if (iParam3 == iParam4)
			{
				func_603(iVar0, (1 << 9), 1);
			}
			else
			{
...
{
	if (func_609(iParam0, bParam1, bParam2, bParam3))
	{
		return true;
	}
	if (bParam1)
...
void func_512(int iParam0, int iParam1)
{
	...
	func_610(&(Global_1347702[iParam0 /*49*/].f_14), iParam1);
	func_610(&(Global_1347702[iParam0 /*49*/].f_14), 2);
	func_611(&(Global_1347702[iParam0 /*49*/].f_12), (1 << 14));
...
void func_513(int iParam0, bool bParam1, Vector3 vParam2)
{
	...
	func_504(&(Global_1347702[iParam0 /*49*/].f_13), (1 << 12));
}
...
void func_526(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	switch (func_617(iParam0))
	{
		case 1:
			...
			{
				if ((func_619(iVar0, -1) && !Global_1835011[iVar0 /*74*/].f_70) && Global_1835011[iVar0 /*74*/].f_63 & 2 == 0)
				{
			...
			else if ((func_619(iVar0, -1) && !Global_1835011[iVar0 /*74*/].f_70) && Global_1835011[iVar0 /*74*/].f_63 & 2 == 0)
			{
			...
			if (Global_1835011[iVar0 /*74*/].f_28 != iVar2)
			{
				...
				if (func_621(&(Global_1835011[iVar0 /*74*/]), 2))
				{
		...
		case 8:
			...
			if (func_622(iVar1, bParam1, bParam2, iParam3) && Global_1357549.f_1709 > 1)
			{
...
float func_537(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 50:
			...
			iVar5 = func_538(fVar3);
			iVar0 = iVar5;
			iVar6 = iVar0 + 1;
			iVar1 = (func_623(iVar6) - func_623(iVar5));
...
int func_541(float fParam0, float fParam1)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	iVar0 = func_538(fParam0);
	fVar1 = BUILTIN::TO_FLOAT(func_623(iVar0));
	fVar2 = BUILTIN::TO_FLOAT(func_623(iVar0 + 1));
	fVar3 = (fVar2 - fVar1);
...
void func_544(int iParam0, int iParam1, int iParam2)
{
	...
	sVar4 = func_628(func_627(iVar3, iParam2));
	sVar6 = func_629(iParam0);
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sVar6))
	{
		sVar5 = "HUD_Toast_Soundset";
	}
	sVar7 = MISC::VAR_STRING(10, sVar0, func_630(iParam0));
	iVar8 = func_631(iParam0);
	...
	if (bVar2)
	{
		...
		sVar10.f_2 = iVar8;
		sVar10.f_4 = 1;
		sVar10.f_5 = func_632(iParam0);
		UILOG::_UILOG_POST_NOTIFICATION(&sVar10);
	}
	func_244(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_633(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
int func_551(int iParam0)
{
	...
	while (iVar95 < 3)
	{
		if (!func_634(&iVar0, 0, iVar95, &sVar1) && !func_634(&iVar0, 1, iVar95, &sVar1))
		{
		}
		else if (STREAMING::IS_MODEL_A_PED(sVar1.f_0))
		{
			func_635(iVar0, &sVar1);
...
void func_552()
{
	...
	func_637(0);
	func_638(7);
	func_639(joaat("KIT_BANDANA"), 1, 1, 0);
	if (func_326() == joaat("MPC_PLAYER_TYPE_SP_MARSTON"))
	{
		func_639(joaat("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
		func_639(joaat("CLOTHING_SP_MAR_OUTFIT_GUNSLINGER"), 1, 1, 1);
	}
	func_640(Global_35, &iVar0);
}

int func_553(int iParam0)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_641(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
{
	func_642(iParam0, iParam6);
	func_643(iParam0, iParam5);
	func_644(iParam0, iParam4);
	func_645(iParam0, iParam3);
	func_646(iParam0, iParam2);
	func_647(iParam0, iParam1);
}
...
int func_563(int iParam0, int iParam1)
{
	...
	func_642(&uVar6, iVar0);
	func_643(&uVar6, iVar1);
	func_644(&uVar6, iVar2);
	func_645(&uVar6, iVar3);
	func_646(&uVar6, iVar4);
	func_647(&uVar6, iVar5);
	return uVar6;
}

bool func_564(int iParam0, int iParam1, bool bParam2)
{
	if (bParam2)
	{
...
void func_565(int iParam0)
{
	...
	sVar0 = { func_333(joaat("GANG_SAVINGS_CASH")) /*2*/ };
...
void func_567(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_649(&(uParam0->f_2[iVar0 /*2*/]), 2) || uParam0->f_2[iVar0 /*2*/] == iParam1) || uParam0->f_2[iVar0 /*2*/] == 39)
			{
				uParam0->f_2[iVar0 /*2*/] = { sVar2 /*2*/ };
			}
			else
			{
				if (func_649(&(uParam0->f_2[iVar0 /*2*/]), 1))
				{
					func_650(&(uParam0->f_2[iVar0 /*2*/]), 2, 6);
				}
...
void func_570(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
{
	return Global_1946054.f_57[func_305(iParam0, 1) /*11*/].f_10 & iParam1 != 0;
}
...
char* func_584(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
...
bool func_588(int iParam0)
{
	...
	while (iVar0 < 9)
	{
		if (func_60(func_662(iVar0, iParam0), 1, 0))
		{
			iVar1++;
		}
		iVar0++;
...
bool func_589(int iParam0)
{
	...
	while (iVar0 < 4)
	{
		if (func_60(func_663(iVar0, iParam0), 1, 0))
		{
			iVar1++;
		}
		iVar0++;
...
bool func_596(int iParam0)
{
	...
	{
		if (func_664(iParam0, Global_1935689.f_19.f_2[iVar0 /*2*/]))
		{
			return true;
		}
		iVar0++;
...
bool func_600(int iParam0)
{
	...
	if (iParam0 != 0)
	{
		...
		{
			iVar0 = func_296(func_668(iParam0), 10);
			if (iVar0 != 0 && func_60(iVar0, 1, 0))
			{
				Global_1901328.f_94 = 1;
				return func_669(func_668(iParam0), iParam0);
			}
			else if (iParam0 == func_296(func_670(iParam0), 5))
			{
				if (!func_48(39))
				{
					return false;
			...
			else if (iParam0 == func_296(func_671(iParam0), 5))
			{
				if (!func_48(49))
				{
					return false;
			...
			else if (func_672(iParam0))
			{
				...
				{
					return func_674(func_673(iParam0), 5, 0);
				}
			}
			else if (func_675(iParam0))
			{
				if (func_60(joaat("DOCUMENT_RARE_ORCHID_ORDER_1"), 1, 0))
				{
					if (!func_48(48))
					{
						return false;
...
int func_609(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	struct<11> /*88*/ sVar0;
	int iVar17;
	struct<11> /*88*/ sVar18;
...
bool func_622(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
...
struct<4> /*32*/ func_627(int iParam0, int iParam1)
{
	char cVar0[32];
...
char* func_628(var uParam0, var uParam1, var uParam2, var uParam3)
{
...
bool func_634(int iParam0, int iParam1, int iParam2, var uParam3)
{
	bool bVar0;
	struct<4> /*32*/ sVar1;
	int iVar5;
...
void func_638(int iParam0)
{
	...
	while (iVar0 < Global_1946054.f_2657.f_19)
	{
		...
		{
			func_692(&(Global_1946054.f_2657.f_26.f_26), iVar2, iVar0);
		}
		if (func_693(iVar2, 0))
		{
			func_694(iVar2, Global_1946054.f_1497.f_1[iVar1 /*3*/] == Global_1946054.f_2657[iVar0]);
		}
		iVar0++;
	}
}

void func_639(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	bool bVar1;
	...
	{
		case joaat("CI_CATEGORY_WARDROBE_HAT"):
			bVar1 = func_696(iParam0, &(Global_1946054.f_2657.f_21), Global_1946054.f_2657.f_26.f_1, bParam1);
			break;
		case joaat("CI_CATEGORY_WARDROBE_MASK"):
			bVar1 = func_696(iParam0, &(Global_1946054.f_2657.f_23), 1, bParam1);
			break;
		case joaat("CI_CATEGORY_WARDROBE_OUTFIT"):
			bVar1 = func_696(iParam0, &(Global_1946054.f_2657.f_20), Global_1946054.f_2657.f_26, bParam1);
			break;
		case joaat("CI_CATEGORY_WARDROBE_BIG_MASK"):
			bVar1 = func_696(iParam0, &(Global_1946054.f_2657.f_22), Global_1946054.f_2657.f_26.f_2, bParam1);
			break;
		case joaat("CI_CATEGORY_WARDROBE_GLOVES"):
			bVar1 = func_696(iParam0, &(Global_1946054.f_2657.f_24), 1, bParam1);
			break;
		case joaat("CI_CATEGORY_WARDROBE_BADGE"):
			bVar1 = func_696(iParam0, &(Global_1946054.f_2657.f_24), 1, bParam1);
			break;
	...
	if (iParam0 == func_697(0))
	{
		...
		if (func_326() == joaat("MPC_PLAYER_TYPE_SP_MARSTON"))
		{
			func_698(func_697(joaat("MPC_PLAYER_TYPE_SP_ARTHUR")), 0);
		}
		else
		{
			func_698(func_697(joaat("MPC_PLAYER_TYPE_SP_MARSTON")), 0);
		}
	}
	func_699();
	if (func_700(iVar0))
...
void func_644(int iParam0, int iParam1)
{
	...
	if (iParam1 < 1 || iParam1 > func_559(iVar0, iVar1))
	{
		return;
	}
...
bool func_648(int iParam0)
{
	...
	if (iVar5 < 1 || iVar5 > func_559(iVar4, iVar3))
	{
		return false;
	}
	return true;
...
bool func_669(int iParam0, int iParam1)
{
	...
	if (iVar0 == 5)
	{
		if (func_674(iParam0, 5, 0) & func_674(iParam0, 6, 0) & func_674(iParam0, 7, 0) & func_674(iParam0, 8, 0) & func_674(iParam0, 9, 0))
		{
	...
	{
		if (func_674(iParam0, 5, 0) & func_674(iParam0, 6, 0) & func_674(iParam0, 7, 0) & func_674(iParam0, 8, 0))
		{
			return func_110(iParam1, (1 << 23));
		}
	}
	...
	{
		if (func_674(iParam0, 5, 0) & func_674(iParam0, 6, 0) & func_674(iParam0, 7, 0))
		{
			return func_110(iParam1, (1 << 23));
		}
	}
	...
	{
		if (func_674(iParam0, 5, 0) & func_674(iParam0, 6, 0))
		{
			return func_110(iParam1, (1 << 23));
		}
	}
...
int func_674(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((((((((((((((((((((iVar0 == joaat("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT") || iVar0 == joaat("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT")) || iVar0 == joaat("PROVISION_ANIMAL_CARCASS_RAT_PERFECT")) || iVar0 == joaat("PROVISION_ANIMAL_CARCASS_WOODPECKER_PERFECT")) || iVar0 == joaat("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT")) || iVar0 == joaat("PROVISION_ANIMAL_CARCASS_ORIOLE_PERFECT")) || iVar0 == joaat("PROVISION_ANIMAL_CARCASS_ROBIN_PERFECT")) || iVar0 == joaat("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT")) || iVar0 == joaat("PROVISION_ANIMAL_CARCASS_SPARROW_PERFECT")) || iVar0 == joaat("PROVISION_ANIMAL_CARCASS_TOAD_PERFECT")) || iVar0 == joaat("PROVISION_ANIMAL_CARCASS_CROW_PERFECT")) || iVar0 == joaat("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT")) || iVar0 == joaat("PROVISION_ANIMAL_CARCASS_BAT_PERFECT")) || iVar0 == joaat("PROVISION_ANIMAL_CARCASS_BLUEJAY_PERFECT")) || iVar0 == joaat("PROVISION_ANIMAL_CARCASS_BULLFROG_PERFECT")) || iVar0 == joaat("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY")) || iVar0 == joaat("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY")) || iVar0 == joaat("PROVISION_FISH_PERCH_LEGENDARY")) || iVar0 == joaat("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY")) || iVar0 == joaat("PROVISION_FISH_ROCK_BASS_LEGENDARY")) || iVar0 == joaat("PROVISION_FISH_BLUEGILL_LEGENDARY"))
	{
		if (func_60(iVar0, 1, 0))
		{
			...
			{
				Global_1901328.f_94 = 1;
				func_716(iVar0, 1, 0, joaat("REMOVE_REASON_DEFAULT"), 0);
			}
			return 1;
		}
	}
...
void func_690(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case joaat("CI_CATEGORY_WARDROBE_HAT"):
			bVar0 = func_720(iParam0, &(Global_1946054.f_2657.f_21));
			break;
		case joaat("CI_CATEGORY_WARDROBE_MASK"):
			bVar0 = func_720(iParam0, &(Global_1946054.f_2657.f_23));
			break;
		case joaat("CI_CATEGORY_WARDROBE_OUTFIT"):
			bVar0 = func_720(iParam0, &(Global_1946054.f_2657.f_20));
			break;
		case joaat("CI_CATEGORY_WARDROBE_BIG_MASK"):
			bVar0 = func_720(iParam0, &(Global_1946054.f_2657.f_22));
			break;
		case joaat("CI_CATEGORY_WARDROBE_GLOVES"):
			bVar0 = func_720(iParam0, &(Global_1946054.f_2657.f_24));
			break;
		case joaat("CI_CATEGORY_WARDROBE_BADGE"):
			bVar0 = func_720(iParam0, &(Global_1946054.f_2657.f_25));
			break;
	}
	if (!bVar0)
	{
...
int func_696(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	{
		func_692(&(Global_1946054.f_2657.f_26.f_26), iParam0, Global_1946054.f_2657.f_19);
	}
		...
		if (ITEMSET::IS_ITEMSET_VALID(iVar14))
		{
			...
			while (iVar16 < iVar15)
			{
				...
				else
				{
					...
					func_688(iVar24, &uVar18, &uVar19, &iVar17, &uVar20);
					if (func_689(&iVar13, iVar24, iVar17, uVar18))
					{
						if (iVar13 == iParam0)
						{
							if (bParam1)
...
int func_720(int iParam0, var uParam1)
{
	...
	*uParam1--;
	...
	if (func_113(iParam0) != joaat("CI_CATEGORY_WARDROBE_OUTFIT"))
	{
		func_735(&(Global_1946054.f_2657.f_26), iVar0, Global_1946054.f_2657.f_19);
	}
	func_693(iParam0, 1);
	return 1;
}
...
void func_722(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (iParam2 == -1)
	{
		uParam0->f_1 = func_305(func_429(iParam1), 1);
		if (uParam0->f_1 == -1)
		{
		}
	}
...
bool func_727(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	while (iVar39 < iVar19)
	{
		...
		{
			if (!func_315(&sVar20, iVar39, iVar18, iVar19))
			{
			}
			else
			{
				...
				sVar34 = { sVar20.f_5 /*4*/ };
				if (func_258(iParam0, &sVar20, &sVar34, 1, iParam3, 0, 0))
				{
					iVar40++;
				}
			}
...
bool func_728(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	sVar5 = { func_257(iParam0, sVar0, sVar0.f_4, bParam4) /*4*/ };
	return func_258(iParam0, &sVar5, &sVar0, iParam1, iParam2, bParam3, bParam4);
}
...
int func_731(int iParam0)
{
	...
	func_688(iVar0, &uVar2, &uVar3, &iVar1, &uVar4);
	if (func_689(&uVar5, iVar0, iVar1, uVar2))
	{
	}
	return uVar5;
}
...
int func_732(int iParam0, bool bParam1)
{
	...
	iVar35 = func_740(0);
	if (ENTITY::DOES_ENTITY_EXIST(iVar35) && func_741(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iVar35), &sVar3, &iVar0, &iVar1))
	{
		iVar2 = 0;
		iVar2 = 0;
		while (iVar2 < iVar1)
		{
			if (func_315(&sVar21, iVar2, iVar0, iVar1))
			{
				if (iParam0 == sVar21.f_4)
				{
					...
					{
						iVar36 = 1;
						func_742(&iVar35, iParam0, &iVar36, 1, joaat("REMOVE_REASON_DEFAULT"));
					}
					func_9(iVar0);
					return 1;
				}
...
void func_749(var uParam0, var uParam1, int iParam2)
{
	int iVar0;

	iVar0 = func_758(func_326());
	if (*uParam0)
	{
		func_748(uParam0);
	}
	uParam0->f_1 = PED::_REQUEST_METAPED_COMPONENT(iVar0, uParam1, 0, func_116() != -1, iParam2);
	*uParam0 = 1;
}
...
int func_753(int iParam0, int iParam1)
{
	...
	sVar0 = { func_759(iParam0, iParam1) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&sVar0))
	{
		return 0;
	}
...
struct<4> /*32*/ func_759(int iParam0, int iParam1)
{
	struct<5> /*40*/ sVar0;

	sVar0 = { func_768(iParam0) /*5*/ };
	return func_769(iParam0, iParam1, sVar0, sVar0.f_4);
}
...
struct<5> /*40*/ func_768(int iParam0)
{
	struct<5> /*40*/ sVar0;

	sVar0 = { func_769(iParam0, joaat("CHARACTER"), func_535(), joaat("SLOTID_NONE")) /*4*/ };
	sVar0.f_4 = joaat("SLOTID_SATCHEL");
	return sVar0;
}

struct<4> /*32*/ func_769(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> /*32*/ sVar0;
...
int func_774(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	sVar0 = { func_768(iParam0) /*5*/ };
	sVar5 = { func_769(iParam0, iParam1, sVar0, sVar0.f_4) /*4*/ };
	return func_781(iParam0, iParam1, &sVar5, iParam2, iParam3, bParam4);
}
...
int func_781(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	sVar0.f_9 = joaat("SLOTID_NONE");
	if (!func_783(iParam0, *uParam2, &sVar0, 0))
	{
		return 0;
	}
	if (iParam3 < 0)
