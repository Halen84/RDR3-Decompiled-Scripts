...
bool func_7(var uParam0)
{
	...
	{
		if (TASK::GET_ITEM_INTERACTION_STATE(Global_35) != -372193721)
		{
	...
	switch (iVar0)
	{
		...
		case 3:
			if (uParam0->f_7 == 1)
			{
				if (TASK::GET_ITEM_INTERACTION_STATE(Global_35) == 336776976)
				{
					TASK::_0xB35370D5353995CB(Global_35, -975912680, 0.0f);
					uParam0->f_7 = 0;
					func_11(uParam0);
					func_32(&(uParam0->f_8));
					func_20(uParam0, 12);
					...
					if (uParam0->f_32.f_87 != -1)
					{
						...
						if (func_33(uParam0->f_4))
						{
							if (func_35(uParam0->f_4, 1))
							{
								...
								uParam0->f_32.f_87 = -1;
								TASK::_0xB35370D5353995CB(Global_35, 606465748, 0.0f);
								func_38(0, uParam0);
								func_34(0, uParam0);
								func_20(uParam0, 14);
								return true;
					...
					else if (uParam0->f_32.f_88 > 0)
					{
						...
						if (func_33(uParam0->f_4))
						{
							if (func_35(uParam0->f_4, 1))
							{
								...
								func_38(0, uParam0);
								func_34(0, uParam0);
								TASK::_0xB35370D5353995CB(Global_35, 1941986386, 0.0f);
								func_20(uParam0, 13);
								return true;
							}
						}
		...
		case 12:
			...
			else if (func_43(&(uParam0->f_8)) > 10.0f || iVar8 == 336776976)
			{
				if (iVar8 != 336776976)
				{
...
void func_36(var uParam0)
{
	if (!func_33(uParam0->f_6))
	{
		uParam0->f_6 = func_78("VI_READ", joaat("INPUT_GAME_MENU_OPTION"), Global_35, 2, 0, 0, 1, 0, 1070386381, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
...
int func_73(int iParam0)
{
	if (iParam0 == 0)
	{
		return joaat("JOURNAL_CHAPTER0");
	}
	else if (iParam0 == 1)
	{
		return joaat("JOURNAL_CHAPTER1");
	}
	else if (iParam0 == 2)
	{
		return joaat("JOURNAL_CHAPTER2");
	}
	else if (iParam0 == 3)
	{
		return joaat("JOURNAL_CHAPTER3");
	}
	else if (iParam0 == 4)
	{
		return joaat("JOURNAL_CHAPTER4");
	}
	else if (iParam0 == 5)
	{
		return joaat("JOURNAL_CHAPTER5");
	}
	else if (iParam0 == 6)
	{
		...
		{
			return joaat("JOURNAL_CHAPTER6");
		}
	}
	else if (iParam0 == 7)
	{
		return joaat("JOURNAL_CHAPTER7");
	}
	return joaat("JOURNAL_CHAPTER0");
}
...
int func_78(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_115(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_116(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_84(int iParam0, var uParam1)
{
	...
	if (!func_33(uParam1->f_4))
	{
		...
		uParam1->f_5 = iParam0;
		uParam1->f_4 = func_78(sVar0, joaat("INPUT_GAME_MENU_EXTRA_OPTION"), Global_35, 2, 0, 0, 1, 0, 1070386381, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
