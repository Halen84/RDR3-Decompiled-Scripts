...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, 0.0f, 1103626240);
	func_151(uParam0, 0.0202455f, 1.08015f, 0.533295f, 0.0f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	iLocal_14 = func_152(uParam0, 19, 0);
	func_153(uParam0, joaat("P_MUGCOFFEE01X"), 0.0f, 0.0f, 0.0f, "MUG", 0, 0, 1);
	...
	sLocal_23 = { func_160(uParam0, 0.0202f, 1.0802f, 1.0f, 180.0f, 5.0f, 0.4f, 0.4f) /*10*/ };
	sLocal_33 = { func_160(uParam0, 0.0202f, 1.0802f, 1.0f, -108.15f, 5.0f, 0.2f, 0.4f) /*10*/ };
	sLocal_43 = { func_160(uParam0, 0.0202f, 1.0802f, 1.0f, 108.15f, 5.0f, 0.4f, 0.2f) /*10*/ };
...
{
	if (func_192(Global_35, uParam0->f_23, 1) < 4.0f)
	{
	}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_193(uParam0, sLocal_33, 1, 0))
		{
