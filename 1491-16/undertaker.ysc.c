...
bool func_41()
{
	...
	iVar0 = func_72(&uLocal_72, &uLocal_84, 10, Global_1425351[iLocal_86 /*3*/], 15.0f, 0, 0, 0, -1, 0, 0, -1082130432, 0, 0);
	if (iVar0 <= 0)
	{
		return false;
	}
...
int func_122(bool bParam0, var uParam1)
{
	...
	{
		return func_176(bParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
{
	if (-1829635046 == func_179(joaat("CI_CATEGORY_WARDROBE_MASK")))
	{
		if (func_131(bParam0))
		{
			return true;
