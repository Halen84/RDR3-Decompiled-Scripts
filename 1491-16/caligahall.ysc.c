...
void func_54(int iParam0, int iParam1, var uParam2)
{
	...
	if ((func_90() || func_57(Global_1935630, (1 << 11))) || CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_55(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_106(iVar0) && func_107(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_145(int iParam0)
{
	...
	func_184(iParam0, (1 << 13));
	func_184(iParam0, (1 << 14));
	func_184(iParam0, (1 << 15));
	func_184(iParam0, (1 << 17));
	func_184(iParam0, (1 << 24));
	func_184(iParam0, (1 << 19));
	func_184(iParam0, (1 << 20));
...
bool func_157(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_195(&(Global_1109000.f_4), iVar0, 5);
	}
	if (iParam1 == func_196())
	{
		return func_195(&(Global_1109000.f_4), iVar0, 5);
	...
	{
		return func_195(&(Global_1108108[iParam1 /*27*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_164(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((Global_1898164.f_163 && !func_204(iParam0, 1)) || func_132((1 << 15)))
	{
		if (!func_204(iParam0, (1 << 18)) || !Global_1905944.f_5696)
		{
			return false;
		}
	}
...
bool func_203(int iParam0)
{
	...
	if (!func_204(iParam0, (1 << 16)) && !func_204(iParam0, (1 << 15)))
	{
		return false;
	}
	iVar0 = 0;
	while (iVar0 < Global_40.f_7756)
	{
		if (Global_40.f_7756[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			if (iVar2 < 1800 && func_204(iParam0, (1 << 15)))
			{
				return true;
			}
		}
...
bool func_208(Vector3 vParam0, int iParam3)
{
	...
	func_222(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_223(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
