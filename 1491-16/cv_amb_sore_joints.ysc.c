...
bool func_72(var uParam0)
{
	...
	switch (func_19(uParam0))
	{
		case 19:
			...
			func_155(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_D", -1, 0, 25.0f, 1065353216, 1);
			break;
		case 18:
			iLocal_14 = func_153(uParam0, 17, "Ped");
			iLocal_16 = func_154(uParam0, iLocal_15, "PL_MALE_ACTION", 1);
			func_155(uParam0, iLocal_14, 2, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_I", -1, 0, 25.0f, 1065353216, 1);
