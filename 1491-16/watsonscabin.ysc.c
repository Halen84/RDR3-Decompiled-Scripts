				...
				case 6:
					if (func_7(func_6(iLocal_19)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_19 /*35*/].f_11 > 0.0f)
							{
...
bool func_11()
{
	...
	iLocal_14 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-1816.485f, 658.493f, 131.7874f, 0.0f, 0.0f, 0.0f, 8.0f, 8.0f, 5.0f, "Watson's Cabin - m_volWatsCats");
...
void func_25()
{
	if (func_50(7, (1 << 22)) || func_50(7, (1 << 11)))
	{
	...
	if (func_50(7, (1 << 11)))
	{
		func_51(joaat("WS_WATSON_GRAVE"), 1, 0);
	}
	else
	{
		func_51(joaat("WS_WATSON_GRAVE"), 0, 0);
	}
	func_52(7);
	func_53(7, 1);
}
...
void func_39(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0.0f, 0.0f, 0.0f) <= 5.0f || func_57(Global_1935630, (1 << 14))) || func_57(Global_1935630, (1 << 23)))
	{
		return;
	}
...
void func_51(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case joaat("WS_DOWNS_RANCH_DOWNS"):
			func_88(joaat("WS_DOWNS_RANCH_DOWNS"));
			func_89(joaat("WS_DOWNS_RANCH_EDITH"));
			func_89(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_89(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_DOWNS_RANCH_EDITH"):
			func_89(joaat("WS_DOWNS_RANCH_DOWNS"));
			func_88(joaat("WS_DOWNS_RANCH_EDITH"));
			func_89(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_89(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_DOWNS_RANCH_EMPTY"):
			func_89(joaat("WS_DOWNS_RANCH_DOWNS"));
			func_89(joaat("WS_DOWNS_RANCH_EDITH"));
			func_88(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_89(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_DOWNS_RANCH_REPOPULATED"):
			...
			func_89(joaat("WS_DOWNS_RANCH_EDITH"));
			func_89(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_88(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_PRONGHORN_RANCH_FENCE_FIXED"):
		case joaat("WS_PRONGHORN_RANCH_EXIST"):
		case joaat("WS_PRONGHORN_RANCH_EMPTY"):
			func_89(joaat("WS_PRONGHORN_RANCH_EXIST"));
			func_89(joaat("WS_PRONGHORN_RANCH_EMPTY"));
			func_89(joaat("WS_PRONGHORN_RANCH_FENCE_FIXED"));
			func_88(iParam0);
			break;
		...
		case joaat("WS_GUARMA3_TOWER_NORMAL"):
			func_89(joaat("WS_GUARMA3_TOWER_FRAG"));
			func_89(joaat("WS_GUARMA3_TOWER_DESTROYED"));
			func_88(joaat("WS_GUARMA3_TOWER_NORMAL"));
			break;
		case joaat("WS_GUARMA3_TOWER_FRAG"):
			func_89(joaat("WS_GUARMA3_TOWER_NORMAL"));
			func_89(joaat("WS_GUARMA3_TOWER_DESTROYED"));
			func_88(joaat("WS_GUARMA3_TOWER_FRAG"));
			break;
		case joaat("WS_GUARMA3_TOWER_DESTROYED"):
			func_89(joaat("WS_GUARMA3_TOWER_NORMAL"));
			func_89(joaat("WS_GUARMA3_TOWER_FRAG"));
			func_88(joaat("WS_GUARMA3_TOWER_DESTROYED"));
			break;
		case joaat("WS_RHODES_GRAVE_NORMAL"):
			func_89(joaat("WS_RHODES_GRAVE_FRESHLY_DUG"));
			func_89(joaat("WS_RHODES_GRAVE_OPEN"));
			func_88(joaat("WS_RHODES_GRAVE_NORMAL"));
			break;
		case joaat("WS_RHODES_GRAVE_FRESHLY_DUG"):
			func_89(joaat("WS_RHODES_GRAVE_NORMAL"));
			func_89(joaat("WS_RHODES_GRAVE_OPEN"));
			func_88(joaat("WS_RHODES_GRAVE_FRESHLY_DUG"));
			break;
		case joaat("WS_RHODES_GRAVE_OPEN"):
			func_89(joaat("WS_RHODES_GRAVE_NORMAL"));
			func_89(joaat("WS_RHODES_GRAVE_FRESHLY_DUG"));
			func_88(joaat("WS_RHODES_GRAVE_OPEN"));
			break;
		case joaat("WS_RHODES_SALOON_TABLE_UP"):
			func_89(joaat("WS_RHODES_SALOON_TABLE_DOWN"));
			func_88(joaat("WS_RHODES_SALOON_TABLE_UP"));
			break;
		case joaat("WS_RHODES_SALOON_TABLE_DOWN"):
			func_89(joaat("WS_RHODES_SALOON_TABLE_UP"));
			func_88(joaat("WS_RHODES_SALOON_TABLE_DOWN"));
			break;
		case joaat("WS_UTOPIA_TREE_STANDING"):
			func_89(joaat("WS_UTOPIA_TREE_MISSION"));
			func_89(joaat("WS_UTOPIA_TREE_FALLEN"));
			func_89(joaat("WS_UTOPIA_TREE_STUMP"));
			func_88(joaat("WS_UTOPIA_TREE_STANDING"));
			break;
		case joaat("WS_UTOPIA_TREE_MISSION"):
			func_89(joaat("WS_UTOPIA_TREE_STANDING"));
			func_89(joaat("WS_UTOPIA_TREE_FALLEN"));
			func_89(joaat("WS_UTOPIA_TREE_STUMP"));
			func_88(joaat("WS_UTOPIA_TREE_MISSION"));
			break;
		case joaat("WS_UTOPIA_TREE_FALLEN"):
			func_89(joaat("WS_UTOPIA_TREE_STANDING"));
			func_89(joaat("WS_UTOPIA_TREE_MISSION"));
			func_89(joaat("WS_UTOPIA_TREE_STUMP"));
			func_88(joaat("WS_UTOPIA_TREE_FALLEN"));
			break;
		case joaat("WS_UTOPIA_TREE_STUMP"):
			func_89(joaat("WS_UTOPIA_TREE_STANDING"));
			func_89(joaat("WS_UTOPIA_TREE_MISSION"));
			func_89(joaat("WS_UTOPIA_TREE_FALLEN"));
			func_88(joaat("WS_UTOPIA_TREE_STUMP"));
			break;
		case joaat("WS_MICAH_CAMP_EMPTY"):
			func_89(joaat("WS_MICAH_CAMP"));
			func_89(joaat("WS_MICAH_CAMP_POST"));
			func_88(joaat("WS_MICAH_CAMP_EMPTY"));
			break;
		case joaat("WS_MICAH_CAMP"):
			func_89(joaat("WS_MICAH_CAMP_EMPTY"));
			func_89(joaat("WS_MICAH_CAMP_POST"));
			func_88(joaat("WS_MICAH_CAMP"));
			break;
		case joaat("WS_MICAH_CAMP_POST"):
			func_89(joaat("WS_MICAH_CAMP_EMPTY"));
			func_89(joaat("WS_MICAH_CAMP"));
			func_88(joaat("WS_MICAH_CAMP_POST"));
			break;
		case joaat("WS_NBX_ART_EXHIBIT_OPEN"):
			if (bParam1)
			{
				func_89(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
				func_88(joaat("WS_NBX_ART_EXHIBIT_OPEN"));
			}
			else
			{
				func_89(joaat("WS_NBX_ART_EXHIBIT_OPEN"));
				func_89(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
			}
			break;
		case joaat("WS_NBX_ART_EXHIBIT_CANCELLED"):
			if (func_92(joaat("WS_NBX_ART_EXHIBIT_OPEN")))
			{
				if (bParam1)
				{
					func_88(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
				}
				else
				{
					func_89(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
		...
		case joaat("WS_HERE_KITTY_3_CLUE_TRAIL_OFF"):
			func_89(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_ON"));
			func_88(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_OFF"));
			break;
		case joaat("WS_HERE_KITTY_3_CLUE_TRAIL_ON"):
			func_89(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_OFF"));
			func_88(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_ON"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_GONE"):
			func_89(joaat("WS_HERE_KITTY_WAGONS_TRASHED"));
			func_89(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_89(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_89(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_88(joaat("WS_HERE_KITTY_WAGONS_GONE"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_TRASHED"):
			func_89(joaat("WS_HERE_KITTY_WAGONS_GONE"));
			func_89(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_89(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_89(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_88(joaat("WS_HERE_KITTY_WAGONS_TRASHED"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"):
			...
			func_89(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_89(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_88(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"):
			...
			func_89(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_89(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_88(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"):
			...
			func_89(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_89(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_88(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			break;
		case joaat("WS_NEW_COM_BANK_BEFORE"):
			func_89(joaat("WS_NEW_COM_BANK_START"));
			func_89(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_89(joaat("WS_NEW_COM_BANK_AFTER"));
			func_89(joaat("WS_NEW_COM_BANK_POST"));
			func_88(joaat("WS_NEW_COM_BANK_BEFORE"));
			break;
		case joaat("WS_NEW_COM_BANK_START"):
			func_89(joaat("WS_NEW_COM_BANK_BEFORE"));
			func_89(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_89(joaat("WS_NEW_COM_BANK_AFTER"));
			func_89(joaat("WS_NEW_COM_BANK_POST"));
			func_88(joaat("WS_NEW_COM_BANK_START"));
			break;
		case joaat("WS_NEW_COM_BANK_SHOOTOUT"):
			...
			func_89(joaat("WS_NEW_COM_BANK_AFTER"));
			func_89(joaat("WS_NEW_COM_BANK_POST"));
			func_88(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			break;
		case joaat("WS_NEW_COM_BANK_AFTER"):
			...
			func_89(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_89(joaat("WS_NEW_COM_BANK_POST"));
			func_88(joaat("WS_NEW_COM_BANK_AFTER"));
			break;
		case joaat("WS_NEW_COM_BANK_POST"):
			...
			func_89(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_89(joaat("WS_NEW_COM_BANK_AFTER"));
			func_88(joaat("WS_NEW_COM_BANK_POST"));
			break;
		case joaat("WS_NO_ANIMALS_GRIZZLIES"):
			func_89(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			func_89(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			func_89(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			func_88(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			break;
		case joaat("WS_LIGHT_ANIMALS_GRIZZLIES"):
			func_89(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			func_89(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			func_89(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			func_88(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			break;
		case joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"):
			func_89(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			func_89(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			func_89(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			func_88(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			break;
		case joaat("WS_NORMAL_ANIMALS_GRIZZLIES"):
			func_89(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			func_89(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			func_89(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			func_88(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			break;
		case joaat("WS_STRAWBERRY_HOUSE_STAGE_0"):
			func_88(joaat("WS_STRAWBERRY_HOUSE_STAGE_0"));
			func_89(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_89(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_89(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			break;
		case joaat("WS_STRAWBERRY_HOUSE_STAGE_1"):
			func_89(joaat("WS_STRAWBERRY_HOUSE_STAGE_0"));
			func_88(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_89(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_89(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			break;
		case joaat("WS_STRAWBERRY_HOUSE_STAGE_2"):
			func_89(joaat("WS_STRAWBERRY_HOUSE_STAGE_0"));
			func_89(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_88(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_89(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			break;
		case joaat("WS_STRAWBERRY_HOUSE_STAGE_3"):
			...
			func_89(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_89(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_88(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			break;
		case joaat("WS_CALIGA_HALL_TABACCO_START"):
			func_88(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_89(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_89(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			func_89(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			break;
		case joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"):
			func_88(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_89(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_89(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			func_89(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			break;
		case joaat("WS_CALIGA_HALL_TABACCO_BURNING"):
			func_88(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			func_89(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_89(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_89(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			break;
		case joaat("WS_CALIGA_HALL_TABACCO_BURNT"):
			func_88(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			func_89(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_89(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_89(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			break;
		case joaat("WS_VALENTINE_BURIAL_DRUNK"):
			func_88(joaat("WS_VALENTINE_BURIAL_DRUNK"));
			func_89(joaat("WS_VALENTINE_BURIAL_POST_DRUNK"));
			break;
		case joaat("WS_VALENTINE_BURIAL_POST_DRUNK"):
			func_88(joaat("WS_VALENTINE_BURIAL_POST_DRUNK"));
			func_89(joaat("WS_VALENTINE_BURIAL_DRUNK"));
			break;
		case joaat("WS_VALENTINE_BURIAL_MURDER"):
			func_88(joaat("WS_VALENTINE_BURIAL_MURDER"));
			func_89(joaat("WS_VALENTINE_BURIAL_POST_MURDER"));
			break;
		case joaat("WS_VALENTINE_BURIAL_POST_MURDER"):
			func_88(joaat("WS_VALENTINE_BURIAL_POST_MURDER"));
			func_89(joaat("WS_VALENTINE_BURIAL_MURDER"));
			break;
		case 0:
			func_88(0);
			func_89(joaat("WS_BRAITHWAITE_MANSION_BURNED"));
			func_89(joaat("WS_BRAITHWAITE_MANSION_ENDLESS_SUMMER"));
			break;
		case joaat("WS_BRAITHWAITE_MANSION_BURNED"):
			func_88(joaat("WS_BRAITHWAITE_MANSION_BURNED"));
			func_89(0);
			func_89(joaat("WS_BRAITHWAITE_MANSION_ENDLESS_SUMMER"));
			break;
		case joaat("WS_BRAITHWAITE_MANSION_ENDLESS_SUMMER"):
			func_88(joaat("WS_BRAITHWAITE_MANSION_ENDLESS_SUMMER"));
			func_89(0);
			func_89(joaat("WS_BRAITHWAITE_MANSION_BURNED"));
			break;
		case joaat("WS_GRAVE_ARTHUR_GOOD"):
			func_88(joaat("WS_GRAVE_ARTHUR_GOOD"));
			func_89(joaat("WS_GRAVE_ARTHUR_BAD"));
			break;
		case joaat("WS_GRAVE_ARTHUR_BAD"):
			func_88(joaat("WS_GRAVE_ARTHUR_BAD"));
			func_89(joaat("WS_GRAVE_ARTHUR_GOOD"));
			break;
		case joaat("WS_OLDFORTWALLACE_WALL_INTACT"):
			func_88(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			func_89(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_89(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_89(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			break;
		case joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"):
			func_88(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_89(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			func_89(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_89(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			break;
		case joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"):
			func_88(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_89(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_89(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			func_89(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			break;
		case joaat("WS_OLDFORTWALLACE_WALL_BROKEN"):
			func_88(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			func_89(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_89(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_89(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			break;
		case joaat("WS_SHADY_BELLE_HIDEOUT"):
			if (bParam1)
			{
				func_88(joaat("WS_SHADY_BELLE_HIDEOUT"));
			}
			else
			{
				func_89(joaat("WS_SHADY_BELLE_HIDEOUT"));
			}
			func_89(joaat("WS_SHADY_BELLE_GANG_0_2"));
			func_89(joaat("WS_SHADY_BELLE_ABANDON"));
			break;
		case joaat("WS_SHADY_BELLE_ABANDON"):
			func_88(joaat("WS_SHADY_BELLE_ABANDON"));
			func_89(joaat("WS_SHADY_BELLE_GANG_0_2"));
			func_89(joaat("WS_SHADY_BELLE_HIDEOUT"));
			break;
		case joaat("WS_SHADY_BELLE_GANG_0_2"):
			func_88(joaat("WS_SHADY_BELLE_GANG_0_2"));
			func_89(joaat("WS_SHADY_BELLE_HIDEOUT"));
			func_89(joaat("WS_SHADY_BELLE_ABANDON"));
			break;
		case joaat("WS_BLACKWATER_PHOTOGRAPHER_FURNITURE"):
			if (bParam1)
			{
				func_88(joaat("WS_BLACKWATER_PHOTOGRAPHER_FURNITURE"));
			}
			else
			{
				func_89(joaat("WS_BLACKWATER_PHOTOGRAPHER_FURNITURE"));
			}
			break;
		case joaat("WS_SAINT_DENIS_PHOTOGRAPHER_FURNITURE"):
			if (bParam1)
			{
				func_88(joaat("WS_SAINT_DENIS_PHOTOGRAPHER_FURNITURE"));
			}
			else
			{
				func_89(joaat("WS_SAINT_DENIS_PHOTOGRAPHER_FURNITURE"));
			}
			break;
		default:
			if (bParam1)
...
bool func_59()
{
	return func_57(Global_1935630, (1 << 12));
}
...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_54(iParam0) && func_81(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_117(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_117(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_117(&cVar6, joaat("COLOR_PURE_WHITE")), func_117(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
void func_90()
{
	func_89(joaat("WS_COLTER_STAGE_WINTER1_INTRO"));
	func_89(joaat("WS_COLTER_STAGE_CABIN_BURNING"));
	func_89(joaat("WS_COLTER_STAGE_HIGH_SNOW"));
	func_89(joaat("WS_COLTER_STAGE_MEDIUM_SNOW"));
	func_89(joaat("WS_COLTER_STAGE_THAWED_SNOW"));
	func_89(joaat("WS_COLTER_STAGE_MUDTOWN1"));
	func_89(joaat("WS_COLTER_STAGE_MP"));
}

void func_91()
{
	func_89(joaat("WS_BEECHERS_SHACK"));
	func_89(joaat("WS_BEECHERS_SHACK_WITH_FIRE"));
	func_89(joaat("WS_BEECHERS_CAMP_WITH_SHACK"));
	func_89(joaat("WS_BEECHERS_CAMP_WITH_RUBBLE"));
	func_89(joaat("WS_BEECHERS_CAMP_WITH_SUPPLIES"));
	func_89(joaat("WS_BEECHERS_HOUSE_FINISHED"));
	func_89(joaat("WS_BEECHERS_BARN_FINISHED"));
	func_89(joaat("WS_BEECHERS_HOUSE_DECORATED"));
	func_89(joaat("WS_BEECHERS_HOUSE_ABIGAIL3"));
	func_89(joaat("WS_BEECHERS_HOUSE_FULLY_DECORATED"));
}
...
void func_94(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(joaat("LONNIES_BED_CASH_STASH"), bParam3);
...
char* func_117(char* sParam0, int iParam1)
{
	...
	return func_161(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

int func_118(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_122(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_132(int iParam0)
{
	...
	func_169(iParam0, (1 << 13));
	func_169(iParam0, (1 << 14));
	func_169(iParam0, (1 << 15));
	func_169(iParam0, (1 << 17));
	func_169(iParam0, (1 << 24));
	func_169(iParam0, (1 << 19));
...
bool func_155(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_184(iVar0) && func_189(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_172(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_199(iParam0, (1 << 10)))
		{
			func_200(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_199(iParam0, (1 << 10)))
	{
...
int func_180(struct<2> /*16*/ sParam0, var uParam2)
{
	int iVar0;
...
bool func_191(Vector3 vParam0, int iParam3)
{
	...
	func_209(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_210(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
