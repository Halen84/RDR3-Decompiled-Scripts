...
void func_39(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0.0f, 0.0f, 0.0f) <= 5.0f || func_53(Global_1935630, (1 << 14))) || func_53(Global_1935630, (1 << 23)))
	{
		return;
	}
...
void func_46()
{
	if (func_78(joaat("WS_THIEVES_LANDING_BOAT")))
	{
...
void func_60(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_51(iParam0) && func_77(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_100(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_100(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_100(&cVar6, joaat("COLOR_PURE_WHITE")), func_100(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
int func_101(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_105(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
