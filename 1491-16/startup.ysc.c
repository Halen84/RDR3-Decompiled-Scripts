	...
	switch (func_80())
	{
		...
		case joaat("FREEROAM"):
			...
			if (Global_1572887.f_182.f_3 != -1)
			{
				...
				return MISC::VAR_STRING(174762, "LAUNCH_PARAMS", &cVar0, &cVar8, &cVar100, &(sVar16[0 /*8*/]), &(sVar16[1 /*8*/]), &(sVar16[2 /*8*/]), &(sVar16[3 /*8*/]), &(sVar16[4 /*8*/]));
			}
			else if (Global_1572887.f_182.f_4 != -1)
			{
				strcpy_s(&cVar108, 64, "-district_id=");
				strcat_s(&cVar108, 64, func_266(Global_1572887.f_182.f_4));
				return MISC::VAR_STRING(174762, "LAUNCH_PARAMS", &cVar0, &cVar8, &cVar108, &(sVar16[0 /*8*/]), &(sVar16[1 /*8*/]), &(sVar16[2 /*8*/]), &(sVar16[3 /*8*/]), &(sVar16[4 /*8*/]));
			}
			else if (Global_1572887.f_182.f_5 != -1)
			{
				strcpy_s(&cVar116, 64, "-state_id=");
				strcat_s(&cVar116, 64, func_267(Global_1572887.f_182.f_5));
				return MISC::VAR_STRING(174762, "LAUNCH_PARAMS", &cVar0, &cVar8, &cVar116, &(sVar16[0 /*8*/]), &(sVar16[1 /*8*/]), &(sVar16[2 /*8*/]), &(sVar16[3 /*8*/]), &(sVar16[4 /*8*/]));
			}
			else
			{
				return MISC::VAR_STRING(43690, "LAUNCH_PARAMS", &cVar0, &cVar8, &(sVar16[0 /*8*/]), &(sVar16[1 /*8*/]), &(sVar16[2 /*8*/]), &(sVar16[3 /*8*/]), &(sVar16[4 /*8*/]));
			}
			break;
		case joaat("GOLDSTORE"):
...
void func_218()
{
	...
	{
		sVar0.f_3 = MISC::GET_HASH_KEY("IB_ACCEPT");
		sVar0.f_3.f_1 = 0;
		sVar0.f_3.f_2 = 0;
		sVar0.f_3.f_3 = 0;
		sVar0.f_7 = MISC::GET_HASH_KEY("IB_EXIT");
		sVar0.f_7.f_1 = 0;
		sVar0.f_7.f_2 = 0;
		sVar0.f_7.f_3 = 0;
	}
	...
	{
		sVar0.f_3 = MISC::GET_HASH_KEY("IB_EXIT");
		sVar0.f_3.f_1 = 0;
		sVar0.f_3.f_2 = 0;
		sVar0.f_3.f_3 = 0;
	}
...
void func_319(int iParam0)
{
	...
	sVar19.f_23 = "IB_GAMERCARD";
	sVar19.f_22 = 2;
	if (MISC::IS_STRING_NULL_OR_EMPTY(&(sVar0.f_12)))
	{
		sVar19.f_11 = MISC::VAR_STRING(42, "NT_INV_BODY_INFO", func_335(&(sVar0.f_2), joaat("COLOR_PURE_WHITE")), "LANDING_FREEROAM_TITLE");
		sVar19.f_25.f_3 = MISC::VAR_STRING(2, "NT_INV_FM_CONTENT");
		sVar19.f_25.f_4 = MISC::VAR_STRING(2, "NM_TI_VIEW_INVITE");
	}
	else if (func_48() != -1)
	{
		...
		if (iVar63 != -1)
		{
			...
			{
				sVar19.f_25.f_3 = MISC::VAR_STRING(2, "NT_INV_MP_PLAYER_JOIN");
				sVar19.f_25.f_4 = MISC::VAR_STRING(2, "NM_TI_VIEW_INVITE");
				sVar65 = MISC::VAR_STRING(2, func_398(Global_265073.f_4[iVar63 /*57*/].f_39));
			}
			else if (iVar64 == joaat("UGC_TYPE_DEATHMATCH"))
			{
				sVar19.f_25.f_3 = MISC::VAR_STRING(2, "NM_TI_VIEW_INVITE_DEATHMATCH");
				sVar19.f_25.f_4 = MISC::VAR_STRING(2, "NM_TI_VIEW_INVITE");
				sVar65 = MISC::VAR_STRING(2, func_399(Global_265073.f_4[iVar63 /*57*/].f_39));
			}
			else if (iVar64 == joaat("UGC_TYPE_RACE"))
			{
				sVar19.f_25.f_3 = MISC::VAR_STRING(2, "NM_TI_VIEW_INVITE_RACE");
				sVar19.f_25.f_4 = MISC::VAR_STRING(2, "NM_TI_VIEW_INVITE");
				sVar65 = MISC::VAR_STRING(2, func_400(Global_265073.f_4[iVar63 /*57*/].f_39));
			}
			sVar19.f_11 = MISC::VAR_STRING(10, "NT_INV_RCV_BODY_INFO", sVar65);
		}
	}
	else
	{
		sVar19.f_11 = MISC::VAR_STRING(42, "NT_INV_BODY_INFO", func_335(&(sVar0.f_2), joaat("COLOR_PURE_WHITE")), "PRES_SET_MODE_MP");
		sVar19.f_25.f_3 = MISC::VAR_STRING(2, "NT_INV_MP_PLAYER_JOIN");
		sVar19.f_25.f_4 = MISC::VAR_STRING(2, "NM_TI_VIEW_INVITE");
	}
...
void func_357(Vector3 vParam0)
{
	...
	func_428(vVar2, 0.0f, vParam0, 0.0f, -1082130432, -1082130432, 1, 1, 1, 1);
	func_429(0);
}
