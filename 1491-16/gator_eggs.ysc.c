...
void __SCRIPT()
{
	...
	iLocal_36 = func_4();
	vLocal_17 = { TASK::_GET_SCENARIO_POINT_COORDS(iLocal_20, true) /*3*/ };
...
void func_3(var uParam0)
{
	...
	while (iVar1 < func_9(iLocal_36, 16))
	{
		...
		{
			PLAYER::_UNREGISTER_EAGLE_EYE_FOR_ENTITY(PLAYER::PLAYER_ID(), uLocal_22[iVar1]);
...
int func_4()
{
	...
	return COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, 689918374, 0);
}
...
bool func_8(var uParam0)
{
	...
	{
		case 0:
			func_12(&(uParam0->f_2), vLocal_17, 2.0f, 1, -1, 0);
			func_13(uParam0);
			func_14(uParam0, 1);
			break;
		case 1:
		...
		case 2:
			...
			break;
		case 3:
			if (func_18(Global_35, vLocal_17, 0) < 25.0f)
			{
				func_14(uParam0, 4);
			}
			break;
		case 4:
			func_19();
			if (func_20(&uLocal_22, &iLocal_28, func_9(iLocal_36, 16), vLocal_17, 5.0f) > 0)
			{
				iVar0 = 0;
				while (iVar0 < func_9(iLocal_36, 16))
				{
					...
					{
						PLAYER::_REGISTER_EAGLE_EYE_FOR_ENTITY(PLAYER::PLAYER_ID(), uLocal_22[iVar0], false);
						PLAYER::_0x6ECFC621A168424C(uLocal_22[iVar0], uLocal_22[iVar0], 0, 0.0f);
					}
					iVar0++;
				}
			}
			...
			break;
		case 5:
			if (func_18(Global_35, vLocal_17, 0) < 10.0f)
			{
				func_14(uParam0, 6);
			}
			break;
		case 6:
			PAD::SET_CONTROL_SHAKE(0, 100, 250);
			func_14(uParam0, 7);
			break;
		case 7:
			if (func_18(Global_35, vLocal_17, 0) < 8.0f)
			{
				func_14(uParam0, 8);
			}
			break;
		case 8:
			...
			break;
		case 9:
			if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, joaat("ADDEGG")) && func_23(Global_35, vLocal_17, 1.5f, 1, 1))
			{
				func_14(uParam0, 10);
			}
			if (func_24())
		...
		case 10:
			...
			func_26(0, 10);
			func_27(iLocal_36);
			func_28(joaat("PROVISION_GATOR_EGG"), func_9(iLocal_36, 16), 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
			func_29(uParam0);
			func_14(uParam0, 14);
			break;
		case 11:
...
{
	TASK::_REQUEST_HERB_COMPOSITE_ASSET(iLocal_35);
}
...
{
	if (TASK::ARE_COMPOSITE_LOOTABLE_ENTITY_DEF_ASSETS_LOADED(iLocal_35))
	{
		return true;
	}
	return false;
...
bool func_17(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
	{
		if (bLocal_37)
		{
			iLocal_34 = TASK::_CREATE_HERB_COMPOSITES(iLocal_35, vLocal_17, 0.0f, 0, &uVar0, -1);
		}
		else
		{
			iLocal_34 = TASK::_CREATE_HERB_COMPOSITES(iLocal_35, vLocal_17, 0.0f, 1, &uVar0, -1);
		}
		return true;
	}
	return false;
...
bool func_24()
{
	...
	while (iVar0 < func_9(iLocal_36, 16))
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_22[iVar0]))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_22[iVar0], Global_35, true, true))
			{
				if (func_33(256, 0))
				{
...
int func_28(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (func_55(iParam0, 0, 0) == 0)
	{
		if (func_56(iParam0))
		{
			...
			{
				func_28(func_64(iVar6), 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
			...
			if (func_48() && func_65(4))
			{
				if (!Global_1914319.f_17376)
				{
					if (func_48() && (func_66(38) || func_61(38)))
					{
						func_70(38, COLLECTION::_COLLECTABLE_CATEGORY_GET_TOAST_TEXTURE_DICTIONARY(joaat("CIGARETTE_CARDS"), iVar6), COLLECTION::_COLLECTABLE_CATEGORY_GET_TOAST_TEXTURE_NAME(joaat("CIGARETTE_CARDS"), iVar6), iVar7, 12, 0, iVar6);
					}
					else
					{
	...
	{
		if ((!func_72(iParam0, joaat("CI_TAG_ITEM_TALISMAN")) && !func_72(iParam0, joaat("CI_TAG_ITEM_UPGRADE"))) && !func_72(iParam0, joaat("CI_TAG_ITEM_IS_SATCHEL")))
		{
			bVar3 = true;
		}
	}
	if (func_73(iParam0, (1 << 23)) && !func_74(28))
	{
		func_75(28);
	}
	if (!bVar3)
	{
		if (func_72(iParam0, joaat("CI_TAG_ITEM_THROWN")))
		{
			bParam2 = true;
			bVar4 = true;
			if (func_76(iParam0) == joaat("CI_CATEGORY_AMMO"))
			{
		...
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_TALISMAN")))
		{
			func_86(iParam0);
		}
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_TRINKET")))
		{
			func_87(iParam0);
		}
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_ANIMAL_CLAW")))
		{
		...
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_VALUABLE")) && !func_72(iParam0, joaat("CI_TAG_ITEM_COLLECTIBLE")))
		{
			...
			if (func_72(iParam0, joaat("CI_TAG_ITEM_TALISMAN_INGREDIENT")) || func_72(iParam0, joaat("CI_TAG_ITEM_TRINKET_INGREDIENT")))
			{
				func_92(iParam0);
			}
		}
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_CANNED")))
		{
			if (func_72(iParam0, joaat("CI_TAG_ITEM_FRUIT")))
			{
			}
		}
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_USED")) && func_72(iParam0, joaat("CI_TAG_ITEM_CONSUMABLE")))
		{
			func_62(484, 0);
		}
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_CONSUMABLE")) && func_72(iParam0, joaat("CI_TAG_ITEM_SNACK")))
		{
		}
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_CONFECTIONARY")))
		{
		}
		else if (func_72(iParam0, 589988438))
		{
			if (func_93())
			{
				func_94(joaat("REWARD_SMALL"), 0, 1065353216, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_LETTER_INVITATION")) && func_72(iParam0, joaat("CI_TAG_ITEM_DOCUMENT")))
		{
			func_95(iParam0);
		}
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_DINO_BONES")))
		{
			func_96(iParam0);
		}
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_ROCK_CARVINGS")))
		{
			func_97(iParam0);
		}
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_TAXIDERMY")) && func_72(iParam0, joaat("CI_TAG_ITEM_DOCUMENT")))
		{
			func_98(iParam0);
		}
		...
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_TREASURE_HUNTER_MAP")))
		{
			func_99();
		}
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_COLLECTIBLE")))
		{
			func_100(iParam0, iParam1);
			func_101(iParam0);
		}
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_TAXIDERMY")) && func_72(iParam0, joaat("CI_TAG_ITEM_MATERIAL")))
		{
			func_102(iParam0, 0, 0, 0);
		}
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_TALISMAN_INGREDIENT")) || func_72(iParam0, joaat("CI_TAG_ITEM_TRINKET_INGREDIENT")))
		{
			func_92(iParam0);
		}
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_MONEY")))
		{
			if (func_1() != -1)
			{
				return 0;
		...
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_FISHING_LURE")))
		{
			switch (iParam0)
			{
		...
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_MEAT_FISH")) && func_73(iParam0, 4))
		{
			if (!func_61(42))
			{
				func_105(iParam0);
		...
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_AMMOBOX")))
		{
			func_106(iParam0, &iVar2);
			bParam2 = true;
			bVar4 = true;
		}
		else if (func_72(iParam0, joaat("CI_TAG_ITEM_IS_SATCHEL")))
		{
			iVar8 = 0;
			switch (iParam0)
			{
			...
			if (iVar8 != 0)
			{
				func_28(iVar8, 1, 1, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
			}
		}
		switch (iParam0)
		{
			...
			case joaat("UPGRADE_OFFHAND_HOLSTER"):
				...
				if (func_108(&iVar9, 0))
				{
					func_81(iVar9, 0, 0, bParam4, 3, 0, joaat("ADD_REASON_DEFAULT"), 0);
				}
				break;
			...
			case joaat("CONSUMABLE_MOONSHINE"):
				...
				{
					func_124(594, joaat("TF_FORTIFY_TANK1"), 1, 1);
			...
			case joaat("CONSUMABLE_RESTORATIVE"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_124(594, joaat("TF_FORTIFY_TANK2"), 1, 1);
					Global_1935689.f_9447 = MISC::GET_GAME_TIMER();
				}
				break;
			...
			case joaat("CONSUMABLE_CHEWING_TOBACCO_USED"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_124(594, joaat("TF_FORTIFY_TANK3"), 1, 1);
					Global_1935689.f_9447 = MISC::GET_GAME_TIMER();
				}
				break;
			...
			case joaat("CONSUMABLE_POTENT_TONIC"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_124(594, joaat("TF_FORTIFY_TANK4"), 1, 1);
					Global_1935689.f_9447 = MISC::GET_GAME_TIMER();
				}
				break;
			...
			case joaat("CONSUMABLE_MEAL_ROAST_BEEF"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_124(595, joaat("TF_FORTIFY_CORE1"), 1, 1);
					Global_1935689.f_9447 = MISC::GET_GAME_TIMER();
				}
				break;
			...
			case joaat("CONSUMABLE_MEAL_BEEF_STEW_PEARSON_REGIONAL_EGGS"):
				if (MISC::GET_GAME_TIMER() >= (Global_1935689.f_9447 + 60000))
				{
					func_124(595, joaat("TF_FORTIFY_CORE2"), 1, 1);
					Global_1935689.f_9447 = MISC::GET_GAME_TIMER();
				}
				break;
			...
			case joaat("CONSUMABLE_CIGARETTE_BOX"):
				...
				{
					func_28(func_125(), 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
				}
				else
				{
					func_28(func_126(), 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
				}
				break;
	...
	if (!bVar4)
	{
		...
		if (func_72(iParam0, joaat("CI_TAG_ITEM_UPGRADE")))
		{
			func_130(iParam0);
		}
	}
	...
	if (fParam6 > 0.0f)
	{
		if (func_72(iParam0, joaat("CI_TAG_ITEM_MEAT_FISH")))
		{
...
void func_29(var uParam0)
{
	...
	while (iVar0 < func_9(iLocal_36, 16))
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_22[iVar0]))
		{
			PLAYER::_UNREGISTER_EAGLE_EYE_FOR_ENTITY(PLAYER::PLAYER_ID(), uLocal_22[iVar0]);
...
bool func_53(int iParam0, int iParam1, int iParam2)
{
	...
	*iParam1 = iParam2;
	...
	sVar0 = { func_159(iParam0, 0, 1) /*5*/ };
	iVar5 = func_160(iParam0, &sVar0, 0, 0);
	iVar6 = func_161(iParam0, 0);
	if ((iVar5 > 1 && !func_162()) && (iVar6 + iParam2) >= iVar5)
	{
		if (func_72(iParam0, joaat("CI_TAG_ITEM_ANIMAL_PART")))
		{
			func_62(583, 1);
		}
		else
	...
	if (func_163(iParam0, &sVar0, *iParam1, 0, 0))
	{
		if (iVar6 < iVar5)
		{
			*iParam1 = (iVar5 - iVar6);
...
void func_54(int iParam0, bool bParam1)
{
	...
	switch (func_164(iParam0, joaat("TAG_INTERACTION_TYPE")))
	{
...
int func_55(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_167(bParam2), iParam0, false);
	return iVar2;
}
...
bool func_81(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, iParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_194(iParam0, &sVar0, iVar5, 0))
			{
				if (func_195(iParam0, &sVar6, iVar5))
				{
					sVar29 = { func_196(iParam0, sVar0, iVar5, 0) /*4*/ };
					func_197(iParam0, &sVar29, &sVar0, 1, joaat("REMOVE_REASON_DEFAULT"), 1, 0);
				}
				else
				{
					iVar28++;
...
bool func_85(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_104(joaat("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == joaat("ADD_REASON_LOOTED"))
	{
...
void func_86(int iParam0)
{
	...
	if ((iParam0 == joaat("PROVISION_TALISMAN_EAGLE_TALON") && !func_205()) || iParam0 != joaat("PROVISION_TALISMAN_EAGLE_TALON"))
	{
		...
		{
			func_107(PLAYER::PLAYER_PED_ID(), iParam0, 0, joaat("MP_COMPONENT_TYPE_END"), 1, 1, 1, 0, 1, 1);
		}
	}
	switch (iParam0)
	{
...
struct<2> /*16*/ func_88(int iParam0)
{
	struct<2> /*16*/ sVar0;
...
struct<2> /*16*/ func_90(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_92(int iParam0)
{
	...
	bVar0 = func_72(iParam0, joaat("CI_TAG_ITEM_TALISMAN_INGREDIENT"));
	if (func_210() < 3)
	{
		if (bVar0)
		{
...
void func_98(int iParam0)
{
	...
	switch (iParam0)
	{
		case joaat("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_62(437, 0);
			func_62(440, 0);
			func_226(joaat("TAXIDERMY_ORDER_01"), joaat("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &cVar0, 1, 0, 0);
			func_68(51, 0, 0, joaat("TAXIDERMY_ORDER_01"), cVar0, 0, -1, 0);
			func_70(51, 0, 0, cVar0, func_9(joaat("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_218(1);
			func_227(joaat("WS_TAXIDERMY_NOTICES"), 0, 0);
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_2"):
			COLLECTION::_COLLECTABLE_INCREMENT_NUM_FOUND(joaat("TAXIDERMY_ORDER_02"), 1);
			func_226(joaat("TAXIDERMY_ORDER_02"), joaat("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &cVar0, 1, 0, 0);
			func_68(51, 0, 0, joaat("TAXIDERMY_ORDER_02"), cVar0, 0, -1, 0);
			func_70(51, 0, 0, cVar0, func_9(joaat("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_218(8);
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_COLLECTABLE_INCREMENT_NUM_FOUND(joaat("TAXIDERMY_ORDER_03"), 1);
			func_226(joaat("TAXIDERMY_ORDER_03"), joaat("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &cVar0, 1, 0, 0);
			func_68(51, 0, 0, joaat("TAXIDERMY_ORDER_03"), cVar0, 0, -1, 0);
			func_70(51, 0, 0, cVar0, func_9(joaat("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_218(64);
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_COLLECTABLE_INCREMENT_NUM_FOUND(joaat("TAXIDERMY_ORDER_04"), 1);
			func_226(joaat("TAXIDERMY_ORDER_04"), joaat("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &cVar0, 1, 0, 0);
			func_68(51, 0, 0, joaat("TAXIDERMY_ORDER_04"), cVar0, 0, -1, 0);
			func_70(51, 0, 0, cVar0, func_9(joaat("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_218((1 << 9));
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_COLLECTABLE_INCREMENT_NUM_FOUND(joaat("TAXIDERMY_ORDER_05"), 1);
			func_62(438, 0);
			func_226(joaat("TAXIDERMY_ORDER_05"), joaat("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &cVar0, 1, 0, 0);
			func_68(51, 0, 0, joaat("TAXIDERMY_ORDER_05"), cVar0, 0, -1, 0);
			func_70(51, 0, 0, cVar0, func_9(joaat("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_218((1 << 15));
			break;
		default:
			func_62(439, 0);
	...
	if (func_1() == -1)
	{
		...
		else if (func_72(iParam0, -1478961327))
		{
			...
			if (func_229() == 2)
			{
				...
				if (iParam0 == joaat("PROVISION_GATOR_EGG"))
				{
					if (!func_233(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, joaat("GATOR_EGGS"), 0)) >= 25)
					{
						func_234(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, joaat("GATOR_EGGS"), 0), 1);
						func_170(48);
					}
					if (func_231(iParam0) < func_232(iParam0))
					{
...
void func_102(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar1 < 5)
	{
		...
		if (func_104(func_235(iVar0, 10), 1, 0))
		{
			if (bParam2)
			{
				func_236(iParam0, iVar0, cVar2, iParam1, bParam2);
			}
			else
			{
...
void func_103(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_1() == -1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam2))
		{
			...
			{
				func_94(0, 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), iVar0);
				return;
			}
		}
	}
	switch (iParam0)
	{
		case joaat("MONEY_ONE_DOLLAR"):
			func_94(joaat("REWARD_BILL"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_FIVE_DOLLARS"):
			func_94(joaat("REWARD_FIVE_DOLLARS"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_TEN_DOLLARS"):
			func_94(joaat("REWARD_TEN_DOLLARS"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLFOLD"):
			func_94(joaat("REWARD_BILLFOLD"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLFOLD_SML"):
			func_94(joaat("REWARD_BILLFOLD_SML"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLSTACK"):
			func_94(joaat("REWARD_BILLSTACK"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COIN"):
			func_94(joaat("REWARD_COIN"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINPURSE"):
			func_94(joaat("REWARD_COINPURSE"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINSACK"):
			func_94(joaat("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINSTACK"):
			func_94(joaat("REWARD_COINS"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYCLIP"):
			func_94(joaat("REWARD_MONEYCLIP"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYSTACK"):
			func_94(joaat("REWARD_MONEYSTACK"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYSTACK_LARGE"):
			if (!func_238())
			{
				func_94(joaat("REWARD_MONEYSTACK_LARGE"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			}
			break;
		case joaat("MONEY_COINCUP_SM"):
			func_94(joaat("REWARD_COINCUP_SM"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINCUP_LG"):
			func_94(joaat("REWARD_COINCUP_LG"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("CURRENCY_CASH"):
			func_94(joaat("REWARD_BILL"), 0, 1065353216, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_CARD_SET_COMMON"):
			func_94(joaat("REWARD_CARD_SET_COMMON"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_CARD_SET_RARE"):
			func_94(joaat("REWARD_CARD_SET_RARE"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_CARD_SET_ALL"):
			func_94(joaat("REWARD_CARD_SET_ALL"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_RARE_FISH"):
			func_94(joaat("REWARD_RARE_FISH"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_TAXIDERMY_STAGE_1"):
			func_94(joaat("REWARD_TAXIDERMY_STAGE_1"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_TAXIDERMY_STAGE_2"):
			func_94(joaat("REWARD_TAXIDERMY_STAGE_2"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_TAXIDERMY_STAGE_3"):
			func_94(joaat("REWARD_TAXIDERMY_STAGE_3"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_TAXIDERMY_STAGE_4"):
			func_94(joaat("REWARD_TAXIDERMY_STAGE_4"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_TAXIDERMY_STAGE_5"):
			func_94(joaat("REWARD_TAXIDERMY_STAGE_5"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_CALLOWAY_LETTER"):
			func_94(joaat("REWARD_CALLOWAY_LETTER"), 0, 1065353216, 1, 0, 0, 0, -1);
			break;
	}
}
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	{
		sVar0 = { func_159(iParam1, 1, 0) /*5*/ };
		iParam3 = func_244(sVar0.f_4);
		if (iParam3 == joaat("MP_COMPONENT_TYPE_END"))
		{
			return 0;
		}
	...
	switch (iParam3)
	{
		...
		case joaat("MP_COMPONENT_TYPE_NECKWEAR_1"):
			if (bParam8 && iParam1 != Global_1946054.f_57[func_245(iParam3, 1) /*11*/])
			{
				func_248(31, 0, 0, 0, 0);
			}
			break;
		case joaat("MP_COMPONENT_TYPE_HEADWEAR"):
			if (func_249((1 << 15)) && iParam1 != Global_1946054.f_57[func_245(iParam3, 1) /*11*/])
			{
				func_250();
...
bool func_108(int iParam0, bool bParam1)
{
	...
	*iParam0 = 0;
	...
	if (func_254("ALL WEAPONS", &iVar0, &iVar1, joaat("SLOTID_NONE"), 0))
	{
		iVar2 = 0;
		while (iVar2 < iVar1)
		{
			if (func_255(&sVar3, iVar2, iVar0, iVar1))
			{
...
int func_126()
{
	...
	return func_169(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, joaat("CIGARETTE_CARDS"), 0));
}
...
int func_128(int iParam0, int iParam1, int iParam2)
{
	...
	sVar0 = { func_159(iParam0, 0, 1) /*5*/ };
	sVar5 = { func_196(iParam0, sVar0, sVar0.f_4, 0) /*4*/ };
	return func_262(iParam0, &sVar5, &sVar0, iParam1, iParam2, 0);
}
...
void func_129(int iParam0)
{
	...
	switch (func_76(iParam0))
	{
		case joaat("CI_CATEGORY_WARDROBE_MASK"):
			if (iParam0 == joaat("KIT_BANDANA") && func_263(joaat("CI_CATEGORY_WARDROBE_MASK"), 0) <= 0)
			{
		...
		case joaat("CI_CATEGORY_WARDROBE_OUTFIT"):
			...
			if (func_267() == joaat("MPC_PLAYER_TYPE_SP_ARTHUR") || func_267() == joaat("MPC_PLAYER_TYPE_SP_ARTHUR_SICK"))
			{
				switch (iParam0)
				{
			...
			else if (func_267() == joaat("MPC_PLAYER_TYPE_SP_MARSTON"))
			{
				switch (iParam0)
				{
		...
		case joaat("CI_CATEGORY_WARDROBE_BIG_MASK"):
			if (!func_268(joaat("CI_CATEGORY_WARDROBE_BIG_MASK"), 0))
			{
				if (func_269(joaat("CI_CATEGORY_WARDROBE_BIG_MASK"), &iVar1))
				{
	...
	if ((iParam0 == joaat("CLOTHING_SP_OFFHAND_000") || iParam0 == -1515874150) || iParam0 == joaat("UPGRADE_OFFHAND_HOLSTER"))
	{
		...
		if (func_108(&iVar2, 0))
		{
			func_81(iVar2, 0, 0, 1, 3, 0, joaat("ADD_REASON_DEFAULT"), 0);
		}
	}
}
...
void func_130(int iParam0)
{
	...
	else if (func_72(iParam0, joaat("CI_TAG_ITEM_EQUIPMENT")))
	{
		func_271(-1, iParam0);
	}
}
...
int func_131(int iParam0, int iParam1)
{
	...
	sVar4.f_1 = 10;
	func_272(&sVar4, joaat("LOOT_TYPE_NORMAL"));
	return func_273(iParam0, &sVar4, &uVar0, iParam1);
}
...
struct<2> /*16*/ func_132(int iParam0)
{
	...
	if (func_72(iParam0, joaat("CI_TAG_ITEM_DEADEYE")))
	{
		if (func_1() == -1)
		{
			if (func_72(iParam0, joaat("CI_TAG_ITEM_MEDICINE")))
			{
	...
	else if (func_72(iParam0, joaat("CI_TAG_ITEM_MEDICINE")))
	{
		return func_274(joaat("MEDICINE_ITEMS"));
	}
	if (func_72(iParam0, joaat("CI_TAG_ITEM_LOCK_BREAKER")))
	{
...
void func_134(int iParam0, char* sParam1)
{
	...
	func_278(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_277(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_135(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	strcpy_s(&cVar2, 32, func_281(iVar1 == 1, "ITEM_GET_PUMP", "ITEM_GET_PUMP_MULT"));
	if (iParam1 > 0)
	{
	}
	else
	{
		...
		else if (bParam2 && func_73(iParam0, (1 << 21)))
		{
	...
	else if (!func_282(iParam0, &sVar7, iVar11, iVar10, 0, joaat("UI_ITEMVIEWER")))
	{
	...
	if (((((iParam1 == 1 || func_72(iParam0, joaat("CI_TAG_SMOKING_CIGARETTE"))) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
		sVar15 = MISC::VAR_STRING(0, func_122(iParam0));
	}
	func_278(sVar15, sVar7.f_1, MISC::GET_HASH_KEY(sVar7.f_0), iVar14, iVar12, "Transaction_Feed_Sounds", sVar13, 0, 1);
}
...
void func_158(int iParam0, int iParam1)
{
	...
	if (func_72(iParam0, joaat("CI_TAG_ITEM_MULTIPLE_USES")))
	{
		func_294(iParam0, joaat("COST_SHOP_DEFAULT"), &iVar0, 1);
		*iParam1 *= iVar0;
	}
}

struct<5> /*40*/ func_159(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;

	sVar0 = { func_295(bParam1) /*4*/ };
	...
	switch (func_71(iParam0))
	{
		case joaat("CLOTHING"):
			...
			break;
		case joaat("WEAPON"):
			sVar0 = { func_296(bParam1) /*4*/ };
			if (bParam2 && func_297(iParam0, 1))
			{
				sVar5.f_9 = joaat("SLOTID_NONE");
				if (!func_194(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_194(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_195(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_299(iParam0, joaat("CI_CATEGORY_CAMP")))
			{
			...
			else if (func_299(iParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_196(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("WARDROBE"));
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_300(sVar0, &sVar27, bParam1, 0))
				{
					sVar0.f_4 = 0;
				}
				else
...
int func_160(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_GET_ITEM_ROLE_MAX_LEVEL_COUNT(func_167(bParam3), iParam0);
}
...
int func_161(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_167(bParam1), iParam0, false);
}
...
bool func_163(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_155(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_195(iParam0, &sVar4, joaat("SLOTID_WEAPON_0")))
			{
				return false;
			}
			if (func_297(iParam0, 1))
			{
				if (!func_194(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					return false;
				}
				else if (func_195(iParam0, &sVar4, joaat("SLOTID_WEAPON_1")))
				{
					return false;
				}
			}
	...
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_167(bParam4), iParam0, false);
	}
...
int func_165(int iParam0, int iParam1)
{
	...
	if (func_72(iParam0, joaat("CI_TAG_ITEM_AMMOBOX")))
	{
...
int func_166(int iParam0, bool bParam1)
{
	...
	sVar0 = { func_305(iParam0, joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0) /*18*/ };
	if (bParam1)
	{
		func_306(&sVar0, func_296(0));
	}
	if (!func_307(&sVar0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_256(iVar18);
...
void func_170(int iParam0)
{
	...
	func_278(MISC::VAR_STRING(6, func_313(iParam0), fVar1), "itemtype_textures", func_314(iVar0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
bool func_172(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((Global_1898164.f_163 && !func_260(iParam0, 1)) || func_318((1 << 15)))
	{
		if (!func_260(iParam0, (1 << 18)) || !Global_1905944.f_5696)
		{
			return false;
		}
	}
...
bool func_180(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		...
		{
			if (func_332(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, joaat("LEGENDARY_FISH"), 0)))
			{
				bVar1 = true;
			}
			else if (iParam5 == 8)
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_333(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, iParam2, 0))), func_333(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, iParam2, 0)), bVar1, true, false);
		}
	...
	switch (iParam0)
	{
		...
		case 24:
			...
			if (func_1() == -1)
			{
				if (!func_270(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) || func_346(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					...
					{
						func_128(iVar0, 1, joaat("ADD_REASON_DEFAULT"));
					}
		...
		case 48:
			if (func_1() == -1)
			{
				...
				{
					func_128(1013902307, 1, joaat("ADD_REASON_DEFAULT"));
				}
			}
			break;
		case 50:
			if (func_1() == -1)
			{
				...
				{
					func_128(142640135, 1, joaat("ADD_REASON_DEFAULT"));
				}
			}
			break;
		case 49:
			if (func_1() == -1)
			{
				...
				{
					func_128(786809402, 1, joaat("ADD_REASON_DEFAULT"));
				}
			}
			break;
		case 51:
			if (func_1() == -1)
			{
				...
				{
					func_128(-518019409, 1, joaat("ADD_REASON_DEFAULT"));
				}
			}
			break;
		case 23:
...
struct<4> /*32*/ func_196(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_167(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}
...
bool func_197(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!func_300(*uParam1, &sVar0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_167(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
bool func_206(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_76(iParam1) == joaat("CI_CATEGORY_WARDROBE_OUTFIT"))
	{
		return true;
	}
	...
	bVar7 = false;
	iVar8 = iParam1;
	if (func_72(iParam1, joaat("CI_TAG_ITEM_TALISMAN")))
	{
		iVar5 = func_245(iVar4, 1);
		if (func_353(&(Global_1946054.f_1497)) >= 2 && Global_1946054.f_1497.f_1[iVar5 /*3*/] != iVar8)
		{
			*uParam2 = -265166256;
			return false;
		}
	...
	switch (iVar4)
	{
		case joaat("MP_COMPONENT_TYPE_NECKWEAR_1"):
			...
			iVar5 = 10;
			iVar3 = func_76(Global_1946054.f_1497.f_1[iVar5 /*3*/]);
		...
		case joaat("MP_COMPONENT_TYPE_FOOTWEAR_1"):
			iVar5 = 35;
			if (Global_1946054.f_1497.f_1[iVar5 /*3*/] != Global_1946054.f_57[iVar5 /*11*/] && func_72(iParam1, -1638171711))
			{
		...
		case joaat("MP_COMPONENT_TYPE_WRIST_ATTIRE"):
			if (func_354(joaat("CI_CATEGORY_WARDROBE_COATS"), &uVar0))
			{
				*uParam2 = 939463734;
				return false;
			}
		...
		case joaat("MP_COMPONENT_TYPE_LOADOUT_6"):
			...
			else
			{
				...
				iVar9 = func_355(Global_1946054.f_1497.f_1[iVar5 /*3*/], iVar4, iVar2, bVar1);
				...
				iVar5 = 36;
				iVar6 = 35;
				if (iParam1 != Global_1946054.f_57[iVar6 /*11*/] && func_72(Global_1946054.f_1497.f_1[iVar5 /*3*/], -1638171711))
				{
				...
				{
					if (iParam1 != Global_1946054.f_57[iVar6 /*11*/] && func_356(Global_1946054.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = joaat("MPC_ACTION_NOT_AVAILABLE_BOOTS_DO_NOT_SUPPORT_THIS");
						return false;
					}
...
int func_215(int iParam0, bool bParam1, int iParam2)
{
	...
	while (iVar24 < sVar1.f_0)
	{
		...
		else
		{
			...
			if (func_51(iVar25, 0) && func_72(iVar25, joaat("CI_TAG_ITEM_MONEY")))
			{
				return BUILTIN::CEIL(((float)sVar1.f_12[iVar24] * fVar0));
			}
		}
...
void func_216(int iParam0, char* sParam1, int iParam2)
{
	...
	func_278(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_217(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iParam0 += iVar2;
		iVar1 += iVar2;
		func_278(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_TOTAL_TAKE"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		iParam0 -= iVar0;
		if (iVar0 > 0)
		{
			func_361(iVar0);
		...
		func_278(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_224()
{
	...
	while (iVar1 < 30)
	{
		if (func_363(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_227(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case joaat("WS_DOWNS_RANCH_DOWNS"):
			func_364(joaat("WS_DOWNS_RANCH_DOWNS"));
			func_365(joaat("WS_DOWNS_RANCH_EDITH"));
			func_365(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_365(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_DOWNS_RANCH_EDITH"):
			func_365(joaat("WS_DOWNS_RANCH_DOWNS"));
			func_364(joaat("WS_DOWNS_RANCH_EDITH"));
			func_365(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_365(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_DOWNS_RANCH_EMPTY"):
			func_365(joaat("WS_DOWNS_RANCH_DOWNS"));
			func_365(joaat("WS_DOWNS_RANCH_EDITH"));
			func_364(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_365(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_DOWNS_RANCH_REPOPULATED"):
			...
			func_365(joaat("WS_DOWNS_RANCH_EDITH"));
			func_365(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_364(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_PRONGHORN_RANCH_FENCE_FIXED"):
		case joaat("WS_PRONGHORN_RANCH_EXIST"):
		case joaat("WS_PRONGHORN_RANCH_EMPTY"):
			func_365(joaat("WS_PRONGHORN_RANCH_EXIST"));
			func_365(joaat("WS_PRONGHORN_RANCH_EMPTY"));
			func_365(joaat("WS_PRONGHORN_RANCH_FENCE_FIXED"));
			func_364(iParam0);
			break;
		...
		case joaat("WS_GUARMA3_TOWER_NORMAL"):
			func_365(joaat("WS_GUARMA3_TOWER_FRAG"));
			func_365(joaat("WS_GUARMA3_TOWER_DESTROYED"));
			func_364(joaat("WS_GUARMA3_TOWER_NORMAL"));
			break;
		case joaat("WS_GUARMA3_TOWER_FRAG"):
			func_365(joaat("WS_GUARMA3_TOWER_NORMAL"));
			func_365(joaat("WS_GUARMA3_TOWER_DESTROYED"));
			func_364(joaat("WS_GUARMA3_TOWER_FRAG"));
			break;
		case joaat("WS_GUARMA3_TOWER_DESTROYED"):
			func_365(joaat("WS_GUARMA3_TOWER_NORMAL"));
			func_365(joaat("WS_GUARMA3_TOWER_FRAG"));
			func_364(joaat("WS_GUARMA3_TOWER_DESTROYED"));
			break;
		case joaat("WS_RHODES_GRAVE_NORMAL"):
			func_365(joaat("WS_RHODES_GRAVE_FRESHLY_DUG"));
			func_365(joaat("WS_RHODES_GRAVE_OPEN"));
			func_364(joaat("WS_RHODES_GRAVE_NORMAL"));
			break;
		case joaat("WS_RHODES_GRAVE_FRESHLY_DUG"):
			func_365(joaat("WS_RHODES_GRAVE_NORMAL"));
			func_365(joaat("WS_RHODES_GRAVE_OPEN"));
			func_364(joaat("WS_RHODES_GRAVE_FRESHLY_DUG"));
			break;
		case joaat("WS_RHODES_GRAVE_OPEN"):
			func_365(joaat("WS_RHODES_GRAVE_NORMAL"));
			func_365(joaat("WS_RHODES_GRAVE_FRESHLY_DUG"));
			func_364(joaat("WS_RHODES_GRAVE_OPEN"));
			break;
		case joaat("WS_RHODES_SALOON_TABLE_UP"):
			func_365(joaat("WS_RHODES_SALOON_TABLE_DOWN"));
			func_364(joaat("WS_RHODES_SALOON_TABLE_UP"));
			break;
		case joaat("WS_RHODES_SALOON_TABLE_DOWN"):
			func_365(joaat("WS_RHODES_SALOON_TABLE_UP"));
			func_364(joaat("WS_RHODES_SALOON_TABLE_DOWN"));
			break;
		case joaat("WS_UTOPIA_TREE_STANDING"):
			func_365(joaat("WS_UTOPIA_TREE_MISSION"));
			func_365(joaat("WS_UTOPIA_TREE_FALLEN"));
			func_365(joaat("WS_UTOPIA_TREE_STUMP"));
			func_364(joaat("WS_UTOPIA_TREE_STANDING"));
			break;
		case joaat("WS_UTOPIA_TREE_MISSION"):
			func_365(joaat("WS_UTOPIA_TREE_STANDING"));
			func_365(joaat("WS_UTOPIA_TREE_FALLEN"));
			func_365(joaat("WS_UTOPIA_TREE_STUMP"));
			func_364(joaat("WS_UTOPIA_TREE_MISSION"));
			break;
		case joaat("WS_UTOPIA_TREE_FALLEN"):
			func_365(joaat("WS_UTOPIA_TREE_STANDING"));
			func_365(joaat("WS_UTOPIA_TREE_MISSION"));
			func_365(joaat("WS_UTOPIA_TREE_STUMP"));
			func_364(joaat("WS_UTOPIA_TREE_FALLEN"));
			break;
		case joaat("WS_UTOPIA_TREE_STUMP"):
			func_365(joaat("WS_UTOPIA_TREE_STANDING"));
			func_365(joaat("WS_UTOPIA_TREE_MISSION"));
			func_365(joaat("WS_UTOPIA_TREE_FALLEN"));
			func_364(joaat("WS_UTOPIA_TREE_STUMP"));
			break;
		case joaat("WS_MICAH_CAMP_EMPTY"):
			func_365(joaat("WS_MICAH_CAMP"));
			func_365(joaat("WS_MICAH_CAMP_POST"));
			func_364(joaat("WS_MICAH_CAMP_EMPTY"));
			break;
		case joaat("WS_MICAH_CAMP"):
			func_365(joaat("WS_MICAH_CAMP_EMPTY"));
			func_365(joaat("WS_MICAH_CAMP_POST"));
			func_364(joaat("WS_MICAH_CAMP"));
			break;
		case joaat("WS_MICAH_CAMP_POST"):
			func_365(joaat("WS_MICAH_CAMP_EMPTY"));
			func_365(joaat("WS_MICAH_CAMP"));
			func_364(joaat("WS_MICAH_CAMP_POST"));
			break;
		case joaat("WS_NBX_ART_EXHIBIT_OPEN"):
			if (bParam1)
			{
				func_365(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
				func_364(joaat("WS_NBX_ART_EXHIBIT_OPEN"));
			}
			else
			{
				func_365(joaat("WS_NBX_ART_EXHIBIT_OPEN"));
				func_365(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
			}
			break;
		case joaat("WS_NBX_ART_EXHIBIT_CANCELLED"):
			if (func_368(joaat("WS_NBX_ART_EXHIBIT_OPEN")))
			{
				if (bParam1)
				{
					func_364(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
				}
				else
				{
					func_365(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
		...
		case joaat("WS_HERE_KITTY_3_CLUE_TRAIL_OFF"):
			func_365(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_ON"));
			func_364(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_OFF"));
			break;
		case joaat("WS_HERE_KITTY_3_CLUE_TRAIL_ON"):
			func_365(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_OFF"));
			func_364(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_ON"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_GONE"):
			func_365(joaat("WS_HERE_KITTY_WAGONS_TRASHED"));
			func_365(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_365(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_365(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_364(joaat("WS_HERE_KITTY_WAGONS_GONE"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_TRASHED"):
			func_365(joaat("WS_HERE_KITTY_WAGONS_GONE"));
			func_365(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_365(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_365(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_364(joaat("WS_HERE_KITTY_WAGONS_TRASHED"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"):
			...
			func_365(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_365(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_364(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"):
			...
			func_365(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_365(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_364(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"):
			...
			func_365(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_365(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_364(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			break;
		case joaat("WS_NEW_COM_BANK_BEFORE"):
			func_365(joaat("WS_NEW_COM_BANK_START"));
			func_365(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_365(joaat("WS_NEW_COM_BANK_AFTER"));
			func_365(joaat("WS_NEW_COM_BANK_POST"));
			func_364(joaat("WS_NEW_COM_BANK_BEFORE"));
			break;
		case joaat("WS_NEW_COM_BANK_START"):
			func_365(joaat("WS_NEW_COM_BANK_BEFORE"));
			func_365(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_365(joaat("WS_NEW_COM_BANK_AFTER"));
			func_365(joaat("WS_NEW_COM_BANK_POST"));
			func_364(joaat("WS_NEW_COM_BANK_START"));
			break;
		case joaat("WS_NEW_COM_BANK_SHOOTOUT"):
			...
			func_365(joaat("WS_NEW_COM_BANK_AFTER"));
			func_365(joaat("WS_NEW_COM_BANK_POST"));
			func_364(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			break;
		case joaat("WS_NEW_COM_BANK_AFTER"):
			...
			func_365(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_365(joaat("WS_NEW_COM_BANK_POST"));
			func_364(joaat("WS_NEW_COM_BANK_AFTER"));
			break;
		case joaat("WS_NEW_COM_BANK_POST"):
			...
			func_365(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_365(joaat("WS_NEW_COM_BANK_AFTER"));
			func_364(joaat("WS_NEW_COM_BANK_POST"));
			break;
		case joaat("WS_NO_ANIMALS_GRIZZLIES"):
			func_365(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			func_365(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			func_365(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			func_364(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			break;
		case joaat("WS_LIGHT_ANIMALS_GRIZZLIES"):
			func_365(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			func_365(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			func_365(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			func_364(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			break;
		case joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"):
			func_365(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			func_365(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			func_365(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			func_364(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			Jump @2853; // curOff = 1932
			func_365(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			func_365(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			func_365(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			func_364(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			Jump @2853; // curOff = 1971
			func_364(joaat("WS_STRAWBERRY_HOUSE_STAGE_0"));
			func_365(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_365(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_365(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			Jump @2853; // curOff = 2010
			func_365(joaat("WS_STRAWBERRY_HOUSE_STAGE_0"));
			func_364(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_365(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_365(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			Jump @2853; // curOff = 2049
			func_365(joaat("WS_STRAWBERRY_HOUSE_STAGE_0"));
			func_365(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_364(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_365(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			Jump @2853; // curOff = 2088
			func_365(joaat("WS_STRAWBERRY_HOUSE_STAGE_0"));
			func_365(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_365(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_364(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			Jump @2853; // curOff = 2127
			func_364(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_365(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_365(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			func_365(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			Jump @2853; // curOff = 2166
			func_364(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_365(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_365(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			func_365(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			Jump @2853; // curOff = 2205
			func_364(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			func_365(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_365(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_365(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			Jump @2853; // curOff = 2244
			func_364(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			func_365(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_365(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_365(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			Jump @2853; // curOff = 2283
			func_364(joaat("WS_VALENTINE_BURIAL_DRUNK"));
			func_365(joaat("WS_VALENTINE_BURIAL_POST_DRUNK"));
			Jump @2853; // curOff = 2304
			func_364(joaat("WS_VALENTINE_BURIAL_POST_DRUNK"));
			func_365(joaat("WS_VALENTINE_BURIAL_DRUNK"));
			Jump @2853; // curOff = 2325
			func_364(joaat("WS_VALENTINE_BURIAL_MURDER"));
			func_365(joaat("WS_VALENTINE_BURIAL_POST_MURDER"));
			Jump @2853; // curOff = 2346
			func_364(joaat("WS_VALENTINE_BURIAL_POST_MURDER"));
			func_365(joaat("WS_VALENTINE_BURIAL_MURDER"));
			Jump @2853; // curOff = 2367
			func_364(0);
			func_365(joaat("WS_BRAITHWAITE_MANSION_BURNED"));
			func_365(joaat("WS_BRAITHWAITE_MANSION_ENDLESS_SUMMER"));
			Jump @2853; // curOff = 2393
			func_364(joaat("WS_BRAITHWAITE_MANSION_BURNED"));
			func_365(0);
			func_365(joaat("WS_BRAITHWAITE_MANSION_ENDLESS_SUMMER"));
			Jump @2853; // curOff = 2419
			func_364(joaat("WS_BRAITHWAITE_MANSION_ENDLESS_SUMMER"));
			func_365(0);
			func_365(joaat("WS_BRAITHWAITE_MANSION_BURNED"));
			Jump @2853; // curOff = 2445
			func_364(joaat("WS_GRAVE_ARTHUR_GOOD"));
			func_365(joaat("WS_GRAVE_ARTHUR_BAD"));
			Jump @2853; // curOff = 2466
			func_364(joaat("WS_GRAVE_ARTHUR_BAD"));
			func_365(joaat("WS_GRAVE_ARTHUR_GOOD"));
			Jump @2853; // curOff = 2487
			func_364(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			func_365(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_365(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_365(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			Jump @2853; // curOff = 2526
			func_364(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_365(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			func_365(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_365(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			Jump @2853; // curOff = 2565
			func_364(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_365(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_365(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			func_365(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			Jump @2853; // curOff = 2604
			func_364(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			func_365(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_365(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_365(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			...
			if (bParam1)
			{
				func_364(joaat("WS_SHADY_BELLE_HIDEOUT"));
			}
			else
			{
				func_365(joaat("WS_SHADY_BELLE_HIDEOUT"));
			}
			func_365(joaat("WS_SHADY_BELLE_GANG_0_2"));
			func_365(joaat("WS_SHADY_BELLE_ABANDON"));
			Jump @2853; // curOff = 2690
			func_364(joaat("WS_SHADY_BELLE_ABANDON"));
			func_365(joaat("WS_SHADY_BELLE_GANG_0_2"));
			func_365(joaat("WS_SHADY_BELLE_HIDEOUT"));
			Jump @2853; // curOff = 2720
			func_364(joaat("WS_SHADY_BELLE_GANG_0_2"));
			func_365(joaat("WS_SHADY_BELLE_HIDEOUT"));
			func_365(joaat("WS_SHADY_BELLE_ABANDON"));
			Jump @2853; // curOff = 2750
			if (bParam1)
			{
				func_364(joaat("WS_BLACKWATER_PHOTOGRAPHER_FURNITURE"));
			}
			else
			{
				func_365(joaat("WS_BLACKWATER_PHOTOGRAPHER_FURNITURE"));
			}
			Jump @2853; // curOff = 2779
			if (bParam1)
			{
				func_364(joaat("WS_SAINT_DENIS_PHOTOGRAPHER_FURNITURE"));
			}
			else
			{
				func_365(joaat("WS_SAINT_DENIS_PHOTOGRAPHER_FURNITURE"));
			}
...
int func_229()
{
	...
	while (iVar1 < 5)
	{
		if (func_369(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, joaat("EXOTIC_ITEMS"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_236(int iParam0, int iParam1, char[4] cParam2, int iParam3, bool bParam4)
{
	...
	{
		func_226(iParam1, iParam0, &cParam2, 0, iParam3, bParam4);
		func_68(51, 0, 0, iParam1, cParam2, 0, -1, 0);
		func_70(51, 0, 0, 0, 0, -1, 0);
	}
}
...
void func_237(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((((iParam0 == func_235(iParam1, 5) || iParam0 == func_235(iParam1, 6)) || iParam0 == func_235(iParam1, 7)) || iParam0 == func_235(iParam1, 8)) || iParam0 == func_235(iParam1, 9))
	{
		if (func_226(iParam1, iParam0, &cVar0, 0, 0, 0))
		{
			func_68(51, iParam0, 0, iParam1, cVar0, 0, -1, 0);
			if (!bParam2)
			{
				func_70(51, 0, 0, cVar0, func_9(iParam1, 20), 1, 0);
			}
		}
		else
		{
...
bool func_239(int iParam0, int iParam1)
{
	...
	sVar4.f_9 = joaat("SLOTID_NONE");
	if (func_254("ALL WEAPONS", &iVar1, &iVar2, joaat("SLOTID_NONE"), 0))
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_255(&sVar4, iVar3, iVar1, iVar2))
			{
			}
...
bool func_246(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (iParam2 == 39)
	{
		sVar0 = { func_159(iParam0, 1, 0) /*5*/ };
		iParam2 = func_245(func_244(sVar0.f_4), 1);
	}
	if (iParam2 < 0 || iParam2 >= 39)
	{
		return false;
	}
	if (func_72(iParam0, joaat("CI_TAG_ITEM_TALISMAN")) && func_353(&(Global_1946054.f_1378)) >= 2)
	{
		return false;
	}
	if ((func_249((1 << 15)) && iParam2 == 10) && iParam0 != Global_1946054.f_57[iParam2 /*11*/])
	{
	...
	func_379(&(Global_1946054.f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1;
	}
	Global_1946054.f_1378.f_1[iParam2 /*3*/] = iParam0;
	Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1 = func_380(iParam0, iParam2, iParam1, func_1() != -1);
	if (bParam4)
	{
		func_381(&(Global_1946054.f_1378), 1, 3);
	}
	else
	{
		func_381(&(Global_1946054.f_1378), 1, 0);
	}
	if (bParam3)
	{
		iVar6 = 0;
		while (iVar6 < Global_1946054.f_2589)
		{
			if (Global_1946054.f_2589.f_2[iVar6 /*2*/] >= 0 && Global_1946054.f_2589.f_2[iVar6 /*2*/] < 39)
			{
				...
				func_382(func_373(Global_1946054.f_2589.f_2[iVar6 /*2*/], 1), 1, 6);
			}
			iVar6++;
		}
	}
...
void func_250()
{
	...
	func_387((1 << 15));
	func_382(joaat("MP_COMPONENT_TYPE_HEADWEAR"), 8, 6);
}
...
float func_257()
{
	...
	func_398(3, fVar9, fVar9 > 100.0f);
	return func_399(fVar7, -100.0f, 100.0f);
}
...
int func_262(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!INVENTORY::_INVENTORY_ADD_ITEM_WITH_GUID(func_167(0), uParam1, uParam2, iParam0, uParam2->f_4, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
{
	if (func_72(iParam1, joaat("CI_TAG_ITEM_EQUIPMENT")))
	{
		func_412(iParam1, 0);
	}
...
int func_273(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	func_415(uParam2, iParam0, sVar1);
	return 1;
}
...
int func_277(int iParam0)
{
	...
	if (!func_416(iParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
...
int func_278(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, bool bParam8)
{
	struct<4> /*32*/ sVar0;
	struct<7> /*56*/ sVar13;
	int iVar20;
...
struct<4> /*32*/ func_295(bool bParam0)
{
...
struct<4> /*32*/ func_296(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_196(joaat("CARRIED_WEAPONS"), func_295(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_196(joaat("CARRIED_WEAPONS"), func_295(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_196(joaat("CARRIED_WEAPONS"), func_295(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_297(int iParam0, bool bParam1)
{
	if (func_76(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
...
struct<4> /*32*/ func_298(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_196(joaat("EMOTE_ITEM"), func_295(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_196(joaat("EMOTE_ITEM"), func_295(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
bool func_303(int iParam0, var uParam1, bool bParam2)
{
	...
	while (iVar29 < 4)
	{
		...
		if (func_194(iParam0, &sVar0, iVar5, 0))
		{
			bVar28 = func_195(iParam0, &sVar6, iVar5);
...
int func_304(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	sVar0 = { func_196(iParam0, sParam1, iParam5, bParam6) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&sVar0))
	{
		return 0;
	}
	iVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_167(bParam6), &sVar0, false);
	return iVar4;
}

struct<18> /*144*/ func_305(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
void func_306(var uParam0, struct<4> /*32*/ sParam1)
{
...
void func_312(int iParam0, float fParam1, bool bParam2)
{
	...
	if (func_428(iParam0) & func_429(iParam0))
	{
		if (!bParam2)
		{
			...
			if (fParam1 > (float)func_431(iParam0) && (iVar2 > iVar0 || iVar3 != 0))
			{
...
bool func_317(int iParam0)
{
	...
	if (!func_260(iParam0, (1 << 16)) && !func_260(iParam0, (1 << 15)))
	{
		return false;
	}
	iVar0 = 0;
	while (iVar0 < Global_40.f_7756)
	{
		if (Global_40.f_7756[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			if (iVar2 < 1800 && func_260(iParam0, (1 << 15)))
			{
				return true;
			}
		}
...
int func_322()
{
	...
	while (iVar1 < 30)
	{
		if (func_436(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_323()
{
	...
	while (iVar1 < 14)
	{
		if (func_332(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, joaat("LEGENDARY_FISH"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_347()
{
	if (!UNLOCK::UNLOCK_IS_UNLOCKED(joaat("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_128(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN"), 1, joaat("ADD_REASON_DEFAULT"));
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN"), true, 2, false, false);
		func_79(joaat("WEAPON_MELEE_KNIFE_JOHN"));
		func_128(joaat("WEAPON_MELEE_KNIFE_JOHN"), 1, joaat("ADD_REASON_DEFAULT"));
...
bool func_348(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_167(0);
	*uParam1 = { func_196(iParam0, func_296(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
...
int func_353(var uParam0)
{
	...
	iVar0 = 0;
	iVar1 = 22;
	if (uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/] && func_72(uParam0->f_1[iVar1 /*3*/], joaat("CI_TAG_ITEM_TALISMAN")))
	{
		iVar0++;
	}
	iVar1 = 37;
...
int func_355(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam0 == Global_1946054.f_57[func_245(iParam1, 1) /*11*/])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_362(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_360())
	{
		func_278(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_GANG_SAVINGS_SPECIAL"), 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_278(MISC::VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_GANG_SAVINGS"), 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
void func_366()
{
	func_365(joaat("WS_COLTER_STAGE_WINTER1_INTRO"));
	func_365(joaat("WS_COLTER_STAGE_CABIN_BURNING"));
	func_365(joaat("WS_COLTER_STAGE_HIGH_SNOW"));
	func_365(joaat("WS_COLTER_STAGE_MEDIUM_SNOW"));
	func_365(joaat("WS_COLTER_STAGE_THAWED_SNOW"));
	func_365(joaat("WS_COLTER_STAGE_MUDTOWN1"));
	func_365(joaat("WS_COLTER_STAGE_MP"));
}

void func_367()
{
	func_365(joaat("WS_BEECHERS_SHACK"));
	func_365(joaat("WS_BEECHERS_SHACK_WITH_FIRE"));
	func_365(joaat("WS_BEECHERS_CAMP_WITH_SHACK"));
	func_365(joaat("WS_BEECHERS_CAMP_WITH_RUBBLE"));
	func_365(joaat("WS_BEECHERS_CAMP_WITH_SUPPLIES"));
	func_365(joaat("WS_BEECHERS_HOUSE_FINISHED"));
	func_365(joaat("WS_BEECHERS_BARN_FINISHED"));
	func_365(joaat("WS_BEECHERS_HOUSE_DECORATED"));
	func_365(joaat("WS_BEECHERS_HOUSE_ABIGAIL3"));
	func_365(joaat("WS_BEECHERS_HOUSE_FULLY_DECORATED"));
}
...
void func_379(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_270(joaat("MP_COMPONENT_TYPE_LOADOUT_9")) && func_448(iParam2, (1 << 19)))
	{
		iVar1 = 33;
		uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
		uParam0->f_1[iVar1 /*3*/].f_1 = 0;
		...
		case joaat("CI_CATEGORY_WARDROBE_SHIRT"):
			...
			else
			{
				...
				if (iParam1 == Global_1946054.f_57[iParam2 /*11*/])
				{
					...
					iVar1 = 35;
					if (joaat("CI_CATEGORY_WARDROBE_SPATS") == func_76(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_356(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && joaat("CI_CATEGORY_WARDROBE_SPATS") == func_76(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				iVar1 = 36;
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946054.f_57[iParam2 /*11*/] && func_72(Global_1946054.f_1497.f_1[iVar1 /*3*/], -1638171711))
				{
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946054.f_57[iParam2 /*11*/] && (func_356(Global_1946054.f_1497.f_1[iVar1 /*3*/]) || func_72(Global_1946054.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946054.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
			...
			switch (func_76(iParam1))
			{
				case joaat("CI_CATEGORY_WARDROBE_MASK"):
					iVar1 = 10;
					if (joaat("CI_CATEGORY_WARDROBE_BIG_MASK") == func_76(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				case joaat("CI_CATEGORY_WARDROBE_BIG_MASK"):
					iVar1 = 12;
					if (joaat("CI_CATEGORY_WARDROBE_MASK") == func_76(uParam0->f_1[iVar1 /*3*/]) || func_72(uParam0->f_1[iVar1 /*3*/], joaat("CI_TAG_ITEM_TALISMAN")))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
void func_381(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_453(iVar5, 6) || uParam0->f_1[iVar0 /*3*/] == Global_1946054.f_57[iVar0 /*11*/])
			{
			}
			else
			{
...
{
	Global_1946054.f_57[func_245(iParam0, 1) /*11*/].f_10 -= (Global_1946054.f_57[func_245(iParam0, 1) /*11*/].f_10 & iParam1);
}
...
void func_385(struct<4> /*32*/ sParam0)
{
	int iVar0;
	int iVar1;
	...
	switch (sParam0.f_0)
	{
		...
		case 35:
		case 36:
			func_253(sParam0.f_0, sParam0.f_1, sParam0.f_2);
			break;
	}
}
...
void func_389(struct<4> /*32*/ sParam0)
{
	int iVar0;
	int iVar1;
	...
	if (func_459(sParam0.f_0))
	{
		...
		while (iVar0 < Global_1946054.f_852)
		{
			...
			if (Global_1946054.f_769[iVar1 /*4*/] == 34 && func_459(20))
			{
				return;
			}
			iVar0++;
...
int func_402()
{
	...
	{
		iVar1 = Global_1946054.f_2657[iVar0];
		if (func_76(iVar1) == joaat("CI_CATEGORY_WARDROBE_OUTFIT"))
		{
			if (func_464() != iVar1)
			{
				iVar2++;
...
int func_409(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	struct<4> /*32*/ sVar0;
	struct<2> /*16*/ sVar13;
	int iVar15;
...
void func_415(var uParam0, int iParam1, struct<14> /*112*/ sParam2)
{
	int iVar0;
	struct<21> /*168*/ sVar1;
...
void func_433(int iParam0, int iParam1, int iParam2)
{
	...
	if (bVar2)
	{
		...
		sVar10.f_2 = iVar8;
		sVar10.f_4 = 1;
		sVar10.f_5 = func_487(iParam0);
		UILOG::_UILOG_POST_NOTIFICATION(&sVar10);
	}
	func_183(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_488(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
int func_439(int iParam0)
{
	...
	while (iVar95 < 3)
	{
		if (!func_489(&iVar0, 0, iVar95, &sVar1) && !func_489(&iVar0, 1, iVar95, &sVar1))
		{
		}
		else if (STREAMING::IS_MODEL_A_PED(sVar1.f_0))
		{
			func_490(iVar0, &sVar1);
			if (func_51(sVar1.f_1, 0))
			{
				return 1;
			}
		}
...
void func_440()
{
	...
	func_492(0);
	func_493(7);
	func_494(joaat("KIT_BANDANA"), 1, 1, 0);
	if (func_267() == joaat("MPC_PLAYER_TYPE_SP_MARSTON"))
	{
		func_494(joaat("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
		func_494(joaat("CLOTHING_SP_MAR_OUTFIT_GUNSLINGER"), 1, 1, 1);
	}
...
void func_444(int iParam0)
{
	...
	sVar0 = { func_274(joaat("GANG_SAVINGS_CASH")) /*2*/ };
...
{
	return (Global_1946054.f_57[func_245(iParam0, 1) /*11*/].f_10 & iParam1) != 0;
}
...
{
	func_502(&(Global_1946054.f_1378), iParam0);
...
void func_470()
{
	...
	func_128(joaat("UPGRADE_STAMINA_TANK_1"), 1, joaat("ADD_REASON_DEFAULT"));
	iVar0 = func_311(1);
	func_433(1, iVar0, 0);
}
...
void func_472()
{
	...
	func_128(joaat("UPGRADE_DEADEYE_TANK_1"), 1, joaat("ADD_REASON_DEFAULT"));
	iVar0 = func_311(2);
	func_433(2, iVar0, 0);
}
...
void func_473()
{
	...
	func_128(joaat("UPGRADE_HEALTH_TANK_1"), 1, joaat("ADD_REASON_DEFAULT"));
	iVar0 = func_311(0);
	func_433(0, iVar0, 0);
}
...
int func_481(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_167(0), joaat("UPGRADE_HEALTH_TANK_1"), false);
		case 1:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_167(0), joaat("UPGRADE_STAMINA_TANK_1"), false);
		case 2:
			return INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_167(0), joaat("UPGRADE_DEADEYE_TANK_1"), false);
	}
	return 0;
}

struct<4> /*32*/ func_482(int iParam0, int iParam1)
{
	char cVar0[32];
...
void func_493(int iParam0)
{
	...
	while (iVar0 < Global_1946054.f_2657.f_19)
	{
		...
		if (func_76(iVar2) != joaat("CI_CATEGORY_WARDROBE_OUTFIT"))
		{
			func_522(&(Global_1946054.f_2657.f_26.f_26), iVar2, iVar0);
		}
		if (func_523(iVar2, 0))
		{
			func_524(iVar2, Global_1946054.f_1497.f_1[iVar1 /*3*/] == Global_1946054.f_2657[iVar0]);
		}
		iVar0++;
	}
}
...
void func_494(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		case joaat("CI_CATEGORY_WARDROBE_HAT"):
			bVar1 = func_526(iParam0, &(Global_1946054.f_2657.f_21), Global_1946054.f_2657.f_26.f_1, bParam1);
			break;
		case joaat("CI_CATEGORY_WARDROBE_MASK"):
			bVar1 = func_526(iParam0, &(Global_1946054.f_2657.f_23), 1, bParam1);
			break;
		case joaat("CI_CATEGORY_WARDROBE_OUTFIT"):
			bVar1 = func_526(iParam0, &(Global_1946054.f_2657.f_20), Global_1946054.f_2657.f_26, bParam1);
			break;
		case joaat("CI_CATEGORY_WARDROBE_BIG_MASK"):
			bVar1 = func_526(iParam0, &(Global_1946054.f_2657.f_22), Global_1946054.f_2657.f_26.f_2, bParam1);
			break;
		case joaat("CI_CATEGORY_WARDROBE_GLOVES"):
			bVar1 = func_526(iParam0, &(Global_1946054.f_2657.f_24), 1, bParam1);
			break;
		case joaat("CI_CATEGORY_WARDROBE_BADGE"):
			bVar1 = func_526(iParam0, &(Global_1946054.f_2657.f_24), 1, bParam1);
			break;
	...
	if (iParam0 == func_527(0))
	{
		...
		if (func_267() == joaat("MPC_PLAYER_TYPE_SP_MARSTON"))
		{
			func_528(func_527(joaat("MPC_PLAYER_TYPE_SP_ARTHUR")), 0);
		}
		else
		{
			func_528(func_527(joaat("MPC_PLAYER_TYPE_SP_MARSTON")), 0);
		}
	}
	func_529();
	if (func_530(iVar0))
	{
		INVENTORY::_INVENTORY_DISABLE_ITEM(func_167(0), iParam0, 0);
	}
...
bool func_507(int iParam0)
{
	...
	if (func_72(iParam0, joaat("CI_TAG_ITEM_EQUIPMENT_HOLSTER")))
	{
		return true;
	}
	return false;
...
bool func_508(int iParam0)
{
	...
	if (func_72(iParam0, joaat("CI_TAG_ITEM_EQUIPMENT_OFFHAND")))
	{
		return true;
	}
	return false;
...
bool func_519(int iParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void func_520(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case joaat("CI_CATEGORY_WARDROBE_HAT"):
			bVar0 = func_545(iParam0, &(Global_1946054.f_2657.f_21));
			break;
		case joaat("CI_CATEGORY_WARDROBE_MASK"):
			bVar0 = func_545(iParam0, &(Global_1946054.f_2657.f_23));
			break;
		case joaat("CI_CATEGORY_WARDROBE_OUTFIT"):
			bVar0 = func_545(iParam0, &(Global_1946054.f_2657.f_20));
			break;
		case joaat("CI_CATEGORY_WARDROBE_BIG_MASK"):
			bVar0 = func_545(iParam0, &(Global_1946054.f_2657.f_22));
			break;
		case joaat("CI_CATEGORY_WARDROBE_GLOVES"):
			bVar0 = func_545(iParam0, &(Global_1946054.f_2657.f_24));
			break;
		case joaat("CI_CATEGORY_WARDROBE_BADGE"):
			bVar0 = func_545(iParam0, &(Global_1946054.f_2657.f_25));
			break;
	}
	if (!bVar0)
	{
...
void func_521(int iParam0)
{
	...
	sVar2.f_16 = -1;
	sVar2.f_17 = -1;
	sVar2 = { func_305(0, joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, iParam0) /*18*/ };
	if (func_307(&sVar2, &iVar0, &iVar1, 0))
	{
		if (iVar1 > 0)
		{
			switch (iParam0)
...
bool func_523(int iParam0, bool bParam1)
{
	...
	sVar0 = { func_159(iParam0, 0, 0) /*5*/ };
	sVar5 = { func_196(iParam0, sVar0, sVar0.f_4, 0) /*4*/ };
	if (func_304(iParam0, sVar0, sVar0.f_4, 0) <= 0)
	{
		return false;
	}
	INVENTORY::_INVENTORY_SET_INVENTORY_ITEM_HIDDEN(func_167(0), &sVar5, bParam1);
	return true;
}
...
void func_524(int iParam0, bool bParam1)
{
	...
	INVENTORY::_INVENTORY_SET_INVENTORY_ITEM_IN_USE(func_167(0), &sVar5, bParam1);
}
...
int func_526(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (func_76(iParam0) != joaat("CI_CATEGORY_WARDROBE_OUTFIT"))
	{
		func_522(&(Global_1946054.f_2657.f_26.f_26), iParam0, Global_1946054.f_2657.f_19);
	}
...
int func_528(int iParam0, bool bParam1)
{
	...
	INVENTORY::_0x0349404A22736740(bParam1, func_167(0), &sVar5);
	return 1;
}
...
int func_545(int iParam0, var uParam1)
{
	...
	*uParam1--;
	...
	if (func_76(iParam0) != joaat("CI_CATEGORY_WARDROBE_OUTFIT"))
	{
		func_551(&(Global_1946054.f_2657.f_26), iVar0, Global_1946054.f_2657.f_19);
	}
	func_523(iParam0, 1);
	return 1;
}
