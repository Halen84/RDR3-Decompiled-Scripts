...
void __SCRIPT()
{
	...
	fLocal_8 = 1.0f;
	iLocal_32 = -1;
	vLocal_47 = { -127.432f, -28.7315f, 95.0632f /*3*/ };
	fLocal_50 = -114.179f;
	vLocal_51 = { -126.5f, -29.1f, 94.995f /*3*/ };
	fLocal_54 = 65.614f;
	strcpy_s(&cLocal_254, 24, "CDT32_DANCE");
	sVar0 = -1;
	sVar0.f_1 = -1;
	sVar0.f_2 = -1;
	sVar0.f_17 = 10;
...
void func_60(var uParam0, int iParam1, bool bParam2)
{
	...
	{
		case 1:
			if (!func_117(&(uParam0->f_107[iParam1 /*113*/].f_32.f_56)) || func_118(&(uParam0->f_107[iParam1 /*113*/].f_32.f_56)) > 1.0f)
			{
				...
				{
					func_120(&(uParam0->f_107[iParam1 /*113*/].f_32.f_56), 0.0f);
				}
			}
			if (!func_117(&(uParam0->f_1693)) || func_118(&(uParam0->f_1693)) > 1.0f)
			{
				if (func_121())
				{
					iVar3 = joaat("ARTHUR");
...
bool func_79(var uParam0)
{
	...
	{
		func_162(uParam0, 0.4883f, 0.0735f, 0.9362f, 0.0f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
		func_162(uParam0, 3.2121f, -1.0102f, 1.1642f, 0.0f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
		func_162(uParam0, 2.723f, -3.706f, 1.1388f, 0.0f, 1.0f, 1.0f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	}
	func_163(uParam0, joaat("P_CS_BOOK04X"), 0.0f, 0.0f, 0.0f, "p_cs_book04x", 0, 1, 1);
	func_163(uParam0, joaat("P_POCKETMIRROR01X"), 0.0f, 0.0f, 0.0f, "p_pocketMirror01x", 0, 1, 1);
	if (!func_159(14))
	{
	...
	sLocal_33 = { func_173(uParam0, 2.723f, -3.706f, 1.1631f, 173.68f, 6.0f, 0.6f, 0.6f) /*10*/ };
	if (func_159(14))
	{
		...
		func_175(uParam0, iLocal_14, -1.0f);
...
{
	ANIMSCENE::SET_ANIM_SCENE_ORIGIN(uParam0->f_1984[iLocal_19], vLocal_51, 0.0f, 0.0f, fLocal_54, 2);
	ANIMSCENE::SET_ANIM_SCENE_ORIGIN(uParam0->f_1984[iLocal_20], vLocal_51, 0.0f, 0.0f, fLocal_54, 2);
	ANIMSCENE::SET_ANIM_SCENE_ORIGIN(uParam0->f_1984[iLocal_21], vLocal_51, 0.0f, 0.0f, fLocal_54, 2);
...
bool func_97(var uParam0)
{
	if (!MAP::DOES_BLIP_EXIST(iLocal_57))
	{
		iLocal_57 = MAP::BLIP_ADD_FOR_COORDS(joaat("BLIP_STYLE_MINIGAME"), func_212(uParam0, vLocal_47));
...
void func_107(Vector3 vParam0, int iParam3)
{
	...
	while (iVar0 < Global_1911670)
	{
		...
		if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(iVar1))
		{
			...
			if (func_238(vVar2, vParam0, 2.0f, 1))
			{
...
int func_116(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_129(iVar0, 0))
	{
		if (func_129(PED::_GET_RIDER_OF_MOUNT(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_114(iParam0)) || func_58(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_239(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000.0f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_241(iParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_242(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_242(iParam0, 0));
					func_243(iParam0);
				}
			}
			else
			{
				if (func_244(iParam0, (1 << 15), 1))
				{
...
void func_132(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		PED::SET_PED_CONFIG_FLAG(func_256(iParam0), 137 /*PCF_0xE18960DE*/, true);
	}
}
...
void func_133(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		PED::SET_PED_CONFIG_FLAG(func_256(iParam0), 204 /*PCF_0x435F091E*/, true);
	}
	else
	{
		PED::SET_PED_CONFIG_FLAG(func_256(iParam0), 204 /*PCF_0x435F091E*/, false);
	}
}
...
void func_134(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_256(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_258(iParam0) < 10000.0f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_151(var uParam0)
{
	...
	if (func_264(Global_1935630, (1 << 14)))
	{
		return true;
	}
	if (func_265(2))
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_271(uParam0->f_107[iVar0 /*113*/].f_1, (1 << 11)))
			{
				return true;
			}
...
{
	uParam0->f_23 = { func_278(iParam1) + Vector(fParam4, fParam3, fParam2) /*3*/ };
	uParam0->f_26 = { func_279(iParam1) /*3*/ };
}
...
int func_162(var uParam0, Vector3 vParam1, float fParam4, Vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_212(uParam0, vParam1) /*3*/ };
...
{
	func_167(uParam0, iParam1, 0, 0, 0, -1, 0, 0.0f, 1065353216, 1);
}
...
void func_170(var uParam0, int iParam1, Vector3 vParam2, float fParam5, int iParam6, bool bParam7)
{
	if (bParam7)
	{
		vParam2 = { func_212(uParam0, vParam2) /*3*/ };
...
struct<10> /*80*/ func_173(var uParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	float fVar0;
	float fVar1;
	struct<10> /*80*/ sVar2;

	fVar0 = func_281(uParam0, (fParam4 + (fParam6 * 90.0f)));
	fVar1 = func_281(uParam0, (fParam4 - (fParam7 * 90.0f)));
	sVar2 = { func_212(uParam0, vParam1) /*3*/ };
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_283(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_297(uParam0->f_107[iVar12 /*113*/].f_1));
				}
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_240(uParam0->f_107[iVar12 /*113*/].f_7, 1));
				}
			}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!uParam0->f_1711[iVar0 /*15*/].f_5 && !ENTITY::DOES_ENTITY_EXIST(uParam0->f_1711[iVar0 /*15*/].f_10))
			{
				...
				{
					vVar3 = { func_212(uParam0, uParam0->f_1711[iVar0 /*15*/].f_1) /*3*/ };
				}
				else
				{
...
void func_206(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_212(uParam0, uParam0->f_1976.f_1), 1, func_281(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
void func_221(var uParam0)
{
	...
	if (!func_334(uParam0, sLocal_33, 1, 0))
	{
		return;
	}
	...
	MISC::REGISTER_INTERACTION_LOCKON_PROMPT(func_8(uParam0, iLocal_16), "", 6.0f, 0.0f, 0, 0.0f, 0.0f, 0, false, -1);
	bLocal_56 = true;
	if (!func_49(iLocal_43))
	{
		iLocal_43 = func_336("GREET_ACC", joaat("INPUT_INTERACT_LOCKON_POS"), func_8(uParam0, iLocal_16), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		func_337(iLocal_43, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(func_8(uParam0, iLocal_16)), 0, 1);
		func_338(iLocal_43, 0, 1);
	}
	if (!func_49(iLocal_44))
	{
		iLocal_44 = func_336("GREET_REJ", joaat("INPUT_INTERACT_LOCKON_NEG"), func_8(uParam0, iLocal_16), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		func_337(iLocal_44, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(func_8(uParam0, iLocal_16)), 0, 1);
...
void func_222(var uParam0)
{
	...
	if (func_342(iLocal_43, 1))
	{
		...
		TASK::TASK_ENTER_ANIM_SCENE(Global_35, func_343(uParam0, iLocal_21), "ARTHUR", "PL_DanceAccept", 1.48f, false, 0, 20000, -1.0f);
...
void func_224(var uParam0)
{
	...
	{
		iLocal_46 = func_336("VIG_FLARE", joaat("INPUT_CONTEXT_X"), func_8(uParam0, iLocal_16), 2, 0, 0, 0, 0, 1070386381, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		func_349(iLocal_46, 6.0f, 1);
		func_338(iLocal_46, 0, 1);
	}
	if (!func_49(iLocal_45))
	{
		iLocal_45 = func_336("LEAVE", joaat("INPUT_CONTEXT_B"), func_8(uParam0, iLocal_16), 2, 0, 0, 0, 0, 1070386381, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		func_349(iLocal_45, 6.0f, 1);
...
void func_234(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_360(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
bool func_270(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_370(iVar0) && func_371(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
int func_275()
{
	...
	if (func_378(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_276()
{
	...
	if (func_378(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
bool func_294(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1 /*15*/].f_5)
		{
			...
			{
				vVar2 = { func_212(uParam0, uParam0->f_1711[iVar1 /*15*/].f_1) /*3*/ };
			}
			else
			{
...
void func_302(var uParam0, int iParam1)
{
	...
	else if (!func_387(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
	{
...
bool func_303(var uParam0, int iParam1, Vector3 vParam2)
{
	...
	if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(uParam0->f_107[iParam1 /*113*/].f_3, vParam2, true))
	{
		...
		{
			func_120(&(uParam0->f_107[iParam1 /*113*/].f_109), 0.0f);
		}
	}
	else
	{
...
bool func_304(var uParam0, int iParam1, Vector3 vParam2)
{
	...
	if (ENTITY::IS_ENTITY_OCCLUDED(uParam0->f_107[iParam1 /*113*/].f_5))
	{
		...
		{
			func_120(&(uParam0->f_107[iParam1 /*113*/].f_106), 0.0f);
		}
	}
	else
	{
...
int func_311(var uParam0, int iParam1)
{
	...
	if (func_360(uParam0, iParam1, 1.0f))
	{
		return 1;
	}
...
void func_329(int iParam0, int iParam1)
{
	...
	Global_1357549.f_1833 = { func_395(iParam0) /*8*/ };
	Global_1357549.f_1841 = { func_396(iParam0) /*3*/ };
...
bool func_334(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
		if (!func_335(func_22(uParam0), 1))
	...
	if (!func_402(sParam1, sParam1.f_6, Global_36))
	{
		return false;
	}
	if (func_402(sParam1, sParam1.f_3, Global_36))
	{
		return false;
	}
	if (bParam12)
...
int func_336(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 48)
	{
		if (func_236(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_405(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
bool func_348(var uParam0, int iParam1)
{
	...
	{
		if (!func_387(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_ANY")))
		{
			return true;
		}
	}
...
{
	PED::SET_PED_RESET_FLAG(Global_35, 53 /*PRF_DisableAgitation*/, true);
	if (bLocal_257)
	{
		return;
	}
...
void func_356(var uParam0)
{
	...
	ANIMSCENE::SET_ANIM_SCENE_ORIGIN(uParam0->f_1984[iLocal_21], vVar0, 0.0f, 0.0f, ENTITY::GET_ENTITY_HEADING(Global_35), 2);
}
...
void func_358(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_282(100.0f, 140.0f);
			}
		}
...
bool func_359(var uParam0, int iParam1)
{
	...
	{
		func_120(&(uParam0->f_107[iParam1 /*113*/].f_32.f_52), 0.0f);
	}
...
int func_379(Vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	Vector3 vVar2;
		...
		else if (func_22(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_436(&iVar2, func_435(iVar3)))
					{
...
void func_389(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_442(iParam1))
		{
			func_443(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
struct<8> /*64*/ func_395(int iParam0)
{
	switch (iParam0)
	{
		case 0:
...
void func_399(char[4] cParam0, char[4] cParam1, char[4] cParam2, var uParam3)
{
	int iVar0;
...
bool func_402(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
bool func_414(var uParam0, int iParam1)
{
	...
	return ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_ACTIVE(iVar5, &sVar1);
}
...
bool func_434(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_271(iParam0, (1 << 31)))
	{
		return true;
	}
	if (func_271(iParam0, (1 << 30)))
	{
		return true;
	}
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_473(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, (1 << 30));
			}
			else if (bParam16)
			{
...
struct<8> /*64*/ func_447(char* sParam0)
{
	char cVar0[64];
...
int func_455(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_487(fVar9) /*3*/ };
			vVar13 = { func_488(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
int func_462(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_491(iParam0) && func_492(iParam0, &cVar4))
				{
					PERSCHAR::_SET_PERSCHAR_SCHEDULE(func_240(iParam0, 1), &cVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_237(vVar0)) && !func_238(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608, 1))
			{
				...
				func_473(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, (1 << 30));
			}
			if (bParam1)
			{
				if (!ENTITY::_DOES_THREAD_OWN_THIS_ENTITY(Global_1360165[iParam0 /*1157*/].f_124))
			...
			{
				PERSCHAR::_0x63AA2B8EB087886A(func_240(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
void func_464(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_498(func_113(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_499(iParam0);
...
bool func_471(int iParam0, Vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_509(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) /*7*/ };
			if (!bParam6)
			{
				func_111(iParam0, 44, 1);
			}
...
void func_473(int iParam0, Vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_254(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_254(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_254(iParam5, 32), true);
...
bool func_494(int iParam0, Vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489.f_12) || (bParam5 && Global_1359489.f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_240(iParam0, 1));
...
void func_496(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_256(iParam1), iParam0, false);
	...
	func_464(iParam1, func_526(iParam1, (1 << 13)), func_526(iParam1, (1 << 14)), 1);
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_378(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_465(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<7> /*56*/ func_509(int iParam0, int iParam1, Vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	struct<7> /*56*/ sVar0;
...
void func_520(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 12)) > 0 && func_480(iParam1, 879715242))
	{
	...
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 9)) > 0 && func_480(iParam1, 1064646155))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1064646155);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 10)) > 0 && func_480(iParam1, -536694793))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -536694793);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 11)) > 0 && func_480(iParam1, -1304053509))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1304053509);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 31)) > 0 && func_480(iParam1, 718939204))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 718939204);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 16)) > 0 && func_480(iParam1, -972364774))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -972364774);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 14)) > 0 && func_480(iParam1, -1100875244))
	{
	...
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 18)) > 0 && func_480(iParam1, 1153596794))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1153596794);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 19)) > 0 && func_480(iParam1, 1016389820))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1016389820);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 20)) > 0 && func_480(iParam1, -726966617))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -726966617);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 21)) > 0 && func_480(iParam1, 1365901568))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1365901568);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 15)) > 0 && func_480(iParam1, -1658942149))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1658942149);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 17)) > 0 && func_480(iParam1, -1980913856))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1980913856);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 22)) > 0 && func_480(iParam1, 491764525))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 491764525);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 23)) > 0 && func_480(iParam1, -76015264))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -76015264);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 24)) > 0 && func_480(iParam1, 622113465))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 622113465);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 25)) > 0 && func_480(iParam1, 781533162))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 781533162);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 26)) > 0 && func_480(iParam1, -271415321))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -271415321);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 27)) > 0 && func_480(iParam1, -1683207356))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1683207356);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 28)) > 0 && func_480(iParam1, -254794762))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -254794762);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 29)) > 0 && func_480(iParam1, 609066278))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 609066278);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 30)) > 0 && func_480(iParam1, -1712783565))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1712783565);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 13)) > 0 && func_480(iParam1, 1544915253))
	{
...
int func_523(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
