...
void func_63()
{
	...
	switch (iLocal_20)
	{
		...
		case 3:
			...
			func_124((func_123(joaat("ABERDEEN_HOME_ROBBERY_REWARD")) + Global_40.f_9422[0 /*7*/].f_3), 0, 1065353216, 1, 0, 0, 1, joaat("ADD_REASON_DEFAULT"));
			func_125(0);
...
char* func_141(char* sParam0, int iParam1)
{
	...
	return func_198(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
