...
{
	func_50(0.775f, 0.2f, 0.025f, 0.0f);
}
...
void func_61(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_101(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_101(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_101(&cVar6, joaat("COLOR_PURE_WHITE")), func_101(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
char* func_101(char* sParam0, int iParam1)
{
	...
	return func_135(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

int func_102(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_106(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_116(int iParam0)
{
	...
	func_143(iParam0, (1 << 13));
	func_143(iParam0, (1 << 14));
	func_143(iParam0, (1 << 15));
	func_143(iParam0, (1 << 17));
	func_143(iParam0, (1 << 24));
	func_143(iParam0, (1 << 19));
...
bool func_129(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_157(iVar0) && func_158(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_146(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_168(iParam0, (1 << 10)))
		{
			func_169(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_168(iParam0, (1 << 10)))
	{
		func_170(iParam0, (1 << 10));
		INVENTORY::_0x9B4E793B1CB6550A();
	}
	func_171(iParam0);
}
...
bool func_160(Vector3 vParam0, int iParam3)
{
	...
	func_177(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_178(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
