					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_5))
					{
						if (!PED::IS_PED_INJURED(iLocal_5))
						{
							...
							if (!func_26(iLocal_4, 256))
							{
								...
								{
									TASK::TASK_LOOK_AT_COORD(iLocal_5, ENTITY::GET_ENTITY_COORDS(Global_35, true, false), 7500, (1 << 11), 51, 0);
...
void func_121(var uParam0, int iParam1)
{
	...
	{
		func_198(Global_35, joaat("CLOTHING_ITEM_NECKWEAR_NONE"), 0, joaat("MP_COMPONENT_TYPE_NECKWEAR_1"), 0, 1, 0, 0, 1, 0);
...
bool func_170(bool bParam0, bool bParam1)
{
	if (!func_202(Global_43801))
	{
		Global_43801 = func_228("CUTSCENE_SKIP", joaat("INPUT_SKIP_CUTSCENE"), 5, 570, 4000, 10, (1 << 30), 0, 1065353216, 0, 3, joaat("LONG_TIMED_EVENT"), 0);
	...
	if (func_238(&bVar0))
	{
		if (func_239(bVar0, 0))
		{
			if (func_240(bVar0) == joaat("CI_CATEGORY_WARDROBE_BIG_MASK"))
			{
				...
				func_198(Global_35, joaat("CLOTHING_ITEM_HAT_NONE"), 0, joaat("MP_COMPONENT_TYPE_HEADWEAR"), 0, 1, 0, 0, 0, 0);
			}
			else
			{
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_263(iVar3, 6) || uParam0->f_1[iVar1 /*3*/] == Global_1946054.f_57[iVar1 /*11*/]) || uParam0->f_1[iVar1 /*3*/].f_1 == 289238755)
				{
...
{
	if (-1829635046 == func_296(joaat("CI_CATEGORY_WARDROBE_MASK")))
	{
		if (func_297(bParam0))
		{
			return true;
...
struct<5> /*40*/ func_271(bool bParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_313(bParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_279(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_315(bParam0, 1))
			{
				...
				if (!func_316(bParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_316(bParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_317(bParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_279(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
...
int func_328(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	iVar0 = func_349(0);
	if (iParam2 != 0 && func_350(bParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
int func_340(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_367("ALL WEAPONS", &iVar1, &iVar2, joaat("SLOTID_NONE"), 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_366(iParam1, (1 << 9)) && func_344(sVar4.f_4, &uVar19, &sVar23, joaat("SLOTID_WEAPON_0"))) && !sVar23.f_21)
			{
			}
