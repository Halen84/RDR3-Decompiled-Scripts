		...
		else if (func_57(uParam0->f_107[iVar0 /*113*/].f_7))
		{
			...
			else
			{
				...
				if (func_57(uParam0->f_107[iVar0 /*113*/].f_1))
				{
					...
					{
						func_73(uParam0->f_107[iVar0 /*113*/].f_1, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
					}
				}
			}
			iVar0++;
...
void func_332(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		...
		{
			func_73(uParam0->f_107[iParam1 /*113*/].f_1, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
		}
	}
}
...
void func_362(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_412(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_412(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
int func_434(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_471(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
int func_462(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !func_236(vVar0)) && !func_237(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608, 1))
			{
