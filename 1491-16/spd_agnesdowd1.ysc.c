...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		func_4();
		func_5();
		func_6(0, iLocal_200, &bLocal_183, &uLocal_204, &bLocal_151, 0, 1097859072, 0);
		func_7();
		func_8();
		...
		if (!func_10(iLocal_139, (1 << 13)))
		{
			if (ENTITY::DOES_ENTITY_EXIST(bLocal_183))
			{
				...
				else if ((bLocal_150 && func_12(bLocal_183, 80.0f, -1082130432, -1082130432, -1082130432)) || func_10(iLocal_139, 256))
				{
					func_14(0, func_13());
...
int func_179(bool bParam0, var uParam1)
{
	...
	{
		return func_245(bParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
