...
void func_86(int iParam0)
{
	...
	switch (func_115())
	{
		case -1:
			...
			while (iVar22 < 10)
			{
				MISC::COPY_SCRIPT_STRUCT(&(Global_40.f_6563.f_274[iVar22 /*20*/]), &sVar2, 20);
				iVar22++;
			}
...
void func_215()
{
	...
	iVar0 = 12;
	func_436(iVar0);
	Global_1879534.f_1911[Global_1879534.f_7287 /*3*/] = joaat("FLOW_TERMINATE");
	Global_1879534.f_1911[Global_1879534.f_7287 /*3*/].f_1 = iVar0;
	Global_1879534.f_1911[Global_1879534.f_7287 /*3*/].f_2 = -1;
	func_437(iVar0);
}
...
void func_241(int iParam0, bool bParam1)
{
	...
	{
		if (Global_1879534.f_1911[iVar1 /*3*/] == joaat("FLOW_LABEL"))
		{
	...
	func_436(iVar0);
	Global_1879534.f_1911[Global_1879534.f_7287 /*3*/] = joaat("FLOW_LABEL");
	Global_1879534.f_1911[Global_1879534.f_7287 /*3*/].f_1 = iVar0;
	Global_1879534.f_1911[Global_1879534.f_7287 /*3*/].f_2 = Global_1879534.f_7288[iVar0];
	iVar4 = 0;
	if (bParam1)
...
int func_414(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	{
		if ((!func_547(iParam0, joaat("CI_TAG_ITEM_TALISMAN")) && !func_547(iParam0, joaat("CI_TAG_ITEM_UPGRADE"))) && !func_547(iParam0, joaat("CI_TAG_ITEM_IS_SATCHEL")))
		{
			bVar3 = true;
		}
	}
	...
	if (!bVar3)
	{
		...
		else if (func_547(iParam0, joaat("CI_TAG_ITEM_IS_SATCHEL")))
		{
			iVar8 = 0;
			switch (iParam0)
			{
...
void func_518(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((((iParam1 == 1 || func_547(iParam0, joaat("CI_TAG_SMOKING_CIGARETTE"))) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
...
void func_600(int iParam0, bool bParam1)
{
	...
	switch (func_840(iParam0, joaat("TAG_INTERACTION_TYPE")))
	{
...
bool func_853(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		...
		{
			if (func_1012(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, joaat("LEGENDARY_FISH"), 0)))
			{
				bVar1 = true;
			}
			else if (iParam5 == 8)
...
int func_887()
{
	...
	while (iVar1 < 5)
	{
		if (func_1034(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, joaat("EXOTIC_ITEMS"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_1003()
{
	...
	while (iVar1 < 14)
	{
		if (func_1012(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, joaat("LEGENDARY_FISH"), 0)))
		{
			iVar0++;
		}
		iVar1++;
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_539(iVar3, 6) || uParam0->f_1[iVar1 /*3*/] == Global_1946054.f_57[iVar1 /*11*/]) || uParam0->f_1[iVar1 /*3*/].f_1 == joaat("REMOVE_COMPONENT"))
				{
...
bool func_1155(int iParam0)
{
	...
	if (func_547(iParam0, joaat("CI_TAG_ITEM_EQUIPMENT_HOLSTER")))
	{
		return true;
	}
	return false;
...
bool func_1156(int iParam0)
{
	...
	if (func_547(iParam0, joaat("CI_TAG_ITEM_EQUIPMENT_OFFHAND")))
	{
		return true;
	}
	return false;
