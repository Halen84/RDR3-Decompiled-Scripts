...
int func_33(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	{
		if ((!func_76(bParam0, joaat("CI_TAG_ITEM_TALISMAN")) && !func_76(bParam0, joaat("CI_TAG_ITEM_UPGRADE"))) && !func_76(bParam0, 1248798204))
		{
			bVar3 = true;
		}
	}
...
bool func_176(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		...
		{
			if (func_312(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, 1995362678, 0)))
			{
				bVar1 = true;
			}
			else if (iParam5 == 8)
...
int func_224()
{
	...
	while (iVar1 < 5)
	{
		if (func_354(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_303()
{
	...
	while (iVar1 < 14)
	{
		if (func_312(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, 1995362678, 0)))
		{
			iVar0++;
		}
		iVar1++;
