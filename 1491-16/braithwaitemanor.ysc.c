...
bool func_11()
{
	...
	{
		if (TASK::_DOES_SCENARIO_GROUP_EXIST_HASH(joaat("BRA_MANOR_GATE_GUARD_RIDERS")))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(joaat("BRA_MANOR_GATE_GUARD_RIDERS"), false);
		}
	}
	else if (TASK::_DOES_SCENARIO_GROUP_EXIST_HASH(joaat("BRA_MANOR_GATE_GUARD_RIDERS")))
	{
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(joaat("BRA_MANOR_GATE_GUARD_RIDERS"), true);
	}
	if (func_46(0) == func_47(22))
	{
		if (TASK::_DOES_SCENARIO_GROUP_EXIST_HASH(joaat("BRA_MANOR_FIELDS_GUARD_RIDERS")))
		{
			TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(joaat("BRA_MANOR_FIELDS_GUARD_RIDERS"), false);
		}
	}
	else if (TASK::_DOES_SCENARIO_GROUP_EXIST_HASH(joaat("BRA_MANOR_FIELDS_GUARD_RIDERS")))
	{
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(joaat("BRA_MANOR_FIELDS_GUARD_RIDERS"), true);
	}
	return true;
}
...
void func_14(int iParam0)
{
	...
	func_49(1595076728, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(1439227364, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(-1072865219, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(1620578985, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(1606293329, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(1913469935, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(-1664744776, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(-1375427275, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(1970779164, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(-2018125672, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(530930529, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(1299101427, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(23338719, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(785447352, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(-461544174, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(-764395272, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(-368185289, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(-656945717, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(248030525, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(606588923, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(825059846, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(-964389706, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(-152106360, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(473912616, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(-1099020037, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(1799856783, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(1518993684, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(426802898, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(-908387367, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(1909255102, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(-415917122, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(409697833, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(-1649837912, bVar0, 0.0f, 0, 0, 0, 1, 0);
	func_49(-1874862635, bVar0, 0.0f, 0, 0, 0, 1, 0);
	iVar1 = VOLUME::CREATE_VOLUME_BOX(1010.465f, -1772.747f, 54.474f, 0.0f, 0.0f, 0.0f, 46.182f, 45.55f, 29.43f);
	iVar2 = ITEMSET::CREATE_ITEMSET(true);
	iVar3 = ENTITY::GET_MATCHING_ENTITIES(iVar1, iVar2, 3, 1, joaat("P_WIN_JTXL_DIRTY01X"), 0);
	iVar4 = 0;
	while (iVar4 < iVar3)
	{
...
bool func_38(int iParam0)
{
	if (iLocal_15 != -1)
	{
		if (func_58(joaat("WS_BRAITHWAITE_MANSION_BURNED")) && !func_59(45))
		{
			if (func_60(Global_35, iLocal_14, 0, 0))
			{
				if (AUDIO::_HAS_SOUND_ID_FINISHED(iLocal_15))
				{
					AUDIO::_PLAY_SOUND_FROM_POSITION_WITH_ID(iLocal_15, "MAIN_LOOP", 1011.224f, -1766.506f, 46.5833f, "FIRE_SMOLDER_LARGE_SOUNDSET", false, 0, false);
				}
			}
...
bool func_48(int iParam0, int iParam1)
{
	...
	iVar0 = func_86(&(Global_1146091[iParam1 /*12*/].f_4), iParam0, 30, 1, 7);
	if (iVar0 == 1)
	{
		return true;
	}
...
void func_49(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_87(iParam0, 0, 0);
	if (func_88(iParam0))
	{
		...
		if (bParam3)
		{
			func_89(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_68(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_56(iParam0) && func_85(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
...
void func_89(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (func_88(iParam0))
	{
...
char* func_119(char* sParam0, int iParam1)
{
	...
	return func_153(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
void func_134(int iParam0)
{
	...
	func_161(iParam0, (1 << 13));
	func_161(iParam0, (1 << 14));
	func_161(iParam0, (1 << 15));
	func_161(iParam0, (1 << 17));
	func_161(iParam0, (1 << 24));
	func_161(iParam0, (1 << 19));
	func_161(iParam0, (1 << 20));
...
char* func_149(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
bool func_177(Vector3 vParam0, int iParam3)
{
	...
	func_191(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_192(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
