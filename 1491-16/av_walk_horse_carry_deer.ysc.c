...
int func_19(var uParam0)
{
	if (*uParam0 == 71)
	{
		...
		{
			if (!PED::_HAS_METAPED_OUTFIT_LOADED(iLocal_74))
			{
				return 0;
			}
		}
	...
	switch (iLocal_9)
	{
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[1 /*14*/], joaat("WEAPON_REPEATER_CARBINE"), 999, bLocal_72, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
...
void func_218(int iParam0, Vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_162(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
