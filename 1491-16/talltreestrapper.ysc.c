...
bool func_11()
{
	if (func_20() == -1)
	{
		iLocal_9 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2251.375f, -1915.508f, 117.618f, 0.0f, 0.0f, -66.588f, 7.714f, 7.649f, 7.583f, "Tall Trees Trapper - m_volTrapper");
		iLocal_10 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2250.752f, -1916.897f, 117.618f, 0.0f, 0.0f, -66.562f, 1.423f, 2.798f, 4.201f, "Tall Trees Trapper - m_volTrapperPrompt");
		iLocal_11 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2251.891f, -1914.261f, 117.618f, 0.0f, 0.0f, -66.562f, 2.755f, 4.58f, 4.201f, "Tall Trees Trapper - m_volTrapperOfflimits");
	}
	return true;
}
