...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			vLocal_32 = { -137.6493f, -19.38938f, 96.22693f /*3*/ };
			func_149(uParam0, 149, 0, 0, 0);
			break;
		case 2:
			vLocal_32 = { 679.4728f, -1254.775f, 43.81953f /*3*/ };
			func_149(uParam0, 82, 0, 0, 0);
			break;
		case 3:
			vLocal_32 = { 1879.968f, -1862.575f, 42.77949f /*3*/ };
	...
	func_151(uParam0, -2.25f, 0.75f, 0.0f, 0.0f, 3.0f, 3.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	iLocal_18 = func_152(uParam0, joaat("P_CS_CARROTSLICE01X"), 0.0f, 0.0f, 0.0f, "CARROT", 0, 1, 1);
	iLocal_17 = func_152(uParam0, joaat("P_KNIFE03X"), 0.0f, 0.0f, 0.0f, "KNIFE", 0, 0, 1);
	iLocal_15 = func_152(uParam0, joaat("P_CS_VEGSACK_UP"), 0.0f, 0.0f, 0.0f, "SACK_1", 0, 0, 1);
	iLocal_16 = func_152(uParam0, joaat("P_CS_VEGSACK_DOWN"), 0.0f, 0.0f, 0.0f, "SACK_2", 0, 0, 1);
	...
	sLocal_22 = { func_159(uParam0, -1.92f, -0.8f, 0.0f, 64.08f, 7.0f, 1.0f, 1.0f) /*10*/ };
	func_160(uParam0, 1);
...
{
	return func_194(uParam0, sLocal_22, 1, 0);
}
...
{
	PLAYER::_0x3946FC742AC305CD(PLAYER::GET_PLAYER_INDEX(), func_48(uParam0, iLocal_14), "CCPRS_CNV_4", 0.0f, 0.0f, 0.0f, 0, 0);
	return true;
}
...
bool func_95(var uParam0)
{
	...
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_32, 1.0f))
	{
		switch (func_148(uParam0))
		{
			case 1:
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_328(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_394(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
