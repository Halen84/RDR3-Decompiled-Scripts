...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.0874f, 0.9197f, 1.0429f, 0.0f, 1.3f, 1.3f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_LENNY"), 1, 1, 1);
	func_151(uParam0, 0.0089f, -0.9555f, 1.0423f, 0.0f, 1.3f, 1.3f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	if (func_152(10))
	{
	...
	iLocal_21 = func_153(uParam0, joaat("P_BOWL04X_STEW"), 0.0f, 0.0f, 0.0f, "BOWL0", 0, 0, 1);
	iLocal_20 = func_153(uParam0, joaat("P_SPOON01X"), 0.0f, 0.0f, 0.0f, "SPOON0", 0, 0, 1);
	iLocal_19 = func_153(uParam0, joaat("P_BOWL04X_STEW"), 0.0f, 0.0f, 0.0f, "BOWL1", 0, 0, 1);
	iLocal_18 = func_153(uParam0, joaat("P_SPOON01X"), 0.0f, 0.0f, 0.0f, "SPOON1", 0, 0, 1);
	if (!func_152(10))
	{
	...
	if (func_152(10))
	{
		func_157(uParam0, iLocal_14, 3, joaat("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_A", iLocal_17, 0, -1.0f, 1065353216, 1);
	}
	else
	{
	...
	if (func_152(10))
	{
		...
		func_163(uParam0, iLocal_15, 7.0f);
		func_164(uParam0, 1);
		func_165(uParam0, 1);
	}
...
{
	ENTITY::_0x669655FFB29EF1A9(func_196(uParam0, iLocal_19), 0, "Stew_Fill", 1.0f);
	ENTITY::_0x669655FFB29EF1A9(func_196(uParam0, iLocal_21), 0, "Stew_Fill", 1.0f);
	return true;
}
