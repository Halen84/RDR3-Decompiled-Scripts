...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			func_149(uParam0, -131.08f, -30.6f, 94.925f, 0.0f, 0.0f, 85.0f);
			break;
		default:
			return false;
	}
	...
	func_151(uParam0, 5.2264f, -6.6722f, 0.5193f, 170.3144f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	func_151(uParam0, 0.4954f, -2.8251f, 0.6547f, -90.36f, 1.5f, 1.8f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_16 = func_152(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 0, 1);
	func_152(uParam0, joaat("S_INTERACT_LANTERN01X"), 0.0f, 0.0f, 0.0f, "LANTERN", 0, 0, 1);
	func_152(uParam0, joaat("P_CHAIRFOLDING02X"), 0.0f, 0.0f, 0.0f, "CHAIR", 0, 0, 1);
	...
	sLocal_20 = { func_159(uParam0, 0.0939f, -2.8236f, 0.6519f, -145.319f, 7.0f, 0.8f, 0.8f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_198(uParam0, sLocal_20, 1, 0))
		{
...
int func_346(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_384(fVar9) /*3*/ };
			vVar13 = { func_385(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
void func_419(int iParam0, int iParam1)
{
	...
	func_391(iParam1, func_447(iParam1, (1 << 13)), func_447(iParam1, (1 << 14)), 1);
}
