...
bool func_60(bool bParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
	{
		...
		{
			if (((TASK::_PED_IS_IN_SCENARIO_BASE(Global_35) || (bParam0 && TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 0))) || (TASK::IS_TASK_MOVE_NETWORK_ACTIVE(Global_35) && TASK::GET_TASK_MOVE_NETWORK_EVENT(Global_35, "SCENARIO_POINT_TRANS_COMPLETE"))) || (func_56((1 << 24)) && ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, -1208591336)))
			{
				return true;
			}
		}
...
int func_228(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (func_122(iParam0) == joaat("CLOTHING"))
	{
		if ((!func_190(iParam0, joaat("CI_TAG_ITEM_TALISMAN")) && !func_190(iParam0, joaat("CI_TAG_ITEM_UPGRADE"))) && !func_190(iParam0, 1248798204))
		{
			bVar3 = true;
		}
	}
...
bool func_698(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		...
		{
			if (func_988(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, 1995362678, 0)))
			{
				bVar1 = true;
			}
			else if (iParam5 == 8)
...
{
	if (-1829635046 == func_1008(joaat("CI_CATEGORY_WARDROBE_MASK")))
	{
		if (func_721(iParam0))
		{
			return true;
...
int func_792()
{
	...
	while (iVar1 < 5)
	{
		if (func_1058(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_979()
{
	...
	while (iVar1 < 14)
	{
		if (func_988(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, 1995362678, 0)))
		{
			iVar0++;
		}
		iVar1++;
