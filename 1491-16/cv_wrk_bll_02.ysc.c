...
bool func_72(var uParam0)
{
	...
	func_160(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", iLocal_17, 0, 85.0f, 1065353216, 1);
	func_161(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	func_162(uParam0, iLocal_14, 1, -1);
	func_160(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY_MALE_D", iLocal_18, 0, 100.0f, 1065353216, 1);
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_262(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
...
int func_356(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_395(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
struct<5> /*40*/ func_481(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_493(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_485(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_495(iParam0, 1))
			{
				...
				if (!func_483(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_483(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_484(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_485(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
