...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		...
		if (bLocal_43)
		{
			if (((!ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 725039534) || PED::IS_PED_FLEEING(uParam0->f_20[0 /*14*/])) || func_65(uParam0->f_20[0 /*14*/], joaat("SCRIPT_TASK_FLEE"))) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
