...
bool func_72(var uParam0)
{
	...
	func_156(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_BOX_PUT_DOWN_1"), "WORLD_HUMAN_BOX_PUT_DOWN_1_MALE_A", -1, 0, 45.0f, 1065353216, 1);
...
int func_373(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_413(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
struct<5> /*40*/ func_496(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_508(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_500(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_510(iParam0, 1))
			{
				...
				if (!func_498(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_498(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_499(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_500(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
