...
void __SCRIPT()
{
	...
	fLocal_7 = 1.0f;
	fLocal_8 = 1.0f;
	iLocal_57 = joaat("CAMP_CONVO_PROP_WASHBOARD");
	sVar0 = -1;
	sVar0.f_1 = -1;
	sVar0.f_2 = -1;
	sVar0.f_17 = 10;
...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 6:
			...
			vLocal_54 = { 2356.71f, 1345.218f, 104.9014f /*3*/ };
			break;
		default:
			return false;
	}
	...
	func_151(uParam0, 0.0f, 0.0f, 0.85f, 0.0f, 1.0f, 1.0f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_151(uParam0, -3.025f, 0.275f, 0.85f, -17.0f, 3.8275f, 2.9425f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	func_152(uParam0, -3.15f, 0.0f, 0.0f, 24.0f, 1.5f, 0.76f, 3.0f, joaat("VOLCYLINDER"), 1);
	func_153(uParam0, joaat("P_CS_BOOK04X"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 1, 1);
	iLocal_22 = func_153(uParam0, joaat("P_RAG02X"), 0.0f, 0.0f, 0.0f, "RAG", 0, 1, 1);
	iLocal_21 = func_153(uParam0, joaat("P_WASHBOARD01X"), 0.0f, 0.0f, 0.0f, "WASHBOARD", 0, 1, 1);
	iLocal_23 = func_153(uParam0, joaat("P_BASINWATER01X"), 2356.782f, 1345.284f, 104.8737f, 0, 0, 1, 0);
	...
	func_159(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_WASHBOARD"), "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 15.0f, 1065353216, 1);
	...
	sLocal_24 = { func_162(uParam0, -2.5775f, 0.58f, 0.9904f, 89.75f, 6.2f, 0.1825f, 0.33f) /*10*/ };
	sLocal_34 = { func_162(uParam0, -2.43f, 0.58f, 0.9904f, -119.88f, 6.2f, 0.295f, 0.395f) /*10*/ };
	sLocal_44 = { func_162(uParam0, -2.4725f, 0.6575f, 0.9904f, 148.75f, 6.285f, 0.6195f, 0.2525f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	if (!bLocal_58)
	{
		...
		{
			if (func_202(uParam0, sLocal_24, 1, 0))
			{
				func_192(uParam0, iLocal_17, 1);
			}
			else if (func_202(uParam0, sLocal_34, 1, 0))
			{
				func_192(uParam0, iLocal_18, 1);
			}
			else if (func_202(uParam0, sLocal_44, 1, 0))
			{
...
bool func_95(var uParam0)
{
	...
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_54, 1.0f))
	{
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(iLocal_57, true);
		return true;
	}
