...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			vLocal_17 = { -138.41f, -6.94f, 95.25f /*3*/ };
			fLocal_20 = -28.238f;
			break;
		case 2:
			func_150(uParam0, 690.4313f, -1259.154f, 43.645f, 0.0f, 0.0f, -128.67f);
			vLocal_17 = { 691.71f, -1264.57f, 43.77f /*3*/ };
			fLocal_20 = -105.192f;
			break;
		default:
			return false;
	...
	func_153(uParam0, 0.0763f, -1.44f, 0.1559f, -176.4356f, 2.56f, 3.53f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_153(uParam0, 4.4707f, -1.4952f, 0.8447f, -17.4529f, 2.8f, 1.96f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	...
	func_156(uParam0, iLocal_14, 1, joaat("WORLD_HUMAN_STAND_WAITING"), 0, -1, 0, 90.0f, 1065353216, 1);
...
bool func_93(var uParam0)
{
	...
	{
		TASK::TASK_START_SCENARIO_AT_POSITION(func_48(uParam0, iLocal_16), joaat("WORLD_ANIMAL_HORSE_GRAZING_CAMP"), vLocal_17, fLocal_20, 15000, true, false, 0, -1.0f, false);
