...
bool func_73(var uParam0)
{
	...
	func_153(uParam0, 1.625f, -0.675f, 0.85f, 0.0f, 1.0f, 1.0f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	func_153(uParam0, 0.6125f, -2.2125f, 0.85f, -8.5f, 1.6325f, 1.1875f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_153(uParam0, -3.7875f, -0.8125f, 0.85f, -65.75f, 1.0f, 1.0f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_TRELAWNY"), 1, 1, 1);
	func_154(uParam0, 1.05f, -1.65f, 0.0f, -30.0f, 1.0f, 1.54f, 3.0f, joaat("VOLCYLINDER"), 1);
	func_155(uParam0, joaat("P_PIPE01X"), 0.0f, 0.0f, 0.0f, "PIPE", 0, 0, 1);
	iLocal_21 = func_155(uParam0, joaat("P_CS_LEDGERSMALL01X"), 0.0f, 0.0f, 0.0f, "LEDGER", 0, 0, 1);
	iLocal_19 = func_155(uParam0, joaat("P_CS_KNITTING01X"), 0.0f, 0.0f, 0.0f, "KNITTING", 0, 0, 1);
...
bool func_94(var uParam0)
{
	...
	if (!bLocal_22)
	{
		if (func_202(uParam0, iLocal_18, 0.457f))
		{
			...
			ENTITY::SET_ENTITY_COORDS(func_47(uParam0, iLocal_17), ENTITY::GET_ENTITY_COORDS(func_203(uParam0, iLocal_21), true, false) + Vector(0.2f, 0.0f, 0.0f), true, false, true, true);
			ENTITY::SET_ENTITY_HEADING(func_47(uParam0, iLocal_17), (ENTITY::GET_ENTITY_HEADING(func_47(uParam0, iLocal_16)) + 90.0f));
...
void func_388(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_422(func_105(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_423(iParam0);
