...
{
	if (TASK::_GET_SCENARIO_POINT_RADIUS(iLocal_3) == 0.0f)
	{
		return;
	}
	if (iParam0->f_1 == joaat("CASH"))
	{
		func_15(joaat("REWARD_MONEYSTACK"), 0, 1065353216, 1, 0, 0, 0, -1);
	}
...
int func_16(int iParam0, bool bParam1, int iParam2)
{
	...
	while (iVar24 < sVar1.f_0)
	{
		...
		else
		{
			...
			if (func_20(bVar25, 0) && func_21(bVar25, joaat("CI_TAG_ITEM_MONEY")))
			{
				return BUILTIN::CEIL(((float)sVar1.f_12[iVar24] * fVar0));
			}
		}
...
void func_18(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iParam0 += iVar2;
		iVar1 += iVar2;
		func_22(MISC::VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_TOTAL_TAKE"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		iParam0 -= iVar0;
		if (iVar0 > 0)
		{
			func_24(iVar0);
		...
		func_22(MISC::VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
bool func_19(bool bParam0, int iParam1, bool bParam2)
{
	...
	return func_30(bParam0, 0, bParam2) >= iParam1;
}
...
bool func_29(bool bParam0, int iParam1)
{
	...
	bVar0 = func_34(bParam0, iParam1);
	sVar4.f_9 = joaat("SLOTID_NONE");
	if (func_35("ALL WEAPONS", &iVar1, &iVar2, joaat("SLOTID_NONE"), 0))
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_36(&sVar4, iVar3, iVar1, iVar2))
			{
			}
			else if (!func_37(sVar4.f_4))
			{
			}
...
int func_30(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		return func_39(bParam0, 0);
	}
	iVar2 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_40(bParam2), bParam0, false);
	return iVar2;
}
...
bool func_34(bool bParam0, int iParam1)
{
	...
	if (func_21(bParam0, joaat("CI_TAG_ITEM_AMMOBOX")))
	{
		func_41(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return false;
}
...
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION(func_40(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
int func_39(bool bParam0, bool bParam1)
{
	...
	sVar0 = { func_42(bParam0, joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0) /*18*/ };
	if (bParam1)
	{
		func_44(&sVar0, func_43(0));
	}
	if (!func_45(&sVar0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_38(iVar18);
...
void func_41(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
struct<18> /*144*/ func_42(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
struct<4> /*32*/ func_43(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_48(joaat("CARRIED_WEAPONS"), func_47(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_48(joaat("CARRIED_WEAPONS"), func_47(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_48(joaat("CARRIED_WEAPONS"), func_47(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

void func_44(var uParam0, struct<4> /*32*/ sParam1)
{
...
bool func_45(var uParam0, int iParam1, int* iParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_40(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
struct<4> /*32*/ func_47(bool bParam0)
{
	return func_48(joaat("CHARACTER"), func_49(), joaat("SLOTID_NONE"), bParam0);
}

struct<4> /*32*/ func_48(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_40(bParam6), &uParam1, bParam0, iParam5, &sVar0);
	return sVar0;
}
