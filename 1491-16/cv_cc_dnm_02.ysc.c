...
bool func_78(var uParam0)
{
	...
	iLocal_103 = func_164(uParam0, joaat("P_CRATE03X"), 0.0f, 0.0f, 0.0f, "CRATE", 0, 0, 1);
	iLocal_104 = func_164(uParam0, joaat("P_CHAIRFOLDING02X"), 0.0f, 0.0f, 0.0f, "CHAIR", 0, 0, 1);
	...
	func_168(uParam0, iLocal_92, 2, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_103, 0, 15.0f, 1065353216, 1);
	...
	func_168(uParam0, iLocal_93, 2, joaat("PROP_HUMAN_SEAT_CHAIR_PORCH"), "PROP_HUMAN_SEAT_CHAIR_PORCH_FEMALE_B", iLocal_104, 0, 10.0f, 1065353216, 1);
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_284(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
...
bool func_390(var uParam0, var uParam1)
{
	...
	if (!func_395(uParam1->f_47.f_3))
	{
		uParam1->f_47.f_3 = func_440("INTERACT_WNT_DISMISS", joaat("INPUT_INTERACT_LOCKON_NEG"), iVar0, 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
