		...
		while (iVar0 <= Global_1415419.f_19[bParam0 /*12*/].f_9)
		{
			*iParam1++;
			...
			else
			{
				...
				{
					iVar5 = func_41(Global_35, Global_1415419.f_2996[iVar0 /*7*/], 1060437492);
					if (iVar5 == 1)
					{
					}
					else if (fVar6 < fVar2)
...
int func_34(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!uParam0->f_469[1])
		{
			...
			{
				if (func_70(uParam0, 0.5f, 80.0f, 4, 1109393408, 1112014848))
				{
					if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
		...
		if (uParam0->f_469[2] && !uParam0->f_469[3])
		{
			if (!uParam0->f_469[6])
			{
				if (func_71(uParam0, 1.5f, 1116471296, 4, joaat("ACTION"), 1))
				{
					func_69(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[6] = 1;
				}
