...
bool func_73(var uParam0)
{
	...
	func_152(uParam0, 0.87499f, 0.291573f, 0.481659f, 3.0f, 0.9f, 0.9f, 2.5f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, -0.00493374f, -0.044972f, 0.582031f, 3.0f, 0.8f, 2.0f, 2.0f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	func_153(uParam0, joaat("P_CS_RAG02X"), 0.0f, 0.0f, 0.0f, "RAG", 0, 1, 1);
	if (!func_154(1) && !func_154(2))
	{
		func_153(uParam0, joaat("P_STOOL03X"), 0.0f, 0.0f, 0.0f, "STOOL", 0, 0, 1);
	}
	if (!func_154(1) && !func_154(2))
	{
	...
	iLocal_21 = func_157(uParam0, 2.82f, -0.137f, 1.0f, 0.0f, 0.0f, 90.0f, 5.0f, 6.0f, 3.0f, "TRIGGER", joaat("VOLBOX"));
	func_158(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0);
	func_159(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0, -1.0f, 1065353216, 1);
	...
	func_159(uParam0, iLocal_15, 4, joaat("WORLD_CAMP_JOHN_RECOVER"), "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0, -1.0f, 1065353216, 1);
	...
	if (func_154(1) || func_154(2))
	{
		...
		func_169(uParam0, iLocal_14, -1.0f);
...
int func_157(var uParam0, Vector3 vParam1, Vector3 vParam4, Vector3 vParam7, char* sParam10, int iParam11)
{
	...
	vVar1 = { func_266(uParam0, vParam1) /*3*/ };
...
void func_162(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1 /*113*/].f_32.f_5 = { func_269(func_149(uParam0), func_268(uParam0, iParam1), func_20(uParam0), 1) /*3*/ };
			break;
		default:
			sVar0 = { func_270(func_149(uParam0), func_268(uParam0, iParam1), func_20(uParam0), 1) /*4*/ };
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_272(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_286(uParam0->f_107[iVar12 /*113*/].f_1));
				}
...
void func_196(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_266(uParam0, uParam0->f_1976.f_1), 1, func_267(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
bool func_203(struct<2> /*16*/ sParam0, float fParam2, struct<2> /*16*/ sParam3, float fParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
struct<4> /*32*/ func_270(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 1:
...
void func_319(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_271(100.0f, 140.0f);
			}
		}
...
void func_405(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_439(func_105(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_440(iParam0);
