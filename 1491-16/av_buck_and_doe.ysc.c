#pragma region Local_Variables
	...
	var uLocal_68 = 0;
	var uLocal_69 = 0;
	struct<23> /*184*/ sLocal_70 = { 0, 0, 0, 0, -1, 0, 0, 0, 2, 1, 1, 1, 0, 1, 2, 2, 3, 0, 0, 3, 1, 3, 3 } ;
	var uLocal_93 = 0;
	var uLocal_94 = 0;
...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_47(uParam0, 0, "BADP_BUCK_1", joaat("A_C_BUCK_01"), OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.0f, 0.0f, 0.0f), (-180.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "BADP_DOE_1", joaat("A_C_DEER_01"), OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.25f, -4.0f, 0.0f), (75.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	if (!uParam0->f_469[1])
	{
		if (func_62(uParam0, &uLocal_17, 0) || func_63(uParam0->f_20[0 /*14*/], Global_35, 1, 1) < 20.0f)
		{
			func_64(uParam0);
			func_65(uParam0);
			iLocal_9 = 8;
	...
	switch (iLocal_9)
	{
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], iLocal_10, uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1.0f, false);
		...
		case 1:
			...
			{
				func_65(uParam0);
				sLocal_45.f_3 = uParam0->f_20[0 /*14*/];
				sLocal_45.f_7 = 0;
				func_69(&uLocal_14);
				...
				TASK::REACT_LOOK_AT(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 1, 1, 6.0f, 1, 0, 0, 0);
				iLocal_9 = 2;
			}
			break;
		case 2:
			...
			{
				IK::_INVERSE_KINEMATICS_REQUEST_LOOK_AT(uParam0->f_20[1 /*14*/], &sLocal_45);
				if (func_70(&uLocal_14, 5.0f))
				{
					TASK::TASK_GO_TO_ENTITY(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], -1, 3.0f, 1.0f, (1 << 30), 0);
					TASK::REACT_LOOK_AT(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 1, 1, 100.0f, 1, 0, 0, 0);
					iLocal_9 = 3;
				}
			}
			break;
		...
		case 4:
			...
			{
				IK::_INVERSE_KINEMATICS_REQUEST_LOOK_AT(uParam0->f_20[1 /*14*/], &sLocal_45);
				if (!func_71(uParam0->f_20[1 /*14*/], joaat("SCRIPT_TASK_GO_TO_ENTITY")))
				{
					sLocal_70.f_3 = uParam0->f_20[1 /*14*/];
					sLocal_70.f_7 = 0;
					func_69(&uLocal_14);
					iLocal_9 = 5;
				}
		...
		case 5:
			...
			{
				IK::_INVERSE_KINEMATICS_REQUEST_LOOK_AT(uParam0->f_20[1 /*14*/], &sLocal_45);
				IK::_INVERSE_KINEMATICS_REQUEST_LOOK_AT(uParam0->f_20[0 /*14*/], &sLocal_70);
				if (func_70(&uLocal_14, 4.0f))
				{
					TASK::TASK_SMART_FLEE_PED(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 1000.0f, -1, 256, 1.25f, 0);
					iLocal_9 = 6;
				}
			}
			break;
		case 6:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				if (func_72(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 1) > 16.0f)
				{
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], -2.0f, -4.0f, 0.0f, 1.5f, -1, 0.1f, true, true, false, false, true, false);
					func_69(&uLocal_14);
					iLocal_9 = 7;
				}
			}
...
bool func_146(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_63(iParam0, iParam1, 1, 1) < 4.0f)
		{
...
bool func_181(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_63(iVar0, iParam0, 1, 1) <= 4.0f)
		{
			return true;
		}
	}
