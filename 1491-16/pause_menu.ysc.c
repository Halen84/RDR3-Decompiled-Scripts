...
int func_189(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	{
		if ((!func_331(iParam0, joaat("CI_TAG_ITEM_TALISMAN")) && !func_331(iParam0, joaat("CI_TAG_ITEM_UPGRADE"))) && !func_331(iParam0, 1248798204))
		{
			bVar3 = true;
		}
	}
...
int func_562()
{
	...
	while (iVar1 < 5)
	{
		if (func_724(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_775(iVar3, 6) || uParam0->f_1[iVar1 /*3*/] == Global_1946054.f_57[iVar1 /*11*/]) || uParam0->f_1[iVar1 /*3*/].f_1 == 289238755)
				{
