...
int func_31(var uParam0)
{
	...
	switch (iLocal_14)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				if (uParam0->f_489 == 3)
				{
					...
					func_64(uParam0->f_20[0 /*14*/], joaat("WEAPON_REVOLVER_CATTLEMAN"), 1, 0, 0, 0, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				}
				else
				{
					PED::_SET_PED_INTERACTION_PERSONALITY(uParam0->f_20[0 /*14*/], joaat("AVOID"));
		...
		case 2:
			...
			if (!bLocal_44)
			{
				if (func_72(uParam0, 1065353216, 1116471296, 4, joaat("ACTION"), 0))
				{
					func_62(*uParam0, uParam0->f_483, 1);
					bLocal_44 = true;
				}
...
bool func_68(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_117(iParam0, joaat("CURRENCY_CASH"), iParam1, iVar0);
	}
...
void func_104(int iParam0, Vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_133(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_176(int iParam0, var uParam1)
{
	...
	{
		return func_244(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
struct<5> /*40*/ func_179(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_189(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_183(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_248(iParam0, 1))
			{
				...
				if (!func_181(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_181(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_182(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_183(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
