		...
		if (MISC::GET_GAME_TIMER() > iLocal_225)
		{
			...
			switch (iLocal_224)
			{
				...
				case 1:
					...
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_226));
				...
				case 6:
					if (func_7(func_6(iLocal_226)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_226 /*35*/].f_11 > 0.0f)
							{
								PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1888801[iLocal_226 /*35*/].f_11);
							}
							Jump @785; // curOff = 766
							func_42(iVar0);
							iVar0 = (1 + iVar0);
						...
						{
							PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1888801[iLocal_226 /*35*/].f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
{
	iParam0 = iParam0;
	return func_48(&uLocal_14, (1 << 11), &uLocal_14, func_46(), 0, func_47(), 0, 0, 0);
}
