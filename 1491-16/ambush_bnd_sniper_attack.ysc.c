...
bool func_31()
{
	...
	switch (sLocal_274.f_4)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (func_171(&iLocal_15, &(sLocal_274.f_34), &(iLocal_15.f_241), "COMBAT_FLEE", 1092616192))
			{
...
bool func_67(int iParam0)
{
	...
	while (iVar0 < iParam0->f_215)
	{
		if (ENTITY::DOES_ENTITY_EXIST((*iParam0)[iVar0]))
		{
			...
			{
				if (func_218((*iParam0)[iVar0], Global_36, 1) < (70.0f * 70.0f) || func_219((*iParam0)[iVar0], 70.0f, -1082130432, -1082130432, -1082130432))
				{
					return true;
				}
			}
...
void func_75()
{
	...
	if (iLocal_15.f_19 < iLocal_15.f_215)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_15[iVar0]))
		{
			...
			{
				if (func_219(iLocal_15[iVar0], 200.0f, -1082130432, iLocal_15.f_9[iVar0], -1082130432))
				{
	...
	else if (iLocal_15.f_19 < (iLocal_15.f_215 + iLocal_15.f_216))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_15.f_40[iVar0]))
		{
			...
			{
				if (func_219(iLocal_15.f_40[iVar0], 200.0f, -1082130432, -1082130432, -1082130432))
				{
	...
	else if (iLocal_15.f_19 < ((iLocal_15.f_215 + iLocal_15.f_216) + iLocal_15.f_217))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_15.f_49[iVar0]))
		{
			if (!func_226(&iLocal_15, iVar0, 8))
			{
				...
				{
					if (func_227(iLocal_15.f_49[iVar0], 200.0f, -1082130432))
					{
...
int func_92(int iParam0)
{
	if (iLocal_15.f_57[iParam0] == 0)
	{
		...
		{
			iLocal_15.f_57[iParam0] = func_250(joaat("HORSE_CLASS_RIDING"), 1);
		}
		else
		{
...
void func_139()
{
	...
	if (!bVar2)
	{
		...
		{
			func_274(&sLocal_274, iLocal_15[0], Global_35, "OPENS_FIRE", -1073741824, 1, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CLEAR"), 0);
			bVar2 = true;
		}
	}
	iVar0 = 0;
	while (iVar0 <= 4)
	{
		...
		else
		{
			...
			if (!bVar2)
			{
				func_274(&sLocal_274, iLocal_15[iVar0], Global_35, "OPENS_FIRE", -1073741824, 1, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CLEAR"), 0);
				bVar2 = true;
			}
		}
		iVar0++;
	...
	switch (sLocal_274.f_5)
	{
		...
		case 1:
			if (func_294())
			{
				...
				func_274(&sLocal_274, iLocal_15[iVar0], Global_35, &cVar1, -1073741824, 1, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CRITICAL"), iVar9);
		...
		case 3:
			...
			if ((func_299(0.0f, 1, iLocal_15[1], 1) && func_299(0.0f, 1, iLocal_15[0], 1)) && func_299(-4.0f, 1, 0, 0))
			{
				...
				func_274(&sLocal_274, iLocal_15[1], Global_35, "GANG_TAUNT_GEN", -1073741824, 1, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CRITICAL"), 2);
	...
	while (iVar0 <= 1)
	{
		if (func_61(iLocal_15[iVar0], 0, 0))
		{
			...
			if (!bVar3)
			{
				...
				{
					func_274(&sLocal_274, iLocal_15[iVar0], Global_35, "CALLOUT_GET_FLEEING_MALE", -1073741824, 1, joaat("SPEECH_PARAMS_BEAT_SHOUTED_CLEAR"), 0);
					bVar3 = true;
				}
				else
				{
...
{
	if (func_358(iParam1, 1114636288) || func_360(iParam1, 1, 1) <= 30.0f)
	{
		return false;
	}
	return true;
...
void func_248(var uParam0, float fParam1)
{
	...
	func_375(uParam0->f_237, "ambush_restriction", 1, 0, (1 << 9), 0, -1082130432);
...
void func_298()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(iLocal_15[iVar0], 0, 1))
		{
			...
			{
				if (func_219(iLocal_15[iVar0], 80.0f, 30.0f, iLocal_15.f_9[iVar0], -1082130432))
				{
					func_275(&iLocal_15, iVar0, joaat("BLIP_STYLE_ENEMY"), 0);
				}
			}
...
bool func_312(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_421(iParam0, joaat("CURRENCY_CASH"), iParam1, iVar0);
	}
...
bool func_354(var uParam0, int iParam1)
{
	...
	{
		if (func_219(iParam1, 200.0f, (30.0f * 3.0f), -1082130432, -1082130432))
		{
			return false;
		}
	}
	else if (func_219(iParam1, 200.0f, 30.0f, -1082130432, -1082130432))
	{
		return false;
	}
	if (!PED::IS_PED_HUMAN(iParam1))
...
int func_506(var uParam0, float fParam1, int iParam2)
{
	...
	return func_607(&iVar0, uParam0->f_209, fParam1, 0, 0, 1084227584, bVar6, iParam2);
}
...
struct<5> /*40*/ func_628(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_701(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_632(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_703(iParam0, 1))
			{
				...
				if (!func_630(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_630(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_631(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_632(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
