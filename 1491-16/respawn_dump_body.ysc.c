	...
	while (true)
	{
		...
		switch (iLocal_29)
		{
			...
			case 6:
				...
				{
					PED::SET_PED_RESET_FLAG(sLocal_32.f_98, 105, true);
				}
				if (sLocal_32.f_53)
				{
...
{
	if (-1829635046 == func_131(joaat("CI_CATEGORY_WARDROBE_MASK")))
	{
		if (func_132(uParam0))
		{
			return true;
...
void func_622(var uParam0)
{
	...
	{
		MAP::_SET_BLIP_NAME_FROM_PLAYER_STRING(*uParam0, func_645(func_644(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_570())
	{
