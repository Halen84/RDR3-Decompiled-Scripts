...
bool func_59(var uParam0)
{
	...
	if (*uParam0 == -415839138)
	{
		if (!ENTITY::IS_ENTITY_DEAD(sLocal_63.f_1[0]))
		{
			...
			PED::SET_PED_CONFIG_FLAG(sLocal_63.f_1[0], 297, true);
		}
		if (VOLUME::DOES_VOLUME_EXIST(iLocal_41))
		{
	...
	else if (*uParam0 == 1861313914)
	{
		if (!ENTITY::IS_ENTITY_DEAD(sLocal_63.f_1[0]))
		{
			...
			PED::SET_PED_CONFIG_FLAG(sLocal_63.f_1[0], 273, true);
...
int func_83(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	{
		if ((!func_222(iParam0, joaat("CI_TAG_ITEM_TALISMAN")) && !func_222(iParam0, joaat("CI_TAG_ITEM_UPGRADE"))) && !func_222(iParam0, 1248798204))
		{
			bVar3 = true;
		}
	}
...
void func_137(var uParam0)
{
	...
	if ((*uParam0 == -654238687 || *uParam0 == 1861313914) || *uParam0 == -35775921)
	{
		...
		if (!VOLUME::DOES_VOLUME_EXIST(iLocal_43) && *uParam0 == 1861313914)
		{
			vVar0 = { 895.55f, -1968.068f, 43.71555f /*3*/ };
			vVar3 = { 0.0f, 0.0f, 0.0f /*3*/ };
...
bool func_404(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		...
		{
			if (func_608(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar0, 1995362678, 0)))
			{
				bVar1 = true;
			}
			else if (iParam5 == 8)
...
int func_451()
{
	...
	while (iVar1 < 5)
	{
		if (func_646(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_599()
{
	...
	while (iVar1 < 14)
	{
		if (func_608(COLLECTION::_COLLECTABLE_GET_COLLECTABLE_ITEM_HASH(iVar1, 1995362678, 0)))
		{
			iVar0++;
		}
		iVar1++;
