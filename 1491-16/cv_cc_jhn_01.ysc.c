...
{
	func_263(uParam0, iParam1, 0, 0, 0, -1, 0, 0.0f, 1065353216, 1);
}
...
int func_359(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_398(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
