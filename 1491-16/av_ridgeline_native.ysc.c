...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	if (func_47(Global_35, vParam1) >= -12.0f)
	{
		uParam0->f_499 = 1;
	}
	...
	{
		case 0:
			func_50(uParam0, 0, "RNP_MAN_1", iVar0, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.5f, 1.25f, 0.0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 3, "RNP_HORSE_1", iVar1, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			uParam0->f_19 = 4;
			break;
		case 1:
			func_50(uParam0, 0, "RNP_MAN_1", iVar0, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.5f, 1.25f, 0.0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 1, "RNP_MAN_2", iVar0, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, -1.75f, 1.25f, 0.0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 3, "RNP_HORSE_1", iVar1, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 4, "RNP_HORSE_2", iVar1, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, -2.0f, -1.0f, 0.0f), (25.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			uParam0->f_19 = 5;
			break;
		case 2:
			func_50(uParam0, 0, "RNP_MAN_1", iVar0, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.5f, 1.25f, 0.0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 1, "RNP_MAN_2", iVar0, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, -1.75f, 1.25f, 0.0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 2, "RNP_MAN_3", iVar0, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 1.75f, 0.75f, 0.0f), (-15.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 3, "RNP_HORSE_1", iVar1, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 4, "RNP_HORSE_2", iVar1, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, -2.0f, -1.0f, 0.0f), (25.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 5, "RNP_HORSE_3", iVar1, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 2.75f, -1.6f, 0.0f), (-15.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			break;
	}
}
	...
	while (iVar0 < uParam0->f_19)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[iVar0 /*14*/]))
		{
			...
			if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(uParam0->f_20[iVar0 /*14*/], true))
			{
				...
				{
					PED::_SET_REMOVE_PED_NETWORKED(uParam0->f_20[iVar0 /*14*/], -1);
					PED::_SET_PED_TO_BE_REMOVED(uParam0->f_20[iVar0 /*14*/], 5.0f, 5.0f, 1000, 1000);
					ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(uParam0->f_20[iVar0 /*14*/]));
				}
...
void func_68(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
		{
			PED::SET_PED_SHOULD_PLAY_FLEE_SCENARIO_EXIT(uParam0->f_20[iVar0 /*14*/], Global_36, 3);
			TASK::OPEN_SEQUENCE_TASK(&iVar1);
			if (!PED::IS_PED_ON_MOUNT(uParam0->f_20[iVar0 /*14*/]))
			{
				if (iVar0 == 0)
				{
					TASK::TASK_MOUNT_ANIMAL(0, uParam0->f_20[3 /*14*/], -1, -1, 2.0f, 1, 0, 0);
				}
				else if (iVar0 == 1)
				{
					TASK::TASK_MOUNT_ANIMAL(0, uParam0->f_20[4 /*14*/], -1, -1, 2.0f, 1, 0, 0);
				}
				else
				{
					TASK::TASK_MOUNT_ANIMAL(0, uParam0->f_20[5 /*14*/], -1, -1, 2.0f, 1, 0, 0);
				}
			}
...
void func_69(var uParam0, bool bParam1, int iParam2)
{
	if (!bParam1)
	{
		...
		{
			if (!func_104(uParam0->f_20[iParam2 /*14*/], joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[iParam2 /*14*/], joaat("WEAPON_BOW"), 500, false, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), true, 0.0f, false);
...
void func_71(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		...
		TASK::TASK_FLEE_PED(0, Global_35, 1, (1 << 19), -1.0f, -1, 0);
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		...
		TASK::TASK_FLEE_PED(0, Global_35, 1, (1 << 19), -1.0f, -1, 0);
		TASK::CLOSE_SEQUENCE_TASK(iVar0);
		TASK::_TASK_PERFORM_SEQUENCE_2(uParam0->f_20[1 /*14*/], iVar0, 1.0f, 1.0f);
...
int func_105(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_165(*uParam0, 0.0f, 0.0f, 0.0f))
	{
		return 1;
	}
	iVar1 = 0;
