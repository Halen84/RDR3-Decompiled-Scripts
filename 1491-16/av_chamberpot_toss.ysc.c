...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_49(uParam0, 0, "Ped", iVar0, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.0f, -6.0f, 0.0f), vParam4.z, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_18(var uParam0)
{
	...
	{
		iLocal_37 = func_50(joaat("WORLD_HUMAN_CHAMBERPOT_EMPTY_RAILING"), uParam0->f_483, uParam0->f_486.f_2, 0, 1000.0f, 0);
	}
	return 0;
}
...
int func_31(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		...
		if (!uParam0->f_469[2])
		{
			if (func_68(uParam0, 0.1f, 60.0f, 4, 33.0f, 1112014848))
			{
				func_66(uParam0);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
				{
					if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_37))
					{
						TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[0 /*14*/], iLocal_37, 0, 1000, true, false, 0, true, -1.0f, false);
						uParam0->f_469[2] = 1;
					}
				}
			}
		...
		if (uParam0->f_469[2])
		{
			if (func_69(uParam0->f_20[0 /*14*/], joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
			{
				if (!uParam0->f_469[4])
				{
					if (func_70(uParam0, 1065353216, 1116471296, 4, joaat("ACTION"), 0))
					{
						func_67(*uParam0, uParam0->f_483, 0);
						uParam0->f_469[4] = 1;
					}
