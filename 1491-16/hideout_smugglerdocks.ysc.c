...
void func_17(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0.0f, 0.0f, 0.0f) <= 5.0f || func_49(Global_1935630, (1 << 14))) || func_49(Global_1935630, (1 << 23)))
	{
		return;
	}
...
void func_56(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_42(iParam0) && func_35(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
...
void func_73(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case joaat("WS_DOWNS_RANCH_DOWNS"):
			func_135(joaat("WS_DOWNS_RANCH_DOWNS"));
			func_136(joaat("WS_DOWNS_RANCH_EDITH"));
			func_136(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_136(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_DOWNS_RANCH_EDITH"):
			func_136(joaat("WS_DOWNS_RANCH_DOWNS"));
			func_135(joaat("WS_DOWNS_RANCH_EDITH"));
			func_136(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_136(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_DOWNS_RANCH_EMPTY"):
			func_136(joaat("WS_DOWNS_RANCH_DOWNS"));
			func_136(joaat("WS_DOWNS_RANCH_EDITH"));
			func_135(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_136(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_DOWNS_RANCH_REPOPULATED"):
			...
			func_136(joaat("WS_DOWNS_RANCH_EDITH"));
			func_136(joaat("WS_DOWNS_RANCH_EMPTY"));
			func_135(joaat("WS_DOWNS_RANCH_REPOPULATED"));
			break;
		case joaat("WS_PRONGHORN_RANCH_FENCE_FIXED"):
		case joaat("WS_PRONGHORN_RANCH_EXIST"):
		case joaat("WS_PRONGHORN_RANCH_EMPTY"):
			func_136(joaat("WS_PRONGHORN_RANCH_EXIST"));
			func_136(joaat("WS_PRONGHORN_RANCH_EMPTY"));
			func_136(joaat("WS_PRONGHORN_RANCH_FENCE_FIXED"));
			func_135(iParam0);
			break;
		...
		case joaat("WS_GUARMA3_TOWER_NORMAL"):
			func_136(joaat("WS_GUARMA3_TOWER_FRAG"));
			func_136(joaat("WS_GUARMA3_TOWER_DESTROYED"));
			func_135(joaat("WS_GUARMA3_TOWER_NORMAL"));
			break;
		case joaat("WS_GUARMA3_TOWER_FRAG"):
			func_136(joaat("WS_GUARMA3_TOWER_NORMAL"));
			func_136(joaat("WS_GUARMA3_TOWER_DESTROYED"));
			func_135(joaat("WS_GUARMA3_TOWER_FRAG"));
			break;
		case joaat("WS_GUARMA3_TOWER_DESTROYED"):
			func_136(joaat("WS_GUARMA3_TOWER_NORMAL"));
			func_136(joaat("WS_GUARMA3_TOWER_FRAG"));
			func_135(joaat("WS_GUARMA3_TOWER_DESTROYED"));
			break;
		case joaat("WS_RHODES_GRAVE_NORMAL"):
			func_136(joaat("WS_RHODES_GRAVE_FRESHLY_DUG"));
			func_136(joaat("WS_RHODES_GRAVE_OPEN"));
			func_135(joaat("WS_RHODES_GRAVE_NORMAL"));
			break;
		case joaat("WS_RHODES_GRAVE_FRESHLY_DUG"):
			func_136(joaat("WS_RHODES_GRAVE_NORMAL"));
			func_136(joaat("WS_RHODES_GRAVE_OPEN"));
			func_135(joaat("WS_RHODES_GRAVE_FRESHLY_DUG"));
			break;
		case joaat("WS_RHODES_GRAVE_OPEN"):
			func_136(joaat("WS_RHODES_GRAVE_NORMAL"));
			func_136(joaat("WS_RHODES_GRAVE_FRESHLY_DUG"));
			func_135(joaat("WS_RHODES_GRAVE_OPEN"));
			break;
		case joaat("WS_RHODES_SALOON_TABLE_UP"):
			func_136(joaat("WS_RHODES_SALOON_TABLE_DOWN"));
			func_135(joaat("WS_RHODES_SALOON_TABLE_UP"));
			break;
		case joaat("WS_RHODES_SALOON_TABLE_DOWN"):
			func_136(joaat("WS_RHODES_SALOON_TABLE_UP"));
			func_135(joaat("WS_RHODES_SALOON_TABLE_DOWN"));
			break;
		case joaat("WS_UTOPIA_TREE_STANDING"):
			func_136(joaat("WS_UTOPIA_TREE_MISSION"));
			func_136(joaat("WS_UTOPIA_TREE_FALLEN"));
			func_136(joaat("WS_UTOPIA_TREE_STUMP"));
			func_135(joaat("WS_UTOPIA_TREE_STANDING"));
			break;
		case joaat("WS_UTOPIA_TREE_MISSION"):
			func_136(joaat("WS_UTOPIA_TREE_STANDING"));
			func_136(joaat("WS_UTOPIA_TREE_FALLEN"));
			func_136(joaat("WS_UTOPIA_TREE_STUMP"));
			func_135(joaat("WS_UTOPIA_TREE_MISSION"));
			break;
		case joaat("WS_UTOPIA_TREE_FALLEN"):
			func_136(joaat("WS_UTOPIA_TREE_STANDING"));
			func_136(joaat("WS_UTOPIA_TREE_MISSION"));
			func_136(joaat("WS_UTOPIA_TREE_STUMP"));
			func_135(joaat("WS_UTOPIA_TREE_FALLEN"));
			break;
		case joaat("WS_UTOPIA_TREE_STUMP"):
			func_136(joaat("WS_UTOPIA_TREE_STANDING"));
			func_136(joaat("WS_UTOPIA_TREE_MISSION"));
			func_136(joaat("WS_UTOPIA_TREE_FALLEN"));
			func_135(joaat("WS_UTOPIA_TREE_STUMP"));
			break;
		case joaat("WS_MICAH_CAMP_EMPTY"):
			func_136(joaat("WS_MICAH_CAMP"));
			func_136(joaat("WS_MICAH_CAMP_POST"));
			func_135(joaat("WS_MICAH_CAMP_EMPTY"));
			break;
		case joaat("WS_MICAH_CAMP"):
			func_136(joaat("WS_MICAH_CAMP_EMPTY"));
			func_136(joaat("WS_MICAH_CAMP_POST"));
			func_135(joaat("WS_MICAH_CAMP"));
			break;
		case joaat("WS_MICAH_CAMP_POST"):
			func_136(joaat("WS_MICAH_CAMP_EMPTY"));
			func_136(joaat("WS_MICAH_CAMP"));
			func_135(joaat("WS_MICAH_CAMP_POST"));
			break;
		case joaat("WS_NBX_ART_EXHIBIT_OPEN"):
			if (bParam1)
			{
				func_136(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
				func_135(joaat("WS_NBX_ART_EXHIBIT_OPEN"));
			}
			else
			{
				func_136(joaat("WS_NBX_ART_EXHIBIT_OPEN"));
				func_136(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
			}
			break;
		case joaat("WS_NBX_ART_EXHIBIT_CANCELLED"):
			if (func_139(joaat("WS_NBX_ART_EXHIBIT_OPEN")))
			{
				if (bParam1)
				{
					func_135(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
				}
				else
				{
					func_136(joaat("WS_NBX_ART_EXHIBIT_CANCELLED"));
		...
		case joaat("WS_HERE_KITTY_3_CLUE_TRAIL_OFF"):
			func_136(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_ON"));
			func_135(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_OFF"));
			break;
		case joaat("WS_HERE_KITTY_3_CLUE_TRAIL_ON"):
			func_136(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_OFF"));
			func_135(joaat("WS_HERE_KITTY_3_CLUE_TRAIL_ON"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_GONE"):
			func_136(joaat("WS_HERE_KITTY_WAGONS_TRASHED"));
			func_136(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_136(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_136(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_135(joaat("WS_HERE_KITTY_WAGONS_GONE"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_TRASHED"):
			func_136(joaat("WS_HERE_KITTY_WAGONS_GONE"));
			func_136(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_136(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_136(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_135(joaat("WS_HERE_KITTY_WAGONS_TRASHED"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"):
			...
			func_136(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_136(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_135(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"):
			...
			func_136(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_136(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			func_135(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			break;
		case joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"):
			...
			func_136(joaat("WS_HERE_KITTY_WAGONS_PART_FIXED"));
			func_136(joaat("WS_HERE_KITTY_WAGONS_FIXED_WITH_CAMP"));
			func_135(joaat("WS_HERE_KITTY_WAGONS_FIXED_NO_CAMP"));
			break;
		case joaat("WS_NEW_COM_BANK_BEFORE"):
			func_136(joaat("WS_NEW_COM_BANK_START"));
			func_136(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_136(joaat("WS_NEW_COM_BANK_AFTER"));
			func_136(joaat("WS_NEW_COM_BANK_POST"));
			func_135(joaat("WS_NEW_COM_BANK_BEFORE"));
			break;
		case joaat("WS_NEW_COM_BANK_START"):
			func_136(joaat("WS_NEW_COM_BANK_BEFORE"));
			func_136(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_136(joaat("WS_NEW_COM_BANK_AFTER"));
			func_136(joaat("WS_NEW_COM_BANK_POST"));
			func_135(joaat("WS_NEW_COM_BANK_START"));
			break;
		case joaat("WS_NEW_COM_BANK_SHOOTOUT"):
			...
			func_136(joaat("WS_NEW_COM_BANK_AFTER"));
			func_136(joaat("WS_NEW_COM_BANK_POST"));
			func_135(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			break;
		case joaat("WS_NEW_COM_BANK_AFTER"):
			...
			func_136(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_136(joaat("WS_NEW_COM_BANK_POST"));
			func_135(joaat("WS_NEW_COM_BANK_AFTER"));
			break;
		case joaat("WS_NEW_COM_BANK_POST"):
			...
			func_136(joaat("WS_NEW_COM_BANK_SHOOTOUT"));
			func_136(joaat("WS_NEW_COM_BANK_AFTER"));
			func_135(joaat("WS_NEW_COM_BANK_POST"));
			break;
		case joaat("WS_NO_ANIMALS_GRIZZLIES"):
			func_136(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			func_136(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			func_136(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			func_135(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			break;
		case joaat("WS_LIGHT_ANIMALS_GRIZZLIES"):
			func_136(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			func_136(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			func_136(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			func_135(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			break;
		case joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"):
			func_136(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			func_136(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			func_136(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			func_135(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			break;
		case joaat("WS_NORMAL_ANIMALS_GRIZZLIES"):
			func_136(joaat("WS_NO_ANIMALS_GRIZZLIES"));
			func_136(joaat("WS_LIGHT_ANIMALS_GRIZZLIES"));
			func_136(joaat("WS_MEDIUM_ANIMALS_GRIZZLIES"));
			func_135(joaat("WS_NORMAL_ANIMALS_GRIZZLIES"));
			break;
		case joaat("WS_STRAWBERRY_HOUSE_STAGE_0"):
			func_135(joaat("WS_STRAWBERRY_HOUSE_STAGE_0"));
			func_136(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_136(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_136(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			break;
		case joaat("WS_STRAWBERRY_HOUSE_STAGE_1"):
			func_136(joaat("WS_STRAWBERRY_HOUSE_STAGE_0"));
			func_135(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_136(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_136(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			break;
		case joaat("WS_STRAWBERRY_HOUSE_STAGE_2"):
			func_136(joaat("WS_STRAWBERRY_HOUSE_STAGE_0"));
			func_136(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_135(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_136(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			break;
		case joaat("WS_STRAWBERRY_HOUSE_STAGE_3"):
			...
			func_136(joaat("WS_STRAWBERRY_HOUSE_STAGE_1"));
			func_136(joaat("WS_STRAWBERRY_HOUSE_STAGE_2"));
			func_135(joaat("WS_STRAWBERRY_HOUSE_STAGE_3"));
			break;
		case joaat("WS_CALIGA_HALL_TABACCO_START"):
			func_135(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_136(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_136(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			func_136(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			break;
		case joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"):
			func_135(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_136(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_136(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			func_136(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			break;
		case joaat("WS_CALIGA_HALL_TABACCO_BURNING"):
			func_135(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			func_136(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_136(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_136(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			break;
		case joaat("WS_CALIGA_HALL_TABACCO_BURNT"):
			func_135(joaat("WS_CALIGA_HALL_TABACCO_BURNT"));
			func_136(joaat("WS_CALIGA_HALL_TABACCO_START"));
			func_136(joaat("WS_CALIGA_HALL_TABACCO_DURING_MISSION"));
			func_136(joaat("WS_CALIGA_HALL_TABACCO_BURNING"));
			break;
		case joaat("WS_VALENTINE_BURIAL_DRUNK"):
			func_135(joaat("WS_VALENTINE_BURIAL_DRUNK"));
			func_136(joaat("WS_VALENTINE_BURIAL_POST_DRUNK"));
			break;
		case joaat("WS_VALENTINE_BURIAL_POST_DRUNK"):
			func_135(joaat("WS_VALENTINE_BURIAL_POST_DRUNK"));
			func_136(joaat("WS_VALENTINE_BURIAL_DRUNK"));
			break;
		case joaat("WS_VALENTINE_BURIAL_MURDER"):
			func_135(joaat("WS_VALENTINE_BURIAL_MURDER"));
			func_136(joaat("WS_VALENTINE_BURIAL_POST_MURDER"));
			break;
		case joaat("WS_VALENTINE_BURIAL_POST_MURDER"):
			func_135(joaat("WS_VALENTINE_BURIAL_POST_MURDER"));
			func_136(joaat("WS_VALENTINE_BURIAL_MURDER"));
			break;
		case 0:
			func_135(0);
			func_136(joaat("WS_BRAITHWAITE_MANSION_BURNED"));
			func_136(joaat("WS_BRAITHWAITE_MANSION_ENDLESS_SUMMER"));
			break;
		case joaat("WS_BRAITHWAITE_MANSION_BURNED"):
			func_135(joaat("WS_BRAITHWAITE_MANSION_BURNED"));
			func_136(0);
			func_136(joaat("WS_BRAITHWAITE_MANSION_ENDLESS_SUMMER"));
			break;
		case joaat("WS_BRAITHWAITE_MANSION_ENDLESS_SUMMER"):
			func_135(joaat("WS_BRAITHWAITE_MANSION_ENDLESS_SUMMER"));
			func_136(0);
			func_136(joaat("WS_BRAITHWAITE_MANSION_BURNED"));
			break;
		case joaat("WS_GRAVE_ARTHUR_GOOD"):
			func_135(joaat("WS_GRAVE_ARTHUR_GOOD"));
			func_136(joaat("WS_GRAVE_ARTHUR_BAD"));
			break;
		case joaat("WS_GRAVE_ARTHUR_BAD"):
			func_135(joaat("WS_GRAVE_ARTHUR_BAD"));
			func_136(joaat("WS_GRAVE_ARTHUR_GOOD"));
			break;
		case joaat("WS_OLDFORTWALLACE_WALL_INTACT"):
			func_135(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			func_136(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_136(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_136(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			break;
		case joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"):
			func_135(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_136(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			func_136(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_136(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			break;
		case joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"):
			func_135(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_136(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_136(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			func_136(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			break;
		case joaat("WS_OLDFORTWALLACE_WALL_BROKEN"):
			func_135(joaat("WS_OLDFORTWALLACE_WALL_BROKEN"));
			func_136(joaat("WS_OLDFORTWALLACE_WALL_INTACT_NTS3"));
			func_136(joaat("WS_OLDFORTWALLACE_WALL_BROKEN_NTS3"));
			func_136(joaat("WS_OLDFORTWALLACE_WALL_INTACT"));
			break;
		case joaat("WS_SHADY_BELLE_HIDEOUT"):
			if (bParam1)
			{
				func_135(joaat("WS_SHADY_BELLE_HIDEOUT"));
			}
			else
			{
				func_136(joaat("WS_SHADY_BELLE_HIDEOUT"));
			}
			func_136(joaat("WS_SHADY_BELLE_GANG_0_2"));
			func_136(joaat("WS_SHADY_BELLE_ABANDON"));
			break;
		case joaat("WS_SHADY_BELLE_ABANDON"):
			func_135(joaat("WS_SHADY_BELLE_ABANDON"));
			func_136(joaat("WS_SHADY_BELLE_GANG_0_2"));
			func_136(joaat("WS_SHADY_BELLE_HIDEOUT"));
			break;
		case joaat("WS_SHADY_BELLE_GANG_0_2"):
			func_135(joaat("WS_SHADY_BELLE_GANG_0_2"));
			func_136(joaat("WS_SHADY_BELLE_HIDEOUT"));
			func_136(joaat("WS_SHADY_BELLE_ABANDON"));
			break;
		case joaat("WS_BLACKWATER_PHOTOGRAPHER_FURNITURE"):
			if (bParam1)
			{
				func_135(joaat("WS_BLACKWATER_PHOTOGRAPHER_FURNITURE"));
			}
			else
			{
				func_136(joaat("WS_BLACKWATER_PHOTOGRAPHER_FURNITURE"));
			}
			break;
		case joaat("WS_SAINT_DENIS_PHOTOGRAPHER_FURNITURE"):
			if (bParam1)
			{
				func_135(joaat("WS_SAINT_DENIS_PHOTOGRAPHER_FURNITURE"));
			}
			else
			{
				func_136(joaat("WS_SAINT_DENIS_PHOTOGRAPHER_FURNITURE"));
			}
			break;
		default:
			if (bParam1)
...
void func_133(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((!bParam3 && ENTITY::DOES_ENTITY_EXIST(func_173(iParam0))) && func_176(iParam0) < 5000.0f) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
	func_174(iParam0, 4, 1);
...
void func_137()
{
	func_136(joaat("WS_COLTER_STAGE_WINTER1_INTRO"));
	func_136(joaat("WS_COLTER_STAGE_CABIN_BURNING"));
	func_136(joaat("WS_COLTER_STAGE_HIGH_SNOW"));
	func_136(joaat("WS_COLTER_STAGE_MEDIUM_SNOW"));
	func_136(joaat("WS_COLTER_STAGE_THAWED_SNOW"));
	func_136(joaat("WS_COLTER_STAGE_MUDTOWN1"));
	func_136(joaat("WS_COLTER_STAGE_MP"));
}

void func_138()
{
	func_136(joaat("WS_BEECHERS_SHACK"));
	func_136(joaat("WS_BEECHERS_SHACK_WITH_FIRE"));
	func_136(joaat("WS_BEECHERS_CAMP_WITH_SHACK"));
	func_136(joaat("WS_BEECHERS_CAMP_WITH_RUBBLE"));
	func_136(joaat("WS_BEECHERS_CAMP_WITH_SUPPLIES"));
	func_136(joaat("WS_BEECHERS_HOUSE_FINISHED"));
	func_136(joaat("WS_BEECHERS_BARN_FINISHED"));
	func_136(joaat("WS_BEECHERS_HOUSE_DECORATED"));
	func_136(joaat("WS_BEECHERS_HOUSE_ABIGAIL3"));
	func_136(joaat("WS_BEECHERS_HOUSE_FULLY_DECORATED"));
}
...
void func_178(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_176(iParam0) < 10000.0f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_181(Vector3 vParam0, int iParam3)
{
	...
	func_201(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_202(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
