...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	func_49(uParam0, 0, "AAP_MAN", func_48(func_47(), 0, 0, 0, 0, 0, 1), OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.0f, 0.0f, 0.0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 1, "AAP_ANIMAL", iVar0, OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, vParam4.z, 0.0f, 4.0f, 0.0f), (180.0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				if (*uParam0 == 45)
				{
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[0 /*14*/], joaat("WEAPON_RIFLE_VARMINT"), 5000, true, false, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), true, 0.0f, false);
					WEAPON::SET_CURRENT_PED_WEAPON(uParam0->f_20[0 /*14*/], joaat("WEAPON_RIFLE_VARMINT"), true, 0, false, false);
					sVar0.f_1 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_20[0 /*14*/], 0.0f, 1.0f, 0.24f) /*3*/ };
					sVar0.f_4 = -1;
					sVar0.f_6 = 1;
					sVar0.f_7 = 1;
					TASK::TASK_SHOOT_WITH_WEAPON(uParam0->f_20[0 /*14*/], &sVar0);
				}
				else
				{
					WEAPON::REMOVE_ALL_PED_WEAPONS(uParam0->f_20[0 /*14*/], true, true);
					TASK::TASK_PLAY_ANIM(uParam0->f_20[0 /*14*/], sLocal_10, sLocal_11, 4.0f, -4.0f, -1, 1, 0.0f, false, 0, false, 0, false);
				}
			}
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				func_66(&(uParam0->f_20[1 /*14*/].f_5), 50, 10, 0);
				PED::SET_PED_CONFIG_FLAG(uParam0->f_20[1 /*14*/], 263 /*PCF_NoCriticalHits*/, true);
		...
		case 3:
			if (!uParam0->f_469[2])
			{
				if (func_71(uParam0, 1065353216, 105.0f, 4, joaat("ACTION"), 0))
				{
					func_72(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[2] = 1;
				}
			}
			if (!func_73(uParam0->f_20[1 /*14*/], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
			{
				if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					if (*uParam0 == 45)
...
int func_66(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_102(*uParam0, 0.0f, 0.0f, 0.0f))
	{
		return 1;
	}
	iVar1 = 0;
...
void func_70(var uParam0)
{
	...
	PED::_SET_PED_DESIRED_LOCO_MOTION_TYPE(uParam0->f_20[1 /*14*/], "default");
	...
	{
		TASK::TASK_GRAPPLE(0, uParam0->f_20[0 /*14*/], iLocal_15, 1, 2.0f, 0, 0);
	}
	if (*uParam0 == 36)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
				{
					...
					{
						if ((func_107(Global_35, uParam0->f_20[iVar0 /*14*/], 1) < fParam2 && PED::_IS_PED_VISIBILITY_TRACKED(uParam0->f_20[iVar0 /*14*/])) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[iVar0 /*14*/]))
						{
							if (!func_108(&(uParam0->f_490)))
							{
...
void func_119(int iParam0, Vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_120(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
