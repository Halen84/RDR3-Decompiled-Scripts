...
void func_14(var uParam0, Vector3 vParam1, Vector3 vParam4)
{
	...
	if (*uParam0 == 123)
	{
		...
		else
		{
			...
			func_47(uParam0, 1, "BFS_BIRD_2", iLocal_9, func_48(-0.25f, 0.0f, 0.0f, vParam4) + vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_47(uParam0, 2, "BFS_BIRD_3", iLocal_9, func_48(0.25f, 0.0f, 0.0f, vParam4) + vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_47(uParam0, 3, "BFS_BIRD_4", iLocal_9, func_48(1.0f, 0.0f, 0.0f, vParam4) + vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_47(uParam0, 4, "BFS_BIRD_5", iLocal_9, func_48(-1.0f, 0.0f, 0.0f, vParam4) + vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_47(uParam0, 5, "BFS_BIRD_6", iLocal_9, func_48(-0.75f, 0.0f, 0.0f, vParam4) + vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_47(uParam0, 6, "BFS_BIRD_7", iLocal_9, func_48(-0.5f, 0.0f, 0.0f, vParam4) + vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_47(uParam0, 7, "BFS_BIRD_8", iLocal_9, func_48(0.5f, 0.0f, 0.0f, vParam4) + vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_47(uParam0, 8, "BFS_BIRD_9", iLocal_9, func_48(0.75f, 0.0f, 0.0f, vParam4) + vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		}
	}
	else if (*uParam0 == 80)
	{
		...
		else if (uParam0->f_489 == 3)
		{
			...
			func_47(uParam0, 10, "BFS_BIRD_11", iLocal_9, 1895.09f, -738.0f, 46.45f, 88.468f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		...
		else if (uParam0->f_489 == 10)
		{
			...
			func_47(uParam0, 7, "BFS_BIRD_8", iLocal_9, 2448.0f, 293.26f, 71.82f, -86.651f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		...
		else
		{
			...
			func_47(uParam0, 4, "BFS_BIRD_5", iLocal_9, -316.18f, -108.68f, 51.0f, -149.582f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	...
	else
	{
		...
		if (uParam0->f_489 == 0)
		{
			...
			func_47(uParam0, 7, "BFS_BIRD_8", iLocal_9, 1089.18f, 459.0f, 96.06f, 136.287f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
...
bool func_28(var uParam0)
{
	if (*uParam0 == 80)
	{
		iLocal_17 = VOLUME::CREATE_VOLUME_BOX(-309.7844f, -113.3582f, 49.77695f, 0.0f, 0.0f, 27.00785f, 19.72045f, 9.976815f, 3.902765f);
	}
	return true;
}
	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iLocal_19 /*14*/]))
			{
				...
				func_56(uParam0->f_20[iLocal_19 /*14*/], iLocal_11, uParam0->f_20[iLocal_19 /*14*/].f_5, uParam0->f_20[iLocal_19 /*14*/].f_8, 0, 0, 1, 0, -1082130432);
				if (*uParam0 == 80)
				{
					ENTITY::SET_ENTITY_COLLISION(uParam0->f_20[iLocal_19 /*14*/], false, false);
					FLOCK::_0xFDB008B3BCF5992F(uParam0->f_20[iLocal_19 /*14*/], 35.0f, 35.0f);
				}
				if (*uParam0 == 80)
				{
						...
						else
						{
							...
							while (iVar1 < iLocal_21)
							{
								if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar1 /*14*/]))
								{
									...
									if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[iLocal_19 /*14*/]))
									{
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iLocal_19 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(Global_35))
										{
											if (*uParam0 == 80)
											{
												if (iLocal_19 < 7)
												{
													TASK::TASK_FLEE_COORD(uParam0->f_20[iLocal_19 /*14*/], uParam0->f_20[iLocal_19 /*14*/].f_5, 3, 256, -1.0f, -1, 0);
													PED::SET_PED_KEEP_TASK(uParam0->f_20[iLocal_19 /*14*/], true);
												}
												else if (iLocal_19 < 14)
												{
													TASK::OPEN_SEQUENCE_TASK(&iVar3);
													TASK::TASK_FLEE_COORD(0, uParam0->f_20[iLocal_19 /*14*/].f_5, 3, 256, -1.0f, -1, 0);
											...
											{
												TASK::TASK_FLEE_PED(uParam0->f_20[iLocal_19 /*14*/], Global_35, 3, 0, -1.0f, -1, 0);
											}
											PED::SET_PED_KEEP_TASK(uParam0->f_20[iLocal_19 /*14*/], true);
										}
									}
									...
									{
										iLocal_20 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(joaat("EVENT_SHOCKING_BEAT_ALARMING_NEW"), uParam0->f_483, -1.0f, -1.0f, -1.0f, -1.0f, -1.0f, 3, 1);
										PED::_0x23BDE06596A22CEC(PED::GET_MOUNT(Global_35), 1, 0.15f, uParam0->f_20[5 /*14*/]);
										PED::_0x23BDE06596A22CEC(Global_35, 1, 1.0f, uParam0->f_20[5 /*14*/]);
										func_62(&uLocal_12);
										iLocal_10 = 4;
									}
									Jump @993; // curOff = 944
									if (*uParam0 == 80)
									{
										if (func_63(&uLocal_12, 15.0f))
										{
											return 1;
										}
									}
									else if (func_63(&uLocal_12, 5.0f))
									{
										return 1;
									}
									return 0;
...
int func_32(var uParam0, var uParam1)
{
	...
	{
		VOLUME::DELETE_VOLUME(iLocal_17);
	}
...
bool func_49(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_80(iVar0) && func_81(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
bool func_59(var uParam0)
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_15) > 1000)
	{
		...
		{
			ITEMSET::_CLEAR_ITEMSET(iLocal_18);
		}
		if (!VOLUME::DOES_VOLUME_EXIST(iLocal_16))
		{
			if (*uParam0 == 89)
			{
				iLocal_16 = VOLUME::CREATE_VOLUME_SPHERE(uParam0->f_20[0 /*14*/].f_5, 0.0f, 0.0f, 0.0f, 6.0f, 6.0f, 10.0f);
			}
			else
			{
				iLocal_16 = VOLUME::CREATE_VOLUME_SPHERE(uParam0->f_20[0 /*14*/].f_5, 0.0f, 0.0f, 0.0f, 25.0f, 25.0f, 10.0f);
			}
		}
		iVar0 = ENTITY::_GET_ENTITIES_IN_VOLUME(iLocal_16, iLocal_18, 1);
		iVar2 = 0;
		while (iVar2 < iVar0)
		{
...
bool func_67(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, Vector3 vParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
bool func_69(Vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_96(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1.0f, 0))
			{
				return true;
			}
		}
...
void func_93(int iParam0, Vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_96(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
