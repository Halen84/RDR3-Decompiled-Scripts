...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 37.025f, -10.025f, -2.675f, -2.75f, 3.005f, 5.265f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, joaat("P_FEATHER01X"), 3.0f, 3.0f, 0.0f, "Feather", 0, 0, 1);
	...
	sLocal_21 = { func_161(uParam0, 36.715f, -10.1275f, -3.975f, 180.0f, 7.0f, 0.7f, 0.744f) /*10*/ };
	func_162(uParam0, 1);
	return true;
}
...
{
	return func_193(uParam0, sLocal_21, 1, 0);
}
...
bool func_93(var uParam0)
{
	...
	if (func_201(uParam0, iLocal_16))
	{
		...
		if (func_202(iVar0, Global_35, 1, 1) < 15.0f)
		{
