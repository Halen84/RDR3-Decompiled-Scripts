...
bool func_11()
{
	if (func_20() == -1)
	{
		iLocal_9 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1006.947f, -545.158f, 98.0f, 0.0f, 0.0f, 8.306f, 13.464f, 17.135f, 4.0f, "Dakota River Trapper - m_volTrapper");
		iLocal_10 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1006.101f, -540.857f, 100.546f, 0.0f, 0.0f, 13.277f, 2.033f, 3.497f, 4.419f, "Dakota River Trapper - m_volTrapperPrompt");
		iLocal_11 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1008.955f, -541.376f, 100.546f, 0.0f, 0.0f, 13.277f, 3.137f, 4.933f, 4.419f, "Dakota River Trapper - m_volTrapperOfflimits");
	}
	return true;
}
...
char* func_118(char* sParam0, int iParam1)
{
	...
	return func_173(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
