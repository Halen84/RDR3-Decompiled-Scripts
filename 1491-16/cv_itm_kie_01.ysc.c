...
void func_18(var uParam0)
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_2268))
	{
		...
		while (iVar0 < uParam0->f_106)
		{
			...
			{
				AUDIO::REMOVE_ENTITY_FROM_AUDIO_MIX_GROUP(bVar1, 0.0f);
			}
			iVar0++;
		}
	}
...
bool func_76(var uParam0)
{
	...
	func_158(uParam0, 0.2865f, 1.346f, 0.0f, 0.0f, 2.8125f, 3.0925f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	func_159(uParam0, joaat("P_BRUSHHORSE01X"), 0.0f, 0.0f, 0.0f, "BRUSH", 0, 1, 1);
	...
	func_161(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_HORSE_TEND_BRUSH_LINK"), "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 18.0f, 1065353216, 1);
	...
	sLocal_20 = { func_164(uParam0, 0.435f, 1.5981f, 1.1559f, -92.88f, 5.5f, 1.0f, 1.0f) /*10*/ };
...
bool func_90(var uParam0)
{
	...
	fVar0 = (func_198(uParam0, 71.00332f) - 180.0f);
...
bool func_94(var uParam0)
{
	...
	{
		PLAYER::_0x3946FC742AC305CD(PLAYER::PLAYER_ID(), func_9(uParam0, iLocal_14), sLocal_34, 0.0f, 0.0f, 0.0f, func_199(uParam0, iLocal_19), sLocal_34);
		MISC::UNREGISTER_INTERACTION_LOCKON_PROMPT(func_9(uParam0, iLocal_14));
	}
...
bool func_97(var uParam0)
{
	...
	{
		TASK::TASK_START_SCENARIO_IN_PLACE_HASH(func_9(uParam0, iLocal_15), joaat("STAND"), 25000, false, 0, -1.0f, false);
	}
	return true;
}
...
{
	uParam0->f_23 = { func_263(iParam1) + Vector(fParam4, fParam3, fParam2) /*3*/ };
	uParam0->f_26 = { func_264(iParam1) /*3*/ };
}
...
int func_158(var uParam0, Vector3 vParam1, float fParam4, Vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_266(uParam0, vParam1) /*3*/ };
...
struct<10> /*80*/ func_164(var uParam0, Vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	...
	fVar0 = func_198(uParam0, (fParam4 + (fParam6 * 90.0f)));
	fVar1 = func_198(uParam0, (fParam4 - (fParam7 * 90.0f)));
	sVar2 = { func_266(uParam0, vParam1) /*3*/ };
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_268(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_282(uParam0->f_107[iVar12 /*113*/].f_1));
				}
		...
		else
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_1711[iVar0 /*15*/].f_13))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(bVar2))
				{
					...
					{
						uParam0->f_1711[iVar0 /*15*/].f_10 = PED::_GET_PED_REGISTER_PROP(bVar2, uParam0->f_1711[iVar0 /*15*/].f_13, true);
					}
				}
			}
			if (!uParam0->f_1711[iVar0 /*15*/].f_5 && !ENTITY::DOES_ENTITY_EXIST(uParam0->f_1711[iVar0 /*15*/].f_10))
			{
				...
				{
					vVar3 = { func_266(uParam0, uParam0->f_1711[iVar0 /*15*/].f_1) /*3*/ };
				}
				else
				{
...
void func_192(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROP_SET_2(uParam0->f_1976, func_266(uParam0, uParam0->f_1976.f_1), 1, func_198(uParam0, uParam0->f_1976.f_4), 3.0f, false, true);
	}
}
...
void func_196(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_302(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iVar2 /*113*/].f_5, true, false));
				iVar1 = func_302(uParam0->f_107[iVar2 /*113*/].f_96);
				if (iVar0 | iVar1)
				{
...
{
	if (!func_308(uParam0, sLocal_20, 1, 0))
	{
		func_8(&iLocal_32, 1, 1);
		if (!ENTITY::IS_ENTITY_DEAD(func_9(uParam0, iLocal_14)))
		{
	...
	iLocal_33 = 0;
	PLAYER::GET_PLAYER_INTERACTION_TARGET_ENTITY(PLAYER::PLAYER_ID(), &iLocal_33, false, false);
	if (iLocal_33 == 0)
	{
		func_8(&iLocal_32, 1, 1);
		return 0;
	...
	{
		iLocal_32 = func_309("INTERACT_GREET", joaat("INPUT_INTERACT_LOCKON_POS"), func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		func_310(iLocal_32, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(func_9(uParam0, iLocal_14)), 0, 1);
	}
...
void func_207(var uParam0)
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_2268))
	{
		...
		while (iVar0 < uParam0->f_106)
		{
			...
			{
				AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(bVar1, uParam0->f_2268, 0.0f);
			}
			iVar0++;
		}
	}
...
float func_223(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_335(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
bool func_255(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_344(iVar0) && func_345(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
bool func_279(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if (uParam0->f_1711[iVar1 /*15*/].f_5)
		{
			...
			{
				vVar2 = { func_266(uParam0, uParam0->f_1711[iVar1 /*15*/].f_1) /*3*/ };
			}
			else
			{
...
int func_301(int iParam0, struct<8> /*64*/ sParam1, int iParam9)
{
	int iVar0;
	var uVar1;
...
bool func_308(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
	...
	if (!func_367(sParam1, sParam1.f_6, Global_36))
	{
		return false;
	}
	if (func_367(sParam1, sParam1.f_3, Global_36))
	{
		return false;
	}
	if (bParam12)
...
int func_309(char* sParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 48)
	{
		if (func_220(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_368(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, bParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_321(var uParam0)
{
	...
	{
		UILOG::_UILOG_ADD_ENTRY_HASH(8, iVar0, func_380(func_24()), 1307979820, func_381(*uParam0), 0);
...
void func_324(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		sVar3 = func_388(&cVar4, joaat("COLOR_PURE_WHITE"));
		sVar2 = func_389(uParam0->f_3, 0);
		func_383(uParam0, 1896170705, MISC::VAR_STRING(168, iVar0, sVar2, sVar3, sVar1), 0, bParam1, 0);
	}
	else
	{
		func_383(uParam0, 1896170705, HUD::GET_STRING_FROM_HASH_KEY(iVar0), 0, bParam1, 0);
	}
}
...
void func_333(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_353(100.0f, 140.0f);
			}
		}
		...
		else if (func_21(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_409(&iVar2, func_408(iVar3)))
					{
...
void func_364(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_415(iParam1))
		{
			func_416(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_367(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
void func_383(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(8, func_377(*uParam0), iParam1, sParam2, bParam3, bParam5, false);
		if (bParam4)
		{
...
bool func_385(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((Global_1898164.f_163 && !func_435(iParam0, 1)) || func_436((1 << 15)))
	{
		if (!func_435(iParam0, (1 << 18)) || !Global_1905944.f_5696)
		{
			return false;
		}
	}
...
char* func_388(char* sParam0, int iParam1)
{
	...
	return func_438(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
bool func_401(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	bool bVar0;
...
int func_427(int iParam0, int iParam1)
{
	...
	if (func_474(iParam0, joaat("CI_TAG_ITEM_AMMOBOX")))
	{
...
int func_428(int iParam0, bool bParam1)
{
	...
	sVar0 = { func_476(iParam0, joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), joaat("SLOTID_NONE"), 0, 0) /*18*/ };
	if (bParam1)
	{
		func_478(&sVar0, func_477(0));
	}
	if (!func_479(&sVar0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_480(iVar18);
...
int func_431(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, bool bParam13)
{
	struct<5> /*40*/ sVar0;
	struct<8> /*64*/ sVar13;
	int iVar21;
...
bool func_434(int iParam0)
{
	...
	if (!func_435(iParam0, (1 << 16)) && !func_435(iParam0, (1 << 15)))
	{
		return false;
	}
	iVar0 = 0;
	while (iVar0 < Global_40.f_7756)
	{
		if (Global_40.f_7756[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			if (iVar2 < 1800 && func_435(iParam0, (1 << 15)))
			{
				return true;
			}
		}
...
int func_446(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_485(fVar9) /*3*/ };
			vVar13 = { func_486(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
void func_455(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_496(func_109(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_497(iParam0);
...
struct<18> /*144*/ func_476(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
struct<4> /*32*/ func_477(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_521(joaat("CARRIED_WEAPONS"), func_520(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_521(joaat("CARRIED_WEAPONS"), func_520(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_521(joaat("CARRIED_WEAPONS"), func_520(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

void func_478(var uParam0, struct<4> /*32*/ sParam1)
{
...
bool func_493(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_EQUIP_META_PED_OUTFIT(bParam1, func_292(iParam0));
	PED::_UPDATE_PED_VARIATION(bParam1, false, true, true, true, false);
...
void func_494(int iParam0, int iParam1)
{
	...
	func_455(iParam1, func_291(iParam1, (1 << 13)), func_291(iParam1, (1 << 14)), 1);
}
...
struct<4> /*32*/ func_521(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, iParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_549(iParam0, &sVar0, iVar5, 0))
			{
				...
				{
					sVar29 = { func_521(iParam0, sVar0, iVar5, 0) /*4*/ };
...
struct<5> /*40*/ func_547(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_426(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_521(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_521(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
...
void func_554(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_566(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> /*32*/ func_558(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_521(joaat("EMOTE_ITEM"), func_520(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_521(joaat("EMOTE_ITEM"), func_520(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
int func_562(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	...
	sVar0 = { func_521(iParam0, sParam1, iParam5, bParam6) /*4*/ };
...
bool func_563(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_429(0);
	*uParam1 = { func_521(iParam0, func_477(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
