...
void __SCRIPT()
{
	...
	func_2(&sLocal_28, &uScriptParam_0);
	while (!func_3(&sLocal_28))
	{
		func_4(&sLocal_28);
		switch (func_5(sLocal_28))
		{
			case 0:
				if (func_6(&sLocal_28))
				{
...
void func_11(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		if (func_15(iLocal_4[iVar0]))
		{
			...
			func_13(iLocal_4[iVar0], 0, 0, 0, 45.0f, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
...
int func_21(var uParam0)
{
	...
	if (func_50(Global_35, 653.5355f, -1253.288f, 42.8492f, 300.0f, 1, 1))
	{
		bLocal_27 = true;
		iLocal_10 = 5;
		iLocal_11 = 3;
...
void func_39(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		PED::SET_PED_CONFIG_FLAG(func_76(iParam0), 137 /*PCF_0xE18960DE*/, true);
	}
}
...
void func_41(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		PED::SET_PED_CONFIG_FLAG(func_76(iParam0), 204 /*PCF_0x435F091E*/, true);
	}
	else
	{
		PED::SET_PED_CONFIG_FLAG(func_76(iParam0), 204 /*PCF_0x435F091E*/, false);
	}
}
...
void func_43(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_76(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_78(iParam0) < 10000.0f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_51()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_18[0]))
	{
		...
		else if ((ENTITY::DOES_ENTITY_EXIST(iLocal_18[0]) && !func_84(iLocal_18[0])) && !func_50(Global_35, 676.5199f, -1227.448f, 43.6281f, 5.0f, 1, 1))
		{
			func_85(iLocal_18[0], 676.5199f, -1227.448f, 43.6281f, 10.0f, 0);
		}
	}
	...
	if (func_15(0))
	{
		...
		switch (iLocal_10)
		{
			...
			case 6:
				...
				func_29(0, (1 << 22), 0);
				if ((!func_86(uLocal_7[0], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) && !func_87(uLocal_7[0])) && !PED::IS_PED_USING_ANY_SCENARIO(uLocal_7[0]))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_3);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 654.2048f, -1253.218f, 42.8467f, 1.0f, -1, 0.25f, 0, 40000.0f);
					TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(0, 654.2048f, -1253.218f, 42.8467f, 10.0f, 30000, false, true, false, false);
					func_88(uLocal_7[0], &iLocal_3, 0, 0, 1, 1);
				}
				if (func_15(0) && TASK::IS_PED_ACTIVE_IN_SCENARIO(uLocal_7[0], 0))
				{
					func_13(0, 0, 0, 0, 45.0f, 1, 1, 0, 0, 0, 0);
				}
				break;
		}
	}
	...
	if (func_15(3))
	{
		...
		switch (iLocal_11)
		{
			case 3:
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_22))
				{
					func_89(iLocal_22, 843.3488f, -1126.801f, 56.4139f, 46.0894f, 2, (1 << 30));
					func_29(3, (1 << 22), 0);
					func_26(&uLocal_15, 0);
					iLocal_11 = 4;
				}
				...
				break;
			case 4:
				if (!func_86(uLocal_7[1], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")))
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_3);
					TASK::TASK_LEAVE_VEHICLE(0, iLocal_22, 0, 0);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 663.9668f, -1265.367f, 42.8657f, 1.85f, -1, 0.25f, 0, 40000.0f);
					func_88(uLocal_7[1], &iLocal_3, 0, 0, 1, 1);
				}
				if ((TASK::GET_SCRIPT_TASK_STATUS(uLocal_7[1], joaat("SCRIPT_TASK_PERFORM_SEQUENCE"), true) == 8 || func_91(&uLocal_15) > 35000) || TASK::IS_PED_ACTIVE_IN_SCENARIO(uLocal_7[1], 1))
				{
					ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_22);
				...
				break;
			case 6:
				if (!func_50(uLocal_7[1], 663.9668f, -1265.367f, 42.8657f, 100.0f, 1, 1))
				{
	...
	if (func_15(0))
	{
		...
		switch (iLocal_10)
		{
			...
			case 4:
				...
				if (iVar1 > 272)
				{
					vVar2 = { 675.2753f, -1225.374f, 43.6898f /*3*/ };
					TASK::OPEN_SEQUENCE_TASK(&iLocal_3);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar2, 1.25f, 20000, 0.25f, 0, 40000.0f);
					TASK::TASK_DISMOUNT_ANIMAL(0, 0, 0, 0, 0, 0);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 654.2048f, -1253.218f, 42.8467f, 1.0f, -1, 0.25f, 0, 40000.0f);
					TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(0, 654.2048f, -1253.218f, 42.8467f, 10.0f, 10000, false, true, false, false);
					func_88(uLocal_7[0], &iLocal_3, 0, 0, 1, 1);
					iLocal_10 = 7;
				}
				break;
			case 7:
				if (!func_86(uLocal_7[0], joaat("SCRIPT_TASK_PERFORM_SEQUENCE")) || TASK::IS_PED_ACTIVE_IN_SCENARIO(uLocal_7[0], 0))
				{
					func_13(0, 0, 0, 0, 45.0f, 1, 1, 0, 0, 0, 0);
					return true;
				}
		...
		if (func_94(uLocal_7[0], Global_35, 1, 1) > 275.0f && !ENTITY::IS_ENTITY_ON_SCREEN(uLocal_7[0]))
		{
	...
	if (func_15(3))
	{
		...
		switch (iLocal_11)
		{
			...
			case 4:
				...
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_3);
					TASK::TASK_VEHICLE_DRIVE_TO_DESTINATION(0, iLocal_22, 843.7542f, -1023.801f, 50.9411f, 7.0f, 69222692, 1, 50.0f, 2.0f, false);
					TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(0, iLocal_22, sLocal_26, 524295, 1, 9218, -1, -1.0f, false, (1 << 30), 0);
					TASK::TASK_LEAVE_VEHICLE(0, iLocal_22, 0, 0);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 779.7314f, -1169.254f, 45.9987f, 1.0f, -1, 0.25f, 0, 40000.0f);
					TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(0, 779.7314f, -1169.254f, 45.9987f, 50.0f, 30000, false, true, false, false);
					func_88(uLocal_7[1], &iLocal_3, 0, 0, 1, 1);
					iLocal_11 = 6;
				}
				break;
			case 6:
				if (func_94(uLocal_7[1], Global_35, 1, 1) > 275.0f)
				{
					func_89(iLocal_22, 843.3488f, -1126.801f, 56.4139f, 46.0894f, 2, (1 << 30));
					ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_22);
					func_29(3, (1 << 22), 0);
				...
				{
					func_13(3, 0, 0, 0, 45.0f, 1, 1, 0, 0, 0, 0);
					ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_22);
				}
				break;
		}
...
void func_62(int iParam0)
{
	...
	func_64(iParam0, (1 << 11));
	func_64(iParam0, (1 << 12));
	func_64(iParam0, (1 << 16));
	func_64(iParam0, (1 << 14));
	func_64(iParam0, (1 << 18));
	func_64(iParam0, (1 << 19));
	func_64(iParam0, (1 << 20));
	func_64(iParam0, (1 << 21));
	func_64(iParam0, (1 << 15));
	func_64(iParam0, (1 << 17));
...
void func_68(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & 1) > 0 && func_66(iParam1, 860729266))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 860729266);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 12)) > 0 && func_66(iParam1, 879715242))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 879715242);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & 128) > 0 && func_66(iParam1, 1606325429))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1606325429);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & 256) > 0 && func_66(iParam1, 1743550585))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1743550585);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 9)) > 0 && func_66(iParam1, 1064646155))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1064646155);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 10)) > 0 && func_66(iParam1, -536694793))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -536694793);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 11)) > 0 && func_66(iParam1, -1304053509))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1304053509);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 31)) > 0 && func_66(iParam1, 718939204))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 718939204);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 16)) > 0 && func_66(iParam1, -972364774))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -972364774);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 14)) > 0 && func_66(iParam1, -1100875244))
	{
	...
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 18)) > 0 && func_66(iParam1, 1153596794))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1153596794);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 19)) > 0 && func_66(iParam1, 1016389820))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1016389820);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 20)) > 0 && func_66(iParam1, -726966617))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -726966617);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 21)) > 0 && func_66(iParam1, 1365901568))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 1365901568);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 15)) > 0 && func_66(iParam1, -1658942149))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1658942149);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 17)) > 0 && func_66(iParam1, -1980913856))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1980913856);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 22)) > 0 && func_66(iParam1, 491764525))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 491764525);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 23)) > 0 && func_66(iParam1, -76015264))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -76015264);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 24)) > 0 && func_66(iParam1, 622113465))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 622113465);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 25)) > 0 && func_66(iParam1, 781533162))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 781533162);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 26)) > 0 && func_66(iParam1, -271415321))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -271415321);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 27)) > 0 && func_66(iParam1, -1683207356))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1683207356);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 28)) > 0 && func_66(iParam1, -254794762))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -254794762);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 29)) > 0 && func_66(iParam1, 609066278))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, 609066278);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 30)) > 0 && func_66(iParam1, -1712783565))
	{
		PED::_EQUIP_META_PED_OUTFIT(iParam1, -1712783565);
	}
	if ((Global_40.f_4942[iParam0 /*60*/].f_5 & (1 << 13)) > 0 && func_66(iParam1, 1544915253))
	{
...
int func_81(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	...
	iVar0 = func_45(iParam1);
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !func_36(iVar0, 0)) || (bParam3 && !func_58(iParam1)))
	{
		if (bParam2)
		{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0) && func_36(iVar0, 0))
	{
		*uParam0 = 2;
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_89(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, (1 << 30));
			}
			else if (bParam16)
			{
...
void func_85(int iParam0, Vector3 vParam1, float fParam4, bool bParam5)
{
	...
	iVar1 = TASK::FIND_SCENARIO_OF_TYPE_HASH(vParam1, iVar0, fParam4, 0, false);
...
void func_89(int iParam0, Vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_133(iParam0))
	{
		if (func_84(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0)))
		{
...
void func_90(int iParam0)
{
	...
	{
		if ((VEHICLE::IS_DRAFT_VEHICLE(iParam0) || func_134(iParam0)) && !ENTITY::IS_ENTITY_DEAD(iParam0))
		{
...
int func_91(var uParam0)
{
	...
	return (func_136() - BUILTIN::ROUND((uParam0->f_1 * 1000.0f)));
}
...
bool func_95(int iParam0, bool bParam1)
{
	...
	return PED::IS_PED_GROUP_MEMBER(iVar0, func_137(), true);
}
...
float func_100(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_83(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_118(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_149(iParam0) && func_150(iParam0, &cVar4))
				{
					PERSCHAR::_SET_PERSCHAR_SCHEDULE(func_101(iParam0, 1), &cVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_124(vVar0)) && !func_154(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608, 1))
			{
				if (ENTITY::IS_ENTITY_ATTACHED(Global_1360165[iParam0 /*1157*/].f_124))
				{
					ENTITY::DETACH_ENTITY(Global_1360165[iParam0 /*1157*/].f_124, true, true);
				}
				func_89(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, (1 << 30));
			}
			if (bParam1)
			{
				if (!ENTITY::_DOES_THREAD_OWN_THIS_ENTITY(Global_1360165[iParam0 /*1157*/].f_124))
...
void func_120(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_158(func_45(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_107(iParam0);
...
bool func_123(int iParam0, Vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_164(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) /*7*/ };
			if (!bParam6)
			{
				func_35(iParam0, 44, 1);
			}
...
void func_131(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_171(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_171(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
bool func_152(int iParam0, Vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489.f_12) || (bParam5 && Global_1359489.f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_GET_PERSCHAR_MODEL_NAME(func_101(iParam0, 1));
			STREAMING::REQUEST_MODEL(iVar0, false);
			if (STREAMING::HAS_MODEL_LOADED(iVar0))
			{
				Global_1360165[iParam0 /*1157*/].f_124 = func_176(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
bool func_153(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_EQUIP_META_PED_OUTFIT(iParam1, func_178(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, false, true, true, true, false);
...
void func_155(int iParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_76(iParam1), iParam0, false);
		PED::_0xED1C764997A86D5A(func_76(iParam1), iParam0);
	...
	func_120(iParam1, func_177(iParam1, (1 << 13)), func_177(iParam1, (1 << 14)), 1);
}
...
void func_158(int iParam0, float fParam1, bool bParam2)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		fParam1 = func_182(fParam1, 0.0f, 1.0f);
...
struct<7> /*56*/ func_164(int iParam0, int iParam1, Vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	struct<7> /*56*/ sVar0;
...
int func_171(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_193(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0.0f;
...
int func_193(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
	...
	{
		sVar0 = { func_206(iParam0, 0, 1) /*5*/ };
		iVar5 = joaat("SLOTID_WEAPON_0");
		sVar6.f_9 = joaat("SLOTID_NONE");
		iVar28 = 0;
		while (iVar28 < 4)
		{
			iVar5 = func_207((398 + iVar28), 1);
			if (func_208(iParam0, &sVar0, iVar5, 0))
			{
				if (func_209(iParam0, &sVar6, iVar5))
				{
					sVar29 = { func_210(iParam0, sVar0, iVar5, 0) /*4*/ };
					func_211(iParam0, &sVar29, &sVar0, 1, joaat("REMOVE_REASON_DEFAULT"), 1, 0);
				}
				else
				{
					iVar28++;
...
void func_200(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_215(iParam1))
		{
			func_216(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
struct<5> /*40*/ func_206(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;

	sVar0 = { func_222(bParam1) /*4*/ };
	...
	switch (func_223(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_210(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
			...
			break;
		case joaat("WEAPON"):
			sVar0 = { func_224(bParam1) /*4*/ };
			if (bParam2 && func_225(iParam0, 1))
			{
				sVar5.f_9 = joaat("SLOTID_NONE");
				if (!func_208(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_208(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_209(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_228(iParam0, joaat("CI_CATEGORY_CAMP")))
			{
				sVar0 = { func_210(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("KIT_CAMP"));
			}
			else if (func_228(iParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_210(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("WARDROBE"));
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_229(sVar0, &sVar27, bParam1, 0))
				{
					sVar0.f_4 = 0;
				}
				else
...
struct<4> /*32*/ func_210(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_233(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}
...
bool func_211(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!func_229(*uParam1, &sVar0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_233(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
void func_214(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_236(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> /*32*/ func_222(bool bParam0)
{
...
struct<4> /*32*/ func_224(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_210(joaat("CARRIED_WEAPONS"), func_222(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_210(joaat("CARRIED_WEAPONS"), func_222(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_210(joaat("CARRIED_WEAPONS"), func_222(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_225(int iParam0, bool bParam1)
{
	if (func_227(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
struct<4> /*32*/ func_226(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_210(joaat("EMOTE_ITEM"), func_222(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_210(joaat("EMOTE_ITEM"), func_222(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
bool func_229(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_233(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_230(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	sVar0 = { func_210(iParam0, sParam1, iParam5, bParam6) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&sVar0))
	{
		return 0;
	}
	iVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_233(bParam6), &sVar0, false);
	return iVar4;
}
...
bool func_231(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_233(0);
	*uParam1 = { func_210(iParam0, func_224(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
