...
void __EntryFunction__()
{
	...
	vLocal_45 = { -230.9494f, 797.3469f, 134.418f /*3*/ };
...
void func_2()
{
	iLocal_43 = VOLUME::CREATE_VOLUME_BOX(-230.0599f, 797.554f, 134.0912f, 0.0f, 0.0f, 29.97786f, 3.336159f, 3.371833f, 4.034389f);
	iLocal_41 = 1;
...
void func_5()
{
	switch (iLocal_41)
	{
		...
		case 2:
			...
			if (STREAMING::HAS_MODEL_LOADED(iLocal_44) && PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY())
			{
				iLocal_41 = 4;
			}
			break;
		case 4:
			...
			break;
		case 5:
			func_18(iLocal_42, joaat("INPUT_FOCUS_CAM"));
			if (!func_6(iLocal_42, 0))
			{
				iLocal_41 = 6;
			}
...
void func_16()
{
	...
	ENTITY::SET_ENTITY_HEALTH(iLocal_42, iVar0, 0);
	func_26(iLocal_42);
}

void func_17(var uParam0)
{
	func_27(uParam0, 0.0f);
}
...
void func_29(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_33(iParam1))
		{
			func_34(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
