...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 5.1653f, 3.3586f, 0.0f, -10.0f, 1.0f, 1.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, 0.6339f, -2.4567f, 0.0f, 3.7983f, 1.0f, 1.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	...
	func_152(uParam0, joaat("P_CHAIR_CRATE02X"), 0.0f, 0.0f, 0.0f, "SEAT", 0, 1, 1);
	...
	sLocal_20 = { func_159(uParam0, -0.0669f, 1.7103f, 1.0237f, -10.08f, 8.0f, 0.7f, 0.5f) /*10*/ };
	sLocal_30 = { func_159(uParam0, -0.2437f, 1.4726f, 1.0087f, 97.0791f, 8.0f, 0.8f, 0.5f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_198(uParam0, sLocal_30, 1, 0))
		{
			func_189(uParam0, iLocal_19, 1);
		}
		else if (func_198(uParam0, sLocal_20, 1, 0))
		{
