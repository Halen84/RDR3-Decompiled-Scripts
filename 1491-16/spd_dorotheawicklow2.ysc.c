	...
	while (true)
	{
		...
		if (!func_19(iLocal_183, 128) && iLocal_14 > 3)
		{
			...
			else
			{
				...
				if (iLocal_14 > 3 && !func_19(iLocal_183, 128))
				{
					func_25(8, 1, &bLocal_163, &uLocal_149, &uLocal_329, fLocal_156, 1097859072, 0);
					func_26();
				...
				switch (iLocal_14)
				{
					...
					case 3:
						...
						if (((func_68(&iLocal_168, iLocal_159, 2547.9f, -1215.18f, 52.3135f) & func_71(&(uLocal_164[0]), iLocal_160, &iVar0, func_69(0), func_70(0), 2, 0, 1)) & func_71(&(uLocal_164[1]), iLocal_161, &iVar0, func_69(1), func_70(1), 1, 0, 1)) & func_71(&(uLocal_164[2]), iLocal_162, &iVar0, func_69(2), func_70(2), 2, 0, 1))
						{
							if (((func_5(bLocal_163, 0) && func_5(uLocal_164[0], 0)) && func_5(uLocal_164[1], 0)) && func_5(uLocal_164[2], 0))
							{
								...
								func_79(&bLocal_163, &uLocal_184, joaat("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20.0f, -1082130432);
								if (func_64())
								{
					...
					case 5:
						...
						else
						{
							...
							func_85(1);
							iLocal_250 = 1;
							func_86(bLocal_163, 1.5f, 1056964608, 12000, 1, 1, 256, 0, 1);
					...
					case 40:
						...
						if (!func_19(iLocal_183, 8))
						{
							...
							func_85(1);
							iLocal_250 = 1;
							if (func_86(bLocal_163, 1.5f, 1056964608, 12000, 1, 1, 256, 0, 1))
							{
	...
	else
	{
		...
		while (iVar1 < 3)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_164[iVar1]))
			{
				...
				{
					TASK::TASK_MOVE_IN_TRAFFIC(uLocal_164[iVar1], -1082130432, 0, 0);
				}
	...
	while (iVar3 < iVar4)
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(bVar2))
		{
			if (((PED::IS_PED_HUMAN(bVar2) && !PED::IS_PED_A_PLAYER(bVar2)) && bVar2 != bLocal_163) && PED::IS_PED_USING_SCENARIO_HASH(bVar2, joaat("WORLD_HUMAN_STAND_WAITING")))
			{
				...
				{
					TASK::TASK_MOVE_IN_TRAFFIC(bVar2, -1082130432, 0, 0);
					iVar6++;
				}
			}
			iVar5++;
...
int func_180(int iParam0)
{
	...
	iVar1 = 0;
	iVar0 = func_291(&bLocal_163, &(sLocal_257[iParam0 /*59*/]), 12.0f, &(sLocal_257[iParam0 /*59*/].f_21), 0.0f, 2, sLocal_257[iParam0 /*59*/].f_57, iVar1, sLocal_257[iParam0 /*59*/].f_56, 0, 0, 2, -1082130432);
	if (func_292())
	{
...
int func_279(bool bParam0, var uParam1)
{
	...
	{
		return func_392(bParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
bool func_292()
{
	if (((((((((((ENTITY::DOES_ENTITY_EXIST(Global_35) && !Global_1935630.f_12) && VOLUME::DOES_VOLUME_EXIST(iLocal_170)) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_170, true, 0)) && func_409(Global_35, bLocal_163, 1060437492) != 1) && ((((iLocal_246 >= 11 && ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_254)) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_254) >= 0.8f) && iLocal_14 != 46) || (iLocal_14 >= 31 && iLocal_14 <= 36))) && !func_19(iLocal_183, 2)) && !PED::IS_PED_IN_ANY_VEHICLE(Global_35, true)) && !PED::IS_PED_ON_MOUNT(Global_35)) && !func_165(&bLocal_163, &iLocal_325, 1071644672, 1074790400)) && !func_410(&bLocal_163, &iLocal_326, 1071644672, 1074790400)) && !func_411())
	{
		if (func_412(0) != 1)
		{
			func_413(0, 1, 1);
...
int func_504(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_480(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_508(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
