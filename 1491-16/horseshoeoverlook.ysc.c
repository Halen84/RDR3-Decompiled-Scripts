...
bool func_11()
{
	...
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_0, -131.6045f, -34.30135f, 102.2093f, 0.0f, 0.0f, -24.47213f, 46.71921f, 37.52021f, 13.16044f);
	VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(iLocal_0, -117.99f, -66.781f, 100.0f, 0.0f, 0.0f, 94.0f, 16.719f, 19.52f, 13.16044f);
	return true;
}
