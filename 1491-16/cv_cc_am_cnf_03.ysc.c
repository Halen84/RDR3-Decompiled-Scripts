...
bool func_79(var uParam0)
{
	...
	func_169(uParam0, iLocal_18, 2, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", iLocal_38, 0, 110.0f, 1065353216, 1);
...
int func_417(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_460(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
struct<5> /*40*/ func_546(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_558(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_550(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_550(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
