...
bool func_48(var uParam0)
{
	...
	func_99(uParam0->f_3, "Hunting Zone Target Pending", 0, 0, (1 << 13), 0, -1082130432);
	return true;
}
...
void func_52(var uParam0)
{
	...
	while (iVar0 < uParam0->f_618)
	{
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_31[iVar0 /*36*/].f_1))
			{
				...
				if ((uParam0->f_31[iVar0 /*36*/].f_13 && fVar8 < 2500.0f) && ENTITY::IS_ENTITY_ON_SCREEN(uParam0->f_31[iVar0 /*36*/].f_1))
				{
					...
					if ((fVar8 < 6.25f && !func_112()) && !bVar6)
					{
						...
						{
							uParam0->f_31[iVar0 /*36*/].f_16 = func_113("INSPECT_GENERIC", joaat("INPUT_CONTEXT_Y"), uParam0->f_31[iVar0 /*36*/].f_1, 2, 0, 0, 0, 5, 1070386381, 570, 4000, 10, (1 << 30), 0, joaat("MEDIUM_TIMED_EVENT"), 0, 0);
		...
		else if (uParam0->f_31[iVar0 /*36*/].f_15)
		{
			...
			{
				func_121(uParam0->f_12, func_109(&(uParam0->f_31[iVar0 /*36*/].f_29)), 1, 0.762f, 1053609165, 0, 2.0f, 1);
...
{
	if (func_227(bParam0, joaat("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
bool func_198(bool bParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_229(bParam0) && WEAPON::IS_WEAPON_A_GUN(bParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
		{
			...
			if (!func_231(bParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
			{
				return false;
			}
			else if (func_232(bParam0, &sVar4, joaat("SLOTID_WEAPON_0")))
			{
				return false;
			}
			if (func_233(bParam0, 1))
			{
				if (!func_231(bParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					return false;
				}
				else if (func_232(bParam0, &sVar4, joaat("SLOTID_WEAPON_1")))
				{
					return false;
				}
			}
...
struct<5> /*40*/ func_249(bool bParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_246(bParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_135(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_233(bParam0, 1))
			{
				...
				else if (!func_231(bParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_232(bParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_135(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
