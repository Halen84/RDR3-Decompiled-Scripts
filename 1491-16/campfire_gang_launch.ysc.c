...
bool func_32(Vector3 vParam0, var uParam3)
{
	...
	{
		if (!func_51(vParam0, -1165.043f, 91.94646f, 43.90535f, 10.0f, 0))
		{
			return false;
		}
	}
	...
	{
		case 11:
			if (func_51(vParam0, 1504.914f, -1469.925f, 71.38271f, 10.0f, 0))
			{
				return false;
			}
			break;
		case 9:
			if (func_51(vParam0, -1712.438f, 606.3528f, 117.7065f, 10.0f, 0))
			{
				return false;
			}
			break;
...
bool func_75(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_100(iVar0) && func_101(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_93(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar4 += func_92(iVar0, iVar1);
		iVar3--;
		iVar0 = BUILTIN::ROUND(func_108(BUILTIN::TO_FLOAT(iVar0 + 1), 0.0f, 12.0f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
