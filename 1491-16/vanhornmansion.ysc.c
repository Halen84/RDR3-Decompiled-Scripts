...
void func_54()
{
	...
	if (func_92(5) && !(func_93(3, 16) && !func_94()))
	{
		func_96(-2035177903);
		func_96(-1147247388);
		func_97(-19313405, 1, 0.0f, 0, 0, 0, 0, 0);
	}
	else
	{
		func_98(-2035177903);
		func_98(-1147247388);
		func_97(-19313405, 0, 0.0f, 0, 0, 0, 0, 0);
	}
	func_95(5, 64);
}
...
void func_62(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_51(iParam0) && func_79(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
...
bool func_160(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_190(iVar0) && func_198(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
void func_177(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_208(iParam0, (1 << 10)))
		{
			func_209(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_208(iParam0, (1 << 10)))
	{
...
int func_186(struct<2> /*16*/ sParam0, var uParam2)
{
	int iVar0;
...
void func_194(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3--;
		iVar0 = BUILTIN::ROUND(func_221(BUILTIN::TO_FLOAT(iVar0 + 1), 0.0f, 12.0f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
