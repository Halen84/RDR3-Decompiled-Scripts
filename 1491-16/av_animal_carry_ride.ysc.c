	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					...
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[1 /*14*/], joaat("WEAPON_REVOLVER_CATTLEMAN"), 999, false, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), false, 0.0f, false);
					...
					else
					{
						...
						func_74(uParam0->f_20[1 /*14*/], joaat("WORLD_HUMAN_CROUCH_INSPECT"), 0, 0, 0, -1082130432);
		...
		case 8:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				if (PED::IS_PED_ON_MOUNT(uParam0->f_20[1 /*14*/]))
				{
					TASK::TASK_MOVE_IN_TRAFFIC(uParam0->f_20[1 /*14*/], -1082130432, 0, 0);
...
void func_182(int iParam0, Vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_136(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
struct<5> /*40*/ func_183(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_252(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_187(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_254(iParam0, 1))
			{
				...
				if (!func_185(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_185(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_186(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_187(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
