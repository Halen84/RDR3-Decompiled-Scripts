...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			func_149(uParam0, -122.349f, -8.52f, 95.134f, 0.0f, 0.0f, 0.0f);
			break;
		case 2:
			func_149(uParam0, 669.6f, -1250.3f, 42.96f, 0.0f, 0.0f, -165.0f);
			break;
		case 3:
			func_149(uParam0, 1867.925f, -1850.425f, 41.775f, 0.0f, 0.0f, 123.48f);
			break;
		default:
			return false;
	}
	iLocal_14 = func_150(uParam0, 0, 0);
	func_151(uParam0, -0.048f, -0.6479f, 1.1058f, 164.7765f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	...
	sLocal_18 = { func_160(uParam0, -0.048f, -0.6479f, 1.1058f, 164.7765f, 8.0f, 0.8f, 0.8f) /*10*/ };
	func_161(uParam0, 1);
...
{
	return func_193(uParam0, sLocal_18, 1, 0);
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_193(uParam0, sLocal_18, 1, 0))
		{
