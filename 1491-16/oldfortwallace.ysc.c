...
void func_66(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_53(iParam0) && func_83(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::VAR_STRING(674, sVar8, iVar4, func_109(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_109(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::VAR_STRING(162, sVar8, iVar4, func_109(&cVar6, joaat("COLOR_PURE_WHITE")), func_109(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
void func_84(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
...
char* func_109(char* sParam0, int iParam1)
{
	...
	return func_152(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

int func_110(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	Vector3 vVar13;
	int iVar16;
...
struct<2> /*16*/ func_114(int iParam0, int iParam1)
{
	struct<2> /*16*/ sVar0;
...
void func_124(int iParam0)
{
	...
	func_160(iParam0, (1 << 13));
	func_160(iParam0, (1 << 14));
	func_160(iParam0, (1 << 15));
	func_160(iParam0, (1 << 17));
	func_160(iParam0, (1 << 24));
	func_160(iParam0, (1 << 19));
	func_160(iParam0, (1 << 20));
...
void func_163(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (!func_185(iParam0, (1 << 10)))
		{
			func_186(iParam0, (1 << 10));
			INVENTORY::_0x9B4E793B1CB6550A();
		}
	}
	else if (func_185(iParam0, (1 << 10)))
	{
...
bool func_178(Vector3 vParam0, int iParam3)
{
	...
	func_194(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_195(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
