...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			func_149(uParam0, -1660.994f, -1362.774f, 83.275f, 0.0f, 0.0f, 92.26f);
			break;
		default:
			return false;
	}
	...
	func_151(uParam0, -31.1981f, 3.29326f, 0.868729f, 0.0f, 1.0f, 1.0f, 2.75f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, -33.4896f, -4.24883f, 0.369225f, 0.0f, 2.275f, 1.11f, 2.75f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	sLocal_24 = { func_152(uParam0, -33.4896f, -4.24883f, 0.369225f, -60.0f, 6.5f, 0.2825f, 0.7275f) /*10*/ };
	sLocal_34 = { func_152(uParam0, -33.4896f, -4.24883f, 0.369225f, 26.4f, 6.5f, 0.2775f, 0.6775f) /*10*/ };
	sLocal_44 = { func_152(uParam0, -33.4896f, -4.24883f, 0.369225f, -151.0f, 6.5f, 0.285f, 0.66f) /*10*/ };
	iLocal_23 = func_153(uParam0, joaat("P_CS_BOOK04X"), 0.0f, 0.0f, 0.0f, "BOOK", 0, 0, 1);
	func_153(uParam0, joaat("P_TEACUP"), 0.0f, 0.0f, 0.0f, "TEACUP", 0, 0, 1);
