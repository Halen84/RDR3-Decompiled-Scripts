...
void __SCRIPT()
{
	...
	fLocal_7 = 1.0f;
	fLocal_8 = 1.0f;
	vLocal_16 = { -1353.511f, 2440.355f, 312.6553f /*3*/ };
	sVar0 = -1;
	sVar0.f_1 = -1;
	sVar0.f_2 = -1;
	sVar0.f_17 = 10;
...
bool func_72(var uParam0)
{
	...
	{
		case 0:
			func_149(uParam0, -1353.042f, 2440.511f, 310.3f, 0.0f, 0.0f, -20.0f);
			break;
		default:
			return false;
	}
	...
	func_151(uParam0, joaat("P_CHAIR24X"), 0.0f, 0.0f, 0.0f, "p_chair04x", 0, 0, 1);
	func_152(uParam0, 1.73738f, -1.67007f, -1.92981f, 0.0f, 1.2f, 1.2f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, 1.5599f, 1.30484f, -1.93771f, 0.0f, 1.2f, 1.2f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
...
bool func_81(var uParam0)
{
	if (func_164(0))
	{
		if (BUILTIN::VDIST2(Global_36, vLocal_16) < 169.0f)
		{
			return false;
		}
	}
...
bool func_93(var uParam0)
{
	if (!uParam0->f_107[iLocal_14 /*113*/].f_32)
	{
		...
		{
			PED::FORCE_PED_MOTION_STATE(func_48(uParam0, iLocal_14), joaat("MOTIONSTATE_JOG"), false, 1, false);
			PERSCHAR::_RETASK_PERSISTENT_CHARACTER(func_121(0, 0));
		}
	}
	return true;
}
