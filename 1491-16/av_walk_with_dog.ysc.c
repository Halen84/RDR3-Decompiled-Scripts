	...
	switch (iLocal_9)
	{
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[1 /*14*/], joaat("WEAPON_REVOLVER_CATTLEMAN"), 5000, false, true, 0, false, 0.5f, 1.0f, joaat("ADD_REASON_DEFAULT"), true, 0.0f, false);
				func_71(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], &uLocal_12, 0.0f, 0.0f, 0.0f, 0, 0, 1, 1069547520, -1082130432, 1073069561, 1.0f, 1092616192, -1, 1, 0, 0, 0, 1);
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				if (!PED::IS_PED_USING_SCENARIO_HASH(uParam0->f_20[1 /*14*/], iLocal_51))
				{
					...
					func_74(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], &uLocal_12, -1082130432, 0, 0, -1082130432, 1.0f, 1, 32, fVar1, fVar2, 1.0f, (1 << 30), 1050253722, 1067030938, 0, 0, -1, 1, -1082130432, -1082130432, 1);
					iLocal_9 = 5;
				}
			}
			break;
