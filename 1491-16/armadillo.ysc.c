		...
		if (MISC::GET_GAME_TIMER() > iLocal_252)
		{
			...
			switch (iLocal_251)
			{
				...
				case 1:
					...
					LAW::_SET_LAW_RBS_VOLUME(PLAYER::PLAYER_ID(), func_9(iLocal_253));
				...
				case 6:
					if (func_7(func_6(iLocal_253)))
					{
						...
						else
						{
							...
							if (Global_1888801[iLocal_253 /*35*/].f_11 > 0.0f)
							{
								PED::_SET_SCENARIO_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1888801[iLocal_253 /*35*/].f_11);
							}
							Jump @785; // curOff = 766
							func_42(iVar0);
							iVar0 = (1 + iVar0);
						...
						{
							PED::_SET_SCENARIO_PED_DENSITY_THIS_FRAME(Global_1888801[iLocal_253 /*35*/].f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
void func_5(int iParam0)
{
	...
	if (func_46(75, (1 << 24)) < 1)
	{
		func_47(75, 1, 0.0f, 0.0f, 0.0f, -1, 0, 1);
		func_48(1);
	}
}
...
bool func_11()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_242, -3686.114f, -2623.858f, -12.89814f, 0.0f, 0.0f, 0.0f, 5.86845f, 3.98367f, 3.717603f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_242, -3681.782f, -2626.667f, -12.97999f, 0.0f, 0.0f, 0.0f, 3.247781f, 3.506042f, 3.000762f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_242, -3685.422f, -2627.413f, -12.92333f, 0.0f, 0.0f, 0.0f, 4.057125f, 5.521852f, 3.439446f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_242, -3682.85f, -2624.268f, -13.04125f, 0.0f, 0.0f, 42.27255f, 3.071827f, 4.479604f, 2.948806f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_242, -3689.445f, -2628.58f, -12.81253f, 0.0f, 0.0f, 0.0f, 4.103154f, 6.370532f, 3.388822f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iLocal_242, -3688.071f, -2623.283f, -9.7791f, 0.0f, 0.0f, 0.0f, 2.257698f, 2.906237f, 3.016091f);
	iLocal_243 = VOLUME::CREATE_VOLUME_BOX(-3685.352f, -2623.258f, -13.4981f, 0.0f, 0.0f, 0.0f, 1.100183f, 2.220348f, 1.996734f);
	iLocal_244 = VOLUME::CREATE_VOLUME_BOX(-3687.81f, -2623.527f, -13.30467f, 0.0f, 0.0f, 0.0f, 2.162535f, 3.2466f, 2.122298f);
	VOLUME::_0xB469CFD9E065EB99(iLocal_242, 10111);
	iLocal_245 = VOLUME::CREATE_VOLUME_BOX(-3701.056f, -2595.456f, -14.37373f, 0.0f, 0.0f, 0.0f, 21.94766f, 22.09092f, 14.36038f);
	iLocal_246[0] = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-3715.032f, -2610.383f, -14.5792f, 0.0f, 0.0f, 0.0f, 6.0f, 6.0f, 5.0f, "Fire 1 blocking volume");
	iLocal_246[1] = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-3635.024f, -2587.306f, -14.9224f, 0.0f, 0.0f, 0.0f, 6.0f, 6.0f, 5.0f, "Fire 2 blocking volume");
	iLocal_246[2] = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-3619.826f, -2627.633f, -14.5396f, 0.0f, 0.0f, 0.0f, 6.0f, 6.0f, 5.0f, "Fire 3 blocking volume");
	PATHFIND::_ADD_NAVMESH_BLOCKING_VOLUME(iLocal_246[0], 7);
	PATHFIND::_ADD_NAVMESH_BLOCKING_VOLUME(iLocal_246[1], 7);
	PATHFIND::_ADD_NAVMESH_BLOCKING_VOLUME(iLocal_246[2], 7);
	return true;
}
...
void func_14(int iParam0)
{
	...
	if (func_50(83, (1 << 24)) && func_51(83) >= 2)
	{
...
bool func_15(int iParam0)
{
	if (func_20() == -1)
	{
		HUD::TEXT_BLOCK_REQUEST("SCVTFAU");
		HUD::TEXT_BLOCK_REQUEST("ARRGNAU");
		HUD::TEXT_BLOCK_REQUEST("ARMRDAU");
...
void func_39(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0.0f, 0.0f, 0.0f) <= 5.0f || func_67(Global_1935630, (1 << 14))) || func_67(Global_1935630, (1 << 23)))
	{
		return;
	}
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	vVar1 = { func_113(iVar0) /*3*/ };
	vVar4 = { func_114(iVar0) /*3*/ };
	if (func_109(vVar1))
	{
		return;
	}
...
bool func_69()
{
	return func_67(Global_1935630, (1 << 12));
}
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_63(iParam0) && func_91(iParam0, (1 << 24))) && !Global_1894899.f_9)
	{
...
void func_86(int iParam0)
{
	...
	{
		if (VOLUME::DOES_VOLUME_EXIST(iLocal_246[iVar0]))
		{
			PATHFIND::_REMOVE_NAVMESH_BLOCKING_VOLUME(iLocal_246[iVar0]);
			VOLUME::DELETE_VOLUME(iLocal_246[iVar0]);
		}
		iVar0++;
	}
	...
	func_162();
	func_61(0.775f, 0.2f, 0.025f, 0.0f);
}
...
int func_95(int iParam0, Vector3 vParam1)
{
	...
	{
		vVar1 = { func_168(iParam0, iVar0) /*3*/ };
...
void func_102()
{
	...
	uVar0 = 5;
	func_180(&sLocal_150, 432, &uVar0, 0, 0);
	sLocal_150[0 /*45*/].f_43 = 30809;
	sLocal_150[0 /*45*/].f_44 = 30934;
	func_183(&(sLocal_150[0 /*45*/]), (1 << 9));
	uVar6 = 5;
	func_180(&sLocal_150, 434, &uVar6, 1, 0);
	sLocal_150[1 /*45*/].f_43 = 30997;
	sLocal_150[1 /*45*/].f_44 = 30934;
	func_183(&(sLocal_150[1 /*45*/]), (1 << 9));
}
...
int func_108(int iParam0, bool bParam1)
{
	...
	if (func_165(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			if (func_165(iParam0, (1 << 11)))
			{
				PERSCHAR::_REVIVE_PERSCHAR(func_187(iParam0));
				func_188(iParam0, (1 << 11));
			}
	...
	if (PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(func_187(iParam0)))
	{
...
void func_110(int iParam0)
{
	...
	func_192(iParam0, (1 << 13));
	func_192(iParam0, (1 << 14));
	func_192(iParam0, (1 << 15));
	func_192(iParam0, (1 << 17));
	func_192(iParam0, (1 << 24));
	func_192(iParam0, (1 << 19));
	func_192(iParam0, (1 << 20));
...
bool func_121(int iParam0, int iParam1)
{
	...
	if (func_115(iParam0, (1 << 14)) && !func_204(iParam0, 1))
	{
		return true;
	}
	if (!func_106(iParam1))
					...
					else
					{
						...
						else
						{
							...
							if (!func_219(uParam0->f_1))
							{
								...
								else if (func_226(&(uParam0->f_12)) > 15.0f)
								{
									func_223(&(uParam0->f_12));
									uParam0->f_8 = 256;
								}
							...
							else
							{
								...
								else if (func_226(&(uParam0->f_12)) > 3.0f)
								{
									uParam0->f_8 = 128;
								}
								...
								if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1))
								{
									...
									if (!func_227(1))
									{
										iVar1 = TASK::FIND_SCENARIO_OF_TYPE_HASH(func_229(), joaat("WORLD_HUMAN_LEAN_BACK_WALL_SMOKING_BAR_CA"), 3.0f, 1, false);
										TASK::OPEN_SEQUENCE_TASK(&iVar0);
...
char* func_149(char* sParam0, int iParam1)
{
	...
	return func_241(MISC::VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
void func_162()
{
	...
	while (iVar0 < 2)
	{
		if (func_224(&(sLocal_150[iVar0 /*45*/].f_34)))
		{
			func_223(&(sLocal_150[iVar0 /*45*/].f_34));
		}
		func_247(sLocal_150[iVar0 /*45*/].f_38);
		func_247(sLocal_150[iVar0 /*45*/].f_39);
		iVar0++;
	}
}
...
int func_166(int iParam0, bool bParam1)
{
	...
	func_250(iParam0);
	PERSCHAR::_DELETE_PERSCHAR(func_187(iParam0));
	func_186(iParam0, 0);
	return 1;
}
...
int func_178(var uParam0)
{
	switch (uParam0->f_3)
	{
		case joaat("A_M_M_ARMTOWNFOLK_01"):
			...
			{
				func_254(120, 5, 2);
				strcpy_s(&(uParam0->f_15), 24, "SCAR_1070A");
				strcpy_s(&(uParam0->f_18), 24, "SCAR_1070B");
			...
			{
				func_254(120, 5, 4);
				strcpy_s(&(uParam0->f_15), 24, "SCAR_1071A");
				strcpy_s(&(uParam0->f_18), 24, "SCAR_1071B");
...
void func_180(var uParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	func_183(uParam0[iParam3 /*45*/], (1 << 15));
	func_183(uParam0[iParam3 /*45*/], (1 << 10));
	...
	if (func_233())
	{
		if (!func_253(120, 1, 2))
		{
			if (func_259(3))
			{
				func_254(120, 1, 2);
				uParam0->f_21 = -1;
				uParam0->f_40 = { -3688.825f, -2623.38f, -12.3598f /*3*/ };
...
void func_197(int iParam0, bool bParam1)
{
	...
	else if (func_211(iParam0, (1 << 10)))
	{
		func_263(iParam0, (1 << 10));
		INVENTORY::_0x9B4E793B1CB6550A();
	}
	func_264(iParam0);
}
...
bool func_216(var uParam0)
{
	...
	iVar0 = ENTITY::_GET_ENTITIES_NEAR_POINT(func_274(PLAYER::PLAYER_ID()), 2.5f, iVar3, 1);
	if (iVar0 <= 0)
	{
...
bool func_219(int iParam0)
{
	...
	if (func_280(Global_35, iParam0, 1, 1) > 5.0f)
	{
		return true;
	}
	return false;
...
bool func_231(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (uParam0->f_30 == 1)
	{
		if (!func_290(uParam0, (1 << 16)) && func_291(Global_35, iVar0, 1) > 25.0f)
		{
			func_228(1, 1, 0);
		}
	...
	else
	{
		...
		if (func_291(Global_35, iVar0, 1) < 49.0f)
		{
...
char* func_236(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
bool func_272(int iParam0, bool bParam1)
{
	...
	return !PERSCHAR::_IS_PERSISTENT_CHARACTER_DEAD(func_187(iParam0));
}
...
bool func_284(var uParam0, Vector3 vParam1, int iParam4, int iParam5, float fParam6)
{
...
bool func_292(var uParam0, bool bParam1)
{
	...
	if (Global_1914319.f_17371 | func_339(func_205(*uParam0), 1, 1, 1, 0) || PED::IS_PED_HOGTIED(func_205(*uParam0)))
	{
		func_335(uParam0);
		return uParam0->f_30;
	}
	if (((func_340(PLAYER::PLAYER_ID(), 1, 0, 1) | func_341() || LAW::_0xF46108C50A22B029()) || LAW::ARE_WITNESSES_ACTIVE(PLAYER::PLAYER_ID())) || PLAYER::_0xD1F6B912785BFD35(PLAYER::PLAYER_ID()))
	{
		return false;
	}
	...
	if (!func_221(iVar0, func_290(uParam0, (1 << 11))))
	{
		return false;
	}
	if (uParam0->f_30 == 0)
	{
		if (!func_290(uParam0, (1 << 11)) && !func_290(uParam0, (1 << 15)))
		{
			...
			else if (func_290(uParam0, (1 << 10)))
			{
				if (func_226(&(uParam0->f_34)) < 5.0f)
				{
					return false;
				}
			}
			else if (func_226(&(uParam0->f_34)) < 25.0f)
			{
				return false;
			}
		}
...
bool func_294(int iParam0)
{
	...
	return func_211(iParam0, (1 << 30));
}

void func_295(int iParam0)
{
	func_263(iParam0, (1 << 30));
}
...
bool func_297(var uParam0, int iParam1)
{
	...
	if (func_290(uParam0, 128))
	{
		...
		while (iVar0 < 5)
		{
			...
			if (func_300(iVar1, 0) && func_280(iVar1, iParam1, 1, 1) <= 4.0f)
			{
				uParam0->f_21 = iVar0;
				return true;
			}
	...
	if (!func_290(uParam0, (1 << 9)) && !func_290(uParam0, 256))
	{
		return true;
	}
	if (func_290(uParam0, (1 << 9)))
	{
		if (func_344(uParam0))
		{
			return true;
...
void func_304(var uParam0)
{
	...
	func_225(&(uParam0->f_34), 1);
	uParam0->f_40 = { func_350() /*3*/ };
	uParam0->f_21 = -1;
	if (func_290(uParam0, (1 << 14)))
	{
		func_351(uParam0, (1 << 14));
	}
	func_351(uParam0, (1 << 15));
	func_351(uParam0, (1 << 10));
	func_223(&uLocal_15);
	if (func_290(uParam0, (1 << 12)))
	{
		...
		{
			func_352(iVar0, 0);
			func_351(uParam0, (1 << 13));
			func_351(uParam0, (1 << 12));
		}
	}
}
...
bool func_310(Vector3 vParam0, int iParam3)
{
	...
	func_354(iParam3, &vVar0, &sVar3, &uVar6);
	if (func_355(vParam0, vVar0, sVar3.f_0, sVar3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
bool func_344(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
		if (func_291(Global_35, iVar0, 1) < 9.0f)
		{
			return true;
		}
	}
...
bool func_348(int iParam0, int iParam1)
{
	...
	return func_211(Global_1914319.f_3[iParam0 /*446*/].f_10, (1 << 10));
}
