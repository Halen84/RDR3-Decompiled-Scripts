...
int func_31(var uParam0)
{
	switch (iLocal_10)
	{
		case 0:
			...
			break;
		case 1:
			if (ENTITY::_IS_TRACKED_ENTITY_VISIBLE(uParam0->f_453) || func_55(Global_35, uParam0->f_453, 1) < 400.0f)
			{
				func_56(*uParam0, 0);
				iLocal_10 = 2;
			}
			break;
		case 2:
			if (func_55(Global_35, uParam0->f_453, 1) > 10000.0f)
			{
				return 1;
			}
			break;
...
bool func_47(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_72(iVar0) && func_73(Global_1347702[iVar0 /*49*/].f_12, (1 << 17)))
		{
			return false;
		}
	}
...
bool func_59(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, Vector3 vParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
bool func_61(Vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_77(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1.0f, 0))
			{
				return true;
			}
		}
