...
bool func_79(var uParam0)
{
	...
	{
		case 3:
			func_157(uParam0, 1876.586f, -1885.01f, 41.783f, 0.0f, 0.0f, 3.102f);
			break;
		case 6:
	...
	func_159(uParam0, -0.73f, -0.92f, 0.0f, -96.48f, 3.955f, 4.8675f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	...
	func_168(uParam0, iLocal_18, 2, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_A", iLocal_37, 0, 110.0f, 1065353216, 1);
...
bool func_94(var uParam0)
{
	...
	if (func_215(uParam0, sLocal_39, 1, 0))
	{
	...
	if (iLocal_49 >= 3 && iLocal_49 < 6)
	{
		...
		if (func_225(&uLocal_98))
		{
			...
			else
			{
				...
				func_168(uParam0, iLocal_18, 2, joaat("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", iLocal_37, 0, 110.0f, 1065353216, 1);
			}
			func_227(uParam0, iLocal_23, "b_WaitLoop", 1);
			func_216(9);
			return false;
		}
		if (!func_228(Global_35, joaat("SCRIPT_TASK_USE_SCENARIO_POINT")) && bLocal_61)
		{
			func_229();
		}
	}
...
int func_165(int iParam0, int iParam1, int iParam2)
{
	...
	iVar12 = 0;
	sVar16 = { func_289(joaat("NUM_PEDS_HURT")) /*2*/ };
	STATS::STAT_ID_GET_INT(&sVar16, &iVar13);
	sVar16 = { func_290(joaat("KILLS"), joaat("HUMAN")) /*2*/ };
	STATS::STAT_ID_GET_INT(&sVar16, &iVar14);
	sVar16 = { func_289(joaat("HOLD_UPS")) /*2*/ };
	STATS::STAT_ID_GET_INT(&sVar16, &iVar15);
	iVar18 = BUILTIN::CEIL((BUILTIN::TO_FLOAT((iVar13 + iVar15)) / 2.0f));
	iVar19 = BUILTIN::CEIL((BUILTIN::TO_FLOAT((iVar14 + iVar15)) / 2.0f));
	iVar20 = BUILTIN::CEIL((BUILTIN::TO_FLOAT((iParam0 + iParam2)) / 2.0f));
	iVar21 = BUILTIN::CEIL((BUILTIN::TO_FLOAT((iParam1 + iParam2)) / 2.0f));
	if (iVar15 >= iParam2)
	{
		iVar0[iVar12] = 6;
		iVar12++;
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_292(uParam0->f_33[iVar0], 0, 1, 0, (1 << 11), 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
...
void func_211(int iParam0, int iParam1, var uParam2, var uParam3)
{
	if (!func_51(*iParam0))
	{
		*iParam0 = func_330("GREET_ACC", joaat("INPUT_INTERACT_LOCKON_POS"), func_8(uParam2, *uParam3), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		func_331(*iParam0, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(func_8(uParam2, *uParam3)), 0, 1);
	}
	if (!func_51(*iParam1))
	{
		*iParam1 = func_330("GREET_REJ", joaat("INPUT_INTERACT_LOCKON_NEG"), func_8(uParam2, *uParam3), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		func_331(*iParam1, HUD::_UI_PROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(func_8(uParam2, *uParam3)), 0, 1);
	}
}
...
bool func_215(var uParam0, struct<4> /*32*/ sParam1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_338(sParam1, sParam1.f_6, Global_36))
	{
		return false;
	}
	if (func_338(sParam1, sParam1.f_3, Global_36))
	{
		return false;
	}
	if (bParam12)
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0 /*113*/].f_32.f_32 > -1)
			{
				...
				func_343(uParam0->f_107[iVar0 /*113*/].f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
...
void func_230(var uParam0)
{
	...
	if (func_348(iLocal_52, 1) || func_117(&uLocal_95) >= 15.0f)
	{
...
bool func_231(var uParam0, int iParam1)
{
	...
	if (func_355(uParam0, iParam1, 1.0f))
	{
		return true;
	}
...
void func_232(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		if (uParam0->f_107[iParam1 /*113*/].f_32.f_1 == 1)
		{
			...
			{
				uParam0->f_107[iParam1 /*113*/].f_32.f_4 = func_357(100.0f, 140.0f);
			}
		}
...
void func_234(var uParam0)
{
	...
	{
		iLocal_53 = func_330("VIG_LEAVE_CONVERSATION", joaat("INPUT_GAME_MENU_CANCEL"), func_8(uParam0, iLocal_18), 3, 0, 0, 0, 0, 6.0f, 570, 4000, 10, (1 << 30), 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	}
...
void func_242(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if ((uParam0->f_107[iVar0 /*113*/].f_32.f_60 > 0.0f && !uParam0->f_107[iVar0 /*113*/].f_32.f_62) && func_355(uParam0, uParam0->f_107[iVar0 /*113*/].f_32.f_61, uParam0->f_107[iVar0 /*113*/].f_32.f_60))
		{
...
int func_283()
{
	...
	if (func_385(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_284()
{
	...
	if (func_385(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
struct<2> /*16*/ func_289(int iParam0)
{
	struct<2> /*16*/ sVar0;
...
void func_313(var uParam0, int iParam1)
{
	...
	else if (!func_228(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
	{
...
int func_330(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12, float fParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_244(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_400(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0.0f, 0.0f, 0.0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, fParam12, fParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
bool func_338(struct<2> /*16*/ sParam0, var uParam2, struct<2> /*16*/ sParam3, var uParam5, struct<2> /*16*/ sParam6, var uParam8)
{
...
bool func_345(var uParam0, var uParam1)
{
	...
	if (uParam1->f_21)
	{
		...
		while (iVar0 <= iVar1)
		{
			if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(func_347(uParam0, uParam1->f_4), func_362(uParam0, iVar0)) && !func_364(uParam0, iVar0))
			{
				return false;
			}
			iVar0++;
	...
	if (uParam1->f_20)
	{
		...
		while (iVar2 <= iVar3)
		{
			if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(func_347(uParam0, uParam1->f_5), func_362(uParam0, iVar2)) && !func_364(uParam0, iVar2))
			{
				return false;
			}
			iVar2++;
	...
	if (uParam1->f_22)
	{
		...
		while (iVar4 <= iVar5)
		{
			if (!ANIMSCENE::_IS_ANIM_SCENE_PLAYBACK_LIST_PHASE_LOADED(func_347(uParam0, uParam1->f_6), func_362(uParam0, iVar4)) && !func_364(uParam0, iVar4))
			{
				return false;
			}
			iVar4++;
...
bool func_367(var uParam0, int iParam1)
{
	...
	{
		if (!func_228(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_ANY")))
		{
			return true;
		}
	}
		...
		else if (func_23(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_441(&iVar2, func_440(iVar3)))
					{
...
void func_398(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_447(iParam1))
		{
			func_448(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
int func_413(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_455(fVar9) /*3*/ };
			vVar13 = { func_456(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
char* func_418(var uParam0, var uParam1)
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}

char* func_419(var uParam0, var uParam1, var uParam2, var uParam3)
{
	return HUD::_GET_TEXT_SUBSTRING_2(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_471(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, (1 << 30));
			}
			else if (bParam16)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !func_245(vVar0)) && !func_246(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608, 1))
			{
				...
				func_471(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, (1 << 30));
			}
			if (bParam1)
			{
				if (!ENTITY::_DOES_THREAD_OWN_THIS_ENTITY(Global_1360165[iParam0 /*1157*/].f_124))
...
void func_462(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_492(func_112(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_493(iParam0);
...
bool func_469(int iParam0, Vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_503(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) /*7*/ };
			if (!bParam6)
			{
				func_110(iParam0, 44, 1);
			}
...
bool func_488(int iParam0, Vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489.f_12) || (bParam5 && Global_1359489.f_13 < 8))
	{
		...
		else
		{
			...
			{
				Global_1360165[iParam0 /*1157*/].f_124 = func_319(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
void func_490(int iParam0, int iParam1)
{
	...
	func_462(iParam1, func_518(iParam1, (1 << 13)), func_518(iParam1, (1 << 14)), 1);
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_385(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_463(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<7> /*56*/ func_503(int iParam0, int iParam1, Vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	struct<7> /*56*/ sVar0;
...
int func_517(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, iParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_544(iParam0, &sVar0, iVar5, 0))
			{
				...
				{
					sVar29 = { func_546(iParam0, sVar0, iVar5, 0) /*4*/ };
...
bool func_539(bool bParam0, bool bParam1)
{
...
struct<5> /*40*/ func_542(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_554(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_546(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_556(iParam0, 1))
			{
				...
				if (!func_544(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_544(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_545(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				sVar0 = { func_546(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
...
struct<4> /*32*/ func_546(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
...
struct<4> /*32*/ func_555(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_546(joaat("CARRIED_WEAPONS"), func_553(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_546(joaat("CARRIED_WEAPONS"), func_553(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_546(joaat("CARRIED_WEAPONS"), func_553(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_556(int iParam0, bool bParam1)
{
	if (func_558(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
struct<4> /*32*/ func_557(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_546(joaat("EMOTE_ITEM"), func_553(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_546(joaat("EMOTE_ITEM"), func_553(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
int func_561(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	sVar0 = { func_546(iParam0, sParam1, iParam5, bParam6) /*4*/ };
...
bool func_562(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_564(0);
	*uParam1 = { func_546(iParam0, func_555(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
