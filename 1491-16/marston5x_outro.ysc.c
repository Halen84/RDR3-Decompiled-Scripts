...
int func_61(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_32(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_68(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000.0f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_70(iParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_71(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_71(iParam0, 0));
					func_72(iParam0);
				}
			}
			else
