...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			vLocal_20 = { -133.89f, -17.48f, 95.14f /*3*/ };
			break;
		case 2:
			func_150(uParam0, 673.066f, -1266.676f, 42.93f, 0.0f, 0.0f, 142.755f);
			vLocal_20 = { 672.5f, -1261.14f, 42.98f /*3*/ };
			break;
		case 3:
			func_150(uParam0, 1881.889f, -1874.921f, 41.752f, 0.0f, 0.0f, -180.0f);
			vLocal_20 = { 1878.09f, -1870.85f, 41.81f /*3*/ };
			break;
	}
	iLocal_15 = func_151(uParam0, 21, 0);
	iLocal_14 = func_151(uParam0, 5, 0);
	func_152(uParam0, 4.8939f, -0.71f, 0.0f, 0.0f, 1.2f, 1.2f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	func_152(uParam0, 3.7439f, -4.0725f, 0.0f, 0.0f, 1.2f, 1.2f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_18 = func_153(uParam0, joaat("P_MUGCOFFEE01X"), 0.0f, 0.0f, 0.0f, "MUG", 0, 0, 1);
	iLocal_19 = func_153(uParam0, joaat("P_MUGCOFFEE01X"), 0.0f, 0.0f, 0.0f, "MUG1", 0, 0, 1);
	...
	func_157(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1, 25.0f, 1065353216, 1);
...
bool func_93(var uParam0)
{
	if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_1984[iLocal_17], "BOILER"))
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(iLocal_24))
		{
			...
			{
				if (TASK::_ASSOCIATE_PROP_WITH_SCENARIO(iLocal_24, iLocal_23, "p_boiler02x_PH_L_HAND", true))
				{
				}
			}
		}
...
int func_167(var uParam0, Vector3 vParam1, int iParam4, int iParam5, char* sParam6, bool bParam7)
{
	...
	if (!TASK::DOES_SCENARIO_POINT_EXIST(*iParam5))
	{
		*iParam5 = TASK::FIND_SCENARIO_OF_TYPE_HASH(vParam1, iParam4, 1.0f, 0, false);
		return 0;
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_23))
	{
		iLocal_23 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(TASK::GET_PROP_FOR_SCENARIO_POINT(*iParam5, sParam6));
	}
	if (TASK::_DISASSOCIATE_PROP_FROM_SCENARIO(*iParam5, sParam6))
	{
	}
	return 0;
}
