...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -1.6101f, -1.2696f, 0.4797f, -62.28f, 2.0f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	func_152(uParam0, 3.1676f, -2.4034f, 0.4069f, -21.3303f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, -6.8056f, -8.6035f, 1.0723f, 1.44f, 2.0f, 2.0f, 3.0f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_153(uParam0, -0.8f, -0.88f, 0.9775f, 0.0f, 0.84f, 0.84f, 2.0f, joaat("VOLCYLINDER"), 1);
	...
	sLocal_19 = { func_160(uParam0, -1.8601f, -0.8196f, 0.4797f, -75.4893f, 7.0f, 1.0f, 0.7f) /*10*/ };
...
bool func_93(var uParam0)
{
	if (!func_199(uParam0, iLocal_17) && !func_199(uParam0, iLocal_18))
	{
		...
		{
			if (func_201(uParam0, sLocal_19, 1, 0))
			{
