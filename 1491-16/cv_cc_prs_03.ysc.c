...
{
	if (ENTITY::HAS_ANIM_EVENT_FIRED(func_8(uParam0, iLocal_14), joaat("REMOVEKNIFE")) || !func_9(func_8(uParam0, iLocal_14), joaat("SCRIPT_TASK_ANY")))
	{
...
bool func_73(var uParam0)
{
	switch (func_149(uParam0))
	{
		case 1:
			...
			break;
		case 2:
			func_151(uParam0, 676.17f, -1251.42f, 43.0117f, 0.0f, 0.0f, -12.0f);
			break;
		case 3:
	...
	func_153(uParam0, 1.0f, 0.8f, 0.0f, 0.0f, 3.0f, 6.0f, 5.0f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	func_154(uParam0, joaat("P_CS_DEERCARCASS"), 0.0f, 0.0f, 0.0f, "CARCASS", 0, 0, 1);
	iLocal_20 = func_154(uParam0, joaat("P_CS_DEERCARCASSARM"), 0.0f, 0.0f, 0.0f, "LEG", 0, 1, 1);
	iLocal_21 = func_154(uParam0, joaat("P_KNIFE03X"), 0.0f, 0.0f, 0.0f, "KNIFE", 0, 1, 1);
	func_154(uParam0, joaat("P_SAWMEAT01X"), 0.0f, 0.0f, 0.0f, "SAW", 0, 0, 1);
	func_154(uParam0, joaat("P_BOTTLEJD01X"), 0.0f, 0.0f, 0.0f, "BOTTLE", 0, 0, 1);
	...
	sLocal_22 = { func_162(uParam0, 1.6307f, 2.9087f, 1.0166f, -66.9355f, 6.0f, 1.0f, 0.143f) /*10*/ };
	sLocal_32 = { func_162(uParam0, 1.631f, 2.909f, 1.017f, 71.64f, 4.3f, 0.5f, 0.5f) /*10*/ };
	func_163(uParam0, 1);
...
{
	if (func_195(uParam0, sLocal_22, 1, 0))
	{
		iLocal_19 = iLocal_15;
		return true;
	}
	else if (func_195(uParam0, sLocal_32, 1, 0))
	{
		iLocal_19 = iLocal_16;
		return true;
	}
...
void func_158(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			uParam0->f_107[iParam1 /*113*/].f_32.f_5 = { func_260(func_149(uParam0), func_259(uParam0, iParam1), func_21(uParam0), 1) /*3*/ };
			break;
		default:
			sVar0 = { func_261(func_149(uParam0), func_259(uParam0, iParam1), func_21(uParam0), 1) /*4*/ };
...
void func_281(var uParam0, int iParam1)
{
	...
	else if (!func_9(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_USE_SCENARIO_POINT")))
	{
...
bool func_310(var uParam0, int iParam1)
{
	...
	{
		if (!func_9(uParam0->f_107[iParam1 /*113*/].f_5, joaat("SCRIPT_TASK_ANY")))
		{
			return true;
		}
	}
		...
		else if (func_21(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_370(&iVar2, func_369(iVar3)))
					{
...
int func_386(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_418(fVar9) /*3*/ };
			vVar13 = { func_419(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216) /*3*/ };
...
void func_395(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_429(func_105(iParam0), 1.0f, 0);
	}
	if (bParam1)
	{
		func_430(iParam0);
...
void func_427(int iParam0, int iParam1)
{
	...
	func_395(iParam1, func_457(iParam1, (1 << 13)), func_457(iParam1, (1 << 14)), 1);
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_330(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_396(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
