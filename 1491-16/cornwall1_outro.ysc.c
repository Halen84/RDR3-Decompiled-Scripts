#pragma region Local_Variables
	...
	int iLocal_3 = 0;
	int iLocal_4 = 0;
	struct<6> /*48*/ sLocal_5[4];
	struct<4> /*32*/ sLocal_30 = { 0, 0, 0, 0 } ;
...
void __EntryFunction__()
{
	...
	func_2(&sLocal_30, &uScriptParam_0);
	while (!func_3(&sLocal_30))
	{
		func_4(&sLocal_30);
		switch (func_5(sLocal_30))
		{
			case 0:
				if (func_6(&sLocal_30))
				{
...
{
	func_26(&(sLocal_5[0 /*6*/]), ENTITY::IS_ENTITY_DEAD(sLocal_5[0 /*6*/]));
	func_26(&(sLocal_5[1 /*6*/]), ENTITY::IS_ENTITY_DEAD(sLocal_5[1 /*6*/]));
	func_26(&(sLocal_5[2 /*6*/]), ENTITY::IS_ENTITY_DEAD(sLocal_5[2 /*6*/]));
	func_26(&(sLocal_5[3 /*6*/]), ENTITY::IS_ENTITY_DEAD(sLocal_5[3 /*6*/]));
	return 1;
}
...
int func_21(var uParam0)
{
	if (func_44())
	{
		...
		PED::SET_PED_AS_GROUP_LEADER(sLocal_5[0 /*6*/], iLocal_3, false);
		PED::SET_PED_AS_GROUP_MEMBER(sLocal_5[1 /*6*/], iLocal_3);
		PED::SET_PED_CONFIG_FLAG(sLocal_5[1 /*6*/], 279, true);
		...
		TASK::TASK_PATROL(sLocal_5[0 /*6*/], "miss_cornwall1_01", 1, true, true);
		if (!PED::DOES_GROUP_EXIST(iLocal_4))
		{
			iLocal_4 = PED::CREATE_GROUP(0);
			PED::SET_GROUP_FORMATION(iLocal_4, 9);
		}
		PED::SET_PED_AS_GROUP_LEADER(sLocal_5[2 /*6*/], iLocal_4, false);
		PED::SET_PED_AS_GROUP_MEMBER(sLocal_5[3 /*6*/], iLocal_4);
		PED::SET_PED_CONFIG_FLAG(sLocal_5[3 /*6*/], 279, true);
		...
		TASK::CLOSE_PATROL_ROUTE();
		TASK::CREATE_PATROL_ROUTE();
		TASK::TASK_PATROL(sLocal_5[2 /*6*/], "miss_cornwall1_02", 1, true, true);
		return 1;
	}
	return 0;
}
...
bool func_44()
{
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(sLocal_5[iVar0 /*6*/]) && !func_62(sLocal_5[iVar0 /*6*/].f_5, 1))
		{
			if (iVar0 == 0)
			{
				sLocal_5[iVar0 /*6*/] = func_63(joaat("S_M_M_CORNWALLGUARD_01"), 1321.848f, -639.7525f, 60.6564f, 50.7916f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
				PED::SET_PED_NAME_DEBUG(sLocal_5[iVar0 /*6*/], "Group01_01");
			}
			else if (iVar0 == 1)
			{
				sLocal_5[iVar0 /*6*/] = func_63(joaat("S_M_M_CORNWALLGUARD_01"), 1323.208f, -638.7339f, 61.351f, 52.7915f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
				PED::SET_PED_NAME_DEBUG(sLocal_5[iVar0 /*6*/], "Group01_02");
			}
			else if (iVar0 == 2)
			{
				sLocal_5[iVar0 /*6*/] = func_63(joaat("S_M_M_CORNWALLGUARD_01"), 1231.225f, -479.1585f, 82.4746f, 181.6388f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
				PED::SET_PED_NAME_DEBUG(sLocal_5[iVar0 /*6*/], "Group02_01");
			}
			else if (iVar0 == 3)
			{
				sLocal_5[iVar0 /*6*/] = func_63(joaat("S_M_M_CORNWALLGUARD_01"), 1229.978f, -478.3989f, 82.5741f, 186.8161f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
				PED::SET_PED_NAME_DEBUG(sLocal_5[iVar0 /*6*/], "Group02_02");
			}
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(sLocal_5[iVar0 /*6*/], joaat("REL_PLAYER_ENEMY"));
			PED::SET_PED_COMBAT_ATTRIBUTES(sLocal_5[iVar0 /*6*/], 46, true);
			PED::SET_PED_FLEE_ATTRIBUTES(sLocal_5[iVar0 /*6*/], (1 << 9), true);
			PED::SET_PED_COMBAT_ATTRIBUTES(sLocal_5[iVar0 /*6*/], 35, true);
			ENTITY::_SET_ENTITY_CARRYING_FLAG(sLocal_5[iVar0 /*6*/], 0, false);
			PED::SET_PED_LASSO_HOGTIE_FLAG(sLocal_5[iVar0 /*6*/], 0, false);
			ENTITY::_SET_ENTITY_CARRYING_FLAG(sLocal_5[iVar0 /*6*/], 1, false);
			ENTITY::_SET_ENTITY_CARRYING_FLAG(sLocal_5[iVar0 /*6*/], 2, false);
			PED::_SET_PED_BLACKBOARD_FLOAT(sLocal_5[iVar0 /*6*/], "searching_high_energy_indirect", 1.0f, -1);
			PED::_SET_PED_COMBAT_BEHAVIOUR(sLocal_5[iVar0 /*6*/], -820192119);
			PED::_0x00B380FF2DF6AB7A(sLocal_5[iVar0 /*6*/], 2);
			PED::SET_PED_SEEING_RANGE(sLocal_5[iVar0 /*6*/], 50.0f);
			PED::SET_PED_ID_RANGE(sLocal_5[iVar0 /*6*/], 20.0f);
			WEAPON::REMOVE_ALL_PED_WEAPONS(sLocal_5[iVar0 /*6*/], true, true);
			func_64(sLocal_5[iVar0 /*6*/], joaat("WEAPON_MELEE_LANTERN"), 1, 0, 1, 1, 1, 1056964608, 1065353216, -1, 0, 0, 0, 0);
			func_64(sLocal_5[iVar0 /*6*/], joaat("WEAPON_REVOLVER_CATTLEMAN"), 1, 0, 0, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
			func_65(&(sLocal_5[iVar0 /*6*/].f_5), 1);
			return false;
		}
		iVar0++;
	}
...
bool func_45()
{
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(sLocal_5[iVar0 /*6*/]))
		{
			if (bVar31 && func_66(sLocal_5[iVar0 /*6*/], Global_35, 200.0f, 1))
			{
				bVar31 = false;
			}
			if (!MAP::DOES_BLIP_EXIST(sLocal_5[iVar0 /*6*/].f_1))
			{
				sLocal_5[iVar0 /*6*/].f_1 = MAP::BLIP_ADD_FOR_ENTITY(joaat("BLIP_STYLE_ENEMY"), sLocal_5[iVar0 /*6*/]);
				MAP::BLIP_ADD_MODIFIER(sLocal_5[iVar0 /*6*/].f_1, joaat("BLIP_MODIFIER_ENEMY_GUNSHOTS_ONLY"));
			}
			if (!func_62(sLocal_5[iVar0 /*6*/].f_5, 2))
			{
				func_67(&sVar1, 0);
				func_68(&sVar1, 0);
				if (func_69(sLocal_5[iVar0 /*6*/], 0, &sVar1, &uVar29, 0, 0) | func_70(sLocal_5[iVar0 /*6*/], &sVar1, &uVar29, 0))
				{
					TASK::OPEN_SEQUENCE_TASK(&iVar30);
					TASK::TASK_COMBAT_PED(0, Global_35, 0, 0);
					TASK::CLOSE_SEQUENCE_TASK(iVar30);
					TASK::_TASK_PERFORM_SEQUENCE_2(sLocal_5[iVar0 /*6*/], iVar30, 0.6f, 1.2f);
					TASK::CLEAR_SEQUENCE_TASK(&iVar30);
					func_65(&(sLocal_5[iVar0 /*6*/].f_5), 2);
				}
			}
		}
		iVar0++;
...
int func_64(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, float fParam7, float fParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_86(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0.0f;
...
void func_68(var uParam0, bool bParam1)
{
	if (bParam1)
	{
		func_89(&(uParam0->f_1), (1 << 19));
	}
	else
	{
		func_90(&(uParam0->f_1), (1 << 19));
	}
}
...
int func_69(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (Global_1935630.f_26 & func_97(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & (1 << 19) == 0))
		{
...
float func_76(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_127(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_86(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
	...
	{
		sVar0 = { func_135(iParam0, 0, 1) /*5*/ };
		iVar5 = joaat("SLOTID_WEAPON_0");
		sVar6.f_9 = joaat("SLOTID_NONE");
		iVar28 = 0;
		while (iVar28 < 4)
		{
			iVar5 = func_136((398 + iVar28), 1);
			if (func_137(iParam0, &sVar0, iVar5, 0))
			{
				if (func_138(iParam0, &sVar6, iVar5))
				{
					sVar29 = { func_139(iParam0, sVar0, iVar5, 0) /*4*/ };
					func_140(iParam0, &sVar29, &sVar0, 1, joaat("REMOVE_REASON_DEFAULT"), 1, 0);
				}
				else
				{
					iVar28++;
...
bool func_121(int iParam0, var uParam1)
{
	...
	{
		fVar1 = -1.0f;
		fVar2 = func_186(PED::_0x2BA9D7BF629F920C(iParam0), (fVar0 + 5.0f));
...
struct<5> /*40*/ func_135(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;
	...
	switch (func_194(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				sVar0 = { func_139(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_196(iParam0, 1))
			{
				...
				if (!func_137(iParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_137(iParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_138(iParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_199(iParam0, joaat("CI_CATEGORY_CAMP")))
			{
				sVar0 = { func_139(joaat("KIT_CAMP"), sVar0, joaat("SLOTID_SATCHEL"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("KIT_CAMP"));
			}
			else if (func_199(iParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_139(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(iParam0, joaat("WARDROBE"));
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(iParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_200(sVar0, &sVar27, bParam1, 0))
				{
					sVar0.f_4 = 0;
				}
				else
...
struct<4> /*32*/ func_139(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_204(bParam6), &uParam1, iParam0, iParam5, &sVar0);
	return sVar0;
}
...
bool func_140(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!func_200(*uParam1, &sVar0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_INVENTORY_REMOVE_INVENTORY_ITEM_WITH_GUID(func_204(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
void func_143(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_207(WEAPON::GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
void func_153(var uParam0, bool bParam1)
{
	if (bParam1)
	{
		func_90(uParam0, (1 << 27));
	}
	else
	{
		func_89(uParam0, (1 << 27));
	}
}
...
struct<4> /*32*/ func_195(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_139(joaat("CARRIED_WEAPONS"), func_193(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_139(joaat("CARRIED_WEAPONS"), func_193(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_139(joaat("CARRIED_WEAPONS"), func_193(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_196(int iParam0, bool bParam1)
{
	if (func_198(iParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
...
struct<4> /*32*/ func_197(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_139(joaat("EMOTE_ITEM"), func_193(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_139(joaat("EMOTE_ITEM"), func_193(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
...
bool func_200(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::INVENTORY_GET_INVENTORY_ITEM(func_204(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
int func_201(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	...
	sVar0 = { func_139(iParam0, sParam1, iParam5, bParam6) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(&sVar0))
	{
		return 0;
	}
	iVar4 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_GUID(func_204(bParam6), &sVar0, false);
	return iVar4;
}
...
bool func_202(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_204(0);
	*uParam1 = { func_139(iParam0, func_195(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
