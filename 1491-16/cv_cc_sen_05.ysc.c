...
bool func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			break;
		case 2:
			func_150(uParam0, 675.5f, -1204.7f, 45.7f, 0.0f, 0.0f, -180.0f);
			break;
		default:
			return false;
	}
	...
	func_152(uParam0, WEAPON::_GET_WEAPONTYPE_MODEL(joaat("WEAPON_SHOTGUN_DOUBLEBARREL")), 0.0f, 0.0f, 0.0f, "SHOTGUN", 0, 1, 1);
	func_153(uParam0, -7.13439f, -11.6913f, 0.418625f, 0.0f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	func_153(uParam0, -9.14886f, -2.50338f, 0.186272f, 0.0f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	...
	sLocal_19 = { func_160(uParam0, -7.912f, -10.5553f, 0.3967f, -176.76f, 7.0f, 0.5f, 0.5f) /*10*/ };
	sLocal_29 = { func_160(uParam0, -7.912f, -10.555f, 0.397f, 0.0f, 7.0f, 0.5f, 0.5f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_199(uParam0, sLocal_19, 1, 0))
		{
			func_190(uParam0, iLocal_17, 1);
		}
		else if (func_199(uParam0, sLocal_29, 1, 0))
		{
