...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 4.6881f, -5.8244f, 0.9868f, 0.0f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, -0.8422f, -0.053f, 1.0012f, 0.0f, 1.5f, 1.5f, 3.0f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	...
	sLocal_19 = { func_156(uParam0, -1.6045f, -0.128f, 0.9926f, -27.0f, 7.0f, 0.5f, 0.5f) /*10*/ };
	sLocal_29 = { func_156(uParam0, -1.605f, -0.128f, 0.993f, -160.0f, 7.0f, 0.5f, 0.5f) /*10*/ };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (func_195(uParam0, sLocal_19, 1, 0))
		{
			func_186(uParam0, iLocal_17, 1);
		}
		else if (func_195(uParam0, sLocal_29, 1, 0))
		{
