...
int func_19(var uParam0)
{
	if (*uParam0 == 52)
	{
		...
		{
			if (!PED::_HAS_METAPED_OUTFIT_LOADED(iLocal_112))
			{
				return 0;
			}
		}
		...
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				if (*uParam0 == 52)
				{
					...
					func_78(uParam0->f_20[1 /*14*/], uParam0->f_20[2 /*14*/], &uLocal_38, 0.0f, 0.0f, 0.0f, 0, 0, 1, 1069547520, -1082130432, 1073069561, 1.0f, 1092616192, -1, 1, 0, 0, 0, 1);
			...
			if (*uParam0 == 52)
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
				{
					...
					func_80(uParam0->f_20[2 /*14*/], uParam0->f_20[1 /*14*/], &uLocal_38, -1082130432, 0, 0, -1082130432, 1.0f, 1, 32, 0, -4.5f, 4.5f, (1 << 30), 1050253722, 1067030938, 0, 0, -1, 1, -1082130432, -1082130432, 1);
				}
			}
			iLocal_9 = 1;
			break;
