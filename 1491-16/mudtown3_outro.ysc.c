...
void __SCRIPT()
{
	fLocal_7 = 1.0f;
	fLocal_8 = 1.0f;
	fLocal_26 = 1000000.0f;
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(555))
	{
		func_1(&sLocal_174);
	}
	func_2(&sLocal_174, &uScriptParam_0);
	while (!func_3(&sLocal_174))
	{
		func_4(&sLocal_174);
		switch (func_5(sLocal_174))
		{
			case 0:
				if (func_6(&sLocal_174))
				{
					func_7(&sLocal_174, 1);
				}
				break;
			case 1:
				if (func_8(&sLocal_174))
				{
					func_7(&sLocal_174, 2);
				}
				break;
			case 2:
				if (func_9(&sLocal_174))
				{
					func_7(&sLocal_174, 3);
				}
				break;
...
bool func_6(var uParam0)
{
	...
	if (func_16(uParam0, 1))
	{
		...
		{
			sLocal_168[0 /*5*/] = uParam0->f_2;
			sLocal_168[0 /*5*/].f_1 = 1;
			ANIMSCENE::TAKE_OWNERSHIP_OF_ANIM_SCENE(uParam0->f_2);
		}
	}
...
int func_19(var uParam0)
{
	...
	iLocal_20 = 4;
	vLocal_21 = { -324.32f, 739.0914f, 116.5348f /*3*/ };
	fLocal_24 = 121.4624f;
	...
	if (!VOLUME::DOES_VOLUME_EXIST(iLocal_19))
	{
		vVar0 = { -347.47f, 740.87f, 116.45f /*3*/ };
		fVar3 = 21.0f;
		iLocal_19 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vVar0, 0.0f, 0.0f, 0.0f, fVar3, fVar3, fVar3, "Mudtown3_outro_res");
...
bool func_22(int iParam0, int iParam1, int iParam2)
{
	...
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(sLocal_168[iParam0 /*5*/]))
	{
		sLocal_168[iParam0 /*5*/] = ANIMSCENE::_CREATE_ANIM_SCENE(sVar1, iParam2, sVar0, false, true);
		sLocal_168[iParam0 /*5*/].f_4 = iParam1;
		return false;
	}
	if (!sLocal_168[iParam0 /*5*/].f_1)
	{
		ANIMSCENE::LOAD_ANIM_SCENE(sLocal_168[iParam0 /*5*/]);
		sLocal_168[iParam0 /*5*/].f_1 = 1;
		return false;
	}
	if (!ANIMSCENE::IS_ANIM_SCENE_LOADED(sLocal_168[iParam0 /*5*/], true, false))
	{
		return false;
	}
	return true;
...
int func_23(var uParam0)
{
	...
	{
		TASK::TASK_START_SCENARIO_IN_PLACE_HASH(bLocal_14, joaat("WORLD_HUMAN_WAITING_IMPATIENT"), 0, false, 0, -1.0f, false);
...
void func_30(int iParam0)
{
	if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(sLocal_168[iParam0 /*5*/]))
	{
		if (ANIMSCENE::CHECK_OWNERSHIP_OF_ANIM_SCENE(sLocal_168[iParam0 /*5*/]))
		{
			ANIMSCENE::_DELETE_ANIM_SCENE(sLocal_168[iParam0 /*5*/]);
		}
	}
}
...
void func_42(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		PED::SET_PED_CONFIG_FLAG(func_74(iParam0), 137 /*PCF_0xE18960DE*/, true);
	}
}
...
void func_44(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		PED::SET_PED_CONFIG_FLAG(func_74(iParam0), 204 /*PCF_0x435F091E*/, true);
	}
	else
	{
		PED::SET_PED_CONFIG_FLAG(func_74(iParam0), 204 /*PCF_0x435F091E*/, false);
	}
}
...
void func_46(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_74(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_76(iParam0) < 10000.0f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
int func_51(int iParam0, char* sParam1, bool bParam2)
{
	...
	while (iVar0 < ITEMSET::GET_ITEMSET_SIZE(Global_43616))
	{
		...
		{
			if (!DECORATOR::DECOR_EXIST_ON(ITEMSET::GET_INDEXED_ITEM_IN_ITEMSET(iVar0, Global_43616), func_83()) && ENTITY::GET_ENTITY_MODEL(iVar1) == iParam0)
			{
				if (ENTITY::IS_ENTITY_A_PED(iVar1))
				{
					if (!PED::GET_PED_BLACKBOARD_SCRIPT_BOOL(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iVar1), sParam1))
					{
					}
					else
					{
...
void func_54(bool bParam0)
{
	...
	func_84(bParam0, 1);
	PED::SET_PED_CONFIG_FLAG(*bParam0, 413 /*PCF_0xD291BB15*/, true);
...
void func_61()
{
	...
	{
		func_90();
		if (sLocal_168[0 /*5*/].f_2 == 1)
		{
			if (!bLocal_31)
			{
				if (func_91(0) || func_92(0, "A_M_M_ValTownfolk_02", 1))
				{
					TASK::TASK_SMART_FLEE_PED(bLocal_16, Global_35, 10000.0f, -1, 0, 3.0f, bLocal_17);
					AITRANSPORT::SET_TRANSPORT_CONFIG_FLAG(bLocal_17, 0, false);
					bLocal_31 = true;
				}
				else
				{
					AITRANSPORT::SET_TRANSPORT_CONFIG_FLAG(bLocal_17, 0, true);
				}
			}
		}
	}
...
void func_62()
{
	...
	if (func_39(bLocal_16, 73))
	{
		bLocal_32 = true;
		func_94(bLocal_16, 0);
		if (!func_95(Global_35, bLocal_16, 50.0f, 1))
		{
			func_96();
		}
		func_97();
	...
	{
		if (func_98(bLocal_16, Global_35) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bLocal_16, Global_35, true, true))
		{
			strcpy_s(&cVar0, 24, "MUD3_SORRYJB");
			if (func_99(&uLocal_42, cVar0, 0, -1, 0, 0))
			{
				func_100(3, 0, 0, "MUD3_HG_KILL", bLocal_16, 0, 1065353216, 0);
				bLocal_33 = true;
			}
			if (func_39(bLocal_17, 73))
			{
				AITRANSPORT::SET_TRANSPORT_CONFIG_FLAG(bLocal_17, 0, false);
				TASK::TASK_SMART_FLEE_PED(bLocal_17, Global_35, 1000.0f, -1, 0, 2.0f, 0);
			}
			func_101(joaat("DISCOVER_LOC_EASEL"), (1 << 31));
...
void func_63()
{
	...
	{
		if (func_107(Global_35, -354.01f, 491.56f, 95.67f, 35.0f, 1, 1) | func_108(&bLocal_15) | func_108(&bLocal_17))
		{
			func_106();
		}
	}
...
bool func_64()
{
	...
	if (BUILTIN::VDIST(Global_36, vLocal_21) > (fLocal_25 + 50.0f))
	{
		return true;
	}
	if (func_39(bLocal_15, 0))
	{
		...
		if (iVar0 != 1 && iVar0 != -1)
		{
			...
			if (func_39(bLocal_14, 0))
			{
				TASK::TASK_SMART_FLEE_PED(bLocal_14, Global_35, 1000.0f, -1, 0, 1.0f, 0);
			}
			return true;
		}
	}
...
bool func_65()
{
	...
	{
		if (func_116(bLocal_14, bLocal_15, 1, 80.0f, 0))
		{
			bLocal_166 = true;
		}
	}
	...
	if (iLocal_159 != 0)
	{
		if (!func_95(Global_35, bLocal_14, 150.0f, 1))
		{
			return true;
		}
	}
	...
	iVar29 = 2567;
	if (func_117(bLocal_14, 0, &sVar1, &iVar29, 0, 0))
	{
		func_115(10);
	}
	switch (iLocal_159)
	{
		case 0:
			if (func_95(bLocal_14, Global_35, 80.0f, 1))
			{
				func_115(1);
			}
			else
			{
				...
				if (func_116(bLocal_14, Global_35, 1, 40.0f, 0))
				{
					func_115(2);
				}
				else
				{
					...
					if (func_39(bLocal_15, 73))
					{
						if (func_118(Global_35, bLocal_15, 0) || func_95(Global_35, bLocal_15, 10.0f, 1))
						{
							bVar30 = true;
						}
					}
					...
					if (func_95(bLocal_14, Global_35, 20.0f, 1) && iVar0 == 1)
					{
						func_115(3);
					}
					else
					{
						...
						else if ((!func_118(Global_35, bLocal_15, 0) && !func_95(Global_35, bLocal_15, 10.0f, 1)) && !bLocal_34)
						{
							func_115(7);
						}
						else if (func_118(Global_35, bLocal_15, 0))
						{
							...
							if (!func_95(bLocal_14, Global_35, 30.0f, 1) || fVar32 > 18.0f)
							{
								func_115(9);
							}
							else
							{
								...
								if (func_118(Global_35, bLocal_15, 0))
								{
									...
									if (func_121(Global_35, ENTITY::GET_ENTITY_COORDS(bLocal_14, true, false), &uLocal_163, 6.5f, 6.0f, 5.5f, 5.0f, 2.0f, 0, 0, 1, 1, 0))
									{
										bLocal_34 = true;
									}
								}
								else if (func_95(bLocal_14, bLocal_15, 10.0f, 1) || bLocal_34)
								{
									func_115(4);
								}
								else
								{
									...
									else
									{
										...
										else
										{
											...
											if (func_123(&uLocal_160) >= 10.0f || !TASK::_0x9FF5F9B24E870748(bLocal_14))
											{
												func_115(6);
											}
											else
												...
												if (func_39(bLocal_15, 73))
												{
													...
													else
													{
														...
														else
														{
															...
															{
																func_89(&uLocal_155, 4.0f);
															}
															if (func_124(&uLocal_155) > 3000)
															{
																if (func_95(Global_35, bLocal_14, 30.0f, 1))
																{
																	if (func_125())
																	{
																		if (func_119(256) == 1)
...
void func_69(Vector3 vParam0, int iParam3)
{
	...
	while (iVar0 < Global_1911670)
	{
		...
		if (VOLUME::_IS_VOLUME_LOCK_REQUEST_VALID_2(iVar1))
		{
			...
			if (func_129(vVar2, vParam0, 2.0f, 1))
			{
...
int func_81(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_39(bVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(bVar0) && func_133(PLAYER::PLAYER_PED_ID(), bVar0, 1) < 10000.0f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_135(iParam0);
					PERSCHAR::_FORCE_DESPAWN_PERSCHAR(func_136(iParam0, 0));
...
void func_90()
{
	...
	if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(sLocal_168[iVar0 /*5*/], false))
	{
		sLocal_168[iVar0 /*5*/].f_2 = 1;
	}
	if (!sLocal_168[iVar0 /*5*/].f_2)
	{
		if (func_39(bLocal_16, 1))
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(sLocal_168[iVar0 /*5*/], "A_M_M_ValTownfolk_02", bLocal_16, 0);
		}
		if (func_39(bLocal_17, 1))
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(sLocal_168[iVar0 /*5*/], "HORSE_01", bLocal_17, 0);
		}
		if (func_39(Global_35, 1))
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(sLocal_168[iVar0 /*5*/], "ARTHUR", Global_35, 0);
		}
	}
	if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(sLocal_168[iVar0 /*5*/], false))
	{
		ANIMSCENE::START_ANIM_SCENE(sLocal_168[iVar0 /*5*/]);
		sLocal_168[iVar0 /*5*/].f_2 = 1;
	}
	else
	{
...
bool func_91(int iParam0)
{
	...
	if (ANIMSCENE::IS_ANIM_SCENE_FINISHED(sLocal_168[iParam0 /*5*/], false))
	{
		return true;
	}
	if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(sLocal_168[iParam0 /*5*/], false))
	{
		return true;
	}
	return false;
...
bool func_92(int iParam0, char* sParam1, bool bParam2)
{
	...
	if (ANIMSCENE::HAS_ENTITY_EXITED_ANIM_SCENE(sLocal_168[iParam0 /*5*/], sParam1))
	{
		return true;
	}
	if (bParam2)
	{
		if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(sLocal_168[iParam0 /*5*/], sParam1))
		{
			return true;
		}
	}
...
void func_101(int iParam0, int iParam1)
{
	...
	Global_40.f_8863[func_169(iParam0, 1)] |= iParam1;
}
...
int func_104(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	struct<4> /*32*/ sVar0;
	struct<2> /*16*/ sVar13;
	int iVar15;
...
int func_112(bool bParam0)
{
	...
	if (func_95(Global_35, *bParam0, 3.0f, 1) && func_177(Global_35, *bParam0, 0))
	{
		return 1;
	}
	return 0;
...
void func_115(int iParam0)
{
	...
	switch (iLocal_159)
	{
		...
		case 1:
			...
			break;
		case 2:
			iLocal_18 = MAP::BLIP_ADD_FOR_ENTITY(joaat("BLIP_STYLE_FRIENDLY"), bLocal_14);
			MAP::BLIP_ADD_MODIFIER(iLocal_18, joaat("BLIP_MODIFIER_URGENT_ALERT"));
			PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(bLocal_14);
			TASK::TASK_LOOK_AT_ENTITY(bLocal_14, Global_35, -1, 0, 51, 0);
			TASK::OPEN_SEQUENCE_TASK(&iVar0);
			TASK::TASK_PLAY_UPPER_ANIM_FACING_ENTITY(0, sLocal_27, "neutral_get_attention_l_001", Global_35, func_179(sLocal_27, "neutral_get_attention_l_001"), 2.0f, -2.0f, 0, 0.0f, false, false, -1.0f, 0, 0, -1.0f);
			TASK::TASK_PLAY_UPPER_ANIM_FACING_ENTITY(0, sLocal_27, "positive_nod_f_002", Global_35, func_179(sLocal_27, "positive_nod_f_002"), 2.0f, -2.0f, 0, 0.0f, false, false, -1.0f, 0, 0, -1.0f);
			TASK::TASK_PLAY_UPPER_ANIM_FACING_ENTITY(0, sLocal_27, "neutral_get_attention_l_002", Global_35, func_179(sLocal_27, "neutral_get_attention_l_002"), 2.0f, -2.0f, 0, 0.0f, false, false, -1.0f, 0, 0, -1.0f);
			TASK::TASK_PLAY_UPPER_ANIM_FACING_ENTITY(0, sLocal_27, "neutral_look_around_f_001", Global_35, func_179(sLocal_27, "neutral_look_around_f_001"), 2.0f, -2.0f, 0, 0.0f, false, false, -1.0f, 0, 0, -1.0f);
			TASK::TASK_PLAY_UPPER_ANIM_FACING_ENTITY(0, sLocal_27, "neutral_get_attention_r_001", Global_35, func_179(sLocal_27, "neutral_get_attention_r_001"), 2.0f, -2.0f, 0, 0.0f, false, false, -1.0f, 0, 0, -1.0f);
			TASK::TASK_PLAY_UPPER_ANIM_FACING_ENTITY(0, sLocal_27, "neutral_get_attention_r_002", Global_35, func_179(sLocal_27, "neutral_get_attention_r_002"), 2.0f, -2.0f, 0, 0.0f, false, false, -1.0f, 0, 0, -1.0f);
		...
		case 3:
			TASK::TASK_LOOK_AT_ENTITY(bLocal_14, Global_35, -1, 0, 51, 0);
			TASK::TASK_TURN_PED_TO_FACE_ENTITY(bLocal_14, Global_35, -1, -1.0f, -1.0f, -1.0f);
			break;
		case 4:
			func_122();
			break;
		case 5:
			...
			if (func_39(bLocal_15, 0))
			{
				AITRANSPORT::SET_TRANSPORT_CONFIG_FLAG(bLocal_15, 0, true);
				FLOCK::SET_ANIMAL_TUNING_BOOL_PARAM(bLocal_15, 48, true);
			}
			TASK::OPEN_SEQUENCE_TASK(&iVar0);
			TASK::TASK_PLAY_UPPER_ANIM_FACING_ENTITY(0, sLocal_27, "positive_nod_f_001", Global_35, func_179(sLocal_27, "positive_nod_f_001"), 2.0f, -2.0f, 0, 0.0f, false, false, -1.0f, 0, 0, -1.0f);
			if (PED::IS_ANIMAL_INTERACTION_POSSIBLE(bLocal_14, bLocal_15))
			{
				TASK::TASK_ANIMAL_INTERACTION(0, bLocal_15, joaat("INTERACTION_POSITIVESHORT"), 0, false);
			}
			TASK::CLOSE_SEQUENCE_TASK(iVar0);
			TASK::TASK_PERFORM_SEQUENCE(bLocal_14, iVar0);
			TASK::CLEAR_SEQUENCE_TASK(&iVar0);
			func_100(13, 0, 0, "MUD3_HG_HORSE", bLocal_14, 0, 1065353216, 0);
			break;
		case 6:
			func_28(&iLocal_18);
			PED::SET_PED_KEEP_TASK(bLocal_14, true);
			TASK::OPEN_SEQUENCE_TASK(&iVar0);
			TASK::TASK_MOUNT_ANIMAL(0, bLocal_15, -1, -1, 1.0f, 1, 0, 0);
			TASK::TASK_SMART_FLEE_PED(0, Global_35, 1000.0f, -1, 0, 1.0f, 0);
			TASK::CLOSE_SEQUENCE_TASK(iVar0);
			TASK::TASK_PERFORM_SEQUENCE(bLocal_14, iVar0);
			TASK::CLEAR_SEQUENCE_TASK(&iVar0);
			break;
		...
		case 9:
			...
			PED::SET_PED_KEEP_TASK(bLocal_14, true);
			TASK::CLEAR_PED_TASKS(bLocal_14, true, false);
			LAW::_LAW_WITNESS_RESPONSE_TASK(bLocal_14, Global_35, bLocal_14, Global_36, joaat("CRIME_THEFT_HORSE"));
			TASK::OPEN_SEQUENCE_TASK(&iVar0);
			TASK::TASK_LOOK_AT_ENTITY(0, Global_35, -1, 0, 51, 0);
			TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, Global_35, 2000, -1.0f, -1.0f, -1.0f);
			TASK::TASK_SMART_FLEE_PED(0, Global_35, 1000.0f, -1, 0, 1.5f, 0);
			TASK::CLOSE_SEQUENCE_TASK(iVar0);
			TASK::TASK_PERFORM_SEQUENCE(bLocal_14, iVar0);
			TASK::CLEAR_SEQUENCE_TASK(&iVar0);
			func_178(1, 0, 1);
			...
			func_178(32, 0, 1);
			func_178(64, 0, 1);
			func_100(2, joaat("HONOR_EVENT_STEAL_HORSE"), 0, 0, bLocal_14, 0, 1065353216, 0);
			break;
		case 10:
			func_28(&iLocal_18);
			PED::SET_PED_KEEP_TASK(bLocal_14, true);
			TASK::TASK_SMART_FLEE_PED(bLocal_14, Global_35, 1000.0f, -1, 0, 2.0f, 0);
			break;
		case 11:
			func_28(&iLocal_18);
			break;
...
bool func_116(bool bParam0, bool bParam1, bool bParam2, float fParam3, bool bParam4)
{
	if (bParam2)
	{
		if (!func_177(bParam0, bParam1, 0.0f))
		{
			return false;
		}
	}
...
bool func_117(bool bParam0, int iParam1, var uParam2, int iParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		...
		if (Global_1935630.f_27)
		{
			if (!(uParam2->f_1 & 8) != 0)
			{
				...
				else if (func_184(bParam0, iParam1, uParam2))
				{
					*iParam3 = 8;
					func_182(bParam0, uParam2, *iParam3);
					return true;
		...
		if (Global_1935630.f_26 & func_186(PLAYER::PLAYER_ID(), 0, 1, (uParam2->f_1 & (1 << 19)) == 0))
		{
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_203(bParam0, iParam1, uParam2))
				{
					*iParam3 = (1 << 11);
					func_182(bParam0, uParam2, *iParam3);
					return true;
...
int func_119(int iParam0)
{
	...
	strcpy_s(&cVar0, 24, func_210(iParam0));
...
bool func_121(int iParam0, Vector3 vParam1, float fParam4, float fParam5, bool bParam6, float fParam7, bool bParam8, float fParam9, bool bParam10, int iParam11, float fParam12, float fParam13, bool bParam14)
{
	...
	if (func_68(fParam4))
	{
		...
		if (func_215(fParam4) >= fParam9)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iVar1) && !func_216(iParam0, joaat("SCRIPT_TASK_DISMOUNT_ANIMAL")))
			{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iVar2) && !func_216(iParam0, joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")))
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(iParam0, false))
				{
...
bool func_122()
{
	...
	if (!bLocal_38)
	{
		...
		if (!func_218(1))
		{
			PED::SET_PED_CONFIG_FLAG(bLocal_15, 300 /*PCF_DisablePlayerHorseLeading*/, true);
			PED::SET_PED_CONFIG_FLAG(bLocal_15, 297 /*PCF_ForceInteractionLockonOnTargetPed*/, false);
			AITRANSPORT::SET_TRANSPORT_CONFIG_FLAG(bLocal_15, 0, true);
			bLocal_38 = true;
			func_219(1, 1);
		}
...
int func_124(float fParam0)
{
	...
	return (func_200() - BUILTIN::ROUND((fParam0->f_1 * 1000.0f)));
}
...
bool func_125()
{
	...
	if (PED::_HAS_PED_BEEN_SHOVED_RECENTLY(bLocal_14, 1000))
	{
		return false;
	}
...
void func_147(bool bParam0, int iParam1, int iParam2)
{
	...
	bVar4 = func_255(iVar3);
	func_256(iParam1, bVar4);
}
...
void func_166(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	sVar8 = { func_274(joaat("HONOR_CURRENT")) /*2*/ };
...
bool func_171(int iParam0, float fParam1)
{
	...
	if (ANIMSCENE::GET_ANIM_SCENE_PHASE(sLocal_168[iParam0 /*5*/]) >= fParam1)
	{
		return true;
	}
	return false;
	...
	switch (uParam0->f_6)
	{
		case 0:
			if ((*uParam0 & 16) != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_286(1) || (*uParam0 & (1 << 13)) != 0))
				{
...
bool func_183(bool bParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		if (func_296(bParam0, !(*uParam1 & (1 << 28)) != 0, !(*uParam1 & (1 << 29)) != 0, !(*uParam1 & (1 << 30)) != 0, 0, 0))
		{
...
bool func_184(bool bParam0, int iParam1, var uParam2)
{
	float fVar0;
	float fVar1;
	...
	fVar0 = 85.0f;
	if (func_300(iParam1, !(*uParam2 & (1 << 28)) != 0, !(*uParam2 & (1 << 29)) != 0, !(*uParam2 & (1 << 30)) != 0, 0))
	{
...
bool func_185(bool bParam0, var uParam1)
{
	...
	if (func_290(bParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
...
bool func_189(int iParam0, bool bParam1, var uParam2)
{
	var uVar0;
...
int func_194(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_197(bool bParam0, bool bParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(bParam1))
	{
		...
		if (func_120(bParam0, bParam1, 1, 1) < 4.0f)
		{
		...
		else if (VEHICLE::GET_DRAFT_ANIMAL_COUNT(iVar0, &iVar5, &iVar4))
		{
			...
			else if (iVar4 == iVar5)
			{
				...
				while (iVar6 < iVar4)
				{
					...
					{
						if (func_214(iVar7, vVar1, 1) < 3.0f)
						{
...
int func_203(bool bParam0, int iParam1, var uParam2)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	return func_318(bParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
		...
		case joaat("EVENT_SHOCKING_ENTITY_HOGTIED"):
			...
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(bParam0, iVar4, -1.0f, -1.0f, -1.0f, -1.0f) && PED::IS_TARGET_PED_IN_PERCEPTION_AREA(bParam0, Global_35, -1.0f, -1.0f, -1.0f, -1.0f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bParam0, iVar4, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bParam0, Global_35, 17))
				{
					...
					{
						if (func_214(iVar4, Global_36, 1) < 7.0f)
						{
							return true;
						}
					}
...
int func_208(bool bParam0, var uParam1)
{
	...
	{
		return func_323(bParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_213(int iParam0, Vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, int iParam12)
{
	...
	if (func_325(vParam1, 0.0f, 0.0f, 0.0f))
	{
		return;
	}
	...
	if (bParam4)
	{
		if (bVar3 <= bParam8)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iVar0) && !func_216(iParam0, joaat("SCRIPT_TASK_DISMOUNT_ANIMAL")))
			{
				TASK::TASK_DISMOUNT_ANIMAL(iParam0, iParam12, 0, 0, 0, 0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(iVar1) && !func_216(iParam0, joaat("SCRIPT_TASK_LEAVE_ANY_VEHICLE")))
			{
...
void func_235(int iParam0, struct<2> /*16*/ sParam1)
{
	...
	if (!func_336(iParam0, sParam1.f_0))
	{
	}
	if (!func_337(iParam0, sParam1.f_1))
	{
	}
}
...
int func_253(int iParam0)
{
	...
	if (!func_356(iParam0, &sVar0))
	{
		return 0;
	}
	sVar29 = { sVar0.f_5 /*4*/ };
	sVar29.f_4 = sVar0.f_9;
	if (!func_357(sVar0.f_4, &sVar0, &sVar29, -1, joaat("REMOVE_REASON_DEFAULT"), 0, 0))
	{
		return 0;
	}
	return 1;
...
int func_256(int iParam0, bool bParam1)
{
	...
	sVar1 = { func_354(0) /*4*/ };
	sVar1.f_4 = iVar0;
	if (!func_360(bParam1, &uVar6, &sVar1, 1, joaat("ADD_REASON_DEFAULT"), 0))
	{
		return 0;
	}
	return 1;
...
int func_265(int iParam0)
{
	...
	fVar1 = func_391(MISC::ABSF(fVar1) < 1.0f, func_391(fVar1 < 0.0f, -1.0f, 1.0f), fVar1);
			...
			if (func_398(iVar5, &bVar2, &iVar0))
			{
				...
				else
				{
					...
					else
					{
						...
						{
							if (func_400(bVar2) == joaat("WEAPON_MOD"))
							{
								if (iVar0 == 1014511709)
								{
									bVar3 = func_264() <= -160;
...
int func_277(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, bool bParam8)
{
	struct<4> /*32*/ sVar0;
	struct<7> /*56*/ sVar13;
	int iVar20;
...
bool func_296(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(bVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, bParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, bParam0)) && func_120(bVar0, bParam0, 1, 1) <= 4.0f)
		{
			return true;
		}
	}
...
bool func_314(int iParam0, bool bParam1, Vector3 vParam2)
{
	float fVar0;
...
int func_318(bool bParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar1))
	{
		if (bVar1 != bParam0)
		{
			if (PED::IS_TARGET_PED_IN_PERCEPTION_AREA(bParam0, Global_35, -1.0f, -1.0f, -1.0f, -1.0f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bParam0, Global_35, 17))
			{
				...
				{
					if (func_214(bVar1, Global_36, 1) < 5.0f)
					{
						return true;
					}
				}
...
bool func_336(int iParam0, bool bParam1)
{
	...
	sVar29 = { func_420(bParam1, sVar0, joaat("SLOTID_HORSE_MANE"), 0) /*4*/ };
	return func_421(sVar29, 1);
}
...
bool func_337(int iParam0, bool bParam1)
{
	...
	sVar29 = { func_420(bParam1, sVar0, joaat("SLOTID_HORSE_TAIL"), 0) /*4*/ };
	return func_421(sVar29, 1);
}
...
bool func_356(int iParam0, var uParam1)
{
	...
	sVar15 = { func_354(0) /*4*/ };
	if (!func_425(sVar15, iVar0, &sVar1, 0, 0))
	{
		return false;
	}
	if (!func_426(&sVar1, uParam1))
	{
		return false;
	}
	return true;
...
bool func_357(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> /*96*/ sVar0;
	int iVar14;
	...
	sVar0.f_9 = joaat("SLOTID_NONE");
	if (!func_428(*uParam1, &sVar0, bParam6, 0))
	{
		return false;
	}
	if (iParam3 < 0)
...
{
	return func_400(bParam0) == joaat("HORSE");
}

bool func_360(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (func_430(bParam0, uParam2, iParam3, bParam5, 0))
	{
		return false;
	}
	if (!func_429(0))
	...
	if (!INVENTORY::_INVENTORY_ADD_ITEM_WITH_GUID(func_424(0), uParam1, uParam2, bParam0, uParam2->f_4, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
void func_383(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME(*uParam0, func_432(func_431(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_362())
	{
...
bool func_398(int iParam0, bool bParam1, int iParam2)
{
	struct<4> /*32*/ sVar0;
	var uVar5;

	if (!func_436(23, &sVar0))
	{
		return false;
	}
...
struct<4> /*32*/ func_420(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
...
bool func_421(struct<4> /*32*/ sParam0, bool bParam4)
{
	struct<11> /*88*/ sVar0;

	if (!func_429(0))
	{
		return func_444(sParam0, bParam4, 1) != -1;
	}
	...
	if (!INVENTORY::_INVENTORY_EQUIP_ITEM_WITH_GUID(func_424(0), &sParam0, bParam4))
	{
		return false;
	}
	return true;
...
bool func_426(var uParam0, var uParam1)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_424(0), uParam0, uParam1, 29, 1))
	{
		return false;
	}
	return true;
...
bool func_430(bool bParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	struct<4> /*32*/ sVar0;
	struct<10> /*80*/ sVar4;
	var uVar26;
	...
	if (func_446(bParam0) && WEAPON::IS_WEAPON_A_GUN(bParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
		{
			sVar0 = { func_447(0) /*4*/ };
			sVar4.f_9 = joaat("SLOTID_NONE");
			if (!func_448(bParam0, &sVar0, joaat("SLOTID_WEAPON_0"), 0))
			{
				return false;
			}
			else if (func_449(bParam0, &sVar4, joaat("SLOTID_WEAPON_0")))
			{
				return false;
			}
			if (func_450(bParam0, 1))
			{
				if (!func_448(bParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					return false;
				}
				else if (func_449(bParam0, &sVar4, joaat("SLOTID_WEAPON_1")))
				{
					return false;
				}
			}
		}
		else if (!func_451(bParam0, &uVar26, 0))
		{
			return false;
		}
		return true;
	}
	iVar27 = func_452(bParam0, uParam1, bParam3, bParam4);
	if (iVar27 < 0)
	{
		return false;
	}
	...
	if (bParam3 || !func_453(bParam0))
	{
		iVar28 = func_454(bParam0, *uParam1, uParam1->f_4, bParam4);
	}
	else
	{
		iVar28 = INVENTORY::_INVENTORY_GET_INVENTORY_ITEM_COUNT_WITH_ITEMID(func_424(bParam4), bParam0, false);
	}
...
int func_444(struct<4> /*32*/ sParam0, bool bParam4, bool bParam5)
{
	int iVar0;
	struct<11> /*88*/ sVar1;
	int iVar15;
	...
	iVar15 = func_400(sVar1.f_4);
	if (iVar15 == joaat("HORSE"))
	{
		sVar16 = { func_462(sParam0, 1) /*29*/ };
		sVar16.f_10 = bParam4;
		iVar0 = func_463(joaat("UPDATE"), &sVar16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		sVar45 = { func_464(sParam0, 1) /*18*/ };
		sVar45.f_10 = bParam4;
		iVar0 = func_465(joaat("UPDATE"), &sVar45, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		sVar63 = { func_466(&sVar1) /*17*/ };
		sVar63.f_10 = bParam4;
		iVar0 = func_467(joaat("UPDATE"), &sVar63, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
{
	return func_400(bParam0) == joaat("WEAPON");
}
...
struct<4> /*32*/ func_447(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_420(joaat("CARRIED_WEAPONS"), func_354(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), bParam0) /*4*/ };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_420(joaat("CARRIED_WEAPONS"), func_354(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0) /*4*/ };
		}
		return Global_1223208;
	}
	return func_420(joaat("CARRIED_WEAPONS"), func_354(bParam0), joaat("SLOTID_CARRIED_WEAPONS"), 0);
}

bool func_448(bool bParam0, var uParam1, int iParam2, bool bParam3)
{
	return func_454(bParam0, *uParam1, iParam2, bParam3) > 0;
}

bool func_449(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;
...
{
	if (func_469(bParam0) == joaat("CI_CATEGORY_WEAPON_UNIQUE"))
	{
		return false;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
...
bool func_451(bool bParam0, var uParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
	...
	while (iVar29 < 4)
	{
		...
		if (func_448(bParam0, &sVar0, iVar5, 0))
		{
			bVar28 = func_449(bParam0, &sVar6, iVar5);
...
int func_452(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (!func_358(bParam0, 0))
	{
		return 0;
	...
	if (bParam2 || !func_453(bParam0))
	{
		return INVENTORY::_GET_ITEM_SLOT_MAX_COUNT(bParam0, uParam1->f_4);
	}
	return INVENTORY::_GET_ITEM_ROLE_MAX_LEVEL_COUNT(func_424(bParam3), bParam0);
}

bool func_453(bool bParam0)
{
	if (func_472(bParam0, joaat("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
int func_454(bool bParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	...
	sVar0 = { func_420(bParam0, sParam1, iParam5, bParam6) /*4*/ };
...
struct<29> /*232*/ func_462(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_424(bParam4), &uParam0, &sVar29, 29, 1))
	{
		return sVar0;
	}
	sVar0 = { func_466(&sVar29) /*17*/ };
...
struct<18> /*144*/ func_464(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_INVENTORY_GET_FULL_INVENTORY_ITEM_DATA(func_424(bParam4), &uParam0, &sVar18, 15, 1))
	{
		return sVar0;
	}
	sVar0 = { func_466(&sVar18) /*17*/ };
...
bool func_468(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_424(0);
	*uParam1 = { func_420(bParam0, func_447(0), iParam3, 0) /*4*/ };
	if (!INVENTORY::_INVENTORY_IS_GUID_VALID(uParam1))
	{
		return false;
	}
...
struct<5> /*40*/ func_470(bool bParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_400(bParam0))
	{
		case joaat("CLOTHING"):
			...
			break;
		case joaat("WEAPON"):
			sVar0 = { func_447(bParam1) /*4*/ };
			if (bParam2 && func_450(bParam0, 1))
			{
				...
				else if (!func_448(bParam0, &sVar0, joaat("SLOTID_WEAPON_1"), 0))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_449(bParam0, &sVar5, joaat("SLOTID_WEAPON_0")))
				{
					sVar0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_480(bParam0, joaat("CI_CATEGORY_CAMP")))
			{
			...
			else if (func_480(bParam0, joaat("CI_CATEGORY_WARDROBE")))
			{
				sVar0 = { func_420(joaat("WARDROBE"), sVar0, joaat("SLOTID_WARDROBE"), bParam1) /*4*/ };
				sVar0.f_4 = INVENTORY::_GET_DEFAULT_ITEM_SLOT_INFO(bParam0, joaat("WARDROBE"));
			}
		...
		default:
			...
			else if (INVENTORY::_INVENTORY_FITS_SLOT_ID(bParam0, joaat("SLOTID_CURRENCY")))
			{
				...
				if (!func_428(sVar0, &sVar27, bParam1, 0))
				{
					sVar0.f_4 = 0;
				}
				else
...
struct<4> /*32*/ func_479(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_420(joaat("EMOTE_ITEM"), func_354(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0) /*4*/ };
		}
		return Global_1223204;
	}
	return func_420(joaat("EMOTE_ITEM"), func_354(bParam0), joaat("SLOTID_EMOTE_ITEM"), 0);
}
